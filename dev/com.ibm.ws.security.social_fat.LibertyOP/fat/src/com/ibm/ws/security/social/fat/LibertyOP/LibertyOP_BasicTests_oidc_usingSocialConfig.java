...
@Mode(TestMode.FULL)
public class LibertyOP_BasicTests_oidc_usingSocialConfig extends Social_BasicTests {

    public static Class<?> thisClass = LibertyOP_BasicTests_oidc_usingSocialConfig.class;
    ...
    public static void setUp() throws Exception {
        ...
        genericTestServer = commonSetUp(SocialConstants.SERVER_NAME + ".LibertyOP.social", "server_LibertyOP_basicTests_oidc_usingSocialConfig.xml", SocialConstants.GENERIC_SERVER, extraApps, SocialConstants.DO_NOT_USE_DERBY, startMsgs);
