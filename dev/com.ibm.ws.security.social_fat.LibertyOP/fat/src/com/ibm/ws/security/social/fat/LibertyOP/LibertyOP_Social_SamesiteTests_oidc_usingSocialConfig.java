...
@Mode(TestMode.FULL)
public class LibertyOP_Social_SamesiteTests_oidc_usingSocialConfig extends SameSiteTests {

    public static Class<?> thisClass = LibertyOP_Social_SamesiteTests_oidc_usingSocialConfig.class;

    @ClassRule
    public static RepeatTests r = RepeatTests.with(new OAuthOIDCRepeatActions(OAuthOIDCRepeatActions.oidc_type));
    ...
    public static void setUp() throws Exception {
        ...
        genericTestServer = commonSetUp(SocialConstants.SERVER_NAME + ".LibertyOP.social", "server_social_oidc_samesite.xml", SocialConstants.GENERIC_SERVER, extraApps, SocialConstants.DO_NOT_USE_DERBY, startMsgs);
