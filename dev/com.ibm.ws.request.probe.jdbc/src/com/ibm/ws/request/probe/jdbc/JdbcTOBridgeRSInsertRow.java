...
public class JdbcTOBridgeRSInsertRow implements RequestProbeTransformDescriptor {

    private static final String classToInstrument = "com/ibm/ws/rsadapter/jdbc/WSJdbcResultSet";
    private static final String methodToInstrument = "insertRow";
    private static final String descOfMethod = "all";
    private static final String requestProbeType = "websphere.datasource.rsInsertRow";
