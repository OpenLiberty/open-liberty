...
public class JdbcTOBridgeRSUpdateRow implements RequestProbeTransformDescriptor {

    private static final String classToInstrument = "com/ibm/ws/rsadapter/jdbc/WSJdbcResultSet";
    private static final String methodToInstrument = "updateRow";
    private static final String descOfMethod = "all";
    private static final String requestProbeType = "websphere.datasource.rsUpdateRow";
