...
public class JdbcTOBridgePSExecuteUpdate implements RequestProbeTransformDescriptor {

    private static final String classToInstrument = "com/ibm/ws/rsadapter/jdbc/WSJdbcPreparedStatement";
    private static final String methodToInstrument = "executeUpdate";
    private static final String descOfMethod = "all";
    private static final String requestProbeType = "websphere.datasource.psExecuteUpdate";
