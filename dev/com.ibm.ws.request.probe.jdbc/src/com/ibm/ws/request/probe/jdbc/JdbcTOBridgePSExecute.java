...
public class JdbcTOBridgePSExecute implements RequestProbeTransformDescriptor {
    ...
    private static final String requestProbeType = "websphere.datasource.psExecute";
