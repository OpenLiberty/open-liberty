...
public class JdbcTOBridgeExecuteQuery implements RequestProbeTransformDescriptor {
    ...
    private static final String requestProbeType = "websphere.datasource.executeQuery";
