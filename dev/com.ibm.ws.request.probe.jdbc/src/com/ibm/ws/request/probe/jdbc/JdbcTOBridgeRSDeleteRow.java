...
public class JdbcTOBridgeRSDeleteRow implements RequestProbeTransformDescriptor {

    private static final String classToInstrument = "com/ibm/ws/rsadapter/jdbc/WSJdbcResultSet";
    private static final String methodToInstrument = "deleteRow";
    private static final String descOfMethod = "all";
    private static final String requestProbeType = "websphere.datasource.rsDeleteRow";
