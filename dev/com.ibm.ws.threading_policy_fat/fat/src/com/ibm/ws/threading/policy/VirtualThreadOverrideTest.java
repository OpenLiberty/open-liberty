...
public class VirtualThreadOverrideTest extends FATServletClient {

    @Server("com.ibm.ws.threading.override.fat.vt")
    ...
    public static void setUp() throws Exception {
        ...
        server.copyFileToLibertyInstallRoot("lib/features/", "features/vtOverrideUser-1.0.mf");
        server.copyFileToLibertyInstallRoot("lib/", "bundles/test.vtoverrideservice.bundle_fat.jar");
    ...
    public static void tearDown() throws Exception {
        ...
        server.deleteFileFromLibertyInstallRoot("lib/features/vtOverrideUser-1.0.mf");
        server.deleteFileFromLibertyInstallRoot("lib/test.vtoverrideservice.bundle_fat.jar");
    }

    @Test
    public void testDisableVirtualThreads() throws Exception {
        runTest(server, "vtpolicyapp/PolicyVirtualThreadServlet", "testDisableVirtualThreads");
    }
