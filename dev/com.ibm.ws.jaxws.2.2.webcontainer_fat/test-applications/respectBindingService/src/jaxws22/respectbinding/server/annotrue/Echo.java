...
package jaxws22.respectbinding.server.annotrue; // don't change this package
...
public class Echo {
    public String echo(String in) throws Exception_Exception {
        System.out.println("EchoPort's RespectBinding is enabled and called with arg:" + in);
        return in;
    }
}
