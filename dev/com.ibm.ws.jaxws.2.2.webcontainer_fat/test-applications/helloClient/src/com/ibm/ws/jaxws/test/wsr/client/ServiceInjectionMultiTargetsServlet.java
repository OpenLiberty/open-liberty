...
@WebServlet("/ServiceInjectionMultiTargetsServlet")
public class ServiceInjectionMultiTargetsServlet extends HttpServlet {
    private static final long serialVersionUID = -1L;

    @WebServiceRef(name = "services/serviceInjectionMultiTargets")
    PeopleService service1;

    @WebServiceRef(name = "services/serviceInjectionMultiTargets", value = PeopleService.class)
    Service service2;

    public ServiceInjectionMultiTargetsServlet() {
        super();
    }
