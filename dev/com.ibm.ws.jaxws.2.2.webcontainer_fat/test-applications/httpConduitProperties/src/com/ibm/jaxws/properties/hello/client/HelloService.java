...
@WebServiceClient(name = "HelloService", targetNamespace = "http://hello.properties.jaxws.ibm.com/", wsdlLocation = "WEB-INF/wsdl/HelloService.wsdl")
public class HelloService extends Service {

    private final static URL HELLOSERVICE_WSDL_LOCATION;
    private final static WebServiceException HELLOSERVICE_EXCEPTION;
    private final static QName HELLOSERVICE_QNAME = new QName("http://hello.properties.jaxws.ibm.com/", "HelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("WEB-INF/wsdl/HelloService.wsdl");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://hello.properties.jaxws.ibm.com/", "HelloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://hello.properties.jaxws.ibm.com/", "HelloPort"), Hello.class, features);
    }
