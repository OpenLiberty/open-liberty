...
@WebServlet("/CustomerServiceClientGetCustomerByImplServlet")
public class CustomerServiceClientGetCustomerByImplServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            out.println(customer.getCustomersByName("Joe").get(0).getName());
