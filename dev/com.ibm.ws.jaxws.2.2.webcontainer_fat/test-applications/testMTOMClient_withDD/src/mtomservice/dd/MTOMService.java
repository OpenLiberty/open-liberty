...
@WebServiceClient(name = "MTOMService", targetNamespace = "http://MTOMService/", wsdlLocation = "WEB-INF/wsdl/MTOMService.wsdl")
public class MTOMService extends Service {
    ...
    static {
        ...
        try {
            url = new URL("WEB-INF/wsdl/MTOMService.wsdl");
