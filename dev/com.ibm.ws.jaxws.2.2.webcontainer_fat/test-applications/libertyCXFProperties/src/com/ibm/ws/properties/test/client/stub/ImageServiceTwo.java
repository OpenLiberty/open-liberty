...
public interface ImageServiceTwo {
    ...
    @RequestWrapper(localName = "uploadImage", targetNamespace = "http://jaxws.service/", className = "com.ibm.ws.properties.test.client.stub.UploadImage")
    @WebMethod(action = "urn:UploadImage")
    @ResponseWrapper(localName = "uploadImageResponse", targetNamespace = "http://jaxws.service/", className = "com.ibm.ws.properties.test.client.stub.UploadImageResponse")
