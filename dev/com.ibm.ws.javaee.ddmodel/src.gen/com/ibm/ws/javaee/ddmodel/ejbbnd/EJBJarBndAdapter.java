...
public class EJBJarBndAdapter
    extends BndExtAdapter<EJBJarBnd>
    implements ContainerAdapter<EJBJarBnd> {
    ...
    public EJBJarBnd adapt(
        ...
        EJBJarBnd fromConfig = getConfigOverrides(configurations, ddOverlay, ddArtifactRoot);
        ...
        EJBJarBnd fromModule;
        try {
            fromModule = new EJBJarBndDDParser(ddAdaptRoot, ddEntry, xmi).parse();
