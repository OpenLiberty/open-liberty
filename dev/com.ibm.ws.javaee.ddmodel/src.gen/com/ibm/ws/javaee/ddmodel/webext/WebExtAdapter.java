...
public class WebExtAdapter implements ContainerAdapter<com.ibm.ws.javaee.dd.webext.WebExt> {
    ...
    public com.ibm.ws.javaee.dd.webext.WebExt adapt(Container root, OverlayContainer rootOverlay, ArtifactContainer artifactContainer,
        ...
        if (ddEntry != null) {
            try {
                com.ibm.ws.javaee.dd.webext.WebExt fromApp = new com.ibm.ws.javaee.ddmodel.webext.WebExtDDParser(containerToAdapt, ddEntry, xmi).parse();
                if (fromConfig == null) {
                    return fromApp;
                } else {
            ...
            if (servicePid.equals(parentPid) || parentPid.equals(extendsPid)) {
                ...
                if (moduleName == null) {
                    if (rootOverlay.getFromNonPersistentCache(MODULE_NAME_NOT_SPECIFIED, WebExtAdapter.class) == null) {
                        ...
                        overlay.getParentOverlay().addToNonPersistentCache(MODULE_NAME_NOT_SPECIFIED, WebExtAdapter.class, MODULE_NAME_NOT_SPECIFIED);
                    }
                    continue;
                }
