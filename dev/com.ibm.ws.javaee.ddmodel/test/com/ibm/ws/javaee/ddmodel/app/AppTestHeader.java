...
public class AppTestHeader extends AppTestBase {
    ...
    public void testApp50NoSchema() throws Exception {
        Application app = parse(app50NoSchema, JavaEEVersion.VERSION_9_0_INT);
        Assert.assertEquals( "5", app.getVersion() );
    }
    
    @Test
    public void testApp50NoSchemaInstance() throws Exception {
        parse(app50NoSchemaInstance, JavaEEVersion.VERSION_9_0_INT,
              XML_ERROR_MESSAGES);
    }
    
    @Test
    public void testApp50NoSchemaLocation() throws Exception {
        Application app = parse(app50NoSchemaLocation, JavaEEVersion.VERSION_9_0_INT);
        Assert.assertEquals( "5", app.getVersion() );
    }
    
    @Test
    public void testApp50NoXSI() throws Exception {
        Application app = parse(app50NoXSI, JavaEEVersion.VERSION_9_0_INT);
        Assert.assertEquals( "5", app.getVersion() );
    }
    
    @Test
    public void testApp50NoVersion() throws Exception {
        Application app = parse(app50NoVersion, JavaEEVersion.VERSION_9_0_INT);
        Assert.assertEquals( "6", app.getVersion() );
    }

    @Test
    public void testApp50NoID() throws Exception {
        Application app = parse(app50NoID, JavaEEVersion.VERSION_9_0_INT);
        Assert.assertEquals( "5", app.getVersion() );
    }
    ...
    public void testApp14NamespaceOnly () throws Exception {
        Application app = parse(app14NamespaceOnly , JavaEEVersion.VERSION_9_0_INT);
        Assert.assertEquals( "1.4", app.getVersion() );
    }
    
    @Test
    public void testApp14VersionOnly () throws Exception {
        Application app = parse(app14VersionOnly , JavaEEVersion.VERSION_9_0_INT);
        Assert.assertEquals( "1.4", app.getVersion() );
    }

    @Test
    public void testApp50NamespaceOnlyAt50() throws Exception {
        Application app = parse(app50NamespaceOnly, JavaEEVersion.VERSION_5_0_INT);
        Assert.assertEquals( "6", app.getVersion() );
    }

    @Test
    public void testApp50NamespaceOnlyAt60() throws Exception {
        Application app = parse(app50NamespaceOnly, JavaEEVersion.VERSION_6_0_INT);
        Assert.assertEquals( "6", app.getVersion() );
    }

    @Test
    public void testApp50NamespaceOnlyAt70() throws Exception {
        Application app = parse(app50NamespaceOnly, JavaEEVersion.VERSION_7_0_INT);
        Assert.assertEquals( "6", app.getVersion() );
    }
    
    @Test
    public void testApp50VersionOnly() throws Exception {
        Application app = parse(app50VersionOnly, JavaEEVersion.VERSION_9_0_INT);
        Assert.assertEquals( "5", app.getVersion() );
    }

    @Test
    public void testApp70NamespaceOnlyAt70() throws Exception {
        Application app = parse(app70NamespaceOnly, JavaEEVersion.VERSION_7_0_INT);
        Assert.assertEquals( "7", app.getVersion() );
    }

    @Test
    public void testApp70NamespaceOnlyAt80() throws Exception {
        Application app = parse(app70NamespaceOnly, JavaEEVersion.VERSION_8_0_INT);
        Assert.assertEquals( "8", app.getVersion() );
    }

    @Test
    public void testApp70NamespaceOnlyAt90() throws Exception {
        Application app = parse(app70NamespaceOnly, JavaEEVersion.VERSION_9_0_INT);
        Assert.assertEquals( "8", app.getVersion() );
    }

    @Test
    public void testApp70VersionOnly() throws Exception {
        Application app = parse(app70VersionOnly, JavaEEVersion.VERSION_9_0_INT);
        Assert.assertEquals( "7", app.getVersion() );
    }
    ...
    public void testApp50VersionMismatch() throws Exception {
        Application app = parse(app50VersionMismatch, JavaEEVersion.VERSION_9_0_INT);
        Assert.assertEquals( "5", app.getVersion() );
    }

    @Test
    public void testApp50UnknownNamespace() throws Exception {
        parse(app50UnknownNamespace, JavaEEVersion.VERSION_9_0_INT,
              UNSUPPORTED_DESCRIPTOR_NAMESPACE_MESSAGES);
    }

    @Test
    public void testApp50UnknownVersion() throws Exception {
        parse(app50UnknownVersion, JavaEEVersion.VERSION_9_0_INT,
