...
import io.openliberty.restfulWS30.fat.xml.XmlWithJaxbTestServlet;

/**
 * Tests whether the built-in JAXB Provider is used correctly when the {@code jaxb-3.0} feature is enabled.
 */
@AllowedFFDC
@RunWith(FATRunner.class)
public class XmlWithJaxbTest extends FATServletClient {

    public static final String APP_NAME = "xml";
    public static final String SERVER_NAME = APP_NAME + "-with-jaxb";

    @Server(SERVER_NAME)
    @TestServlet(servlet = XmlWithJaxbTestServlet.class, contextRoot = APP_NAME)
    public static LibertyServer server;

    @BeforeClass
    public static void setUp() throws Exception {
        WebArchive war = ShrinkWrap.create(WebArchive.class, APP_NAME + ".war")
                        .addPackages(true, XmlWithJaxbTestServlet.class.getPackage());
