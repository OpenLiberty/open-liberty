...
public interface WebSphereConfig extends Config, Closeable {
     ...
     */
    Object getValue(String propertyName, Type type);
     ...
     * @param propertyName The name of the property
     * @param type The type to convert to
     * @param optional if true, do not throw an exception if the property is not found
     * @return The converted value
     * @throws NoSuchElementException thrown if optional is false and the requested property does not exist
     * @throws IllegalArgumentException thrown if the raw String property value was not compatible with the converter for the specified type
     */
    Object getValue(String propertyName, Type type, boolean optional);
     ...
     * @throws IllegalArgumentException thrown if the raw String property value was not compatible with the converter for the specified type
     */
    Object getValue(String propertyName, Type type, String defaultString);
     ...
     */
    Object convertValue(String rawValue, Type type);
     ...
     * @throws IllegalArgumentException thrown if the raw String value was not compatible with the converter for the specified type
     */
    <T> T convertValue(String rawValue, Class<T> type);
     ...
     * @throws IllegalArgumentException thrown if the raw String value was not compatible with the converter for the specified type
     */
    Object convertValue(String rawString, Type type, Class<?> genericSubType);
     ...
     * @throws IllegalArgumentException thrown if the raw String property value was not compatible with the converter for the specified type
     */
    SourcedValue getSourcedValue(String propertyName, Type type);
