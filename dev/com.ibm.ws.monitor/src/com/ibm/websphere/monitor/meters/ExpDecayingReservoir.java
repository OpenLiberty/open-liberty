...
import com.ibm.websphere.monitor.meters.WeightedSnapshot.WeightedSample;
...
public class ExpDecayingReservoir {
     ...
     */
    public ExpDecayingReservoir(int size, double alpha) {
     ...
     */
    public ExpDecayingReservoir(int size, double alpha, Clock clock) {
