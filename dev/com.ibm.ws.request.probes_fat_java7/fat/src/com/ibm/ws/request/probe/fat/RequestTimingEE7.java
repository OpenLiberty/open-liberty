...
public class RequestTimingEE7 {
    ...
    private static final String APP_NAME = "jdbcTestPrj_3";

    @MinimumJavaLevel(javaLevel = 7)

    @BeforeClass
    public static void beforeClass() throws Exception {
        ShrinkHelper.defaultDropinApp(server, "jdbcTestPrj_3", "com.ibm.ws.request.probe");
        server.startServer();
    }
    ...
    public void testSlowRequestTimingEE7() throws Exception {
        ...
        URL url = new URL("http://" + server.getHostname() + ":" + server.getHttpDefaultPort() + "/jdbcTestPrj_3?sleepTime=11000");
