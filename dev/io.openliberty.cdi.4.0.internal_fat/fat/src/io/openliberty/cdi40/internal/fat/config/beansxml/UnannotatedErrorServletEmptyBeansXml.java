...
@WebServlet("/UnannotatedError")
public class UnannotatedErrorServletEmptyBeansXml extends FATServlet {

    @Inject
    private RequestScopedBean requestScopedBean;

    @Inject
    private UnannotatedBean unannotatedBean; //this will actually cause a deployment error unless the legacy config option is set
