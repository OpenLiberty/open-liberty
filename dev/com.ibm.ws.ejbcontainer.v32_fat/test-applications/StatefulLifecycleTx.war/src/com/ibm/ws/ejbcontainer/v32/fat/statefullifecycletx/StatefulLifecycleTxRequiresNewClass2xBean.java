...
public class StatefulLifecycleTxRequiresNewClass2xBean extends AbstractStatefulLifecycleTxBean implements SessionBean {
    private static final Logger logger = Logger.getLogger(StatefulLifecycleTxRequiresNewClass2xBean.class.getName());
