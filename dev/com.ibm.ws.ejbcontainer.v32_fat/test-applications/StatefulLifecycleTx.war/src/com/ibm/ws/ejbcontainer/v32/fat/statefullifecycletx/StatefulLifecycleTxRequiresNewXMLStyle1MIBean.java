...
public class StatefulLifecycleTxRequiresNewXMLStyle1MIBean extends AbstractStatefulLifecycleTxBean {
    private static final Logger logger = Logger.getLogger(StatefulLifecycleTxRequiresNewXMLStyle1MIBean.class.getName());
