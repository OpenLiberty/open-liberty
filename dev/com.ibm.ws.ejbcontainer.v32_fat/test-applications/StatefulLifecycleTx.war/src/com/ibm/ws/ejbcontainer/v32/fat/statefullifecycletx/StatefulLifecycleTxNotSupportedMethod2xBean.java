...
public class StatefulLifecycleTxNotSupportedMethod2xBean extends AbstractStatefulLifecycleTxBean implements SessionBean {
    private static final Logger logger = Logger.getLogger(StatefulLifecycleTxNotSupportedMethod2xBean.class.getName());
