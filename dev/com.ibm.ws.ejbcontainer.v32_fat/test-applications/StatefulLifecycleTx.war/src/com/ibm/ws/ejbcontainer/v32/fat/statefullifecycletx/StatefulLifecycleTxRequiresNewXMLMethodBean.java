...
public class StatefulLifecycleTxRequiresNewXMLMethodBean extends AbstractStatefulLifecycleTxBean {
    private static final Logger logger = Logger.getLogger(StatefulLifecycleTxRequiresNewXMLMethodBean.class.getName());
