...
public class StatefulLifecycleTxNotSupportedXMLMethodBean extends AbstractStatefulLifecycleTxBean {
    private static final Logger logger = Logger.getLogger(StatefulLifecycleTxNotSupportedXMLMethodBean.class.getName());
