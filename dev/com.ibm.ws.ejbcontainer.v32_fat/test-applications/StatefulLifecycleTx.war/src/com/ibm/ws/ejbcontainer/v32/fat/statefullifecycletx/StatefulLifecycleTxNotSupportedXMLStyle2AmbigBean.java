...
public class StatefulLifecycleTxNotSupportedXMLStyle2AmbigBean extends AbstractStatefulLifecycleTxBean {
    private static final Logger logger = Logger.getLogger(StatefulLifecycleTxNotSupportedXMLStyle2AmbigBean.class.getName());
