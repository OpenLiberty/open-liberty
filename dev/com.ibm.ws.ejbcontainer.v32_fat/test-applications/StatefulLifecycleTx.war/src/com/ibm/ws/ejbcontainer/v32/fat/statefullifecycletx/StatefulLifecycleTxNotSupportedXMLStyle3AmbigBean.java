...
public class StatefulLifecycleTxNotSupportedXMLStyle3AmbigBean extends AbstractStatefulLifecycleTxBean {
    private static final Logger logger = Logger.getLogger(StatefulLifecycleTxNotSupportedXMLStyle3AmbigBean.class.getName());
