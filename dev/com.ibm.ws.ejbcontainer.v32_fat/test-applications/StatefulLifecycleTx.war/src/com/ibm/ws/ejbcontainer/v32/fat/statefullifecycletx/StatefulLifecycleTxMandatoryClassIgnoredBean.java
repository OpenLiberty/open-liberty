...
public class StatefulLifecycleTxMandatoryClassIgnoredBean extends AbstractStatefulLifecycleTxBean {
    private static final Logger logger = Logger.getLogger(StatefulLifecycleTxMandatoryClassIgnoredBean.class.getName());
