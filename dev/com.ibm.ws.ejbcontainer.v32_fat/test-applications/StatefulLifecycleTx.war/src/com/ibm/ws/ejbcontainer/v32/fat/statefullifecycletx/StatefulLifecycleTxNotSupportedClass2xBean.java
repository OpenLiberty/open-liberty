...
public class StatefulLifecycleTxNotSupportedClass2xBean extends AbstractStatefulLifecycleTxBean implements SessionBean {
    private static final Logger logger = Logger.getLogger(StatefulLifecycleTxNotSupportedClass2xBean.class.getName());
