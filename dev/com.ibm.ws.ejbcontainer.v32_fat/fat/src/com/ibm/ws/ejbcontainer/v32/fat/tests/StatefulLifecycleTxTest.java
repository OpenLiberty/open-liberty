...
import com.ibm.ws.ejbcontainer.v32.fat.statefullifecycletx.StatefulLifecycleTxTestServlet;
...
public class StatefulLifecycleTxTest extends FATServletClient {
    ...
    public static void beforeClass() throws Exception {
        ...
        //#################### StatefulLifecycleTx.war
        WebArchive StatefulLifecycleTx = ShrinkHelper.buildDefaultApp("StatefulLifecycleTx.war", "com.ibm.ws.ejbcontainer.v32.fat.statefullifecycletx.");
        ShrinkHelper.exportDropinAppToServer(server, StatefulLifecycleTx, DeployOptions.SERVER_ONLY);
