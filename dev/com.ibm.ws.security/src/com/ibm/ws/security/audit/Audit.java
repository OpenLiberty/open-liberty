...
public class Audit {
    ...
    public static enum EventID {
        ...
        FILE_TRANSFER_UPDATE_01(AuditConstants.FILE_TRANSFER_UPDATE),
        FILE_TRANSFER_DELETE_01(AuditConstants.FILE_TRANSFER_DELETE),
        FILE_TRANSFER_ADD_01(AuditConstants.FILE_TRANSFER_ADD);
