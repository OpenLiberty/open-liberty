    			...
    			<div class="modal-content">
					<div class="modal-body">
						<a class="dialog-close-link" href="#" draggable="false" data-dismiss="modal">
       					...
       					<h3 class="modal-title text-center" data-externalizedString="VALIDATE_CONNECTION"></h3>
						...
						<form id="testParameters" aria-labelledby="betaLabel">
							<div id="testUserPassParameters" class="form-group hidden">
								<div id="testNoReference" class="form-check">
									...
									<legend class="bx--label" data-externalizedString="RESOURCE_REFERENCE"></legend>
									<div class="bx--form-item">
										<input id="testReferenceCheckbox" type="checkbox" class="checkbox-btn bx--toggle" aria-labelledby="betaLabel">
										<label class="bx--toggle__label" for="testReferenceCheckbox" id="testReferenceCheckboxLabel">
											<span class="bx--toggle__text--left" data-externalizedString="NO"></span>
											<span class="bx--toggle__appearance"></span>
											<span class="bx--toggle__text--right" data-externalizedString="YES"></span>
										</label>
									</div>
									  
								</div>
								<label id="testUsernameInputTitle" data-externalizedString="USER_NAME_LABEL" for="testUsernameInput" class="bx--label"></label>
							...
							<div id="testAuthAliasParameter" class="form-group">
								<fieldset>
									<legend data-externalizedString="CONTAINER_AUTHENTICATION" id="containerAuthLegend"></legend>
										...
										<div class="containerAuthenticationFullRowSection">
											...
											<div class="keyValueTable containerAuthSubSection" id="keyValueTable">
												<div class="keyValueTableRow">
													<div class="keyValueTableRowTitle" data-externalizedString="LOGIN_CONFIG_PROPERTIES"></div>
													<div class="keyValueTableItemAction">
														<div class="keyValueTableItemActionIcon keyValueTableItemActionIconAdd bx--tag" data-externalizedString="ADD"></div>
													</div>
												</div>
