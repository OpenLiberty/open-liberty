...
public class JAXRSClientFactoryBean extends AbstractJAXRSFactoryBean {
    ...
    public WebClient createWebClient() {
        ...
        try {
            ...
            WebClient client = actualState == null ? new WebClient(getAddress()) : new WebClient(actualState);
    ...
    private ClientState getActualState() {
        ...
        if (initialState != null) {
            return headers != null ? initialState.newState(URI.create(getAddress()), headers, null) : initialState;
        } else {
            return null;
        }
    }
    ...
    protected ClientProxyImpl createClientProxy(ClassResourceInfo cri, boolean isRoot,
        ...
        if (actualState == null) {
            return new ClientProxyImpl(URI.create(getAddress()), proxyLoader, cri, isRoot, inheritHeaders, varValues);
        } else {
            return new ClientProxyImpl(actualState, proxyLoader, cri, isRoot, inheritHeaders, varValues);
        }
    }
