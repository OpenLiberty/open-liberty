 ...
 * under the License.
 */
// Liberty Change - from 3.1.18 https://github.com/apache/cxf/blob/ae5bc3a7bc9b718c8b452e4f46e113709b6312da/rt/transports/http/src/main/java/org/apache/cxf/transport/servlet/AbstractHTTPServlet.java
...
public abstract class AbstractHTTPServlet extends HttpServlet implements Filter {
    ...
    private static boolean matchPath(boolean checkRedirect, List<Pattern> values, HttpServletRequest request) { // Liberty Change
        ...
        if (checkRedirect) { // Liberty Chance
