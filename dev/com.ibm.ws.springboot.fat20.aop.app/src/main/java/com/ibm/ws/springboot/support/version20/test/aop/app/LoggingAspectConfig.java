...
public class LoggingAspectConfig {
    ...
    @Before("execution(* com.ibm.ws.springboot.support.version20.test.aop.app.AopService.getInternalService())")
    public void beforeInternalMethodExecution() {
        LOGGER.info("==> Before internal service method execution");
    }

    @After("execution(* com.ibm.ws.springboot.support.version20.test.aop.app.AopService.getService())")
