...
public class JMS2AsyncSend extends ClientMain {
  ...
  @ClientTest
  public void testRAIssue() throws Exception
  {
      ...
      new Thread("SUB"+i)
      {
        ...
        public void run()
        {
          try
          {
            ...
            ConnectionFactory cf = (ConnectionFactory)ctx.lookup("java:comp/env/tcf_raissue");
            Util.TRACE("SUB"+ID+": cf="+cf);
            Topic topic = (Topic)ctx.lookup("java:comp/env/topic_raissue");
