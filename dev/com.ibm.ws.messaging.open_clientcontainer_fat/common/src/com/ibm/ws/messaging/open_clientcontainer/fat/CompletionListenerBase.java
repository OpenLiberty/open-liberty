...
public class CompletionListenerBase implements CompletionListener, AutoCloseable {
  ...
  String formattedState() {
      return "completionCount="+completionCount_
            +",exceptionCount="+exceptionCount_
            +",expectedCompletionCount="+expectedCompletionCount_
            +",expectedExceptionCount="+expectedExceptionCount_
            +",paused="+paused_;
  }
}
