...
public class RESTHelperTest {
    ...
    public void testRepairSlashes() {
        ...
        // This will fail as the output name is wrong
        //assertEquals("wrongObjectName", RESTHelper.repairSlashes("anObjectName", new RESTRequestTestImpl("aURI")));
        // This will fail as the test uri doesn't contain the object name. TODO properly when the exception is correctly thrown
        // assertEquals("anObject/Name", RESTHelper.repairSlashes("anObject/Name", new RESTRequestTestImpl("aURI")));
