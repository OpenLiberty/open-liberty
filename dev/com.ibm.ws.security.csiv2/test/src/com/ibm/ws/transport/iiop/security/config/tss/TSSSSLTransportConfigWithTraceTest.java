 ...
 */
public class TSSSSLTransportConfigWithTraceTest extends TSSSSLTransportConfigTest {

    @BeforeClass
    public static void traceSetUp() {
        outputMgr.trace("com.ibm.ws.security.csiv2.config.server.ServerSSLTransportConfig=all");
    }
