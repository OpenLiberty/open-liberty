...
public class ValidationInterceptor implements Serializable {
    ...
    public Object validateMethodInvocation(InvocationContext ctx) throws Exception {
        Validator validator = BeanValidationAccessor.getValidatorFactory().getValidator();
    ...
    public void validateConstructorInvocation(InvocationContext ctx) throws Exception {
        ...
        if (!violations.isEmpty()) {
            throw new ConstraintViolationException(getMessage(ctx.getConstructor(), ctx.getParameters(), violations), violations);
        }
