...
public class ObjectFactory {
    ...
    private final static QName _SayHelloResponse_QNAME = new QName("http://ibm.com/ws/jaxws/transport/security/", "sayHelloResponse");
    private final static QName _SayHello_QNAME = new QName("http://ibm.com/ws/jaxws/transport/security/", "sayHello");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ibm.com/ws/jaxws/transport/security/", name = "sayHelloResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ibm.com/ws/jaxws/transport/security/", name = "sayHello")
