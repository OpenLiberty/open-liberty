...
//	  System.err.println("MessageDeframer.deliver: " + hashCode() + " " + Thread.currentThread());
    if (inDelivery) {
      return;
    }
    inDelivery = true;
    try {
      ...
      if (stopDelivery) {
//    	  System.err.println("MessageDeframer.deliver stopDelivery " + hashCode() + " " + Thread.currentThread());
        close();
        return;
      }
...
//    	  System.err.println("MessageDeframer.deliver isStalled " + hashCode() + " " + Thread.currentThread());
        close();
      }
    } finally {
      inDelivery = false;
