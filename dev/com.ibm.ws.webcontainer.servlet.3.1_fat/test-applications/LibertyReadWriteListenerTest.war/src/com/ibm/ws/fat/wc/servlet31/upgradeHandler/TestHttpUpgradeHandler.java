    ...
    private void setReadListenerTests(WebConnection wc) throws Exception {
        if (getTestSet().equals("testUpgradeReadListenerSmallData"))
        {
            ...
            ReadListener readListener =
                            new TestUpgradeReadListener(input, wc, output, "testUpgradeReadListenerSmallData");
        ...
        else if (getTestSet().equals("testUpgradeReadListenerLargeData"))
        {
            ...
            ReadListener readListener =
                            new TestUpgradeReadListener(input, wc, output, "testUpgradeReadListenerLargeData");
            input.setReadListener(readListener);
            ...
            ReadListener readListener =
                            new TestUpgradeReadListener(input, wc, output, "testUpgradeReadListenerTimeout");
            input.setReadListener(readListener);
            ...
            try {
                ...
                output = wc.getOutputStream();
                ReadListener readListener =
                                new TestUpgradeReadListener(input, wc, output, "testRead_ContextTransferProperly_WhenUpgradeRLSet");
                input.setReadListener(readListener);
            } catch (Exception e) {
        ...
        if (getTestSet().equals("testUpgrade_WriteListener_From_ReadListener"))
        {
            ...
            //setting readListener
            ReadListener readListener =
                            new TestUpgradeReadListener(input, wc, output, "testUpgrade_WriteListener_From_ReadListener");
            input.setReadListener(readListener);
