...
public class CDIServletFilterListenerTest {
    ...
    public static void setupClass() throws Exception {
        ...
        ShrinkHelper.exportDropinAppToServer(LS, CDI12TestV2InjectionApp);

        // Start the server and use the class name so we can find logs easily.
        LS.startServer(CDIServletFilterListenerTest.class.getSimpleName() + ".log");
    }
    ...
    public void testCDIServletFilterListener() throws Exception { 
      ...
      verifyStringsInResponse(client, SERVLET_INJECTION_CONTEXT_ROOT, SERVLET_INJECTION_URL_FRAGMENT + "?payload=" + "V1", SERVLET_EXPECTED_TEXT_1);
      verifyStringsInResponse(client, SERVLET_INJECTION_CONTEXT_ROOT, SERVLET_INJECTION_URL_FRAGMENT + "?payload=" + "V2", SERVLET_EXPECTED_TEXT_2);
      HttpClient client2 = new HttpClient(); 
      verifyStringsInResponse(client2, SERVLET_INJECTION_CONTEXT_ROOT, SERVLET_INJECTION_URL_FRAGMENT + "?payload=" + "V3", SERVLET_EXPECTED_TEXT_3);
    }
