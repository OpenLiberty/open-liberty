...
public class CityAttrNames2 {
    public static final Attribute<City> areaCodes = new AttributeRecord<>("areaCodes");
    public static final SortableAttribute<City> changeCount = new SortableAttributeRecord<>("changeCount");
    ...
    public static volatile TextAttribute<City> name = null; // ignored due to final
}