 ...
 * com.ibm.ws.security.mp.jwt.1.1_fat.mpJwt-2.1 will become
 *
 * com.ibm.ws.security.mp.jwt.1.1_fat.mpJwt-2.1 - base/targetted tests
 * com.ibm.ws.security.mp.jwt.1.1_fat.mpJwt-2.1.envVars - environment variable tests
 * com.ibm.ws.security.mp.jwt.1.1_fat.mpJwt-2.1.sysProps - system properties tests
 */
@RunWith(Suite.class)
@SuiteClasses({
        ...
        // mp-config specified as system properties - run in project com.ibm.ws.security.mp.jwt.1.1_fat.mpJwt-2.1.sysProps

        // mp-config specified as env vars - run in project run in project com.ibm.ws.security.mp.jwt.1.1_fat.mpJwt-2.1.envVars
