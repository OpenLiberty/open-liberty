 ...
 * be called during a javax.faces.event.PreClearFlashEvent event.
 * It contains a counter which will be checked after each test to ensure it was called the expected amount of times
 */
public class PreClearFlashEventListener implements SystemEventListener {

    private int counter;

    public PreClearFlashEventListener() {
        counter = 0;
    }
    ...
    public void processEvent(SystemEvent event) throws AbortProcessingException {
        counter++;
        FacesContext.getCurrentInstance().getExternalContext().log("PreClearFlashEvent processEvent - counter: " + counter);
    }
