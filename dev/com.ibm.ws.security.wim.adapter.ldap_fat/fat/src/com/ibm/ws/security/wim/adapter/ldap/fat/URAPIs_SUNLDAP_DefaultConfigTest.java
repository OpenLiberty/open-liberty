...
@Mode(TestMode.FULL)
public class URAPIs_SUNLDAP_DefaultConfigTest {
    private static LibertyServer server = LibertyServerFactory.getLibertyServer("com.ibm.ws.security.wim.adapter.ldap.fat.sun.default");
    private static final Class<?> c = URAPIs_SUNLDAP_DefaultConfigTest.class;
    ...
    public void getGroupDisplayNameWithInvalidGroup() throws Exception {
        ...
        try {
            ...
            String errorMessage = e.getMessage();
            assertTrue("An invalid group should cause EntryNotFoundException error CWIML4527E. Message was: "
                       + errorMessage, errorMessage.contains("CWIML4527E"));
        }
    }
    ...
    public void getGroupDisplayNameWithEntityOutOfRealmScope() throws Exception {
        ...
        try {
            ...
            String errorMessage = e.getMessage();
            assertTrue("An invalid group should cause RegistryException error CWIML0515E. Message was: "
    ...
    public void getUniqueGroupIdWithInvalidGroup() throws Exception {
        ...
        try {
            ...
            String errorMessage = e.getMessage();
            assertTrue("An invalid group should cause EntryNotFoundException error CWIML4001E. Message was: "
                       + errorMessage, errorMessage.contains("CWIML4001E"));
        }
    }
    ...
    public void getGroupSecurityNameWithEntityOutOfRealmScope() throws Exception {
        ...
        try {
            ...
            String errorMessage = e.getMessage();
            assertTrue("An invalid group should cause EntryNotFoundException error CWIML0515E. Message was: "
                       + errorMessage, errorMessage.contains("CWIML0515E"));
        }
    }
