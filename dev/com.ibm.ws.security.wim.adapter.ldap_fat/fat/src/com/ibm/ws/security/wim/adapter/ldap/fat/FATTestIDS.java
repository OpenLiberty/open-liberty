...
@Mode(TestMode.LITE)
public class FATTestIDS {
    private static LibertyServer server = LibertyServerFactory.getLibertyServer("com.ibm.ws.security.registry.ldap.fat.ids");
    private static final Class<?> c = FATTestIDS.class;
    ...
    public static void setUp() throws Exception {
        ...
        ldapServer = PopulateDefaultLdapConfig.setupLdapServerTDS(ldapServer, c.getSimpleName());
    ...
    private static void updateLibertyServer() throws Exception {
        ...
        for (LdapRegistry ldap : serverConfig.getLdapRegistries()) {
            if (ldap.getId().equals("LDAP")) { // from "com.ibm.ws.security.registry.ldap.fat.ids"
                ...
                LdapFilters ids = ldap.getIdsFilters();
                ldap.setCustomFilters(ids);
                ldap.setIdsFilters(null);
            }
        }
     ...
     */
    @Test
    public void getUserDisplayNameWithValidUser2() throws Exception {
        String user = "cn=vmmtestuser,o=ibm,c=us";
        Log.info(c, "getUserDisplayNameWithValidUser2", "Checking with a valid user.");
        assertEquals("vmmtestuser", servlet.getUserDisplayName(user));
    }
    ...
    public void getUserSecurityNameWithValidUser() throws Exception {
        ...
        String userSecurityName = "cn=vmmtestuser,o=ibm,c=us";
