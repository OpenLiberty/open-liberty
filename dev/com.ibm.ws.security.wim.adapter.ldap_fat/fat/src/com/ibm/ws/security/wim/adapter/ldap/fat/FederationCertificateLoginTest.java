...
@Mode(TestMode.LITE)
public class FederationCertificateLoginTest {
    private static LibertyServer myServer = LibertyServerFactory.getLibertyServer("com.ibm.ws.security.wim.adapter.ldap.fat.tds.fedcertlogin");
    private static final Class<?> c = FederationCertificateLoginTest.class;
    ...
    protected final static String EXACT_DN_SERVER_XML = "fedclientCertExactDN.xml";
    protected final static String DEFAULT_CONFIG_FILE = "fedclientcert.server.xml";
    protected final static String INVALID_FILTER_SERVER_XML = "fedclientCertInvalidFilter.xml";
    protected final static String COMPLEX_FILTERS_SERVER_XML = "fedclientCertComplexFilter.xml";
    protected final static String NON_MATCHING_FILTER_SERVER_XML = "fedclientCertNonMatchingFilter.xml";
     ...
     */
    @Test
    @AllowedFFDC(value = { "com.ibm.ws.security.registry.EntryNotFoundException" })
