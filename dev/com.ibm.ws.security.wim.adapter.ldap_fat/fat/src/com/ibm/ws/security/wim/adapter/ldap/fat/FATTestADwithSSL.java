...
@Ignore("Currently, this server does not support SSL so we are only testing with IDS")
@RunWith(FATRunner.class)
@Mode(TestMode.FULL)
public class FATTestADwithSSL {
    private static LibertyServer server = LibertyServerFactory.getLibertyServer("com.ibm.ws.security.registry.ldap.fat.ad.ssl");
    ...
    public void getGroupDisplayNameWithValidGroup() throws Exception {
        ...
        assertEquals("null", servlet.getGroupDisplayName(group));
    }
    ...
    public void getUniqueGroupIdWithValidGroup() throws Exception {
        ...
        assertEquals(uniqueGroupId, servlet.getUniqueGroupId(group));
    }
    ...
    public void getGroupSecurityNameWithValidGroup() throws Exception {
        ...
        assertEquals(uniqueGroupId, servlet.getGroupSecurityName(group));
    }
