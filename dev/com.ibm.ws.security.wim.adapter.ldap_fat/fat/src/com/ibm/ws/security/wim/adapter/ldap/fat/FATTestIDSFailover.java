...
@Mode(TestMode.FULL)
public class FATTestIDSFailover {
    private static LibertyServer server = LibertyServerFactory.getLibertyServer("com.ibm.ws.security.registry.ldap.fat.ids.failover");
    private static final Class<?> c = FATTestIDSFailover.class;
