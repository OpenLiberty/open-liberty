...
@JSFFaceletTag(
        ...
        bodyContent = "empty",
        componentClass="jakarta.faces.component.UISelectItemGroup")
public class SelectItemGroupHandler extends ComponentHandler
{

    public SelectItemGroupHandler(ComponentConfig config)
    {
        super(config);
    }
