 ...
 */
final class ReferenceStream extends com.ibm.ws.sib.msgstore.ReferenceStream {
     ...
     * 
     */
    public ReferenceStream(int lowByte, int highByte, int lowCount, int highCount) {
        super();
        HWM_BYTE = highByte;
        LWM_BYTE = lowByte;
        HWM_COUNT = highCount;
    ...
    private final void _emptyAuto() throws MessageStoreException {
        ...
        LockingCursor cursor = newLockingCursor(null);
    ...
    /* (non-Javadoc)
     * @see com.ibm.ws.sib.msgstore.ReferenceStream#eventWatermarkBreached()
     */
    ...
    /* (non-Javadoc)
     * @see com.ibm.ws.sib.msgstore.ReferenceStream#getByteHighWaterMark()
     */
    ...
    /* (non-Javadoc)
     * @see com.ibm.ws.sib.msgstore.ReferenceStream#getByteLowWaterMark()
     */
    ...
    /* (non-Javadoc)
     * @see com.ibm.ws.sib.msgstore.ReferenceStream#getCountHighWaterMark()
     */
    ...
    /* (non-Javadoc)
     * @see com.ibm.ws.sib.msgstore.ReferenceStream#getCountLowWaterMark()
     */
