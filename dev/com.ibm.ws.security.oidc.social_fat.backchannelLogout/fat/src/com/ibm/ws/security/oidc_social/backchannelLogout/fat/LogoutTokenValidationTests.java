...
public class LogoutTokenValidationTests extends BackChannelLogoutCommonTests {
    ...
    public void LogoutTokenValidationTests_invalid_sub_omit_sid() throws Exception {
        ...
        expectations = validationTools.addMessageExpectation(clientServer, expectations, Constants.INVOKE_BACK_CHANNEL_LOGOUT_ENDPOINT, Constants.MESSAGES_LOG, Constants.STRING_CONTAINS, "Message log did not contain message indicating that a recent session for the subject couldn't be found.", MessageConstants.CWWKS1552E_NO_RECENT_SESSIONS_WITH_CLAIMS);
