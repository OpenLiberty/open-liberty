...
public class HttpMethodsTests extends BackChannelLogoutCommonTests {
    ...
    public void HttpMethodsTests_Valid_Http_Method() throws Exception {
        ...
        // TODO - once the backchannel endpoint is fully implemented, we may receive additional error messages and a non-200 status code
        ...
        //        expectations400 = validationTools.addMessageExpectation(clientServer, expectations400, Constants.INVOKE_BACK_CHANNEL_LOGOUT_ENDPOINT, Constants.MESSAGES_LOG, Constants.STRING_CONTAINS, "Message log did not contain message indicating that the logout_token was invalid.", MessageConstants.CWWKS1541E_BACK_CHANNEL_LOGOUT_ERROR);
        ...
        // TODO - 400, 501 or 200? POST is valid - if we get a 400, it means that the endpoint passed the http method check and was trying to actually process the logout_token
        genericInvokeEndpoint(_testName, webClient, null, logutOutEndpoint,
