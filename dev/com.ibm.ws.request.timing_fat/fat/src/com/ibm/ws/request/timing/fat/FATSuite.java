...
public class FATSuite {
    // Using the RepeatTests @ClassRule in FATSuite will cause all tests in the FAT to be run multiple times.
    // First without any modifications, then again with all features in all server.xml's upgraded to their EE8/EE9/EE10/EE11 equivalents.
