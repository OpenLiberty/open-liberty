...
public class FeatureResolverTest {
    ...
    static boolean returnAutoFeatures = false;

    static final FeatureResolver resolver = new FeatureResolverImpl();
    static final Collection<ProvisioningFeatureDefinition> noKernelFeatures = Collections.emptySet();
