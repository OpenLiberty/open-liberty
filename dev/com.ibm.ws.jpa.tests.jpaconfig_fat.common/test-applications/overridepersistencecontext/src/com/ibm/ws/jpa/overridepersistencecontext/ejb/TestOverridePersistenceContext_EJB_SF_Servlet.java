...
@WebServlet(urlPatterns = "/TestOverridePersistenceContext_EJB_SF_Servlet")
public class TestOverridePersistenceContext_EJB_SF_Servlet extends EJBDBTestVehicleServlet {

    @PostConstruct
    private void initFAT() {
        testClassName = OverridePersistenceContextLogic.class.getName();
        ejbJNDIName = "ejb/OverridePersistenceContextSFEJB";
    ...
    @Test
    public void jpa_jpaconfig_testOverridePersistenceContext_EJB_SF_AMJTA_Web() throws Exception {
        final String testName = "jpa_jpaconfig_testOverridePersistenceContext_EJB_SF_AMJTA_Web";
    ...
    @Test
    public void jpa_jpaconfig_testOverridePersistenceContext_EJB_SF_AMRL_Web() throws Exception {
        final String testName = "jpa_jpaconfig_testOverridePersistenceContext_EJB_SF_AMRL_Web";
        final String testMethod = "testOverridePersistenceContext";
    ...
    @Test
    public void jpa_jpaconfig_testOverridePersistenceContext_EJB_SF_CMTS_Web() throws Exception {
        final String testName = "jpa_jpaconfig_testOverridePersistenceContext_EJB_SF_CMTS_Web";
        final String testMethod = "testOverridePersistenceContext";
