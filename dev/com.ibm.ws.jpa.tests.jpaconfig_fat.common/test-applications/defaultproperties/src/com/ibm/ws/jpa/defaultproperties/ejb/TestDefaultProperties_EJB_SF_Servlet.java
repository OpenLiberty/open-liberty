...
@WebServlet(urlPatterns = "/TestDefaultProperties_EJB_SF_Servlet")
public class TestDefaultProperties_EJB_SF_Servlet extends EJBDBTestVehicleServlet {

    @PostConstruct
    private void initFAT() {
        testClassName = DefaultPropertiesLogic.class.getName();
        ejbJNDIName = "ejb/DefaultPropertiesSFEJB";
    ...
    @Test
    public void jpa_jpaconfig_testDefaultProperties_EJB_SF_AMJTA_Web() throws Exception {
        final String testName = "jpa_jpaconfig_testDefaultProperties_EJB_SF_AMJTA_Web";
    ...
    @Test
    public void jpa_jpaconfig_testDefaultProperties_EJB_SF_AMRL_Web() throws Exception {
        final String testName = "jpa_jpaconfig_testDefaultProperties_EJB_SF_AMRL_Web";
        final String testMethod = "testDefaultProperties";
    ...
    @Test
    public void jpa_jpaconfig_testDefaultProperties_EJB_SF_CMTS_Web() throws Exception {
        final String testName = "jpa_jpaconfig_testDefaultProperties_EJB_SF_CMTS_Web";
        final String testMethod = "testDefaultProperties";
