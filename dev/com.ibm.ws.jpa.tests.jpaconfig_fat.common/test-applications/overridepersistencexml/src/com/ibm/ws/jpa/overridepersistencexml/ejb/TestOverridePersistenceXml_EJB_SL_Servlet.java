...
@WebServlet(urlPatterns = "/TestOverridePersistenceXml_EJB_SL_Servlet")
public class TestOverridePersistenceXml_EJB_SL_Servlet extends EJBDBTestVehicleServlet {

    @PostConstruct
    private void initFAT() {
        testClassName = OverridePersistenceXmlLogic.class.getName();
        ejbJNDIName = "ejb/OverridePersistenceXmlSLEJB";
    ...
    @Test
    public void jpa_jpaconfig_testOverridePersistenceXml_EJB_SL_AMJTA_Web() throws Exception {
        final String testName = "jpa_jpaconfig_testOverridePersistenceXml_EJB_SL_AMJTA_Web";
    ...
    @Test
    public void jpa_jpaconfig_testOverridePersistenceXml_EJB_SL_AMRL_Web() throws Exception {
        final String testName = "jpa_jpaconfig_testOverridePersistenceXml_EJB_SL_AMRL_Web";
        final String testMethod = "testOverridePersistenceXml";
    ...
    @Test
    public void jpa_jpaconfig_testOverridePersistenceXml_EJB_SL_CMTS_Web() throws Exception {
        final String testName = "jpa_jpaconfig_testOverridePersistenceXml_EJB_SL_CMTS_Web";
        final String testMethod = "testOverridePersistenceXml";
