...
/**
 * Servlet implementation class ECDHCxfCallerSvcClient
 */
//@WebServlet("/ECDHCxfCallerSvcClient")
public class ECDHCxfCallerSvcClient extends HttpServlet {
    ...
    protected void doWorker(HttpServletRequest request,
        ...
        System.out.println("ECDHCxfCallerSvcClient: wsdl:" + wsdlLocation);
 ...
 */
        ...
        try {
            ...
            if (thisMethod.equals("testCxfBasic128GCMSha256ECDHESWithUserNameToken")) {
                service = new FatBAC01Service(wsdlURL, serviceName);
                strExpect = "Liberty Fat Caller bac01(" + untID + ")";
            } else if (thisMethod.equals("testCxfBasic128GCMSha256ECDHESWithSupportingUNT")) {
                service = new FatBAC02Service(wsdlURL, serviceName);
                strExpect = "Liberty Fat Caller bac02(" + untID + ")";
            } else if (thisMethod.equals("testCxfBasic192GCMSha256ECDHESWithUserNameToken")) {
                service = new FatBAC03Service(wsdlURL, serviceName);
                strExpect = "Liberty Fat Caller bac03(" + untID + ")";
            } else if (thisMethod.equals("testCxfBasic192GCMSha256ECDHESWithSupportingUNT")) {
                service = new FatBAC04Service(wsdlURL, serviceName);
                strExpect = "Liberty Fat Caller bac04(" + untID + ")";
                strSubErrMsg = "BSP:R5620: Any ED_ENCRYPTION_METHOD Algorithm attribute MUST have a value of";
            } else if (thisMethod.equals("testCxfBasic256GCMSha256ECDHESWithUserNameToken")) {
                service = new FatBAC05Service(wsdlURL, serviceName);
                strExpect = "Liberty Fat Caller bac05(" + untID + ")";
            } else if (thisMethod.equals("testCxfBasic256GCMSha256ECDHESWithSupportingUNT")) {
    ...
    void printExpectingResult(HttpServletResponse response, String answer, String strExpect) throws IOException {
        ...
        System.out.println("@TJJ the answer was: " + answer);
    ...
    void printExpectingException(HttpServletResponse response, Exception ex, String strSubErrMsg) throws IOException {
        ...
        System.out.println("@TJJ the exception message was: " + strMsg);
        System.out.println("@TJJ the strSubErrMsg message is: " + strSubErrMsg);
        if (strMsg == null)
            strMsg = "";
