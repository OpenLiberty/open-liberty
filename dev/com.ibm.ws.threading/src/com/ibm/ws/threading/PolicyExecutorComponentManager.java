 ...
 *
 */
public class PolicyExecutorComponentManager implements StaticComponentManager {
    ...
    public ReturnValue bind(Object instance, String name, Parameters parameters) {
        if ("setGlobalExecutor".equals(name)) {
            Object[] params = parameters.getParameters(ExecutorService.class);
            ((PolicyExecutorProvider) instance).setGlobalExecutor((ExecutorService) params[0]);
        }
        return ReturnValue.VOID;
    }
