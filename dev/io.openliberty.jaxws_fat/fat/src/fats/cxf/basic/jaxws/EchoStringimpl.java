 ...
 *
 */
@WebService(serviceName = "EchoStringService", portName = "EchoStringPort", targetNamespace = "http://jaxws.basic.cxf.fats/")
public class EchoStringimpl implements EchoString {
