...
import fat.cxf.basic.jaxws.annotations.bindingtype.checkdefaults.server11.AddNumbersImpl;
import fat.cxf.basic.jaxws.annotations.bindingtype.checkdefaults.server11.AddNumbersImplService;

/**
 * Copied from tWAS based com.ibm.ws.jaxws_fat annotations/bindingtype/checkdefaults/** bucket
 *
 * A Simple client that calls the AddNumbersImpl which is a SOAP 1.1 Service for adding two passed numbers together
 */
