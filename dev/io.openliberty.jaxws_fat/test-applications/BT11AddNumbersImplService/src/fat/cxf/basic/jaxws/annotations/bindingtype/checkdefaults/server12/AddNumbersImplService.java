 ...
 *
 */
@WebServiceClient(name = "AddNumbersImplService", targetNamespace = "http://server12.checkdefaults.bindingtype.annotations.jaxws.basic.cxf.fat/",
                  wsdlLocation = "WEB-INF/wsdl/AddNumbersImplService12.wsdl")
public class AddNumbersImplService extends Service {

    private final static QName ADDNUMBERSIMPLSERVICE_QNAME = new QName("http://server12.checkdefaults.bindingtype.annotations.jaxws.basic.cxf.fat/", "AddNumbersImplService");
    ...
    public AddNumbersImpl getAddNumbersImplPort() {
        return super.getPort(new QName("http://server12.checkdefaults.bindingtype.annotations.jaxws.basic.cxf.fat/", "AddNumbersImplPort"),
    ...
    public AddNumbersImpl getAddNumbersImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server12.checkdefaults.bindingtype.annotations.jaxws.basic.cxf.fat/", "AddNumbersImplPort"), AddNumbersImpl.class, features);
    }
