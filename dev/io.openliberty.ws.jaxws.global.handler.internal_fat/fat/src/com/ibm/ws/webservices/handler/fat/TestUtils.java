...
public class TestUtils {
     ...
     * @throws Exception
     */
    public static void publishFileToServer(LibertyServer server, String srcPathFromPubishFolder, String srcFileName, String targetPathFromServerRoot, String targetFileName) throws Exception {
    ...
    public static String getBaseTestUri(String contextRoot) {
        if (contextRoot == null) {
            System.out.println("getBaseTestUri(contextRoot) returning empty string");
            return "";
        }
