...
public class ConcurrencyAppTests20 extends ConcurrencyAppAbstractTests {
    ...
    public Set<String> getFeatures() {
        return new HashSet<>(Arrays.asList("springBoot-2.0", "servlet-4.0", "concurrent-1.0", "jndi-1.0", "jca-1.7"));
    }
