CREATE TABLE ${schemaname}.EmbIDManyXManyEntA (id INTEGER NOT NULL, password VARCHAR(254), userName VARCHAR(254), PRIMARY KEY (id));
CREATE TABLE ${schemaname}.EmbIDManyXManyEntB (country VARCHAR(254) NOT NULL, id INTEGER NOT NULL, name VARCHAR(254), salary INTEGER, PRIMARY KEY (country, id));
CREATE TABLE ${schemaname}.EmbManyXManyJoinTable (EMBEDIDMMENTITYA_ID INTEGER, identity_id INTEGER, identity_country VARCHAR(254));
CREATE TABLE ${schemaname}.IDClassMMEntA_IDClassMMEntB (IDCLASSMMENTITYA_ID INTEGER, identity_id INTEGER, identity_country VARCHAR(254));
CREATE TABLE ${schemaname}.IDClassMMEntityA (id INTEGER NOT NULL, password VARCHAR(254), userName VARCHAR(254), PRIMARY KEY (id));
CREATE TABLE ${schemaname}.IDClassMMEntityB (country VARCHAR(254) NOT NULL, id INTEGER NOT NULL, name VARCHAR(254), salary INTEGER, PRIMARY KEY (country, id));
...
CREATE TABLE ${schemaname}.MMBiEntA (id INTEGER NOT NULL, name VARCHAR(254), PRIMARY KEY (id));
...
CREATE TABLE ${schemaname}.MMBiEntB_CA (id INTEGER NOT NULL, name VARCHAR(254), PRIMARY KEY (id));
CREATE TABLE ${schemaname}.MMBiEntB_CM (id INTEGER NOT NULL, name VARCHAR(254), PRIMARY KEY (id));
CREATE TABLE ${schemaname}.MMBiEntB_CP (id INTEGER NOT NULL, name VARCHAR(254), PRIMARY KEY (id));
CREATE TABLE ${schemaname}.MMBiEntB_CRF (id INTEGER NOT NULL, name VARCHAR(254), PRIMARY KEY (id));
CREATE TABLE ${schemaname}.MMBiEntB_CRM (id INTEGER NOT NULL, name VARCHAR(254), PRIMARY KEY (id));
CREATE TABLE ${schemaname}.MMBiEntB_DR (id INTEGER NOT NULL, name VARCHAR(254), PRIMARY KEY (id));
CREATE TABLE ${schemaname}.MMContainerTypeEntityA (id INTEGER NOT NULL, name VARCHAR(254), PRIMARY KEY (id));
CREATE TABLE ${schemaname}.MMContainerTypeEntityB (id INTEGER NOT NULL, name VARCHAR(254), PRIMARY KEY (id));
...
CREATE TABLE ${schemaname}.MMUniEntA (id INTEGER NOT NULL, name VARCHAR(254), PRIMARY KEY (id));
...
CREATE TABLE ${schemaname}.MMUniEntB_CA (id INTEGER NOT NULL, name VARCHAR(254), PRIMARY KEY (id));
CREATE TABLE ${schemaname}.MMUniEntB_CM (id INTEGER NOT NULL, name VARCHAR(254), PRIMARY KEY (id));
CREATE TABLE ${schemaname}.MMUniEntB_CP (id INTEGER NOT NULL, name VARCHAR(254), PRIMARY KEY (id));
CREATE TABLE ${schemaname}.MMUniEntB_CRF (id INTEGER NOT NULL, name VARCHAR(254), PRIMARY KEY (id));
CREATE TABLE ${schemaname}.MMUniEntB_CRM (id INTEGER NOT NULL, name VARCHAR(254), PRIMARY KEY (id));
CREATE TABLE ${schemaname}.MMUniEntB_DR (id INTEGER NOT NULL, name VARCHAR(254), PRIMARY KEY (id));
CREATE TABLE ${schemaname}.XMLEmbIDManyXManyEntA (id INTEGER NOT NULL, password VARCHAR(254), userName VARCHAR(254), PRIMARY KEY (id));
CREATE TABLE ${schemaname}.XMLEmbIDManyXManyEntB (country VARCHAR(254) NOT NULL, id INTEGER NOT NULL, name VARCHAR(254), salary INTEGER, PRIMARY KEY (country, id));
CREATE TABLE ${schemaname}.XMLEmbManyXManyJoinTable (XMLEMBEDIDMMENTITYA_ID INTEGER, identity_id INTEGER, identity_country VARCHAR(254));
CREATE TABLE ${schemaname}.XMLIDClassMMEntA_IDClassMMEntB (XMLIDCLASSMMENTITYA_ID INTEGER, identity_id INTEGER, identity_country VARCHAR(254));
CREATE TABLE ${schemaname}.XMLIDClassMMEntityA (id INTEGER NOT NULL, password VARCHAR(254), userName VARCHAR(254), PRIMARY KEY (id));
CREATE TABLE ${schemaname}.XMLIDClassMMEntityB (country VARCHAR(254) NOT NULL, id INTEGER NOT NULL, name VARCHAR(254), salary INTEGER, PRIMARY KEY (country, id));
...
CREATE TABLE ${schemaname}.XMLMMBiEntA (id INTEGER NOT NULL, name VARCHAR(254), PRIMARY KEY (id));
...
CREATE TABLE ${schemaname}.XMLMMBiEntB_CA (id INTEGER NOT NULL, name VARCHAR(254), PRIMARY KEY (id));
CREATE TABLE ${schemaname}.XMLMMBiEntB_CM (id INTEGER NOT NULL, name VARCHAR(254), PRIMARY KEY (id));
CREATE TABLE ${schemaname}.XMLMMBiEntB_CP (id INTEGER NOT NULL, name VARCHAR(254), PRIMARY KEY (id));
CREATE TABLE ${schemaname}.XMLMMBiEntB_CRF (id INTEGER NOT NULL, name VARCHAR(254), PRIMARY KEY (id));
CREATE TABLE ${schemaname}.XMLMMBiEntB_CRM (id INTEGER NOT NULL, name VARCHAR(254), PRIMARY KEY (id));
CREATE TABLE ${schemaname}.XMLMMBiEntB_DR (id INTEGER NOT NULL, name VARCHAR(254), PRIMARY KEY (id));
CREATE TABLE ${schemaname}.XMLMMContainerTypeEntityA (id INTEGER NOT NULL, name VARCHAR(254), PRIMARY KEY (id));
CREATE TABLE ${schemaname}.XMLMMContainerTypeEntityB (id INTEGER NOT NULL, name VARCHAR(254), PRIMARY KEY (id));
...
CREATE TABLE ${schemaname}.XMLMMUniEntA (id INTEGER NOT NULL, name VARCHAR(254), PRIMARY KEY (id));
...
CREATE TABLE ${schemaname}.XMLMMUniEntB_CA (id INTEGER NOT NULL, name VARCHAR(254), PRIMARY KEY (id));
CREATE TABLE ${schemaname}.XMLMMUniEntB_CM (id INTEGER NOT NULL, name VARCHAR(254), PRIMARY KEY (id));
CREATE TABLE ${schemaname}.XMLMMUniEntB_CP (id INTEGER NOT NULL, name VARCHAR(254), PRIMARY KEY (id));
CREATE TABLE ${schemaname}.XMLMMUniEntB_CRF (id INTEGER NOT NULL, name VARCHAR(254), PRIMARY KEY (id));
CREATE TABLE ${schemaname}.XMLMMUniEntB_CRM (id INTEGER NOT NULL, name VARCHAR(254), PRIMARY KEY (id));
CREATE TABLE ${schemaname}.XMLMMUniEntB_DR (id INTEGER NOT NULL, name VARCHAR(254), PRIMARY KEY (id));
