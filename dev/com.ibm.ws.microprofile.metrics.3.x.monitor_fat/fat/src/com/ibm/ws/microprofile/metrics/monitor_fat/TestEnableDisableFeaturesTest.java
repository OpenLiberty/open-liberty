...
public class TestEnableDisableFeaturesTest {
    ...
    private static void add3Apps(LibertyServer server) throws Exception {
        ...
        ShrinkHelper.defaultDropinApp(server, "testJaxWsApp", "com.ibm.ws.microprofile.metrics.monitor_fat.jaxws",
                "com.ibm.ws.microprofile.metrics.monitor_fat.jaxws.client");
    ...
    public void testEDF2() throws Exception {
        ...
        Log.info(c, testName,
                "------- Enable " + metricFeature + " and monitor-1.0: threadpool metrics should be available ------");
    ...
    public void testEDF3() throws Exception {
        ...
        checkStrings(getHttpsServlet("/metrics/vendor", serverEDF3),
                new String[] { "vendor_session_create_total{appname=\"default_host_testSessionApp\"}",
    ...
    public void testEDF5() throws Exception {
        ...
        ShrinkHelper.defaultDropinApp(serverEDF5, "testJaxWsApp", "com.ibm.ws.microprofile.metrics.monitor_fat.jaxws",
                "com.ibm.ws.microprofile.metrics.monitor_fat.jaxws.client");
        Log.info(c, testName, "------- added testJaxWsApp to dropins -----");
    ...
    public void testEDF10() throws Exception {
        ...
        checkStrings(getHttpsServlet("/metrics/vendor", serverEDF10), new String[] { "vendor_" },
