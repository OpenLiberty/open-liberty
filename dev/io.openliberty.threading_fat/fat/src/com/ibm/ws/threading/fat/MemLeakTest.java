...
public class MemLeakTest {
    ...
    public void testScheduleClose() throws Exception {
        final String method = "testScheduleClose";
        Log.entering(c, method);
        assertNotNull("Expected message indicating the test passed on the server was not found.",
                      server.waitForStringInLog("runScheduleCloseTest PASSED"));
    }
}
