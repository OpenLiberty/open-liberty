...
@WebServlet("/ObsFoldEchoServlet")
public class ObsFoldEchoServlet extends HttpServlet {
    ...
    private void writeResponse(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        writer.println("ObsFoldEchoServlet");
        writer.println("query=" + request.getQueryString());
        writer.flush();
    }
}
