...
public interface WebSecurityValidator {
    boolean checkDataConstraints(String contextId, Object req, WebUserDataPermission webUDPermission, PolicyProxy policyProxy);

    boolean checkResourceConstraints(String contextId, Object req, Permission webPerm, Subject subject, PolicyProxy policyProxy);
