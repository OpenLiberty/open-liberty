...
public interface NavigableExpression<T, U> {
    ...
    default <V extends Temporal & Comparable<? extends Temporal>> //
                    ...
                    navigate(@Nonnull TemporalAttribute<U, V> attribute) {
