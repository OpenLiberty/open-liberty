...
public class JASPIFormLoginJACCAuthorizationAuditTest extends JASPITestBase {
     ...
     */
    @ClassRule
    public static RepeatTests auditRepeat = RepeatTests.with(new FeatureReplacementAction("audit-2.0", "audit-1.0").forServers("com.ibm.ws.security.jaspic11.fat.jacc.audit").fullFATOnly())
                    .andWith(new FeatureReplacementAction("audit-1.0", "audit-2.0").forServers("com.ibm.ws.security.jaspic11.fat.jacc.audit"));
