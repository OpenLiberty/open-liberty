...
@WebServiceProvider(targetNamespace="http://caller.libertyfat.test/contract",
                    serviceName="FatSamlC08Service", portName="SamlCallerToken08",
...
/**
 */
public class SAMLCaller_bac08 implements javax.xml.ws.Provider<SOAPMessage> {
    ...
    public SOAPMessage invoke(SOAPMessage request) {
        ...
        String respMsg = new String(
                               ...
                               "<SOAP-ENV:Body><provider><message>Liberty Fat SAMLCaller bac08(" + PrincipalUserID + 
