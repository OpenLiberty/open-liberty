...
@WebServiceProvider(targetNamespace="http://caller.libertyfat.test/contract",
                    serviceName="FatSamlC03Service", portName="SamlCallerToken03",
...
/**
 */
public class SAMLCaller_bac03 implements javax.xml.ws.Provider<SOAPMessage> {
    ...
    public SOAPMessage invoke(SOAPMessage request) {
        ...
        String respMsg = new String(
                               ...
                               "<SOAP-ENV:Body xmlns=\"http://wssec.basic.cxf.fats/types\"><provider><message>Liberty Fat SAMLCaller bac03(" + PrincipalUserID + 
