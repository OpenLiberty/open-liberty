...
/**
 * Servlet implementation class CxfWssSAMLTemplatesSvcClient
 */
//@WebServlet("/CxfWssSAMLTemplatesSvcClient")
public class CxfWssSAMLTemplatesSvcClient extends HttpServlet {
     ...
     */
    public CxfWssSAMLTemplatesSvcClient() {
        super();
    }
    ...
    protected void doWorker(HttpServletRequest request,
        ...
        try {
            ...
            clientWsdl = request.getParameter("clntWsdlLocation") ;
            if (clientWsdl != null ) {
                clientWsdl = clientWsdl.trim();
            }
            ...
            if (httpSecurePortNum == null || httpSecurePortNum.equals("")) {
                thePort = httpPortNum;
                theType = "http";
            } else {
 ...
 */
        ...
        wsdlLocation = theType + "://localhost:" + thePort + "/samlwsstemplates/"
                        + rawServiceName + "?wsdl";
        if (clientWsdl != null && !clientWsdl.equals("")) {
        ...
        try {
            ...
            if (msgId != null && msgId.equals("someFutureSpecificMsg")) {
            ...
            String endPtUrl = theType + "://localhost:" + thePort + "/samlwsstemplates/" + rawServiceName ;
            System.out.println("endPtUrl: " + endPtUrl);
