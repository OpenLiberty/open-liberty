...
public class BasicUnsolicitedSPInitiatedTests extends BasicSAMLTests {

    private static final Class<?> thisClass = BasicUnsolicitedSPInitiatedTests.class;
    ...
    public static void setupBeforeTest() throws Exception {
        ...
        startSPWithIDPServer("com.ibm.ws.security.saml.sso-2.0_fat", "server_1_unsolicited.xml", extraMsgs, extraApps, true);
