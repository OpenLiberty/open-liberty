...
import com.ibm.ws.microprofile.config14.configAccessor.cacheFor.web.CacheForServlet;
...
public class CacheForTest extends FATServletClient {

    public static final String APP_NAME = "configAccessorCacheForApp";
    ...
    @Server(SERVER_NAME)
    @TestServlet(servlet = CacheForServlet.class, contextRoot = APP_NAME)
    ...
    public static void setUp() throws Exception {
        ...
        WebArchive war = ShrinkWrap.create(WebArchive.class, APP_NAME + ".war")
                        .addPackages(true, "com.ibm.ws.microprofile.config14.configAccessor")
