...
@Stateful(name = "EarLibLevelJTADPUMethodInjectionSFEJB")
@Local(EarLibLevelJTADPUMethodInjectionSFEJBLocal.class)
@TransactionManagement(javax.ejb.TransactionManagementType.BEAN)
public class EarLibLevelJTADPUMethodInjectionSFEJB extends BMTEJBTestVehicle {
