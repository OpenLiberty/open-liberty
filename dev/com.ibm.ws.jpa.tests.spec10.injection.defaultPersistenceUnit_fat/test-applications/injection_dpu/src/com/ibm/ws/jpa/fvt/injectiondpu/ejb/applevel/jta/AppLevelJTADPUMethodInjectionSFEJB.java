...
@Stateful(name = "AppLevelJTADPUMethodInjectionSFEJB")
@Local(AppLevelJTADPUMethodInjectionSFEJBLocal.class)
@TransactionManagement(javax.ejb.TransactionManagementType.BEAN)
public class AppLevelJTADPUMethodInjectionSFEJB extends BMTEJBTestVehicle {
