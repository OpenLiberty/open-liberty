...
@Stateful(name = "EarLibLevelRLDPUMethodInjectionSFEJB")
@Local(EarLibLevelRLDPUMethodInjectionSFEJBLocal.class)
@TransactionManagement(javax.ejb.TransactionManagementType.BEAN)
public class EarLibLevelRLDPUMethodInjectionSFEJB extends BMTEJBTestVehicle {
