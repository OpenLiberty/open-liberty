...
@Stateless(name = "AppLevelRLDPUMethodInjectionSLEJB")
@Local(AppLevelRLDPUMethodInjectionSLEJBLocal.class)
@TransactionManagement(javax.ejb.TransactionManagementType.BEAN)
public class AppLevelRLDPUMethodInjectionSLEJB extends BMTEJBTestVehicle {
