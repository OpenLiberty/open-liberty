...
public class SpnegoTokenHelper {
    ...
    private static Subject doKerberosLogin(String jaasLoginContextEntry, final String upn, @Sensitive final String password) throws LoginException {
        if (Krb5Common.IBM_KRB5_LOGIN_MODULE_AVAILABLE)
            return doIBMKerberosLogin(jaasLoginContextEntry, upn, password);
        else if (Krb5Common.OTHER_KRB5_LOGIN_MODULE_AVAILABLE)
            return doOtherKerberosLogin(jaasLoginContextEntry, upn, password);
        else
            return null;
    }
     ...
     */
    private static Subject doIBMKerberosLogin(String jaasLoginContextEntry, final String upn, @Sensitive final String password) throws LoginException {
    ...
    static Subject doOtherKerberosLogin(String jaasLoginContextEntry, final String upn, @Sensitive final String password) throws LoginException {
