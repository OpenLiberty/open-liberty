...
public class TestJaxWsTransportSecurityServlet extends HttpServlet {
    ...
    private String createMessage(String userName) {
        StringBuilder sBuilder = new StringBuilder("<soap:Envelope xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\">").append("<soap:Body>").append("<ns2:sayHello xmlns:ns2=\"http://ibm.com/ws/jaxws/transport/security/\">").append("<arg0>").append(userName).append("</arg0>").append("</ns2:sayHello>").append("</soap:Body>").append("</soap:Envelope>");
