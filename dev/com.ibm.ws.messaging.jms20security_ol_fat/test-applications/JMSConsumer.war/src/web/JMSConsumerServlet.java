...
public class JMSConsumerServlet extends HttpServlet {
	...
	public void testCloseConsumer_B(HttpServletRequest request,
		...
		if (!exceptionFlag)
			throw new WrongException(
					"testCloseConsumer_B failed: Expected exception was not seen");
	...
	public void testReceive_B(HttpServletRequest request,
		...
		if (exceptionFlag)
			throw new WrongException(
					"testReceive_B failed: Expected message was not received");
		jmsConsumer.close();
		jmsContext.close();
	...
	public void testReceive_TCP(HttpServletRequest request,
		...
		if (exceptionFlag)
			throw new WrongException(
					"testReceive_TCP failed: Expected message was not received");
		jmsConsumer.close();
		jmsContext.close();
	}
	...
	public void testReceiveBody_B(HttpServletRequest request,
		...
		if (exceptionFlag)
			throw new WrongException(
					"testReceiveBody_B failed: Expected message was not received");
		jmsConsumer.close();
		jmsContext.close();
	...
	public void testReceiveBody_TCP(HttpServletRequest request,
		...
		if (exceptionFlag)
			throw new WrongException(
					"testReceiveBody_TCP failed: Expected message was not received");
		jmsConsumer.close();
		jmsContext.close();
	...
	public void testReceiveBodyTimeOut_B(HttpServletRequest request,
		...
		if (exceptionFlag)
			throw new WrongException(
					"testReceiveBodyTimeOut_B failed: Expected message was not received");
		jmsConsumer.close();
		jmsContext.close();
	...
	public void testReceiveBodyTimeOut_TCP(HttpServletRequest request,
		...
		if (exceptionFlag)
			throw new WrongException(
					"testReceiveBodyTimeOut_TCP failed: Expected message was not received");
	...
	public void testReceiveBodyNoWait_B(HttpServletRequest request,
		...
		if (exceptionFlag)
			throw new WrongException(
					"testReceiveBodyNoWait_B failed: Expected message was not received");
	...
	public void testReceiveBodyNoWait_TCP(HttpServletRequest request,
		...
		if (exceptionFlag)
			throw new WrongException(
					"testReceiveBodyNoWait_TCP failed: Expected message was not received");
	...
	public void testReceiveWithTimeOut_B_SecOn(HttpServletRequest request,
		...
		if (exceptionFlag)
			throw new WrongException(
					"testReceiveWithTimeOut_B_SecOn failed: Expected message was not received on time");
	...
	public void testReceiveWithTimeOut_TcpIp_SecOn(HttpServletRequest request,
		...
		if (exceptionFlag)
			throw new WrongException(
					"testReceiveWithTimeOut_TcpIp_SecOn failed: Expected message was not received on time");
	...
	public void testReceiveNoWait_B_SecOn(HttpServletRequest request,
		...
		if (exceptionFlag)
			throw new WrongException(
					"testReceiveNoWait_B_SecOn failed: Expected message was not received");
	...
	public void testReceiveNoWait_TcpIp_SecOn(HttpServletRequest request,
		...
		if (exceptionFlag)
			throw new WrongException(
					"testReceiveNoWait_TcpIp_SecOn failed: Expected message was not received");
	...
	public void testReceiveBodyEmptyBody_B_SecOn(HttpServletRequest request,
		...
		if (!exceptionFlag)
			throw new WrongException(
					"testReceiveBodyEmptyBody_B_SecOn failed: Expected message was not received");
	}
	...
	public void testReceiveBodyEmptyBody_TcpIp_SecOn(
		...
		if (!exceptionFlag)
			throw new WrongException(
					"testReceiveBodyEmptyBody_TcpIp_SecOn failed: Expected message was not received");
	}
	...
	public void testReceiveBodyWithTimeOutUnspecifiedType_B_SecOn(
		...
		jmsConsumer = jmsContext.createConsumer(jmsQueue);
		jmsProducer = jmsContext.createProducer();
		TextMessage m = jmsContext
				.createTextMessage("testReceiveBodyWithTimeOutUnspecifiedType_B_SecOn");
		jmsProducer.send(jmsQueue, m);
		...
		try {
			...
			System.out
					.println("Expected MessageFormatRuntimeException was found in testReceiveBodyWithTimeOutUnspecifiedType_B_SecOn");
			exceptionFlag = true;
		}

		if (!exceptionFlag)
			throw new WrongException(
					"testReceiveBodyWithTimeOutUnspecifiedType_B_SecOn failed: Expected exception was not seen");
	}
	...
	public void testReceiveBodyWithTimeOutUnspecifiedType_TcpIp_SecOn(
		...
		jmsProducer = jmsContext.createProducer();
		TextMessage m = jmsContext
				.createTextMessage("testReceiveBodyWithTimeOutUnspecifiedType_TcpIp_SecOn");
		jmsProducer.send(jmsQueue, m);
		try {
			byte[] msgBody = jmsConsumer.receiveBody(byte[].class,
					DEFAULT_TIMEOUT);
		...
		if (!exceptionFlag)
			throw new WrongException(
					"testReceiveBodyWithTimeOutUnspecifiedType_TcpIp_SecOn failed: Expected exception not seen");
	}
	...
	public void testReceiveBodyNoWaitUnsupportedType_B_SecOn(
		...
		if (!exceptionFlag)
			throw new WrongException(
					"testReceiveBodyNoWaitUnsupportedType_B_SecOn failed: Expected exception not seen");
	}
	...
	public void testReceiveBodyNoWaitUnsupportedType_TcpIp_SecOn(
		...
		if (!exceptionFlag)
			throw new WrongException(
					"testReceiveBodyNoWaitUnsupportedType_TcpIp_SecOn failed: Expected exception not seen");
	}
	...
	public void testReceiveTopic_B(HttpServletRequest request,
		...
		if (exceptionFlag)
			throw new WrongException(
					"testReceiveTopic_B failed: Expected message was not received");
	}
	...
	public void testReceiveTopic_TCP(HttpServletRequest request,
		...
		if (exceptionFlag)
			throw new WrongException(
					"testReceiveTopic_TCP failed: Expected message was not received");
	...
	public void testReceiveBodyTopic_B(HttpServletRequest request,
		...
		if (exceptionFlag)
			throw new WrongException(
					"testReceiveBodyTopic_B failed: Expected message was not received");
	...
	public void testReceiveBodyTopic_TCP(HttpServletRequest request,
		...
		if (exceptionFlag)
			throw new WrongException(
					"testReceiveBodyTopic_TCP failed: Expected message was not received");
	...
	public void testReceiveBodyTimeOutTopic_B(HttpServletRequest request,
		...
		if (exceptionFlag)
			throw new WrongException(
					"testReceiveBodyTimeOutTopic_B failed: Expected message was not received");
	...
	public void testReceiveBodyTimeOutTopic_TCP(HttpServletRequest request,
		...
		if (exceptionFlag)
			throw new WrongException(
					"testReceiveBodyTimeOutTopic_TCP failed: Expected message was not received");
	...
	public void testReceiveBodyNoWaitTopic_B(HttpServletRequest request,
		...
		if (exceptionFlag)
			throw new WrongException(
					"testReceiveBodyNoWaitTopic_B failed: Expected message was not received");
	...
	public void testReceiveBodyNoWaitTopic_TCP(HttpServletRequest request,
		...
		if (exceptionFlag)
			throw new WrongException(
					"testReceiveBodyNoWaitTopic_TCP failed: Expected message was not received");
		jmsConsumer.close();
		jmsContext.close();
	...
	public void testReceiveWithTimeOutTopic_B_SecOn(HttpServletRequest request,
		...
		if (exceptionFlag)
			throw new WrongException(
					"testReceiveWithTimeOutTopic_B_SecOn failed: Expected message was not received");
	...
	public void testReceiveWithTimeOutTopic_TcpIp_SecOn(
		...
		if (exceptionFlag)
			throw new WrongException(
					"testReceiveWithTimeOutTopic_TcpIp_SecOn failed: Expected message was not received");
	...
	public void testReceiveNoWaitTopic_B_SecOn(HttpServletRequest request,
		...
		if (exceptionFlag)
			throw new WrongException(
					"testReceiveNoWaitTopic_B_SecOn failed: Expected message was not received");
	...
	public void testReceiveNoWaitTopic_TcpIp_SecOn(HttpServletRequest request,
		...
		if (exceptionFlag)
			throw new WrongException(
					"testReceiveNoWaitTopic_TcpIp_SecOn failed: Expected message was not received");
	...
	public void testReceiveBodyEmptyBodyTopic_B_SecOn(
		...
		if (!exceptionFlag)
			throw new WrongException(
					"testReceiveBodyEmptyBodyTopic_B_SecOn failed: Expected exception not seen");
	...
	public void testReceiveBodyEmptyBodyTopic_TcpIp_SecOn(
		...
		if (!exceptionFlag)
			throw new WrongException(
					"testReceiveBodyEmptyBodyTopic_TcpIp_SecOn failed: Expected exception not seen");
	...
	public void testReceiveBodyWithTimeOutUnspecifiedTypeTopic_B_SecOn(
		...
		jmsProducer = jmsContext.createProducer();
		TextMessage m = jmsContext
				.createTextMessage("testReceiveBodyWithTimeOutUnspecifiedTypeTopic_B_SecOn");
		jmsProducer.send(jmsTopic, m);
		try {
			byte[] msgBody = jmsConsumer.receiveBody(byte[].class,
					DEFAULT_TIMEOUT);
		...
		if (!exceptionFlag)
			throw new WrongException(
					"testReceiveBodyWithTimeOutUnspecifiedTypeTopic_B_SecOn failed: Expected exception not seen");
	}
	...
	public void testReceiveBodyWithTimeOutUnspecifiedTypeTopic_TcpIp_SecOn(
		...
		jmsProducer = jmsContext.createProducer();
		TextMessage m = jmsContext
				.createTextMessage("testReceiveBodyWithTimeOutUnspecifiedTypeTopic_TcpIp_SecOn");
		jmsProducer.send(jmsTopic, m);
		...
		if (!exceptionFlag)
			throw new WrongException(
					"testReceiveBodyWithTimeOutUnspecifiedTypeTopic_TcpIp_SecOn failed: Expected exception not seen");
	}
	...
	public void testReceiveBodyNoWaitUnsupportedTypeTopic_B_SecOn(
		...
		exceptionFlag = false;
		JMSContext context = jmsTCFBindings.createContext();
		...
		if (!exceptionFlag)
			throw new WrongException(
					"testReceiveBodyNoWaitUnsupportedTypeTopic_B_SecOn failed: Expected exception not seen");
	}
	...
	public void testReceiveBodyNoWaitUnsupportedTypeTopic_TcpIp_SecOn(
		...
		exceptionFlag = false;
		JMSContext context = jmsTCFTCP.createContext();
		...
		try {
			String msgBody = consumer.receiveBodyNoWait(String.class);
			System.out
					.println("testReceiveBodyNoWaitUnsupportedTypeTopic_TcpIp_SecOn: Message was received without any exception "
							+ msgBody);
		} catch (MessageFormatRuntimeException e) {
			exceptionFlag = true;
		...
		if (!exceptionFlag)
			throw new WrongException(
					"testReceiveBodyNoWaitUnsupportedTypeTopic_TcpIp_SecOn failed: Expected exception not seen");
	}
	...
	public void testCreateSharedDurableConsumer_create(
		...
		JMSConsumer jmsDurConsumer = jmsContext.createSharedDurableConsumer(
				jmsTopic, "SUBID1");
		JMSProducer jmsProducer = jmsContext.createProducer();
		TextMessage msg = jmsContext
				.createTextMessage("testCreateSharedDurableConsumer_create");
		jmsProducer.send(jmsTopic, msg);
	...
	public void testCreateSharedDurableConsumer_consume(
		...
		if (exceptionFlag)
			throw new WrongException(
					"testCreateSharedDurableConsumer_consume failed");
	...
	public void testCreateSharedDurableConsumer_create_TCP(
		...
		JMSProducer jmsProducer = jmsContext.createProducer();
		TextMessage msg = jmsContext
				.createTextMessage("testCreateSharedDurableConsumer_create_TCP");
	...
	public void testCreateSharedDurableConsumer_consume_TCP(
		...
		if (exceptionFlag)
			throw new WrongException(
					"testCreateSharedDurableConsumer_create_TCP failed: Expected message was not received");
	...
	public void testCreateSharedDurableConsumerWithMsgSel_create(
		...
		jmsProducer = jmsContext.createProducer();
		TextMessage msg = jmsContext
				.createTextMessage("testCreateSharedDurableConsumerWithMsgSel_create");
	...
	public void testCreateSharedDurableConsumerWithMsgSel_consume(
		...
		if (exceptionFlag)
			throw new WrongException(
					"testCreateSharedDurableConsumerWithMsgSel_create failed: Expected message was not received");
	...
	public void testCreateSharedDurableConsumerWithMsgSel_create_TCP(
		...
		TextMessage msg = jmsContext
				.createTextMessage("testCreateSharedDurableConsumerWithMsgSel_create_TCP");
		msg.setStringProperty("Company", "IBM");
	...
	public void testCreateSharedDurableConsumerWithMsgSel_consume_TCP(
		...
		if (exceptionFlag)
			throw new WrongException(
					"testCreateSharedDurableConsumerWithMsgSel_create_TCP failed: Expected message was not received");
	...
	public void testCreateSharedNonDurableConsumer_create(
		...
		jmsProducer = jmsContext.createProducer();
		TextMessage msg = jmsContext
				.createTextMessage("testCreateSharedNonDurableConsumer_create");
	...
	public void testCreateSharedNonDurableConsumer_consume(
		...
		JMSConsumer jmsNonDurConsumer = jmsContext.createSharedConsumer(
				jmsTopic, "SUBID5");
		TextMessage msg = (TextMessage) jmsNonDurConsumer
				.receive(DEFAULT_TIMEOUT);
		if (!(msg == null))
			exceptionFlag = true;
		if (exceptionFlag)
			throw new WrongException(
					"testCreateSharedNonDurableConsumer_create failed: Expected message was not received");
		jmsContext.close();
	...
	public void testCreateSharedNonDurableConsumer_create_TCP(
		...
		TextMessage msg = jmsContext
				.createTextMessage("testCreateSharedNonDurableConsumer_create_TCP");
		jmsProducer.send(jmsTopic, msg);
	...
	public void testCreateSharedNonDurableConsumer_consume_TCP(
		...
		if (exceptionFlag)
			throw new WrongException(
					"testCreateSharedNonDurableConsumer_create_TCP failed: Expected message was not received");
	...
	public void testCreateSharedNonDurableConsumerWithMsgSel_create(
		...
		jmsProducer = jmsContext.createProducer();
		TextMessage msg = jmsContext
				.createTextMessage("testCreateSharedNonDurableConsumerWithMsgSel_create");
	...
	public void testCreateSharedNonDurableConsumerWithMsgSel_consume(
		...
		if (exceptionFlag)
			throw new WrongException(
					"testCreateSharedNonDurableConsumerWithMsgSel_create failed: Expected message was not received");
		jmsContext.close();
	...
	public void testCreateSharedNonDurableConsumerWithMsgSel_create_TCP(
		...
		jmsProducer = jmsContext.createProducer();
		TextMessage msg = jmsContext
				.createTextMessage("testCreateSharedNonDurableConsumerWithMsgSel_create_TCP");
		msg.setStringProperty("Team", "WAS");
		jmsProducer.send(jmsTopic, msg);
	...
	public void testSetMessageProperty_Bindings_SecOn(
		...
		if (exceptionFlag)
			throw new WrongException(
					"testSetMessageProperty_Bindings_SecOn failed: Expected message was not received");
	...
	public void testSetMessageProperty_TCP_SecOn(HttpServletRequest request,
		...
		if (exceptionFlag)
			throw new WrongException(
					"testSetMessageProperty_TCp_SecOn failed: Expected message was not received");
	...
	public void testTopicName_temp_B(HttpServletRequest request,
		...
		if (exceptionFlag)
			throw new WrongException(
					"testTopicName_temp_B failed: Expected message was not received");
	...
	public void testTopicName_temp_TCP(HttpServletRequest request,
		...
		TextMessage message = jmsContext
				.createTextMessage("testTopicName_temp_TCP");
		...
		if (exceptionFlag)
			throw new WrongException(
					"testTopicName_temp_TCP failed: Expected message was not received");
	...
	public void testQueueNameCaseSensitive_Bindings(HttpServletRequest request,
		...
		if (!exceptionFlag)
			throw new WrongException(
					"testQueueNameCaseSensitive_Bindings failed: expected exception was not seen");
	}
	...
	public void testQueueNameCaseSensitive_TCP(HttpServletRequest request,
		...
		if (!exceptionFlag)
			throw new WrongException(
					"testQueueNameCaseSensitive_TCP failed: expected exception was not seen");
