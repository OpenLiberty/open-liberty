...
public class JMSContextInjectServlet extends HttpServlet {
	...
	public void testP2P_B_SecOn(HttpServletRequest request,
		...
		TextMessage message = jmsContextQueue
				.createTextMessage("testP2P_B_SecOn");
		...
		if (exceptionFlag)
			throw new WrongException(
					"testP2P_B_SecOn failed: Expected message was not received");
	...
	public void testP2P_TCP_SecOn(HttpServletRequest request,
		...
		TextMessage message = jmsContextQueueTCP
				.createTextMessage("testP2P_TCP_SecOn");
		...
		if (!(message1 != null && message1.getText()
				.equals("testP2P_TCP_SecOn")))
			exceptionFlag = true;

		if (exceptionFlag)
			throw new WrongException(
					"testP2P_TCP_SecOn failed: Expected message was not received");
	...
	public void testPubSub_B_SecOn(HttpServletRequest request,
		...
		TextMessage message = jmsContextTopic
				.createTextMessage("testPubSub_B_SecOn");
		...
		if (exceptionFlag)
			throw new WrongException(
					"testPubSub_B_SecOn failed: Expected message was not received");
	...
	public void testPubSub_TCP_SecOn(HttpServletRequest request,
		...
		TextMessage message = jmsContextTopicTCP
				.createTextMessage("testPubSub_TCP_SecOn");
		...
		if (exceptionFlag)
			throw new WrongException(
					"testPubSub_TCP_SecOn failed: Expected message was not received");
	...
	public void testPubSubDurable_B_SecOn(HttpServletRequest request,
		...
		TextMessage message = jmsContextTopic
				.createTextMessage("testPubSubDurable_B_SecOn");
		...
		if (exceptionFlag)
			throw new WrongException(
					"testPubSubDurable_B_SecOn failed: Expected message was not received");
	...
	public void testPubSubDurable_TCP_SecOn(HttpServletRequest request,
		...
		TextMessage message = jmsContextTopicTCP
				.createTextMessage("testPubSubDurable_TCP_SecOn");
		...
		if (exceptionFlag)
			throw new WrongException(
					"testPubSubDurable_TCP_SecOn failed: Expected message was not received");
	...
	public void testNegativeSetters_B_SecOn(HttpServletRequest request,
		...
		try {
			...
			ex1 = true;
			System.out
					.println("Expected exception seen on calling setClientID method");
		}
		...
		try {
			...
			ex2 = true;
			System.out
					.println("Expected exception seen on calling setExceptionListener method");
		}
		...
		try {
			...
			ex3 = true;
			System.out
					.println("Expected exception seen on calling stop method");
		}
		...
		try {
			...
			ex4 = true;
			System.out
					.println("Expected exception seen on calling acknowledge method");
		}
		...
		try {
			...
			ex5 = true;
			System.out
					.println("Expected exception seen on calling commit method");
		}
		...
		try {
			...
			ex6 = true;
			System.out
					.println("Expected exception seen on calling rollback method");
		}
		...
		try {
			...
			ex7 = true;
			System.out
					.println("Expected exception seen on calling recover method");
		}
		...
		try {
			...
			ex8 = true;
			System.out
					.println("Expected exception seen on calling setAutoStart method");
		}
		...
		try {
			...
			ex9 = true;
			System.out
					.println("Expected exception seen on calling start method");
		}
		...
		try {
			...
			ex10 = true;
			System.out
					.println("Expected exception seen on calling close method");
		}
		...
		if (exceptionFlag)
			throw new WrongException(
					"testNegativeSetters_B_SecOn failed: Expected exception was not seen");
	...
	public void testNegativeSetters_TCP_SecOn(HttpServletRequest request,
		...
		if (exceptionFlag)
			throw new WrongException(
					"testNegativeSetters_TCP_SecOn failed: Expected exception was not seen");
	...
	public void testWrongUserCredentialsQueue_B_SecOn(
		...
		try {
			...
			if (!(actualException
					.equals("javax.jms.JMSSecurityRuntimeException")))
				exceptionFlag = true;
			e.printStackTrace();
		}
		...
		if (exceptionFlag)
			throw new WrongException(
					"testWrongUserCredentialsQueue_B_SecOn failed: Expected exception was not seen");
	...
	public void testWrongUserCredentialsQueue_TCP_SecOn(
		...
		if (exceptionFlag)
			throw new WrongException(
					"testWrongUserCredentialsQueue_TCP_SecOn failed: Expected exception was not seen");
	...
	public void testWrongUserCredentialsTopic_B_SecOn(
		...
		if (exceptionFlag)
			throw new WrongException(
					"testWrongUserCredentialsTopic_B_SecOn failed: Expected exception was not seen");
	...
	public void testWrongUserCredentialsTopic_TCP_SecOn(
		...
		if (exceptionFlag)
			throw new WrongException(
					"testWrongUserCredentialsTopic_TCP_SecOn failed: Expected exception was not seen");
	...
	public void testQueueMDB(HttpServletRequest request,
		...
		Queue queue10 = (Queue) new InitialContext()
				.lookup("java:comp/env/queue/test");
