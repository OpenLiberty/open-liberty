...
import io.openliberty.jaxrs.client.fat.simpleSSL.dynamic.servlet.DynamicOutboundSSLClientTestServlet;
...
public class DynamicOutboundSSLTest extends FATServletClient {
    ...
    public static void setup() throws Exception {
        ...
        ShrinkHelper.defaultDropinApp(server, appName, "io.openliberty.jaxrs.client.fat.simpleSSL", "io.openliberty.jaxrs.client.fat.simpleSSL.dynamic.servlet");
