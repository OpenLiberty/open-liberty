...
import io.openliberty.jaxrs.client.fat.simpleSSL.multi.servlet.clientapi.SimpleSSLMultipleServersClientAPIClientTestServlet;

@RunWith(FATRunner.class)
public class SimpleSSLMultipleServersClientAPITest extends FATServletClient {

    private static final String appName = "simpleSSL";

    @Server("com.ibm.ws.jaxrs.2.0.client.fat.SimpleSSLMultiServerTestA_mismatching_default")
    @TestServlet(servlet = SimpleSSLMultipleServersClientAPIClientTestServlet.class, contextRoot = appName)
    ...
    public static void setup() throws Exception {
        ...
        ShrinkHelper.defaultDropinApp(server, appName, "io.openliberty.jaxrs.client.fat.simpleSSL.multi.servlet.clientapi");
