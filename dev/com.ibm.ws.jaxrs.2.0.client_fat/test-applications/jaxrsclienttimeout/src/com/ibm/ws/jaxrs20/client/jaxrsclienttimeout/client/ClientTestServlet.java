 ...
 *******************************************************************************/
package com.ibm.ws.jaxrs20.client.jaxrsclienttimeout.client;
...
public class ClientTestServlet extends HttpServlet {
    ...
    private static final String moduleName = "jaxrsclienttimeout";
    ...
    public void testTimeout(Map<String, String> param, StringBuilder ret) {
        ...
        String res = null;
        try {
            res = c.target("http://" + serverIP + ":" + serverPort + "/" + moduleName + "/TimeoutClientTest/BasicResource")
                            .path("echo")
