 ...
 *******************************************************************************/
package com.ibm.ws.jaxrs20.client.JAXRS20WithClientFeatureEnabledTest.client;
...
public class ClientTestServlet extends HttpServlet {
    ...
    private static final String moduleName = "jaxrs20withclientfeatureenabled";
    ...
    public void testNewClientBuilder_WithClientFeature(Map<String, String> param, StringBuilder ret) {
        ClientBuilder cb = ClientBuilder.newBuilder();
        ret.append("OK");
    }

    public void testNewClient_WithClientFeature(Map<String, String> param, StringBuilder ret) {
        ClientBuilder cb = ClientBuilder.newBuilder();
        Client c = cb.build();
        c.close();
        ret.append("OK");
    ...
    public void testNewWebTarget_WithClientFeature(Map<String, String> param, StringBuilder ret) {
        ClientBuilder cb = ClientBuilder.newBuilder();
        Client c = cb.build();
    ...
    public void testNewInvocationBuilder_WithClientFeature(Map<String, String> param, StringBuilder ret) {
        ClientBuilder cb = ClientBuilder.newBuilder();
        Client c = cb.build();
        WebTarget t = c.target("http://localhost:8010/dumpservice/test");
    ...
    public void testNewInvocation_WithClientFeature(Map<String, String> param, StringBuilder ret) {
        ClientBuilder cb = ClientBuilder.newBuilder();
        Client c = cb.build();
        WebTarget t = c.target("http://localhost:8010/dumpservice/test");
        Builder ib = t.request();
    ...
    public void testFlowProgram_WithClientFeature(Map<String, String> param, StringBuilder ret) {
