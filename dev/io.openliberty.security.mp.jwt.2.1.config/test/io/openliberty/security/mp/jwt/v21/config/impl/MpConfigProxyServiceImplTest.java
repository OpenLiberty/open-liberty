...
public class MpConfigProxyServiceImplTest {
    ...
    public void testActivate() {
        ...
        assertTrue("CWWKS5786I message was not logged.", outputMgr.checkForMessages("CWWKS5786I:"));
    }
    ...
    public void testModified() {
        ...
        assertTrue("CWWKS5787I message was not logged.", outputMgr.checkForMessages("CWWKS5787I:"));
    }
    ...
    public void testDeactivate() {
        ...
        assertTrue("CWWKS5788I message was not logged.", outputMgr.checkForMessages("CWWKS5788I:"));
    }
    ...
    public void testGetVersion() {
        ...
        assertEquals("MP version did not match the expected value.", "2.1", output);
    }
