...
public class ResponseFullExpectationTest extends CommonSpecificExpectationTest {
    ...
    public void test_constructor_nullArgs() {
        try {
            ...
            ResponseFullExpectation exp = new ResponseFullExpectation(testAction, checkType, searchForVal, failureMsg);
