 ...
 *
 */
@Component(name = "com.ibm.ws.lra.config", service = LraConfig.class, configurationPid = "com.ibm.ws.lra.config", configurationPolicy = ConfigurationPolicy.REQUIRE, immediate = true, property = { "service.vendor=IBM" })
