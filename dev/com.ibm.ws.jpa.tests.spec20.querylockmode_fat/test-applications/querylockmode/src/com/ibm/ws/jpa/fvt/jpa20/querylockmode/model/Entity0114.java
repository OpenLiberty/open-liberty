...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0114_SELECT",
                                    query = "SELECT e FROM Entity0114 e WHERE e.entity0114_id1 = :id1_0114 AND e.entity0114_id2 = :id2_0114")
              })
@Entity
@IdClass(IdClass0114.class)
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0114")
public class Entity0114 {

    @Id
    private short entity0114_id1;

    @Id
    private short entity0114_id2;

    @Version
    private short entity0114_version;

    private String entity0114_string01;

    private String entity0114_string02;

    private String entity0114_string03;

    public Entity0114() {}

    public Entity0114(short id1,
                      short id2,
                      short version,
                      String string01,
                      String string02,
                      String string03) {
        this.entity0114_id1 = id1;
        this.entity0114_id2 = id2;
        this.entity0114_version = version;
        this.entity0114_string01 = string01;
        this.entity0114_string02 = string02;
        this.entity0114_string03 = string03;
    }

    @Override
    public String toString() {
        return (" Entity0114: " +
                " entity0114_id1: " + getEntity0114_id1() +
                " entity0114_id2: " + getEntity0114_id2() +
                " entity0114_version: " + getEntity0114_version() +
                " entity0114_string01: " + getEntity0114_string01() +
                " entity0114_string02: " + getEntity0114_string02() +
                " entity0114_string03: " + getEntity0114_string03());
    }

    //----------------------------------------------------------------------------------------------
    // Persisent property accessor(s)
    //----------------------------------------------------------------------------------------------
    public short getEntity0114_id1() {
        return entity0114_id1;
    }

    public void setEntity0114_id1(short p) {
        this.entity0114_id1 = p;
    }

    public short getEntity0114_id2() {
        return entity0114_id2;
    }

    public void setEntity0114_id2(short p) {
        this.entity0114_id2 = p;
    }

    public short getEntity0114_version() {
        return entity0114_version;
    }

    public void setEntity0114_version(short p) {
        this.entity0114_version = p;
    }

    public String getEntity0114_string01() {
        return entity0114_string01;
    }

    public void setEntity0114_string01(String p) {
        this.entity0114_string01 = p;
    }

    public String getEntity0114_string02() {
        return entity0114_string02;
    }

    public void setEntity0114_string02(String p) {
        this.entity0114_string02 = p;
    }

    public String getEntity0114_string03() {
        return entity0114_string03;
    }

    public void setEntity0114_string03(String p) {
        this.entity0114_string03 = p;
    }
}
