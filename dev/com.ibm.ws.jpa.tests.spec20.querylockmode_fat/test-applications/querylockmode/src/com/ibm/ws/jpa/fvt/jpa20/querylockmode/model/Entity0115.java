...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0115_SELECT",
                                    query = "SELECT e FROM Entity0115 e WHERE e.entity0115_id1 = :id1_0115 AND e.entity0115_id2 = :id2_0115")
              })
@Entity
@IdClass(IdClass0115.class)
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0115")
public class Entity0115 {
    ...
    @Version
    private Short entity0115_version;

    private String entity0115_string01;

    private String entity0115_string02;

    private String entity0115_string03;

    public Entity0115() {}

    public Entity0115(Short id1,
                      Short id2,
                      Short version,
                      String string01,
                      String string02,
        ...
        this.entity0115_version = version;
        this.entity0115_string01 = string01;
        this.entity0115_string02 = string02;
        this.entity0115_string03 = string03;
    }
    ...
    public String toString() {
        return (" Entity0115: " +
                ...
                " entity0115_version: " + getEntity0115_version() +
                " entity0115_string01: " + getEntity0115_string01() +
                " entity0115_string02: " + getEntity0115_string02() +
                " entity0115_string03: " + getEntity0115_string03());
    }
    ...
    public void setEntity0115_id1(Short p) {
        this.entity0115_id1 = p;
    }
    ...
    public void setEntity0115_id2(Short p) {
        this.entity0115_id2 = p;
    }

    public Short getEntity0115_version() {
        return entity0115_version;
    }

    public void setEntity0115_version(Short p) {
        this.entity0115_version = p;
    }

    public String getEntity0115_string01() {
        return entity0115_string01;
    }

    public void setEntity0115_string01(String p) {
        this.entity0115_string01 = p;
    }

    public String getEntity0115_string02() {
        return entity0115_string02;
    }

    public void setEntity0115_string02(String p) {
        this.entity0115_string02 = p;
    }

    public String getEntity0115_string03() {
        return entity0115_string03;
    }

    public void setEntity0115_string03(String p) {
        this.entity0115_string03 = p;
    }
}
