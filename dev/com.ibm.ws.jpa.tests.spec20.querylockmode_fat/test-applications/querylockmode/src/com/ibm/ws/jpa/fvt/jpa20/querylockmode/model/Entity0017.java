...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0017_SELECT",
                                    query = "SELECT e FROM Entity0017 e WHERE e.entity0017_id = :id_0017"),
                        @NamedQuery(name = "ENTITY0017_UPDATE",
                                    query = "UPDATE Entity0017 e SET e.entity0017_string01 = :string01_0017, e.entity0017_string02 = :string02_0017, e.entity0017_string03 = :string03_0017 WHERE e.entity0017_id = :id_0017")
              })
@Entity
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0017")
public class Entity0017 {

    @Id
    private BigInteger entity0017_id;

    @Version
    private long entity0017_version;

    private String entity0017_string01;

    private String entity0017_string02;

    private String entity0017_string03;

    public Entity0017() {}

    public Entity0017(BigInteger id,
                      long version,
                      String string01,
                      String string02,
                      String string03) {
        this.entity0017_id = id;
        this.entity0017_version = version;
        this.entity0017_string01 = string01;
        this.entity0017_string02 = string02;
        this.entity0017_string03 = string03;
    }

    @Override
    public String toString() {
        return (" Entity0017: " +
                " entity0017_id: " + getEntity0017_id() +
                " entity0017_version: " + getEntity0017_version() +
                " entity0017_string01: " + getEntity0017_string01() +
                " entity0017_string02: " + getEntity0017_string02() +
                " entity0017_string03: " + getEntity0017_string03());
    }

    //----------------------------------------------------------------------------------------------
    // Persisent property accessor(s)
    //----------------------------------------------------------------------------------------------
    public BigInteger getEntity0017_id() {
        return entity0017_id;
    }

    public void setEntity0017_id(BigInteger p) {
        this.entity0017_id = p;
    }

    public long getEntity0017_version() {
        return entity0017_version;
    }

    public void setEntity0017_version(long p) {
        this.entity0017_version = p;
    }

    public String getEntity0017_string01() {
        return entity0017_string01;
    }

    public void setEntity0017_string01(String p) {
        this.entity0017_string01 = p;
    }

    public String getEntity0017_string02() {
        return entity0017_string02;
    }

    public void setEntity0017_string02(String p) {
        this.entity0017_string02 = p;
    }

    public String getEntity0017_string03() {
        return entity0017_string03;
    }

    public void setEntity0017_string03(String p) {
        this.entity0017_string03 = p;
    }
}
