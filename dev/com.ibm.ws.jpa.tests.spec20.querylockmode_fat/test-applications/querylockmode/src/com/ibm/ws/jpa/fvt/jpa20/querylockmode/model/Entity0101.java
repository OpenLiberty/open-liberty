...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0101_SELECT",
                                    query = "SELECT e FROM Entity0101 e WHERE e.entity0101_id1 = :id1_0101 AND e.entity0101_id2 = :id2_0101")
              })
@Entity
@IdClass(IdClass0101.class)
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0101")
public class Entity0101 {
    ...
    @Version
    private Short entity0101_version;

    private String entity0101_string01;

    private String entity0101_string02;

    private String entity0101_string03;

    public Entity0101() {}

    public Entity0101(byte id1,
                      byte id2,
                      Short version,
                      String string01,
                      String string02,
        ...
        this.entity0101_version = version;
        this.entity0101_string01 = string01;
        this.entity0101_string02 = string02;
        this.entity0101_string03 = string03;
    }
    ...
    public String toString() {
        return (" Entity0101: " +
                ...
                " entity0101_version: " + getEntity0101_version() +
                " entity0101_string01: " + getEntity0101_string01() +
                " entity0101_string02: " + getEntity0101_string02() +
                " entity0101_string03: " + getEntity0101_string03());
    }
    ...
    public void setEntity0101_id1(byte p) {
        this.entity0101_id1 = p;
    }
    ...
    public void setEntity0101_id2(byte p) {
        this.entity0101_id2 = p;
    }

    public Short getEntity0101_version() {
        return entity0101_version;
    }

    public void setEntity0101_version(Short p) {
        this.entity0101_version = p;
    }

    public String getEntity0101_string01() {
        return entity0101_string01;
    }

    public void setEntity0101_string01(String p) {
        this.entity0101_string01 = p;
    }

    public String getEntity0101_string02() {
        return entity0101_string02;
    }

    public void setEntity0101_string02(String p) {
        this.entity0101_string02 = p;
    }

    public String getEntity0101_string03() {
        return entity0101_string03;
    }

    public void setEntity0101_string03(String p) {
        this.entity0101_string03 = p;
    }
}
