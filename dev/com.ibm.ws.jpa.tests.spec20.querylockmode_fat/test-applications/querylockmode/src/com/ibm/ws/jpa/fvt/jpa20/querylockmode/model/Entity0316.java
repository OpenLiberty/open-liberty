...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0316_SELECT",
                                    query = "SELECT e FROM Entity0316 e WHERE e.entity0316_id1 = :id1_0316 AND e.entity0316_id2 = :id2_0316 AND e.entity0316_id3 = :id3_0316")
              })
@Entity
@IdClass(IdClass0316.class)
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0316")
public class Entity0316 {
    ...
    @Version
    private long entity0316_version;

    private String entity0316_string01;

    private String entity0316_string02;

    private String entity0316_string03;

    public Entity0316() {}

    public Entity0316(BigDecimal id1,
                      BigInteger id2,
                      java.util.Date id3,
                      long version,
                      String string01,
        ...
        this.entity0316_version = version;
        this.entity0316_string01 = string01;
        this.entity0316_string02 = string02;
        this.entity0316_string03 = string03;
    }
    ...
    public String toString() {
        return (" Entity0316: " +
                ...
                " entity0316_version: " + getEntity0316_version() +
                " entity0316_string01: " + getEntity0316_string01() +
                " entity0316_string02: " + getEntity0316_string02() +
                " entity0316_string03: " + getEntity0316_string03());
    }
    ...
    public void setEntity0316_id1(BigDecimal p) {
        this.entity0316_id1 = p;
    }
    ...
    public void setEntity0316_id2(BigInteger p) {
        this.entity0316_id2 = p;
    }
    ...
    public void setEntity0316_id3(java.util.Date p) {
        this.entity0316_id3 = p;
    }

    public long getEntity0316_version() {
        return entity0316_version;
    }

    public void setEntity0316_version(long p) {
        this.entity0316_version = p;
    }

    public String getEntity0316_string01() {
        return entity0316_string01;
    }

    public void setEntity0316_string01(String p) {
        this.entity0316_string01 = p;
    }

    public String getEntity0316_string02() {
        return entity0316_string02;
    }

    public void setEntity0316_string02(String p) {
        this.entity0316_string02 = p;
    }

    public String getEntity0316_string03() {
        return entity0316_string03;
    }

    public void setEntity0316_string03(String p) {
        this.entity0316_string03 = p;
    }
}
