...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0117_SELECT",
                                    query = "SELECT e FROM Entity0117 e WHERE e.entity0117_id1 = :id1_0117 AND e.entity0117_id2 = :id2_0117")
              })
@Entity
@IdClass(IdClass0117.class)
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0117")
public class Entity0117 {
    ...
    @Version
    private int entity0117_version;

    private String entity0117_string01;

    private String entity0117_string02;

    private String entity0117_string03;

    public Entity0117() {}

    public Entity0117(BigInteger id1,
                      BigInteger id2,
                      int version,
                      String string01,
                      String string02,
        ...
        this.entity0117_version = version;
        this.entity0117_string01 = string01;
        this.entity0117_string02 = string02;
        this.entity0117_string03 = string03;
    }
    ...
    public String toString() {
        return (" Entity0117: " +
                ...
                " entity0117_version: " + getEntity0117_version() +
                " entity0117_string01: " + getEntity0117_string01() +
                " entity0117_string02: " + getEntity0117_string02() +
                " entity0117_string03: " + getEntity0117_string03());
    }
    ...
    public void setEntity0117_id1(BigInteger p) {
        this.entity0117_id1 = p;
    }
    ...
    public void setEntity0117_id2(BigInteger p) {
        this.entity0117_id2 = p;
    }

    public int getEntity0117_version() {
        return entity0117_version;
    }

    public void setEntity0117_version(int p) {
        this.entity0117_version = p;
    }

    public String getEntity0117_string01() {
        return entity0117_string01;
    }

    public void setEntity0117_string01(String p) {
        this.entity0117_string01 = p;
    }

    public String getEntity0117_string02() {
        return entity0117_string02;
    }

    public void setEntity0117_string02(String p) {
        this.entity0117_string02 = p;
    }

    public String getEntity0117_string03() {
        return entity0117_string03;
    }

    public void setEntity0117_string03(String p) {
        this.entity0117_string03 = p;
    }
}
