...
public class MPJwtGoodMPConfigAsEnvVars_NoPublicKey_UseKeyLocRS384Url extends MPJwtWithGoodAltSigAlgMPConfig {

    public static Class<?> thisClass = MPJwtGoodMPConfigAsEnvVars_NoPublicKey_UseKeyLocRS384Url.class;
    ...
    public static void setUp() throws Exception {
        ...
        commonSetup(envVarsResourceServer, sigAlg, "file:///" + JwtKeyTools.getDefaultKeyFileLoc(envVarsResourceServer) + JwtKeyTools.getPublicKeyFileNameForAlg(sigAlg),
