 ...
 *
 */
public class RepeatOnErrorEE9 extends JakartaEE9Action {

    public static final String ID_EJB_ON_ERROR = JakartaEE9Action.ID + "_EjbOnErr";
    ...
    private static final Class<?> c = RepeatOnErrorEE9.class;
    String serverName;

    public EjbOnError onErrorAction = EjbOnError.WARN;

    public RepeatOnErrorEE9(EjbOnError ejbOnError) {
