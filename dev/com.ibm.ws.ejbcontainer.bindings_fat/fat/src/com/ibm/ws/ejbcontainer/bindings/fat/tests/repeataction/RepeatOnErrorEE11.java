 ...
 *
 */
public class RepeatOnErrorEE11 extends JakartaEE11Action {

    public static final String ID_EJB_ON_ERROR = JakartaEE11Action.ID + "_EjbOnErr";
    ...
    private static final Class<?> c = RepeatOnErrorEE11.class;
    String serverName;

    public EjbOnError onErrorAction = EjbOnError.WARN;

    public RepeatOnErrorEE11(EjbOnError ejbOnError) {
