...
public class EJB2XDefBndBean implements javax.ejb.SessionBean {
    private final static String CLASS_NAME = EJB2XDefBndBean.class.getName();
    private final static Logger svLogger = Logger.getLogger(CLASS_NAME);
    private static final String BeanName = "EJB2XDefBnd";

    public EJB2XDefBndBean() {}
    ...
    public String foo() {
        return "EJB2XDefBndBean.toString()";
    }
}
