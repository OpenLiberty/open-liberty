...
import com.ibm.ws.ejbcontainer.bindings.noInterface.bnd.ejb.BasicNoInterfaceSGBean;

/**
 * Test that the various binding options work properly for Singleton beans with
 * a No-Interface View. <p>
 *
 * The following configurations of Singleton Session beans are tested:
 *
 * <ul>
...
@WebServlet("/NoInterfaceBindingSingletonServlet")
public class NoInterfaceBindingSingletonServlet extends NoInterfaceBindingAbstractServlet {
    private static final String CLASS_NAME = NoInterfaceBindingSingletonServlet.class.getName();
    ...
    protected void setUp() {
        ...
        beanName = "NoInterfaceSG";
        componentid = "com/ibm/ws/ejbcontainer/bindings/noInterface/bnd/comp/sg";
        simpleName = "com/ibm/ws/ejbcontainer/bindings/noInterface/bnd/NoInterfaceSG";
        customPrefix = "com/ibm/ws/ejbcontainer/bindings/noInterface/bnd/sg";
        supportsComponentInterface = false; // no component interface beans
    ...
    public void testUniqueNoInterfaceDefaultBindings_NoInterfaceBindingSingleton() throws Exception {
        ...
        bbean = (BasicNoInterfaceSGBean) ivContext.lookup("ejblocal:" + APP_NAME + "/" + MOD_NAME + "/" + beanName + "#" + beanInterface);
