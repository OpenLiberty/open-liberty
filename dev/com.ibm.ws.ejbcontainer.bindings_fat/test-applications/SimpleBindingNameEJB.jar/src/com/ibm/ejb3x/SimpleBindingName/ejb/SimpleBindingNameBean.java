...
public class SimpleBindingNameBean implements javax.ejb.SessionBean {
    private final static String CLASS_NAME = SimpleBindingNameBean.class.getName();
    private final static Logger svLogger = Logger.getLogger(CLASS_NAME);
    private static final String BeanName = "SimpleBindingName";

    public SimpleBindingNameBean() {}
