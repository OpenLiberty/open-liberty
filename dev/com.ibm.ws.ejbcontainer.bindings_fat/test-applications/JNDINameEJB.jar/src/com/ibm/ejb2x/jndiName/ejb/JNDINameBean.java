...
public class JNDINameBean implements javax.ejb.SessionBean {
    private final static String CLASS_NAME = JNDINameBean.class.getName();
    private final static Logger svLogger = Logger.getLogger(CLASS_NAME);
    private static final String BeanName = "JNDIName";
