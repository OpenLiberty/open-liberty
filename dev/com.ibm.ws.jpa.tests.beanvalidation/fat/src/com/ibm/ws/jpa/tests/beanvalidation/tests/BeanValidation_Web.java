...
import com.ibm.ws.jpa.beanvalidation.web.TestBeanValidationServlet;
...
public class BeanValidation_Web extends JPAFATServletClient {
    ...
    private final static String appName = "beanvalidationWeb";
    ...
    @TestServlets({
                    @TestServlet(servlet = TestBeanValidationServlet.class, path = CONTEXT_ROOT + "/" + "TestBeanValidationServlet")
    })
    ...
    public static void setUp() throws Exception {
        ...
        bannerStart(BeanValidation_Web.class);
        ...
        System.out.println(BeanValidation_Web.class.getName() + " Setting up database tables...");

        JPAPersistenceProvider provider = AbstractFATSuite.provider;
        System.out.println("provider: " + provider);
        System.out.println("getDbVendor(): " + getDbVendor());
        ddlSet.clear();
    ...
    private static void setupTestApplication() throws Exception {
        ...
        webApp.addPackages(true, "com.ibm.ws.jpa.beanvalidation.model");
        webApp.addPackages(true, "com.ibm.ws.jpa.beanvalidation.testlogic");
        webApp.addPackages(true, "com.ibm.ws.jpa.beanvalidation.web");
    ...
    public static void tearDown() throws Exception {
        try {
            ...
            bannerEnd(BeanValidation_Web.class, timestart);
        }
    }
}
