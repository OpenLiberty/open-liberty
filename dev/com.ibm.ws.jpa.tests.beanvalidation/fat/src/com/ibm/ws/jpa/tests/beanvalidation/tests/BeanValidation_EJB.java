...
@Mode(TestMode.FULL)
public class BeanValidation_EJB extends JPAFATServletClient {

    @Rule
    public static SkipDatabaseRule skipDBRule = new SkipDatabaseRule();

    private final static String CONTEXT_ROOT = "beanvalidationEjb";
    private final static String RESOURCE_ROOT = "test-applications/beanvalidation/";
    private final static String appFolder = "ejb";
    private final static String appName = "beanvalidationEjb";
    ...
    static {
        dropSet.add("JPA_BEAN_VALIDATION_${provider}_DROP_${dbvendor}.ddl");
        createSet.add("JPA_BEAN_VALIDATION_${provider}_CREATE_${dbvendor}.ddl");
    }

    @Server("BeanValidationServer")
    @TestServlets({
                    @TestServlet(servlet = TestBeanValidation_EJB_SF_Servlet.class, path = CONTEXT_ROOT + "/" + "TestBeanValidation_EJB_SF_Servlet"),
                    @TestServlet(servlet = TestBeanValidation_EJB_SFEx_Servlet.class, path = CONTEXT_ROOT + "/" + "TestBeanValidation_EJB_SFEx_Servlet"),
                    @TestServlet(servlet = TestBeanValidation_EJB_SL_Servlet.class, path = CONTEXT_ROOT + "/" + "TestBeanValidation_EJB_SL_Servlet")
    })
    ...
    public static void setUp() throws Exception {
        ...
        bannerStart(BeanValidation_EJB.class);
        ...
        System.out.println(BeanValidation_EJB.class.getName() + " Setting up database tables...");
    ...
    private static void setupTestApplication() throws Exception {
        ...
        ejbApp.addPackages(true, "com.ibm.ws.jpa.beanvalidation.ejblocal");
        ejbApp.addPackages(true, "com.ibm.ws.jpa.beanvalidation.model");
        ejbApp.addPackages(true, "com.ibm.ws.jpa.beanvalidation.testlogic");
        ShrinkHelper.addDirectory(ejbApp, RESOURCE_ROOT + appFolder + "/" + appName + ".jar");

        WebArchive webApp = ShrinkWrap.create(WebArchive.class, appName + ".war");
        webApp.addPackages(true, "com.ibm.ws.jpa.beanvalidation.ejb");
    ...
    public static void tearDown() throws Exception {
        try {
            ...
            bannerEnd(BeanValidation_EJB.class, timestart);
        }
    }
}
