...
public class JPAExEntityManagerV32 extends JPAExEntityManager{
    private static final TraceComponent tc = Tr.register(JPAExEntityManagerV32.class,
                                                         JPA_TRACE_GROUP,
                                                         JPA_RESOURCE_BUNDLE_NAME);

    public JPAExEntityManagerV32(JPAPuId puRefId,
                                 JPAPUnitInfo puInfo,
                                 J2EEName j2eeName,
                                 String refName,
                                 Map<?, ?> properties,
