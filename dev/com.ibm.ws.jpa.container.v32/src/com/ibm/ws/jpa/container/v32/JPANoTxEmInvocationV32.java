...
public class JPANoTxEmInvocationV32 extends JPANoTxEmInvocation{
    protected JPANoTxEmInvocationV32(UOWCoordinator uowCoord, EntityManager em, JPAEntityManager jpaEm, boolean txIsUnsynchronized) {
