...
//                    @TestServlet(servlet = TestOLGH8014_EJB_SFEx_Servlet.class, path = "olgh8014ejb" + "/" + "TestOLGH8014_EJB_SFEx_Servlet")
    ...
    public static void setUp() throws Exception {
        ...
        bannerStart(TestEntityLocking_EJB.class);
        ...
        System.out.println(TestEntityLocking_EJB.class.getName() + " Setting up database tables...");
    ...
    public static void tearDown() throws Exception {
        try {
            ...
            bannerEnd(TestEntityLocking_EJB.class, timestart);
        }
    }
}
