...
public class TestEntityLocking_Web extends JPAFATServletClient {
    ...
    private static void setupTestApplication() throws Exception {
        ...
        webApp.addPackages(true, "com.ibm.ws.jpa.fvt.entitylocking20.entities");
        webApp.addPackages(true, "com.ibm.ws.jpa.fvt.entitylocking20.testlogic");
        webApp.addPackages(true, "com.ibm.ws.jpa.fvt.entitylocking20.tests.web");
