...
public class TestOrbConfigurator implements OrbConfigurator {
    ...
    @Activate public TestOrbConfigurator(@Reference Register providerRegistry) { providerRegistry.registerProvider(SERVICE_PROVIDER); }
    @Override public Policy getTargetPolicy(ORB orb, Map<String, Object> properties, Map<String, Object> extraConfig) { return null; }
    @Override public Policy getClientPolicy(ORB orb, Map<String, Object> properties) { return null; }
    @Override public String getInitializerClassName(boolean endpoint) { return ORBInitializerImpl.class.getName(); }
}
