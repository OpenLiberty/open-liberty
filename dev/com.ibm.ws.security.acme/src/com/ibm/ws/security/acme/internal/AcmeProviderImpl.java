...
public class AcmeProviderImpl implements AcmeProvider, ApplicationStateListener {
	...
	private static final String DEFAULT_KEY_STORE = "defaultKeyStore";
	...
	public void deactivate(ComponentContext context, int reason) {
		...
		/*
		 * We are no longer the default SSL certificate creator.
		 */
	...
	public void modify(ComponentContext context, Map<String, Object> properties) throws AcmeCaException {
		...
		initialize(context, properties);
		checkAndInstallCertificate(null, null, null);
	...
	public void initialize(ComponentContext context, Map<String, Object> properties) throws AcmeCaException {
		...
		/*
		 * We are the default SSL certificate creator.
		 */
		// DefaultSSLCertificateFactory.setDefaultSSLCertificateCreator(this);
	 ...
	 */
	private void checkAndInstallCertificate(KeyStore keyStore, File keyStoreFile, String password)
			throws AcmeCaException {
		 ...
		 */
		AcmeCertificate acmeCertificate = checkAndRetrieveCertificate(existingCertificate);
	 ...
	 */
	private AcmeCertificate checkAndRetrieveCertificate(X509Certificate existingCertificate) throws AcmeCaException {
		 ...
		 */
		if (isCertificateRequired(existingCertificate)) {
	...
	private boolean hasWrongDomains(X509Certificate certificate) throws AcmeCaException {
		...
		try {
			...
			throw new AcmeCaException("The certificate's subject name is not a valid distinguished name.", e);
		}
	 ...
	 */
	@Override
	public File createDefaultSSLCertificate(String filePath, @Sensitive String password, int validity, String subjectDN,
	...
	public void updateDefaultSSLCertificate(KeyStore keyStore, File keyStoreFile, @Sensitive String password)
		...
		try {
			checkAndInstallCertificate(keyStore, keyStoreFile, password);
		} catch (AcmeCaException e) {
			throw new CertificateException(e.getMessage(), e);
		}
