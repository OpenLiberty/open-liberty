...
public class AuthFilterConstants {
    ...
    static {
        ...
        DEFAULT_CMD_ARGS.put(AuthFilterConstants.ARG_ENABLE_TRUSTED_FOR_DELEGATION, "false");
        DEFAULT_CMD_ARGS.put(AuthFilterConstants.ARG_ENABLE_TRUSTED_FOR_AUTH_DELEGATION, "true");
        DEFAULT_CMD_ARGS.put(AuthFilterConstants.ARG_ENABLE_ALLOWED_TO_DELEGATE, "true");
        DEFAULT_CMD_ARGS.put(AuthFilterConstants.ARG_ENABLE_PASSWORD_NEVER_EXPIRES, "true");
        DEFAULT_CMD_ARGS.put(AuthFilterConstants.ARG_DISABLE_KERBEROS_PRE_AUTH, "false");

        // Do not disable Kerberos pre-auth
        S4U2_PROXY_DEFAULT_CMD_ARGS.put(AuthFilterConstants.ARG_ENABLE_TRUSTED_FOR_DELEGATION, "true");
        S4U2_PROXY_DEFAULT_CMD_ARGS.put(AuthFilterConstants.ARG_ENABLE_TRUSTED_FOR_AUTH_DELEGATION, "true");
        S4U2_PROXY_DEFAULT_CMD_ARGS.put(AuthFilterConstants.ARG_ENABLE_ALLOWED_TO_DELEGATE, "true");
        S4U2_PROXY_DEFAULT_CMD_ARGS.put(AuthFilterConstants.ARG_ENABLE_PASSWORD_NEVER_EXPIRES, "true");
        S4U2_PROXY_DEFAULT_CMD_ARGS.put(AuthFilterConstants.ARG_DISABLE_KERBEROS_PRE_AUTH, "false");

        // Do not enable trusted for delegation
        S4U2_SELF_DEFAULT_CMD_ARGS.put(AuthFilterConstants.ARG_ENABLE_TRUSTED_FOR_DELEGATION, "false");
        S4U2_SELF_DEFAULT_CMD_ARGS.put(AuthFilterConstants.ARG_ENABLE_TRUSTED_FOR_AUTH_DELEGATION, "true");
        S4U2_SELF_DEFAULT_CMD_ARGS.put(AuthFilterConstants.ARG_ENABLE_ALLOWED_TO_DELEGATE, "true");
        S4U2_SELF_DEFAULT_CMD_ARGS.put(AuthFilterConstants.ARG_ENABLE_PASSWORD_NEVER_EXPIRES, "true");
        S4U2_SELF_DEFAULT_CMD_ARGS.put(AuthFilterConstants.ARG_DISABLE_KERBEROS_PRE_AUTH, "true");

        // Disable Delegation for Self
        S4U2_SELF_ALLOW_DELEGATION_FALSE_CMD_ARGS.put(AuthFilterConstants.ARG_ENABLE_TRUSTED_FOR_DELEGATION, "false");
        S4U2_SELF_ALLOW_DELEGATION_FALSE_CMD_ARGS.put(AuthFilterConstants.ARG_ENABLE_TRUSTED_FOR_AUTH_DELEGATION, "true");
        S4U2_SELF_ALLOW_DELEGATION_FALSE_CMD_ARGS.put(AuthFilterConstants.ARG_ENABLE_ALLOWED_TO_DELEGATE, "false");
        S4U2_SELF_ALLOW_DELEGATION_FALSE_CMD_ARGS.put(AuthFilterConstants.ARG_ENABLE_PASSWORD_NEVER_EXPIRES, "true");
        S4U2_SELF_ALLOW_DELEGATION_FALSE_CMD_ARGS.put(AuthFilterConstants.ARG_DISABLE_KERBEROS_PRE_AUTH, "true");

        // Disable Account Trusted
        S4U2_SELF_ALLOW_ACCOUNT_TRUSTED_FALSE_CMD_ARGS.put(AuthFilterConstants.ARG_ENABLE_TRUSTED_FOR_DELEGATION, "false");
        S4U2_SELF_ALLOW_ACCOUNT_TRUSTED_FALSE_CMD_ARGS.put(AuthFilterConstants.ARG_ENABLE_TRUSTED_FOR_AUTH_DELEGATION, "true");
        S4U2_SELF_ALLOW_ACCOUNT_TRUSTED_FALSE_CMD_ARGS.put(AuthFilterConstants.ARG_ENABLE_ALLOWED_TO_DELEGATE, "false");
        S4U2_SELF_ALLOW_ACCOUNT_TRUSTED_FALSE_CMD_ARGS.put(AuthFilterConstants.ARG_ENABLE_PASSWORD_NEVER_EXPIRES, "true");
        S4U2_SELF_ALLOW_ACCOUNT_TRUSTED_FALSE_CMD_ARGS.put(AuthFilterConstants.ARG_DISABLE_KERBEROS_PRE_AUTH, "true");
