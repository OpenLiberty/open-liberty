...
public class SimpleDBTranlogTestNoRecOnStart extends FATServletClient {
    ...
    @Server("com.ibm.ws.transaction.dblog_noRecoveryOnStartup")
     ...
     */
    @Test
    public void testTransactionEnlistmentDBLogNoRecOnStart() throws Exception {
