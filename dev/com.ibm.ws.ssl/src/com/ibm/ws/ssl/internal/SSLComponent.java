...
public class SSLComponent extends GenericSSLConfigService implements SSLSupportOptional {
    ...
    protected synchronized void activate(ComponentContext ctx, Map<String, Object> properties) {
        ...
        if ((JavaInfo.vendor().equals(JavaInfo.Vendor.OPENJ9) && JavaInfo.majorVersion() >= 11 && JavaInfo.microVersion() < 2) || (JavaInfo.vendor().equals(JavaInfo.Vendor.ORACLE) && JavaInfo.majorVersion() >= 11))
            disableTLSv13();
