...
@WebServiceClient(name = "HelloImplService", targetNamespace = "http://server.wsatAppServiceOptional.web/", wsdlLocation = "file:/C:/Jordan/workspace/WDT/cxfApp2/WebContent/WEB-INF/wsdl/hello.wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOIMPLSERVICE_QNAME = new QName("http://server.wsatAppServiceOptional.web/", "HelloImplService");
    ...
    public Hello getHelloImplPort() {
        return super.getPort(new QName("http://server.wsatAppServiceOptional.web/", "HelloImplPort"), Hello.class);
    }
    ...
    public Hello getHelloImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.wsatAppServiceOptional.web/", "HelloImplPort"), Hello.class, features);
    }
