 ...
 * generated in the web.wsatAppServiceOptional.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _SayHelloToOtherWithoutResponse_QNAME = new QName("http://server.wsatAppServiceOptional.web/", "sayHelloToOtherWithoutResponse");
    private final static QName _SayHelloToOtherWithout_QNAME = new QName("http://server.wsatAppServiceOptional.web/", "sayHelloToOtherWithout");
    private final static QName _SayHelloToOtherResponse_QNAME = new QName("http://server.wsatAppServiceOptional.web/", "sayHelloToOtherResponse");
    private final static QName _SayHelloToOther_QNAME = new QName("http://server.wsatAppServiceOptional.web/", "sayHelloToOther");
    private final static QName _SayHelloResponse_QNAME = new QName("http://server.wsatAppServiceOptional.web/", "sayHelloResponse");
    private final static QName _SayHello_QNAME = new QName("http://server.wsatAppServiceOptional.web/", "sayHello");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: web.wsatAppServiceOptional.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.wsatAppServiceOptional.web/", name = "sayHelloToOtherWithoutResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.wsatAppServiceOptional.web/", name = "sayHelloToOtherWithout")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.wsatAppServiceOptional.web/", name = "sayHelloToOtherResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.wsatAppServiceOptional.web/", name = "sayHelloToOther")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.wsatAppServiceOptional.web/", name = "sayHelloResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.wsatAppServiceOptional.web/", name = "sayHello")
