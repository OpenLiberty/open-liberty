...
/**
 * Extends {@link ServerBootstrap} to allow configuration via a {@link ServerBootstrapConfiguration} 
 */
public class ServerBootstrapExtended extends ServerBootstrap {

    private ServerBootstrapConfiguration config;
    private ChannelInitializerWrapper initializer;

    /**
     * Apply the given {@link ServerBootstrapConfiguration} to this {@link ServerBootstrap}
     * Note that most props are implemented via handlers, see {@link TCPChannelInitializerImpl}
     * 
     * @param config
     */
    public void applyConfiguration(ServerBootstrapConfiguration config) {
        this.config = config;
     ...
     */
    public ServerBootstrapConfiguration getConfiguration() {
        return config;
    }
