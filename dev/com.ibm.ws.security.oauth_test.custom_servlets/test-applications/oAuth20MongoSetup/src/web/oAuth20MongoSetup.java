...
public class oAuth20MongoSetup extends HttpServlet {
	...
	private JSONObject buildClientMetaData(String clientId, String redirectUri, String introspectTokens)
			throws Exception {
	...
	private void connect(String dbName, String dbUser, String dbHost, String dbPort, String dbPwd) {
		...
		try {
			...
			mongoClient = new MongoClient(new ServerAddress(dbHost, Integer.parseInt(dbPort)), credentials,
					clientOptions);
