...
public class LooseConfigTest extends CachingTest {
    ...
    public static void setUp() throws Exception {
        LOG.info("setUp LooseConfigTest");
    ...
    public static void deployLooseApplication() throws IOException {
        ...
        copyFile(APP_SOURCE + "" + earFileName,   sharedServer.getLibertyServer().getServerRoot() + "/apps/");
    }
