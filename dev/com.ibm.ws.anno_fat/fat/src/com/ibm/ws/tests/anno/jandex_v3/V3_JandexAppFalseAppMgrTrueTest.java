...
public class V3_JandexAppFalseAppMgrTrueTest extends V3_JandexAppTest {
    private static final Logger LOG = Logger.getLogger(V3_JandexAppFalseAppMgrTrueTest.class.getName());
    ...
    public static void setUp() throws Exception {
        V3_JandexAppTest.setUp(LOG, SHARED_SERVER, "jandexAppFalseAppMgrTrue_server.xml", null);
    }
