...
public class V3_JandexAppDefaultAppMgrDefaultTest extends V3_JandexAppTest {
    private static final Logger LOG = Logger.getLogger(V3_JandexAppDefaultAppMgrDefaultTest.class.getName());
    ...
    public static void setUp() throws Exception {
        V3_JandexAppTest.setUp(LOG, SHARED_SERVER, "jandexAppDefaultAppMgrDefault_server.xml", null);
    }
