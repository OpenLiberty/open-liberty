...
public class V3_JandexAppTrueAppMgrTrueTest extends V3_JandexAppTest {
    private static final Logger LOG = Logger.getLogger(V3_JandexAppTrueAppMgrTrueTest.class.getName());
    ...
    public static void setUp() throws Exception {
        V3_JandexAppTest.setUp(LOG, SHARED_SERVER, "jandexAppTrueAppMgrTrue_server.xml", null);
    }
    ...
    public void trueTrue_testJandex() throws Exception {
        super.testJandex(V3_JandexAppTest.DO_EXPECT_JANDEX);
    }
}
