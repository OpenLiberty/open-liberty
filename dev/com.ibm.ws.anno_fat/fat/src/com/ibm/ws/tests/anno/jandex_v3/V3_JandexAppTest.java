 ...
 */
public abstract class V3_JandexAppTest extends LoggingTest {
    /**
    ...
    public static void setUp(
        ...
        AppPackagingHelper.addEarToServerApps(
            ...
            "V3JandexTestServlet40.ear", // earName
            true, // addEarResources
            "V3JandexTestServlet40.war", // warName
            true, // addWarResources
            "V3JandexTestServlet40.jar", // jarName
            true, // addJarResources
            "testservlet40_v3.war.servlets", "testservlet40_v3.jar.servlets"); // packageNames

        logger.info("setUp: Added V3JandexTestServlet40 to the server applications folder");
        ...
        sharedServer.getLibertyServer().addInstalledAppForValidation("V3JandexTestServlet40");
    ...
    public static final String SOURCE_PATH = "publish/servers/v3_annoFat_server/config";
