...
import io.openliberty.microprofile.health31.spi.impl.HealthCheck31ResponseProviderImpl;
...
public class HealthCheck31ResponseTest {
    ...
    */
    ...
    public void testSetProvider() throws Exception {
        ...
        HealthCheckResponseProvider provider = new HealthCheck31ResponseProviderImpl();
