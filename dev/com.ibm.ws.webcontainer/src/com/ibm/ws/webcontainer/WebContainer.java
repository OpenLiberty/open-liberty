        ...
        try {
            ...
            if (isServlet60orAbove) {
                ...
                try {
                    ...
                    logger.logp(Level.INFO, CLASS_NAME, "handleRequest", "canonicalize sending 400 [" + ioe.getMessage() + "]");
            ...
            // End 293696 ServletRequest.getPathInfo() fails WASCC.web.webcontainereve
...
//	CODE REVIEW END
    ...
    //This method will be after the URI is decoded
