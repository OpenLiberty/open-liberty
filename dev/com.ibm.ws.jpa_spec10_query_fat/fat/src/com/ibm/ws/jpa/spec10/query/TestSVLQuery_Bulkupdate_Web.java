...
package com.ibm.ws.jpa.spec10.query;
...
import com.ibm.ws.query.web.JUBulkUpdateTestServlet;
...
@Mode(TestMode.FULL)
public class TestSVLQuery_Bulkupdate_Web extends JPAFATServletClient {
    ...
    @Server("JPA10SVLQueryBulkUpdateServer")
    @TestServlets({
                    @TestServlet(servlet = JUBulkUpdateTestServlet.class, path = "svlquery" + "/" + "JUBulkUpdateTestServlet"),
    })
    ...
    public static void setUp() throws Exception {
        ...
        bannerStart(TestSVLQuery_Bulkupdate_Web.class);
        ...
        System.out.println(TestSVLQuery_Bulkupdate_Web.class.getName() + " Setting up database tables...");
...
//        executeDDL(server, ddlSet, false);
        ...
        final String pathAndQuery = "svlquery" + "/" + "JUBulkUpdateTestServlet" + "?setupDB=true";
...
//                executeDDL(server, ddlSet, true);
            ...
            bannerEnd(TestSVLQuery_Bulkupdate_Web.class, timestart);
        }
    }
}
