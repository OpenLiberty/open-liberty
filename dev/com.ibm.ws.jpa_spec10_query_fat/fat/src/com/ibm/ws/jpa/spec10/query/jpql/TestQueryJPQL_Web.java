...
package com.ibm.ws.jpa.spec10.query.jpql;
...
import com.ibm.ws.jpa.query.jpql.web.TestJPQLServlet;
...
@Mode(TestMode.FULL)
public class TestQueryJPQL_Web extends JPAFATServletClient {
    private final static String queryAppFolder = "jpql";
    private final static String RESOURCE_ROOT = "test-applications/query/" + queryAppFolder + "/";
    private final static String appName = "jpql";
    ...
    @TestServlets({
                    @TestServlet(servlet = TestJPQLServlet.class, path = "jpql" + "/" + "TestJPQLServlet"),
    ...
    public static void setUp() throws Exception {
        ...
        bannerStart(TestQueryJPQL_Web.class);
        ...
        System.out.println("TestQueryJPQL_Web Setting up database tables...");
    ...
    private static void setupTestApplication() throws Exception {
        ...
        webApp.addPackages(true, "com.ibm.ws.jpa.query.jpql.model");
        webApp.addPackages(true, "com.ibm.ws.jpa.query.jpql.testlogic");
        webApp.addPackages(true, "com.ibm.ws.jpa.query.jpql.web");
...
//        loader.getCommonLibraryRefs().add("HibernateLib");
    ...
    public static void tearDown() throws Exception {
        try {
            ...
            bannerEnd(TestQueryJPQL_Web.class, timestart);
        }
