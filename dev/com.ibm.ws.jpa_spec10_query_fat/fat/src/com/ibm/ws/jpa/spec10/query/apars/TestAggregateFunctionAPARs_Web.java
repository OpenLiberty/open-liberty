...
import com.ibm.ws.jpa.query.aggregate_functions.web.APARAggregateFunctionsTestServlet;
...
@Mode(TestMode.FULL)
public class TestAggregateFunctionAPARs_Web extends JPAFATServletClient {
    private final static String RESOURCE_ROOT = "test-applications/apars/";
    private final static String appName = "AggregateFunctions";
    ...
    @TestServlets({
                    @TestServlet(servlet = APARAggregateFunctionsTestServlet.class, path = "APAR_AggregateFunctions" + "/" + "APARAggregateFunctionsTestServlet"),
    ...
    public static void setUp() throws Exception {
        ...
        bannerStart(TestAggregateFunctionAPARs_Web.class);
        ...
        System.out.println("TestAggregateFunctionAPARs_Web Setting up database tables...");
    ...
    private static void setupTestApplication() throws Exception {
        ...
        webApp.addPackages(true, "com.ibm.ws.jpa.query.aggregate_functions.model");
        webApp.addPackages(true, "com.ibm.ws.jpa.query.aggregate_functions.testlogic");
        webApp.addPackages(true, "com.ibm.ws.jpa.query.aggregate_functions.web");
...
//        loader.getCommonLibraryRefs().add("HibernateLib");
    ...
    public static void tearDown() throws Exception {
        try {
            ...
            bannerEnd(TestAggregateFunctionAPARs_Web.class, timestart);
        }
