...
package com.ibm.ws.jpa.spec10.query.aggregatefunctions;
...
import com.ibm.ws.jpa.query.aggregatefunctions.web.TestAggregateFunctionTestServlet;
...
@Mode(TestMode.FULL)
public class TestQueryAggregateFunctions_Web extends JPAFATServletClient {
    private final static String queryAppFolder = "aggregate_functions";
    private final static String RESOURCE_ROOT = "test-applications/query/" + queryAppFolder + "/";
    private final static String appName = "AggregateFunctionQuery_Web";
    ...
    @TestServlets({
                    @TestServlet(servlet = TestAggregateFunctionTestServlet.class, path = "JPAQueryAggregateFunctions" + "/" + "TestAggregateFunctionTestServlet"),
    ...
    public static void setUp() throws Exception {
        ...
        bannerStart(TestQueryAggregateFunctions_Web.class);
    ...
    private static void setupTestApplication() throws Exception {
        ...
        webApp.addPackages(true, "com.ibm.ws.jpa.query.aggregatefunctions.model");
        webApp.addPackages(true, "com.ibm.ws.jpa.query.aggregatefunctions.testlogic");
        webApp.addPackages(true, "com.ibm.ws.jpa.query.aggregatefunctions.web");
...
//        loader.getCommonLibraryRefs().add("HibernateLib");
    ...
    public static void tearDown() throws Exception {
        try {
            ...
            bannerEnd(TestQueryAggregateFunctions_Web.class, timestart);
        }
