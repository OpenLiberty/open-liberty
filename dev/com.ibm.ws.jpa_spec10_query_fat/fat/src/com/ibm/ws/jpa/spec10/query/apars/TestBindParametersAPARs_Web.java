...
import com.ibm.ws.jpa.query.bindparameters.web.BindParametersTestServlet;
...
@Mode(TestMode.FULL)
public class TestBindParametersAPARs_Web extends JPAFATServletClient {
    private final static String RESOURCE_ROOT = "test-applications/apars/";
    private final static String appName = "BindParameters";
    ...
    @TestServlets({
                    @TestServlet(servlet = BindParametersTestServlet.class, path = "APAR_BindParameters" + "/" + "BindParametersTestServlet"),
    ...
    public static void setUp() throws Exception {
        ...
        bannerStart(TestBindParametersAPARs_Web.class);
    ...
    private static void setupTestApplication() throws Exception {
        ...
        webApp.addPackages(true, "com.ibm.ws.jpa.query.bindparameters.model");
        webApp.addPackages(true, "com.ibm.ws.jpa.query.bindparameters.testlogic");
        webApp.addPackages(true, "com.ibm.ws.jpa.query.bindparameters.web");
...
//        loader.getCommonLibraryRefs().add("HibernateLib");
    ...
    public static void tearDown() throws Exception {
        try {
            ...
            bannerEnd(TestBindParametersAPARs_Web.class, timestart);
        }
