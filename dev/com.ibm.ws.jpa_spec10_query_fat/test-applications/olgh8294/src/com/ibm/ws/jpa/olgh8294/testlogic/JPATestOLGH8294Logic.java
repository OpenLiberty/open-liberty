...
public class JPATestOLGH8294Logic extends AbstractTestLogic {
    ...
    //TODO: support for COALESCE function was added in JPA 2.0. Move this test.
    public void testCOALESCE(TestExecutionContext testExecCtx, TestExecutionResources testExecResources,
        ...
        //This test relies on EclipseLink Session Customizers to run
        if (!(getJPAProviderImpl(jpaResource).equals(JPAProviderImpl.ECLIPSELINK))) {
            System.out.println("This test is invalid for providers other than EclipseLink");
            return;
        }
        ...
        try {
            ...
            {
                System.out.println("testCOALESCE Test #001");
            ...
            // Expecting query parameter binding to not be set
            {
                System.out.println("testCOALESCE Test #002");
                SQLListener.getAndClear();
            ...
            // Expecting query parameter binding to not be set
            {
                System.out.println("testCOALESCE Test #003");
                SQLListener.getAndClear();
    ...
    public void testABS(TestExecutionContext testExecCtx, TestExecutionResources testExecResources,
                        Object managedComponentObject) {
        final String testName = getTestName();
        ...
        try {
            ...
            // Expecting query parameter binding to not be set
            {
                System.out.println("testABS Test #001");
                SQLListener.getAndClear();
            ...
            // Expecting query parameter binding to not be set
            {
                System.out.println("testABS Test #002");
                SQLListener.getAndClear();
    ...
    public void testCONCAT(TestExecutionContext testExecCtx, TestExecutionResources testExecResources,
                           Object managedComponentObject) {
        final String testName = getTestName();
        ...
        try {
            ...
            {
                System.out.println("testCONCAT Test #001");
                SQLListener.getAndClear();
            ...
            {
                System.out.println("testCONCAT Test #002");
                SQLListener.getAndClear();
    ...
    public void testEXISTS(TestExecutionContext testExecCtx, TestExecutionResources testExecResources,
                           Object managedComponentObject) {
        final String testName = getTestName();
        ...
        try {
            ...
            {
                System.out.println("testEXISTS Test #001");
                SQLListener.getAndClear();
...
//                Assert.assertEquals("Expecting 1 entries in the result list", 1, resultList.size());
            ...
            {
                System.out.println("testEXISTS Test #002");
                SQLListener.getAndClear();
    ...
    public void testNUMERICALEXPRESSION(TestExecutionContext testExecCtx, TestExecutionResources testExecResources,
                                        Object managedComponentObject) {
        final String testName = getTestName();
        ...
        try {
            ...
            {
                System.out.println("testNUMERICALEXPRESSION Test #001");
                SQLListener.getAndClear();
            ...
            {
                System.out.println("testNUMERICALEXPRESSION Test #002");
                SQLListener.getAndClear();
            ...
            {
                System.out.println("testNUMERICALEXPRESSION Test #003");
                SQLListener.getAndClear();
                String queryStr = "SELECT (s.itemInteger1 + 4) FROM SimpleEntityOLGH8294 s " +
    ...
    public void testIN(TestExecutionContext testExecCtx, TestExecutionResources testExecResources,
                       Object managedComponentObject) {
        final String testName = getTestName();
        ...
        try {
            ...
            {
                System.out.println("testIN Test #001");
                SQLListener.getAndClear();
                String queryStr = "SELECT 2 FROM SimpleEntityOLGH8294 s " +
                                  "WHERE ?1 IN (?2, ?3, ?4)";
                Query query = em.createQuery(queryStr);
            ...
            {
                System.out.println("testIN Test #002");
                SQLListener.getAndClear();
            ...
            {
                System.out.println("testIN Test #003");
                SQLListener.getAndClear();
                String queryStr = "SELECT 2 FROM SimpleEntityOLGH8294 s " +
                                  "WHERE ?1 IN (5, ?2, 6)";
                Query query = em.createQuery(queryStr);
            ...
            {
                System.out.println("testIN Test #004");
                SQLListener.getAndClear();
                String queryStr = "SELECT 2 FROM SimpleEntityOLGH8294 s " +
    ...
    public void testLIKE(TestExecutionContext testExecCtx, TestExecutionResources testExecResources,
                         Object managedComponentObject) {
        final String testName = getTestName();
        ...
        try {
            ...
            {
                System.out.println("testLIKE Test #001");
                SQLListener.getAndClear();
            ...
            // is not an untyped parameter marker
            {
                System.out.println("testLIKE Test #002");
                SQLListener.getAndClear();
                String queryStr = "SELECT 1 FROM SimpleEntityOLGH8294 s " +
    ...
    public void testSUBSTR(TestExecutionContext testExecCtx, TestExecutionResources testExecResources,
                           Object managedComponentObject) {
        final String testName = getTestName();
        ...
        try {
            ...
            {
                System.out.println("testSUBSTR Test #001");
                SQLListener.getAndClear();
                String queryStr = "SELECT 1 FROM SimpleEntityOLGH8294 s " +
            ...
            {
                System.out.println("testSUBSTR Test #002");
                SQLListener.getAndClear();
                String queryStr = "SELECT 1 FROM SimpleEntityOLGH8294 s " +
            ...
            {
                System.out.println("testSUBSTR Test #003");
                SQLListener.getAndClear();
                String queryStr = "SELECT 1 FROM SimpleEntityOLGH8294 s " +
            ...
            {
                System.out.println("testSUBSTR Test #004");
                SQLListener.getAndClear();
                String queryStr = "SELECT 1 FROM SimpleEntityOLGH8294 s " +
