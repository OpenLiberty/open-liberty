...
public class CheckpointSessionCacheTwoServerTest extends FATServletClient {
    ...
    public static final String checkpointServerA = "com.ibm.ws.session.cache.fat.infinispan.container.checkpointServerA";

    public static final String checkpointServerB = "com.ibm.ws.session.cache.fat.infinispan.container.checkpointServerB";
