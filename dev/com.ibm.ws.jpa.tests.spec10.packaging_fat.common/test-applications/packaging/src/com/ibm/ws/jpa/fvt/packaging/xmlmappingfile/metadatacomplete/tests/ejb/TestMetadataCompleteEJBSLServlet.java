...
@WebServlet(urlPatterns = "/TestMetadataCompleteEJBSLServlet")
public class TestMetadataCompleteEJBSLServlet extends EJBDBTestVehicleServlet {

    @PostConstruct
    private void initFAT() {
        testClassName = MetadataCompleteTestLogic.class.getName();
        ejbJNDIName = "ejb/MetadataCompleteSLEJB";
    ...
    public void jpa10_Packaging_MetadataComplete_Test001_AMJTA_EJBSL() throws Exception {
        final String testName = "jpa10_Packaging_MetadataComplete_Test001_AMJTA_EJBSL";
    ...
    @Test
    public void jpa10_Packaging_MetadataComplete_Test001_AMRL_EJBSL() throws Exception {
        final String testName = "jpa10_Packaging_MetadataComplete_Test001_AMRL_EJBSL";
        final String testMethod = "executeMetadataCompleteTest001";
    ...
    @Test
    @ExpectedFFDC("javax.transaction.RollbackException")
    public void jpa10_Packaging_MetadataComplete_Test001_CMTS_EJBSL() throws Exception {
        final String testName = "jpa10_Packaging_MetadataComplete_Test001_CMTS_EJBSL";
        final String testMethod = "executeMetadataCompleteTest001";
