...
public class IDPInitiatedLogin_servletRequestLogout_spLogoutTrue_Tests extends OneServerSPCookieLogoutTests {

    private static final Class<?> thisClass = IDPInitiatedLogin_servletRequestLogout_spLogoutTrue_Tests.class;
    ...
    public static void setupBeforeTest() throws Exception {
        ...
        setLogoutFlowSettings(testSettings, SAMLConstants.IDP_INITIATED, SAMLConstants.HTTPSERVLET_INITIATED, LOGOUT_INVOLVES_IDP);
