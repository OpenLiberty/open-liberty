...
public class IDPInitiatedLogin_2ServerLogout_usingApps_Tests extends TwoServerLogoutTests {

    private static final Class<?> thisClass = IDPInitiatedLogin_2ServerLogout_usingApps_Tests.class;
    ...
    @Test
    public void IDPInitiatedLogin_2ServerLogout_usingApps_Tests_ibmSecurityLogout_spLogoutFalse_sameUser() throws Exception {

        testUsers = new Testusers(UserType.SAME);
        reconfigServers(server1MasterConfig, server2MasterConfig);
        test_logout_with_multipleSPs_on_2Servers(SAMLConstants.IDP_INITIATED, SAMLConstants.IBMSECURITYLOGOUT_INITIATED, LogoutStaysInSPOnly);

    }

    @Test
    public void IDPInitiatedLogin_2ServerLogout_usingApps_Tests_ibmSecurityLogout_spLogoutFalse_differentUsers() throws Exception {
    ...
    @Test
    public void IDPInitiatedLogin_2ServerLogout_usingApps_Tests_ibmSecurityLogout_spLogoutFalse_tryToUseSPServer2CookieAfterLogout() throws Exception {

        testUsers = new Testusers(UserType.SAME);
        reconfigServers(server1MasterConfig, server2MasterConfig);
        test_usingCookieAfterLogout(SAMLConstants.IDP_INITIATED, SAMLConstants.IBMSECURITYLOGOUT_INITIATED, LogoutStaysInSPOnly);

    }

    @Test
    public void IDPInitiatedLogin_2ServerLogout_usingApps_Tests_ibmSecurityLogout_spLogoutTrue_sameUser() throws Exception {

        reconfigServers(server1OtherConfig, server2OtherConfig);
        test_logout_with_multipleSPs_on_2Servers(SAMLConstants.IDP_INITIATED, SAMLConstants.IBMSECURITYLOGOUT_INITIATED, LOGOUT_INVOLVES_IDP);

    }

    @Mode(TestMode.LITE)
    @Test
    public void IDPInitiatedLogin_2ServerLogout_usingApps_Tests_ibmSecurityLogout_spLogoutTrue_differentUsers() throws Exception {
    ...
    @Test
    public void IDPInitiatedLogin_2ServerLogout_usingApps_Tests_ibmSecurityLogout_spLogoutTrue_tryToUseSPServer2CookieAfterLogout() throws Exception {

        reconfigServers(server1OtherConfig, server2OtherConfig);
        test_usingCookieAfterLogout(SAMLConstants.IDP_INITIATED, SAMLConstants.IBMSECURITYLOGOUT_INITIATED, LOGOUT_INVOLVES_IDP);
