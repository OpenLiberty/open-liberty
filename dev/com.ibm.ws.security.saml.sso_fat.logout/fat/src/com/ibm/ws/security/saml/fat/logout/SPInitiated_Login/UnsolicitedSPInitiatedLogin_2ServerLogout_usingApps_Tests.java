...
public class UnsolicitedSPInitiatedLogin_2ServerLogout_usingApps_Tests extends TwoServerLogoutTests {

    private static final Class<?> thisClass = UnsolicitedSPInitiatedLogin_2ServerLogout_usingApps_Tests.class;
    ...
    @Test
    public void UnsolicitedSPInitiatedLogin_2ServerLogout_usingApps_Tests_ibmSecurityLogout_spLogoutTrue_sameUser() throws Exception {

        reconfigServers(server1OtherConfig, server2OtherConfig);
        test_logout_with_multipleSPs_on_2Servers(SAMLConstants.UNSOLICITED_SP_INITIATED, SAMLConstants.IBMSECURITYLOGOUT_INITIATED, LOGOUT_INVOLVES_IDP);

    }

    @Test
    public void UnsolicitedSPInitiatedLogin_2ServerLogout_usingApps_Tests_ibmSecurityLogout_spLogoutTrue_differentUsers() throws Exception {
    ...
    @Test
    public void UnsolicitedSPInitiatedLogin_2ServerLogout_usingApps_Tests_ibmSecurityLogout_spLogoutTrue_tryToUseSPServer2CookieAfterLogout() throws Exception {

        reconfigServers(server1OtherConfig, server2OtherConfig);
        test_usingCookieAfterLogout(SAMLConstants.UNSOLICITED_SP_INITIATED, SAMLConstants.IBMSECURITYLOGOUT_INITIATED, LOGOUT_INVOLVES_IDP);
