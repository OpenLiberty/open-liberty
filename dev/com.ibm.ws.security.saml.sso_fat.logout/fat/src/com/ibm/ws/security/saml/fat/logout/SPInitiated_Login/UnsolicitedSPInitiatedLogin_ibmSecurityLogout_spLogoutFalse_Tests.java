...
public class UnsolicitedSPInitiatedLogin_ibmSecurityLogout_spLogoutFalse_Tests extends OneServerSPCookieLogoutTests {

    private static final Class<?> thisClass = UnsolicitedSPInitiatedLogin_ibmSecurityLogout_spLogoutFalse_Tests.class;
    ...
    public static void setupBeforeTest() throws Exception {
        ...
        startSPWithIDPServer("com.ibm.ws.security.saml.sso_fat.logout", "server_SPLogoutFalse" + cookieInfo.getCookieFileExtension() + "_unsolicited_multiApp.xml", extraMsgs, extraApps, true);
        ...
        setLogoutFlowSettings(testSettings, SAMLConstants.UNSOLICITED_SP_INITIATED, SAMLConstants.IBMSECURITYLOGOUT_INITIATED, LogoutStaysInSPOnly);
