...
public class SolicitedSPInitiatedLogin_ibmSecurityLogout_spLogoutTrue_Tests extends OneServerSPCookieLogoutTests {

    private static final Class<?> thisClass = SolicitedSPInitiatedLogin_ibmSecurityLogout_spLogoutTrue_Tests.class;
    ...
    public static void setupBeforeTest() throws Exception {
        ...
        startSPWithIDPServer("com.ibm.ws.security.saml.sso_fat.logout", "server_SPLogoutTrue" + cookieInfo.getCookieFileExtension() + "_multiApp.xml", extraMsgs, extraApps, true);
        ...
        setLogoutFlowSettings(testSettings, SAMLConstants.SOLICITED_SP_INITIATED, SAMLConstants.IBMSECURITYLOGOUT_INITIATED, LOGOUT_INVOLVES_IDP);
