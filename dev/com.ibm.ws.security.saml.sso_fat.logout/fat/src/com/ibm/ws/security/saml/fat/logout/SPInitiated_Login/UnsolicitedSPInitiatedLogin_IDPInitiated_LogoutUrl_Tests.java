...
public class UnsolicitedSPInitiatedLogin_IDPInitiated_LogoutUrl_Tests extends OneServerSPCookieLogoutTests {

    private static final Class<?> thisClass = UnsolicitedSPInitiatedLogin_IDPInitiated_LogoutUrl_Tests.class;
    ...
    public static void setupBeforeTest() throws Exception {
        ...
        setLogoutFlowSettings(testSettings, SAMLConstants.UNSOLICITED_SP_INITIATED, SAMLConstants.IDP_INITIATED, LOGOUT_INVOLVES_IDP);
