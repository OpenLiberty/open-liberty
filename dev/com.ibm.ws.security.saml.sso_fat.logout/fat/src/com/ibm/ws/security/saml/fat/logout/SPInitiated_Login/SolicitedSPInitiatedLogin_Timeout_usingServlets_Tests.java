...
public class SolicitedSPInitiatedLogin_Timeout_usingServlets_Tests extends TimeoutTests {

    private static final Class<?> thisClass = SolicitedSPInitiatedLogin_Timeout_usingServlets_Tests.class;
    ...
    @Test
    public void SolicitedSPInitiatedLogin_Timeout_usingServlets_Tests_IDPInitiated_LogoutUrl_IDPSessionTimeout() throws Exception {

        testSAMLServer.reconfigServer(serverMasterConfig, _testName, null, SAMLConstants.JUNIT_REPORTING);
        test_logoutAfterIDPSessionExpires(SAMLConstants.SOLICITED_SP_INITIATED, SAMLConstants.IDP_INITIATED, LOGOUT_INVOLVES_IDP, null);
    }

    @Test
    public void SolicitedSPInitiatedLogin_Timeout_usingServlets_Tests_IDPInitiated_LogoutUrl_SPSessionTimeout() throws Exception {

        testSAMLServer.reconfigServer(serverMasterConfig, _testName, null, SAMLConstants.JUNIT_REPORTING);
        test_logoutAfterSAMLTokenExpires(SAMLConstants.SOLICITED_SP_INITIATED, SAMLConstants.IDP_INITIATED, LOGOUT_INVOLVES_IDP, null);
    }

    @Test
    public void SolicitedSPInitiatedLogin_Timeout_usingServlets_Tests_servletRequestLogout_spLogoutFalse_IDPSessionTimeout() throws Exception {

        testSAMLServer.reconfigServer(serverMasterConfig, _testName, null, SAMLConstants.JUNIT_REPORTING);
        test_logoutAfterIDPSessionExpires(SAMLConstants.SOLICITED_SP_INITIATED, SAMLConstants.HTTPSERVLET_INITIATED, LogoutStaysInSPOnly, null);

    }

    @Test
    public void SolicitedSPInitiatedLogin_Timeout_usingServlets_Tests_servletRequestLogout_spLogoutFalse_SPSessionTimeout() throws Exception {

        testSAMLServer.reconfigServer(serverMasterConfig, _testName, null, SAMLConstants.JUNIT_REPORTING);
        test_logoutAfterSAMLTokenExpires(SAMLConstants.SOLICITED_SP_INITIATED, SAMLConstants.HTTPSERVLET_INITIATED, LogoutStaysInSPOnly, null);

    }

    @Test
    public void SolicitedSPInitiatedLogin_Timeout_usingServlets_Tests_servletRequestLogout_spLogoutTrue_IDPSessionTimeout() throws Exception {

        testSAMLServer.reconfigServer(serverOtherConfig, _testName, null, SAMLConstants.JUNIT_REPORTING);
        test_logoutAfterIDPSessionExpires(SAMLConstants.SOLICITED_SP_INITIATED, SAMLConstants.HTTPSERVLET_INITIATED, LOGOUT_INVOLVES_IDP, null);

    }

    @ExpectedFFDC(value = { "com.ibm.ws.security.saml.error.SamlException" })
    @Test
    public void SolicitedSPInitiatedLogin_Timeout_usingServlets_Tests_servletRequestLogout_spLogoutTrue_SPSessionTimeout() throws Exception {

        String[] flowOverride = { SAMLConstants.PERFORM_SP_LOGOUT };
        testSAMLServer.reconfigServer(serverOtherConfig, _testName, null, SAMLConstants.JUNIT_REPORTING);
        test_logoutAfterSAMLTokenExpires(SAMLConstants.SOLICITED_SP_INITIATED, SAMLConstants.HTTPSERVLET_INITIATED, LOGOUT_INVOLVES_IDP, flowOverride);
