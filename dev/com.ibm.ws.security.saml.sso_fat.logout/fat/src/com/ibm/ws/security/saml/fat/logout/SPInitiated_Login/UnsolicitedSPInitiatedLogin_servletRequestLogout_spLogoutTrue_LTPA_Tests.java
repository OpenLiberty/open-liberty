...
public class UnsolicitedSPInitiatedLogin_servletRequestLogout_spLogoutTrue_LTPA_Tests extends OneServerLTPALogoutTests {

    private static final Class<?> thisClass = UnsolicitedSPInitiatedLogin_servletRequestLogout_spLogoutTrue_LTPA_Tests.class;
    ...
    public static void setupBeforeTest() throws Exception {
        ...
        startSPWithIDPServer("com.ibm.ws.security.saml.sso_fat.logout", "server_SPLogoutTrue" + cookieInfo.getCookieFileExtension() + "_unsolicited.xml", extraMsgs, extraApps, true);
        ...
        setLogoutFlowSettings(testSettings, SAMLConstants.UNSOLICITED_SP_INITIATED, SAMLConstants.HTTPSERVLET_INITIATED, LOGOUT_INVOLVES_IDP);
