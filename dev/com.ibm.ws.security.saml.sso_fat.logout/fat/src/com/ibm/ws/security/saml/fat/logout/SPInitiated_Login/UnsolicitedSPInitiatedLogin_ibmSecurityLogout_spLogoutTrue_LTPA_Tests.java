...
public class UnsolicitedSPInitiatedLogin_ibmSecurityLogout_spLogoutTrue_LTPA_Tests extends OneServerLTPALogoutTests {

    private static final Class<?> thisClass = UnsolicitedSPInitiatedLogin_ibmSecurityLogout_spLogoutTrue_LTPA_Tests.class;
    ...
    public static void setupBeforeTest() throws Exception {
        ...
        startSPWithIDPServer("com.ibm.ws.security.saml.sso_fat.logout", "server_SPLogoutTrue" + cookieInfo.getCookieFileExtension() + "_unsolicited_multiApp.xml", extraMsgs, extraApps, true);
        ...
        setLogoutFlowSettings(testSettings, SAMLConstants.UNSOLICITED_SP_INITIATED, SAMLConstants.IBMSECURITYLOGOUT_INITIATED, LOGOUT_INVOLVES_IDP);
