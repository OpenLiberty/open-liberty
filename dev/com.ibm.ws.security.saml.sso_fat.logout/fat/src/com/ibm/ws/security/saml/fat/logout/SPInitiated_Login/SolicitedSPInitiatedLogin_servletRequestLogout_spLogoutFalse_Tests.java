...
public class SolicitedSPInitiatedLogin_servletRequestLogout_spLogoutFalse_Tests extends OneServerSPCookieLogoutTests {

    private static final Class<?> thisClass = SolicitedSPInitiatedLogin_servletRequestLogout_spLogoutFalse_Tests.class;
    ...
    public static void setupBeforeTest() throws Exception {
        ...
        setLogoutFlowSettings(testSettings, SAMLConstants.SOLICITED_SP_INITIATED, SAMLConstants.HTTPSERVLET_INITIATED, LogoutStaysInSPOnly);
