...
public class IDPInitiatedLogin_IDPInitiated_LogoutUrl_Tests extends OneServerSPCookieLogoutTests {

    private static final Class<?> thisClass = IDPInitiatedLogin_IDPInitiated_LogoutUrl_Tests.class;
