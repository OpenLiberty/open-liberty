...
public class UnsolicitedSPInitiatedLogin_Timeout_usingApps_Tests extends TimeoutTests {

    private static final Class<?> thisClass = UnsolicitedSPInitiatedLogin_Timeout_usingApps_Tests.class;
    ...
    @Test
    public void UnsolicitedSPInitiatedLogin_Timeout_usingApps_Tests_ibmSecurityLogout_spLogoutTrueIDPPSessionTimeout() throws Exception {
        ...
        test_logoutAfterIDPSessionExpires(SAMLConstants.UNSOLICITED_SP_INITIATED, SAMLConstants.IBMSECURITYLOGOUT_INITIATED, LOGOUT_INVOLVES_IDP, flowOverride);
    }

    @Mode(TestMode.LITE)
    @ExpectedFFDC(value = { "com.ibm.ws.security.saml.error.SamlException" })
    @Test
    public void UnsolicitedSPInitiatedLogin_Timeout_usingApps_Tests_ibmSecurityLogout_spLogoutTrue_SPSessionTimeout() throws Exception {

        String[] flowOverride = { SAMLConstants.PERFORM_SP_LOGOUT };
        testSAMLServer.reconfigServer(serverOtherConfig, _testName, null, SAMLConstants.JUNIT_REPORTING);
        test_logoutAfterSAMLTokenExpires(SAMLConstants.UNSOLICITED_SP_INITIATED, SAMLConstants.IBMSECURITYLOGOUT_INITIATED, LOGOUT_INVOLVES_IDP, flowOverride);
    }
