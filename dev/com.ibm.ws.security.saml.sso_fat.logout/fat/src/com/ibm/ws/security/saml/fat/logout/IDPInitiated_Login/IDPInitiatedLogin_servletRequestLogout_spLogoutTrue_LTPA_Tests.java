...
public class IDPInitiatedLogin_servletRequestLogout_spLogoutTrue_LTPA_Tests extends OneServerLTPALogoutTests {

    private static final Class<?> thisClass = IDPInitiatedLogin_servletRequestLogout_spLogoutTrue_LTPA_Tests.class;
