...
@Mode(TestMode.FULL)
public class SolicitedSPInitiatedLogin_servletRequestLogout_spLogoutTrue_LTPA_Tests extends OneServerLTPALogoutTests {

    private static final Class<?> thisClass = SolicitedSPInitiatedLogin_servletRequestLogout_spLogoutTrue_LTPA_Tests.class;
