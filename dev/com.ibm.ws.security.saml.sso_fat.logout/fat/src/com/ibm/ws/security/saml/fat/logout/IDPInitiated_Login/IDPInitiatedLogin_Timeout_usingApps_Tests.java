 ...
 * IDP Initiated Login is done, then ibm_security_logout with spLogout set to False and True are tested.
 */
@LibertyServerWrapper
@Mode(TestMode.FULL)
@RunWith(FATRunner.class)
public class IDPInitiatedLogin_Timeout_usingApps_Tests extends TimeoutTests {

    private static final Class<?> thisClass = IDPInitiatedLogin_Timeout_usingApps_Tests.class;
    ...
    @Test
    public void IDPInitiatedLogin_Timeout_usingApps_Tests_ibmSecurityLogout_spLogoutTrue_IDPSessionTimeout() throws Exception {
        ...
        test_logoutAfterIDPSessionExpires(SAMLConstants.IDP_INITIATED, SAMLConstants.IBMSECURITYLOGOUT_INITIATED, LOGOUT_INVOLVES_IDP, flowOverride);

    }

    @ExpectedFFDC(value = { "com.ibm.ws.security.saml.error.SamlException" })
    @Test
    public void IDPInitiatedLogin_Timeout_usingApps_Tests_ibmSecurityLogout_spLogoutTrue_SPSessionTimeout() throws Exception {

        String[] flowOverride = { SAMLConstants.PERFORM_SP_LOGOUT };
        testSAMLServer.reconfigServer(serverOtherConfig, _testName, null, SAMLConstants.JUNIT_REPORTING);
        test_logoutAfterSAMLTokenExpires(SAMLConstants.IDP_INITIATED, SAMLConstants.IBMSECURITYLOGOUT_INITIATED, LOGOUT_INVOLVES_IDP, flowOverride);
