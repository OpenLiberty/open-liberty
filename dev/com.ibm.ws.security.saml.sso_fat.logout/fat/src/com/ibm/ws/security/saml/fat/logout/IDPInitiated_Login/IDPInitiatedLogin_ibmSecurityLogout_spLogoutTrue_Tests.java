...
public class IDPInitiatedLogin_ibmSecurityLogout_spLogoutTrue_Tests extends OneServerSPCookieLogoutTests {

    private static final Class<?> thisClass = IDPInitiatedLogin_ibmSecurityLogout_spLogoutTrue_Tests.class;
    ...
    public static void setupBeforeTest() throws Exception {
        ...
        List<String> extraApps = setMultiAppsForValidation();
        ...
        // login is IDP initiated, logout starts on the SP, logout stays on the sp
        setLogoutFlowSettings(testSettings, SAMLConstants.IDP_INITIATED, SAMLConstants.IBMSECURITYLOGOUT_INITIATED, LOGOUT_INVOLVES_IDP);
