...
import com.ibm.ws.security.saml.fat.logout.common.OneServerSPCookieLogoutTests;
...
public class SolicitedSPInitiatedLogin_ibmSecurityLogout_spLogoutFalse_Tests extends OneServerSPCookieLogoutTests {

    private static final Class<?> thisClass = SolicitedSPInitiatedLogin_ibmSecurityLogout_spLogoutFalse_Tests.class;
    ...
    public static void setupBeforeTest() throws Exception {
        ...
        startSPWithIDPServer("com.ibm.ws.security.saml.sso_fat.logout", "server_SPLogoutFalse" + cookieInfo.getCookieFileExtension() + "_multiApp.xml", extraMsgs, extraApps, true);
        ...
        // login is SP initiated, logout starts on the SP using HTTPServletRequest.logout, logout stays on the sp
        setLogoutFlowSettings(testSettings, SAMLConstants.SOLICITED_SP_INITIATED, SAMLConstants.IBMSECURITYLOGOUT_INITIATED, LogoutStaysInSPOnly);
