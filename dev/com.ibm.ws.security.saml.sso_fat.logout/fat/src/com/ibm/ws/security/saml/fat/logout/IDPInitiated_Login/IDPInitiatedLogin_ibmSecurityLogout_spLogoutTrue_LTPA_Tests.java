...
public class IDPInitiatedLogin_ibmSecurityLogout_spLogoutTrue_LTPA_Tests extends OneServerLTPALogoutTests {

    private static final Class<?> thisClass = IDPInitiatedLogin_ibmSecurityLogout_spLogoutTrue_LTPA_Tests.class;
