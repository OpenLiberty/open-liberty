...
public class SolicitedSPInitiatedLogin_servletRequestLogout_spLogoutTrue_Tests extends OneServerSPCookieLogoutTests {

    private static final Class<?> thisClass = SolicitedSPInitiatedLogin_servletRequestLogout_spLogoutTrue_Tests.class;
    ...
    public static void setupBeforeTest() throws Exception {
        ...
        startSPWithIDPServer("com.ibm.ws.security.saml.sso_fat.logout", "server_SPLogoutTrue" + cookieInfo.getCookieFileExtension() + ".xml", extraMsgs, extraApps, true);
        ...
        setLogoutFlowSettings(testSettings, SAMLConstants.SOLICITED_SP_INITIATED, SAMLConstants.HTTPSERVLET_INITIATED, LOGOUT_INVOLVES_IDP);
