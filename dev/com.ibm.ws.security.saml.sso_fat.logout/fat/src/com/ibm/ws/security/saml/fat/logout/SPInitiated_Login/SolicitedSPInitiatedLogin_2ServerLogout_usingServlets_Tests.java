...
public class SolicitedSPInitiatedLogin_2ServerLogout_usingServlets_Tests extends TwoServerLogoutTests {

    private static final Class<?> thisClass = SolicitedSPInitiatedLogin_2ServerLogout_usingServlets_Tests.class;
    ...
    @Mode(TestMode.LITE)
    @Test
    public void SolicitedSPInitiatedLogin_2ServerLogout_usingServlets_Tests_IDPInitiated_LogoutUrl_differentUsers() throws Exception {
    ...
    @Test
    public void SolicitedSPInitiatedLogin_2ServerLogout_usingServlets_Tests_servletRequestLogout_spLogoutTrue_sameUser() throws Exception {

        reconfigServers(server1OtherConfig, server2OtherConfig);
        test_logout_with_multipleSPs_on_2Servers(SAMLConstants.SOLICITED_SP_INITIATED, SAMLConstants.HTTPSERVLET_INITIATED, LOGOUT_INVOLVES_IDP);

    }

    @Test
    public void SolicitedSPInitiatedLogin_2ServerLogout_usingServlets_Tests_servletRequestLogout_spLogoutTrue_differentUsers() throws Exception {
    ...
    @Test
    public void SolicitedSPInitiatedLogin_2ServerLogout_usingServlets_Tests_servletRequestLogout_spLogoutTrue_tryToUseSPServer2CookieAfterLogout() throws Exception {

        reconfigServers(server1OtherConfig, server2OtherConfig);
        test_usingCookieAfterLogout(SAMLConstants.SOLICITED_SP_INITIATED, SAMLConstants.HTTPSERVLET_INITIATED, LOGOUT_INVOLVES_IDP);
