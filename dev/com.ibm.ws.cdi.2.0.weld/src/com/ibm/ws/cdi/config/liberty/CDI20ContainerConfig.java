 ...
 */
@Component(name = "com.ibm.ws.cdi.config.liberty.CDI20ContainerConfig", service = { CDIContainerConfig.class }, configurationPid = "com.ibm.ws.cdi20.cdiContainer", configurationPolicy = ConfigurationPolicy.REQUIRE, immediate = true, property = { "service.vendor=IBM" })
public class CDI20ContainerConfig implements CDIContainerConfig {
    ...
    private static final TraceComponent tc = Tr.register(CDI20ContainerConfig.class);
    private static final AtomicReference<CDI20ContainerConfig> INSTANCE = new AtomicReference<CDI20ContainerConfig>();
