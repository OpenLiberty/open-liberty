...
public class OASFactoryResolverImpl extends OASFactoryResolver {
    ...
    static {
        ...
        MODEL_CLASS_MAP.put(CookieParameter.class, CookieParameterImpl.class);
        MODEL_CLASS_MAP.put(HeaderParameter.class, HeaderParameterImpl.class);
        MODEL_CLASS_MAP.put(PathParameter.class, PathParameterImpl.class);
        MODEL_CLASS_MAP.put(QueryParameter.class, QueryParameterImpl.class);
