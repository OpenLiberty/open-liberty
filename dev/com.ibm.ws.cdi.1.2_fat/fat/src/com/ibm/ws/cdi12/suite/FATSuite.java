 ...
 */
        ...
        exportAppToServer("visTestServer", visTest107);
        ...
        exportAppToServer("cdi12AppExtensionServer", applicationExtension80);
        exportAppToServer("conversationFilterServer", appConversationFilter120);
        exportAppToServer("cdi12SharedLibraryServer", sharedLibraryNoInjectionApp104);
        exportAppToServer("cdi12SharedLibraryServer", sharedLibraryAppWeb171);
        ...
        exportAppToServer("cdi12DeltaSpikeServer", deltaspikeTest137);
        exportAppToServer("cdi12BasicServer", multiModuleApp2171);
        ...
        exportAppToServer("cdi12BasicServer", alterableContextsApp162, "/");
        ...
        exportAppToServer("cdi12BasicServer", multiModuleApp170);
        exportAppToServer("cdi12BeanDiscoveryModeNoneServer", beanDiscoveryModeNone114);
        exportAppToServer("cdi12JSFWithSharedLibServer", simpleJSFWithSharedLib57);
        exportAppToServer("cdi12AfterTypeDiscoveryServer", afterTypeDiscoveryApp30);
