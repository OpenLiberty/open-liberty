...
public class ShrinkWrapServer extends SharedServer {
    ...
    private static EnterpriseArchive alterableContextsApp162;
 ...
 */
        ...
        alterableContextsApp162 = ShrinkWrap.create(EnterpriseArchive.class,"alterableContextsApp.ear")
        ...
        serversToApps.put("aparServer",new LinkedList<Archive>());
        serversToApps.get("aparServer").add(vetoedEJBStartup99);
        serversToApps.put("cdi12GlobalPriorityServer",new LinkedList<Archive>());
        serversToApps.get("cdi12GlobalPriorityServer").add(globalPriorityApp61);
        serversToApps.put("nonContextualServer",new LinkedList<Archive>());
        serversToApps.get("nonContextualServer").add(appNonContextual147);
        serversToApps.put("cdi12ValidatorInJarServer",new LinkedList<Archive>());
        serversToApps.get("cdi12ValidatorInJarServer").add(TestValidatorInJar36);
        serversToApps.put("cdi12JSFServer",new LinkedList<Archive>());
        serversToApps.get("cdi12JSFServer").add(simpleJSFApp91);
        serversToApps.put("cdi12RuntimeExtensionServer",new LinkedList<Archive>());
        serversToApps.get("cdi12RuntimeExtensionServer").add(helloWorldExension153);
        serversToApps.get("cdi12RuntimeExtensionServer").add(multipleWars259);
        serversToApps.put("cdi12PassivationServer",new LinkedList<Archive>());
        serversToApps.get("cdi12PassivationServer").add(transientReferenceInSessionPersist40);
        serversToApps.get("cdi12PassivationServer").add(passivationBean65);
        serversToApps.put("cdi12BeanLifecycleTestServer",new LinkedList<Archive>());
        serversToApps.get("cdi12BeanLifecycleTestServer").add(scopeActivationDestructionSecondApp28);
        serversToApps.put("cdi12ClassExclusionTestServer",new LinkedList<Archive>());
        serversToApps.get("cdi12ClassExclusionTestServer").add(classExclusion85);
        serversToApps.get("cdi12ClassExclusionTestServer").add(TestVetoedAlternative141);
        serversToApps.put("cdi12WarLibsAccessWarServer",new LinkedList<Archive>());
        serversToApps.get("cdi12WarLibsAccessWarServer").add(warLibAccessBeansInWar21);
        serversToApps.put("cdi12StatefulSessionBeanServer",new LinkedList<Archive>());
        serversToApps.get("cdi12StatefulSessionBeanServer").add(statefulSessionBeanInjection127);
        serversToApps.put("cdi12ImplicitServer",new LinkedList<Archive>());
        serversToApps.get("cdi12ImplicitServer").add(implicitBeanDiscovery27);
        serversToApps.get("cdi12ImplicitServer").add(implicitBeanArchive95);
        serversToApps.get("cdi12ImplicitServer").add(implicitWarApp121);
        serversToApps.get("cdi12ImplicitServer").add(implicitEJBInWar125);
        serversToApps.put("cdi12EJB32Server",new LinkedList<Archive>());
        serversToApps.get("cdi12EJB32Server").add(ejbTimer51);
        serversToApps.get("cdi12EJB32Server").add(injectParameters167);
        serversToApps.get("cdi12EJB32Server").add(postConstructErrorMessageApp81);
        serversToApps.get("cdi12EJB32Server").add(multipleWars87);
        serversToApps.get("cdi12EJB32Server").add(multipleEJBsSingleClass90);
        serversToApps.get("cdi12EJB32Server").add(ejbScope46);
        serversToApps.get("cdi12EJB32Server").add(aroundConstructApp115);
        serversToApps.put("visTestServer",new LinkedList<Archive>());
        serversToApps.get("visTestServer").add(visTest107);
        serversToApps.put("cdi12EjbConstructorInjectionServer",new LinkedList<Archive>());
        serversToApps.get("cdi12EjbConstructorInjectionServer").add(ejbConstructorInjection133);
        serversToApps.put("cdi12EventMetadataServer",new LinkedList<Archive>());
        serversToApps.get("cdi12EventMetadataServer").add(eventMetaData94);
        serversToApps.put("cdi12JEEInjectionTargetTestServer",new LinkedList<Archive>());
        serversToApps.get("cdi12JEEInjectionTargetTestServer").add(jeeInjectionTargetTest43);
        serversToApps.put("cdi12InjectInjectionPointServer",new LinkedList<Archive>());
        serversToApps.get("cdi12InjectInjectionPointServer").add(injectInjectionPoint37);
        serversToApps.put("cdi12MultipleBeansXmlServer",new LinkedList<Archive>());
        serversToApps.get("cdi12MultipleBeansXmlServer").add(multipleBeansXml75);
        serversToApps.put("cdiServerForClient",new LinkedList<Archive>());
        serversToApps.get("cdiServerForClient").add(HelloAppClient72);
        serversToApps.put("cdi12AlterableContextServer",new LinkedList<Archive>());
        serversToApps.put("cdi12AppExtensionServer",new LinkedList<Archive>());
        serversToApps.get("cdi12AppExtensionServer").add(applicationExtension80);
        serversToApps.put("conversationFilterServer",new LinkedList<Archive>());
        serversToApps.get("conversationFilterServer").add(appConversationFilter120);
        serversToApps.put("cdi12SharedLibraryServer",new LinkedList<Archive>());
        serversToApps.get("cdi12SharedLibraryServer").add(sharedLibraryNoInjectionApp104);
        serversToApps.get("cdi12SharedLibraryServer").add(sharedLibraryAppWeb171);
        serversToApps.put("cdi12DecoratorOnBuiltInBeansTestServer",new LinkedList<Archive>());
        serversToApps.get("cdi12DecoratorOnBuiltInBeansTestServer").add(defaultDecoratorApp139);
        serversToApps.put("packagePrivateAccessServer",new LinkedList<Archive>());
        serversToApps.get("packagePrivateAccessServer").add(packagePrivateAccessApp168);
        serversToApps.put("cdi12DisableImplicitBeanArchiveServer",new LinkedList<Archive>());
        serversToApps.get("cdi12DisableImplicitBeanArchiveServer").add(implicitBeanArchiveDisabled69);
        serversToApps.put("cdi12DynamicallyAddedBeansServer",new LinkedList<Archive>());
        serversToApps.get("cdi12DynamicallyAddedBeansServer").add(dynamicallyAddedBeans26);
        serversToApps.put("cdi12EjbDiscoveryServer",new LinkedList<Archive>());
        serversToApps.get("cdi12EjbDiscoveryServer").add(ejbDiscovery22);
        serversToApps.put("cdi12DeltaSpikeServer",new LinkedList<Archive>());
        serversToApps.get("cdi12DeltaSpikeServer").add(deltaspikeTest137);
        serversToApps.put("cdi12BasicServer",new LinkedList<Archive>());
        serversToApps.get("cdi12BasicServer").add(multiModuleApp2171);
        serversToApps.get("cdi12BasicServer").add(cdi12helloworldtest106);
        serversToApps.get("cdi12BasicServer").add(rootClassLoaderApp105);
        serversToApps.get("cdi12BasicServer").add(simpleJSPApp55);
        serversToApps.get("cdi12BasicServer").add(TestClassLoadPrereqLogger8);
        serversToApps.get("cdi12BasicServer").add(beanManagerLookupApp152);
        serversToApps.get("cdi12BasicServer").add(nonContextual7);
        serversToApps.get("cdi12BasicServer").add(ObservesInitializedInJars170);
        serversToApps.get("cdi12BasicServer").add(WebListener163);
        serversToApps.get("cdi12BasicServer").add(multiModuleApp170);
        serversToApps.put("cdi12BeanDiscoveryModeNoneServer",new LinkedList<Archive>());
        serversToApps.get("cdi12BeanDiscoveryModeNoneServer").add(beanDiscoveryModeNone114);
        serversToApps.put("cdi12JSFWithSharedLibServer",new LinkedList<Archive>());
        serversToApps.get("cdi12JSFWithSharedLibServer").add(simpleJSFWithSharedLib57);
        serversToApps.put("cdi12AfterTypeDiscoveryServer",new LinkedList<Archive>());
        serversToApps.get("cdi12AfterTypeDiscoveryServer").add(afterTypeDiscoveryApp30);
        serversToApps.put("cdi12JNDIServer",new LinkedList<Archive>());
        serversToApps.get("cdi12JNDIServer").add(jndiLookup149);
        serversToApps.put("cdi12CDICurrentServer",new LinkedList<Archive>());
        serversToApps.get("cdi12CDICurrentServer").add(cdiCurrentTest66);
        serversToApps.put("cdi12NoBeansXmlValidationServer",new LinkedList<Archive>());
        serversToApps.get("cdi12NoBeansXmlValidationServer").add(invalidBeansXml13);
        serversToApps.put("cdi12WebBeansBeansXmlServer",new LinkedList<Archive>());
        serversToApps.get("cdi12WebBeansBeansXmlServer").add(webBeansBeansXmlDecorators103);
        serversToApps.get("cdi12WebBeansBeansXmlServer").add(webBeansBeansXmlInterceptors39);
        serversToApps.put("cdi12BeanLifecycleTestServer ",new LinkedList<Archive>());
        serversToApps.get("cdi12BeanLifecycleTestServer ").add(scopeActivationDestructionTests160);
        serversToApps.put("cdi12ClassMasking",new LinkedList<Archive>());
        serversToApps.get("cdi12ClassMasking").add(maskedClass38);
        serversToApps.put("cdi12EjbDefInXmlServer",new LinkedList<Archive>());
        serversToApps.get("cdi12EjbDefInXmlServer").add(ejbArchiveWithNoAnnotations82);
        serversToApps.get("cdi12EjbDefInXmlServer").add(archiveWithNoBeansXml165);
        serversToApps.get("cdi12EjbDefInXmlServer").add(ejbJarInWarNoAnnotations88);
        serversToApps.put("cdi12WebServicesServer",new LinkedList<Archive>());
        serversToApps.get("cdi12WebServicesServer").add(resourceWebServices128);
        serversToApps.put("cdi12EJB32FullServer",new LinkedList<Archive>());
        serversToApps.get("cdi12EJB32FullServer").add(ejbMisc16);
        serversToApps.put("cdi12WithAnnotationsServer",new LinkedList<Archive>());
        serversToApps.get("cdi12WithAnnotationsServer").add(withAnnotationsApp161);
        serversToApps.put(" cdi12BeansXmlValidationServer",new LinkedList<Archive>());
        serversToApps.get(" cdi12BeansXmlValidationServer").add(invalidBeansXml13);
        serversToApps.put("cdi12ManagedBeanTestServer",new LinkedList<Archive>());
        serversToApps.get("cdi12ManagedBeanTestServer").add(managedBeanApp15);

    }

    public ShrinkWrapServer(String serverName) {
        super(serverName);

    }

    public static List<Archive> getAppsForServer(String serverName) {
        return serversToApps.get(serverName);
    }
    ...
    protected void before() {
        ...
        for (Archive archive : serversToApps.get(getServerName())) {
        ...
        if (getServerName().equals("AlterableContextServer")) {
            ShrinkHelper.exportArtifact(alterableContextsApp162, "publish/servers/" + getServerName() + "/");
        }
