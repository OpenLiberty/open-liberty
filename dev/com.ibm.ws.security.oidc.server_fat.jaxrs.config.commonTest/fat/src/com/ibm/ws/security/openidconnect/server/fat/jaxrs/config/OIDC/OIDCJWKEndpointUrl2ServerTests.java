...
import com.ibm.ws.security.openidconnect.server.fat.jaxrs.config.CommonTests.JWKEndpointUrl2ServerTests;
...
public class OIDCJWKEndpointUrl2ServerTests extends JWKEndpointUrl2ServerTests {

    private static final Class<?> thisClass = OIDCJWKEndpointUrl2ServerTests.class;
    ...
    public static void setupBeforeTest() throws Exception {
        ...
        genericTestServer = commonSetUp(RSServerName, "server_jwkEndpointUrl.xml", Constants.GENERIC_SERVER, extraApps2, Constants.DO_NOT_USE_DERBY, null, null, Constants.OIDC_OP, true, true, tokenType, certType);
