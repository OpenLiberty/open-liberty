...
public class OAuthCookieAttributesInboundPropNoneWithOPToken2ServerTests extends CookieAttributes2ServerTests {

    private static final Class<?> thisClass = OAuthCookieAttributesInboundPropNoneWithOPToken2ServerTests.class;
    ...
    public static void setupBeforeTest() throws Exception {
        ...
        tokenTestingSetup("server_disableLtpaCookie_authnSessionDisabled_none.xml", Constants.NONE, Constants.OAUTH_OP, true);
