...
public class OAuthMapToUserRegistryNoRegIntrospect2ServerTests extends MapToUserRegistryNoRegIntrospect2ServerTests {

    private static final Class<?> thisClass = OAuthMapToUserRegistryNoRegIntrospect2ServerTests.class;
    ...
    public static void setupBeforeTest() throws Exception {
        ...
        genericTestServer = commonSetUp(RSServerName, "server_orig_maptest_noregistry_introspect.xml", Constants.GENERIC_SERVER, extraApps2, Constants.DO_NOT_USE_DERBY, extraMsgs2, null, Constants.OAUTH_OP);
