...
// com.ibm.ws.security.openidconnect.server-1.0_fat.jaxrs.config/fat/src/com/ibm/ws/security/openidconnect/server/fat/jaxrs/config/CommonTests/MapToUserRegistryWithRegLDAP2ServerTests.java

@LibertyServerWrapper
@Mode(TestMode.FULL)
@RunWith(FATRunner.class)
public class OAuthMapToUserRegistryWithRegLDAP2ServerTests extends MapToUserRegistryWithRegLDAP2ServerTests {

    private static final Class<?> thisClass = OAuthMapToUserRegistryWithRegLDAP2ServerTests.class;
    ...
    public static void setupBeforeTest() throws Exception {
        ...
        testOPServer = commonSetUp(OPServerName, "server_orig_maptest_ldap.xml", Constants.OAUTH_OP, extraApps, Constants.DO_NOT_USE_DERBY, extraMsgs);
        genericTestServer = commonSetUp(RSServerName, "server_orig_maptest_withLdap.xml", Constants.GENERIC_SERVER, extraApps2, Constants.DO_NOT_USE_DERBY, extraMsgs2, null, Constants.OAUTH_OP);
