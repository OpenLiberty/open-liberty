...
public class OIDCMapToUserRegistryWithRegIntrospect2ServerTests extends MapToUserRegistryWithRegIntrospect2ServerTests {

    private static final Class<?> thisClass = OIDCMapToUserRegistryWithRegIntrospect2ServerTests.class;
    ...
    public static void setupBeforeTest() throws Exception {
        ...
        genericTestServer = commonSetUp(RSServerName, "server_orig_maptest_withregistry_introspect.xml", Constants.GENERIC_SERVER, extraApps2, Constants.DO_NOT_USE_DERBY, extraMsgs2, null, Constants.OIDC_OP, true, true, tokenType, certType);
