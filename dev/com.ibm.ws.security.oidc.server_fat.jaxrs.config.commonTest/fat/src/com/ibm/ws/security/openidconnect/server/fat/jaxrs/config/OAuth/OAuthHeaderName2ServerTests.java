...
import com.ibm.ws.security.openidconnect.server.fat.jaxrs.config.CommonTests.HeaderName2ServerTests;
...
public class OAuthHeaderName2ServerTests extends HeaderName2ServerTests {

    private static final Class<?> thisClass = OAuthHeaderName2ServerTests.class;
    ...
    public static void setupBeforeTest() throws Exception {
        ...
        String[] propagationTokenTypes = rsTools.chooseTokenSettings(Constants.OAUTH_OP);
        ...
        testOPServer = commonSetUp(OPServerName, "server_orig.xml", Constants.OAUTH_OP, extraApps, Constants.DO_NOT_USE_DERBY, extraMsgs, null, Constants.OAUTH_OP, true, true, tokenType, certType);
        genericTestServer = commonSetUp(RSServerName, "server_headerName.xml", Constants.GENERIC_SERVER, extraApps2, Constants.DO_NOT_USE_DERBY, null, null, Constants.OAUTH_OP, true, true, tokenType, certType);
        ...
        testSettings.setWhere(Constants.HEADER);
