...
public class OAuthValidationMethod2ServerTests extends ValidationMethod2ServerTests {

    private static final Class<?> thisClass = OAuthValidationMethod2ServerTests.class;
    ...
    public static void setupBeforeTest() throws Exception {
        ...
        genericTestServer = commonSetUp(RSServerName, "server_validationMethod_tests.xml", Constants.GENERIC_SERVER, extraApps2, Constants.DO_NOT_USE_DERBY, null, null, Constants.OAUTH_OP);
