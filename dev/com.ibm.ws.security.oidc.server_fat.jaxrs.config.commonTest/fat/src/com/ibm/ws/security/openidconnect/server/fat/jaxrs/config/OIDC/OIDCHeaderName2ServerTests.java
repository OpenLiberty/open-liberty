...
public class OIDCHeaderName2ServerTests extends HeaderName2ServerTests {

    private static final Class<?> thisClass = OIDCHeaderName2ServerTests.class;
    ...
    public static void setupBeforeTest() throws Exception {
        ...
        genericTestServer = commonSetUp(RSServerName, "server_headerName.xml", Constants.GENERIC_SERVER, extraApps2, Constants.DO_NOT_USE_DERBY, null, null, Constants.OIDC_OP, true, true, tokenType, certType);
