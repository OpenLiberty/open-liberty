...
public class OAuthIssuerIdentifier2ServerTests extends IssuerIdentifierServerTests {
    ...
    public static void setupBeforeTest() throws Exception {
        ...
        genericTestServer = commonSetUp(RSServerName, "server_issuerIdentifier.xml", Constants.GENERIC_SERVER, extraApps2, Constants.DO_NOT_USE_DERBY, null, null, Constants.OAUTH_OP);
        ...
        targetISSHttpsEndpoint = "localhost:" + testOPServer.getHttpDefaultSecurePort().toString() + "/" + Constants.OAUTH_ROOT + "/endpoint/" + targetProvider;
