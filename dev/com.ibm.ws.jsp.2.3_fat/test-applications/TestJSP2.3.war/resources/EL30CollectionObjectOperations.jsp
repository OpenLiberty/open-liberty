...
<%@ page
 import="com.ibm.ws.jsp23.fat.testjsp23.beans.EL30MapCollectionObjectBean"%>
...
<body>
 ...
 <%!// List to be used as a collection object
	...
	Set<Set<String>> nestedSet = new LinkedHashSet<Set<String>>() {
		{
 ...
 <%
 	final EL30MapCollectionObjectBean[] cObjectOp = new EL30MapCollectionObjectBean[] {
 			new EL30MapCollectionObjectBean(), new EL30MapCollectionObjectBean(),
