 ...
 *
 * The default value of 1 is tested.
 */
//No need to run against cdi-2.0 since these tests don't use CDI at all.
@SkipForRepeat("CDI-2.0")
@RunWith(FATRunner.class)
@Mode(TestMode.FULL)
public class JSPPrepareJSPThreadCountDefaultValueTests {
    private static final String APP_NAME = "SimpleJSPApp";

    @Server("jsp23_prepareJSPThreadCountDefaultServer")
    ...
    /**
     * Test to ensure that the default value of prepareJSPThreadCount is 1.
     *
     * <jspEngine prepareJSPs="0" keepGenerated="true" scratchdir="scratchdir"/>
     *
     * @throws Exception
     */
    @Test
