...
public class JSPExpressionLanguageTests {
    private static final Logger LOG = Logger.getLogger(JSPExpressionLanguageTests.class.getName());
    private static final String TestEL_APP_NAME = "TestEL";

    @Server("expressionLanguageServer")
    ...
    public static void setup() throws Exception {
        ...
        server.startServer(JSPExpressionLanguageTests.class.getSimpleName() + ".log");
    }
