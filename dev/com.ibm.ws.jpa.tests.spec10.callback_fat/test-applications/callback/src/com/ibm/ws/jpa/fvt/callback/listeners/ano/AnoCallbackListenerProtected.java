...
package com.ibm.ws.jpa.fvt.callback.listeners.ano;
...
public class AnoCallbackListenerProtected extends AbstractCallbackListener {
    private static final AnoCallbackListenerProtected _singleton = new AnoCallbackListenerProtected();
