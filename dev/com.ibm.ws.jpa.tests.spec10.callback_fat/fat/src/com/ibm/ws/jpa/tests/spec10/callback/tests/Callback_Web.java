...
public class Callback_Web extends JPAFATServletClient {
    ...
    @Server("JPA10CallbackWebServer")
    @TestServlets({
                    @TestServlet(servlet = TestCallbackServlet.class, path = CONTEXT_ROOT + "/" + "TestCallbackServlet"),
                    @TestServlet(servlet = TestCallbackExceptionServlet.class, path = CONTEXT_ROOT + "/" + "TestCallbackExceptionServlet"),
                    @TestServlet(servlet = TestCallbackListenerServlet.class, path = CONTEXT_ROOT + "/" + "TestCallbackListenerServlet"),
                    @TestServlet(servlet = TestCallbackListenerExceptionServlet.class, path = CONTEXT_ROOT + "/" + "TestCallbackListenerExceptionServlet"),
                    @TestServlet(servlet = TestCallbackDefaultListenerServlet.class, path = CONTEXT_ROOT + "/" + "TestCallbackDefaultListenerServlet"),
                    @TestServlet(servlet = TestCallbackDefaultListenerExceptionServlet.class, path = CONTEXT_ROOT + "/" + "TestCallbackDefaultListenerExceptionServlet"),
                    @TestServlet(servlet = TestCallbackOrderOfInvocationServlet.class, path = CONTEXT_ROOT + "/" + "TestCallbackOrderOfInvocationServlet")
    })
    ...
    public static void setUp() throws Exception {
        ...
        System.out.println(Callback_Web.class.getName() + " Setting up database tables...");
