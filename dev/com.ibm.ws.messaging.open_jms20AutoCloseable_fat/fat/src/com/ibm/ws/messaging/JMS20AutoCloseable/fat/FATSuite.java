...
public class FATSuite {
    ...
    @ClassRule
    public static RepeatTests repeater = RepeatTests.with(FeatureReplacementAction.EE9_FEATURES().conditionalFullFATOnly(FeatureReplacementAction.GREATER_THAN_OR_EQUAL_JAVA_11))
