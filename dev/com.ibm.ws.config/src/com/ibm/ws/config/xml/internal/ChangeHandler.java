...
class ChangeHandler {
     ...
     */
    private List<SingletonElement> orderSingletons(ServerConfiguration serverConfiguration) {
     ...
     *         in natural order.
     */
    private List<FactoryElement> orderFactories(ServerConfiguration serverConfiguration, String factoryPid) {
