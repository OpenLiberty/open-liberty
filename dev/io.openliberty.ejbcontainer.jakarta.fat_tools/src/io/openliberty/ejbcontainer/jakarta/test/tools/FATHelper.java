...
public abstract class FATHelper {
    ...
    /**
     * Lookup in the Enterprise Bean 3 local namespace (e.g. ejblocal: namespace) a specified
     * Enterprise Bean 3 local interface name (either home or business interface) for a specified
     * J2EEName of a Enterprise Bean 3 bean using the default binding generated by Enterprise Bean container.
     ...
     * @param bean
     *            the Enterprise Bean 3 bean name in specified application and module (e.g. AdvBasicCMTStatelessLocal).
     *
    ...
    /**
     * Lookup in the Enterprise Bean java: global namespace
     *
     * @param interfaceName
     *            the fully qualified name of the local home or business interface
     *            name ( e.g. suite.r70.base.ejb3.sla.BasicCMTStatelessLocal ).
    ...
    /**
     * Lookup in the Enterprise Bean java:app namespace
     *
     * @param interfaceName
     *            the fully qualified name of the local home or business interface
     *            name ( e.g. suite.r70.base.ejb3.sla.BasicCMTStatelessLocal ).
    ...
    /**
     * Returns the remote business interface for Enterprise Bean 3 bindings from JNDI lookup.
     *
     * @param interfaceName
     *            the fully qualified name of the local home or business interface
     *            name ( e.g. suite.r70.base.ejb3.sla.BasicCMTStatelessLocal ).
