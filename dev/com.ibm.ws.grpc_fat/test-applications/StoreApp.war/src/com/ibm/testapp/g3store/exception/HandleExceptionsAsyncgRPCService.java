 ...
 *
 */
public class HandleExceptionsAsyncgRPCService {

    InvalidArgException argException = null;
    NotFoundException nfException = null;
    AlreadyExistException alExException = null;

    public AlreadyExistException getAlExException() {
        return alExException;
    }

    public void setAlExException(AlreadyExistException alExException) {
        this.alExException = alExException;
    }
