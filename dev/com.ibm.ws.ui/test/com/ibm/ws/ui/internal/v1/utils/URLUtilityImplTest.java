        ...
        mock.checking(new Expectations() {
            {
                ...
                allowing(mockHTTPConnection).setInstanceFollowRedirects(false);
                allowing(mockHTTPConnection).setConnectTimeout(with(any(Integer.class)));
                allowing(mockHTTPConnection).setReadTimeout(with(any(Integer.class)));
            }
        });
