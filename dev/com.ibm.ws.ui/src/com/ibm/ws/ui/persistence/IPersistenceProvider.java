...
public interface IPersistenceProvider {
     ...
     * @throws JsonParseException    Thrown for parsing problems, used when non-well-formed content (content that does not conform to JSON syntax as per specification) is
     *                                   encountered.
