...
define(['js/common/platform'], function(platform) {
  ...
  return {
     ...
     * <li>Special case bookmarks, such as 'openlibery.io' have custom bookmarks which must be handled.</li>
     * </ol>
     * 
     * @method
    ...
    getToolIcon: function(tool) {
      if (platform.isPhone()) {
        ...
        } else if (tool.id === 'openliberty.io') {
          return 'images/tools/Open_Liberty_square_78x78.png';
