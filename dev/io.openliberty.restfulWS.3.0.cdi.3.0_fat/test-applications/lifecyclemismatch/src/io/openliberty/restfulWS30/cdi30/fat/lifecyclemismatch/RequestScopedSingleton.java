 ...
 */
@RequestScoped
@Path("/RequestScopedSingleton")
public class RequestScopedSingleton implements Serializable {
    ...
    public String postMessage(String incomingMessage) {
        ...
        RequestScopedSingleton.message = incomingMessage;
    ...
    public Response putMessage(byte[] incomingMessage) {
        ...
        RequestScopedSingleton.message = new String(incomingMessage);
    ...
    public Response deleteMessage() {
        RequestScopedSingleton.message = null;
