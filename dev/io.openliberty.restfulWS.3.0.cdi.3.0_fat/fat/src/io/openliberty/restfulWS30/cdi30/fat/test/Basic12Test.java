...
public class Basic12Test extends AbstractTest {
    ...
    @Server("io.openliberty.restfulWS.3.0.cdi.3.0.fat.basic")
    public static LibertyServer server;

    @BeforeClass
    public static void setUp() throws Exception {
        appname = "basic";
        WebArchive app = ShrinkHelper.defaultDropinApp(server, appname, "io.openliberty.restfulWS30.cdi30.fat.basic");
        server.startServer();
    }
    ...
    public void testPerRequestContextInResource4C_queryParam() throws IOException {
        runGetMethod("/rest/helloworldc/uriinfo?id=123", 200, classesType + " Resource Context: /helloworldc/uriinfo", true);
        assertLibertyMessage("The id is: 123.", 1, "equal");
        runGetMethod("/rest/helloworldc/uriinfo?id=321", 200, classesType + " Resource Context: /helloworldc/uriinfo", true);
