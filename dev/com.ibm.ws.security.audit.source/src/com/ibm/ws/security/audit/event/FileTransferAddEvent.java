 ...
 */
public class FileTransferAddEvent extends AuditEvent {

    private static final TraceComponent tc = Tr.register(FileTransferAddEvent.class);
    private static AuditManager auditManager = new AuditManager();

    @SuppressWarnings("unchecked")
    public FileTransferAddEvent() {
        ...
        set(AuditEvent.EVENTNAME, AuditConstants.FILE_TRANSFER_ADD);

    }

    public FileTransferAddEvent(Object request, Object resp) {
        this();
        try {
