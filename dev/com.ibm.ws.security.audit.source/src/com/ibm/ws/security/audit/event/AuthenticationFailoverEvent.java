 ...
 */
public class AuthenticationFailoverEvent extends AuditEvent {

    private static final TraceComponent tc = Tr.register(AuthenticationFailoverEvent.class);

    @SuppressWarnings("unchecked")
    public AuthenticationFailoverEvent() {
        set(AuditEvent.EVENTNAME, AuditConstants.SECURITY_AUTHN_FAILOVER);
    ...
    public AuthenticationFailoverEvent(WebRequest webreq, AuthenticationResult authResult, HashMap extraAuditData, Integer statusCode) {
        ...
        try {
            ...
            if (extraAuditData.get("originalAuthType") != null)
                set(AuditEvent.TARGET_ORIGINAL_AUTH_TYPE, extraAuditData.get("originalAuthType"));
            if (extraAuditData.get("failoverAuthType") != null)
                set(AuditEvent.TARGET_FAILOVER_AUTH_TYPE, extraAuditData.get("failoverAuthType"));
