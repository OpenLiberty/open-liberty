 ...
 */
public class JMSAuthenticationTerminateEvent extends AuditEvent {

    private static final TraceComponent tc = Tr.register(JMSAuthenticationTerminateEvent.class);

    @SuppressWarnings("unchecked")
    public JMSAuthenticationTerminateEvent() {
    ...
    public JMSAuthenticationTerminateEvent(String userName, String hostAddress, String port, String chainName, String busName, String messagingEngine, String credentialType,
                                           Integer statusCode) {
        this();
        try {
