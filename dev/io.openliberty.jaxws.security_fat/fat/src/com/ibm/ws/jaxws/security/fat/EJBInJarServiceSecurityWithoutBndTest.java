 ...
 * in a jar package. Security constraints are configured in server.xml
 */
@RunWith(FATRunner.class)
public class EJBInJarServiceSecurityWithoutBndTest extends EJBInJarServiceSecurityTest {

    @BeforeClass
    public static void setUp() throws Exception {
        init();
        startServer("EJBInJarServiceSecurityWithoutBndTest.log");
    }
    ...
    public void test_ejbws_in_jar_security_without_bndfile_nonsecure() throws Exception {
    ...
    @Test
    @AllowedFFDC({ "java.rmi.AccessException" })
    public void test_ejbws_in_jar_security_without_bndfile_secure() throws Exception {
