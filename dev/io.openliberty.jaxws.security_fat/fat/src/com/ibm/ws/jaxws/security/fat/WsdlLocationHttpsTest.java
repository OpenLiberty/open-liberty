...
public class WsdlLocationHttpsTest {
	private static LibertyServer server = LibertyServerFactory.getLibertyServer("WsdlLocationHttpsServer");
	...
	public static void beforeAllTests() throws Exception {
		...
		ExplodedShrinkHelper.explodedDropinApp(server, "WsdlLocationHttpsClient", "com.ibm.was.wssample.sei.echo",
				"com.ibm.was.wssample.servlet");

		ExplodedShrinkHelper.explodedDropinApp(server, "WsdlLocationHttpsServer", "com.ibm.was.wssample.sei.echo");
	...
	public void test_access_https_wsdl_location() throws Exception {
		StringBuilder sBuilder = new StringBuilder("http://").append(server.getHostname()).append(":")
				.append(server.getHttpDefaultPort()).append("/WsdlLocationHttpsClient/EchoServlet")
				.append("?securePort=").append(server.getHttpDefaultSecurePort());
