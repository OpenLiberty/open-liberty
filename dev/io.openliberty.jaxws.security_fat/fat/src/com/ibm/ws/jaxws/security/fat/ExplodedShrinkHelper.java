...
//		}
	...
	public static WebArchive explodedDropinApp(LibertyServer server, String appName, String... packages)
			throws Exception {
		WebArchive app = ShrinkHelper.buildDefaultApp(appName, packages);
	...
	public static Archive<?> explodedArchiveToDestination(LibertyServer server, Archive<?> archive, String dest)
			throws Exception {
