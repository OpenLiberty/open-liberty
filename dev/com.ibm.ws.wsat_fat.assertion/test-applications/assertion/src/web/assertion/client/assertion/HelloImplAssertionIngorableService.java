...
@WebServiceClient(name = "HelloImplAssertionIngorableService", targetNamespace = "http://server.assertion.web/", wsdlLocation = "http://localhost:8010/assertion/HelloImplAssertionIngorableService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOIMPLASSERTIONINGORABLESERVICE_QNAME = new QName("http://server.assertion.web/", "HelloImplAssertionIngorableService");
    ...
    public Hello getHelloImplAssertionIngorablePort() {
        return super.getPort(new QName("http://server.assertion.web/", "HelloImplAssertionIngorablePort"), Hello.class);
    }
    ...
    public Hello getHelloImplAssertionIngorablePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.assertion.web/", "HelloImplAssertionIngorablePort"), Hello.class, features);
    }
