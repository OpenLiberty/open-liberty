...
public class EJBServicePortProxy{
    ...
    public class Descriptor {
        private web.ejbcdi.client.ejb.EJBServiceService _service = null;
        private web.ejbcdi.client.ejb.EJBService _proxy = null;
        ...
        public Descriptor(URL wsdlLocation, QName serviceName) {
            _service = new web.ejbcdi.client.ejb.EJBServiceService(wsdlLocation, serviceName);
            initCommon();
        }
        ...
        public void init() {
            ...
            try
            {
                ...
                _service = (web.ejbcdi.client.ejb.EJBServiceService)ctx.lookup("java:comp/env/service/EJBServiceService");
            }
            ...
            if (_service == null && !_useJNDIOnly)
                _service = new web.ejbcdi.client.ejb.EJBServiceService();
            initCommon();
        }
        ...
        public web.ejbcdi.client.ejb.EJBService getProxy() {
            return _proxy;
        }
