 ...
 * generated in the web.ejbcdi.client.normal package. 
...
public class ObjectFactory {
    ...
    private final static QName _NormalSayHelloToOtherResponse_QNAME = new QName("http://server.ejbcdi.web/", "normalSayHelloToOtherResponse");
    ...
    private final static QName _NormalSayHelloToOther_QNAME = new QName("http://server.ejbcdi.web/", "normalSayHelloToOther");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: web.ejbcdi.client.normal
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.ejbcdi.web/", name = "normalSayHelloToOtherResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.ejbcdi.web/", name = "normalSayHelloToOther")
