...
public class CDIServicePortProxy{
    ...
    public class Descriptor {
        private web.ejbcdi.client.cdi.CDIServiceService _service = null;
        private web.ejbcdi.client.cdi.CDIService _proxy = null;
        ...
        public Descriptor(URL wsdlLocation, QName serviceName) {
            _service = new web.ejbcdi.client.cdi.CDIServiceService(wsdlLocation, serviceName);
            initCommon();
        }
        ...
        public void init() {
            ...
            try
            {
                ...
                _service = (web.ejbcdi.client.cdi.CDIServiceService)ctx.lookup("java:comp/env/service/CDIServiceService");
            }
            ...
            if (_service == null && !_useJNDIOnly)
                _service = new web.ejbcdi.client.cdi.CDIServiceService();
            initCommon();
        }
        ...
        public web.ejbcdi.client.cdi.CDIService getProxy() {
            return _proxy;
        }
