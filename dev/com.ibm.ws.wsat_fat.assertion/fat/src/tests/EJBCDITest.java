...
public class EJBCDITest extends DBTestBase {
	...
	@Server("WSATEJB_Client")
	public static LibertyServer client;

	@Server("WSATEJB_Server1")
	...
	public static void beforeTests() throws Exception {
		...
		ShrinkHelper.defaultDropinApp(client, "wsatEJBCDIApp", "web.ejbcdi.*");
		ShrinkHelper.defaultDropinApp(server1, "wsatEJBCDIApp", "web.ejbcdi.*");
