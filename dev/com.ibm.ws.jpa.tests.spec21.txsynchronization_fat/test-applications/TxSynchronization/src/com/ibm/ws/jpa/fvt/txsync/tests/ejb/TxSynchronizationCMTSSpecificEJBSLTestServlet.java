...
@WebServlet(urlPatterns = "/TxSynchronizationCMTSSpecificEJBSLTestServlet")
public class TxSynchronizationCMTSSpecificEJBSLTestServlet extends EJBDBTestVehicleServlet {
    @PostConstruct
