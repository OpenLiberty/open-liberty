...
/**
 * An in memory UnboundID LDAP server designed to contain the same data as the Oracle instance of the ApacheDS stand-alone LDAP Servers.
 *
 * This InMemorySunLDAPServer is currently using a null schema to host the data, this could be replaced in the future with a robust Oracle schema design
 */
public class InMemorySUNLDAPServer extends InMemoryLDAPServer {
    ...
    public InMemorySUNLDAPServer() throws Exception {
        super(false, BASE_DN);
        int entriesAdded = this.importFromLDIF(true, extractResourceToFile("/resources/SunOne.ldif", "sundata", "ldif").getAbsolutePath());
