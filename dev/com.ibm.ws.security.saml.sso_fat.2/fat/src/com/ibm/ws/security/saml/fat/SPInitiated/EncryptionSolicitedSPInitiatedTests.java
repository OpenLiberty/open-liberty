...
/**
 * In general, these tests perform a solicited SP initiated SAML Web SSO, using httpunit to simulate browser requests.
...
public class EncryptionSolicitedSPInitiatedTests extends BasicEncryptionTests {

    private static final Class<?> thisClass = EncryptionSolicitedSPInitiatedTests.class;
    ...
    public static void setupBeforeTest() throws Exception {
        ...
        startSPWithIDPServer("com.ibm.ws.security.saml.sso-2.0_fat.2", "server_enc_aes128.xml", extraMsgs, extraApps, true);
