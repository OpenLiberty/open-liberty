...
public class MultipleSPSolicitedSPInitiatedTests extends MultipleSPSAMLTests {

    private static final Class<?> thisClass = MultipleSPSolicitedSPInitiatedTests.class;
