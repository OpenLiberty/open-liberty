...
public class MultipleSPUnsolicitedSPInitiatedTests extends MultipleSPSAMLTests {

    private static final Class<?> thisClass = MultipleSPUnsolicitedSPInitiatedTests.class;
    ...
    public static void setupBeforeTest() throws Exception {
        ...
        startSPWithIDPServer("com.ibm.ws.security.saml.sso-2.0_fat.2", "server_1_unsolicited.xml", extraMsgs, extraApps, true);
