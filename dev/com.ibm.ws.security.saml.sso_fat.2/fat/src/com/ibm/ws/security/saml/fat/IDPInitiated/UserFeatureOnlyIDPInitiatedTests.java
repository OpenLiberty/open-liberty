...
public class UserFeatureOnlyIDPInitiatedTests extends UserFeatureOnlySAMLTests {

    private static final Class<?> thisClass = UserFeatureOnlyIDPInitiatedTests.class;
