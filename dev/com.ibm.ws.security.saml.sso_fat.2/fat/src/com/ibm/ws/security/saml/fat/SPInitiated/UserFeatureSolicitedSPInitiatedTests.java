...
import com.ibm.ws.security.saml.fat.common.UserFeatureSAMLTests;
...
public class UserFeatureSolicitedSPInitiatedTests extends UserFeatureSAMLTests {

    private static final Class<?> thisClass = UserFeatureSolicitedSPInitiatedTests.class;
    ...
    public static void setupBeforeTest() throws Exception {
        ...
        startSPWithIDPServer("com.ibm.ws.security.saml.sso-2.0_fat.2", "server_userFeature.xml", extraMsgs, extraApps, true);
