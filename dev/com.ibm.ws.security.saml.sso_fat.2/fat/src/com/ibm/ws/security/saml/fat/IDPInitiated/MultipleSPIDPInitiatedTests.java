...
import com.ibm.ws.security.saml.fat.common.MultipleSPSAMLTests;
...
public class MultipleSPIDPInitiatedTests extends MultipleSPSAMLTests {

    private static final Class<?> thisClass = MultipleSPIDPInitiatedTests.class;
    ...
    public static void setupBeforeTest() throws Exception {
        ...
        startSPWithIDPServer("com.ibm.ws.security.saml.sso-2.0_fat.2", "server_accessCheck.xml", extraMsgs, extraApps, true);
