 ...
 * specification.
 */
public abstract class SuperDefault1 {
    /**
     * Definitions for the logger
     */
    private final static String CLASSNAME = SuperDefault1.class.getName();
    private final static Logger svLogger = Logger.getLogger(CLASSNAME);

    /** Name of this class */
    private static final String CLASS_NAME = "SuperDefault1";
    ...
    Object getResultsObject(InvocationContext inv) throws Exception {
        svLogger.info("SD1 Invocation target: "
    ...
    private Object superAroundInvoke(InvocationContext inv) throws Exception {
        Object resultsObject = getResultsObject(inv);
        addAroundInvoke(resultsObject, CLASS_NAME, "superAroundInvoke");
        ...
        setAroundInvokeContextData(resultsObject, data);
    ...
    private void superPostConstruct(InvocationContext inv) {
        try {
            Object resultsObject = getResultsObject(inv);
            addPostConstruct(resultsObject, CLASS_NAME, "superPostConstruct");
            ...
            setPostContructContextData(resultsObject, data);
    ...
    private void superPostActivate(InvocationContext inv) {
        try {
            Object resultsObject = getResultsObject(inv);
            addPostActivate(resultsObject, CLASS_NAME, "superPostActivate");
            // Validate and update context data.
            Map<String, Object> map = inv.getContextData();
            String data;
            if (map.containsKey("PostActivate")) {
            ...
            setPostActivateContextData(resultsObject, data);
    ...
    private void superPrePassivate(InvocationContext inv) {
        try {
            Object resultsObject = getResultsObject(inv);
            addPrePassivate(resultsObject, CLASS_NAME, "superPrePassivate");
            ...
            setPrePassivateContextData(resultsObject, data);
    ...
    private void superPreDestroy(InvocationContext inv) {
        try {
            ...
            addPreDestroy(resultsObject, CLASS_NAME, "superPreDestroy");
            ...
            setPreDestroyContextData(resultsObject, data);
