 ...
 * interceptor methods in this class are package protected in order to test
 * whether EJB container can invoke package protected methods on interceptor
 * class as required by EJB 3 specification. Note, the intent is that none of
 * the methods are overridden by a subclass so that we can show that interceptor
