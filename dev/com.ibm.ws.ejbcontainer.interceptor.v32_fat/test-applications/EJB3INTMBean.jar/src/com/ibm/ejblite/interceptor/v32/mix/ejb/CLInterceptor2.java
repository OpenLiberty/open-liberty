...
/**
 * Class level interceptor class for FVT. All of the interceptor methods in this class are
 * protected in order to test whether EJB container can invoke protected methods on
 * interceptor class as required by EJB 3 specification.
 */
public class CLInterceptor2 extends SuperCLInterceptor2 {
    /** Name of this class */
    private static final String CLASS_NAME = "CLInterceptor2";

    @AroundInvoke
    protected Object aroundInvoke(InvocationContext inv) throws Exception {
    ...
    @PostConstruct
    protected void postConstruct(InvocationContext inv) {
        try {
            ResultsLocal results = ResultsLocalBean.getSFBean();
    ...
    @PrePassivate
    protected void prePassivate(InvocationContext inv) {
        try {
            ResultsLocal results = ResultsLocalBean.getSFBean();
