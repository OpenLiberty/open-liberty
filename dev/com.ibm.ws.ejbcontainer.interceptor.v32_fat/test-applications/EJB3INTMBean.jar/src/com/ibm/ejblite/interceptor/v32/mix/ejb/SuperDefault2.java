...
/**
 * Super class of a default interceptor class for FVT. All of the interceptor methods
...
public abstract class SuperDefault2 {
    ...
    private static final String LOGGER_CLASS_NAME = SuperDefault2.class.getName();
    ...
    /**
     * Primary key of ResultsLocal instance.
     */
    protected final static ResultsKey Results_LOCAL_KEY = new ResultsKey("ResultsLocal");
    ...
    Object getResultsObject(InvocationContext inv) throws Exception {
        svLogger.info("SD2 Invocation target: " + inv.getTarget().getClass().getName());
