...
public class ResultsLocalBean implements ResultsLocal {
    ...
    private class ResultsData implements Cloneable {
        ...
        protected Object clone() throws CloneNotSupportedException {
            ...
            clone.ivPostConstructList = (ArrayList) ivPostConstructList.clone();
            clone.ivPostActivateList = (ArrayList) ivPostActivateList.clone();
            clone.ivPrePassivateList = (ArrayList) ivPrePassivateList.clone();
            clone.ivPreDestroyList = (ArrayList) ivPreDestroyList.clone();
            clone.ivMethodList = (ArrayList) ivMethodList.clone();
            clone.ivExceptionList = (ArrayList) ivExceptionList.clone();
            clone.ivInstanceId = (ArrayList) ivInstanceId.clone();
            clone.ivTransactionContextList = (ArrayList) ivTransactionContextList.clone();
            return clone;
        }
    }
    ...
    public static ResultsLocal setupSFBean() throws NamingException {
        ...
        String beanName = "java:app/EJB3INTMBean/ResultsLocalBean!com.ibm.ejblite.interceptor.v32.mix.ejb.ResultsLocal";
