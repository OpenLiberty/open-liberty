 ...
 * that none of the methods are overridden by a subclass so that we can show that
 * interceptor methods are invoked in both the interceptor class and its super class.
 */
public abstract class SuperCLInterceptor1 {
    /** Name of this class */
    private static final String CLASS_NAME = "SuperCLInterceptor1";
