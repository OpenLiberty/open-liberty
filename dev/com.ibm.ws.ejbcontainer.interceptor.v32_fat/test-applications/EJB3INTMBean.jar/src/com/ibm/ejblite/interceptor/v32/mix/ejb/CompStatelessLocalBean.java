...
/**
 * A 2.1 SLSB used in a EJB 3.0 module with exclusion of default interceptors and use
 * of a single class level interceptor. The rest of the bean is meant to be just like
 * it was when it was in a 2.1 module (simulating what a customer might do).
 **/
@ExcludeDefaultInterceptors
@Interceptors({ UnspecifiedInterceptor.class })
public class CompStatelessLocalBean implements SessionBean {
    private static final String LOGGER_CLASS_NAME = CompStatelessLocalBean.class.getName();
    ...
    */
    ...
    public void discard() {
        throw new RuntimeException(CLASS_NAME + ".discard throwing RuntimeException to force discard of bean");
    }
