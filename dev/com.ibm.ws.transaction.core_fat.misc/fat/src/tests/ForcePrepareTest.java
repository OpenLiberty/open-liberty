...
public class ForcePrepareTest extends FATServletClient {
    ...
    public static void setUp() throws Exception {
        ...
        ShrinkHelper.defaultApp(server, APP_NAME, "misc.servlets.*");
