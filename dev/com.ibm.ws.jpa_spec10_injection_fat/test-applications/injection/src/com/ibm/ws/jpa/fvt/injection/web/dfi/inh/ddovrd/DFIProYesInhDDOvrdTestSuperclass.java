...
//    // This EntityManager should refer to the COMMON_JTA in the jar in the EAR file's root directory
//    @PersistenceContext(unitName="../jpapuroot.jar#COMMON_JTA", type=PersistenceContextType.TRANSACTION,
//                        name="jpa/DFIProYesInhDDOvrdTestServlet/ovdem_cmts_common_earroot")
...
//    // This EntityManager should refer to the JPAROOT_JTA in the jar in the EAR file's root directory
//    @PersistenceContext(unitName="JPAROOT_JTA", type=PersistenceContextType.TRANSACTION,
//                        name="jpa/DFIProYesInhDDOvrdTestServlet/ovdem_cmts_jparoot_earroot")
...
//    // This EntityManager should refer to the COMMON_JTA in the jar in the EAR file's root directory
//    @PersistenceUnit(unitName="../jpapuroot.jar#COMMON_JTA", name="jpa/DFIProYesInhDDOvrdTestServlet/ovdemf_amjta_common_earroot")
...
//    // This EntityManager should refer to the JPAROOT_JTA in the jar in the EAR file's root directory
//    @PersistenceUnit(unitName="JPAROOT_JTA", name="jpa/DFIProYesInhDDOvrdTestServlet/ovdemf_amjta_jparoot_earroot")
...
//    // This EntityManager should refer to the COMMON_RL in the jar in the EAR file's root directory
//    @PersistenceUnit(unitName="../jpapuroot.jar#COMMON_RL", name="jpa/DFIProYesInhDDOvrdTestServlet/ovdemf_amrl_common_earroot")
...
//    // This EntityManager should refer to the JPAROOT_RL in the jar in the EAR file's root directory
//    @PersistenceUnit(unitName="JPAROOT_RL", name="jpa/DFIProYesInhDDOvrdTestServlet/ovdemf_amrl_jparoot_earroot")
