 ...
 *
 */
public class DFIPubYesInhDDOvrdEJBSFEXTestServlet extends EJBTestVehicleServlet {
    ...
    private final static String ejbJNDIName = "ejb/dfi/inh/ano/DFIPubYesInhDDOvrdTestSFEXEJB";
...
//                       new JPAPersistenceContext("cleanup", PersistenceContextType.APPLICATION_MANAGED_RL, PersistenceInjectionType.JNDI, "jpa/cleanup"));
    ...
    @Test
    public void jpa10_Injection_DFI_YesInheritance_AnoOvrd_testCommonPUName_PUB_NOOVRD_EJB_SF_CMEX() throws Exception {
        final String testName = "jpa10_Injection_DFI_YesInheritance_AnoOvrd_testCommonPUName_PUB_NOOVRD_EJB_SF_CMEX";
    ...
    @Test
    public void jpa10_Injection_DFI_YesInheritance_AnoOvrd_testCommonPUNameSpecifiedPersistencePathLibJar_PUB_NOOVRD_EJB_SF_CMEX() throws Exception {
        final String testName = "jpa10_Injection_DFI_YesInheritance_AnoOvrd_testCommonPUNameSpecifiedPersistencePathLibJar_PUB_NOOVRD_EJB_SF_CMEX";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DFI_YesInheritance_AnoOvrd_testUniquePUNameAppModule_PUB_NOOVRD_EJB_SF_CMEX() throws Exception {
        final String testName = "jpa10_Injection_DFI_YesInheritance_AnoOvrd_testUniquePUNameAppModule_PUB_NOOVRD_EJB_SF_CMEX";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DFI_YesInheritance_AnoOvrd_testUniquePUNameLibJar_PUB_NOOVRD_EJB_SF_CMEX() throws Exception {
        final String testName = "jpa10_Injection_DFI_YesInheritance_AnoOvrd_testUniquePUNameLibJar_PUB_NOOVRD_EJB_SF_CMEX";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DFI_YesInheritance_AnoOvrd_testCommonPUName_PUB_OVRD_EJB_SF_CMEX() throws Exception {
        final String testName = "jpa10_Injection_DFI_YesInheritance_AnoOvrd_testCommonPUName_PUB_OVRD_EJB_SF_CMEX";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DFI_YesInheritance_AnoOvrd_testCommonPUNameSpecifiedPersistencePathLibJar_PUB_OVRD_EJB_SF_CMEX() throws Exception {
        final String testName = "jpa10_Injection_DFI_YesInheritance_AnoOvrd_testCommonPUNameSpecifiedPersistencePathLibJar_PUB_OVRD_EJB_SF_CMEX";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DFI_YesInheritance_AnoOvrd_testUniquePUNameAppModule_PUB_OVRD_EJB_SF_CMEX() throws Exception {
        final String testName = "jpa10_Injection_DFI_YesInheritance_AnoOvrd_testUniquePUNameAppModule_PUB_OVRD_EJB_SF_CMEX";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DFI_YesInheritance_AnoOvrd_testUniquePUNameLibJar_PUB_OVRD_EJB_SF_CMEX() throws Exception {
        final String testName = "jpa10_Injection_DFI_YesInheritance_AnoOvrd_testUniquePUNameLibJar_PUB_OVRD_EJB_SF_CMEX";
        final String testMethod = "testInjectionTarget";
