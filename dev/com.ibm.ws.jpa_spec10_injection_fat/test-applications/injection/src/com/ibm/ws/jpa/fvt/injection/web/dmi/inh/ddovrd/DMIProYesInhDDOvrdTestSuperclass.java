...
package com.ibm.ws.jpa.fvt.injection.web.dmi.inh.ddovrd;
 ...
 *
 */
public abstract class DMIProYesInhDDOvrdTestSuperclass extends DMIInhCommonServletSuperclass {
    private static final long serialVersionUID = 6501604791500163273L;
...
//    }
    ...
    @PersistenceContext(unitName = "COMMON_JTA", type = PersistenceContextType.TRANSACTION,
                        name = "jpa/DMIProYesInhDDOvrdTestServlet/ovdem_cmts_common_webapp")
    ...
    @PersistenceContext(unitName = "WEBAPP_JTA", type = PersistenceContextType.TRANSACTION,
                        name = "jpa/DMIProYesInhDDOvrdTestServlet/ovdem_cmts_webapp_webapp")
    ...
    @PersistenceContext(unitName = "../lib/jpapulib.jar#COMMON_JTA", type = PersistenceContextType.TRANSACTION,
                        name = "jpa/DMIProYesInhDDOvrdTestServlet/ovdem_cmts_common_earlib")
...
//
//    @PersistenceContext(unitName="../jpapuroot.jar#COMMON_JTA", type=PersistenceContextType.TRANSACTION,
//            name="jpa/DMIProYesInhDDOvrdTestServlet/ovdem_cmts_common_earroot")
...
//    }
    ...
    @PersistenceContext(unitName = "JPALIB_JTA", type = PersistenceContextType.TRANSACTION,
                        name = "jpa/DMIProYesInhDDOvrdTestServlet/ovdem_cmts_jpalib_earlib")
...
//
//    @PersistenceContext(unitName="JPAROOT_JTA", type=PersistenceContextType.TRANSACTION,
//            name="jpa/DMIProYesInhDDOvrdTestServlet/ovdem_cmts_jparoot_earroot")
...
//    }
    ...
    @PersistenceUnit(unitName = "COMMON_JTA", name = "jpa/DMIProYesInhDDOvrdTestServlet/ovdemf_amjta_common_webapp")
    ...
    @PersistenceUnit(unitName = "WEBAPP_JTA", name = "jpa/DMIProYesInhDDOvrdTestServlet/ovdemf_amjta_webapp_webapp")
    ...
    @PersistenceUnit(unitName = "../lib/jpapulib.jar#COMMON_JTA", name = "jpa/DMIProYesInhDDOvrdTestServlet/ovdemf_amjta_common_earlib")
...
//    }
//
//    @PersistenceUnit(unitName="../jpapuroot.jar#COMMON_JTA", name="jpa/DMIProYesInhDDOvrdTestServlet/ovdemf_amjta_common_earroot")
...
//    }
    ...
    @PersistenceUnit(unitName = "JPALIB_JTA", name = "jpa/DMIProYesInhDDOvrdTestServlet/ovdemf_amjta_jpalib_earlib")
...
//    }
//
//    @PersistenceUnit(unitName="JPAROOT_JTA", name="jpa/DMIProYesInhDDOvrdTestServlet/ovdemf_amjta_jparoot_earroot")
...
//    }
    ...
    @PersistenceUnit(unitName = "COMMON_RL", name = "jpa/DMIProYesInhDDOvrdTestServlet/ovdemf_amrl_common_webapp")
    ...
    @PersistenceUnit(unitName = "WEBAPP_RL", name = "jpa/DMIProYesInhDDOvrdTestServlet/ovdemf_amrl_webapp_webapp")
    ...
    @PersistenceUnit(unitName = "../lib/jpapulib.jar#COMMON_RL", name = "jpa/DMIProYesInhDDOvrdTestServlet/ovdemf_amrl_common_earlib")
...
//    }
//
//    @PersistenceUnit(unitName="../jpapuroot.jar#COMMON_RL", name="jpa/DMIProYesInhDDOvrdTestServlet/ovdemf_amrl_common_earroot")
...
//    }
    ...
    @PersistenceUnit(unitName = "JPALIB_RL", name = "jpa/DMIProYesInhDDOvrdTestServlet/ovdemf_amrl_jpalib_earlib")
...
//    }
//
//    @PersistenceUnit(unitName="JPAROOT_RL", name="jpa/DMIProYesInhDDOvrdTestServlet/ovdemf_amrl_jparoot_earroot")
