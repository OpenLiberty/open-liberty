...
@Stateful(name = "DMIPkgNoInhSFEXEJB")
@Local(DMIPkgNoInhSFEXEJBLocal.class)
@TransactionManagement(javax.ejb.TransactionManagementType.BEAN)
public class DMIPkgNoInhSFEXEJB extends BMTEJBTestVehicle {
    /*
    ...
    @PersistenceContext(unitName = "COMMON_JTA", type = PersistenceContextType.EXTENDED,
                        name = "jpa/DMIPkgNoInhTestEJB/ovdem_cmex_common_ejb")
    ...
    @PersistenceContext(unitName = "EJB_JTA", type = PersistenceContextType.EXTENDED,
                        name = "jpa/DMIPkgNoInhTestEJB/ovdem_cmex_ejb_ejb")
    ...
    @PersistenceContext(unitName = "../lib/jpapulib.jar#COMMON_JTA", type = PersistenceContextType.EXTENDED,
                        name = "jpa/DMIPkgNoInhTestEJB/ovdem_cmex_common_earlib")
    ...
    @PersistenceContext(unitName = "JPALIB_JTA", type = PersistenceContextType.EXTENDED,
                        name = "jpa/DMIPkgNoInhTestEJB/ovdem_cmex_jpalib_earlib")
