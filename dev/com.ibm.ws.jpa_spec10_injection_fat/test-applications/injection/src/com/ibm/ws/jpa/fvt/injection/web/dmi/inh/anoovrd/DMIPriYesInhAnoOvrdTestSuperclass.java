 ...
 *
 */
public abstract class DMIPriYesInhAnoOvrdTestSuperclass extends DMIInhCommonServletSuperclass {
    private static final long serialVersionUID = 3792522266821368660L;
...
//    private void setEm_cmts_common_earroot(EntityManager emCmtsCommonEarroot) {
...
//    private void setEm_cmts_jparoot_earroot(EntityManager emCmtsJparootEarroot) {
...
//    private void setEmf_amjta_common_earroot(EntityManagerFactory emfAmjtaCommonEarroot) {
...
//    private void setEmf_amjta_jparoot_earroot(EntityManagerFactory emfAmjtaJparootEarroot) {
...
//    private void setEmf_amrl_common_earroot(EntityManagerFactory emfAmrlCommonEarroot) {
...
//    private void setEmf_amrl_jparoot_earroot(EntityManagerFactory emfAmrlJparootEarroot) {
...
//    }
    ...
    @SuppressWarnings("unused")
    @PersistenceUnit(unitName = "COMMON_JTA", name = "jpa/DMIPriYesInhAnoOvrdTestServlet/ovdemf_amjta_common_webapp")
    ...
    @SuppressWarnings("unused")
    @PersistenceUnit(unitName = "WEBAPP_JTA", name = "jpa/DMIPriYesInhAnoOvrdTestServlet/ovdemf_amjta_webapp_webapp")
    ...
    @SuppressWarnings("unused")
    @PersistenceUnit(unitName = "../lib/jpapulib.jar#COMMON_JTA", name = "jpa/DMIPriYesInhAnoOvrdTestServlet/ovdemf_amjta_common_earlib")
...
//
//    @SuppressWarnings("unused")
//    @PersistenceUnit(unitName="../jpapuroot.jar#COMMON_JTA", name="jpa/DMIPriYesInhAnoOvrdTestServlet/ovdemf_amjta_common_earroot")
...
//    }
    ...
    @SuppressWarnings("unused")
    @PersistenceUnit(unitName = "JPALIB_JTA", name = "jpa/DMIPriYesInhAnoOvrdTestServlet/ovdemf_amjta_jpalib_earlib")
...
//
//    @SuppressWarnings("unused")
//    @PersistenceUnit(unitName="JPAROOT_JTA", name="jpa/DMIPriYesInhAnoOvrdTestServlet/ovdemf_amjta_jparoot_earroot")
...
//    }
    ...
    @SuppressWarnings("unused")
    @PersistenceUnit(unitName = "COMMON_RL", name = "jpa/DMIPriYesInhAnoOvrdTestServlet/ovdemf_amrl_common_webapp")
    ...
    @SuppressWarnings("unused")
    @PersistenceUnit(unitName = "WEBAPP_RL", name = "jpa/DMIPriYesInhAnoOvrdTestServlet/ovdemf_amrl_webapp_webapp")
    ...
    @SuppressWarnings("unused")
    @PersistenceUnit(unitName = "../lib/jpapulib.jar#COMMON_RL", name = "jpa/DMIPriYesInhAnoOvrdTestServlet/ovdemf_amrl_common_earlib")
...
//
//    @SuppressWarnings("unused")
//    @PersistenceUnit(unitName="../jpapuroot.jar#COMMON_RL", name="jpa/DMIPriYesInhAnoOvrdTestServlet/ovdemf_amrl_common_earroot")
...
//    }
    ...
    @SuppressWarnings("unused")
    @PersistenceUnit(unitName = "JPALIB_RL", name = "jpa/DMIPriYesInhAnoOvrdTestServlet/ovdemf_amrl_jpalib_earlib")
...
//
//    @SuppressWarnings("unused")
//    @PersistenceUnit(unitName="JPAROOT_RL", name="jpa/DMIPriYesInhAnoOvrdTestServlet/ovdemf_amrl_jparoot_earroot")
