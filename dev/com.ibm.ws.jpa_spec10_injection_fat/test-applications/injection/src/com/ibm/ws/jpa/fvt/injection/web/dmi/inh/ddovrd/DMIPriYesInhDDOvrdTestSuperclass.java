...
//    @SuppressWarnings("unused")
//    @PersistenceContext(unitName="../jpapuroot.jar#COMMON_JTA", type=PersistenceContextType.TRANSACTION,
//            name="jpa/DMIPriYesInhDDOvrdTestServlet/ovdem_cmts_common_earroot")
...
//    @SuppressWarnings("unused")
//    @PersistenceContext(unitName="JPAROOT_JTA", type=PersistenceContextType.TRANSACTION,
//            name="jpa/DMIPriYesInhDDOvrdTestServlet/ovdem_cmts_jparoot_earroot")
...
//
//    @SuppressWarnings("unused")
//    @PersistenceUnit(unitName="../jpapuroot.jar#COMMON_JTA", name="jpa/DMIPriYesInhDDOvrdTestServlet/ovdemf_amjta_common_earroot")
...
//
//    @SuppressWarnings("unused")
//    @PersistenceUnit(unitName="JPAROOT_JTA", name="jpa/DMIPriYesInhDDOvrdTestServlet/ovdemf_amjta_jparoot_earroot")
...
//
//    @SuppressWarnings("unused")
//    @PersistenceUnit(unitName="../jpapuroot.jar#COMMON_RL", name="jpa/DMIPriYesInhDDOvrdTestServlet/ovdemf_amrl_common_earroot")
...
//
//    @SuppressWarnings("unused")
//    @PersistenceUnit(unitName="JPAROOT_RL", name="jpa/DMIPriYesInhDDOvrdTestServlet/ovdemf_amrl_jparoot_earroot")
