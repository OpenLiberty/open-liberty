 ...
 *
 */
public abstract class DFIPubYesInhDDOvrdTestSuperclass extends JPATestServlet {
    private static final long serialVersionUID = 4408562037616998166L;
...
//    public EntityManager em_cmts_common_earroot;
...
//    public EntityManager em_cmts_jparoot_earroot;
...
//    public EntityManagerFactory emf_amjta_common_earroot;
...
//    public EntityManagerFactory emf_amjta_jparoot_earroot;
...
//    public EntityManagerFactory emf_amrl_common_earroot;
...
//    public EntityManagerFactory emf_amrl_jparoot_earroot;
    ...
    // This EntityManager should refer to the COMMON_JTA in the Web App module
    @PersistenceContext(unitName = "COMMON_JTA", type = PersistenceContextType.TRANSACTION,
                        name = "jpa/DFIPubYesInhDDOvrdTestServlet/ovdem_cmts_common_webapp")
    public EntityManager ovdem_cmts_common_webapp;

    // This EntityManager should refer to the WEBAPP_JTA in the Web App module
    @PersistenceContext(unitName = "WEBAPP_JTA", type = PersistenceContextType.TRANSACTION,
                        name = "jpa/DFIPubYesInhDDOvrdTestServlet/ovdem_cmts_webapp_webapp")
    public EntityManager ovdem_cmts_webapp_webapp;

    // This EntityManager should refer to the COMMON_JTA in the jar in the Application's Library directory
    @PersistenceContext(unitName = "../lib/jpapulib.jar#COMMON_JTA", type = PersistenceContextType.TRANSACTION,
                        name = "jpa/DFIPubYesInhDDOvrdTestServlet/ovdem_cmts_common_earlib")
    public EntityManager ovdem_cmts_common_earlib;

//    // This EntityManager should refer to the COMMON_JTA in the jar in the EAR file's root directory
//    @PersistenceContext(unitName="../jpapuroot.jar#COMMON_JTA", type=PersistenceContextType.TRANSACTION,
//                        name="jpa/DFIPubYesInhDDOvrdTestServlet/ovdem_cmts_common_earroot")
//    public EntityManager ovdem_cmts_common_earroot;

    // This EntityManager should refer to the JPALIB_JTA in the jar in the Application's Library directory
    @PersistenceContext(unitName = "JPALIB_JTA", type = PersistenceContextType.TRANSACTION,
                        name = "jpa/DFIPubYesInhDDOvrdTestServlet/ovdem_cmts_jpalib_earlib")
    public EntityManager ovdem_cmts_jpalib_earlib;

//    // This EntityManager should refer to the JPAROOT_JTA in the jar in the EAR file's root directory
//    @PersistenceContext(unitName="JPAROOT_JTA", type=PersistenceContextType.TRANSACTION,
//                        name="jpa/DFIPubYesInhDDOvrdTestServlet/ovdem_cmts_jparoot_earroot")
//    public EntityManager ovdem_cmts_jparoot_earroot;

    // Application Managed Persistence Unit, JTA-Transaction

    // This EntityManager should refer to the COMMON_JTA in the Web App module
    @PersistenceUnit(unitName = "COMMON_JTA", name = "jpa/DFIPubYesInhDDOvrdTestServlet/ovdemf_amjta_common_webapp")
    public EntityManagerFactory ovdemf_amjta_common_webapp;

    // This EntityManager should refer to the WEBAPP_JTA in the Web App module
    @PersistenceUnit(unitName = "WEBAPP_JTA", name = "jpa/DFIPubYesInhDDOvrdTestServlet/ovdemf_amjta_webapp_webapp")
    public EntityManagerFactory ovdemf_amjta_webapp_webapp;

    // This EntityManager should refer to the COMMON_JTA in the jar in the Application's Library directory
    @PersistenceUnit(unitName = "../lib/jpapulib.jar#COMMON_JTA", name = "jpa/DFIPubYesInhDDOvrdTestServlet/ovdemf_amjta_common_earlib")
    public EntityManagerFactory ovdemf_amjta_common_earlib;

//    // This EntityManager should refer to the COMMON_JTA in the jar in the EAR file's root directory
//    @PersistenceUnit(unitName="../jpapuroot.jar#COMMON_JTA", name="jpa/DFIPubYesInhDDOvrdTestServlet/ovdemf_amjta_common_earroot")
//    public EntityManagerFactory ovdemf_amjta_common_earroot;

    // This EntityManager should refer to the JPALIB_JTA in the jar in the Application's Library directory
    @PersistenceUnit(unitName = "JPALIB_JTA", name = "jpa/DFIPubYesInhDDOvrdTestServlet/ovdemf_amjta_jpalib_earlib")
    public EntityManagerFactory ovdemf_amjta_jpalib_earlib;

//    // This EntityManager should refer to the JPAROOT_JTA in the jar in the EAR file's root directory
//    @PersistenceUnit(unitName="JPAROOT_JTA", name="jpa/DFIPubYesInhDDOvrdTestServlet/ovdemf_amjta_jparoot_earroot")
//    public EntityManagerFactory ovdemf_amjta_jparoot_earroot;

    // Application Managed Persistence Unit, RL-Transaction

    // This EntityManager should refer to the COMMON_RL in the Web App module
    @PersistenceUnit(unitName = "COMMON_RL", name = "jpa/DFIPubYesInhDDOvrdTestServlet/ovdemf_amrl_common_webapp")
    public EntityManagerFactory ovdemf_amrl_common_webapp;

    // This EntityManager should refer to the WEBAPP_RL in the Web App module
    @PersistenceUnit(unitName = "WEBAPP_RL", name = "jpa/DFIPubYesInhDDOvrdTestServlet/ovdemf_amrl_webapp_webapp")
    public EntityManagerFactory ovdemf_amrl_webapp_webapp;

    // This EntityManager should refer to the COMMON_RL in the jar in the Application's Library directory
    @PersistenceUnit(unitName = "../lib/jpapulib.jar#COMMON_RL", name = "jpa/DFIPubYesInhDDOvrdTestServlet/ovdemf_amrl_common_earlib")
    public EntityManagerFactory ovdemf_amrl_common_earlib;

//    // This EntityManager should refer to the COMMON_RL in the jar in the EAR file's root directory
//    @PersistenceUnit(unitName="../jpapuroot.jar#COMMON_RL", name="jpa/DFIPubYesInhDDOvrdTestServlet/ovdemf_amrl_common_earroot")
//    public EntityManagerFactory ovdemf_amrl_common_earroot;

    // This EntityManager should refer to the JPALIB_RL in the jar in the Application's Library directory
    @PersistenceUnit(unitName = "JPALIB_RL", name = "jpa/DFIPubYesInhDDOvrdTestServlet/ovdemf_amrl_jpalib_earlib")
    public EntityManagerFactory ovdemf_amrl_jpalib_earlib;

//    // This EntityManager should refer to the JPAROOT_RL in the jar in the EAR file's root directory
//    @PersistenceUnit(unitName="JPAROOT_RL", name="jpa/DFIPubYesInhDDOvrdTestServlet/ovdemf_amrl_jparoot_earroot")
//    public EntityManagerFactory ovdemf_amrl_jparoot_earroot;
