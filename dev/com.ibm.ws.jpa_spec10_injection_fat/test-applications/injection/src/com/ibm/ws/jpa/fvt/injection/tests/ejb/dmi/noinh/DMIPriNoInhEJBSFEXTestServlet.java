 ...
 *
 */
public class DMIPriNoInhEJBSFEXTestServlet extends EJBTestVehicleServlet {
    ...
    private final static String ejbJNDIName = "ejb/dmi/noinh/DMIPriNoInhSFEXEJB";
     ...
     */
    @Test
    public void jpa10_Injection_DMI_NoInheritance_testCommonPUName_PRI_NOOVRD_EJB_SF_CMEX() throws Exception {
        final String testName = "jpa10_Injection_DMI_NoInheritance_testCommonPUName_PRI_NOOVRD_EJB_SF_CMEX";
    ...
    @Test
    public void jpa10_Injection_DMI_NoInheritance_testCommonPUNameSpecifiedPersistencePathLibJar_PRI_NOOVRD_EJB_SF_CMEX() throws Exception {
        final String testName = "jpa10_Injection_DMI_NoInheritance_testCommonPUNameSpecifiedPersistencePathLibJar_PRI_NOOVRD_EJB_SF_CMEX";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DMI_NoInheritance_testUniquePUNameAppModule_PRI_NOOVRD_EJB_SF_CMEX() throws Exception {
        final String testName = "jpa10_Injection_DMI_NoInheritance_testUniquePUNameAppModule_PRI_NOOVRD_EJB_SF_CMEX";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DMI_NoInheritance_testUniquePUNameLibJar_PRI_NOOVRD_EJB_SF_CMEX() throws Exception {
        final String testName = "jpa10_Injection_DMI_NoInheritance_testUniquePUNameLibJar_PRI_NOOVRD_EJB_SF_CMEX";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DMI_NoInheritance_testCommonPUName_PRI_OVRD_EJB_SF_CMEX() throws Exception {
        final String testName = "jpa10_Injection_DMI_NoInheritance_testCommonPUName_PRI_OVRD_EJB_SF_CMEX";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DMI_NoInheritance_testCommonPUNameSpecifiedPersistencePathLibJar_PRI_OVRD_EJB_SF_CMEX() throws Exception {
        final String testName = "jpa10_Injection_DMI_NoInheritance_testCommonPUNameSpecifiedPersistencePathLibJar_PRI_OVRD_EJB_SF_CMEX";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DMI_NoInheritance_testUniquePUNameAppModule_PRI_OVRD_EJB_SF_CMEX() throws Exception {
        final String testName = "jpa10_Injection_DMI_NoInheritance_testUniquePUNameAppModule_PRI_OVRD_EJB_SF_CMEX";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DMI_NoInheritance_testUniquePUNameLibJar_PRI_OVRD_EJB_SF_CMEX() throws Exception {
        final String testName = "jpa10_Injection_DMI_NoInheritance_testUniquePUNameLibJar_PRI_OVRD_EJB_SF_CMEX";
        final String testMethod = "testInjectionTarget";
