 ...
 *
 */
public class DMIPkgYesInhAnoOvrdEJBSFTestServlet extends EJBTestVehicleServlet {
    ...
    private final static String ejbJNDIName = "ejb/dmi/inh/ano/DMIPkgYesInhAnoOvrdTestSFEJB";
...
//                       new JPAPersistenceContext("cleanup", PersistenceContextType.APPLICATION_MANAGED_RL, PersistenceInjectionType.JNDI, "jpa/cleanup"));
    ...
    @Test
    public void jpa10_Injection_DMI_YesInheritance_testCommonPUName_PKG_NOOVRD_EJB_SF_AMJTA() throws Exception {
        final String testName = "jpa10_Injection_DMI_YesInheritance_testCommonPUName_PKG_NOOVRD_EJB_SF_AMJTA";
    ...
    @Test
    public void jpa10_Injection_DMI_YesInheritance_testCommonPUName_PKG_NOOVRD_EJB_SF_AMRL() throws Exception {
        final String testName = "jpa10_Injection_DMI_YesInheritance_testCommonPUName_PKG_NOOVRD_EJB_SF_AMRL";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DMI_YesInheritance_testCommonPUName_PKG_NOOVRD_EJB_SF_CMTS() throws Exception {
        final String testName = "jpa10_Injection_DMI_YesInheritance_testCommonPUName_PKG_NOOVRD_EJB_SF_CMTS";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DMI_YesInheritance_testCommonPUNameSpecifiedPersistencePathLibJar_PKG_NOOVRD_EJB_SF_AMJTA() throws Exception {
        final String testName = "jpa10_Injection_DMI_YesInheritance_testCommonPUNameSpecifiedPersistencePathLibJar_PKG_NOOVRD_EJB_SF_AMJTA";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DMI_YesInheritance_testCommonPUNameSpecifiedPersistencePathLibJar_PKG_NOOVRD_EJB_SF_AMRL() throws Exception {
        final String testName = "jpa10_Injection_DMI_YesInheritance_testCommonPUNameSpecifiedPersistencePathLibJar_PKG_NOOVRD_EJB_SF_AMRL";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DMI_YesInheritance_testCommonPUNameSpecifiedPersistencePathLibJar_PKG_NOOVRD_EJB_SF_CMTS() throws Exception {
        final String testName = "jpa10_Injection_DMI_YesInheritance_testCommonPUNameSpecifiedPersistencePathLibJar_PKG_NOOVRD_EJB_SF_CMTS";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DMI_YesInheritance_testUniquePUNameAppModule_PKG_NOOVRD_EJB_SF_AMJTA() throws Exception {
        final String testName = "jpa10_Injection_DMI_YesInheritance_testUniquePUNameAppModule_PKG_NOOVRD_EJB_SF_AMJTA";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DMI_YesInheritance_testUniquePUNameAppModule_PKG_NOOVRD_EJB_SF_AMRL() throws Exception {
        final String testName = "jpa10_Injection_DMI_YesInheritance_testUniquePUNameAppModule_PKG_NOOVRD_EJB_SF_AMRL";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DMI_YesInheritance_testUniquePUNameAppModule_PKG_NOOVRD_EJB_SF_CMTS() throws Exception {
        final String testName = "jpa10_Injection_DMI_YesInheritance_testUniquePUNameAppModule_PKG_NOOVRD_EJB_SF_CMTS";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DMI_YesInheritance_testUniquePUNameLibJar_PKG_NOOVRD_EJB_SF_AMJTA() throws Exception {
        final String testName = "jpa10_Injection_DMI_YesInheritance_testUniquePUNameLibJar_PKG_NOOVRD_EJB_SF_AMJTA";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DMI_YesInheritance_testUniquePUNameLibJar_PKG_NOOVRD_EJB_SF_AMRL() throws Exception {
        final String testName = "jpa10_Injection_DMI_YesInheritance_testUniquePUNameLibJar_PKG_NOOVRD_EJB_SF_AMRL";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DMI_YesInheritance_testUniquePUNameLibJar_PKG_NOOVRD_EJB_SF_CMTS() throws Exception {
        final String testName = "jpa10_Injection_DMI_YesInheritance_testUniquePUNameLibJar_PKG_NOOVRD_EJB_SF_CMTS";
        final String testMethod = "testInjectionTarget";
