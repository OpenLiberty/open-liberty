...
@Stateful(name = "EarLibLevelJTADPUMethodInjectionSFEXEJB")
@Local(EarLibLevelJTADPUMethodInjectionSFEXEJBLocal.class)
@TransactionManagement(javax.ejb.TransactionManagementType.BEAN)
public class EarLibLevelJTADPUMethodInjectionSFEXEJB extends BMTEJBTestVehicle {
