...
package com.ibm.ws.jpa.fvt.injectiondpu.web.applevel.rl;
...
//@WebServlet(urlPatterns = "/AppLevelRLDPUFieldInjectionServlet")
public class AppLevelRLDPUFieldInjectionServlet extends JPATestServlet {
    ...
    @Test
    public void jpa10_Injection_DPU_AppLevel_Field_Web_AMRL() throws Exception {
        final String testName = "jpa10_Injection_DPU_AppLevel_Field_Web_AMRL";
