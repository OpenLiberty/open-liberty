...
public class InjectionDPUServlet extends JPATestServlet {
    ...
    private void initFAT() {
        jpaPctxMap.put("test-jpa-resource-amrl",
                       new JPAPersistenceContext("test-jpa-resource-amrl", PersistenceContextType.APPLICATION_MANAGED_RL, PersistenceInjectionType.JNDI, "java:comp/env/jpa/InjectionDPU_AMRL"));

    }

    @Test
    public void jpa10_Injection_DPU_EarLibLevel_JNDI_Web_AMRL() throws Exception {
        final String testName = "jpa10_Injection_DPU_EarLibLevel_JNDI_Web_AMRL";
