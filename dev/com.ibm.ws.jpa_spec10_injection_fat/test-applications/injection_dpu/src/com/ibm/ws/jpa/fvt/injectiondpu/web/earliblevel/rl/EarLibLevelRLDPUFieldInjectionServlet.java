...
//@WebServlet(urlPatterns = "/EarLibLevelRLDPUFieldInjectionServlet")
public class EarLibLevelRLDPUFieldInjectionServlet extends JPATestServlet {
    ...
    @Test
    public void jpa10_Injection_DPU_EarLibLevel_Field_Web_AMRL() throws Exception {
        final String testName = "jpa10_Injection_DPU_EarLibLevel_Field_Web_AMRL";
