...
//@Mode(TestMode.FULL)
public class JPA10Injection_JNDI_Web extends JPAFATServletClient {
    private final static String RESOURCE_ROOT = "test-applications/injection/";
    private final static String applicationName = "InjectionJNDIWeb"; // Name of EAR
...
//        ShrinkHelper.addDirectory(jpaejbJar, libsPath + "jpaejb.jar");
    ...
    public static void tearDown() throws Exception {
        try {
            ...
            bannerEnd(JPA10Injection_JNDI_Web.class, timestart);
        }
    }
}
