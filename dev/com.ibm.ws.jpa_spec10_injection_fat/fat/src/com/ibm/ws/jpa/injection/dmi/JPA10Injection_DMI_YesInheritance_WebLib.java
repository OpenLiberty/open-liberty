...
import com.ibm.ws.jpa.fvt.injection.tests.weblib.dmi.inh.anoovrd.DMIPkgYesInhAnoOvrdTestServlet;
import com.ibm.ws.jpa.fvt.injection.tests.weblib.dmi.inh.anoovrd.DMIPriYesInhAnoOvrdTestServlet;
import com.ibm.ws.jpa.fvt.injection.tests.weblib.dmi.inh.anoovrd.DMIProYesInhAnoOvrdTestServlet;
import com.ibm.ws.jpa.fvt.injection.tests.weblib.dmi.inh.anoovrd.DMIPubYesInhAnoOvrdTestServlet;
import com.ibm.ws.jpa.fvt.injection.tests.weblib.dmi.inh.ddovrd.DMIPkgYesInhDDOvrdTestServlet;
import com.ibm.ws.jpa.fvt.injection.tests.weblib.dmi.inh.ddovrd.DMIPriYesInhDDOvrdTestServlet;
import com.ibm.ws.jpa.fvt.injection.tests.weblib.dmi.inh.ddovrd.DMIProYesInhDDOvrdTestServlet;
import com.ibm.ws.jpa.fvt.injection.tests.weblib.dmi.inh.ddovrd.DMIPubYesInhDDOvrdTestServlet;
...
@Mode(TestMode.FULL)
public class JPA10Injection_DMI_YesInheritance_WebLib extends JPAFATServletClient {
    private final static String RESOURCE_ROOT = "test-applications/injection/";
    private final static String applicationName = "JPA10Injection_DMIYesInheritance_WebLib"; // Name of EAR
    private final static String contextRoot = "JPA10Injection_DMIYesInheritance_WebLib";
    private final static String contextRoot2 = "JPA10Injection_DMIYesInheritance_DDOvrd_WebLib";
    ...
    public static void setUp() throws Exception {
        ...
        bannerStart(JPA10Injection_DMI_YesInheritance_WebLib.class);
...
//        ShrinkHelper.addDirectory(jpaejbJar, libsPath + "jpaejb.jar");
    ...
    public static void tearDown() throws Exception {
        try {
            ...
            bannerEnd(JPA10Injection_DMI_YesInheritance_WebLib.class, timestart);
        }
    }
}
