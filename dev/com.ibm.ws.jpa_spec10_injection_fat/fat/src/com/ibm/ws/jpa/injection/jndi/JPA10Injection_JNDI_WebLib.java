...
//@Mode(TestMode.FULL)
public class JPA10Injection_JNDI_WebLib extends JPAFATServletClient {
    private final static String RESOURCE_ROOT = "test-applications/injection/";
    private final static String applicationName = "InjectionJNDIWebLib"; // Name of EAR
    ...
    public static void setUp() throws Exception {
        ...
        bannerStart(JPA10Injection_JNDI_WebLib.class);
...
//        ShrinkHelper.addDirectory(jpaejbJar, libsPath + "jpaejb.jar");
    ...
    public static void tearDown() throws Exception {
        try {
            ...
            bannerEnd(JPA10Injection_JNDI_WebLib.class, timestart);
        }
    }
}
