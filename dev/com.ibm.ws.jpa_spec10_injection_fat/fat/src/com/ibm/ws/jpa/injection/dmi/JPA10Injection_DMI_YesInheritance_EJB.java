...
@Mode(TestMode.FULL)
public class JPA10Injection_DMI_YesInheritance_EJB extends JPAFATServletClient {
    private final static String RESOURCE_ROOT = "test-applications/injection/";
    private final static String applicationName = "InjectionDMIYesInheritanceEJB"; // Name of EAR
    private final static String contextRoot = "JPA10Injection_DMIYesInheritance_EJB";
    ...
    @Server("JPAServerDMI")
    @TestServlets({
                    @TestServlet(servlet = DMIPkgYesInhAnoOvrdEJBSLTestServlet.class, path = contextRoot + "/" + "DMIPkgYesInhAnoOvrdEJBSLTestServlet"),
                    @TestServlet(servlet = DMIPriYesInhAnoOvrdEJBSLTestServlet.class, path = contextRoot + "/" + "DMIPriYesInhAnoOvrdEJBSLTestServlet"),
                    @TestServlet(servlet = DMIProYesInhAnoOvrdEJBSLTestServlet.class, path = contextRoot + "/" + "DMIProYesInhAnoOvrdEJBSLTestServlet"),
                    @TestServlet(servlet = DMIPubYesInhAnoOvrdEJBSLTestServlet.class, path = contextRoot + "/" + "DMIPubYesInhAnoOvrdEJBSLTestServlet"),

                    @TestServlet(servlet = DMIPkgYesInhAnoOvrdEJBSFTestServlet.class, path = contextRoot + "/" + "DMIPkgYesInhAnoOvrdEJBSFTestServlet"),
                    @TestServlet(servlet = DMIPkgYesInhAnoOvrdEJBSFEXTestServlet.class, path = contextRoot + "/" + "DMIPkgYesInhAnoOvrdEJBSFEXTestServlet"),

                    @TestServlet(servlet = DMIPriYesInhAnoOvrdEJBSFTestServlet.class, path = contextRoot + "/" + "DMIPriYesInhAnoOvrdEJBSFTestServlet"),
                    @TestServlet(servlet = DMIPriYesInhAnoOvrdEJBSFEXTestServlet.class, path = contextRoot + "/" + "DMIPriYesInhAnoOvrdEJBSFEXTestServlet"),

                    @TestServlet(servlet = DMIProYesInhAnoOvrdEJBSFTestServlet.class, path = contextRoot + "/" + "DMIProYesInhAnoOvrdEJBSFTestServlet"),
                    @TestServlet(servlet = DMIProYesInhAnoOvrdEJBSFEXTestServlet.class, path = contextRoot + "/" + "DMIProYesInhAnoOvrdEJBSFEXTestServlet"),

                    @TestServlet(servlet = DMIPubYesInhAnoOvrdEJBSFTestServlet.class, path = contextRoot + "/" + "DMIPubYesInhAnoOvrdEJBSFTestServlet"),
                    @TestServlet(servlet = DMIPubYesInhAnoOvrdEJBSFEXTestServlet.class, path = contextRoot + "/" + "DMIPubYesInhAnoOvrdEJBSFEXTestServlet"),
    ...
    public static void setUp() throws Exception {
        ...
        bannerStart(JPA10Injection_DMI_YesInheritance_EJB.class);
