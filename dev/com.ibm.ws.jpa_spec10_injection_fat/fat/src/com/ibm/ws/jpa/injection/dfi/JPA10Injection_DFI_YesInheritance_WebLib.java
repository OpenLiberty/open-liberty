...
import com.ibm.ws.jpa.fvt.injection.tests.weblib.dfi.inh.anoovrd.DFIPkgYesInhAnoOvrdTestServlet;
import com.ibm.ws.jpa.fvt.injection.tests.weblib.dfi.inh.anoovrd.DFIPriYesInhAnoOvrdTestServlet;
import com.ibm.ws.jpa.fvt.injection.tests.weblib.dfi.inh.anoovrd.DFIProYesInhAnoOvrdTestServlet;
import com.ibm.ws.jpa.fvt.injection.tests.weblib.dfi.inh.anoovrd.DFIPubYesInhAnoOvrdTestServlet;
import com.ibm.ws.jpa.fvt.injection.tests.weblib.dfi.inh.ddovrd.DFIPkgYesInhDDOvrdTestServlet;
import com.ibm.ws.jpa.fvt.injection.tests.weblib.dfi.inh.ddovrd.DFIPriYesInhDDOvrdTestServlet;
import com.ibm.ws.jpa.fvt.injection.tests.weblib.dfi.inh.ddovrd.DFIProYesInhDDOvrdTestServlet;
import com.ibm.ws.jpa.fvt.injection.tests.weblib.dfi.inh.ddovrd.DFIPubYesInhDDOvrdTestServlet;
...
@Mode(TestMode.FULL)
public class JPA10Injection_DFI_YesInheritance_WebLib extends JPAFATServletClient {
    private final static String RESOURCE_ROOT = "test-applications/injection/";
    private final static String applicationName = "JPA10Injection_DFIYesInheritance_WebLib"; // Name of EAR
    private final static String contextRoot = "JPA10Injection_DFIYesInheritance_WebLib";
    private final static String contextRoot2 = "JPA10Injection_DFIYesInheritance_DDOvrd_WebLib";
    ...
    public static void setUp() throws Exception {
        ...
        bannerStart(JPA10Injection_DFI_YesInheritance_WebLib.class);
...
//        ShrinkHelper.addDirectory(jpaejbJar, libsPath + "jpaejb.jar");
    ...
    public static void tearDown() throws Exception {
        try {
            ...
            bannerEnd(JPA10Injection_DFI_YesInheritance_WebLib.class, timestart);
        }
    }
}
