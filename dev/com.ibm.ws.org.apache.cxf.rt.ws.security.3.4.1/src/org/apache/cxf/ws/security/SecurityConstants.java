...
public final class SecurityConstants extends org.apache.cxf.rt.security.SecurityConstants {
    ...
    // Liberty Change Start: Add configuration for Key Agreement Type
    public static final String CUSTOM_ALG_SUITE_KEY_AGREEMENT_METHOD_TYPE =
        "ws-security.custom.alg.suite.encryption.key.agreement.method";
    // Liberty Change End
