 ...
 * generated in the web.wsatAppService.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _SayHelloToOtherWithoutResponse_QNAME = new QName("http://server.wsatAppService.web/", "sayHelloToOtherWithoutResponse");
    private final static QName _SayHelloToOtherWithout_QNAME = new QName("http://server.wsatAppService.web/", "sayHelloToOtherWithout");
    private final static QName _SayHelloToOtherResponse_QNAME = new QName("http://server.wsatAppService.web/", "sayHelloToOtherResponse");
    private final static QName _SayHelloToOther_QNAME = new QName("http://server.wsatAppService.web/", "sayHelloToOther");
    private final static QName _SayHelloResponse_QNAME = new QName("http://server.wsatAppService.web/", "sayHelloResponse");
    private final static QName _SayHello_QNAME = new QName("http://server.wsatAppService.web/", "sayHello");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: web.wsatAppService.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.wsatAppService.web/", name = "sayHelloToOtherWithoutResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.wsatAppService.web/", name = "sayHelloToOtherWithout")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.wsatAppService.web/", name = "sayHelloToOtherResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.wsatAppService.web/", name = "sayHelloToOther")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.wsatAppService.web/", name = "sayHelloResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.wsatAppService.web/", name = "sayHello")
