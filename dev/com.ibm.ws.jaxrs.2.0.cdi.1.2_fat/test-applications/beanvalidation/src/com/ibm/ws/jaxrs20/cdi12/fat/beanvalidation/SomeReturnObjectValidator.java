...
@RequestScoped
public class SomeReturnObjectValidator implements ConstraintValidator<ValidSomeReturnString, String> {
    ...
    public boolean isValid(String someString, ConstraintValidatorContext pContext) {
        new Throwable("DEBUG: SomeReturnObjectValidator.isValid(...)").printStackTrace();
