...
@Provider
@RequestScoped
public class RequestScopedProvider implements ExceptionMapper<RequestScopedException>, Serializable {
    ...
    @Override
    public Response toResponse(RequestScopedException arg0) {
