 ...
 */
@SessionScoped
@Path("/SessionScopedSingleton")
public class SessionScopedSingleton implements Serializable {
    ...
    public String postMessage(String incomingMessage) {
        ...
        SessionScopedSingleton.message = incomingMessage;
    ...
    public Response putMessage(byte[] incomingMessage) {
        ...
        SessionScopedSingleton.message = new String(incomingMessage);
    ...
    public Response deleteMessage() {
        SessionScopedSingleton.message = null;
