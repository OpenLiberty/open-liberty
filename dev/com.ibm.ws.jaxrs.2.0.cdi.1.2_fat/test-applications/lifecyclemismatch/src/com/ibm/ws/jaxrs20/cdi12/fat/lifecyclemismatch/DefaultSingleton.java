 ...
 */
@Path("/DefaultSingleton")
public class DefaultSingleton implements Serializable {
    ...
    public String postMessage(String incomingMessage) {
        ...
        DefaultSingleton.message = incomingMessage;
    ...
    public Response putMessage(byte[] incomingMessage) {
        ...
        DefaultSingleton.message = new String(incomingMessage);
