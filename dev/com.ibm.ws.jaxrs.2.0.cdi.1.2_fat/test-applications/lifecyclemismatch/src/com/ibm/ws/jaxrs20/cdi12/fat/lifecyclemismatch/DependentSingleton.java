 ...
 */
@Dependent
@Path("/DependentSingleton")
public class DependentSingleton implements Serializable {
    ...
    public String postMessage(String incomingMessage) {
        ...
        DependentSingleton.message = incomingMessage;
    ...
    public Response putMessage(byte[] incomingMessage) {
        ...
        DependentSingleton.message = new String(incomingMessage);
    ...
    public Response deleteMessage() {
        DependentSingleton.message = null;
