 ...
 */
@RequestScoped
@Path("/RequestScopedResource")
public class RequestScopedResource implements Serializable {
    ...
    public String postMessage(String incomingMessage) {
        ...
        RequestScopedResource.message = incomingMessage;
    ...
    public Response putMessage(byte[] incomingMessage) {
        ...
        RequestScopedResource.message = new String(incomingMessage);
    ...
    public Response deleteMessage() {
        RequestScopedResource.message = null;
