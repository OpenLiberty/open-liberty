 ...
 */
@Dependent
@Path("/DependentResource")
public class DependentResource implements Serializable {
    ...
    public String postMessage(String incomingMessage) {
        ...
        DependentResource.message = incomingMessage;
    ...
    public Response putMessage(byte[] incomingMessage) {
        ...
        DependentResource.message = new String(incomingMessage);
    ...
    public Response deleteMessage() {
        DependentResource.message = null;
