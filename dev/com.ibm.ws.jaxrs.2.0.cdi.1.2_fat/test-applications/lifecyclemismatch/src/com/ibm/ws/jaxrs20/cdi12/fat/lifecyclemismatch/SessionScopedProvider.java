...
@Provider
@SessionScoped
public class SessionScopedProvider implements ExceptionMapper<SessionScopedException>, Serializable {
    ...
    @Override
    public Response toResponse(SessionScopedException arg0) {
