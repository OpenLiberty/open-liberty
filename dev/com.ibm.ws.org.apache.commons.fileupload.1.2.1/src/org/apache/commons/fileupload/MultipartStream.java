...
public class MultipartStream {
    ...
    MultipartStream(InputStream input,
        ...
        // CVE-2016-3092 update
        // We prepend CR/LF to the boundary to chop trailng CR/LF from
        // body-data tokens.

        this.boundaryLength = boundary.length + BOUNDARY_PREFIX.length;
        if (bufSize < this.boundaryLength + 1) { // CVE-2014-0050 Start
        ...
        this.boundary = new byte[this.boundaryLength]; // CVE-2014-0050 End
     ...
     * method using a constant size buffer. (see {@link #MultipartStream(InputStream,byte[],int, MultipartStream.ProgressNotifier) constructor}).
     * 
