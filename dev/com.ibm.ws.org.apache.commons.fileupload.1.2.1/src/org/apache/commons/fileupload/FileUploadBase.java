...
public abstract class FileUploadBase {
        ...
        try {
            ...
            while (iter.hasNext()) {
                ...
                try {
                    ...
                    //IBM fix - delete file upon error
                    if (error) {
                        try {
                            fileItem.delete();
                        } catch(Exception e) {
                            //do nothing as we don't want this to change the error processing (and this is extra fileupload behavior) 
                        }
                    }
                }
    ...
    private class FileItemIteratorImpl implements FileItemIterator {
        ...
        FileItemIteratorImpl(RequestContext ctx)
            ...
            try{ // CVE-2014-0050 Start PI12926
