...
import static io.openliberty.classloading.classpath.fat.FATSuite.CLASSPATH_TEST_DEFAULT_LOADER_DROPINS_SERVER;
...
public class ClassPathDefaultLoaderDropinsTests extends FATServletClient {

    @Server(CLASSPATH_TEST_DEFAULT_LOADER_DROPINS_SERVER)
    @TestServlets({
    ...
    public static void setupTestServer() throws Exception {
        ShrinkHelper.exportDropinAppToServer(server, TEST_CLASS_PATH_EAR, DeployOptions.SERVER_ONLY);
        server.startServer();
    }
