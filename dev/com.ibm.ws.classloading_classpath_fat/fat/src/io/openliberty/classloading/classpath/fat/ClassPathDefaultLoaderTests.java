...
import static io.openliberty.classloading.classpath.fat.FATSuite.CLASSPATH_TEST_DEFAULT_LOADER_SERVER;
...
public class ClassPathDefaultLoaderTests extends FATServletClient {

    @Server(CLASSPATH_TEST_DEFAULT_LOADER_SERVER)
    @TestServlets({
