...
/**
 * Second in-WAR implementation, used by the State 2 NCDFE probe of Test 1
 ...
 * {@code TestFeatureApi2} while loading this class in State 2, it must walk the
 ...
 */
public class TestFeatureApiImpl2 implements TestFeatureApi2 {

    @Override
    public String doWork() {
        return "TestFeatureApiImpl2.doWork() called successfully (state 2, fresh interface)";
    }
}
