 ...
 * Loading it in State 2 (after the library JAR is removed from the fileset) forces
 ...
 * <p>
 * Compare with {@link LibraryRemovalFeatureLibImplCachedApi}, which implements the
 * already-cached {@code TestFeatureApi} and whose load outcome reveals whether the
 * loader was evicted at all.
 */
public class LibraryRemovalFeatureLibImplFreshApi implements TestFeatureApi2 {
    @Override
    public String doWork() {
        return "LibraryRemovalFeatureLibImplFreshApi.doWork() called successfully — Test 3 State 2 (fresh interface)";
    }
}
