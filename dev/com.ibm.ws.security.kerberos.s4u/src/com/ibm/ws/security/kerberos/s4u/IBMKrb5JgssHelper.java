...
public class IBMKrb5JgssHelper implements Krb5HelperJdk {

    private static final TraceComponent tc = Tr.register(IBMKrb5JgssHelper.class);
    ...
    @Reference(policy = ReferencePolicy.STATIC,
               target = "(|(&(java.specification.version=1.8)(!(java.vendor=ibm corporation)))(java.specification.version>1.8))")
