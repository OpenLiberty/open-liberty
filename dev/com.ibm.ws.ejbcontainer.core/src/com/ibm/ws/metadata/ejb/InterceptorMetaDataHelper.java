...
public class InterceptorMetaDataHelper {
    ...
    public static void populateInterceptorBindingMap(List<InterceptorBinding> bindingList, Map<String, List<EJBInterceptorBinding>> map) throws EJBConfigurationException {
        ...
        for (InterceptorBinding ib : bindingList) {
            ...
            if (ejbName.equals("*")) {
                // Style 1 InterceptorBinding, which is for default interceptors.
                if (nm != null) {
                ...
                // Style 2 InterceptorBinding, which is for class level interceptors
                ...
                // Style 3 InterceptorBinding, which is for method level interceptors
                ...
                // Style 4 InterceptorBinding, which is for method level interceptors
     ...
     */
    public static Map<String, Interceptor> populateInterceptorsMap(ClassLoader classLoader, Interceptors interceptors,
                                                                   IdentityHashMap<Class<?>, EnumMap<InterceptorMethodKind, List<Method>>> interceptorsMap,
                                                                   J2EEName name) throws EJBConfigurationException {
        if (TraceComponent.isAnyTracingEnabled() && tc.isEntryEnabled()) {
     ...
     */
    private static void populateInterceptorMethodMap(Class<?> c, LinkedList<Class<?>> lifoClasses, InterceptorMethodKind kind, Class<?>[] parmTypes,
                                                     List<? extends InterceptorCallback> methodMetaDataList, Map<InterceptorMethodKind, List<Method>> methodMap, boolean ejbClass,
                                                     J2EEName name) throws EJBConfigurationException {
        ...
        for (InterceptorCallback methodMetaData : methodMetaDataList) {
            ...
            if (m == null) {
                ...
                Tr.error(tc, "INTERCEPTOR_METHOD_NOT_FOUND_CNTR0238E", new Object[] { methodName, kind.getXMLElementName(), className });
                throw ecex;
            }
     ...
     * @throws EJBConfigurationException is thrown if configuration error is detected.
     */
    public static EnumMap<InterceptorMethodKind, List<Method>> getEJBInterceptorMethods(Class<?> ejbClass, EnterpriseBean bean, LinkedList<Class<?>> lifoClasses,
                                                                                        J2EEName name) throws EJBConfigurationException {
    ...
    public static LinkedList<Class<?>> getLIFOSuperClassesList(Class<?> interceptorClass) {
        ...
        while (interceptorSuperClass != null && interceptorSuperClass != java.lang.Object.class) {
    ...
    public static void validateAroundSignature(InterceptorMethodKind kind, Method m, J2EEName name) throws EJBConfigurationException {
        ...
        // Get the modifiers for the interceptor method and verify that the
        ...
        if ((parmTypes.length == 1) && (parmTypes[0].equals(InvocationContext.class))) {
            ...
            throw new EJBConfigurationException(kind.getXMLElementName() + " interceptor \"" + method
                                                + "\" must have a single parameter of type javax.interceptor.InvocationContext.");
        }
        ...
        if (returnType != Object.class) {
            ...
            if (!compatiblyValid || isValidationLoggable()) {
                String method = m.toGenericString();
                Tr.error(tc, "INVALID_AROUND_INVOKE_SIGNATURE_CNTR0230E", new Object[] { method, kind.getXMLElementName() }); // F743-17763.1
                if (!compatiblyValid || isValidationFailable()) {
                    throw new EJBConfigurationException(kind.getXMLElementName() + " interceptor \"" + method
    ...
    static void validateLifeCycleSignatureExceptParameters(InterceptorMethodKind kind,
                                                           ...
                                                           boolean ejbClass,
                                                           J2EEName name,
                                                           boolean isInterceptor1_2) throws EJBConfigurationException {
