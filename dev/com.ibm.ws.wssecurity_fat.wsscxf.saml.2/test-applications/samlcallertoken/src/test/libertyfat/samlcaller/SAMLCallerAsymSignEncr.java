...
@WebServiceProvider(targetNamespace="http://caller.libertyfat.test/contract",
                    serviceName="SAMLCallerAsymSignEncrService", portName="SAMLCallerAsymSignEncrPort",
...
/**
 */
public class SAMLCallerAsymSignEncr implements javax.xml.ws.Provider<SOAPMessage> {
    ...
    public SOAPMessage invoke(SOAPMessage request) {
        ...
        String respMsg = new String(
                               ...
                               "<SOAP-ENV:Body><provider><message>Liberty Fat SamlCaller SAMLCallerAsymSignEncr(" + PrincipalUserID +
