...
@WebServiceProvider(targetNamespace="http://caller.libertyfat.test/contract",
                    serviceName="SAMLCallerAsymSignService", portName="SAMLCallerAsymSignPort",
...
/**
 */
public class SAMLCallerAsymSign implements javax.xml.ws.Provider<SOAPMessage> {
    ...
    public SOAPMessage invoke(SOAPMessage request) {
        ...
        String respMsg = new String(
                               ...
                               "<SOAP-ENV:Body><provider><message>Liberty Fat SamlCaller SAMLCallerAsymSign(" + PrincipalUserID +
