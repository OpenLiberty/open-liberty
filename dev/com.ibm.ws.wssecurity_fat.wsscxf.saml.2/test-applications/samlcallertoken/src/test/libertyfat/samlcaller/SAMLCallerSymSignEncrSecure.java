...
@WebServiceProvider(targetNamespace="http://caller.libertyfat.test/contract",
                    serviceName="SAMLCallerSymSignEncrSecureService", portName="SAMLCallerSymSignEncrSecurePort",
...
/**
 */
public class SAMLCallerSymSignEncrSecure implements javax.xml.ws.Provider<SOAPMessage> {
    ...
    public SOAPMessage invoke(SOAPMessage request) {
        ...
        String respMsg = new String(
                               ...
                               "<SOAP-ENV:Body><provider><message>Liberty Fat SamlCaller SAMLCallerSymSignEncrSecure(" + PrincipalUserID +
