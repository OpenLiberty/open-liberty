...
public class MessageModeOutInterceptor extends AbstractPhaseInterceptor<Message> {
    ...
    public void handleMessage(Message message) throws Fault {
        //LOG.info("@TJJ MessageModeOutInterceptor.handleMessage(Message message) entry: " + message);
        ...
        //LOG.info("@TJJ MessageModeOutInterceptor.handleMessage(Message message) exit: " + message);
    }
