...
public class SameSiteAddCookieServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String cookieNameToAdd = req.getParameter("cookieNameToAdd");
        ...
        if (cookieNameToAdd != null) {
            Cookie cookie = new Cookie(cookieNameToAdd, cookieNameToAdd);
            resp.addCookie(cookie);
            pw.print("Adding a Cookie with the following name: " + cookieNameToAdd);
        }
    }
