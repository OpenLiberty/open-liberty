...
/*
 * Testing default (false) behavior of WC property
 *      com.ibm.ws.webcontainer.set400SCOnTooManyParentDirs
 *
 * return a 500 for Non-valid URI (detected by WSUtils)
 *
...
public class WC500BadRequestDefaultTest {
    ...
    @Server("servlet40_500ResponseServer_Default")
    public static LibertyServer server;

    private static final Logger LOG = Logger.getLogger(WC500BadRequestDefaultTest.class.getName());
    ...
    public static void setupClass() throws Exception {
        ...
        server.startServer(WC500BadRequestDefaultTest.class.getSimpleName() + ".log");
     ...
     * Default behavior expects a 500 response status
     *
    ...
    public void testBadRequestURIDefault() throws Exception {
