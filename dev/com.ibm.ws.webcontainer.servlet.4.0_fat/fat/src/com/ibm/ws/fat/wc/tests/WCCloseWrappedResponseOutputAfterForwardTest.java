...
public class WCCloseWrappedResponseOutputAfterForwardTest {
    ...
    public static void setUp() throws Exception {
        ...
        WCApplicationHelper.addWarToServerDropins(server, APP_NAME + ".war", true, "filterandwrapper.war.files");

        // Start the server and use the class name so we can find logs easily.
        server.startServer(WCCloseWrappedResponseOutputAfterForwardTest.class.getSimpleName() + ".log");
        WCApplicationHelper.waitForAppStart(APP_NAME, WCCloseWrappedResponseOutputAfterForwardTest.class.getName(), server);
