 ...
 * This is for servlet 5.0 default behavior tests
 *
 * Flow:
 *
...
public class WC5CloseWrappedResponseOutputAfterForwardTest {

    private static final Logger LOG = Logger.getLogger(WC5CloseWrappedResponseOutputAfterForwardTest.class.getName());

    private static final String APP_NAME = "CloseWrappedResponseOutputForward";

    //reuse the servlet50 server
    ...
    public static void before() throws Exception {
        ...
        server.startServer(WC5CloseWrappedResponseOutputAfterForwardTest.class.getSimpleName() + ".log");
     ...
     */
    @Test
    public void test_50nonWrapResponse_closeOutputStreamAfterForward() throws Exception {
     ...
     */
    @Test
    public void test_50wrapResponse_closeOutputStreamAfterForward() throws Exception {
