...
public class WCContextRootPrecedence extends LoggingTest {
	...
	public static void setUp() throws Exception {
		...
		SHARED_SERVER.getLibertyServer()
				.waitForStringInLog("CWWKZ0001I.* TestDefaultContextPathWithEndSlashInvalidCase", 10000);
		SHARED_SERVER.getLibertyServer()
				.waitForStringInLog("CWWKZ0001I.* TestDefaultContextPathWithoutStartSlashInvalidCase", 10000);
