...
public class EndpointCMTNonJMS implements MessageListener {
    ...
    public void ejbCreate() {
        System.out.println("--EndpointCMTNonJMS: ejbCreate");
    }
    ...
    public void onMessage(Message message) {
        if (AdapterUtil.inGlobalTransaction()) {
            System.out.println("EndpointCMTNonJMS is in a global transaction");
        } else {
            System.out.println("EndpointCMTNonJMS is in a local transaction");
        }
        System.out.println("--onMessage: EndpointCMTNonJMS got the message :" + message);
    }
    ...
    public void onStringMessage(String message) {
        ...
        System.out.println("--onStringMessage: EndpointCMTNonJMS got the message :" + message);
    ...
    public void onIntegerMessage(Integer message) {
        ...
        System.out.println("--onIntegerMessage: EndpointCMTNonJMS got the message :" + message);
    }
