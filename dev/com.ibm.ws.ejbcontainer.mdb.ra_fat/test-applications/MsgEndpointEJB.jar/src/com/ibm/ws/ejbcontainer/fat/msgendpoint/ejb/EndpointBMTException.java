...
public class EndpointBMTException implements MessageListener {
    ...
    public void ejbCreate() {
        System.out.println("--EndpointBMTException: ejbCreate");
    }
    ...
    public void onMessage(Message message) {
        if (AdapterUtil.inGlobalTransaction()) {
            System.out.println("EndpointBMTException is in a global transaction");
        } else {
            System.out.println("EndpointBMTException is in a local transaction");
        }
        System.out.println("--onMessage: EndpointBMTException got the message :" + message);
    }
    ...
    public void onStringMessage(String message) {
        ...
        System.out.println("--onStringMessage: EndpointBMTException got the message :" + message);
