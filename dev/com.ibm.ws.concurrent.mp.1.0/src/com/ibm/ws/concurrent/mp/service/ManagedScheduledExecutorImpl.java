...
import com.ibm.ws.concurrent.mp.spi.CompletableFutureFactory;
...
public class ManagedScheduledExecutorImpl extends AbstractManagedScheduledExecutorService implements ManagedExecutor {
    ...
    public <U> CompletableFuture<U> completedFuture(U value) {
        return CompletableFutureFactory.completedFuture(value, this);
    }

    @Override
    public <U> CompletionStage<U> completedStage(U value) {
        return CompletableFutureFactory.completedStage(value, this);
    }
    ...
    public <U> CompletableFuture<U> failedFuture(Throwable ex) {
        return CompletableFutureFactory.failedFuture(ex, this);
    }

    @Override
    public <U> CompletionStage<U> failedStage(Throwable ex) {
        return CompletableFutureFactory.failedStage(ex, this);
    }
    ...
    public <U> CompletableFuture<U> newIncompleteFuture() {
        return CompletableFutureFactory.newIncompleteFuture(this);
    }

    @Override
    public CompletableFuture<Void> runAsync(Runnable runnable) {
        return CompletableFutureFactory.runAsync(runnable, this);
    }
    ...
    public <U> CompletableFuture<U> supplyAsync(Supplier<U> supplier) {
        return CompletableFutureFactory.supplyAsync(supplier, this);
    }
