...
import com.ibm.ws.concurrent.mp.service.ManagedExecutorImpl;
import com.ibm.ws.concurrent.mp.service.ThreadContextImpl;
...
public class ManagedExecutorBuilderImpl implements ManagedExecutor.Builder {
    ...
    public ManagedExecutor build() {
        ...
        ThreadContextImpl mpThreadContext = new ThreadContextImpl(threadContextName, hash, configPerProvider);
