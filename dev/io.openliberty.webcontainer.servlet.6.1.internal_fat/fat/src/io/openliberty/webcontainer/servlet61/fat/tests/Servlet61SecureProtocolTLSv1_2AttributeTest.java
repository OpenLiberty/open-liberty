...
/**
 * Test TLSv1.2 set in request attribute "jakarta.servlet.request.secure_protocol"
 *
 */
@RunWith(FATRunner.class)
@Mode(TestMode.FULL)
public class Servlet61SecureProtocolTLSv1_2AttributeTest {
    private static final Logger LOG = Logger.getLogger(Servlet61SecureProtocolTLSv1_2AttributeTest.class.getName());
    private static final String TEST_APP_NAME = "SecureProtocolRequestAttribute";

    private static final int CONN_TIMEOUT = 5;

    @Server("servlet61_SecureProtocolTLSv1_2AttributeTest")
     ...
     *
     * TLSv1.2 is controlled by the server setting
     */
    @Test
    public void test_RequestAttribute_SecureProtocol_TLSv1_2() throws Exception {
        LOG.info("====== <test_RequestAttribute_SecureProtocol_TLSv1_2> ======");
        ...
        try {
            ...
            while ((body = reader.readLine()) != null) {
                ...
                assertTrue("The response did not contain [TLSv1.2] . Response [" + body + "]", body != null ? body.contains("TLSv1.2") : null);
            }
