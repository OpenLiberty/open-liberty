...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0217_SELECT",
                                    query = "SELECT e FROM Entity0217 e WHERE e.entity0217_id1 = :id1_0217 AND e.entity0217_id2 = :id2_0217 AND e.entity0217_id3 = :id3_0217")
              })
@Entity
@IdClass(IdClass0217.class)
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0217")
public class Entity0217 {
    ...
    @Version
    private Short entity0217_version;

    private String entity0217_string01;

    private String entity0217_string02;

    private String entity0217_string03;

    public Entity0217() {}

    public Entity0217(BigInteger id1,
                      BigInteger id2,
                      BigInteger id3,
                      Short version,
                      String string01,
        ...
        this.entity0217_version = version;
        this.entity0217_string01 = string01;
        this.entity0217_string02 = string02;
        this.entity0217_string03 = string03;
    }
    ...
    public String toString() {
        return (" Entity0217: " +
                ...
                " entity0217_version: " + getEntity0217_version() +
                " entity0217_string01: " + getEntity0217_string01() +
                " entity0217_string02: " + getEntity0217_string02() +
                " entity0217_string03: " + getEntity0217_string03());
    }
    ...
    public void setEntity0217_id1(BigInteger p) {
        this.entity0217_id1 = p;
    }
    ...
    public void setEntity0217_id2(BigInteger p) {
        this.entity0217_id2 = p;
    }
    ...
    public void setEntity0217_id3(BigInteger p) {
        this.entity0217_id3 = p;
    }

    public Short getEntity0217_version() {
        return entity0217_version;
    }

    public void setEntity0217_version(Short p) {
        this.entity0217_version = p;
    }

    public String getEntity0217_string01() {
        return entity0217_string01;
    }

    public void setEntity0217_string01(String p) {
        this.entity0217_string01 = p;
    }

    public String getEntity0217_string02() {
        return entity0217_string02;
    }

    public void setEntity0217_string02(String p) {
        this.entity0217_string02 = p;
    }

    public String getEntity0217_string03() {
        return entity0217_string03;
    }

    public void setEntity0217_string03(String p) {
        this.entity0217_string03 = p;
    }
}
