 ...
 * </ol>
 */
public class IdClass0313 implements Serializable {
    ...
    public boolean equals(Object o) {
        if (o == null)
            return false;
        if (!(o instanceof IdClass0313))
            return false;
        if (o == this)
            return true;
        IdClass0313 idClass = (IdClass0313) o;
        return (idClass.entity0313_id1 == entity0313_id1 &&
                idClass.entity0313_id2 == entity0313_id2 &&
                idClass.entity0313_id3 == entity0313_id3);
    }

    @Override
    public int hashCode() {
        int result = 0;
        result = result + entity0313_id1.hashCode();
        result = result + entity0313_id2;
        result = result + entity0313_id3.hashCode();
        return result;
    }
