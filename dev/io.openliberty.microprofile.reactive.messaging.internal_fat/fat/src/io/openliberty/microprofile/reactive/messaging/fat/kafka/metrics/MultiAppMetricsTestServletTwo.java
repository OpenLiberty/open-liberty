...
@WebServlet("/MultiAppMetricsTestServletTwo")
@ApplicationScoped
public class MultiAppMetricsTestServletTwo extends AbstractKafkaTestServlet {

    public static final String INCOMING_TOPIC_NAME = "AppTwoTopicOne";
    public static final String OUTGOING_TOPIC_NAME = "AppTwoTopicTwo";

    @Inject
    private KafkaTestClient kafkaTestClient;

    // called manually from MultiAppMetricsTest
    public void stringToReverse() throws Exception {
