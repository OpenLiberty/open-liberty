...
@WebServiceProvider(targetNamespace = "http://wssecfat.test",
                    serviceName = "NoPassService", portName = "UrnNoPassUNT",
                    wsdlLocation = "WEB-INF/nopassunt1.wsdl")
 ...
 * @author Todd Roling
 */
public class FVTVersion_np01 implements javax.xml.ws.Provider<SOAPMessage> {
    ...
    public SOAPMessage invoke(SOAPMessage request) {
        ...
        try {
            System.out.println("Incoming Client Request as a SOAPMessage(np01)");
            ...
            StringReader respMsg = new StringReader("<SOAP-ENV:Envelope xmlns:SOAP-ENV=\"http://schemas.xmlsoap.org/soap/envelope/\">" +
                                                    "<SOAP-ENV:Body><provider><message>WSSECFVT NoPass Version: 1.0-1.0</message></provider></SOAP-ENV:Body>" +
                                                    "</SOAP-ENV:Envelope>");
