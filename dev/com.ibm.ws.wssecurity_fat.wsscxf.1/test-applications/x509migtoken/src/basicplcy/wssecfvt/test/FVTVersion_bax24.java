...
@WebServiceProvider(targetNamespace = "http://x509mig.libertyfat.test/contract",
                    serviceName = "FatBAX24Service", portName = "UrnX509Token24",
 ...
 * @author Todd Roling
 */
public class FVTVersion_bax24 implements javax.xml.ws.Provider<SOAPMessage> {
    ...
    public SOAPMessage invoke(SOAPMessage request) {
        ...
        try {
            System.out.println("Incoming Client Request as a SOAPMessage(mig bax24)");
            ...
            StringReader respMsg = new StringReader("<SOAP-ENV:Envelope xmlns:SOAP-ENV=\"http://schemas.xmlsoap.org/soap/envelope/\">" +
                                                    "<SOAP-ENV:Body><provider><message>LIBERTYFAT X509 bax24</message></provider></SOAP-ENV:Body>" +
                                                    "</SOAP-ENV:Envelope>");
