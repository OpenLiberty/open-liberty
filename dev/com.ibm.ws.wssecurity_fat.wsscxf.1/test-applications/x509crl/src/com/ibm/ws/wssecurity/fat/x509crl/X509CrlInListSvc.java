...
@WebServiceProvider(targetNamespace="http://x509crl.wssecfvt.test",
    portName="X509CrlInList",
    serviceName="X509CrlInListService",
    wsdlLocation = "WEB-INF/X509Crl.wsdl"
)

@ServiceMode(value = Service.Mode.MESSAGE)

public class X509CrlInListSvc implements Provider<SOAPMessage> {

    public X509CrlInListSvc() {
        super();
        try {
            SharedTools.fixProviderOrder("X509CrlInListSvc");
        } catch (Exception e) {
    ...
    public SOAPMessage invoke(SOAPMessage request) {
        ...
        try {
            ...
            StringReader respMsg = new StringReader("<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\"><soapenv:Body xmlns=\"http://x509crl.wssecfvt.test/types\"><provider>This is X509CrlInListService Web Service.</provider></soapenv:Body></soapenv:Envelope>");
