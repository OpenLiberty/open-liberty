...
@javax.jws.WebService(endpointInterface = "com.ibm.was.wssample.sei.echo.EchoServicePortType",
                      ...
                      serviceName = "Echo4Service",
                      wsdlLocation = "WEB-INF/wsdl/Echo.wsdl",
                      portName = "Echo4ServicePort")
public class Echo4SOAPImpl {

    private static final Logger LOG = Logger.getLogger(Echo4SOAPImpl.class.getName());

    public EchoStringResponse echoOperation(EchoStringInput parameter) {
        LOG.info("(Echo4SoapImpl)Executing operation echoOperation");
        String strInput = (parameter == null ? "input_is_null" : parameter.getEchoInput());
        System.out.println("(WSSampleSei)Echo4SOAPImpl:" + parameter + ":" + strInput);
        try {
            com.ibm.was.wssample.sei.echo.EchoStringResponse _return = new EchoStringResponse();
            // Echo back
            _return.setEchoResponse("Echo4SOAPImpl>>" + strInput);
            return _return;
