...
@WebServiceProvider(targetNamespace = "http://sha2sig.wssecfvt.test",
                    portName = "UrnSha2Sig6",
                    serviceName = "Sha2SigService6",
                    wsdlLocation = "WEB-INF/Sha2SigAlg.wsdl")

@ServiceMode(value = Service.Mode.MESSAGE)

public class Sha2SigWebSvc6 implements Provider<SOAPMessage> {
    ...
    public SOAPMessage invoke(SOAPMessage request) {
        ...
        try {
            ...
            StringReader respMsg = new StringReader("<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\"><soapenv:Body xmlns=\"http://sha2sig.wssecfvt.test/types\"><provider>This is WSSECFVT SHA2To1 Web Service.</provider></soapenv:Body></soapenv:Envelope>");
