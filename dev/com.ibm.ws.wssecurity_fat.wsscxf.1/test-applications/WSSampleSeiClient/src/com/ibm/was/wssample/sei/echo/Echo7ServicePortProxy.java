...
public class Echo7ServicePortProxy implements EchoProxyInterface {

    protected Descriptor _descriptor;

    public class Descriptor {
        private com.ibm.was.wssample.sei.echo.Echo7Service _service = null;
        ...
        public Descriptor(Echo7Service echo7Service) {
            init(echo7Service);
        }

        public Descriptor(URL wsdlLocation, QName serviceName) {
            _service = new com.ibm.was.wssample.sei.echo.Echo7Service(wsdlLocation, serviceName);
            initCommon();
        }
        ...
        public void init() {
            ...
            try {
                ...
                _service = (com.ibm.was.wssample.sei.echo.Echo7Service) ctx.lookup("java:comp/env/service/Echo7Service");
            ...
            if (_service == null && !_useJNDIOnly)
                _service = new com.ibm.was.wssample.sei.echo.Echo7Service();
            initCommon();
        }

        // Newly added to allow the EcoService to be added
        public void init(Echo7Service echo7Service) {
            _service = echo7Service;
            _proxy = null;
            _dispatch = null;
            if (_service == null) {
                try {
        ...
        private void initCommon() {
            _proxy = _service.getEcho7ServicePort();
        }
        ...
        public Dispatch<Source> getDispatch() {
            if (_dispatch == null) {
                QName portQName = new QName("http://com/ibm/was/wssample/sei/echo/", "Echo7ServicePort");
        ...
        public void setEndpoint(String endpointUrl) {
            System.out.println("Echo7Service in Proxy is:" + _service);
            BindingProvider bp = (BindingProvider) _proxy;
    ...
    public Echo7ServicePortProxy() {
        _descriptor = new Descriptor();
        _descriptor.setMTOMEnabled(false);
    }

    // Newly added to allow the EcoService to be added
    public Echo7ServicePortProxy(Service echo7Service) {
        _descriptor = new Descriptor((Echo7Service) echo7Service);
        _descriptor.setMTOMEnabled(false);
    }

    public Echo7ServicePortProxy(URL wsdlLocation, QName serviceName) {
    ...
    public String getEchoResponse(Object object, String endpointURL, String input) throws Exception {
        Echo7ServicePortProxy proxy = (Echo7ServicePortProxy) object;
