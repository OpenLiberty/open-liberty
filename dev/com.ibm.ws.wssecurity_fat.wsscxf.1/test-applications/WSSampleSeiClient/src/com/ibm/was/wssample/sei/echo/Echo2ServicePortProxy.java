...
public class Echo2ServicePortProxy implements EchoProxyInterface {

    protected Descriptor _descriptor;

    public class Descriptor {
        private com.ibm.was.wssample.sei.echo.Echo2Service _service = null;
        ...
        public Descriptor(Echo2Service echo2Service) {
            init(echo2Service);
        }

        public Descriptor(URL wsdlLocation, QName serviceName) {
            _service = new com.ibm.was.wssample.sei.echo.Echo2Service(wsdlLocation, serviceName);
            initCommon();
        }
        ...
        public void init() {
            ...
            try {
                ...
                _service = (com.ibm.was.wssample.sei.echo.Echo2Service) ctx.lookup("java:comp/env/service/Echo2Service");
            ...
            if (_service == null && !_useJNDIOnly)
                _service = new com.ibm.was.wssample.sei.echo.Echo2Service();
            initCommon();
        }

        // Newly added to allow the EcoService to be added
        public void init(Echo2Service echo2Service) {
            _service = echo2Service;
            _proxy = null;
            _dispatch = null;
            if (_service == null) {
                try {
        ...
        private void initCommon() {
            _proxy = _service.getEcho2ServicePort();
        }
        ...
        public Dispatch<Source> getDispatch() {
            if (_dispatch == null) {
                QName portQName = new QName("http://com/ibm/was/wssample/sei/echo/", "Echo2ServicePort");
        ...
        public void setEndpoint(String endpointUrl) {
            System.out.println("Echo2Service in Proxy is:" + _service);
            BindingProvider bp = (BindingProvider) _proxy;
    ...
    public Echo2ServicePortProxy() {
        _descriptor = new Descriptor();
        _descriptor.setMTOMEnabled(false);
    }

    // Newly added to allow the EcoService to be added
    public Echo2ServicePortProxy(Service echo2Service) {
        _descriptor = new Descriptor((Echo2Service) echo2Service);
        _descriptor.setMTOMEnabled(false);
    }

    public Echo2ServicePortProxy(URL wsdlLocation, QName serviceName) {
    ...
    public String getEchoResponse(Object object, String endpointURL, String input) throws Exception {
        Echo2ServicePortProxy proxy = (Echo2ServicePortProxy) object;
