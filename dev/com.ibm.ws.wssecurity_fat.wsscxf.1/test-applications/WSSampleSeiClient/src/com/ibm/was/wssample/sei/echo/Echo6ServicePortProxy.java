...
public class Echo6ServicePortProxy implements EchoProxyInterface {

    protected Descriptor _descriptor;

    public class Descriptor {
        private com.ibm.was.wssample.sei.echo.Echo6Service _service = null;
        ...
        public Descriptor(Echo6Service echo6Service) {
            init(echo6Service);
        }

        public Descriptor(URL wsdlLocation, QName serviceName) {
            _service = new com.ibm.was.wssample.sei.echo.Echo6Service(wsdlLocation, serviceName);
            initCommon();
        }
        ...
        public void init() {
            ...
            try {
                ...
                _service = (com.ibm.was.wssample.sei.echo.Echo6Service) ctx.lookup("java:comp/env/service/Echo6Service");
            ...
            if (_service == null && !_useJNDIOnly)
                _service = new com.ibm.was.wssample.sei.echo.Echo6Service();
            initCommon();
        }

        // Newly added to allow the EcoService to be added
        public void init(Echo6Service echo6Service) {
            _service = echo6Service;
            _proxy = null;
            _dispatch = null;
            if (_service == null) {
                try {
        ...
        private void initCommon() {
            _proxy = _service.getEcho6ServicePort();
        }
        ...
        public Dispatch<Source> getDispatch() {
            if (_dispatch == null) {
                QName portQName = new QName("http://com/ibm/was/wssample/sei/echo/", "Echo6ServicePort");
        ...
        public void setEndpoint(String endpointUrl) {
            System.out.println("Echo6Service in Proxy is:" + _service);
            BindingProvider bp = (BindingProvider) _proxy;
    ...
    public Echo6ServicePortProxy() {
        _descriptor = new Descriptor();
        _descriptor.setMTOMEnabled(false);
    }

    // Newly added to allow the EcoService to be added
    public Echo6ServicePortProxy(Service echo6Service) {
        _descriptor = new Descriptor((Echo6Service) echo6Service);
        _descriptor.setMTOMEnabled(false);
    }

    public Echo6ServicePortProxy(URL wsdlLocation, QName serviceName) {
    ...
    public String getEchoResponse(Object object, String endpointURL, String input) throws Exception {
        Echo6ServicePortProxy proxy = (Echo6ServicePortProxy) object;
