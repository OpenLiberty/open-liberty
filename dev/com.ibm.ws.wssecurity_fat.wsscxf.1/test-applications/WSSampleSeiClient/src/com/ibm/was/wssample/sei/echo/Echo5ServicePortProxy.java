...
public class Echo5ServicePortProxy implements EchoProxyInterface {

    protected Descriptor _descriptor;

    public class Descriptor {
        private com.ibm.was.wssample.sei.echo.Echo5Service _service = null;
        ...
        public Descriptor(Echo5Service echo5Service) {
            init(echo5Service);
        }

        public Descriptor(URL wsdlLocation, QName serviceName) {
            _service = new com.ibm.was.wssample.sei.echo.Echo5Service(wsdlLocation, serviceName);
            initCommon();
        }
        ...
        public void init() {
            ...
            try {
                ...
                _service = (com.ibm.was.wssample.sei.echo.Echo5Service) ctx.lookup("java:comp/env/service/Echo5Service");
            ...
            if (_service == null && !_useJNDIOnly)
                _service = new com.ibm.was.wssample.sei.echo.Echo5Service();
            initCommon();
        }

        // Newly added to allow the EcoService to be added
        public void init(Echo5Service echo5Service) {
            _service = echo5Service;
            _proxy = null;
            _dispatch = null;
            if (_service == null) {
                try {
        ...
        private void initCommon() {
            _proxy = _service.getEcho5ServicePort();
        }
        ...
        public Dispatch<Source> getDispatch() {
            if (_dispatch == null) {
                QName portQName = new QName("http://com/ibm/was/wssample/sei/echo/", "Echo5ServicePort");
        ...
        public void setEndpoint(String endpointUrl) {
            System.out.println("Echo5Service in Proxy is:" + _service);
            BindingProvider bp = (BindingProvider) _proxy;
    ...
    public Echo5ServicePortProxy() {
        _descriptor = new Descriptor();
        _descriptor.setMTOMEnabled(false);
    }

    // Newly added to allow the EcoService to be added
    public Echo5ServicePortProxy(Service echo5Service) {
        _descriptor = new Descriptor((Echo5Service) echo5Service);
        _descriptor.setMTOMEnabled(false);
    }

    public Echo5ServicePortProxy(URL wsdlLocation, QName serviceName) {
    ...
    public String getEchoResponse(Object object, String endpointURL, String input) throws Exception {
        Echo5ServicePortProxy proxy = (Echo5ServicePortProxy) object;
