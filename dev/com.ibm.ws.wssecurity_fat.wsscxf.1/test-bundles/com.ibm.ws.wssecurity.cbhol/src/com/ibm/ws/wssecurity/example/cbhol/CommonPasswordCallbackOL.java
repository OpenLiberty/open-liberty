...
package com.ibm.ws.wssecurity.example.cbhol;
...
import io.openliberty.wssecurity.callback.WSPasswordCallback;

/**
 */
public class CommonPasswordCallbackOL implements CallbackHandler {
    ...
    //
    public CommonPasswordCallbackOL() {
                    ...
                    if (!putUserPass(userPasswords, "userPasswords.", strTmp)) {
                        if (!putUserPass(signaturePasswords, "signaturePasswords.", strTmp)) {
                            if (!putUserPass(encryptPasswords, "encryptPasswords.", strTmp)) {
                                System.out.println("A String is not handled in CommonPasswordCallbackOL:'" + strTmp + "'");
                            }
                        }
                    }
                }
    ...
    public void handle(Callback[] callbacks) throws IOException, UnsupportedCallbackException {
        System.out.println("From CommonPasswordCallbackOL.java, using the callbacks:" + callbacks);
        for (int i = 0; i < callbacks.length; i++) {
            WSPasswordCallback pwcb = (WSPasswordCallback) callbacks[i];
            String id = pwcb.getIdentifier();
            System.out.println("From CommonPasswordCallbackOL.java: id:" + id);
            String pass = null;
            ...
            switch (pwcb.getUsage()) {
                ...
                case WSPasswordCallback.USERNAME_TOKEN:
                    ...
                    System.out.println("From CommonPasswordCallbackOL.java: Getting userPassword id:" + id);
                ...
                case WSPasswordCallback.DECRYPT:
                    System.out.println("From CommonPasswordCallbackOL.java: Getting decryptPassword id:" + id);
                    pass = encryptPasswords.get(id);
                    if (pass != null) {
                        System.out.println("From CommonPasswordCallbackOL.java: encryptPassword:" + pass);
                        pwcb.setPassword(pass);
                        return;
                    }
                ...
                case WSPasswordCallback.SIGNATURE:
                    ...
                    System.out.println("From CommonPasswordCallbackOL.java: Getting signaturePassword id:" + id);
                    pass = signaturePasswords.get(id);
                    if (pass != null) {
                        pwcb.setPassword(pass);
                        System.out.println("From CommonPasswordCallbackOL.java: signaturePassword:" + pass);
                        return;
                    }
                    break;
                default:
                    System.out.println("From CommonPasswordCallbackOL.java: Password not handled id:" + id + "  type:" + pwcb.getUsage());
                    break;
            }
        }
    }
