 ...
 */
public class ContextualRunnable implements Runnable, ContextualAction<Runnable> {
    private final Runnable action;
    private final ManagedCompletableFuture<Void> completableFuture;
    private final ThreadContextDescriptor threadContextDescriptor;

    public ContextualRunnable(ThreadContextDescriptor threadContextDescriptor, Runnable action) {
        this.action = action;
