 ...
 */
public class ContextualBiFunction<T, U, R> implements BiFunction<T, U, R>, ContextualAction<BiFunction<T, U, R>> {
    private final BiFunction<T, U, R> action;
    private final ThreadContextDescriptor threadContextDescriptor;

    public ContextualBiFunction(ThreadContextDescriptor threadContextDescriptor, BiFunction<T, U, R> action) {
        this.action = action;
