 ...
 */
public class ContextualFunction<T, R> implements Function<T, R>, ContextualAction<Function<T, R>> {
    private final Function<T, R> action;
    private final ThreadContextDescriptor threadContextDescriptor;

    public ContextualFunction(ThreadContextDescriptor threadContextDescriptor, Function<T, R> action) {
        this.action = action;
