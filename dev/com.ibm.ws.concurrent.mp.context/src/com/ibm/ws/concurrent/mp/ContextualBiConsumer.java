 ...
 */
public class ContextualBiConsumer<T, U> implements BiConsumer<T, U>, ContextualAction<BiConsumer<T, U>> {
    private final BiConsumer<T, U> action;
    private final ThreadContextDescriptor threadContextDescriptor;

    public ContextualBiConsumer(ThreadContextDescriptor threadContextDescriptor, BiConsumer<T, U> action) {
        this.action = action;
