 ...
 */
public class ContextualSupplier<T> implements Supplier<T>, ContextualAction<Supplier<T>> {
    private final Supplier<T> action;
    private final ThreadContextDescriptor threadContextDescriptor;

    public ContextualSupplier(ThreadContextDescriptor threadContextDescriptor, Supplier<T> action) {
        this.action = action;
