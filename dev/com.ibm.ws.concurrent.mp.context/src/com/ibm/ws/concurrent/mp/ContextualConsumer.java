 ...
 */
public class ContextualConsumer<T> implements Consumer<T>, ContextualAction<Consumer<T>> {
    private final Consumer<T> action;
    private final ThreadContextDescriptor threadContextDescriptor;

    public ContextualConsumer(ThreadContextDescriptor threadContextDescriptor, Consumer<T> action) {
        this.action = action;
