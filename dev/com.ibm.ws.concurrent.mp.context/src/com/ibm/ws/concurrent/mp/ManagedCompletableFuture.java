...
public class ManagedCompletableFuture<T> extends CompletableFuture<T> {
     ...
     */
    public ManagedCompletableFuture(CompletableFuture<T> completableFuture, Executor managedExecutor, FutureRefExecutor futureRef) {
        super();
     ...
     * @param futureRef reference to a policy executor Future that will be submitted if requested to run async. Otherwise null.
     */
    public ManagedCompletableFuture(Executor managedExecutor, FutureRefExecutor futureRef) {
        super();
     ...
     * @see java.util.concurrent.CompletableFuture#complete(T)
     */
    public final boolean super_complete(T value) {
        if (JAVA8)
     ...
     * @see java.util.concurrent.CompletableFuture#completeExceptionally(java.lang.Throwable)
     */
    public final boolean super_completeExceptionally(Throwable x) {
        if (JAVA8)
