 ...
 */
public class ManagedCompletionStage<T> extends ManagedCompletableFuture<T> {
     ...
     */
    public ManagedCompletionStage(CompletableFuture<T> completableFuture, Executor executor, FutureRefExecutor futureRef) {
