...
import inmemory.identity.store.PropertyNotFoundInMemoryIdentityStoreApplication;

/**
 * Tests the invalid priorityExpression: "SOMERUBBISH" in InMemoryIdentityStoreDefinition
 * Value can be resolved to a property so it throws an propertyNotFoundException in the InMemoryIdentityStoreDefinitionWrapper and should be caught with a warning shown
 */
@RunWith(FATRunner.class)
@Mode(TestMode.LITE)
public class InMemoryIdentityStorePropertyNotFoundTest extends BaseJakartaSecurity40Test {

    private static final Class<?> c = InMemoryIdentityStorePropertyNotFoundTest.class;
    ...
    public static void setUp() throws Exception {
        InMemoryIdentityStorePropertyNotFoundTest instance = new InMemoryIdentityStorePropertyNotFoundTest();
        ...
        WebArchive app = ShrinkWrap.create(WebArchive.class,
                                           APP_NAME + ".war").addClass(PropertyNotFoundInMemoryIdentityStoreApplication.class).addClass(InMemoryIdentityStoreProtectedResource.class).addAsWebInfResource(new File("test-applications/inmemory/WEB-INF/web.xml"));
     ...
     */
    @Test
    public void testELWarning() throws Exception {
