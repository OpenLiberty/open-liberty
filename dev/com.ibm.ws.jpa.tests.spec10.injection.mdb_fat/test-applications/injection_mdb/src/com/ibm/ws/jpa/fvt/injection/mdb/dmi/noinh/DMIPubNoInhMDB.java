...
@MessageDriven(activationConfig = {
                                    ...
                                    @ActivationConfigProperty(propertyName = "destination", propertyValue = "DMIPubNoInhMDB_Queue")

},
               name = "DMIPubNoInhMDB")
@TransactionManagement(TransactionManagementType.BEAN)
public class DMIPubNoInhMDB extends AbstractTestMDB {
    /*
    ...
    @PersistenceContext(unitName = "COMMON_JTA", type = PersistenceContextType.TRANSACTION,
                        name = "jpa/DMIPubNoInhMDB/ovdem_cmts_common_ejb")
    ...
    @PersistenceContext(unitName = "EJB_JTA", type = PersistenceContextType.TRANSACTION,
                        name = "jpa/DMIPubNoInhMDB/ovdem_cmts_ejb_ejb")
    ...
    @PersistenceContext(unitName = "../lib/jpapulib.jar#COMMON_JTA", type = PersistenceContextType.TRANSACTION,
                        name = "jpa/DMIPubNoInhMDB/ovdem_cmts_common_earlib")
    ...
    @PersistenceContext(unitName = "JPALIB_JTA", type = PersistenceContextType.TRANSACTION,
                        name = "jpa/DMIPubNoInhMDB/ovdem_cmts_jpalib_earlib")
    ...
    @PersistenceUnit(unitName = "COMMON_JTA", name = "jpa/DMIPubNoInhMDB/ovdemf_amjta_common_ejb")
    ...
    @PersistenceUnit(unitName = "EJB_JTA", name = "jpa/DMIPubNoInhMDB/ovdemf_amjta_ejb_ejb")
    ...
    @PersistenceUnit(unitName = "../lib/jpapulib.jar#COMMON_JTA", name = "jpa/DMIPubNoInhMDB/ovdemf_amjta_common_earlib")
    ...
    @PersistenceUnit(unitName = "JPALIB_JTA", name = "jpa/DMIPubNoInhMDB/ovdemf_amjta_jpalib_earlib")
    ...
    @PersistenceUnit(unitName = "COMMON_RL", name = "jpa/DMIPubNoInhMDB/ovdemf_amrl_common_ejb")
    ...
    @PersistenceUnit(unitName = "EJB_RL", name = "jpa/DMIPubNoInhMDB/ovdemf_amrl_ejb_ejb")
    ...
    @PersistenceUnit(unitName = "../lib/jpapulib.jar#COMMON_RL", name = "jpa/DMIPubNoInhMDB/ovdemf_amrl_common_earlib")
    ...
    @PersistenceUnit(unitName = "JPALIB_RL", name = "jpa/DMIPubNoInhMDB/ovdemf_amrl_jpalib_earlib")
