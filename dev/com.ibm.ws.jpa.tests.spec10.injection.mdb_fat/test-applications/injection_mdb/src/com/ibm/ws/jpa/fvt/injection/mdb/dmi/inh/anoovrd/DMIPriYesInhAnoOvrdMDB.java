...
@MessageDriven(activationConfig = {
                                    ...
                                    @ActivationConfigProperty(propertyName = "destination", propertyValue = "DMIPriYesInhAnoOvrdMDB_Queue")

},
               name = "DMIPriYesInhAnoOvrdMDB")
@TransactionManagement(TransactionManagementType.BEAN)
public class DMIPriYesInhAnoOvrdMDB extends DMIPriYesInhAnoOvrdTestSuperclass {
