 ...
 *
 */
public abstract class DMIPriYesInhDDOvrdTestSuperclass extends AbstractParentMDB {
    ...
    @SuppressWarnings("unused")
    @PersistenceContext(unitName = "COMMON_JTA", type = PersistenceContextType.TRANSACTION,
                        name = "jpa/DMIPriYesInhDDOvrdMDB/ovdem_cmts_common_ejb")
    ...
    @SuppressWarnings("unused")
    @PersistenceContext(unitName = "EJB_JTA", type = PersistenceContextType.TRANSACTION,
                        name = "jpa/DMIPriYesInhDDOvrdMDB/ovdem_cmts_ejb_ejb")
    ...
    @SuppressWarnings("unused")
    @PersistenceContext(unitName = "../lib/jpapulib.jar#COMMON_JTA", type = PersistenceContextType.TRANSACTION,
                        name = "jpa/DMIPriYesInhDDOvrdMDB/ovdem_cmts_common_earlib")
    ...
    @SuppressWarnings("unused")
    @PersistenceContext(unitName = "JPALIB_JTA", type = PersistenceContextType.TRANSACTION,
                        name = "jpa/DMIPriYesInhDDOvrdMDB/ovdem_cmts_jpalib_earlib")
    ...
    @SuppressWarnings("unused")
    @PersistenceUnit(unitName = "COMMON_JTA", name = "jpa/DMIPriYesInhDDOvrdMDB/ovdemf_amjta_common_ejb")
    ...
    @SuppressWarnings("unused")
    @PersistenceUnit(unitName = "EJB_JTA", name = "jpa/DMIPriYesInhDDOvrdMDB/ovdemf_amjta_ejb_ejb")
    ...
    @SuppressWarnings("unused")
    @PersistenceUnit(unitName = "../lib/jpapulib.jar#COMMON_JTA", name = "jpa/DMIPriYesInhDDOvrdMDB/ovdemf_amjta_common_earlib")
    ...
    @SuppressWarnings("unused")
    @PersistenceUnit(unitName = "JPALIB_JTA", name = "jpa/DMIPriYesInhDDOvrdMDB/ovdemf_amjta_jpalib_earlib")
    ...
    @SuppressWarnings("unused")
    @PersistenceUnit(unitName = "COMMON_RL", name = "jpa/DMIPriYesInhDDOvrdMDB/ovdemf_amrl_common_ejb")
    ...
    @SuppressWarnings("unused")
    @PersistenceUnit(unitName = "EJB_RL", name = "jpa/DMIPriYesInhDDOvrdMDB/ovdemf_amrl_ejb_ejb")
    ...
    @SuppressWarnings("unused")
    @PersistenceUnit(unitName = "../lib/jpapulib.jar#COMMON_RL", name = "jpa/DMIPriYesInhDDOvrdMDB/ovdemf_amrl_common_earlib")
    ...
    @SuppressWarnings("unused")
    @PersistenceUnit(unitName = "JPALIB_RL", name = "jpa/DMIPriYesInhDDOvrdMDB/ovdemf_amrl_jpalib_earlib")
