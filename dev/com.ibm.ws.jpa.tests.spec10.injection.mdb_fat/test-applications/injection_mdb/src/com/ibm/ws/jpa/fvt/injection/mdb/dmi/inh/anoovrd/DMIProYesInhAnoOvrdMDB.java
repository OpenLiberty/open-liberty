...
@MessageDriven(activationConfig = {
                                    ...
                                    @ActivationConfigProperty(propertyName = "destination", propertyValue = "DMIProYesInhAnoOvrdMDB_Queue")

},
               name = "DMIProYesInhAnoOvrdMDB")
@TransactionManagement(TransactionManagementType.BEAN)
public class DMIProYesInhAnoOvrdMDB extends DMIProYesInhAnoOvrdTestSuperclass {
