...
public class InboundSecurityTestServlet extends HttpServlet {
    ...
    public void testCallerIdentityPropagationFromCallerPrincipalCallback(
        ...
        System.out.println("Begin testCallerIdentityPropagationFromCallerPrincipalCallback");
        String callerIdentity = CALLER1;

        try {
            InitialContext ctx = new InitialContext();
            SampleSessionLocal local = (SampleSessionLocal) ctx.lookup("java:comp/env/ejb/SampleSessionBean");
            ...
            if (testResults.getNumberOfMessagesDelivered() == 1) {
                if (testResults.getCallerSubject() != null) {
                    Set<Principal> principalSet = testResults.getCallerSubject().getPrincipals();
                    if (principalSet != null && principalSet.size() == 1) {
                        Principal principalFromSubject = principalSet.iterator().next();
            ...
            if (!testStatus) {
                ...
                System.out.println("The Inbound Security Context propagated by the resource adapter was established for this work instance.");
            }
        } catch (Exception ex) {
            throw ex;
        } finally {
            System.out.println("End testCallerIdentityPropagationFromCallerPrincipalCallback");
        }
    }
    ...
    public void testCallerIdentityPropagationFromCallerPrincipalCallbackStartWork(
                                                                                  HttpServletRequest request, HttpServletResponse response) throws Exception {
        boolean testStatus = false;
        System.out.println("Begin testCallerIdentityPropagationFromCallerPrincipalCallbackStartWork");
        InitialContext ctx = new InitialContext();
        String callerIdentity = CALLER1;
        try {
            ...
            System.out.println("End testCallerIdentityPropagationFromCallerPrincipalCallbackStartWork");
        }
    }
    ...
    public void testCallerIdentityPropagationFromCallerPrincipalCallbackScheduleWork(
                                                                                     HttpServletRequest request, HttpServletResponse response) throws Exception {
        boolean testStatus = false;
        System.out.println("Begin testCallerIdentityPropagationFromCallerPrincipalCallbackScheduleWork");
        InitialContext ctx = new InitialContext();
        String callerIdentity = CALLER1;
        ...
        System.out.println("End testCallerIdentityPropagationFromCallerPrincipalCallbackScheduleWork");
    }
    ...
    public void testCallerIdentityPropagationFailureForDifferentRealm(
                                                                      HttpServletRequest request, HttpServletResponse response) throws Exception {
        System.out.println("Begin testCallerIdentityPropagationFailureForDifferentRealm");
        InitialContext ctx = new InitialContext();
        String callerIdentity = CALLER1;
        ...
        try {
            ...
            System.out.println("A WorkCompletedException was thrown because an error occurred during security context setup");
            return;
        } finally {
            System.out.println("End testCallerIdentityPropagationFailureForDifferentRealm");
        }
    }
    ...
    public void testCallerIdentityPropagationFailureForDifferentRealmStartWork(
                                                                               HttpServletRequest request, HttpServletResponse response) throws Exception {
        System.out.println("Begin testCallerIdentityPropagationFailureForDifferentRealmStartWork");
        InitialContext ctx = new InitialContext();
        String callerIdentity = CALLER1;
        callerIdentity = "NonExistentRealm/" + callerIdentity + "ABCDEF";
        ...
        try {
            ...
            System.out.println("Test Passed: A WorkCompletedException was thrown because an error occurred during security context setup");
        } finally {
            System.out.println("End testCallerIdentityPropagationFailureForDifferentRealmStartWork");
        }
    }
    ...
    public void testCallerIdentityPropagationFailureForDifferentRealmScheduleWork(
                                                                                  HttpServletRequest request, HttpServletResponse response) throws Exception {
        System.out.println("Begin testCallerIdentityPropagationFailureForDifferentRealmScheduleWork");
        InitialContext ctx = new InitialContext();
        String callerIdentity = CALLER1;
        callerIdentity = "NonExistentRealm/" + callerIdentity + "ABCDEF";
        ...
        try {
            ...
            System.out.println("End testCallerIdentityPropagationFailureForDifferentRealmScheduleWork");
        }
    }
    ...
    public void testCallerIdentityPropagationFailureForMultipleCPC(
        ...
        System.out.println("Begin testCallerIdentityPropagationFailureForMultipleCPC");
        InitialContext ctx = new InitialContext();
        String callerIdentity = CALLER1;
        ...
        try {
            ...
            System.out.println("End testCallerIdentityPropagationFailureForMultipleCPC");
        }
    }
    ...
    public void testCallerIdentityPropagationFailureForMultipleCPCStartWork(
                                                                            HttpServletRequest request, HttpServletResponse response) throws Throwable {
        System.out.println("Begin testCallerIdentityPropagationFailureForMultipleCPCStartWork");
        InitialContext ctx = new InitialContext();
        String callerIdentity = CALLER1;
        ...
        try {
            ...
            System.out.println("End testCallerIdentityPropagationFailureForMultipleCPCStartWork");
        }
    }
    ...
    public void testCallerIdentityPropagationFailureForMultipleCPCScheduleWork(
                                                                               HttpServletRequest request, HttpServletResponse response) throws Throwable {
        System.out.println("Begin testCallerIdentityPropagationFailureForMultipleCPCScheduleWork");
        InitialContext ctx = new InitialContext();
        String callerIdentity = CALLER1;
        ...
        try {
            ...
            System.out.println("End testCallerIdentityPropagationFailureForMultipleCPCScheduleWork");
        }
    }
    ...
    public void testCallerIdentityPropagationDiffSubjectInCallback(
                                                                   HttpServletRequest request, HttpServletResponse response) throws Throwable {
        System.out.println("Begin testCallerIdentityPropagationDiffSubjectInCallback");
        ...
        try {
            ...
            System.out.println("End testCallerIdentityPropagationDiffSubjectInCallback");
        }
    }
    ...
    public void testCallerIdentityPropagationDiffSubjectInCallbackStartWork(
                                                                            HttpServletRequest request, HttpServletResponse response) throws Throwable {
        System.out.println("Start testCallerIdentityPropagationDiffSubjectInCallbackStartWork");
        boolean testStatus = false;
        InitialContext ctx = new InitialContext();
        String callerIdentity = CALLER1;
        try {
            ...
            System.out.println("End testCallerIdentityPropagationDiffSubjectInCallbackStartWork");
        }
    }
    ...
    public void testCallerIdentityPropagationDiffSubjectInCallbackScheduleWork(
                                                                               HttpServletRequest request, HttpServletResponse response) throws Throwable {
        System.out.println("Start testCallerIdentityPropagationDiffSubjectInCallbackScheduleWork");
        boolean testStatus = false;
        InitialContext ctx = new InitialContext();
        String callerIdentity = CALLER1;
        try {
            ...
            if (testResults.getNumberOfMessagesDelivered() == 1) {
                if (testResults.getCallerSubject() != null) {
                    ...
                    if (principalSet != null && principalSet.size() == 1) {
                        Principal principalFromSubject = principalSet.iterator().next();
                        String identityFromSubject = principalFromSubject.getName();
                        if (identityFromSubject.equals(wi.getCalleridentity())) {
                            testStatus = true;
                        }
                    }
            ...
            System.out.println("End testCallerIdentityPropagationDiffSubjectInCallbackScheduleWork");
        }
    }
    ...
    public void testFailureAuthenticatedSubjectandCPCStartWork(
                                                               HttpServletRequest request, HttpServletResponse response) throws Throwable {
        System.out.println("Begin testFailureAuthenticatedSubjectandCPCStartWork");
        boolean testStatus = false;
        InitialContext ctx = new InitialContext();
        String callerIdentity = CALLER1;
        try {
            ...
            System.out.println("End testFailureAuthenticatedSubjectandCPCStartWork");
        }
        if (!testStatus) {
            throw new Exception("A WorkCompletedException was not thrown when multiple Principals are present in the executionSubject but there is no CallerPrincipalCallback.");
        }
    ...
    public void testFailureAuthenticatedSubjectandCPCScheduleWork(
                                                                  HttpServletRequest request, HttpServletResponse response) throws Throwable {
        System.out.println("Begin testFailureAuthenticatedSubjectandCPCScheduleWork");
        boolean testStatus = false;
        InitialContext ctx = new InitialContext();
        String callerIdentity = CALLER1;
        try {
            ...
            System.out.println("End testFailureAuthenticatedSubjectandCPCScheduleWork");
        }
        if (!testStatus) {
            throw new Exception("A WorkCompletedException was not thrown when multiple Principals are present in the executionSubject but there is no CallerPrincipalCallback.");
        }
            ...
            if (testResults.getNumberOfMessagesDelivered() == 1) {
                if (testResults.getCallerSubject() != null) {
                    ...
                    if (principalSet != null && principalSet.size() == 1) {
                        Principal principalFromSubject = principalSet.iterator().next();
                        String identityFromSubject = principalFromSubject.getName();
                        if (identityFromSubject.equals(wi.getSubjectIdentities()[0])) {
                            testStatus = true;
                        }
                    }
                }
    ...
    public void testCallerIdentityPropagationForNestedWork(
        ...
        try {
            ...
            nestedWorkInformation.setCallbacks(new String[] { WorkInformation.CALLERPRINCIPALCALLBACK });
            ...
            MessageEndpointTestResultsImpl[] testResults = local.sendNestedMessage(deliveryId, messageText, state,
                                                                                   waitTime, xid, xid, workExecutionType,
                                                                                   workExecutionType, wi);

            if (testResults[0].getNumberOfMessagesDelivered() == 1) {
                if (testResults[0].getCallerSubject() != null) {
                    Set<Principal> principalSet = testResults[0].getCallerSubject().getPrincipals();
                    if (principalSet != null && principalSet.size() == 1) {
                        Principal principalFromSubject = principalSet.iterator().next();
                        String identityFromSubject = principalFromSubject.getName();
                        if (identityFromSubject.equals(wi.getSubjectIdentities()[0])) {
            ...
            if (testResults[1].getNumberOfMessagesDelivered() == 1) {
                if (testResults[1].getCallerSubject() != null) {
                    Set<Principal> principalSet = testResults[1].getCallerSubject().getPrincipals();
                    if (principalSet != null && principalSet.size() == 1) {
                        Principal principalFromSubject = principalSet.iterator().next();
                        String identityFromSubject = principalFromSubject.getName();

                        if (identityFromSubject.equals(wi.getNestedWorkInformation().getCalleridentity())) {
        ...
        try {
            ...
            if (testResults.getNumberOfMessagesDelivered() == 1) {
                if (testResults.getCallerSubject() != null) {
                    ...
                    if (principalSet != null && principalSet.size() == 1) {
                        Principal principalFromSubject = principalSet.iterator().next();
                        String identityFromSubject = identityFromSubject = principalFromSubject.getName();
                        if (identityFromSubject.equals(wi.getCalleridentity())) {
                            testStatus = true;
                        }
                    }
