...
public class TestWorkContextProviderWorkImpl extends FVTGeneralWorkImpl implements WorkContextProvider {
    ...
    private static final TraceComponent tc = Tr.register(TestWorkContextProviderWorkImpl.class);
    ...
    /*
     * d174256: Added by swai. Get the exception object for WorkDispatcher so
    ...
    /*
     * d174256: Added by swai. Set the exception object to the Work so that
