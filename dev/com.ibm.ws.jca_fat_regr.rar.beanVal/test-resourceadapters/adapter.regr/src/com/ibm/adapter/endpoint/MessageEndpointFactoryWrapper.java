...
public class MessageEndpointFactoryWrapper implements MessageEndpointFactory {
    ...
    private static final TraceComponent tc = Tr.register(MessageEndpointFactoryWrapper.class);
    ...
    public String introspectSelf() {
        ...
        for (int i = endpoints.size() - 1; i >= 0; i--) {
            str.append(((MessageEndpointWrapper) endpoints.elementAt(i)).toString()
                       + lineSeparator);
        }
