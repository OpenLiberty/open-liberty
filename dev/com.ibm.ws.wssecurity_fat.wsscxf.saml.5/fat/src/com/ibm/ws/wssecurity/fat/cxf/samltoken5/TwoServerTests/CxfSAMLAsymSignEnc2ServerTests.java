...
public class CxfSAMLAsymSignEnc2ServerTests extends CxfSAMLAsymSignEncTests {
    ...
    public static void setupBeforeTest() throws Exception {
        ...
        //6/2021 update the config for EE8 test
        //ServerConfiguration config2 = testSAMLServer2.getServer().getServerConfiguration();
        //Set<String> features2 = config2.getFeatureManager().getFeatures();
        //if (features2.contains("usr:wsseccbh-2.0")) {
