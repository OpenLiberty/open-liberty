 ...
 * </ol>
 */
public class CheckpointEE10Action extends JakartaEE10Action {
    public static final String ID = EE10_ACTION_ID + "_Checkpoint";

    public CheckpointEE10Action() {
        super();
        withID(ID);
    }
    ...
    public String toString() {
        return "JakartaEE10 FAT checkpoint repeat action (" + getID() + ")";
    }
