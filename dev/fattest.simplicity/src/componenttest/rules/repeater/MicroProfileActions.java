...
public class MicroProfileActions {
    ...
    public static final String MP71_EE10_ID = JakartaEE10Action.ID + "_MicroProfile_70";
    public static final String MP71_EE11_ID = JakartaEE11Action.ID + "_MicroProfile_70";
