...
public class MicroProfileActions extends RepeatActions {
    ...
    //currently remains based on EE9 but this will switch to EE10 before GA
    ...
    public static final String MP60_ID = JakartaEE9Action.ID + "_MicroProfile_60"; //EE9 for the moment but will be EE10 before GA
    ...
    public static final FeatureSet MP60 = new FeatureSet(MP60_ID, MP60_FEATURE_SET, EEVersion.EE9); //EE9 for the moment but will be EE10 before GA
