 ...
 * </ol>
 */
public class CheckpointEE11Action extends JakartaEE11Action {
    public static final String ID = EE11_ACTION_ID + "_Checkpoint";

    public CheckpointEE11Action() {
        super();
        withID(ID);
    }
    ...
    public String toString() {
        return "JakartaEE11 FAT checkpoint repeat action (" + getID() + ")";
    }
