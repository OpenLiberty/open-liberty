...
public class ArtifactoryImageNameSubstitutor extends ImageNameSubstitutor {
     ...
     * generated by Testcontainers. FATs that use ImageFromDockerfile should consider using the ImageBuilder
     * to ensure docker hosts are pre-cached with custom images
     */
