...
/**
 * Copy of OracleXE container.
 * TODO replace instances where this container is used with the new OracleFree container
 */
@Deprecated
public class OracleXEContainer extends JdbcDatabaseContainer<OracleXEContainer> {
    ...
    public String getJdbcUrl() {
        return isUsingSid() ? "jdbc:oracle:thin:" + "@" + getHost() + ":" + getOraclePort() + ":" + getSid() : "jdbc:oracle:thin:" + "@" + getHost() + ":" + getOraclePort() + "/"
                                                                                                               + getDatabaseName();
    }
    ...
    @Override
    public OracleXEContainer withDatabaseName(String databaseName) {
    ...
    public OracleXEContainer usingSid() {
        this.usingSid = true;
        return self();
    }

    @Override
    public OracleXEContainer withUrlParam(String paramName, String paramValue) {
