...
public class Faces41CDITests {
     ...
     *  3) Exit the flow
     *  4) Verify the @Destroyed method occurred (via FacesMessage on the page)
     *  
     *  TODO: BeforeDestroyed does not work. 
     * 
     * @throws Exception
     */
    @Test
    public void testFlowScopedEventsFire() throws Exception {
        ...
        try (WebClient webClient = new WebClient()) {
            ...
            assertTrue("@Initialized message not on Page!",  page.asText().contains("Initialized FLOW"));
