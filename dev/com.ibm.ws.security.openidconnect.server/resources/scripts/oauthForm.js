...
function createForm(data) {
	...
	if (data.extendedProperties.nonce) {
		form.appendChild(createInput("nonce", data.extendedProperties.nonce));
	}
	if (data.extendedProperties.response_mode) {
		form.appendChild(createInput("response_mode", data.extendedProperties.response_mode));
	}
