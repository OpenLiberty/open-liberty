 ...
 */
public class OIDCUnsupportedResponseTypeException extends OAuth20Exception {
    ...
    public OIDCUnsupportedResponseTypeException(String error, String message, Throwable cause) {
