...
public interface FATOpentracingConstants {
     ...
     * beneath "open-liberty/dev/io.openliberty.opentracing.2.x_fat/publish/servers".</p>
     */
    ...
    String SERVICE_PACKAGE_NAME = "io.openliberty.opentracing.internal.test.service";
