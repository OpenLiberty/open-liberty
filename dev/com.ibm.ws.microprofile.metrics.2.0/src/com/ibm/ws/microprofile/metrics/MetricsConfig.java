...
@Component(service = { MetricsConfig.class }, configurationPid = "com.ibm.ws.microprofile.metrics", configurationPolicy = ConfigurationPolicy.OPTIONAL, immediate = true)
