...
public class ClientServlet extends HttpServlet {
    ...
    public Service getService( String scenario ){
        if( scenario.equals( "EchoService"  ) ) return  echoService;
        else if( scenario.equals( "Echo1Service" ) ) return  echo1Service;
        else if( scenario.equals( "Echo2Service" ) ) return  echo2Service;
        else if( scenario.equals( "Echo3Service" ) ) return  echo3Service;
        else if( scenario.equals( "Echo4Service" ) ) return  echo4Service;
        else if( scenario.equals( "Echo5Service" ) ) return  echo5Service;
        else if( scenario.equals( "Echo6Service" ) ) return  echo6Service;
        else if( scenario.equals( "Echo7Service" ) ) return  echo7Service;
        else if( scenario.equals( "Echo11Service" ) ) return  echo11Service;
        else if( scenario.equals( "Echo12Service" ) ) return  echo12Service;
        else if( scenario.equals( "Echo13Service" ) ) return  echo13Service;
        else if( scenario.equals( "Echo14Service" ) ) return  echo14Service;
        else if( scenario.equals( "Echo21Service" ) ) return  echo21Service;
        else if( scenario.equals( "Echo22Service" ) ) return  echo22Service;
        else if( scenario.equals( "Echo23Service" ) ) return  echo23Service;
        return null;
    }
