...
public class UploadIRT extends HttpServlet {
	...
	private void processRequest(HttpServletRequest req, HttpServletResponse resp)
		...
		if ((contentType != null)
			...
			context.getRequestDispatcher(CLIENT_JSP_LOCATION)
					.forward(req, resp);
		}
		...
		try {
			...
			for (int index = 0; index < nodeLst.getLength(); index++) {
				...
				if (docNode.getNodeType() == Node.ELEMENT_NODE) {
			          ...
			          feature = ((Node) thisList.item(0)).getNodeValue();
			          ...
			          address = ((Node) thisList2.item(0)).getNodeValue();
			          ...
			          wsdl = ((Node) thisList2.item(0)).getNodeValue();
