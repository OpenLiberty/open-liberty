...
public class Echo12ServicePortProxy implements EchoProxyInterface{

    protected Descriptor _descriptor;

    public class Descriptor {
        private com.ibm.was.wssample.sei.echo.Echo12Service _service = null;
        ...
        public Descriptor(Echo12Service echo12Service) {
            init( echo12Service);
        }

        public Descriptor(URL wsdlLocation, QName serviceName) {
            _service = new com.ibm.was.wssample.sei.echo.Echo12Service(wsdlLocation, serviceName);
            initCommon();
        }
        ...
        public void init() {
            ...
            try
            {
                ...
                _service = (com.ibm.was.wssample.sei.echo.Echo12Service)ctx.lookup("java:comp/env/service/Echo12Service");
            }
            ...
            if (_service == null && !_useJNDIOnly)
                _service = new com.ibm.was.wssample.sei.echo.Echo12Service();
            initCommon();
        }

        // Newly added to allow the EcoService to be added 
        public void init(Echo12Service echo12Service) {
            _service = echo12Service;
            _proxy = null;
            _dispatch = null;
            if( _service == null ){
                try
        ...
        private void initCommon() {
            _proxy = _service.getEcho12ServicePort();
        }
        ...
        public Dispatch<Source> getDispatch() {
            if (_dispatch == null ) {
                QName portQName = new QName("http://com/ibm/was/wssample/sei/echo/", "Echo12ServicePort");
        ...
        public void setEndpoint(String endpointUrl) {
            System.out.println("Echo12Service in Proxy is:" + _service);
            BindingProvider bp = (BindingProvider) _proxy;
    ...
    public Echo12ServicePortProxy() {
        _descriptor = new Descriptor();
        _descriptor.setMTOMEnabled(false);
    }

    // Newly added to allow the EcoService to be added 
    public Echo12ServicePortProxy(Service echo12Service) {
        _descriptor = new Descriptor((Echo12Service)echo12Service);
        _descriptor.setMTOMEnabled(false);
    }

    public Echo12ServicePortProxy(URL wsdlLocation, QName serviceName) {
    ...
    public String getEchoResponse( Object object, String endpointURL, String input) throws Exception {
        Echo12ServicePortProxy proxy = (Echo12ServicePortProxy) object;
