    ...
    extends Service
{
    ...
    static {
        URL url = null;
        try {
            url = com.ibm.was.wssample.sei.async.EchoService12.class.getResource("/WEB-INF/wsdl/Echo12.wsdl");
            if (url == null) throw new MalformedURLException("/WEB-INF/wsdl/Echo12.wsdl does not exist in the module.");
    ...
    public EchoService12PortType getEchoService12Port() {
        return (EchoService12PortType)super.getPort(new QName("http://com/ibm/was/wssample/sei/echo/", "EchoService12Port"), EchoService12PortType.class);
    }
    ...
    public EchoService12PortType getEchoService12Port(WebServiceFeature... features) {
        return (EchoService12PortType)super.getPort(new QName("http://com/ibm/was/wssample/sei/echo/", "EchoService12Port"), EchoService12PortType.class, features);
    }
