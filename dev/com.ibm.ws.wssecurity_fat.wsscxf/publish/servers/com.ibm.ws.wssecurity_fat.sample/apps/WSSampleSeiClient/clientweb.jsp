...
<TITLE>Interop Scenarios Client - <%=request.getAttribute("scenario")%></TITLE>
...
<P><IMG border="0" src="ws_brandmark.gif" width="150" height="21"
	...
	height="21" alt=""></P>
<H2>Interop Scenarios Client - <%=request.getAttribute("scenario")%></H2>
<FORM ID="irtfile" NAME="irtfile" ACTION="UploadIRT" method="POST"
	enctype="multipart/form-data"
	onsubmit="return validateField('filedef', 'Filename');">
<TABLE border="0" cellpadding="0" cellspacing="1" width="100%">
	<TR>
		<TD align="right"><B>IRT Filename:</B></TD>
		<TD WIDTH="8">&nbsp;</TD>
		<TD><B> <INPUT type="file" id="filedef" name="filedef"
			size="64" value=""> </B></TD>
		<td><INPUT type="submit" value="Load IRT File"> <INPUT
			type="button" value="Reset" ONCLICK="window.location='ClientWeb';">
		</td>
	</TR>
	<TR>
		<TD align="right"><B>Current File:</B></TD>
		<TD WIDTH="8">&nbsp;</TD>
		<TD><b><A href="DownloadIRT?filename=Interop_IBM.irt.xml">Interop_IBM.irt.xml</A></b></TD>
	</TR>
</table>
</FORM>
				...
				<TBODY>
					<TR>
						<TD><FONT size="+1">Scenarios</FONT> [ <A
							...
							href="javascript:selectAll(theform, false);">Select None</A> ]
						&nbsp;&nbsp;&nbsp; <input id="submit0" name="submit0"
							type="submit" value="Start Tests"></TD>
					</TR>
					<TR>
						<TD><BR>
						</TD>
										...
										<TABLE border="0">
											...
											<TR>
												...
												<TD><B> <INPUT type="text" id="uri01" name="uri01"
													size="100"
													value='<%=request.getAttribute("hostbase")%><%=request.getAttribute("context")%>/PingService'>
												</B></TD>
											</TR>
											<TR>
												...
												<TD><B> <INPUT type="text" readonly="readonly"
													...
													value='<%=request.getAttribute("hostbase")%><%=request.getAttribute("context")%>/PingService?wsdl'>
												</B></TD>
											</TR>
											<TR>
										...
										<TABLE border="0">
											...
											<TR>
												...
												<TD><B> <INPUT type="text" id="uri02" name="uri02"
													size="100"
													value='<%=request.getAttribute("hostbase")%><%=request.getAttribute("context")%>/EchoService'>
												</B></TD>
											</TR>
											<TR>
												<TD colspan="2" width="20%" align="right"><B>WSDL
												...
												<TD><B> <INPUT type="text" readonly="readonly"
													...
													value='<%=request.getAttribute("hostbase")%><%=request.getAttribute("context")%>/EchoService?wsdl'>
												</B></TD>
											</TR>
											<TR>
										...
										<TABLE border="0">
											...
											<TR>
												...
												<TD><B> <INPUT type="text" id="uri04" name="uri04"
													size="100"
													value='<%=request.getAttribute("hostbase")%><%=request.getAttribute("context")%>/PingService12'>
												</B></TD>
											</TR>
											<TR>
												<TD colspan="2" width="20%" align="right"><B>WSDL
												...
												<TD><B> <INPUT type="text" readonly="readonly"
													...
													value='<%=request.getAttribute("hostbase")%><%=request.getAttribute("context")%>/PingService12?wsdl'>
												</B></TD>
											</TR>
											<TR>
										...
										<TABLE border="0">
											...
											<TR>
												...
												<TD><B> <INPUT type="text" id="uri05" name="uri05"
													size="100"
													value='<%=request.getAttribute("hostbase")%><%=request.getAttribute("context")%>/EchoService12'>
												</B></TD>
											</TR>
											<TR>
												<TD colspan="2" width="20%" align="right"><B>WSDL
												...
												<TD><B> <INPUT type="text" readonly="readonly"
													...
													value='<%=request.getAttribute("hostbase")%><%=request.getAttribute("context")%>/EchoService12?wsdl'>
												</B></TD>
											</TR>
											<TR>
					...
					<TR>
						<TD>[ <A href="javascript:selectAll(theform, true);">Select
						All</A>, <A href="javascript:selectAll(theform, false);">Select
						None</A> ] &nbsp;&nbsp;&nbsp; <input id="submit1" name="submit1"
							type="submit" value="Start Tests"></TD>
					</TR>
				</TBODY>
			</TABLE>
