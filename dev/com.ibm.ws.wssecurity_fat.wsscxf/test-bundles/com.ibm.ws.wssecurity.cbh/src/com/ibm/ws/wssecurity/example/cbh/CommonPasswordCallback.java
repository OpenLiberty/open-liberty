...
public class CommonPasswordCallback implements CallbackHandler {
    ...
    private Map<String, String> signaturePasswords = 
    new HashMap<String, String>();

    private Map<String, String> encryptPasswords = 
    new HashMap<String, String>();
        ...
        if( bFileExist ){
            ...
            try
            {
               InputStreamReader inputStream = 
                  new InputStreamReader( new FileInputStream( filePasswd ));
    ...
    public void handle(Callback[] callbacks) throws IOException, UnsupportedCallbackException {
        System.out.println("CommonPasswordCallback :" + callbacks);
        for (int i = 0; i < callbacks.length; i++) {
            WSPasswordCallback pwcb = (WSPasswordCallback)callbacks[i];
            String id = pwcb.getIdentifier();
            System.out.println("CommonPasswordCallback: id:" + id);
            String pass = null;
            ...
            case WSPasswordCallback.USERNAME_TOKEN:
                ...
                System.out.println("CommonPasswordCallback: Getting userPassword id:" + id);
            ...
            case WSPasswordCallback.DECRYPT:
                System.out.println("CommonPasswordCallback: Getting decryptPassword id:" + id);
                pass = encryptPasswords.get(id);
                if (pass != null) {
                    System.out.println("CommonPasswordCallback: encryptPassword:" + pass);
                    pwcb.setPassword(pass);
                    return;
                }
            ...
            case WSPasswordCallback.SIGNATURE:
                ...
                if (pass != null) {
                    pwcb.setPassword(pass);
                    System.out.println("CommonPasswordCallback: signaturePassword:" + pass);
                    return;
                }
                break;
            default:
                System.out.println("CommonPasswordCallback: Password not handled id:" + id + "  type:" + pwcb.getUsage());
                break;
            }
        }
    }
