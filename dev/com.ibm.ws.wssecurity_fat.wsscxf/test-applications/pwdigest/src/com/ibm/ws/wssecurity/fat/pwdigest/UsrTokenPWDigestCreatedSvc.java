...
@WebServiceProvider(targetNamespace="http://wssec.pwdigest.cxf.fats",
	serviceName="SOAPServicePWDigestCreated",
    portName="SOAPPortPWDigestCreated",
    wsdlLocation = "WEB-INF/UsrTokenPWDigestCreatedSvc.wsdl"
)

@ServiceMode(value = Service.Mode.MESSAGE)

public class UsrTokenPWDigestCreatedSvc implements Provider<SOAPMessage> {
    ...
    public SOAPMessage invoke(SOAPMessage request) {
        ...
        try {
            ...
            String returnMsg = "<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\"><soapenv:Body xmlns=\"http://wssec.pwdigest.cxf.fats/types\"><provider>This is WSSECFVT CXF Web Service (Password Digest Created) for: " + hdrText + ".</provider></soapenv:Body></soapenv:Envelope>";
