...
@WebServlet("/CxfWssTemplatesSvcClientWithep")
public class CxfWssTemplatesSvcClientWithep extends HttpServlet {
    ...
    public CxfWssTemplatesSvcClientWithep() {
        super();
    }
 ...
 */
        ...
        wsdlLocation = theType + "://localhost:" + thePort + "/wsstemplateswithep/"
                       + rawServiceName + "?wsdl";
        ...
        try {
            ...
            String endPtUrl = theType + "://localhost:" + thePort + "/wsstemplateswithep/" + rawServiceName;
            ...
            if (rawServiceName.equals("WSSTemplatesService1")) {
                ...
                WSSTemplatesService1 service = new WSSTemplatesService1(wsdlURL, serviceName);
            ...
            if (rawServiceName.equals("WSSTemplatesService2")) {
                ...
                WSSTemplatesService2 service = new WSSTemplatesService2(wsdlURL, serviceName);
                service.addPort(servicePort, SOAPBinding.SOAP11HTTP_BINDING, endPtUrl);
                dispSOAPMsg = service.createDispatch(servicePort,
                                                     SOAPMessage.class, Mode.MESSAGE);
            }
            if (rawServiceName.equals("WSSTemplatesService3")) {
                ...
                WSSTemplatesService3 service = new WSSTemplatesService3(wsdlURL, serviceName);
                service.addPort(servicePort, SOAPBinding.SOAP11HTTP_BINDING, endPtUrl);
                dispSOAPMsg = service.createDispatch(servicePort,
                                                     SOAPMessage.class, Mode.MESSAGE);
            }
            if (rawServiceName.equals("WSSTemplatesService4")) {
                ...
                WSSTemplatesService4 service = new WSSTemplatesService4(wsdlURL, serviceName);
                service.addPort(servicePort, SOAPBinding.SOAP11HTTP_BINDING, endPtUrl);
                dispSOAPMsg = service.createDispatch(servicePort,
                                                     SOAPMessage.class, Mode.MESSAGE);
            }
            if (rawServiceName.equals("WSSTemplatesService5")) {
                ...
                WSSTemplatesService5 service = new WSSTemplatesService5(wsdlURL, serviceName);
                service.addPort(servicePort, SOAPBinding.SOAP11HTTP_BINDING, endPtUrl);
                dispSOAPMsg = service.createDispatch(servicePort,
                                                     SOAPMessage.class, Mode.MESSAGE);
            }
            if (rawServiceName.equals("WSSTemplatesService6")) {
                ...
                WSSTemplatesService6 service = new WSSTemplatesService6(wsdlURL, serviceName);
                service.addPort(servicePort, SOAPBinding.SOAP11HTTP_BINDING, endPtUrl);
                dispSOAPMsg = service.createDispatch(servicePort,
                                                     SOAPMessage.class, Mode.MESSAGE);
            }
