...
public class Echo4ServicePortProxy implements EchoProxyInterface {

    protected Descriptor _descriptor;

    public class Descriptor {
        private com.ibm.was.wssample.sei.echo.Echo4Service _service = null;
        ...
        public Descriptor(Echo4Service echo4Service) {
            init(echo4Service);
        }

        public Descriptor(URL wsdlLocation, QName serviceName) {
            _service = new com.ibm.was.wssample.sei.echo.Echo4Service(wsdlLocation, serviceName);
            initCommon();
        }
        ...
        public void init() {
            ...
            try {
                ...
                _service = (com.ibm.was.wssample.sei.echo.Echo4Service) ctx.lookup("java:comp/env/service/Echo4Service");
            ...
            if (_service == null && !_useJNDIOnly)
                _service = new com.ibm.was.wssample.sei.echo.Echo4Service();
            initCommon();
        }

        // Newly added to allow the EcoService to be added
        public void init(Echo4Service echo4Service) {
            _service = echo4Service;
            _proxy = null;
            _dispatch = null;
            if (_service == null) {
                try {
        ...
        private void initCommon() {
            _proxy = _service.getEcho4ServicePort();
        }
        ...
        public Dispatch<Source> getDispatch() {
            if (_dispatch == null) {
                QName portQName = new QName("http://com/ibm/was/wssample/sei/echo/", "Echo4ServicePort");
        ...
        public void setEndpoint(String endpointUrl) {
            System.out.println("Echo4Service in Proxy is:" + _service);
            BindingProvider bp = (BindingProvider) _proxy;
    ...
    public Echo4ServicePortProxy() {
        _descriptor = new Descriptor();
        _descriptor.setMTOMEnabled(false);
    }

    // Newly added to allow the EcoService to be added
    public Echo4ServicePortProxy(Service echo4Service) {
        _descriptor = new Descriptor((Echo4Service) echo4Service);
        _descriptor.setMTOMEnabled(false);
    }

    public Echo4ServicePortProxy(URL wsdlLocation, QName serviceName) {
    ...
    public String getEchoResponse(Object object, String endpointURL, String input) throws Exception {
        Echo4ServicePortProxy proxy = (Echo4ServicePortProxy) object;
