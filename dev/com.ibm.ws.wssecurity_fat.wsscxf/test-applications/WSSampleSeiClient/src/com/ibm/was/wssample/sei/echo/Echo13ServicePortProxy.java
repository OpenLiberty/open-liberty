...
public class Echo13ServicePortProxy implements EchoProxyInterface {

    protected Descriptor _descriptor;

    public class Descriptor {
        private com.ibm.was.wssample.sei.echo.Echo13Service _service = null;
        ...
        public Descriptor(Echo13Service echo13Service) {
            init(echo13Service);
        }

        public Descriptor(URL wsdlLocation, QName serviceName) {
            _service = new com.ibm.was.wssample.sei.echo.Echo13Service(wsdlLocation, serviceName);
            initCommon();
        }
        ...
        public void init() {
            ...
            try {
                ...
                _service = (com.ibm.was.wssample.sei.echo.Echo13Service) ctx.lookup("java:comp/env/service/Echo13Service");
            ...
            if (_service == null && !_useJNDIOnly)
                _service = new com.ibm.was.wssample.sei.echo.Echo13Service();
            initCommon();
        }

        // Newly added to allow the EcoService to be added
        public void init(Echo13Service echo13Service) {
            _service = echo13Service;
            _proxy = null;
            _dispatch = null;
            if (_service == null) {
                try {
        ...
        private void initCommon() {
            _proxy = _service.getEcho13ServicePort();
        }
        ...
        public Dispatch<Source> getDispatch() {
            if (_dispatch == null) {
                QName portQName = new QName("http://com/ibm/was/wssample/sei/echo/", "Echo13ServicePort");
        ...
        public void setEndpoint(String endpointUrl) {
            System.out.println("Echo13Service in Proxy is:" + _service);
            BindingProvider bp = (BindingProvider) _proxy;
    ...
    public Echo13ServicePortProxy() {
        _descriptor = new Descriptor();
        _descriptor.setMTOMEnabled(false);
    }

    // Newly added to allow the EcoService to be added
    public Echo13ServicePortProxy(Service echo13Service) {
        _descriptor = new Descriptor((Echo13Service) echo13Service);
        _descriptor.setMTOMEnabled(false);
    }

    public Echo13ServicePortProxy(URL wsdlLocation, QName serviceName) {
    ...
    public String getEchoResponse(Object object, String endpointURL, String input) throws Exception {
        Echo13ServicePortProxy proxy = (Echo13ServicePortProxy) object;
