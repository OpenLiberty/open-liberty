...
public class EchoServicePortProxy implements EchoProxyInterface {

    protected Descriptor _descriptor;

    public class Descriptor {
        private com.ibm.was.wssample.sei.echo.EchoService _service = null;
        ...
        public Descriptor(EchoService echoService) {
            init(echoService);
        }

        public Descriptor(URL wsdlLocation, QName serviceName) {
            _service = new com.ibm.was.wssample.sei.echo.EchoService(wsdlLocation, serviceName);
            initCommon();
        }
        ...
        public void init() {
            ...
            try {
                ...
                _service = (com.ibm.was.wssample.sei.echo.EchoService) ctx.lookup("java:comp/env/service/EchoService");
            ...
            if (_service == null && !_useJNDIOnly)
                _service = new com.ibm.was.wssample.sei.echo.EchoService();
            initCommon();
        }

        // Newly added to allow the EcoService to be added
        public void init(EchoService echoService) {
        ...
        public void setEndpoint(String endpointUrl) {
            System.out.println("EchoService in Proxy is:" + _service);
            BindingProvider bp = (BindingProvider) _proxy;
    ...
    // Newly added to allow the EcoService to be added
    public EchoServicePortProxy(Service echoService) {
        _descriptor = new Descriptor((EchoService) echoService);
        _descriptor.setMTOMEnabled(false);
    }
    ...
    public String getEchoResponse(Object object, String endpointURL, String input) throws Exception {
        EchoServicePortProxy proxy = (EchoServicePortProxy) object;
