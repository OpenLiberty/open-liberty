...
public class Echo14ServicePortProxy implements EchoProxyInterface {

    protected Descriptor _descriptor;

    public class Descriptor {
        private com.ibm.was.wssample.sei.echo.Echo14Service _service = null;
        ...
        public Descriptor(Echo14Service echo14Service) {
            init(echo14Service);
        }

        public Descriptor(URL wsdlLocation, QName serviceName) {
            _service = new com.ibm.was.wssample.sei.echo.Echo14Service(wsdlLocation, serviceName);
            initCommon();
        }
        ...
        public void init() {
            ...
            try {
                ...
                _service = (com.ibm.was.wssample.sei.echo.Echo14Service) ctx.lookup("java:comp/env/service/Echo14Service");
            ...
            if (_service == null && !_useJNDIOnly)
                _service = new com.ibm.was.wssample.sei.echo.Echo14Service();
            initCommon();
        }

        // Newly added to allow the EcoService to be added
        public void init(Echo14Service echo14Service) {
            _service = echo14Service;
            _proxy = null;
            _dispatch = null;
            if (_service == null) {
                try {
        ...
        private void initCommon() {
            _proxy = _service.getEcho14ServicePort();
        }
        ...
        public Dispatch<Source> getDispatch() {
            if (_dispatch == null) {
                QName portQName = new QName("http://com/ibm/was/wssample/sei/echo/", "Echo14ServicePort");
        ...
        public void setEndpoint(String endpointUrl) {
            System.out.println("Echo14Service in Proxy is:" + _service);
            BindingProvider bp = (BindingProvider) _proxy;
    ...
    public Echo14ServicePortProxy() {
        _descriptor = new Descriptor();
        _descriptor.setMTOMEnabled(false);
    }

    // Newly added to allow the EcoService to be added
    public Echo14ServicePortProxy(Service echo14Service) {
        _descriptor = new Descriptor((Echo14Service) echo14Service);
        _descriptor.setMTOMEnabled(false);
    }

    public Echo14ServicePortProxy(URL wsdlLocation, QName serviceName) {
    ...
    public String getEchoResponse(Object object, String endpointURL, String input) throws Exception {
        Echo14ServicePortProxy proxy = (Echo14ServicePortProxy) object;
