...
public class Echo11ServicePortProxy implements EchoProxyInterface {

    protected Descriptor _descriptor;

    public class Descriptor {
        private com.ibm.was.wssample.sei.echo.Echo11Service _service = null;
        ...
        public Descriptor(Echo11Service echo11Service) {
            init(echo11Service);
        }

        public Descriptor(URL wsdlLocation, QName serviceName) {
            _service = new com.ibm.was.wssample.sei.echo.Echo11Service(wsdlLocation, serviceName);
            initCommon();
        }
        ...
        public void init() {
            ...
            try {
                ...
                _service = (com.ibm.was.wssample.sei.echo.Echo11Service) ctx.lookup("java:comp/env/service/Echo11Service");
            ...
            if (_service == null && !_useJNDIOnly)
                _service = new com.ibm.was.wssample.sei.echo.Echo11Service();
            initCommon();
        }

        // Newly added to allow the EcoService to be added
        public void init(Echo11Service echo11Service) {
            _service = echo11Service;
            _proxy = null;
            _dispatch = null;
            if (_service == null) {
                try {
        ...
        private void initCommon() {
            _proxy = _service.getEcho11ServicePort();
        }
        ...
        public Dispatch<Source> getDispatch() {
            if (_dispatch == null) {
                QName portQName = new QName("http://com/ibm/was/wssample/sei/echo/", "Echo11ServicePort");
        ...
        public void setEndpoint(String endpointUrl) {
            System.out.println("Echo11Service in Proxy is:" + _service);
            BindingProvider bp = (BindingProvider) _proxy;
    ...
    public Echo11ServicePortProxy() {
        _descriptor = new Descriptor();
        _descriptor.setMTOMEnabled(false);
    }

    // Newly added to allow the EcoService to be added
    public Echo11ServicePortProxy(Service echo11Service) {
        _descriptor = new Descriptor((Echo11Service) echo11Service);
        _descriptor.setMTOMEnabled(false);
    }

    public Echo11ServicePortProxy(URL wsdlLocation, QName serviceName) {
    ...
    public String getEchoResponse(Object object, String endpointURL, String input) throws Exception {
        Echo11ServicePortProxy proxy = (Echo11ServicePortProxy) object;
