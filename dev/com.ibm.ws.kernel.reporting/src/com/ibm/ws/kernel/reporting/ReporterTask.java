...
public class ReporterTask implements Runnable {
	...
	public void run() {
		...
		try {
			...
			new CVEResponseHandler().handleResponse(data.get("productEdition"), response);
	...
	/**
	 * <p>
	 * Creates a string with the type and message of a Throwable and it's causes.
	 * </p>
	 * 
	 * <pre>
	 * 	Example: 
	 ...
	 * @return A string with the type and message of a Throwable and it's causes.
	 */
