...
import com.ibm.ws.kernel.reporting.utils.HashUtils;
...
//		osArch = System.getProperty("os.arch");
			...
			String tempProductEdition = "";
			String tempProductName = "";

			for (String key : allProductInfo.keySet()) {
				tempProductEdition += ", " + allProductInfo.get(key).getEdition();
				tempProductName += ", " + allProductInfo.get(key).getName();
			}

			productEdition = tempProductEdition.substring(2);
