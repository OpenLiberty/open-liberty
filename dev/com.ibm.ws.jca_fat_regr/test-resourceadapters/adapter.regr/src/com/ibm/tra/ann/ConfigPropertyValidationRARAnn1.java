...
public class ConfigPropertyValidationRARAnn1 implements ResourceAdapter, Serializable {

    static final String className = ConfigPropertyValidationRARAnn1.class.getName();
