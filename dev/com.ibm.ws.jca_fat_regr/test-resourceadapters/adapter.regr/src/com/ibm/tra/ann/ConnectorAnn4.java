...
@Connector(
           authMechanisms = {
                              @AuthenticationMechanism(
                                                       description = "CONN_4_AUTHMECH_1_DESC",
                                                       authMechanism = "BasicPassword",
                                                       credentialInterface = AuthenticationMechanism.CredentialInterface.PasswordCredential),
                              @AuthenticationMechanism(
                                                       description = "CONN_4_AUTHMECH_2_DESC",
                                                       authMechanism = "Kerbv5",
                                                       credentialInterface = AuthenticationMechanism.CredentialInterface.GenericCredential) },

           description = { "CONN_4_DESC_1", "CONN_4_DESC_2" },

           displayName = { "CONN_4_DISPNAME_1, CONN_4_DISPNAME_2" }, // Not a rar display name ==> ra.xml contains display-name 

           eisType = "CONN_4_EISTYPE",

           licenseDescription = { "CONN_4_LICDESC_1", "CONN_4_LICDESC_2" },
           licenseRequired = false, // CONN_4_LIC_REQ

           reauthenticationSupport = false, // CONN_4_REAUTHSUPPORT 

           requiredWorkContexts = { TRAWorkContext1.class, TRAWorkContext2.class },
           // { CONN_4_RQWRKCTX_1, CONN_4_REQWRKCTX_2 }

           securityPermissions = {
                                   @SecurityPermission(
                                                       description = "CONN_4_SECPERM_1_DESC",
                                                       permissionSpec = "grant { permission java.util.PropertyPermission \"*\", \"read, write\"; };"),
                                   @SecurityPermission(
                                                       description = "CONN_4_SECPERM_2_DESC",
           ...
           smallIcon = { "CONN_4_SMALLICON_1" },
           largeIcon = { "CONN_4_LARGEICON_1", "CONN_4_LARGEICON_2" },

           vendorName = "CONN_4_VENDORNAME",

           version = "CONN_4_VERSION")
public class ConnectorAnn4 implements ResourceAdapter, Serializable {

    static final String className = ConnectorAnn4.class.getName();
