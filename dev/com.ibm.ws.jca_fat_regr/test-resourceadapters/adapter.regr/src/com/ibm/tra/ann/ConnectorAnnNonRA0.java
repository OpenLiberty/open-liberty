...
@Connector(
           description = "CONN_NONRA_0_DESC_1",

           displayName = "TRA_jca16_ann_ConnectorValidator_NonRA0",

           smallIcon = { "CONN_NONRA_0_SMALLICON_1" },
           largeIcon = { "CONN_NONRA_0_LARGEICON_1" },
           vendorName = "CONN_NONRA_0_VENDORNAME",
           eisType = "CONN_NONRA_0_EISTYPE",
           version = "CONN_NONRA_0_VERSION",
           licenseDescription = { "CONN_NONRA_0_LICDESC_1" },
           licenseRequired = false,
           authMechanisms = {
                              @AuthenticationMechanism(
                                                       description = "CONN_NONRA_0_AUTHMECH_1_DESC_1",
                                                       authMechanism = "BasicPassword",
                                                       credentialInterface = AuthenticationMechanism.CredentialInterface.PasswordCredential),
                              @AuthenticationMechanism(
                                                       description = "CONN_NONRA_0_AUTHMECH_1_DESC_2",
           ...
           securityPermissions = {
                                   @SecurityPermission(
                                                       description = "CONN_NONRA_0_SECPERM_1_DESC_1",
...
public class ConnectorAnnNonRA0 implements /* javax.resource.spi.ResourceAdapter, */Serializable { //  F743-15626.1 validation ignores lack of MCF ancestry.

    static final String className = ConnectorAnnNonRA0.class.getName();
