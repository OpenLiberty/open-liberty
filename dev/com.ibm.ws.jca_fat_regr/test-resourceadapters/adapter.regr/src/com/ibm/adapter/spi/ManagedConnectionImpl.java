...
public class ManagedConnectionImpl implements ManagedConnection, ConnectionEventSender {
    ...
    private Subject copySubject() throws ResourceException {
        ...
        try {
            return (Subject) java.security.AccessController.doPrivileged(new java.security.PrivilegedExceptionAction() {
    ...
    private ResourceException closeHandles() {
        ...
        if (handlesInUse != null) {
            ...
            System.out.println("We are NOT attempting to close any Handles because the 'handles in use' list is null....");
        } // end else
    ...
    public void sendConnectionClosedEvent(Object handle) throws ResourceException {
        ...
        synchronized (this) {
            ...
            if (handlesInUse != null) {
                ...
                System.out.println("The 'handles in use' list is null...NOT attempting to remove the Handle from it.");
            } // end else
        } // end sychronized
