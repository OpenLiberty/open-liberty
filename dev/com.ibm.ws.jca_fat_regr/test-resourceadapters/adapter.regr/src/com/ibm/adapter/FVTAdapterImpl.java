...
public class FVTAdapterImpl implements ResourceAdapter, Serializable {
    ...
    private transient static final TraceComponent tc = Tr.register(FVTAdapterImpl.class);
    ...
    public void endpointActivation(MessageEndpointFactory factory,
        ...
        if (spec instanceof ActivationSpecCompMsgDestValidImpl) {
            ...
            switch (testVar) {
                case 1:
                    verifyString = ((FVTCompMsgDestAOImpl) (authSpec.getDestination())).getVerifyString();
                    Tr.debug(tc, "verifyString: " + verifyString);
                    Tr.debug(tc,
                             "Setting verifyString for testMsgDestASGlobalDest");
                    ActivationSpecCompMsgDestValidVerifyImpl.setVerifyStringGlobal(verifyString);
                    break;
                case 2:
                    verifyString = ((FVTCompMsgDestAOImpl) (authSpec.getDestination())).getVerifyString();
                    Tr.debug(tc, "verifyString: " + verifyString);
                    Tr.debug(tc, "Setting verifyString for testMsgDestASLocalDest");
                    ActivationSpecCompMsgDestValidVerifyImpl.setVerifyStringLocal(verifyString);
                    break;
                case 3:
                    Tr.debug(tc,
                    ...
                    ActivationSpecCompMsgDestValidVerifyImpl.setDestinationInvalidDest(authSpec.getDestination());
                    break;
                case 4:
                    Tr.debug(tc,
                    ...
                    ActivationSpecCompMsgDestValidVerifyImpl.setDestinationNullDest(authSpec.getDestination());
                    break;
                case 5:
                    Tr.debug(tc,
                    ...
                    ActivationSpecCompMsgDestValidVerifyImpl.setDestinationValidDestWrongAODestType(authSpec.getDestination());
                    break;
                case 6:
                    Tr.debug(tc,
                             "Setting Destination object for testMsgDestASValidDestWrongAODestType");
                    ...
                    ActivationSpecCompMsgDestValidVerifyImpl.setDestinationBlankDest(authSpec.getDestination());
                    break;
            }
        }
        ...
        if (spec instanceof ActivationSpecCompMsgDestObjectImpl) {
            ...
            switch (testVar) {
                case 7:
                    ...
                    ActivationSpecCompMsgDestObjectVerifyImpl.setDestinationWrongASDestType(authSpec.getDestination());
                    break;
            }
        }
        ...
        if (spec instanceof ActivationSpecCompMsgDestStringImpl) {
            ...
            switch (testVar) {
                case 8:
                    ...
                    ActivationSpecCompMsgDestStringVerifyImpl.setDestinationNullDest(verifyString);
                    break;
                case 9:
                    verifyString = authSpec.getDestination();
                    if (verifyString == null) {
                    ...
                    ActivationSpecCompMsgDestStringVerifyImpl.setDestinationValidDest(verifyString);
                    break;
            }
        }
        ...
        if (spec instanceof ActivationSpecCompMsgDestRequiredImpl) {
            ...
            switch (testVar) {
                case 12:
                    ...
                    ActivationSpecCompMsgDestRequiredVerifyImpl.setDestinationRequiredWrongAODestType(authSpec.getDestination());
                    break;
                case 13:
                    Tr.debug(
                             tc,
                    ...
                    ActivationSpecCompMsgDestRequiredVerifyImpl.setDestinationRequiredNullDest(authSpec.getDestination());
                    break;
                case 14:
                    Tr.debug(
                             tc,
                    ...
                    ActivationSpecCompMsgDestRequiredVerifyImpl.setDestinationRequiredInvalidDest(authSpec.getDestination());
                    break;
                case 15:
                    Tr.debug(
                             tc,
                    ...
                    ActivationSpecCompMsgDestRequiredVerifyImpl.setDestinationRequiredValidateThrowEx(authSpec.getDestination());
                    ...
                    // to indicate this.
                    ActivationSpecCompMsgDestRequiredVerifyImpl.setASRequiredValidateThrowExActivated(true);
                    break;
                case 16:
                    verifyString = ((FVTCompMsgDestAOImpl) (authSpec.getDestination())).getVerifyString();
                    Tr.debug(tc, "verifyString: " + verifyString);
                    ...
                    ActivationSpecCompMsgDestRequiredVerifyImpl.setVerifyStringGlobal(verifyString);
                    break;
            }
        }
        /*
    ...
    public boolean equals(Object someResourceAdapter) {
        ...
        try {
            ...
            if (someResourceAdapter == null) {
                System.out.println("The passed in ResourceAdapter was null. This means it can't equal the current ResourceAdapter instance.");
                return false;
            } // end if
            ...
            if ("fvt.adapter.FVTAdapterImpl".equalsIgnoreCase(className)) {
                ...
                // true
                System.out.println("The passed in RA was a FVTAdapterImpl...the RA's are equal.");
                return true;
            } // end if
            else if ("fvt.adapter.EmbeddedFVTAdapterImpl".equalsIgnoreCase(className)) {
                // its an EmbeddedFVTAdapterImpl...this is considered an
                // equal...return true
                System.out.println("The passed in RA was a EmbeddedFVTAdapterImpl...the RA's are equal.");
                return true;
            } // end else if
            else {
            ...
            System.out.println("We got some kind of error trying to determine if the ResourceAdapter instances "
    ...
    private void writeServerNameThatThisRAIsRunningOnToLog(String endpointName) {
        if (NAME_OF_MESSAGE_DRIVEN_EJB.equalsIgnoreCase(endpointName)) {
            System.out.println("We ARE activating the endpoint for **"
                               + endpointName
            ...
            try {
                ...
                System.out.println("Failed to write the server that the RA is running on to the log. The error was:\n");
            ...
            System.out.println("Activating endpoint for **"
                               + endpointName
