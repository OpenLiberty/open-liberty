...
public class ManagedConnectionFactoryImpl implements ManagedConnectionFactory, Serializable, ResourceAdapterAssociation // {
                , ValidatingManagedConnectionFactory { // added by gburli - LI2110.97 -
                                                       // 06/08/2004
    ...
    public ManagedConnectionFactoryImpl() {
        ...
        System.out.println("313344.1 - ManagedConnectionFactoryImpl constructor "
                           + this);
    ...
    public ManagedConnection createManagedConnection(Subject subject,
        ...
        /*
         * 04/20/04: swai Copy the code from RRA to here. very useful.
         * 
        ...
        } else // Subject is available
        {
            ...
            while (iter.hasNext()) {
                ...
                try {
                    credential = java.security.AccessController.doPrivileged(iterationAction);
        ...
        try {
            ...
            // swai: d177221, The following code is added for security
            // permission.
            /*
             * 02/17/04: swai final String userName1 = userName; final String
             * password1 = password;
             * 
        ...
        /*
         * 02/17/04: swai catch (java.security.PrivilegedActionException pae) {
        ...
        if (subject == null) {
            ...
            for (Iterator iter = connectionSet.iterator(); iter.hasNext();) {
                ...
                if ((currentmc.getSubject() == null)
                    ...
                    // // LIDB ????
                    && currentmc.isLazyAssociatable() == lazyAssociatable.booleanValue() // LIDB ????
                    && currentmc.isLazyEnlistable() == lazyAssociatable.booleanValue() // LIDB ????
                ) {
                    matchedmc = currentmc;
                    break;
                }
            ...
            try {
                matchedmc = (ManagedConnectionImpl) java.security.AccessController.doPrivileged(new java.security.PrivilegedExceptionAction() {
                    @Override
                    public java.lang.Object run() throws Exception {
                        ManagedConnectionImpl currentmc = null;
                        for (Iterator iter = connectionSet.iterator(); iter.hasNext();) {
    ...
    /**
     * LIDB:2110.97 - 06/08/04 added begin by gburli Implementation of
