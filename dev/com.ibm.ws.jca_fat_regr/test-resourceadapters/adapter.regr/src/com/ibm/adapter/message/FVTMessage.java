...
public class FVTMessage {
    ...
    public void add(String endpointName, String message, Method m) {
        if (tc.isEntryEnabled()) {
            Tr.entry(tc, "add", new Object[] { this, endpointName,
                                               message, m });
        }
    ...
    /**
     * <p>
     * Add an FVTXAResource object to the message object.
     * </p>
     * 
     * <p>
     * Users can add a customized FVTXAResourceImpl object to the message object
     * for a particular endpoint instance. This FVTXAResourceImpl object will be
     * used for transacted delivery. If they don't add an FVTXAResourceImpl
     * object for a particular transacted message delivery, test resource
     * adapter will treat it as null.
     * </p>
     * 
     * <p>
     * Adding an FVTXAResourceImpl object to the message object has the
     * following advantages. Firstly, users can force a particular method, such
     * as prepare() to sleep for a while to test the crash recovery. Secondly,
     * users can force some methods to throw an XAException. Lastly, after the
     * message delivery is completed, users can call getExecutionPath() of
     * FVTXAResourceImpl to get the execution path of the FVTXAResource object.
     * An execution path is a string which has the information of which methods
     * of FVTXAResourceImpl are called and in which order. For more details,
     * please refer to the JavaDoc of <code>FVTXAResourceImpl</code> class.
     * </p>
     * 
     * @param endpointName
     *                         the name of the endpoint application
     ...
     *                         the instance ID of the endpoint application
     * @param resource
     *                         the object of FVTXAResource
     */
    public void addXAResource(String endpointName, int instanceID,
    ...
    /**
     * <p>
     * Add an FVTXAResource object to the message object. This FVTXAResource is
     * used for the default endpoint instance 0.
     * </p>
     * 
     * <p>
     * Users can add a customized FVTXAResourceImpl object to the message object
