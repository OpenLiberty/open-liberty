...
public class FVTMessageProviderImpl implements FVTMessageProvider, FVTBaseMessageProvider, Serializable {
    ...
    private static final TraceComponent tc = Tr.register(FVTMessageProviderImpl.class);
    ...
    public void sendMessageWithoutWorkProcessing(String endpointName,
        ...
        // .onMessage() method
        System.out.println("Getting actual MessageEndpoint and casting into MessageListener...");
