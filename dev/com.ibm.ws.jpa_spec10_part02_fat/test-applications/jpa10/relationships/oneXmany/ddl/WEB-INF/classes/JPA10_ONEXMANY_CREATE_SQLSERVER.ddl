...
CREATE TABLE OMCTEA_GMT (OMContainerTypeEntityA_ID INT, OMContainerTypeEntityB_ID INT, GENERICIZEDMAPTYPE_KEY INT, KEY0 INT);
...
CREATE TABLE XMLOMCTEA_GMT (XMLOMContainerTypeEntityA_ID INT, XMLOMContainerTypeEntityB_ID INT, GENERICIZEDMAPTYPE_KEY INT, KEY0 INT);
