...
CREATE TABLE OMCTEA_GMT (OMContainerTypeEntityA_ID INTEGER, OMContainerTypeEntityB_ID INTEGER, GENERICIZEDMAPTYPE_KEY INTEGER, KEY0 INTEGER);
...
CREATE TABLE XMLOMCTEA_GMT (XMLOMContainerTypeEntityA_ID INTEGER, XMLOMContainerTypeEntityB_ID INTEGER, GENERICIZEDMAPTYPE_KEY INTEGER, KEY0 INTEGER);
