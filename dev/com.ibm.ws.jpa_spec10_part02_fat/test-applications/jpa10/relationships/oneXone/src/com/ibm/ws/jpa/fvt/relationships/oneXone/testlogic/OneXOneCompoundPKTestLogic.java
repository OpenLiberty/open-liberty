...
public class OneXOneCompoundPKTestLogic extends AbstractTestLogic {
    ...
    public void testOneXOneCompoundPK001(
        ...
        try {
            ...
            ICompoundPKOneXOneEntityA new_entityA = (ICompoundPKOneXOneEntityA) constructNewEntityObject(entityAClass);
            new_entityA.setId(1);
            ...
            ICompoundPKOneXOneEntityB new_entityB = (ICompoundPKOneXOneEntityB) constructNewEntityObject(entityBClass);
            ...
            ICompoundPKOneXOneEntityA find_entityA = (ICompoundPKOneXOneEntityA) jpaResource.getEm().find(entityAClass, 1);
