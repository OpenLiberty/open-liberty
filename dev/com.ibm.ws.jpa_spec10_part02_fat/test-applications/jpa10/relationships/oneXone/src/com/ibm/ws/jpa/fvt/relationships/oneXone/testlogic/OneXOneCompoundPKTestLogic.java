...
public class OneXOneCompoundPKTestLogic extends AbstractTestLogic {
    ...
    public void testTemplate(
        ...
        // Verify parameters
        if (testExecCtx == null || testExecResources == null) {
            Assert.fail("OneXOneCompoundPKTestLogic.testTemplate(): Missing context and/or resources.  Cannot execute the test.");
            return;
        }
        ...
        // Execute Test Case
        try {
            System.out.println("OneXOneCompoundPKTestLogic.testTemplate(): Begin");
            //cleanupDatabase(jpaCleanupResource);

            System.out.println("Ending test.");
        } finally {
            System.out.println("OneXOneCompoundPKTestLogic.testTemplate(): End");
        }
    }
    ...
    protected void cleanupDatabase(JPAResource jpaResource) {
        ...
        cleanupDatabase(jpaResource.getEm(), jpaResource.getTj(), OneXOneCompoundPKEntityEnum.values());
