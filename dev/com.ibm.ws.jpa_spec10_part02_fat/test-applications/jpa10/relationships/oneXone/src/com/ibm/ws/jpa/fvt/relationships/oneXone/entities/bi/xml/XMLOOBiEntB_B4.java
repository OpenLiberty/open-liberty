 ...
 *
 */
public class XMLOOBiEntB_B4 extends XMLAbstractOneXOneBiEntityB {
    private XMLOOBiEntA entityA;

    public XMLOOBiEntB_B4() {
        super();
    }

    public XMLOOBiEntB_B4(int id, String name) {
        super(id, name);
    }
    ...
    public String toString() {
        return "XMLOOBiEntB_B4 [getId()=" + getId() + ", getName()=" + getName() + "]";
    }
}