CREATE TABLE OOBiCardEntA (id INTEGER NOT NULL, name VARCHAR(255), B_ID INTEGER NOT NULL, PRIMARY KEY (id), UNIQUE(B_ID));
...
CREATE TABLE XMLOOBiCardEntA (id INTEGER NOT NULL, name VARCHAR(255), B_ID INTEGER NOT NULL, PRIMARY KEY (id), UNIQUE(B_ID));
...
CREATE INDEX I_XMLNTTY_B1 ON XMLOONoOptBiEntityA (B_ID);
...
CREATE TABLE OOCardEntA (id INTEGER NOT NULL, name VARCHAR(255), B_ID INTEGER NOT NULL, PRIMARY KEY (id), UNIQUE(B_ID));
...
CREATE TABLE XMLOOCardEntA (id INTEGER NOT NULL, name VARCHAR(255), B_ID INTEGER NOT NULL, PRIMARY KEY (id), UNIQUE(B_ID));
...
CREATE INDEX I_XMLNTTY_B ON XMLOONoOptEntityA (B_ID);
