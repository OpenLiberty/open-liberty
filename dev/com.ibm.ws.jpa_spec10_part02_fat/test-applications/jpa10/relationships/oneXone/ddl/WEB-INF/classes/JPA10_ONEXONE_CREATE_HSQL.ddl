...
CREATE TABLE ${schemaname}.OOBiEntA (id INTEGER NOT NULL, name VARCHAR(255), BIENT_B1CP INTEGER, BIENT_B1 INTEGER, B2_ID INTEGER, BIENT_B4 INTEGER, BIENT_B1CA INTEGER, BIENT_B1CM INTEGER, BIENT_B1RF INTEGER, BIENT_B1RM INTEGER, PRIMARY KEY (id));
...
CREATE TABLE ${schemaname}.XMLOOBiEntA (id INTEGER NOT NULL, name VARCHAR(255), B5CM_ID INTEGER, XMLBIENT_B1 INTEGER, B2_ID INTEGER, B4_ID INTEGER, B5CA_ID INTEGER, B5CP_ID INTEGER, B5RF_ID INTEGER, B5RM_ID INTEGER, PRIMARY KEY (id));
...
CREATE TABLE ${schemaname}.EmbedIDOOEntA (id INTEGER NOT NULL, password VARCHAR(255), userName VARCHAR(255), identity_id INTEGER, identity_country VARCHAR(255), PRIMARY KEY (id));
...
CREATE TABLE ${schemaname}.IDClassOOEntityA (id INTEGER NOT NULL, password VARCHAR(255), userName VARCHAR(255), identity_id INTEGER, identity_country VARCHAR(255), PRIMARY KEY (id));
...
CREATE TABLE ${schemaname}.XMLEmbedIDOOEntA (id INTEGER NOT NULL, password VARCHAR(255), userName VARCHAR(255), identity_id INTEGER, identity_country VARCHAR(255), PRIMARY KEY (id));
...
CREATE TABLE ${schemaname}.XMLIDClassOOEntityA (id INTEGER NOT NULL, password VARCHAR(255), userName VARCHAR(255), identity_id INTEGER, identity_country VARCHAR(255), PRIMARY KEY (id));
