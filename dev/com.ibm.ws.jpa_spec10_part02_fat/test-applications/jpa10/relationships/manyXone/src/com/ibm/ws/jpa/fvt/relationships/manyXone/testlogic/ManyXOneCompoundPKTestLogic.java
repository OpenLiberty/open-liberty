...
public class ManyXOneCompoundPKTestLogic extends AbstractTestLogic {
    ...
    public void testManyXOneCompoundPK001(
        ...
        try {
            ...
            ICompoundPKManyXOneEntityA new_entityA = (ICompoundPKManyXOneEntityA) constructNewEntityObject(entityAClass);
            new_entityA.setId(1);
            ...
            ICompoundPKManyXOneEntityB new_entityB = (ICompoundPKManyXOneEntityB) constructNewEntityObject(entityBClass);
            ...
            ICompoundPKManyXOneEntityA find_entityA = (ICompoundPKManyXOneEntityA) jpaResource.getEm().find(entityAClass, 1);
