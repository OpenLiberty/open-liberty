...
public class ManyXManyCompoundPKTestLogic extends AbstractTestLogic {
    ...
    public void testManyXManyCompoundPK001(
        ...
        try {
            ...
            ICompoundPKManyXManyEntityA new_entityA = (ICompoundPKManyXManyEntityA) constructNewEntityObject(entityAClass);
            new_entityA.setId(1);
            ...
            ICompoundPKManyXManyEntityB new_entityB = (ICompoundPKManyXManyEntityB) constructNewEntityObject(entityBClass);
            ...
            ICompoundPKManyXManyEntityA find_entityA = (ICompoundPKManyXManyEntityA) jpaResource.getEm().find(entityAClass, 1);
