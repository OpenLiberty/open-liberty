...
CREATE TABLE ${schemaname}.EmbManyXManyJoinTable (EMBEDIDMMENTITYA_ID INT NULL, identity_id INT NULL, identity_country VARCHAR(255) NULL, UNQ_INDEX NUMERIC IDENTITY UNIQUE);
CREATE TABLE ${schemaname}.IDClassMMEntA_IDClassMMEntB (IDCLASSMMENTITYA_ID INT NULL, identity_id INT NULL, identity_country VARCHAR(255) NULL, UNQ_INDEX NUMERIC IDENTITY UNIQUE);
...
CREATE TABLE ${schemaname}.MMCTEA_GCT (MMContainerTypeEntityA_ID INT NULL, MMContainerTypeEntityB_ID INT NULL, UNQ_INDEX NUMERIC IDENTITY UNIQUE);
CREATE TABLE ${schemaname}.MMCTEA_GLT (MMContainerTypeEntityA_ID INT NULL, MMContainerTypeEntityB_ID INT NULL, UNQ_INDEX NUMERIC IDENTITY UNIQUE);
CREATE TABLE ${schemaname}.MMCTEA_GMKT (MMContainerTypeEntityA_ID INT NULL, MMContainerTypeEntityB_ID INT NULL, UNQ_INDEX NUMERIC IDENTITY UNIQUE);
CREATE TABLE ${schemaname}.MMCTEA_GMT (MMContainerTypeEntityA_ID INT NULL, MMContainerTypeEntityB_ID INT NULL, KEY0 INT NULL, UNQ_INDEX NUMERIC IDENTITY UNIQUE);
CREATE TABLE ${schemaname}.MMCTEA_GST (MMContainerTypeEntityA_ID INT NULL, MMContainerTypeEntityB_ID INT NULL, UNQ_INDEX NUMERIC IDENTITY UNIQUE);
CREATE TABLE ${schemaname}.MMCTEA_OLT (MMContainerTypeEntityA_ID INT NULL, MMContainerTypeEntityB_ID INT NULL, UNQ_INDEX NUMERIC IDENTITY UNIQUE);
CREATE TABLE ${schemaname}.MMCTEA_UGCT (MMContainerTypeEntityA_ID INT NULL, MMContainerTypeEntityB_ID INT NULL, UNQ_INDEX NUMERIC IDENTITY UNIQUE);
CREATE TABLE ${schemaname}.MMCTEA_UGLT (MMContainerTypeEntityA_ID INT NULL, MMContainerTypeEntityB_ID INT NULL, UNQ_INDEX NUMERIC IDENTITY UNIQUE);
CREATE TABLE ${schemaname}.MMCTEA_UGMKT (MMContainerTypeEntityA_ID INT NULL, MMContainerTypeEntityB_ID INT NULL, UNQ_INDEX NUMERIC IDENTITY UNIQUE);
CREATE TABLE ${schemaname}.MMCTEA_UGST (MMContainerTypeEntityA_ID INT NULL, MMContainerTypeEntityB_ID INT NULL, UNQ_INDEX NUMERIC IDENTITY UNIQUE);
...
CREATE TABLE ${schemaname}.XMLEmbManyXManyJoinTable (XMLEMBEDIDMMENTITYA_ID INT NULL, identity_id INT NULL, identity_country VARCHAR(255) NULL, UNQ_INDEX NUMERIC IDENTITY UNIQUE);
CREATE TABLE ${schemaname}.XMLIDClassMMEntA_IDClassMMEntB (XMLIDCLASSMMENTITYA_ID INT NULL, identity_id INT NULL, identity_country VARCHAR(255) NULL, UNQ_INDEX NUMERIC IDENTITY UNIQUE);
...
CREATE TABLE ${schemaname}.XMLMMCTEA_GCT (XMLMMContainerTypeEntityA_ID INT NULL, XMLMMContainerTypeEntityB_ID INT NULL, UNQ_INDEX NUMERIC IDENTITY UNIQUE);
CREATE TABLE ${schemaname}.XMLMMCTEA_GLT (XMLMMContainerTypeEntityA_ID INT NULL, XMLMMContainerTypeEntityB_ID INT NULL, UNQ_INDEX NUMERIC IDENTITY UNIQUE);
CREATE TABLE ${schemaname}.XMLMMCTEA_GMKT (XMLMMContainerTypeEntityA_ID INT NULL, XMLMMContainerTypeEntityB_ID INT NULL, UNQ_INDEX NUMERIC IDENTITY UNIQUE);
CREATE TABLE ${schemaname}.XMLMMCTEA_GMT (XMLMMContainerTypeEntityA_ID INT NULL, XMLMMContainerTypeEntityB_ID INT NULL, KEY0 INT NULL, UNQ_INDEX NUMERIC IDENTITY UNIQUE);
CREATE TABLE ${schemaname}.XMLMMCTEA_GST (XMLMMContainerTypeEntityA_ID INT NULL, XMLMMContainerTypeEntityB_ID INT NULL, UNQ_INDEX NUMERIC IDENTITY UNIQUE);
CREATE TABLE ${schemaname}.XMLMMCTEA_OLT (XMLMMContainerTypeEntityA_ID INT NULL, XMLMMContainerTypeEntityB_ID INT NULL, UNQ_INDEX NUMERIC IDENTITY UNIQUE);
CREATE TABLE ${schemaname}.XMLMMCTEA_UGCT (XMLMMContainerTypeEntityA_ID INT NULL, XMLMMContainerTypeEntityB_ID INT NULL, UNQ_INDEX NUMERIC IDENTITY UNIQUE);
CREATE TABLE ${schemaname}.XMLMMCTEA_UGLT (XMLMMContainerTypeEntityA_ID INT NULL, XMLMMContainerTypeEntityB_ID INT NULL, UNQ_INDEX NUMERIC IDENTITY UNIQUE);
CREATE TABLE ${schemaname}.XMLMMCTEA_UGMKT (XMLMMContainerTypeEntityA_ID INT NULL, XMLMMContainerTypeEntityB_ID INT NULL, UNQ_INDEX NUMERIC IDENTITY UNIQUE);
CREATE TABLE ${schemaname}.XMLMMCTEA_UGST (XMLMMContainerTypeEntityA_ID INT NULL, XMLMMContainerTypeEntityB_ID INT NULL, UNQ_INDEX NUMERIC IDENTITY UNIQUE);
