...
public class TestEmbeddableNestedServlet extends JPATestServlet {
    ...
    @Test
    public void jpa_spec10_nested_template_AMJTA_Web() throws Exception {
        final String testName = "jpa_spec10_nested_template_AMJTA_Web";
    ...
    @Test
    public void jpa_spec10_nested_template_AMRL_Web() throws Exception {
        final String testName = "jpa_spec10_nested_template_AMRL_Web";
        final String testMethod = "template";
    ...
    @Test
    public void jpa_spec10_nested_template_CMTS_Web() throws Exception {
        final String testName = "jpa_spec10_nested_template_CMTS_Web";
        final String testMethod = "template";
