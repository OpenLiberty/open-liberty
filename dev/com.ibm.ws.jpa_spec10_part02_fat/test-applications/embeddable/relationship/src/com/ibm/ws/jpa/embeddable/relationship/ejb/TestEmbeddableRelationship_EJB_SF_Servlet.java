...
public class TestEmbeddableRelationship_EJB_SF_Servlet extends EJBTestVehicleServlet {
    ...
    @Test
    public void jpa_spec10_relationship_template_EJB_SF_AMJTA_Web() throws Exception {
        final String testName = "jpa_spec10_relationship_template_EJB_SF_AMJTA_Web";
    ...
    @Test
    public void jpa_spec10_relationship_template_EJB_SF_AMRL_Web() throws Exception {
        final String testName = "jpa_spec10_relationship_template_EJB_SF_AMRL_Web";
        final String testMethod = "template";
    ...
    @Test
    public void jpa_spec10_relationship_template_EJB_SF_CMTS_Web() throws Exception {
        final String testName = "jpa_spec10_relationship_template_EJB_SF_CMTS_Web";
        final String testMethod = "template";
