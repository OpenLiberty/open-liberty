CREATE TABLE ${schemaname}.AnnRootEmBT (id INTEGER NOT NULL, enumeratedOrdinalValueFA SMALLINT, enumeratedStringValueFA VARCHAR(20), enumeratedOrdinalValuePA SMALLINT, enumeratedStringValuePA VARCHAR(20), integerValueAttributeOverride INTEGER, integerValue INTEGER, integerValueFAColumn INTEGER, integerValuePAColumn INTEGER, clobValueFA CLOB, clobValuePA CLOB, temporalValueFA DATE, temporalValuePA DATE, PRIMARY KEY (id));
CREATE TABLE ${schemaname}.ColDate (parent_id INTEGER, value TIMESTAMP);
CREATE TABLE ${schemaname}.ColEnum (parent_id INTEGER, value VARCHAR(255));
CREATE TABLE ${schemaname}.ColInt (parent_id INTEGER, value INTEGER);
CREATE TABLE ${schemaname}.ColLob (parent_id INTEGER, value VARCHAR(255));
CREATE TABLE ${schemaname}.EntColLobPAE (parent_id INTEGER, clobValuePA CLOB);
CREATE TABLE ${schemaname}.EntListEnumPAE (parent_id INTEGER, enumeratedOrdinalValuePA SMALLINT, enumeratedStringValuePA VARCHAR(20), valueOrderColumn INTEGER);
...
CREATE TABLE ${schemaname}.EntMapLobPAELobPAE (parent_id INTEGER, mykey CLOB, value CLOB);
...
CREATE TABLE ${schemaname}.ListInt (parent_id INTEGER, value INTEGER, valueOrderColumn INTEGER);
...
CREATE TABLE ${schemaname}.XMLColDate (parent_id INTEGER, value DATE);
CREATE TABLE ${schemaname}.XMLColEnum (parent_id INTEGER, value VARCHAR(255));
CREATE TABLE ${schemaname}.XMLColInt (parent_id INTEGER, value INTEGER);
CREATE TABLE ${schemaname}.XMLColLob (parent_id INTEGER, value CLOB);
CREATE TABLE ${schemaname}.XMLEntColLobPAE (parent_id INTEGER, clobValuePA CLOB);
CREATE TABLE ${schemaname}.XMLEntListEnumPAE (parent_id INTEGER, enumeratedOrdinalValuePA SMALLINT, enumeratedStringValuePA VARCHAR(20), valueOrderColumn INTEGER);
...
CREATE TABLE ${schemaname}.XMLListInt (parent_id INTEGER, value INTEGER, valueOrderColumn INTEGER);
CREATE TABLE ${schemaname}.XMLListLob (parent_id INTEGER, value CLOB, valueOrderColumn INTEGER);
...
CREATE TABLE ${schemaname}.XMLMapEnumLob (parent_id INTEGER, mykey VARCHAR(255), value CLOB);
...
CREATE TABLE ${schemaname}.XMLSetLob (parent_id INTEGER, value CLOB);
