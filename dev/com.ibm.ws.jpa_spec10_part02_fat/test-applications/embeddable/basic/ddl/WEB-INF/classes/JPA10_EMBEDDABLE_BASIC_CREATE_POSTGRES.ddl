...
CREATE TABLE ${schemaname}.EntColLobPAE (parent_id INTEGER, clobValuePA TEXT);
...
CREATE TABLE ${schemaname}.EntMapLobPAELobPAE (parent_id INTEGER, mykey TEXT, value TEXT);
...
CREATE TABLE ${schemaname}.XMLColLob (parent_id INTEGER, value TEXT);
CREATE TABLE ${schemaname}.XMLEntColLobPAE (parent_id INTEGER, clobValuePA TEXT);
...
CREATE TABLE ${schemaname}.XMLListLob (parent_id INTEGER, value TEXT, valueOrderColumn INTEGER);
...
CREATE TABLE ${schemaname}.XMLMapEnumLob (parent_id INTEGER, mykey VARCHAR(255), value TEXT);
...
CREATE TABLE ${schemaname}.XMLSetLob (parent_id INTEGER, value TEXT);
