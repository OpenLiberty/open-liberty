...
CREATE TABLE ${schemaname}.ColEnum (parent_id INTEGER, value VARCHAR(254));
CREATE TABLE ${schemaname}.ColInt (parent_id INTEGER, value INTEGER);
CREATE TABLE ${schemaname}.ColLob (parent_id INTEGER, value VARCHAR(254));
CREATE TABLE ${schemaname}.EntColLobPAE (parent_id INTEGER, clobValuePA CLOB(1M));
...
CREATE TABLE ${schemaname}.XMLColEnum (parent_id INTEGER, value VARCHAR(254));
CREATE TABLE ${schemaname}.XMLColInt (parent_id INTEGER, value INTEGER);
CREATE TABLE ${schemaname}.XMLColLob (parent_id INTEGER, value CLOB(1M));
CREATE TABLE ${schemaname}.XMLEntColLobPAE (parent_id INTEGER, clobValuePA CLOB(1M));
