 ...
 */
public class SSRepositoryFactoryImpl extends SSRepositoryFactory
{
	/**
     * Class Logger.
     */
    private static final LogMgr c_logger = Log.get(SSRepositoryFactoryImpl.class);
    
	
    public SSRepository createRepository() 
    throws ClassNotFoundException,InstantiationException, IllegalAccessException
    {
    	if (c_logger.isTraceDebugEnabled()) {
			c_logger.traceDebug(this, "createRepository", "Standalone type");
		}
		return new StandAloneSSRepoMgr();
