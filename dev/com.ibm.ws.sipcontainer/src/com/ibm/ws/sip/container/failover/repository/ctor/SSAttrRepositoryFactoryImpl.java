 ...
 */
public class SSAttrRepositoryFactoryImpl extends SSAttrRepositoryFactory
{
	/**
	 * Class Logger.
	 */
	private static final LogMgr c_logger = Log.get(SSAttrRepositoryFactoryImpl.class);


	public SSAttrRepository createRepository()
	throws ClassNotFoundException,InstantiationException, IllegalAccessException
	{
		if (c_logger.isTraceDebugEnabled()) {
			c_logger.traceDebug(this, "createRepository", "Standalone type");
		}
		return new StandAloneSSAttrRepoMgr();
