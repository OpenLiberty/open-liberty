 ...
 */
public class CommitedAddressImpl extends ContactSystemAddressImpl
{
     ...
     * Class Logger. 
     */
    private static final LogMgr c_logger = Log.get(CommitedAddressImpl.class);
     ...
     */
    protected CommitedAddressImpl(NameAddressHeader nameAddressHeader)
    {
