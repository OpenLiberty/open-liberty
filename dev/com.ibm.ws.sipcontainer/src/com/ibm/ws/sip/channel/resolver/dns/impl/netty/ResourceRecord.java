...
public class ResourceRecord {
    ...
    protected ResourceRecord(ByteBuf buffer) {
        _class = buffer.readShort();
        _ttl = buffer.readInt();
        _rdLength = buffer.readShort();
    ...
    protected static ResourceRecord createRecord(ByteBuf buffer) {
        /**
        ...
        try {
            ...
            /** SRVRecord field members are derived from name */
                ...
                Constructor constructor = clazz.getDeclaredConstructor(ByteBuf.class, Name.class);
            ...
            // System.out.println("ResourceRecord::createRecord Exception: " +
            // e.getMessage());
            return null;
        }
    ...
    protected void toBuffer(ByteBuf buffer) {
        ...
        buffer.writeShort(_class);
        buffer.writeInt(_ttl);
        buffer.writeShort(_rdLength);
    }
    ...
    public static Class className(Short type) throws ClassNotFoundException {
        ...
        String className = "com.ibm.ws.sip.channel.resolver.dns.impl.netty.";
        Class clazz = null;
