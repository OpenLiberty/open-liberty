...
public class Saml20TokenImpl implements Saml20Token, Serializable {
    ...
    private void init(Assertion assertion) throws SamlException {
    ...
    private void handleSamlSignature(Signature signature) throws SamlException {
        ...
        while (it.hasNext()) {
            ...
            List<org.opensaml.xml.signature.X509Certificate> certs = x509data.getX509Certificates();
            Iterator<org.opensaml.xml.signature.X509Certificate> itc = certs.iterator();
            while (itc.hasNext()) {
                org.opensaml.xml.signature.X509Certificate cert = itc.next();
