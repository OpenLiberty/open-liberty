...
import io.openliberty.jpa.tests.jpa32.web.TestAutoClosableServlet;
import io.openliberty.jpa.tests.jpa32.web.TestCaseConditionExpressionServlet;
import io.openliberty.jpa.tests.jpa32.web.TestNewQueryMathFunctionsServlet;
import io.openliberty.jpa.tests.jpa32.web.TestNewQueryTimeFunctionsServlet;
import io.openliberty.jpa.tests.jpa32.web.TestUUIDEntityIDServlet;

@RunWith(FATRunner.class)
@Mode(TestMode.LITE)
@MinimumJavaLevel(javaLevel = 17)
public class JPA32Test extends JPAFATServletClient {
    private final static String CONTEXT_ROOT = "JPA32";
    private final static String RESOURCE_ROOT = "test-applications/jpa32/";
    private final static String appFolder = "web";
    private final static String appName = "jpa32";
    private final static String appNameEar = appName + ".ear";

    private final static String PKG_ROOT = "io.openliberty.jpa.tests.jpa32";
    ...
    static {
        dropSet.add("JPA32_DROP_${dbvendor}.ddl");
        createSet.add("JPA32_CREATE_${dbvendor}.ddl");
        populateSet.add("JPA32_POPULATE_${dbvendor}.ddl");
    }
    ...
    public static void setUp() throws Exception {
        ...
        System.out.println(JPA32Test.class.getName() + " Setting up database tables...");
...
//        loader.setApiTypeVisibility("+third-party");
    ...
    public static void tearDown() throws Exception {
        try {
            ...
            bannerEnd(JPA32Test.class, timestart);
        }
    }
}
