...
public class WSSecEncrypt extends WSSecEncryptedKey {
     ...
     * @throws WSSecurityException
     */
    // Liberty Change Start: Ignoring the DestroyFailedException FFDC, because the SecretKeySpec is already null at the time secretKeySpec.destroy() is called
    @FFDCIgnore(DestroyFailedException.class)
    // Liberty Change End.
