...
public abstract class ELNode { 
    ...
    abstract public void accept(Visitor v) throws JspTranslationException;
	...
	public void accept(Visitor v) throws JspTranslationException {
	    v.visit(this);
	}
	 ...
	 */
	public void visit(Visitor v) throws JspTranslationException {
	...
	public void visit(Root n) throws JspTranslationException {
	    n.getExpression().visit(this);
	}

	public void visit(Function n) throws JspTranslationException {
	}

	public void visit(Text n) throws JspTranslationException {
	}

	public void visit(ELText n) throws JspTranslationException {
	}
    }
}
