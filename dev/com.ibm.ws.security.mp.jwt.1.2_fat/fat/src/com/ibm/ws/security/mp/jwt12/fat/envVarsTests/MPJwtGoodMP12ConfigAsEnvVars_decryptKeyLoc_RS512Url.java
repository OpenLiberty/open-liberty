...
public class MPJwtGoodMP12ConfigAsEnvVars_decryptKeyLoc_RS512Url extends GenericEnvVarsAndSystemPropertiesTests {

    public static Class<?> thisClass = MPJwtGoodMP12ConfigAsEnvVars_decryptKeyLoc_RS512Url.class;
    ...
    public static void setUp() throws Exception {
        ...
        commonMpJwt12Setup(envVarsResourceServer, "rs_server_AltConfigNotInApp_good12ServerXmlConfigNoAudiences.xml", MPJwt12FatConstants.AUTHORIZATION,
                           ...
                           JwtKeyTools.getDefaultKeyFileLoc(envVarsResourceServer) + JwtKeyTools.getPrivateKeyFileNameForAlg(MPJwt12FatConstants.SIGALG_RS512),
                           MPConfigLocation.ENV_VAR);

    }

    @Test
    public void MPJwtGoodMP12ConfigAsEnvVars_decryptKeyLoc_RS512Url_test() throws Exception {
        genericGoodTest("sign_RS256_enc_RS512");
    }

    @Test
    public void MPJwtGoodMP12ConfigAsEnvVars_decryptKeyLoc_RS512Url_overriddenByServerXml_test() throws Exception {
        genericBadTest("sign_RS256_enc_RS512", "rs_server_AltConfigNotInApp_Bad_DecryptKeyLoc.xml", setEncryptMismatchKeyTypeExpectations(resourceServer, false));
    }
}
