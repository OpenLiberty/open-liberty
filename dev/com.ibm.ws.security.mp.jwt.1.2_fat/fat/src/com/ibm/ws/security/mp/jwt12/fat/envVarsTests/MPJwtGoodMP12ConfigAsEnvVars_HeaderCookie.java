...
public class MPJwtGoodMP12ConfigAsEnvVars_HeaderCookie extends GenericEnvVarsAndSystemPropertiesTests {

    public static Class<?> thisClass = MPJwtGoodMP12ConfigAsEnvVars_HeaderCookie.class;
    ...
    public static void setUp() throws Exception {
        ...
        commonSetup(envVarsResourceServer, "rs_server_AltConfigNotInApp_good12ServerXmlConfigWithAudiences.xml", MpJwt12FatConstants.COOKIE, MpJwt12FatConstants.TOKEN_TYPE_BEARER,
                    "client01, client02", MPConfigLocation.ENV_VAR);

    }

    @Test
    public void MPJwtGoodMP12ConfigAsEnvVars_HeaderCookie_test() throws Exception {
        genericGoodTest();
    }

    @Test
    public void MPJwtGoodMP12ConfigAsEnvVars_HeaderCookie_overriddenByServerXml_test() throws Exception {
