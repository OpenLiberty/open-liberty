...
public class CertificateMapFailedException extends WIMApplicationException {
    ...
    /**
     * Constructs a CertificateMapFailedException with no message key, no detail message, and no cause.
     */
    ...
    /**
     * Constructs a CertificateMapFailedException with the specified message key and detail message.
     *
    ...
    /**
     * Constructs a CertificateMapFailedException with the specified cause.
     *
    ...
    /**
     * Constructs a CertificateMapFailedException with the specified message key, detail message, and cause.
     *
     * @param key The message key.
     * @param message The detail message.
     * @param cause The cause.
