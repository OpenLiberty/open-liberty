...
public class EntityIdentifierNotSpecifiedException extends WIMApplicationException {
    ...
    /**
     * Constructs a EntityIdentifierNotSpecifiedException with no message key, no detail message, and no cause.
     */
    ...
    /**
     * Constructs a EntityIdentifierNotSpecifiedException with the specified message key and detail message.
     *
    ...
    /**
     * Constructs a EntityIdentifierNotSpecifiedException with the specified cause.
     *
    ...
    /**
     * Constructs a EntityIdentifierNotSpecifiedException with the specified message key, detail message, and cause.
     *
     * @param key The message key.
     * @param message The detail message.
     * @param cause The cause.
