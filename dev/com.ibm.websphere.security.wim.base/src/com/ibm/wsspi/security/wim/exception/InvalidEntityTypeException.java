...
public class InvalidEntityTypeException extends WIMApplicationException {
    ...
    /**
     * Constructs a InvalidEntityTypeException with no message key, no detail message, and no cause.
     */
    ...
    /**
     * Constructs a InvalidEntityTypeException with the specified message key and detail message.
     *
    ...
    /**
     * Constructs a InvalidEntityTypeException with the specified cause.
     *
    ...
    /**
     * Constructs a InvalidEntityTypeException with the specified message key, detail message, and cause.
     *
     * @param key The message key.
     * @param message The detail message.
     * @param cause The cause.
