...
public class DuplicateLogonIdException extends WIMApplicationException {
    ...
    /**
     * Constructs a DuplicateLogonIdException with no message key, no detail message, and no cause.
     */
    ...
    /**
     * Constructs a DuplicateLogonIdException with the specified message key and detail message.
     *
    ...
    /**
     * Constructs a DuplicateLogonIdException with the specified cause.
     *
    ...
    /**
     * Constructs a DuplicateLogonIdException with the specified message key, detail message, and cause.
     *
     * @param key The message key.
     * @param message The detail message.
     * @param cause The cause.
