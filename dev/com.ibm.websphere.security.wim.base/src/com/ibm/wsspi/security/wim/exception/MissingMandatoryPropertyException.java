...
public class MissingMandatoryPropertyException extends WIMApplicationException {
    ...
    /**
     * Constructs a MissingMandatoryPropertyException with no message key, no detail message, and no cause.
     */
    ...
    /**
     * Constructs a MissingMandatoryPropertyException with the specified message key and detail message.
     *
    ...
    /**
     * Constructs a MissingMandatoryPropertyException with the specified cause.
     *
    ...
    /**
     * Constructs a MissingMandatoryPropertyException with the specified message key, detail message, and cause.
     *
     * @param key The message key.
     * @param message The detail message.
     * @param cause The cause.
