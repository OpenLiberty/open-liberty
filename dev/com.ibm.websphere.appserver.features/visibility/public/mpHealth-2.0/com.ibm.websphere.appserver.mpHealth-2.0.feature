...
-features=com.ibm.websphere.appserver.org.eclipse.microprofile.health-2.0, \
...
-bundles=\
 com.ibm.websphere.org.eclipse.microprofile.health.2.0; location:="dev/api/stable/,lib/"; mavenCoordinates="org.eclipse.microprofile.health:microprofile-health-api:2.0.1", \
