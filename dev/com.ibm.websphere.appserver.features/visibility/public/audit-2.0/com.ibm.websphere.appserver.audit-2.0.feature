...
-features=com.ibm.websphere.appserver.servlet-3.0; ibm.tolerates:="3.1,4.0,5.0,6.0,6.1,6.2", \
  io.openliberty.audit1.0.internal.ee-6.0; ibm.tolerates:="9.0, 10.0, 11.0, 12.0", \
