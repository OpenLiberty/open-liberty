...
symbolicName=io.openliberty.cdi-5.0
visibility=public
singleton=true
...
IBM-ShortName: cdi-5.0
Subsystem-Name: Jakarta Contexts and Dependency Injection 5.0
-features=io.openliberty.jakartaeePlatform-12.0, \
  io.openliberty.servlet.api-6.2, \
  ...
  io.openliberty.jakarta.pages-4.1, \
