...
symbolicName=io.openliberty.jsonbContainer-3.1
visibility=public
singleton=true
...
IBM-ShortName: jsonbContainer-3.1
Subsystem-Name: Jakarta JSON Binding 3.1 Container
-features=io.openliberty.jsonbImpl-3.1.0, \
