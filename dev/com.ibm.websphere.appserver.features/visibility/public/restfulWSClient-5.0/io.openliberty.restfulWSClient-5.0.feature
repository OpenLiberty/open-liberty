...
symbolicName=io.openliberty.restfulWSClient-5.0
visibility=public
singleton=true
...
IBM-App-ForceRestart: uninstall, \
 install
IBM-ShortName: restfulWSClient-5.0
WLP-AlsoKnownAs: jaxrsClient-5.0
Subsystem-Name: Jakarta RESTful Web Services 5.0 Client
-features=io.openliberty.cdi-5.0, \
  io.openliberty.jakarta.mail-2.2, \
  io.openliberty.jakarta.validation-4.0, \
  com.ibm.websphere.appserver.eeCompatible-12.0, \
  io.openliberty.servlet.internal-6.2, \
  io.openliberty.jakarta.restfulWS-5.0, \
  com.ibm.websphere.appserver.org.reactivestreams.reactive-streams-1.0, \
  com.ibm.websphere.appserver.jndi-1.0, \
  io.openliberty.activation.internal-2.2, \
