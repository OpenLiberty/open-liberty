...
-features=com.ibm.websphere.appserver.restHandler-1.0, \
  com.ibm.websphere.appserver.servlet-3.1; ibm.tolerates:="4.0, 5.0, 6.0, 6.1, 6.2", \
  com.ibm.websphere.appserver.transaction-1.2; ibm.tolerates:="2.0, 2.1", \
  com.ibm.websphere.appserver.jdbc-4.1; ibm.tolerates:="4.0,4.2,4.3", \
  com.ibm.websphere.appserver.eeCompatible-7.0; ibm.tolerates:="8.0,9.0,10.0,11.0,12.0", \
  io.openliberty.batchManagement1.0.internal.ee-7.0; ibm.tolerates:="9.0,10.0,12.0"
