...
symbolicName=io.openliberty.appSecurity-7.0
visibility=public
singleton=true
...
IBM-ShortName: appSecurity-7.0
Subsystem-Name: Application Security 7.0 (Jakarta Security 5.0)
-features=io.openliberty.cdi-5.0, \
  ...
  io.openliberty.jakarta.security.enterprise-5.0, \
