...
symbolicName=com.ibm.websphere.appserver.mpMetrics-2.1
visibility=public
singleton=true
IBM-API-Package: org.eclipse.microprofile.metrics.annotation;  type="stable", \
 org.eclipse.microprofile.metrics; type="stable"
IBM-ShortName: mpMetrics-2.1
Subsystem-Name: MicroProfile Metrics 2.1
-features=com.ibm.websphere.appserver.org.eclipse.microprofile.metrics-2.1, \
...
-bundles=com.ibm.ws.require.java8, \
 ...
 com.ibm.ws.microprofile.metrics.2.1, \
 com.ibm.ws.microprofile.metrics.private.2.1, \
