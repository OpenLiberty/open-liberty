...
symbolicName=io.openliberty.persistence-3.1
visibility=public
singleton=true
...
IBM-ShortName: persistence-3.1
WLP-AlsoKnownAs: jpa-3.1
Subsystem-Name: Jakarta Persistence 3.1
...
-bundles=io.openliberty.persistence.3.1.thirdparty; location:=dev/api/third-party/; mavenCoordinates="org.eclipse.persistence:eclipselink:4.0.0", \
