...
symbolicName=io.openliberty.restfulWS-5.0
visibility=public
singleton=true
IBM-API-Package: com.ibm.websphere.jaxrs.server; type="ibm-api"
IBM-App-ForceRestart: uninstall, \
 install
IBM-ShortName: restfulWS-5.0
WLP-AlsoKnownAs: jaxrs-5.0
Subsystem-Name: Jakarta RESTful Web Services 5.0
-features=\
  io.openliberty.restfulWSClient-5.0, \
