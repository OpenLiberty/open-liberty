...
# io.openliberty.mpCompatible-5.0; ibm.tolerates:="6.0" comes from io.openliberty.org.eclipse.microprofile.config-3.0 feature
...
WLP-Platform: microProfile-5.0,microProfile-6.0
