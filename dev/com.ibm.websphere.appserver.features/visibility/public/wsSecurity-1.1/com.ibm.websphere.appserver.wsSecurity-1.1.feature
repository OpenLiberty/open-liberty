...
-features=io.openliberty.servlet.api-3.0; apiJar=false; ibm.tolerates:="3.1,4.0,5.0,6.0,6.1,6.2", \
  com.ibm.websphere.appserver.ssoCommon-1.0, \
  io.openliberty.wsSecurity1.1.internal.jaxws-2.2; ibm.tolerates:="3.0,4.0,11.0,12.0", \
