...
-features=io.openliberty.constrainedDelegation1.0.internal.ee-6.0; ibm.tolerates:="9.0,10.0,11.0,12.0", \
  com.ibm.websphere.appserver.eeCompatible-6.0; ibm.tolerates:="7.0,8.0,9.0,10.0,11.0,12.0"
-bundles=\
