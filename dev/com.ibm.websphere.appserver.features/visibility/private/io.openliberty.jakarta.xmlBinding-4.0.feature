...
-features=com.ibm.websphere.appserver.eeCompatible-10.0; ibm.tolerates:="11.0, 12.0", \
  ...
  io.openliberty.jakarta.activation-2.1; ibm.tolerates:="2.2"
-bundles=\
  io.openliberty.jakarta.xmlBinding.4.0; location:="dev/api/spec/,lib/"; mavenCoordinates="jakarta.xml.bind:jakarta.xml.bind-api:4.0.2", \
