...
symbolicName=io.openliberty.org.eclipse.microprofile.rest.client-3.1
singleton=true
...
-bundles=io.openliberty.org.eclipse.microprofile.rest.client.3.0; location:="dev/api/stable/,lib/"; mavenCoordinates="org.eclipse.microprofile.rest.client:microprofile-rest-client-api:3.1.0"
kind=noship
edition=full
