...
IBM-Provision-Capability: \
  osgi.identity; filter:="(&(type=osgi.subsystem.feature)(|(osgi.identity=com.ibm.websphere.appserver.managedBeansCore-1.0)(osgi.identity=io.openliberty.managedBeansCore-2.0)))", \
