...
IBM-Provision-Capability: osgi.identity; filter:="(&(type=osgi.subsystem.feature)(|(osgi.identity=io.openliberty.mpFaultTolerance-4.0)(osgi.identity=io.openliberty.mpFaultTolerance-4.1)))", \
