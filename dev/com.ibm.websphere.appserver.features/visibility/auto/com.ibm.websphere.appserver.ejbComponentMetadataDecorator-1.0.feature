...
visibility=private
IBM-Provision-Capability: osgi.identity; filter:="(&(type=osgi.subsystem.feature)(|(osgi.identity=io.openliberty.ejbCore-2.0)(osgi.identity=com.ibm.websphere.appserver.ejbCore-1.0)))", \
