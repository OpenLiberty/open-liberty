...
visibility=private
IBM-Provision-Capability: osgi.identity; filter:="(&(type=osgi.subsystem.feature)(|(osgi.identity=com.ibm.websphere.appserver.transaction-2.0)(osgi.identity=com.ibm.websphere.appserver.transaction-2.1)))", \
