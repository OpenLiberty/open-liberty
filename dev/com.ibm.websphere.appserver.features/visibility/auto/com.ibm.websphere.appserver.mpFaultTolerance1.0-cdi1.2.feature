...
IBM-Provision-Capability: \
  osgi.identity; filter:="(&(type=osgi.subsystem.feature)(|(osgi.identity=com.ibm.websphere.appserver.mpFaultTolerance-1.0)(osgi.identity=com.ibm.websphere.appserver.mpFaultTolerance-1.1)))", \
