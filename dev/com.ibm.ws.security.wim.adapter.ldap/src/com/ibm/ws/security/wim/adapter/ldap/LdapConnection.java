...
import static com.ibm.ws.security.wim.adapter.ldap.LdapConstants.ATTRIBUTES_CACHE_CONFIG;
import static com.ibm.ws.security.wim.adapter.ldap.LdapConstants.CACHE_CONFIG;
import static com.ibm.ws.security.wim.adapter.ldap.LdapConstants.CONFIG_CONTEXT_POOL;
import static com.ibm.ws.security.wim.adapter.ldap.LdapConstants.CONFIG_IGNORE_CASE;
import static com.ibm.ws.security.wim.adapter.ldap.LdapConstants.CONFIG_PROP_ALLOW_WRITE_TO_SECONDARY_SERVERS;
import static com.ibm.ws.security.wim.adapter.ldap.LdapConstants.CONFIG_PROP_ATTRIBUTE_RANGE_STEP;
import static com.ibm.ws.security.wim.adapter.ldap.LdapConstants.CONFIG_PROP_ATTRIBUTE_SIZE_LIMIT;
import static com.ibm.ws.security.wim.adapter.ldap.LdapConstants.CONFIG_PROP_BIND_DN;
import static com.ibm.ws.security.wim.adapter.ldap.LdapConstants.CONFIG_PROP_BIND_PASSWORD;
import static com.ibm.ws.security.wim.adapter.ldap.LdapConstants.CONFIG_PROP_CACHE_SIZE;
import static com.ibm.ws.security.wim.adapter.ldap.LdapConstants.CONFIG_PROP_CACHE_TIME_OUT;
import static com.ibm.ws.security.wim.adapter.ldap.LdapConstants.CONFIG_PROP_CONNECT_TIMEOUT;
import static com.ibm.ws.security.wim.adapter.ldap.LdapConstants.CONFIG_PROP_ENABLED;
import static com.ibm.ws.security.wim.adapter.ldap.LdapConstants.CONFIG_PROP_HOST;
import static com.ibm.ws.security.wim.adapter.ldap.LdapConstants.CONFIG_PROP_INIT_POOL_SIZE;
import static com.ibm.ws.security.wim.adapter.ldap.LdapConstants.CONFIG_PROP_MAX_POOL_SIZE;
import static com.ibm.ws.security.wim.adapter.ldap.LdapConstants.CONFIG_PROP_POOL_TIME_OUT;
import static com.ibm.ws.security.wim.adapter.ldap.LdapConstants.CONFIG_PROP_POOL_WAIT_TIME;
import static com.ibm.ws.security.wim.adapter.ldap.LdapConstants.CONFIG_PROP_PORT;
import static com.ibm.ws.security.wim.adapter.ldap.LdapConstants.CONFIG_PROP_PREF_POOL_SIZE;
import static com.ibm.ws.security.wim.adapter.ldap.LdapConstants.CONFIG_PROP_PRIMARY_SERVER_QUERY_TIME_INTERVAL;
import static com.ibm.ws.security.wim.adapter.ldap.LdapConstants.CONFIG_PROP_READ_TIMEOUT;
import static com.ibm.ws.security.wim.adapter.ldap.LdapConstants.CONFIG_PROP_REFERAL;
import static com.ibm.ws.security.wim.adapter.ldap.LdapConstants.CONFIG_PROP_REFERRAL;
import static com.ibm.ws.security.wim.adapter.ldap.LdapConstants.CONFIG_PROP_RETURN_TO_PRIMARY_SERVER;
import static com.ibm.ws.security.wim.adapter.ldap.LdapConstants.CONFIG_PROP_SEARCH_COUNT_LIMIT;
import static com.ibm.ws.security.wim.adapter.ldap.LdapConstants.CONFIG_PROP_SEARCH_PAGE_SIZE;
import static com.ibm.ws.security.wim.adapter.ldap.LdapConstants.CONFIG_PROP_SEARCH_RESULTS_SIZE_LIMIT;
import static com.ibm.ws.security.wim.adapter.ldap.LdapConstants.CONFIG_PROP_SEARCH_TIME_OUT;
import static com.ibm.ws.security.wim.adapter.ldap.LdapConstants.CONFIG_PROP_SSL_ENABLED;
import static com.ibm.ws.security.wim.adapter.ldap.LdapConstants.CONFIG_REUSE_CONNECTION;
import static com.ibm.ws.security.wim.adapter.ldap.LdapConstants.SEARCH_CACHE_CONFIG;
