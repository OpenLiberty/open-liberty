 ...
 * the read/write methods for TestBean. A PropertyNotFoundException is not expected when trying to resolve
 * the "test" property of TestBean because a non standard read/write methods are used but are defined in the
 * TestBeanBeanInfo.
 */
