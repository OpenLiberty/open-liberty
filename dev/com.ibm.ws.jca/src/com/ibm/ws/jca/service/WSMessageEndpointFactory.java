...
public interface WSMessageEndpointFactory extends MessageEndpointFactory {
    ...
    /**
     * Determines if the message endpoint should be deactivated during server quiesce.
     * The default implementation returns true, indicating that endpoints should be
     * deactivated during quiesce. Subclasses may override this method to provide
     * custom behavior based on configuration.
     *
     * @return true if the endpoint should be deactivated during quiesce, false otherwise
     */
    default boolean isDeactivateOnQuiesce() {
        return true;
    }
}
