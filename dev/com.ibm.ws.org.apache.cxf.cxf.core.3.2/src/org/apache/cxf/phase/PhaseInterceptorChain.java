        ...
        try {
            ...
            while (state == State.EXECUTING && iterator.hasNext()) {
                try {
                    ...
                    System.out.println("before=" + (String)message.get(Message.CONTENT_TYPE) + " " + currentInterceptor);
                    currentInterceptor.handleMessage(message);
                    System.out.println("after=" + (String)message.get(Message.CONTENT_TYPE) + " " + currentInterceptor);
