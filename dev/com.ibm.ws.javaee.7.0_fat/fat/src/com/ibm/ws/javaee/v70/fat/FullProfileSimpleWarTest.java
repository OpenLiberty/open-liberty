...
/**
 * Test of Servlet 3.1 parsing using the 'javaee-7.0' feature.
 *
 * This test puts together a server definition which uses feature
 * 'javaee-7.0' with a simple WAR which uses the Servlet 3.1
 * schemas.
 *
...
public class FullProfileSimpleWarTest extends FATServletClient implements FATAppConstants {

    @Server(JAVA7_FULL_SIMPLE_WAR_SERVER_NAME)
