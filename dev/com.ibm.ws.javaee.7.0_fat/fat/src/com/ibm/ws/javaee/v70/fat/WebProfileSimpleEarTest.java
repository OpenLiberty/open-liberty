...
/**
 * Test of Application 7 and Servlet 3.1 parsing using the 'webProfile-7.0'
 * feature.
 *
 * This test puts together a server definition which uses feature
 * 'webProfile-7.0' with a simple EAR which uses Application 7 and which
...
public class WebProfileSimpleEarTest extends FATServletClient implements FATAppConstants {
    ...
    @Server(JAVA7_WEB_SIMPLE_EAR_SERVER_NAME)
