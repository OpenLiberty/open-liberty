...
import com.ibm.ws.jpa.olgh17376.web.TestOLGH17376Servlet;
...
public class TestOLGH17376_Web extends JPAFATServletClient {
    private final static String CONTEXT_ROOT = "olgh17376Web";
    private final static String RESOURCE_ROOT = "test-applications/olgh17376/";
    private final static String appFolder = "web";
    private final static String appName = "olgh17376Web";
    ...
    static {
        dropSet.add("JPA_OLGH17376_DROP_${dbvendor}.ddl");
        createSet.add("JPA_OLGH17376_CREATE_${dbvendor}.ddl");
        populateSet.add("JPA_OLGH17376_POPULATE_${dbvendor}.ddl");
    }

    @Server("JPA10QueryServer")
    @TestServlets({
                    @TestServlet(servlet = TestOLGH17376Servlet.class, path = CONTEXT_ROOT + "/" + "TestOLGH17376Servlet"),
    })
    ...
    public static void setUp() throws Exception {
        ...
        bannerStart(TestOLGH17376_Web.class);
        ...
        System.out.println(TestOLGH17376_Web.class.getName() + " Setting up database tables...");
    ...
    private static void setupTestApplication() throws Exception {
        ...
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh17376.model");
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh17376.testlogic");
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh17376.web");
    ...
    public static void tearDown() throws Exception {
        try {
            ...
            bannerEnd(TestOLGH17376_Web.class, timestart);
        }
    }
}
