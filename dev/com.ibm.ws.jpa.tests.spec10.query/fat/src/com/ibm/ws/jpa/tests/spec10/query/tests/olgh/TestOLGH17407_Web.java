...
public class TestOLGH17407_Web extends JPAFATServletClient {
    private final static String CONTEXT_ROOT = "olgh17407Web";
    private final static String RESOURCE_ROOT = "test-applications/olgh17407/";
    private final static String appFolder = "web";
    private final static String appName = "olgh17407Web";
    ...
    static {
        dropSet.add("JPA_OLGH17407_DROP_${dbvendor}.ddl");
        createSet.add("JPA_OLGH17407_CREATE_${dbvendor}.ddl");
        populateSet.add("JPA_OLGH17407_POPULATE_${dbvendor}.ddl");
    }

    @Server("JPA10QueryServer")
    @TestServlets({
                    @TestServlet(servlet = TestOLGH17407Servlet.class, path = CONTEXT_ROOT + "/" + "TestOLGH17407Servlet"),
    })
    ...
    public static void setUp() throws Exception {
        ...
        bannerStart(TestOLGH17407_Web.class);
        ...
        System.out.println(TestOLGH17407_Web.class.getName() + " Setting up database tables...");
    ...
    private static void setupTestApplication() throws Exception {
        ...
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh17407.model");
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh17407.testlogic");
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh17407.web");
    ...
    public static void tearDown() throws Exception {
        try {
            ...
            bannerEnd(TestOLGH17407_Web.class, timestart);
        }
    }
}
