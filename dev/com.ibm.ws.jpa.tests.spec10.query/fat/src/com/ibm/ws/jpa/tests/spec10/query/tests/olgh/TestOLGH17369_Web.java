...
import com.ibm.ws.jpa.olgh17369.web.TestOLGH17369Servlet;
...
public class TestOLGH17369_Web extends JPAFATServletClient {
    ...
    @TestServlets({
                    @TestServlet(servlet = TestOLGH17369Servlet.class, path = CONTEXT_ROOT + "/" + "TestOLGH17369Servlet"),
    })
    ...
    public static void setUp() throws Exception {
        ...
        bannerStart(TestOLGH17369_Web.class);
        ...
        System.out.println(TestOLGH17369_Web.class.getName() + " Setting up database tables...");
    ...
    private static void setupTestApplication() throws Exception {
        ...
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh17369.model");
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh17369.testlogic");
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh17369.web");
    ...
    public static void tearDown() throws Exception {
        try {
            ...
            bannerEnd(TestOLGH17369_Web.class, timestart);
        }
    }
}
