...
public class TestOLGH14137_EJB extends JPAFATServletClient {
    ...
    private final static String appName = "olgh14137Ejb";
    ...
    @TestServlets({
                    @TestServlet(servlet = TestOLGH14137_EJB_SL_Servlet.class, path = CONTEXT_ROOT + "/" + "TestOLGH14137_EJB_SL_Servlet"),
                    @TestServlet(servlet = TestOLGH14137_EJB_SF_Servlet.class, path = CONTEXT_ROOT + "/" + "TestOLGH14137_EJB_SF_Servlet"),
                    @TestServlet(servlet = TestOLGH14137_EJB_SFEx_Servlet.class, path = CONTEXT_ROOT + "/" + "TestOLGH14137_EJB_SFEx_Servlet")
    })
    ...
    public static void setUp() throws Exception {
        ...
        bannerStart(TestOLGH14137_EJB.class);
    ...
    private static void setupTestApplication() throws Exception {
        JavaArchive ejbApp = ShrinkWrap.create(JavaArchive.class, "olgh14137Ejb.jar");
        ejbApp.addPackages(true, "com.ibm.ws.jpa.olgh14137.ejblocal");
        ejbApp.addPackages(true, "com.ibm.ws.jpa.olgh14137.model");
        ejbApp.addPackages(true, "com.ibm.ws.jpa.olgh14137.testlogic");
        ShrinkHelper.addDirectory(ejbApp, RESOURCE_ROOT + appFolder + "/" + appName + ".jar");

        WebArchive webApp = ShrinkWrap.create(WebArchive.class, appName + ".war");
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh14137.ejb");
...
//        cel.add(loader);
    ...
    public static void tearDown() throws Exception {
        try {
            ...
            bannerEnd(TestOLGH14137_EJB.class, timestart);
        }
    }
}
