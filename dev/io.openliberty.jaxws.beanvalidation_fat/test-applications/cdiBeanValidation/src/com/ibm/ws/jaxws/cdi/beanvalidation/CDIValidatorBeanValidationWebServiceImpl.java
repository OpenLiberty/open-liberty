 ...
 */
@ApplicationScoped
@WebService(serviceName = "CDIValidatorBeanValidationWebService",
            portName = "CDIValidatorBeanValidationWebServicePort")
public class CDIValidatorBeanValidationWebServiceImpl {
    ...
    private final static Logger logger = Logger.getLogger(CDIValidatorBeanValidationWebServiceImpl.class.getName());
    ...
    public void oneWayWithValidation(String testString) {
        ...
        try {
            ...
            final Set<ConstraintViolation<String>> violations = injectValidator.validate(testString);
    ...
    public void oneWayWithJAXBAnnotatedValidation(OneWayWithValidation request) {
        ...
        try {
            ...
            final Set<ConstraintViolation<OneWayWithValidation>> violations = injectValidator.validate(request);
            if (!violations.isEmpty()) {
    ...
    public String twoWayWithValidation(String testString) {
        ...
        try {
            ...
            final Set<ConstraintViolation<@NotNull @Size(min = 4, max = 10) String>> violations = injectValidator.validate(testString);
            if (!violations.isEmpty()) {
                final ConstraintViolation<String> firstViolation = violations.iterator().next();
    ...
    public String twoWayWithValidationJAXBAnnotatedValidation(TwoWayWithValidation request) {
        ...
        try {
            ...
            logger.info("Begining validation of request: " + request);
            final Set<ConstraintViolation<TwoWayWithValidation>> violations = injectValidator.validate(request);
            if (!violations.isEmpty()) {
