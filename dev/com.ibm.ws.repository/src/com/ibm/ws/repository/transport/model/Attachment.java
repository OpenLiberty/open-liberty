...
import static com.ibm.ws.repository.transport.model.CopyUtils.copyCalendar;
...
public class Attachment extends AbstractJSON {
    ...
    public Attachment(Attachment other) {
        ...
        this.uploadOn = copyCalendar(other.uploadOn);
        this.gridFSId = other.gridFSId;
        this.content = other.content;
        this.authentication = other.authentication;
        this.size = other.size;
        this.wlpInformation = CopyUtils.copyObject(other.wlpInformation, AttachmentInfo::new);
