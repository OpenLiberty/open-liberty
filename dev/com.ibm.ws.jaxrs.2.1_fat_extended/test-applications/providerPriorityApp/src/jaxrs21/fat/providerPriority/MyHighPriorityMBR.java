...
@Provider
@Priority(1001)
public class MyHighPriorityMBR implements MessageBodyReader<MyObject> {

    private static final int mbrVersion = 2;
    ...
    public MyObject readFrom(Class<MyObject> clazz, Type type, Annotation[] annos, MediaType mt, MultivaluedMap<String, String> map,
        ...
        System.out.println("MyHighPriorityMBR received: " + line);
