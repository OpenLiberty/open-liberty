...
@Provider
@Priority(1)
public class MyHighPriorityMBW implements MessageBodyWriter<MyObject> {

    private static final int mbwVersion = 2;
    ...
    public void writeTo(MyObject myObject, Class<?> clazz, Type type, Annotation[] annos, MediaType mt, MultivaluedMap<String, Object> map,
        ...
        System.out.println("MyHighPriorityMBW sending: " + myObject);
