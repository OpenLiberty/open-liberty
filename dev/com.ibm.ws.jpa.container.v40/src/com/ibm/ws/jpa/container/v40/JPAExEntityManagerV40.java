...
public class JPAExEntityManagerV40 extends JPAExEntityManager{
    private static final TraceComponent tc = Tr.register(JPAExEntityManagerV40.class,
                                                         JPA_TRACE_GROUP,
                                                         JPA_RESOURCE_BUNDLE_NAME);

    public JPAExEntityManagerV40(JPAPuId puRefId,
                                 JPAPUnitInfo puInfo,
                                 J2EEName j2eeName,
                                 String refName,
                                 Map<?, ?> properties,
