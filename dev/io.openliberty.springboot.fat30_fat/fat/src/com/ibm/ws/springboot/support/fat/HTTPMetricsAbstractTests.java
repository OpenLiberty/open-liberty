...
public abstract class HTTPMetricsAbstractTests extends AbstractSpringTests {
    ...
    public static final String NO_CONTEXTROOT_WAR = "io.openliberty.springboot.fat30.http.app-0.0.1-SNAPSHOT.war";
    public static final String WITH_CONTEXTROOT_WAR = "io.openliberty.springboot.fat30.http.contextroot.app-0.0.1-SNAPSHOT.war";

    public static final String CONTEXT_ROOT = "/contextual";

    @Override
    public Set<String> getFeatures() {
        HashSet<String> result = new HashSet<>(Arrays.asList("springBoot-3.0", "servlet-6.0", "monitor-1.0", "pages-3.1"));
        return result;
    }
