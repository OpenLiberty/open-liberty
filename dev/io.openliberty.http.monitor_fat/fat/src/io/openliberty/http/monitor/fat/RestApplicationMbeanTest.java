...
public class RestApplicationMbeanTest extends BaseTestClass {

    private static Class<?> c = RestApplicationMbeanTest.class;
    ...
    public static void afterClass() throws Exception {
        ...
        if (server != null && server.isStarted()) {
            //SRVE0777E for JAVA EE runs
            server.stopServer("CWMCG0007E", "CWMCG0014E", "CWMCG0015E", "CWMCG5003E", "CWPMI2006W", "CWMMC0013E", "CWWKG0033W", "SRVE0315E", "SRVE0777E");
        }
    }

    @Test
    public void mr1_normalPathGet() throws Exception {
    ...
    @Test
    public void mr1_normalPathPost() throws Exception {
        assertTrue(server.isStarted());
    ...
    @Test
    public void mr1_normalPathPut() throws Exception {
    ...
    @Test
    public void mr1_normalPathDelete() throws Exception {
    ...
    @Test
    public void mr1_normalPathOptions() throws Exception {
    ...
    @Test
    public void mr1_normalPathHead() throws Exception {
    ...
    @Test
    @AllowedFFDC
    public void mr1_failDivZero() throws Exception {
    ...
    @Test
    public void mr1_nonExistentPath() throws Exception {
    ...
    @Test
    @AllowedFFDC
    public void mr1_failThrowIO() throws Exception {
    ...
    @Test
    @AllowedFFDC
    public void mr1_failThrowIAE() throws Exception {
    ...
    @Test
    public void mr1_params_any() throws Exception {
    ...
    @Test
    public void mr1_params_getName() throws Exception {
    ...
    @Test
    public void mr1_params_postName() throws Exception {
    ...
    @Test
    public void mr1_params_query() throws Exception {
        ...
        Log.info(c, " mr1_params_query", "the response is " + res);
    ...
    @Test
    public void mr1_params_queryParam() throws Exception {
