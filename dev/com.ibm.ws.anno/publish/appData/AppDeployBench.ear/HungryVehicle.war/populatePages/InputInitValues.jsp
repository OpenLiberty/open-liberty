...
<%-- jsf:pagecode language="java" location="/src/pagecode/populatePages/InputInitValues.java" --%><%-- /jsf:pagecode --%><%@page
...
<div id="container">
		...
		<t:column>
				<div id="leftcenter_section">
		         	<jsp:include 
							page="InputInitValues_e.jsp" flush="false">
					</jsp:include>
		         </div>
		</t:column>
		<t:column>
