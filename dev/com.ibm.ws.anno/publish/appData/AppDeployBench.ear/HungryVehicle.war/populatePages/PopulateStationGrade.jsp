...
<%-- jsf:pagecode language="java" location="/src/pagecode/populatePages/PopulateStationGrade.java" --%><%-- /jsf:pagecode --%><%@page
...
<link rel="stylesheet"
	...
	type="text/css">
<title>PopulateStationGrade</title>
...
<div id="container">
		...
		<t:column>
				<div id="leftcenter_section">
		         <jsp:include 
							page="PopulateStationGrade_e.jsp" flush="false">
			 		</jsp:include>
		         </div>
		</t:column>
		<t:column>
