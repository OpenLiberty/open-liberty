...
<%-- jsf:pagecode language="java" location="/src/pagecode/gaspurchasePages/CustomerPurchase.java" --%><%-- /jsf:pagecode --%><%@page
...
<div id="container">
		...
		<t:column>
				<div id="leftcenter_section">
		        	 <jsp:include 
							page="CustomerPurchase_e.jsp" flush="false">
			 		</jsp:include>
		         </div>
		</t:column>
		<t:column>
