...
<%-- jsf:pagecode language="java" location="/src/pagecode/gaspurchasePages/PumpInterface.java" --%><%-- /jsf:pagecode --%><%@page
	...
	<div id="container">
		...
		<t:column>
				<div id="leftcenter_section">
		         	<jsp:include 
							page="PumpInterface_e.jsp" flush="false">
					</jsp:include>
		         </div>
		</t:column>
		<t:column>
