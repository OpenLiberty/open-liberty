...
<%-- jsf:pagecode language="java" location="/src/pagecode/aboutusPages/FuelType_Display.java" --%><%-- /jsf:pagecode --%><%@page
		...
		<h:panelGrid styleClass="panelGrid" id="grid1" columns="2">
			...
			<h:column>		         
		         <div id="leftcenter_section">
		         	<jsp:include 
							page="FuelType_Display_e.jsp" flush="false">
			 		</jsp:include>
		         </div>
			</h:column>
