...
<%-- jsf:pagecode language="java" location="/src/pagecode/stlocatorPages/StationLocator.java" --%><%-- /jsf:pagecode --%><%@page
		...
		<h:panelGrid styleClass="panelGrid" id="grid1" columns="2">
			...
			<h:column>		         
		         <div id="leftcenter_section">
		         	<jsp:include 
							page="StationLocator_e.jsp" flush="false">
			 		</jsp:include>
		         </div>
			</h:column>
