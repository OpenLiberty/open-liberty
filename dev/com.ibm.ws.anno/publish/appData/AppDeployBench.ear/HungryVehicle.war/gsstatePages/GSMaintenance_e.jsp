...
<%-- jsf:pagecode language="java" location="/src/pagecode/gsstatePages/GSMaintenance_e.java" --%><%-- /jsf:pagecode --%><%@page
...
<f:subview id="maintenance">
	...
	<h:form styleClass="form" id="form1">
						...
						<tbody>
							...
							GasStation in Maintenance</FONT> <br>
