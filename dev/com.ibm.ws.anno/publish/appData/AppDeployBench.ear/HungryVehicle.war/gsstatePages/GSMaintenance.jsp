...
<%-- jsf:pagecode language="java" location="/src/pagecode/gsstatePages/GSMaintenance.java" --%><%-- /jsf:pagecode --%><%@page
		...
		<t:panelGrid styleClass="panelGrid" id="grid1" columns="2">
			...
			<t:column>
				<div id="leftcenter_section">
		         	...
		         	<jsp:include 
							page="GSMaintenance_e.jsp" flush="false">
			 		</jsp:include>
