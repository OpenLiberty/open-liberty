...
<%-- jsf:pagecode language="java" location="/src/pagecode/gsstatePages/GSEODMaintenance.java" --%><%-- /jsf:pagecode --%><%@page
		...
		<t:panelGrid styleClass="panelGrid" id="grid1" columns="2">
			...
			<t:column>
				<div id="leftcenter_section">
		         	...
		         	<jsp:include 
							page="GSEODMaintenance_e.jsp" flush="false">
			 		</jsp:include>
