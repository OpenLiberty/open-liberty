...
<%-- jsf:pagecode language="java" location="/src/pagecode/storepurchasePages/ProductList.java" --%><%-- /jsf:pagecode --%><%@page
...
<link rel="stylesheet" type="text/css" title="Style"
	href="<%=request.getContextPath()%>/theme/tabpanel.css">
<link rel="stylesheet"
		...
		<h:panelGrid styleClass="panelGrid" id="grid1" columns="2">
			...
			<h:column>		         
		         <div id="leftcenter_section">
		         	<jsp:include 
							page="ProductList_e.jsp" flush="false">
			 		</jsp:include>
		         </div>
			</h:column>
