...
<%-- jsf:pagecode language="java" location="/src/pagecode/gaspurchasePages/InputMemberData.java" --%><%-- /jsf:pagecode --%><%@page
		...
		<h:panelGrid styleClass="panelGrid" id="grid1" columns="2">
			...
			<h:column>		         
		         <div id="leftcenter_section">
		         	<jsp:include 
							page="InputMemberData_e.jsp" flush="false">
			 		</jsp:include>
		         </div>
			</h:column>
