...
<%-- jsf:pagecode language="java" location="/src/pagecode/populatePages/PopulateProductCat.java" --%><%-- /jsf:pagecode --%><%@page
...
<link rel="stylesheet"
	...
	type="text/css">
<title>PopulateProductCat</title>
	...
	<div id="container">
		...
		<t:column>
				<div id="leftcenter_section">
		         <jsp:include 
							page="PopulateProductCat_e.jsp" flush="false">
			 		</jsp:include>
		         </div>
		</t:column>
		<t:column>
