...
public class Test_AnnoRepeatable_Test extends Test_Base {
    ...
    public static final String AUTHOR_CLASS_NAME = "com.ibm.ws.anno.test.classes.repeatable.Author";
    public static final String AUTHORS_CLASS_NAME = "com.ibm.ws.anno.test.classes.repeatable.Authors";

    public static final String BOOK_DIRECT_CLASS_NAME = "com.ibm.ws.anno.test.classes.repeatable.Book_Direct";
    public static final String BOOK_INDIRECT_CLASS_NAME = "com.ibm.ws.anno.test.classes.repeatable.Book_Indirect";
