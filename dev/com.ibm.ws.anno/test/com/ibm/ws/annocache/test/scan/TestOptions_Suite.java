...
public class TestOptions_Suite {
    ...
    public static TestOptions MULTI_OPTIONS =
        new TestOptions(
            ...
            !USE_JANDEX, !USE_JANDEX_FULL, SCAN_THREADS_MULTI,
            !DO_IGNORE_MISSING_PACKAGES, DO_IGNORE_MISSING_INTERFACES);
    ...
    public static TestOptions SINGLE_WRITE_OPTIONS =
        new TestOptions(
            ...
            !DO_USE_JANDEX_FORMAT, !DO_READ_JANDEX_FULL, !DO_USE_BINARY_FORMAT,
            !DO_IGNORE_MISSING_PACKAGES, !DO_IGNORE_MISSING_INTERFACES);
    ...
    public static TestOptions SINGLE_WRITE_JANDEX_NOWRITE_OPTIONS =
        new TestOptions(
            ...
            USE_JANDEX, !USE_JANDEX_FULL, SCAN_THREADS_DEFAULT,
            SINGLE_WRITE_OMIT_JANDEX_SUFFIX, DO_CLEAN_STORAGE,
            READ_ONLY_DEFAULT, ALWAYS_VALID_DEFAULT, WRITE_THREADS_DEFAULT,
            OMIT_JANDEX_WRITE, !SEPARATE_CONTAINERS,
            !DO_USE_JANDEX_FORMAT, !DO_READ_JANDEX_FULL, !DO_USE_BINARY_FORMAT,
            !DO_IGNORE_MISSING_PACKAGES, DO_IGNORE_MISSING_INTERFACES);
    ...
    public static TestOptions MULTI_WRITE_JANDEX_NOWRITE_OPTIONS =
        new TestOptions(
            ...
            USE_JANDEX, !USE_JANDEX_FULL, SCAN_THREADS_MULTI,
            MULTI_WRITE_OMIT_JANDEX_SUFFIX, DO_CLEAN_STORAGE,
            READ_ONLY_DEFAULT, ALWAYS_VALID_DEFAULT, WRITE_THREADS_DEFAULT,
            OMIT_JANDEX_WRITE, !SEPARATE_CONTAINERS,
            !DO_USE_JANDEX_FORMAT, !DO_READ_JANDEX_FULL, !DO_USE_BINARY_FORMAT,
            !DO_IGNORE_MISSING_PACKAGES, DO_IGNORE_MISSING_INTERFACES);
    ...
    public static TestOptions SINGLE_WRITE_SEPARATE_OPTIONS =
            new TestOptions(
                ...
                !USE_JANDEX, !USE_JANDEX_FULL, SCAN_THREADS_DEFAULT,
                SINGLE_WRITE_SEPARATE_SUFFIX, DO_CLEAN_STORAGE,
                READ_ONLY_DEFAULT, ALWAYS_VALID_DEFAULT, WRITE_THREADS_DEFAULT,
                !OMIT_JANDEX_WRITE, SEPARATE_CONTAINERS,
                !DO_USE_JANDEX_FORMAT, !DO_READ_JANDEX_FULL, !DO_USE_BINARY_FORMAT,
                !DO_IGNORE_MISSING_PACKAGES, !DO_IGNORE_MISSING_INTERFACES);
    ...
    public static TestOptions MULTI_WRITE_SEPARATE_OPTIONS =
            new TestOptions(
                ...
                !USE_JANDEX, !USE_JANDEX_FULL, SCAN_THREADS_MULTI,
                MULTI_WRITE_SEPARATE_SUFFIX, DO_CLEAN_STORAGE,
                READ_ONLY_DEFAULT, ALWAYS_VALID_DEFAULT, WRITE_THREADS_DEFAULT,
                !OMIT_JANDEX_WRITE, SEPARATE_CONTAINERS,
                !DO_USE_JANDEX_FORMAT, !DO_READ_JANDEX_FULL, !DO_USE_BINARY_FORMAT,
                !DO_IGNORE_MISSING_PACKAGES, !DO_IGNORE_MISSING_INTERFACES);
    ...
    public static TestOptions SINGLE_READ_JANDEX_FORMAT_FULL_OPTIONS =
            new TestOptions(
                "SingleReadUsingJandex", "Read using Jandex Format",
                !USE_JANDEX, !USE_JANDEX_FULL, SCAN_THREADS_DEFAULT,
                SINGLE_WRITE_JANDEX_FORMAT_SUFFIX, !DO_CLEAN_STORAGE,
