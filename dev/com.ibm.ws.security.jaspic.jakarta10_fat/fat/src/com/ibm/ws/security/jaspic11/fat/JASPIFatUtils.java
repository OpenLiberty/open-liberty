...
public class JASPIFatUtils {
    ...
    /**
     * Install the jaspicUserTestFeature-1.0 or jaspicUserTestFeature-2.0 user feature or jaspicUserTestFeature-3.0 and bundle
    ...
    /**
     * Uninstall the jaspicUserTestFeature-1.0 or jaspicUserTestFeature-2.0 or jaspicUserTestFeature-2.1 user feature and bundle
    ...
    /**
     * Install the jaccTestProvider-1.0, jaccTestProvider-2.0, or jaccTestProvider-2.1 user feature and bundle into the Liberty
     * server.
     *
     * @param myServer
     *            The server to install onto.
    ...
    /**
     * Uninstall the jaccTestProvider-1.0, jaccTestProvider-2.0 or jaccTestProvider-2.1 user feature and bundle from the Liberty
     * server.
     *
     * @param myServer
     *            The server to uninstall from.
    ...
    /**
     * JakartaEE9 transform a list of applications. The applications are the simple app names and they must exist at
     * '<server>/apps/<appname>'.
     *
     * @param myServer
     *            The server to transform the applications on.
     * @param apps
     *            The simple names of the applications to transform.
     */
