...
public class JASPITestBase {
    ...
    public static final String DEFAULT_SERVERAUTH_REGISTRATION_APP = "JASPIServerAuthRegistrationTestServlet";
    ...
    protected final String DEFAULT_AUTHMODULE_CLASS = "com.ibm.ws.security.jaspi.test.AuthModule";
    protected final String PERSISTENT_AUTHMODULE_CLASS = "com.ibm.ws.security.jaspi.test.AuthModule_1";
    ...
    protected String buildServerAuthQueryString(String operation, String layer, String context, String serverAuthModuleClass) {
        String queryString = operation + "**" + layer + "**" + context + "**" + serverAuthModuleClass;
        return queryString;
    }
    ...
    protected void verifyServerAuthModuleRegisteredSuccessfully(String response) {
        mustContain(response, "Successfully registered server auth module.");
    }
    ...
    protected void verifyServerAuthModuleRemovedSuccessfully(String response) {
        mustContain(response, "Successfully removed server auth module.");
    }
    ...
    protected void verifyPersistentServerAuthModuleInformation(String response, String msgLayer, String appContext, String serverAuthModuleClass) {
        mustContain(response, msgLayer);
        mustContain(response, appContext);
        mustContain(response, isPersistentTrue);
        mustContain(response, serverAuthModuleClass);
    }
    ...
    protected void verifyServerAuthModuleNotRegistered(String response, String msgLayer, String appContext) {
        response.contains("Failed to get registered server auth module for message layer=" + msgLayer + " and application context=" + appContext);
    }
