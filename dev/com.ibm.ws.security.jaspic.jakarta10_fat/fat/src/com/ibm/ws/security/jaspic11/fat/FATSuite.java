...
public class FATSuite {
    ...
    //public static RepeatTests repeat = RepeatTests.withoutModificationInFullMode().andWith(FeatureReplacementAction.EE10_FEATURES().removeFeatures(EE78_FEATURES).removeFeatures(EE9_FEATURES).addFeatures(EE10_FEATURES));
