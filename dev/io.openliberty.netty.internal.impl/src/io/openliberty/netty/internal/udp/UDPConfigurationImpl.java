...
public class UDPConfigurationImpl implements BootstrapConfiguration {
    ...
    private void setValues(Map<String, Object> props) throws NettyException {
        ...
        for (Map.Entry<String, Object> entry : props.entrySet()) {
            ...
            try {
                if (key.equals("id") || key.equals("type") || key.startsWith("service.") || key.startsWith("component.")
                        || key.startsWith("config.") || key.startsWith("objectClass") || key.startsWith("parentPid")) {
