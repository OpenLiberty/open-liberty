...
import com.ibm.ws.security.openidconnect.client.fat.CommonTests.LogoutOidcClientTests;
...
public class OidcClientLogoutTests extends LogoutOidcClientTests {

    @SuppressWarnings("serial")
    @BeforeClass
    public static void setUp() throws Exception {

        thisClass = OidcClientLogoutTests.class;
        ...
        List<String> opApps = new ArrayList<String>() {
            {
                add(Constants.OAUTHCONFIGTAI_START_APP);
            }
        ...
        testOPServer = commonSetUp("com.ibm.ws.security.openidconnect.client-1.0_fat.op", "op_server_orig.xml", Constants.OIDC_OP, opApps,
