...
public class GenericOidcClientTests extends CommonTest {
    ...
    public void OidcClientTestGetMainPathWithAddlAuthAndTokenParms() throws Exception {
        ...
        updatedTestSettings.setScope("openid profile");
        updatedTestSettings.addRequestParms();
        updatedTestSettings.setTestURL(updatedTestSettings.getTestURL().replace(Constants.DEFAULT_SERVLET, "simple/addlParms"));
    ...
    public void OidcClientTestGetMainPathWithAddlBadAuthAndTokenParms() throws Exception {
        ...
        updatedTestSettings.setScope("openid profile");
        updatedTestSettings.addRequestParms();
        updatedTestSettings.setTestURL(updatedTestSettings.getTestURL().replace(Constants.DEFAULT_SERVLET, "simple/addlBadParms"));
    ...
    public void OidcClientTestGetMainPathWithDyanmicLoginParameter() throws Exception {
        ...
        TestSettings updatedTestSettings = testSettings.copyTestSettings();
        updatedTestSettings.setScope("openid profile");
        String applicationUrl = testRPServer.getHttpsString() + "/" + Constants.OPENID_APP + "/" + "simple/addDynamicParms" + "?&login_hint=testuser1@us.ibm.com";
     ...
     * <OL>
     * <LI>Attempt to access a test servlet specifying valid OP url
     * <LI>The client is configured to redirect to client02 on the provider.
    ...
    public void OidcClientTestGetMainPathWithRegexpRedirect() throws Exception {
        ...
        updatedTestSettings.addRequestParms();
        updatedTestSettings.setTestURL(updatedTestSettings.getTestURL().replace(Constants.DEFAULT_SERVLET, "simple/regexpRedirect"));
    ...
    public void OidcClientTestGetMainPathWithNonce() throws Exception {
        ...
        updatedTestSettings.setTestURL(updatedTestSettings.getTestURL().replace(Constants.DEFAULT_SERVLET, "simple/nonceEnabled"));
    ...
    public void OidcClientTestFilterOut() throws Exception {
        ...
        TestSettings updatedTestSettings = testSettings.copyTestSettings();
        updatedTestSettings.setTestURL(updatedTestSettings.getTestURL().replace(Constants.DEFAULT_SERVLET, "simple/missingFilter"));

        List<validationData> expectations = vData.addSuccessStatusCodes(null);
        expectations = vData.addExpectation(expectations, Constants.GET_LOGIN_PAGE, Constants.RESPONSE_FULL, Constants.STRING_CONTAINS, "Did Not get the regular login page.", null, "<TITLE>login.jsp</TITLE>");
        expectations = vData.addExpectation(expectations, Constants.GET_LOGIN_PAGE, Constants.RESPONSE_FULL, Constants.STRING_CONTAINS, "Did Not get the regular login page.", null, "Form Login Page");
    ...
    public void OidcClientTestUserIdNotInRegistry() throws Exception {
        ...
        // can't remove the reconfig in this test - test needs a different registry
    ...
    public void OidcClientTestConsentForm() throws Exception {
        ...
        TestSettings updatedTestSettings = testSettings.copyTestSettings();
        updatedTestSettings.setTestURL(updatedTestSettings.getTestURL().replace(Constants.DEFAULT_SERVLET, "simple/consent"));

        List<validationData> expectations = vData.addSuccessStatusCodes(null);
        expectations = vData.addExpectation(expectations, Constants.GET_LOGIN_PAGE, Constants.RESPONSE_FULL, Constants.STRING_CONTAINS, "Did Not get the OpenID Connect login page.", null, Constants.LOGIN_PROMPT);
        expectations = vData.addExpectation(expectations, Constants.LOGIN_USER, Constants.RESPONSE_FULL, Constants.STRING_CONTAINS, "Did Not get Consent Form ", null, Constants.APPROVAL_HEADER);
    ...
    public void OidcClientTestHttpRedirectUrl() throws Exception {
        ...
        TestSettings updatedTestSettings = testSettings.copyTestSettings();
        updatedTestSettings.setTestURL(updatedTestSettings.getTestURL().replace(Constants.DEFAULT_SERVLET, "simple/httpRedirect"));
    ...
    public void OidcClientTestHTTPWithHttpsTrue() throws Exception {
        ...
        String HttpUrl = testRPServer.getHttpString() + "/" + Constants.OPENID_APP + "/" + "simple/httpsTrue";
    ...
    public void OidcClientTestHTTPWithDefaultHttps() throws Exception {
        ...
        TestSettings newSettings = testSettings.copyTestSettings();
        String HttpUrl = testRPServer.getHttpString() + "/" + Constants.OPENID_APP + "/" + "simple/defaultRedirect";
        newSettings.setTestURL(HttpUrl);
    ...
    public void OidcClientSSLTestNoRedirectInRP() throws Exception {
        ...
        TestSettings updatedTestSettings = testSettings.copyTestSettings();
        updatedTestSettings.setScope("openid profile");
        updatedTestSettings.setTestURL(updatedTestSettings.getTestURL().replace(Constants.DEFAULT_SERVLET, "simple/redirectSSL"));
    ...
    public void OidcClientSSLTestConsentForm() throws Exception {
        ...
        TestSettings updatedTestSettings = testSettings.copyTestSettings();
        updatedTestSettings.setScope("openid profile");
        updatedTestSettings.setTestURL(updatedTestSettings.getTestURL().replace(Constants.DEFAULT_SERVLET, "simple/SSLConsent"));
    ...
    public void OidcClientTestNoOpenidScope() throws Exception {
        ...
        TestSettings updatedTestSettings = testSettings.copyTestSettings();
        updatedTestSettings.setScope("openid profile");
        updatedTestSettings.setTestURL(updatedTestSettings.getTestURL().replace(Constants.DEFAULT_SERVLET, "simple/NoOpenidScope"));
    ...
    public void OidcClientTestBadClientSecret() throws Exception {
        ...
        TestSettings updatedTestSettings = testSettings.copyTestSettings();
        updatedTestSettings.setScope("openid profile");
        updatedTestSettings.setTestURL(updatedTestSettings.getTestURL().replace(Constants.DEFAULT_SERVLET, "simple/badClientSecret"));
        ...
        testRPServer.addIgnoredServerExceptions("CWWKS1708E", "SRVE8094W", "SRVE8115W");
    ...
    public void OidcClientTestSSLHttpsFalse() throws Exception {
        ...
        TestSettings updatedTestSettings = testSettings.copyTestSettings();
        updatedTestSettings.setScope("openid profile");
        updatedTestSettings.setTestURL(updatedTestSettings.getTestURL().replace(Constants.DEFAULT_SERVLET, "simple/sslHttpsFalse"));
    ...
    public void OidcClientTestSSLHttpsTrue() throws Exception {
        ...
        TestSettings updatedTestSettings = testSettings.copyTestSettings();
        updatedTestSettings.setScope("openid profile");
        updatedTestSettings.setTestURL(updatedTestSettings.getTestURL().replace(Constants.DEFAULT_SERVLET, "simple/sslHttpsTrue"));
    ...
    public void OidcClientTestSigAlgNone_clientSecretConfigured() throws Exception {
        ...
        updatedTestSettings.setTestURL(updatedTestSettings.getTestURL().replace(Constants.DEFAULT_SERVLET, "simple/SigAlgNoneWithSecret"));
    ...
    public void OidcClientTestSigAlgNone_clientSecretNotConfigured() throws Exception {
        ...
        updatedTestSettings.setNonce(Constants.EXIST_WITH_ANY_VALUE);
        updatedTestSettings.setState(Constants.EXIST_WITH_ANY_VALUE);
        updatedTestSettings.setTestURL(updatedTestSettings.getTestURL().replace(Constants.DEFAULT_SERVLET, "simple/SigAlgNoneWithoutSecret"));
    ...
    public void OidcClientTestSigAlgHS256() throws Exception {
        ...
        updatedTestSettings.setTestURL(updatedTestSettings.getTestURL().replace(Constants.DEFAULT_SERVLET, "simple/SigAlgHS256"));
    ...
    public void OidcClientTestSigAlgMisMatch1() throws Exception {
        ...
        updatedTestSettings.setScope("openid profile");
        updatedTestSettings.setSignatureAlg(Constants.SIGALG_NONE);
        updatedTestSettings.setTestURL(updatedTestSettings.getTestURL().replace(Constants.DEFAULT_SERVLET, "simple/MisMatchSigAlgHS256"));
    ...
    public void OidcClientTestSigAlgMisMatch2() throws Exception {
        ...
        updatedTestSettings.setNonce(Constants.EXIST_WITH_ANY_VALUE);
        updatedTestSettings.setState(Constants.EXIST_WITH_ANY_VALUE);
        updatedTestSettings.setTestURL(updatedTestSettings.getTestURL().replace(Constants.DEFAULT_SERVLET, "simple/MisMatchSigAlgNoneWithSecret"));
    ...
    public void OidcClientTestMainPath_VerifyNoPasswordInClearTextInTrace() throws Exception {
        ...
        updatedTestSettings.setScope("openid profile");
        updatedTestSettings.setTestURL(updatedTestSettings.getTestURL().replace(Constants.DEFAULT_SERVLET, "simple/pwdTest"));
    ...
    public void OidcClientTestBadClientIDInRPConfig() throws Exception {
        ...
        TestSettings updatedTestSettings = testSettings.copyTestSettings();
        updatedTestSettings.setTestURL(updatedTestSettings.getTestURL().replace(Constants.DEFAULT_SERVLET, "simple/badClientId"));
    ...
    public void OidcClientTestBadRedirectURIOPConfig() throws Exception {
        ...
        TestSettings updatedTestSettings = testSettings.copyTestSettings();
        updatedTestSettings.setTestURL(updatedTestSettings.getTestURL().replace(Constants.DEFAULT_SERVLET, "simple/SSLBadRedirectInOp"));
        ...
        expectations = vData.addExpectation(expectations, Constants.GET_LOGIN_PAGE, testOPServer, Constants.MESSAGES_LOG, Constants.STRING_CONTAINS,
                "Did not get a message in OP messages.log indicating the provider could not redirect the request because the redirect URI is not valid.", null, "CWOAU0056E:.*/badRedirectInOP");
        genericRP(_testName, wc, updatedTestSettings, test_LOGIN_PAGE_ONLY, expectations);
    ...
    public void OidcClientTestClientDisabledInOPConfig() throws Exception {
        ...
        TestSettings updatedTestSettings = testSettings.copyTestSettings();
        updatedTestSettings.setTestURL(updatedTestSettings.getTestURL().replace(Constants.DEFAULT_SERVLET, "simple/disabledClient"));
    ...
    public void OidcClientTestBadClientSharedKeyInRPConfig() throws Exception {
        ...
        updatedTestSettings.setScope("openid profile");
        updatedTestSettings.addRequestParms();
        updatedTestSettings.setTestURL(updatedTestSettings.getTestURL().replace(Constants.DEFAULT_SERVLET, "simple/badSharedKey"));
