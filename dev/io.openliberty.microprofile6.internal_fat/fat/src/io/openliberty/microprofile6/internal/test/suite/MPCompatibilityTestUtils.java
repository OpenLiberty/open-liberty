...
public class MPCompatibilityTestUtils {
    ...
    protected static void cleanUp(LibertyServer server) throws Exception {
        cleanUp(server, "CWMOT0010W"); //CWMOT0010W: OpenTracing cannot track JAX-RS requests because an OpentracingTracerFactory class was not provided or client libraries for tracing backend are not in the class path.
    }

    protected static void cleanUp(LibertyServer server, String... expectedFailures) throws Exception {
