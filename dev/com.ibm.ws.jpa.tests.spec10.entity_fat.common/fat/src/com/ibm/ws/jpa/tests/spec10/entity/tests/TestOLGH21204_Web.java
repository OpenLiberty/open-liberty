...
@Mode(TestMode.LITE)
public class TestOLGH21204_Web extends JPAFATServletClient {

    @Rule
    public static SkipRule skipRule = new SkipRule();

    private final static String CONTEXT_ROOT = "olgh21204Web";
    private final static String RESOURCE_ROOT = "test-applications/olgh21204/";
    private final static String appFolder = "web";
    private final static String appName = "olgh21204Web";
    ...
    @TestServlets({
                    @TestServlet(servlet = TestOLGH21204Servlet.class, path = CONTEXT_ROOT + "/" + "TestOLGH21204Servlet")
    })
    ...
    public static void setUp() throws Exception {
        ...
        bannerStart(TestOLGH21204_Web.class);
        ...
        System.out.println(TestOLGH21204_Web.class.getName() + " Setting up database tables...");
    ...
    private static void setupTestApplication() throws Exception {
        ...
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh21204.model");
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh21204.testlogic");
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh21204.web");
    ...
    public static void tearDown() throws Exception {
        try {
            ...
            bannerEnd(TestOLGH21204_Web.class, timestart);
        }
    }
}
