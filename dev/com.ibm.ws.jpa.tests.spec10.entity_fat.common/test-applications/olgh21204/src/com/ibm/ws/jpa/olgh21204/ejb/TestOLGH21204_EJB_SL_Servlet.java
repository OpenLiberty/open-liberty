...
public class TestOLGH21204_EJB_SL_Servlet extends EJBDBTestVehicleServlet {
    ...
    @Test
    public void jpa_spec10_query_olgh21204_testPersistWithSecondaryTables_EJB_SL_AMJTA_Web() throws Exception {
        final String testName = "jpa10_query_olgh21204_testPersistWithSecondaryTables_EJB_SL_AMJTA_Web";
    ...
    @Test
    public void jpa_spec10_query_olgh21204_testPersistWithSecondaryTables_EJB_SL_AMRL_Web() throws Exception {
        final String testName = "jpa10_query_olgh21204_testPersistWithSecondaryTables_EJB_SL_AMRL_Web";
        final String testMethod = "testPersistWithSecondaryTables";
        final String testResource = "test-jpa-resource-amrl";
        executeTest(testName, testMethod, testResource);
    }
    ...
    @Test
    public void jpa_spec10_query_olgh21204_testPersistWithSecondaryTables_EJB_SL_CMTS_Web() throws Exception {
        final String testName = "jpa10_query_olgh21204_testPersistWithSecondaryTables_EJB_SL_CMTS_Web";
        final String testMethod = "testPersistWithSecondaryTables";
        final String testResource = "test-jpa-resource-cmts";
        executeTest(testName, testMethod, testResource);
    }
