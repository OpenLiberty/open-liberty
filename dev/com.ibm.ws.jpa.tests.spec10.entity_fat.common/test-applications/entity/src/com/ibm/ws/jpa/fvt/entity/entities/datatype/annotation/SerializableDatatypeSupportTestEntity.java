...
@Entity
@Table(name = "SerialDatatypeSupTE")
@SuppressWarnings("serial")
public class SerializableDatatypeSupportTestEntity implements IDatatypeSupportTestEntity, java.io.Serializable {
    @Id
    private int id;
    ...
    public SerializableDatatypeSupportTestEntity() {
        transientString = "";
    }
    ...
    public String toString() {
        return "SerializableDatatypeSupportTestEntity [id=" + id + "]";
    }
