...
public class XMLDatatypeSupportPropertyTestEntity implements IDatatypeSupportTestEntity {
    private int id;
    ...
    public XMLDatatypeSupportPropertyTestEntity() {
        transientString = "";
    }
    ...
    public String toString() {
        return "XMLDatatypeSupportPropertyTestEntity [id=" + id + "]";
    }
}
