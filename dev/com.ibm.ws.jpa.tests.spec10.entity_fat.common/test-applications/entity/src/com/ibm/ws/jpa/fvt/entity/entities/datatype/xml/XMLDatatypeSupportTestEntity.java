...
public class XMLDatatypeSupportTestEntity implements IDatatypeSupportTestEntity {
    private int id;
    ...
    public XMLDatatypeSupportTestEntity() {
        transientString = "";
    }
    ...
    public String toString() {
        return "XMLDatatypeSupportTestEntity [id=" + id + "]";
    }
}
