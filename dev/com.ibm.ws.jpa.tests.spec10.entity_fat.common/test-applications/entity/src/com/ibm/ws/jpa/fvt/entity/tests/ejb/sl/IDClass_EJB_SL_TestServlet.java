...
@WebServlet(urlPatterns = "/IDClass_EJB_SL_TestServlet")
public class IDClass_EJB_SL_TestServlet extends EJBDBTestVehicleServlet {
    @PostConstruct
    ...
    @Test
    public void jpa10_Entity_IDClass_Ano_AMJTA_EJB_SL() throws Exception {
        final String testName = "jpa10_Entity_IDClass_Ano_AMJTA_EJB_SL";
    ...
    @Test
    public void jpa10_Entity_IDClass_XML_AMJTA_EJB_SL() throws Exception {
        final String testName = "jpa10_Entity_IDClass_XML_AMJTA_EJB_SL";
        final String testMethod = "testIDClass001";
        final String testResource = "test-jpa-resource-amjta";
    ...
    @Test
    public void jpa10_Entity_IDClass_Ano_AMRL_EJB_SL() throws Exception {
        final String testName = "jpa10_Entity_IDClass_Ano_AMRL_EJB_SL";
        final String testMethod = "testIDClass001";
    ...
    @Test
    public void jpa10_Entity_IDClass_XML_AMRL_EJB_SL() throws Exception {
        final String testName = "jpa10_Entity_IDClass_XML_AMRL_EJB_SL";
        final String testMethod = "testIDClass001";
        final String testResource = "test-jpa-resource-amrl";
    ...
    @Test
    public void jpa10_Entity_IDClass_Ano_CMTS_EJB_SL() throws Exception {
        final String testName = "jpa10_Entity_IDClass_Ano_CMTS_EJB_SL";
        final String testMethod = "testIDClass001";
    ...
    @Test
    public void jpa10_Entity_IDClass_XML_CMTS_EJB_SL() throws Exception {
        final String testName = "jpa10_Entity_IDClass_XML_CMTS_EJB_SL";
        final String testMethod = "testIDClass001";
        final String testResource = "test-jpa-resource-cmts";
