...
@WebServlet(urlPatterns = "/ReadOnly_EJB_SF_TestServlet")
public class ReadOnly_EJB_SF_TestServlet extends EJBDBTestVehicleServlet {
    @PostConstruct
    ...
    @Test
    public void jpa10_Entity_ReadOnly_Ano_AMJTA_EJB_SF() throws Exception {
        final String testName = "jpa10_Entity_ReadOnly_Ano_AMJTA_EJB_SF";
    ...
    @Test
    public void jpa10_Entity_ReadOnly_XML_AMJTA_EJB_SF() throws Exception {
        final String testName = "jpa10_Entity_ReadOnly_XML_AMJTA_EJB_SF";
        final String testMethod = "testReadOnly001";
        final String testResource = "test-jpa-resource-amjta";
    ...
    @Test
    public void jpa10_Entity_ReadOnly_Ano_AMRL_EJB_SF() throws Exception {
        final String testName = "jpa10_Entity_ReadOnly_Ano_AMRL_EJB_SF";
        final String testMethod = "testReadOnly001";
    ...
    @Test
    public void jpa10_Entity_ReadOnly_XML_AMRL_EJB_SF() throws Exception {
        final String testName = "jpa10_Entity_ReadOnly_XML_AMRL_EJB_SF";
        final String testMethod = "testReadOnly001";
        final String testResource = "test-jpa-resource-amrl";
    ...
    @Test
    public void jpa10_Entity_ReadOnly_Ano_CMTS_EJB_SF() throws Exception {
        final String testName = "jpa10_Entity_ReadOnly_Ano_CMTS_EJB_SF";
        final String testMethod = "testReadOnly001";
    ...
    @Test
    public void jpa10_Entity_ReadOnly_XML_CMTS_EJB_SF() throws Exception {
        final String testName = "jpa10_Entity_ReadOnly_XML_CMTS_EJB_SF";
        final String testMethod = "testReadOnly001";
        final String testResource = "test-jpa-resource-cmts";
