...
package com.ibm.ws.jpa.fvt.entity.entities.datatype.annotation;
...
@Entity
@Table(name = "SerialDatatypeSupPropTE")
@SuppressWarnings("serial")
public class SerializableDatatypeSupportPropertyTestEntity implements IDatatypeSupportTestEntity, java.io.Serializable {
    private int id;
    ...
    public SerializableDatatypeSupportPropertyTestEntity() {
        transientString = "";
    }
    ...
    public String toString() {
        return "SerializableDatatypeSupportPropertyTestEntity [id=" + id + "]";
    }
