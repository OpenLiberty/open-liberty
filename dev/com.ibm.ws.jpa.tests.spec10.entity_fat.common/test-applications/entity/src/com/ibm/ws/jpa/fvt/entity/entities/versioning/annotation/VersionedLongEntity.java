...
@Entity
public class VersionedLongEntity implements IVersionedEntity {
    @Id
    private int id;
    ...
    public String toString() {
        return "VersionedLongEntity [id=" + id + ", version=" + version + ", intVal=" + intVal + ", stringVal="
               + stringVal + "]";
    }
}
