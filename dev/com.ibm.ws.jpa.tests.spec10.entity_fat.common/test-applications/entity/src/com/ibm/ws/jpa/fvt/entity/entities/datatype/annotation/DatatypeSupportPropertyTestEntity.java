...
@Entity
@Table(name = "DatatypeSupPropTestEntity")
public class DatatypeSupportPropertyTestEntity implements IDatatypeSupportTestEntity {
    private int id;
    ...
    public DatatypeSupportPropertyTestEntity() {
        transientString = "";
    }
    ...
    public String toString() {
        return "DatatypeSupportPropertyTestEntity [id=" + id + "]";
    }
}
