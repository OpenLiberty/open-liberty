...
public class SerializableXMLDatatypeSupportPropertyTestEntity implements IDatatypeSupportTestEntity, java.io.Serializable {
    private int id;
    ...
    public SerializableXMLDatatypeSupportPropertyTestEntity() {
        transientString = "";
    }
    ...
    public String toString() {
        return "SerializableXMLDatatypeSupportPropertyTestEntity [id=" + id + "]";
    }
