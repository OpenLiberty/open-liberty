CREATE TABLE ${schemaname}.SEQUENCE (SEQ_NAME VARCHAR(255) NOT NULL, SEQ_COUNT BIGINT, PRIMARY KEY (SEQ_NAME));
...
CREATE TABLE ${schemaname}.DatatypeSupPropTestEntity (id INTEGER NOT NULL, bigDecimalAttrDefault DECIMAL(19,2), bigIntegerAttrDefault DECIMAL(19,2), booleanAttrDefault BOOLEAN NOT NULL, booleanWrapperAttrDefault BOOLEAN, byteArrayAttrDefault BLOB, byteAttrDefault SMALLINT NOT NULL, byteWrapperArrayAttrDefault BLOB, byteWrapperAttrDefault SMALLINT, charArrayAttrDefault CLOB(255), charAttrDefault CHAR(1) NOT NULL, charWrapperArrayAttrDefault CLOB(255), characterWrapperAttrDefault CHAR(1), doubleAttrDefault DOUBLE NOT NULL, doubleWrapperAttrDefault DOUBLE, enumeration SMALLINT, floatAttrDefault REAL NOT NULL, floatWrapperAttrDefault REAL, intAttrDefault INTEGER NOT NULL, integerWrapperAttrDefault INTEGER, longAttrDefault BIGINT NOT NULL, longWrapperAttrDefault BIGINT, serializableClass BLOB, shortAttrDefault SMALLINT NOT NULL, shortWrapperAttrDefault SMALLINT, sqlDateAttrDefault DATE, sqlTimeAttrDefault TIME, sqlTimestampAttrDefault TIMESTAMP, stringAttrDefault VARCHAR(255), utilCalendarAttrDefault DATE, utilDateAttrDefault DATE, PRIMARY KEY (id));
CREATE TABLE ${schemaname}.DatatypeSupTestEntity (id INTEGER NOT NULL, bigDecimalAttrDefault DECIMAL(19,2), bigIntegerAttrDefault DECIMAL(19,2), booleanAttrDefault BOOLEAN NOT NULL, booleanWrapperAttrDefault BOOLEAN, byteArrayAttrDefault BLOB, byteAttrDefault SMALLINT NOT NULL, byteWrapperArrayAttrDefault BLOB, byteWrapperAttrDefault SMALLINT, charArrayAttrDefault CLOB(255), charAttrDefault CHAR(1) NOT NULL, charWrapperArrayAttrDefault CLOB(255), characterWrapperAttrDefault CHAR(1), doubleAttrDefault DOUBLE NOT NULL, doubleWrapperAttrDefault DOUBLE, enumeration SMALLINT, floatAttrDefault REAL NOT NULL, floatWrapperAttrDefault REAL, intAttrDefault INTEGER NOT NULL, integerWrapperAttrDefault INTEGER, longAttrDefault BIGINT NOT NULL, longWrapperAttrDefault BIGINT, serializableClass VARCHAR(255) for bit data, shortAttrDefault SMALLINT NOT NULL, shortWrapperAttrDefault SMALLINT, sqlDateAttrDefault DATE, sqlTimeAttrDefault TIME, sqlTimestampAttrDefault TIMESTAMP, stringAttrDefault VARCHAR(255), utilCalendarAttrDefault DATE, utilDateAttrDefault DATE, PRIMARY KEY (id));
...
CREATE TABLE ${schemaname}.XMLDatatypeSupPropTestEntity (id INTEGER NOT NULL, bigDecimalAttrDefault DECIMAL(19,2), bigIntegerAttrDefault DECIMAL(19,2), booleanAttrDefault BOOLEAN NOT NULL, booleanWrapperAttrDefault BOOLEAN, byteArrayAttrDefault VARCHAR(255) for bit data, byteAttrDefault SMALLINT NOT NULL, byteWrapperArrayAttrDefault VARCHAR(255) for bit data, byteWrapperAttrDefault SMALLINT, charArrayAttrDefault VARCHAR(255), charAttrDefault CHAR(1) NOT NULL, charWrapperArrayAttrDefault VARCHAR(255), characterWrapperAttrDefault CHAR(1), doubleAttrDefault DOUBLE NOT NULL, doubleWrapperAttrDefault DOUBLE, enumeration INTEGER, floatAttrDefault FLOAT NOT NULL, floatWrapperAttrDefault FLOAT, intAttrDefault INTEGER NOT NULL, integerWrapperAttrDefault INTEGER, longAttrDefault BIGINT NOT NULL, longWrapperAttrDefault BIGINT, serializableClass BLOB, shortAttrDefault SMALLINT NOT NULL, shortWrapperAttrDefault SMALLINT, sqlDateAttrDefault DATE, sqlTimeAttrDefault TIME, sqlTimestampAttrDefault TIMESTAMP, stringAttrDefault VARCHAR(255), utilCalendarAttrDefault DATE, utilDateAttrDefault DATE, PRIMARY KEY (id));
...
CREATE TABLE ${schemaname}.XMLEmbeddedObjectAOEntity (id INTEGER NOT NULL, localIntVal INTEGER, localStrVal VARCHAR(255), booleanVal BOOLEAN NOT NULL, byteVal SMALLINT, charVal CHAR(254), doubleVal DOUBLE, floatVal REAL, intValCol INTEGER, longValCol BIGINT, shortVal SMALLINT, stringVal VARCHAR(255), PRIMARY KEY (id));
CREATE TABLE ${schemaname}.XMLEmbeddedObjectEntity (id INTEGER NOT NULL, localIntVal INTEGER, localStrVal VARCHAR(255), booleanVal BOOLEAN NOT NULL, byteVal SMALLINT, charVal CHAR(254), doubleVal DOUBLE, floatVal REAL, intVal INTEGER, longVal BIGINT, shortVal SMALLINT, stringVal VARCHAR(255), PRIMARY KEY (id));
...
CREATE TABLE ${schemaname}.XMLSerialDatatypeSupPropTE (id INTEGER NOT NULL, bigDecimalAttrDefault DECIMAL(12,6), bigIntegerAttrDefault BIGINT, booleanAttrDefault SMALLINT, booleanWrapperAttrDefault SMALLINT, byteArrayAttrDefault VARCHAR(255) for bit data, byteAttrDefault SMALLINT, byteWrapperArrayAttrDefault VARCHAR(255) for bit data, byteWrapperAttrDefault SMALLINT, charArrayAttrDefault VARCHAR(255), charAttrDefault CHAR(1), charWrapperArrayAttrDefault VARCHAR(255), characterWrapperAttrDefault CHAR(1), doubleAttrDefault DOUBLE, doubleWrapperAttrDefault DOUBLE, enumeration SMALLINT, floatAttrDefault REAL, floatWrapperAttrDefault REAL, intAttrDefault INTEGER, integerWrapperAttrDefault INTEGER, longAttrDefault BIGINT, longWrapperAttrDefault BIGINT, serializableClass BLOB, shortAttrDefault SMALLINT, shortWrapperAttrDefault SMALLINT, sqlDateAttrDefault DATE, sqlTimeAttrDefault TIME, sqlTimestampAttrDefault TIMESTAMP, stringAttrDefault VARCHAR(255), utilCalendarAttrDefault DATE, utilDateAttrDefault DATE, PRIMARY KEY (id));
