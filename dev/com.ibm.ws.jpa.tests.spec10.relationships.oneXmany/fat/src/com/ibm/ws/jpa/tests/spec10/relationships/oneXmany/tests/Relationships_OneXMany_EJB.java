...
public class Relationships_OneXMany_EJB extends JPAFATServletClient {
    private final static String CONTEXT_ROOT = "OneXMany10EJB";
    ...
    private final static String appName = "oneXmanyejb";
    ...
    @TestServlets({
                    @TestServlet(servlet = TestOneXManyUnidirectional_EJB_SL_Servlet.class, path = CONTEXT_ROOT + "/" + "TestOneXManyUnidirectional_EJB_SL_Servlet"),
                    @TestServlet(servlet = TestOneXManyUnidirectional_EJB_SF_Servlet.class, path = CONTEXT_ROOT + "/" + "TestOneXManyUnidirectional_EJB_SF_Servlet"),
                    @TestServlet(servlet = TestOneXManyUnidirectional_EJB_SFEX_Servlet.class, path = CONTEXT_ROOT + "/" + "TestOneXManyUnidirectional_EJB_SFEX_Servlet"),
                    @TestServlet(servlet = TestOneXManyCollectionType_EJB_SL_Servlet.class, path = CONTEXT_ROOT + "/" + "TestOneXManyCollectionType_EJB_SL_Servlet"),
                    @TestServlet(servlet = TestOneXManyCollectionType_EJB_SF_Servlet.class, path = CONTEXT_ROOT + "/" + "TestOneXManyCollectionType_EJB_SF_Servlet"),
                    @TestServlet(servlet = TestOneXManyCollectionType_EJB_SFEX_Servlet.class, path = CONTEXT_ROOT + "/" + "TestOneXManyCollectionType_EJB_SFEX_Servlet"),
                    @TestServlet(servlet = TestOneXManyCompoundPK_EJB_SL_Servlet.class, path = CONTEXT_ROOT + "/" + "TestOneXManyCompoundPK_EJB_SL_Servlet"),
                    @TestServlet(servlet = TestOneXManyCompoundPK_EJB_SF_Servlet.class, path = CONTEXT_ROOT + "/" + "TestOneXManyCompoundPK_EJB_SF_Servlet"),
                    @TestServlet(servlet = TestOneXManyCompoundPK_EJB_SFEX_Servlet.class, path = CONTEXT_ROOT + "/" + "TestOneXManyCompoundPK_EJB_SFEX_Servlet")
    })
