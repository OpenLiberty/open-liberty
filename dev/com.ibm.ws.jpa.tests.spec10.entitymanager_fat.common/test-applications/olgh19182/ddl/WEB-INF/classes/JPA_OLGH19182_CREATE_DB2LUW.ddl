CREATE TABLE ${schemaname}.HelmetEntityOLGH19182 (id INTEGER NOT NULL, color VARCHAR(254), SHELF_ID BIGINT, PRIMARY KEY (id));
...
CREATE TABLE ${schemaname}.JPA_HELMET_PROPERTIES (HELMET_ID INTEGER, PROPERTY_NAME VARCHAR(254) NOT NULL, PROPERTY_VALUE VARCHAR(254));
CREATE TABLE ${schemaname}.ShelfEntityOLGH19182 (id BIGINT NOT NULL, name VARCHAR(254), PRIMARY KEY (id));
