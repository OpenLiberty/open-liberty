...
import com.ibm.ws.jpa.olgh19182.web.TestOLGH19182Servlet;
...
public class TestOLGH19182_Web extends JPAFATServletClient {
    ...
    @TestServlets({
                    @TestServlet(servlet = TestOLGH19182Servlet.class, path = CONTEXT_ROOT + "/" + "TestOLGH19182Servlet")
    })
    ...
    public static void setUp() throws Exception {
        ...
        bannerStart(TestOLGH19182_Web.class);
    ...
    private static void setupTestApplication() throws Exception {
        ...
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh19182.model");
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh19182.testlogic");
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh19182.web");
    ...
    public static void tearDown() throws Exception {
        try {
            ...
            bannerEnd(TestOLGH19182_Web.class, timestart);
        }
    }
}
