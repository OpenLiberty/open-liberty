...
public interface ConnectionManagerMBean {
     ...
     *            Priority may be <code>"immediate"</code>, <code>"abort"</code> or <code>"normal"</code>.
     *            Immediate purges the pool contents as quickly as possible but waits for transactions to complete,
     *            abort purges the pool by aborting connections without waiting for transactions to complete and
     *            normal purges the pool with normal priority.
