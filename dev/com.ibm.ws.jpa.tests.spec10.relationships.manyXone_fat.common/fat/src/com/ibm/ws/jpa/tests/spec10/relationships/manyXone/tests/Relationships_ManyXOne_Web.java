...
public class Relationships_ManyXOne_Web extends JPAFATServletClient {
    private final static String CONTEXT_ROOT = "ManyXOne10Web";
    ...
    private final static String appName = "manyXoneWeb";
    ...
    @TestServlets({
                    @TestServlet(servlet = TestManyXOneUnidirectionalServlet.class, path = CONTEXT_ROOT + "/" + "TestManyXOneUnidirectionalServlet"),
                    @TestServlet(servlet = TestManyXOneBidirectionalServlet.class, path = CONTEXT_ROOT + "/" + "TestManyXOneBidirectionalServlet"),
                    @TestServlet(servlet = TestManyXOneCompoundPKServlet.class, path = CONTEXT_ROOT + "/" + "TestManyXOneCompoundPKServlet")
    })
