...
public class ConnDefsAnn1 extends ManagedConnectionFactoryBase implements javax.resource.spi.ManagedConnectionFactory {

    private static final String className = "ConnDefsAnn1";

    private static final TraceComponent tc = Tr.register(ConnDefsAnn1.class, SimpleRAImpl.RAS_GROUP, null);
