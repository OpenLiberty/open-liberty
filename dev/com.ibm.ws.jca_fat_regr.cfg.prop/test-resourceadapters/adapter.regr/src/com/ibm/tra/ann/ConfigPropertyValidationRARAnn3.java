...
public class ConfigPropertyValidationRARAnn3 implements ResourceAdapter, Serializable {

    static final String className = ConfigPropertyValidationRARAnn3.class.getName();
