...
import com.ibm.ws.jpa.pxml22.PersistenceUnitCachingType;
import com.ibm.ws.jpa.pxml22.PersistenceUnitValidationModeType;

public class JaxbPUnit22 extends JaxbPUnit {
    private static final String CLASS_NAME = JaxbPUnit22.class.getName();
    private static final TraceComponent tc = Tr.register(JaxbPUnit22.class, JPA_TRACE_GROUP, JPA_RESOURCE_BUNDLE_NAME);

    private final PersistenceUnit ivPUnit;

    /**
     * Constructs a JaxbPUnit22 instance with the JAXB PersistenceUnit instance for which the
     * created instance will provide an abstraction.
     **/
    JaxbPUnit22(PersistenceUnit pUnit) {
        if (pUnit == null) {
    ...
    public SharedCacheMode getSharedCacheMode() {
        ...
        // in JAXB (com.ibm.ws.jpa.pxml22.PersistenceUnitCachingType)
    ...
    public ValidationMode getValidationMode() {
        ...
        // in JAXB (com.ibm.ws.jpa.pxml22.PersistenceUnitValidationModeType)
    ...
    public Properties getProperties() {
        ...
        // (com.ibm.ws.jpa.pxml22.Persistence.PersistenceUnit.Properties)
        // to standard JDK classes (java.util.Properties).

        com.ibm.ws.jpa.pxml22.Persistence.PersistenceUnit.Properties puProperties = ivPUnit.getProperties();

        if (puProperties != null) {
            List<com.ibm.ws.jpa.pxml22.Persistence.PersistenceUnit.Properties.Property> propertyList = puProperties.getProperty();
            if (propertyList != null && !propertyList.isEmpty()) {
                rtnProperties = new Properties();
                for (com.ibm.ws.jpa.pxml22.Persistence.PersistenceUnit.Properties.Property puProperty : propertyList) {
    ...
    public PersistenceUnitTransactionType getTransactionType() {
        ...
        // (com.ibm.ws.jpa.pxml22.PersistenceUnitTransactionType) to JPA
        // (javax.persistence.spi.PersistenceUnitTransactionType).

        PersistenceUnitTransactionType rtnType = null;
        com.ibm.ws.jpa.pxml22.PersistenceUnitTransactionType jaxbType = null;

        jaxbType = ivPUnit.getTransactionType();
        if (jaxbType == com.ibm.ws.jpa.pxml22.PersistenceUnitTransactionType.JTA) {
            rtnType = PersistenceUnitTransactionType.JTA;
        } else if (jaxbType == com.ibm.ws.jpa.pxml22.PersistenceUnitTransactionType.RESOURCE_LOCAL) {
