...
/**
 * Provides the persistence-unit abstraction for a Jakarta Persistence 4.0 descriptor.
 *
 */
public class JaxbPUnit40 extends JaxbPUnit {
    ...
    public SharedCacheMode getSharedCacheMode() {
        ...
        // in JAXB (com.ibm.ws.jpa.pxml40.PersistenceUnitCachingType)
     ...
     *
     * @return the configured fetch type, defaulting to {@link FetchType#EAGER}
     */
    @Override
    public FetchType getDefaultToOneFetchType() {
        PersistenceUnitDefaultToOneFetchType fetchType = ivPUnit.getDefaultToOneFetchType();
        return fetchType == PersistenceUnitDefaultToOneFetchType.LAZY ? FetchType.LAZY : FetchType.EAGER;
    }
    ...
    public ValidationMode getValidationMode() {
        ...
        // in JAXB (com.ibm.ws.jpa.pxml40.PersistenceUnitValidationModeType)
    ...
    public Properties getProperties() {
        ...
        // (com.ibm.ws.jpa.pxml40.Persistence.PersistenceUnit.Properties)
    ...
    public PersistenceUnitTransactionType getTransactionType() {
        ...
        // (com.ibm.ws.jpa.pxml40.PersistenceUnitTransactionType) to JPA
        // (javax.persistence.spi.PersistenceUnitTransactionType).

        PersistenceUnitTransactionType rtnType = null;
        com.ibm.ws.jpa.pxml40.PersistenceUnitTransactionType jaxbType = null;
