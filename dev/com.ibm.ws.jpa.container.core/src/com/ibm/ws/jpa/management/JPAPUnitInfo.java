...
import static com.ibm.ws.jpa.management.JPAConstants.JPATRANSFORMER_TRACE_GROUP;
...
public abstract class JPAPUnitInfo implements PersistenceUnitInfo {
    ...
    private static final TraceComponent tcBytecodeCapture = Tr.register(CLASS_NAME + "_BytecodeCapture", JPAPUnitInfo.class, JPATRANSFORMER_TRACE_GROUP, JPA_RESOURCE_BUNDLE_NAME);
