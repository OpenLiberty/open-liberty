...
import com.ibm.ws.jpa.pxml32.Persistence.PersistenceUnit;
import com.ibm.ws.jpa.pxml32.PersistenceUnitCachingType;
import com.ibm.ws.jpa.pxml32.PersistenceUnitValidationModeType;

public class JaxbPUnit32 extends JaxbPUnit {
    private static final String CLASS_NAME = JaxbPUnit32.class.getName();
    private static final TraceComponent tc = Tr.register(JaxbPUnit32.class, JPA_TRACE_GROUP, JPA_RESOURCE_BUNDLE_NAME);

    private final PersistenceUnit ivPUnit;

    /**
     * Constructs a JaxbPUnit32 instance with the JAXB PersistenceUnit instance for which the
     * created instance will provide an abstraction.
     **/
    JaxbPUnit32(PersistenceUnit pUnit) {
        if (pUnit == null) {
    ...
    public SharedCacheMode getSharedCacheMode() {
        ...
        // in JAXB (com.ibm.ws.jpa.pxml32.PersistenceUnitCachingType)
    ...
    public ValidationMode getValidationMode() {
        ...
        // in JAXB (com.ibm.ws.jpa.pxml32.PersistenceUnitValidationModeType)
    ...
    public Properties getProperties() {
        ...
        // (com.ibm.ws.jpa.pxml32.Persistence.PersistenceUnit.Properties)
        // to standard JDK classes (java.util.Properties).

        com.ibm.ws.jpa.pxml32.Persistence.PersistenceUnit.Properties puProperties = ivPUnit.getProperties();

        if (puProperties != null) {
            List<com.ibm.ws.jpa.pxml32.Persistence.PersistenceUnit.Properties.Property> propertyList = puProperties.getProperty();
            if (propertyList != null && !propertyList.isEmpty()) {
                rtnProperties = new Properties();
                for (com.ibm.ws.jpa.pxml32.Persistence.PersistenceUnit.Properties.Property puProperty : propertyList) {
    ...
    public PersistenceUnitTransactionType getTransactionType() {
        ...
        // (com.ibm.ws.jpa.pxml32.PersistenceUnitTransactionType) to JPA
        // (javax.persistence.spi.PersistenceUnitTransactionType).

        PersistenceUnitTransactionType rtnType = null;
        com.ibm.ws.jpa.pxml32.PersistenceUnitTransactionType jaxbType = null;

        jaxbType = ivPUnit.getTransactionType();
        if (jaxbType == com.ibm.ws.jpa.pxml32.PersistenceUnitTransactionType.JTA) {
            rtnType = PersistenceUnitTransactionType.JTA;
        } else if (jaxbType == com.ibm.ws.jpa.pxml32.PersistenceUnitTransactionType.RESOURCE_LOCAL) {
