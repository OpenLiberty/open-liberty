...
public final class TypeConverter
{
   ...
   public static boolean isConvertable(final Class<?> targetType)
   {
      ...
      try
      {
         getDeclaredMethod(targetType, VALUE_OF_METHOD, String.class); //Liberty change
         return true;
      }
      catch (NoSuchMethodException e)
      {
         try
         {
            getDeclaredConstructor(targetType, String.class); //Liberty change
            return true;
         }
         ...
         throws NoSuchMethodException
   {
      ...
      try
      {
         ...
         Method valueOf = getDeclaredMethod(actualTarget, VALUE_OF_METHOD, String.class); //Liberty change
   ...
   private static <T> T getTypeViaStringConstructor(String source, Class<T> targetType)
   {
      ...
      try
      {
         c = getDeclaredConstructor(targetType, String.class); //Liberty change
      }
      catch (NoSuchMethodException e)
      {
