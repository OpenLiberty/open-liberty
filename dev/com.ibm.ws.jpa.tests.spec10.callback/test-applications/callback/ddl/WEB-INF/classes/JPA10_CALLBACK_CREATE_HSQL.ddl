CREATE TABLE ${schemaname}.CALLBACKENTITY (id INTEGER NOT NULL, name VARCHAR(255), protectionType VARCHAR(31), PRIMARY KEY (id)); 
CREATE INDEX ${schemaname}.I_CLLBTTY_DTYPE ON ${schemaname}.CALLBACKENTITY (protectionType);
CREATE TABLE ${schemaname}.OOIRootEntity (id INTEGER NOT NULL, name VARCHAR(255), leafType VARCHAR(31), PRIMARY KEY (id));
