...
public class AnoCallbackListenerPublic extends AbstractCallbackListener {
    private static final AnoCallbackListenerPublic _singleton = new AnoCallbackListenerPublic();
