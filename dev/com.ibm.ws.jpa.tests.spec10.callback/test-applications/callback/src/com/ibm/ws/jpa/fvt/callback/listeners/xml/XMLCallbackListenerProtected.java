...
public class XMLCallbackListenerProtected extends AbstractCallbackListener {
    private static final XMLCallbackListenerProtected _singleton = new XMLCallbackListenerProtected();
