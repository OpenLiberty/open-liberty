...
public class XMLCallbackListenerPublic extends AbstractCallbackListener {
    private static final XMLCallbackListenerPublic _singleton = new XMLCallbackListenerPublic();
