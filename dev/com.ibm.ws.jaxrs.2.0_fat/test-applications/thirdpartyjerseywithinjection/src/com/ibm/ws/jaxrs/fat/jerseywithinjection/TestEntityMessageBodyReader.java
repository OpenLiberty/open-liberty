...
public class TestEntityMessageBodyReader implements MessageBodyReader<TestEntity> {
    ...
    public boolean isReadable(Class<?> type, Type genericType, Annotation[] annotations,
                              MediaType mediaType) {
        System.out.println("TestEntityMessageBodyReader(isReadable) - injectableObject=" + injectableObject.getSomething());
    ...
    public TestEntity readFrom(Class<TestEntity> type, Type genericType, Annotation[] annotations,
        ...
        System.out.println("TestEntityMessageBodyReader(readFrom)");
