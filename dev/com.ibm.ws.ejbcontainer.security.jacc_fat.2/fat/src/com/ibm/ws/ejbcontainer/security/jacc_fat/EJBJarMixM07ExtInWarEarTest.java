...
public class EJBJarMixM07ExtInWarEarTest extends EJBJarMixM07ExtBase {

    protected static Class<?> logClass = EJBJarMixM07ExtInWarEarTest.class;

    @Rule
    public TestName name = new TestName();

    @ClassRule
    public static RepeatTests r = FATSuite.defaultRepeat(Constants.SERVER_EJBJAR_INWAR);
    ...
    public static void setUp() throws Exception {
        ...
        commonSetup(logClass, Constants.SERVER_EJBJAR_INWAR,
                    Constants.APPLICATION_SECURITY_EJB_JAR_INWAR_EAR_M07, Constants.SERVLET_SECURITY_EJBXML, Constants.CONTEXT_ROOT_SECURITY_EJB_JAR_INWAR_EAR_M07);
