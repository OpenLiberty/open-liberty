 ...
 *
 * UPDATE: For JACC we are not going to run the PureAnnTestBase tests
 *
 */

@Mode(TestMode.FULL)
@RunWith(FATRunner.class)
public class PureAnnMergeConflictXMLBindingsTest extends EJBAnnTestBase {

    protected static Class<?> logClass = PureAnnMergeConflictXMLBindingsTest.class;
    ...
    public static void setUp() throws Exception {
        ...
        commonSetup(logClass, Constants.SERVER_EJB_MERGE_BINDINGS,
                    Constants.APPLICATION_SECURITY_EJB_XML_MERGE, Constants.SERVLET_SECURITY_EJB, Constants.CONTEXT_ROOT_SECURITY_EJB_XML_MERGE);
