...
public class PureAnnAppBndXMLBindingsTest extends EJBAnnTestBase {

    protected static Class<?> logClass = PureAnnAppBndXMLBindingsTest.class;

    @Rule
    public TestName name = new TestName();

    @ClassRule
    public static RepeatTests r = FATSuite.defaultRepeat(Constants.SERVER_EJB_BINDINGS);
    ...
    public static void setUp() throws Exception {
        ...
        commonSetup(logClass, Constants.SERVER_EJB_BINDINGS,
                    Constants.APPLICATION_SECURITY_EJB_XML, Constants.SERVLET_SECURITY_EJB, Constants.CONTEXT_ROOT_SECURITY_EJB_XML);
     ...
     * <P> Expected Results:
     * <OL>
     * <LI> isCallerInRole will return false for all users.
     * <LI>
     * </OL>
     */
    @Test
