 ...
 * with security constraints in annotations, ejb-jar.xml and ibm-ejb-jar-ext.xml files.
 *
...
public class EJBJarMixExtMergeConflictXMLBindingsTest extends EJBJarMixM07ExtBase {

    protected static Class<?> logClass = EJBJarMixExtMergeConflictXMLBindingsTest.class;

    @Rule
    public TestName name = new TestName();

    @ClassRule
    public static RepeatTests r = FATSuite.defaultRepeat(Constants.SERVER_EJBJAR_MERGE_BINDINGS);

    @BeforeClass
    public static void setUp() throws Exception {

        commonSetup(logClass, Constants.SERVER_EJBJAR_MERGE_BINDINGS,
                    Constants.APPLICATION_SECURITY_EJB_JAR_XMLMERGE, Constants.SERVLET_SECURITY_EJBXML, Constants.CONTEXT_ROOT_SECURITY_EJB_JAR_XMLMERGE);
