...
/**
 * Performs testing where metadata-complete is specified in ejb-jar.xml such that all annotations
 ...
 * The annotations specified at class level is @DenyAll with a mix of annotations at
 ...
 *
 * This test invokes Stateless SecurityEJBM06Bean methods with a variety of method signatures to insure that
 * annotations are processed correctly with methods of the same name and different signature.
 */
@Mode(TestMode.FULL)
@RunWith(FATRunner.class)
public class EJBJarMixMC06InWarTest extends EJBJarMixMC06Base {

    protected static Class<?> logClass = EJBJarMixMC06InWarTest.class;

    @Rule
    public TestName name = new TestName();

    @ClassRule
    public static RepeatTests r = FATSuite.defaultRepeat(Constants.SERVER_EJBJAR_MC);
    ...
    public static void setUp() throws Exception {
        ...
        commonSetup(logClass, Constants.SERVER_EJBJAR_MC,
                    Constants.APPLICATION_SECURITY_EJB_JAR_INSTANDALONE_MC06,
                    Constants.SERVLET_SECURITY_EJBMC, Constants.CONTEXT_ROOT_SECURITY_EJB_JAR_INSTANDALONE_MC06);
