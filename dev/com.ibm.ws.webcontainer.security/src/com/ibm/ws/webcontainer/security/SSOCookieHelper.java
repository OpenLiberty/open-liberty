...
public interface SSOCookieHelper {
    ...
    void addSSOCookiesToResponse(Subject subject, HttpServletRequest req, HttpServletResponse resp, String contextRoot, boolean useContextRoot);

    boolean addJwtSsoCookiesToResponse(Subject subject, HttpServletRequest req, HttpServletResponse resp, String contextRoot, boolean useContextRoot);
