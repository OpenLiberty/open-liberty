...
public class WebAppSecurityConfigImpl implements WebAppSecurityConfig {
    ...
    public static final String CFG_KEY_ADD_SSO_COOKIE_TO_RESPONSE_FOR_PROGRAMMATIC_JAAS_LOGIN = "addSsoCookieToResponseForProgrammaticJaasLogin";
    ...
    private final Boolean addSsoCookieToResponseForProgrammaticJaasLogin;
    ...
    static Map<String, String> configAttributes = new TreeMap<String, String>() {
        ...
        private static final long serialVersionUID = -6244999820664139565L;
        {
            ...
            put(CFG_KEY_ADD_SSO_COOKIE_TO_RESPONSE_FOR_PROGRAMMATIC_JAAS_LOGIN, "addSsoCookieToResponseForProgrammaticJaasLogin");
        }
    };
    ...
    public WebAppSecurityConfigImpl(Map<String, Object> newProperties,
        ...
        addSsoCookieToResponseForProgrammaticJaasLogin = (Boolean) newProperties.get(CFG_KEY_ADD_SSO_COOKIE_TO_RESPONSE_FOR_PROGRAMMATIC_JAAS_LOGIN);
