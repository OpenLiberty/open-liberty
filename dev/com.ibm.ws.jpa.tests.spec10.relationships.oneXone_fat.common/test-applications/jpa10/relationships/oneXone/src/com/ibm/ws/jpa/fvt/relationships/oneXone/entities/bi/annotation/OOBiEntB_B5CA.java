 ...
 */
@Entity
public class OOBiEntB_B5CA extends AbstractOneXOneBiEntityB {
    @OneToOne(mappedBy = "b5ca")
    private OOBiEntA entityA;

    public OOBiEntB_B5CA() {
        super();
    }

    public OOBiEntB_B5CA(int id, String name) {
        super(id, name);
    }
    ...
    public String toString() {
        return "OOBiEntB_B5CA [getId()=" + getId() + ", getName()=" + getName() + "]";
    }
}