...
/**
 * Implementation entity for the inverse side of the B2 bidirectional relationship defined on the entity BiEntityA.
 *
 */
public class XMLOOBiEntB_B2 extends XMLAbstractOneXOneBiEntityB {
    private XMLOOBiEntA entityA;

    public XMLOOBiEntB_B2() {
        super();
    }

    public XMLOOBiEntB_B2(int id, String name) {
        super(id, name);
    }
    ...
    public String toString() {
        return "XMLOOBiEntB_B2 [getId()=" + getId() + ", getName()=" + getName() + "]";
    }
