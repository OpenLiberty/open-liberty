...
public class TestOneXOneUnidirectionalServlet extends JPADBTestServlet {
    ...
    private final String testLogicClassName = OneXOneUnidirectionalTestLogic.class.getName();
