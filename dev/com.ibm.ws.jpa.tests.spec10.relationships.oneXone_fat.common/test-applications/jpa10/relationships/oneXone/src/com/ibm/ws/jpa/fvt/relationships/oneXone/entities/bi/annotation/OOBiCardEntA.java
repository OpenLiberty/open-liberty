 ...
 */
@Entity
public class OOBiCardEntA implements ICardinalEntityA {
    /**
    ...
    public OOBiCardEntB getB() {
        return b;
    }

    public void setB(OOBiCardEntB b) {
        this.b = b;
    }

    @Override
    public String toString() {
        return "OOBiCardEntA [id=" + id + ", name=" + name + "]";
    }
