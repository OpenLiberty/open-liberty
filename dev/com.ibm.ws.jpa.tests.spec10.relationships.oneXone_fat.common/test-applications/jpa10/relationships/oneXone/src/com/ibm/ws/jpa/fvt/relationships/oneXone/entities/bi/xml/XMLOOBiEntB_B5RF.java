 ...
 *
 */
public class XMLOOBiEntB_B5RF extends XMLAbstractOneXOneBiEntityB {
    private XMLOOBiEntA entityA;

    public XMLOOBiEntB_B5RF() {
        super();
    }

    public XMLOOBiEntB_B5RF(int id, String name) {
        super(id, name);
    }
    ...
    public String toString() {
        return "XMLOOBiEntB_B5RF [getId()=" + getId() + ", getName()=" + getName() + "]";
    }
}