 ...
 */
@Entity
public class OOBiEntB_B1 extends AbstractOneXOneBiEntityB {
    @OneToOne(mappedBy = "b1")
    ...
    public OOBiEntB_B1(int id, String name) {
        super(id, name);
    }
    ...
    public String toString() {
        return "OOBiEntB_B1 [getId()=" + getId() + ", getName()=" + getName() + "]";
    }
