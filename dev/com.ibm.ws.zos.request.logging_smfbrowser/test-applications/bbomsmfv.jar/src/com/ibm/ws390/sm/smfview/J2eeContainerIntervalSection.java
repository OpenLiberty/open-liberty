...
//------------------------------------------------------------------------------
/** Data container for SMF data related to a J2ee container interval. */
public class J2eeContainerIntervalSection extends SmfEntity {

    /** Supported version of this class. */
    public final static int s_supportedVersion = 2; // @MD17014C
    ...
    //----------------------------------------------------------------------------
    /**
     * J2eeContainerIntervalSection constructor from SmfStream.
     ...
     */
    public J2eeContainerIntervalSection(SmfStream aSmfStream, int aRequestedVersion) throws UnsupportedVersionException, UnsupportedEncodingException {
     ...
     *                           where this instance of J2eeContainerIntervalSection originates from.
     */
    public void dump(SmfPrintStream aPrintStream, int aTripletNumber) {

        aPrintStream.println("");
        aPrintStream.printKeyValue("Triplet #", aTripletNumber);
        aPrintStream.printlnKeyValue("Type", "J2eeContainerIntervalSection");
        ...
        // Write Server InstanceName out to summaryReport file.                //@SUa   
