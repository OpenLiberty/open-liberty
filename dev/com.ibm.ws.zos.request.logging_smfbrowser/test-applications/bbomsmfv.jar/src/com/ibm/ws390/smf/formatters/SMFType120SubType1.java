...
import com.ibm.ws390.sm.smfview.ServerActivitySmfRecord;
...
/**
 * Formats the SMF 120 Subtype 1 record
 *
 */
public class SMFType120SubType1 extends ServerActivitySmfRecord {
     ...
     */
    public SMFType120SubType1(SmfRecord smfRecord) throws UnsupportedVersionException, UnsupportedEncodingException {
        super(smfRecord);
