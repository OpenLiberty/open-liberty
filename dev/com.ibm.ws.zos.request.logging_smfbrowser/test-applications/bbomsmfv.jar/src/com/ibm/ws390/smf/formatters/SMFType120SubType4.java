...
import com.ibm.ws390.sm.smfview.ContainerIntervalSmfRecord;
...
/**
 * Formats the SMF 120 Subtype 4 record
 *
 */

public class SMFType120SubType4 extends ContainerIntervalSmfRecord {
    /**
     * Constructor
     * 
     ...
     */
    public SMFType120SubType4(SmfRecord smfRecord) throws UnsupportedVersionException, UnsupportedEncodingException {
        super(smfRecord);
