...
import com.ibm.ws390.sm.smfview.ContainerActivitySmfRecord;
...
/**
 * Formats the SMF 120 Subtype 2 record
 *
 */

public class SMFType120SubType2 extends ContainerActivitySmfRecord {
    /**
     * Constructor
     * 
     ...
     */
    public SMFType120SubType2(SmfRecord smfRecord) throws UnsupportedVersionException, UnsupportedEncodingException {
        super(smfRecord);
