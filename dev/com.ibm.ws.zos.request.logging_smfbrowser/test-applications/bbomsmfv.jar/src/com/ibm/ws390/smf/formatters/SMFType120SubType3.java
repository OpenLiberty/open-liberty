...
import com.ibm.ws390.sm.smfview.ServerIntervalSmfRecord;
...
/**
 * Formats the SMF 120 Subtype 3 record
 *
 */

public class SMFType120SubType3 extends ServerIntervalSmfRecord {
    /**
     * Constructor
     * 
     ...
     */
    public SMFType120SubType3(SmfRecord smfRecord) throws UnsupportedVersionException, UnsupportedEncodingException {
        super(smfRecord);
