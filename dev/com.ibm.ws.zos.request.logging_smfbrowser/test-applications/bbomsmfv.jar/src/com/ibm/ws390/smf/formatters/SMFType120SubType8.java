...
import com.ibm.ws390.sm.smfview.WebContainerIntervalSmfRecord;

/**
 * Formats the SMF 120 Subtype 8 record
 *
 */

public class SMFType120SubType8 extends WebContainerIntervalSmfRecord {
    /**
     * Constructor
     * 
     ...
     */
    public SMFType120SubType8(SmfRecord smfRecord) throws UnsupportedVersionException, UnsupportedEncodingException {
        super(smfRecord);
