...
public class KafkaOutgoingConnector implements OutgoingConnectorFactory {
    ...
    public SubscriberBuilder<Message<Object>, Void> getSubscriberBuilder(Config config) {
        ...
        producerConfig.put(KafkaConnectorConstants.KEY_SERIALIZER, KafkaConnectorConstants.DEFAULT_SERIALIZER);
        producerConfig.put(KafkaConnectorConstants.VALUE_SERIALIZER, KafkaConnectorConstants.DEFAULT_SERIALIZER);
