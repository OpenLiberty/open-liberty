 ...
 *******************************************************************************/
package com.ibm.ws.security.audit.reader.pqc;
...
/**
 * Runtime support for Post-Quantum Cryptography (PQC) algorithms for Audit Reader.
 * 
...
public class AuditPQCRuntimeSupport {
    ...
    private static final TraceComponent tc = Tr.register(AuditPQCRuntimeSupport.class, "AUDIT", "com.ibm.ws.security.audit.reader");
