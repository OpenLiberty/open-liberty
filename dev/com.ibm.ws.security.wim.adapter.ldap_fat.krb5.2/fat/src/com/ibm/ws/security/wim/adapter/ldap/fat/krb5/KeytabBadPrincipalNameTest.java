...
public class KeytabBadPrincipalNameTest extends CommonBindTest {
    ...
    public static void setStopMessages() {
        stopStrings = new String[] { "CWIML4508E", "CWIML4512E" };
    }

    /**
     * Run with a krb5Principal name that is not in the keytab, without and without a realm name and
    ...
    public void badPrincipalName() throws Exception {
        ...
        bodyOfBadPrincipleName(newServer, ldap, "CWIML4508E");
    }
