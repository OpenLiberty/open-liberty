 ...
 *******************************************************************************/
package io.openliberty.mpRestClient40.fat.multipart;
...
public class Util {
    ...
    static String getPartName(EntityPart part) {
        String contentDisposition = (String)(part.getHeaders().get("Content-Disposition").get(0));
    ...
    static String getFileName(EntityPart part) {
        String contentDisposition = (String)(part.getHeaders().get("Content-Disposition").get(0));
