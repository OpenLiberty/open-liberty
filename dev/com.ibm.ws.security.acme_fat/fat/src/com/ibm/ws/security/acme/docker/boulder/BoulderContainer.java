...
public class BoulderContainer extends CAContainer {
    ...
    /**
     * Container that runs the hardware security module.
     * Use the same Docker Image as the base container.
     */
    ...
    /**
     * Create and start a BoulderContainer. Use a custom docker image
     * built on top of boulder-tools-go.
     */
    ...
    protected void configure() {
            ...
            .withExposedPorts(getManagementPort(), getListenPort())
    ...
    public String getManagementAddress() {
        return "http://" + this.getContainerIpAddress() + ":" + this.getMappedPort(getManagementPort());
    }
    
    @Override
    public String getAcmeDirectoryURI(boolean usePebbleURI) {
        return "http://" + this.getContainerIpAddress() + ":" + this.getMappedPort(getListenPort()) + "/directory";
    }
