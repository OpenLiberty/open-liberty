...
public class EmbeddableLocalTranCoordImpl extends com.ibm.tx.ltc.impl.LocalTranCoordImpl implements SynchronizationRegistryUOWScope {
    private static final com.ibm.ejs.ras.TraceComponent tc = com.ibm.ejs.ras.Tr.register(EmbeddableLocalTranCoordImpl.class, TranConstants.TRACE_GROUP, TranConstants.LTC_NLS_FILE);
