...
public class TestServletA extends FATServlet {
    ...
    public void testWrapString() throws Exception {
        WsByteBuffer wb = getBM().wrap("SERVER".getBytes());
        byte[] a = wb.array();
    ...
    @Test
    @Mode(TestMode.EXPERIMENTAL)
    public void testWsByteBufferUtilsSniffTest() {
        WsByteBuffer buffer = getBM().wrap("SERVER".getBytes());
     ...
     */
    @Test
    public void testPooledBuffers() throws Throwable {
        try {
            WsByteBuffer buffer = getBM().allocate(1024);
            runTests(buffer, false, 1024);
            assertEquals(WsByteBuffer.TYPE_WsByteBuffer, buffer.getType());
            buffer.release();
            buffer = getBM().allocateDirect(1024);
     ...
     * @throws Exception
     */
    private void runTests(WsByteBuffer buffer, boolean bDirect, int size) throws Exception {
...
//              ~/libertyGit/open-liberty/dev/io.openliberty.netty_fat/build/libs/autoFVT/output/servers
//            ./FATServer-01-04-2021-14-55-11/logs/NettyWsByteBufferTests.log
//            [err] java.lang.ClassNotFoundException: com.ibm.ws.bytebuffer.internal.WsByteBufferImpl
//            [err]   at com.ibm.ws.classloading.internal.AppClassLoader.findClassCommonLibraryClassLoaders(AppClassLoader.java:569)
//            [err]   at [internal classes]
//            [err]   at java.base/java.lang.ClassLoader.loadClass(ClassLoader.java:589)
//            [err]   at com.ibm.ws.classloading.internal.AppClassLoader.findOrDelegateLoadClass(AppClassLoader.java:547)
//            [err]   at [internal classes]
//            [err]   at java.base/java.lang.ClassLoader.loadClass(ClassLoader.java:522)
//            [err]   at java.base/java.lang.Class.forName0(Native Method)
//            [err]   at java.base/java.lang.Class.forName(Class.java:398)
//            [err]   at java.base/java.io.ObjectInputStream.resolveClass(ObjectInputStream.java:756)
//            [err]   at java.base/java.io.ObjectInputStream.readNonProxyDesc(ObjectInputStream.java:1995)
//            [err]   at java.base/java.io.ObjectInputStream.readClassDesc(ObjectInputStream.java:1862)
//            [err]   at java.base/java.io.ObjectInputStream.readOrdinaryObject(ObjectInputStream.java:2169)
//            [err]   at java.base/java.io.ObjectInputStream.readObject0(ObjectInputStream.java:1679)
//            [err]   at java.base/java.io.ObjectInputStream.readObject(ObjectInputStream.java:493)
//            [err]   at java.base/java.io.ObjectInputStream.readObject(ObjectInputStream.java:451)
//            [err]   at app1.web.WsByteBufferTests.runTests(WsByteBufferTests.java:426)
     ...
     */
    @Test
    public void testNonPooledBuffer() throws Throwable {
        try {
            WsByteBuffer buffer = getBM().wrap(new byte[8192]);
            assertEquals(WsByteBuffer.TYPE_WsByteBuffer, buffer.getType());
            runTests(buffer, false, 8192);
        } catch (Throwable t) {
            throw t; // outputMgr.failWithThrowable("testNonPooledBuffer", t);
        }
    }
     ...
     */
    @Test
    public void testRefCountBuffer() throws Throwable {
        try {
            WsByteBufferPoolManager mgr = getBM();
            WsByteBuffer buffer = mgr.wrap(ByteBuffer.allocate(1024));
            assertEquals(WsByteBuffer.TYPE_WsByteBuffer, buffer.getType());
            runTests(buffer, false, 1024);
        } catch (Throwable t) {
            throw t; // outputMgr.failWithThrowable("testRefCountBuffer", t);
        }
    }
     ...
     */
//    @Test
//    public void testFCBuffer() throws Throwable {
//        FileChannel fc = null;
...
//                }
//            }
//            throw t; //  outputMgr.failWithThrowable("testFCBuffer", t);
//        }
//    }
    ...
    public void testIndirectSlices() {
        try {
            WsByteBuffer buffer = getBM().allocate(8192);
            buffer.clear();
    ...
    /**
     * @return the WAS buffer pool manager
     */
    private WsByteBufferPoolManager getBM() {
        return WsByteBufferFactory.getBufferManager();
    }
