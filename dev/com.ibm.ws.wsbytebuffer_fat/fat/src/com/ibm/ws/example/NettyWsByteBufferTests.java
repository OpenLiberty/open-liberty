...
import app1.web.WsByteBufferTests;
...
public class NettyWsByteBufferTests extends FATServletClient {

    public static final String APP_NAME = "app1";

    @Server("FATServer")
    @TestServlet(servlet = WsByteBufferTests.class, contextRoot = APP_NAME)
