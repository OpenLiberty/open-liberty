...
public class ByteBufferTest {
    ...
    public void testPooledBuffers() {
        try {
            ...
            buffer.release();
            buffer = WsByteBufferFactory.getBufferManager().allocateDirect(1024);
    ...
    public void testNonPooledBuffer() {
        try {
            WsByteBuffer buffer = WsByteBufferFactory.getBufferManager().wrap(new byte[8192]);
            assertEquals(WsByteBuffer.TYPE_WsByteBuffer, buffer.getType());
    ...
    public void testRefCountBuffer() {
        try {
            WsByteBufferPoolManagerImpl mgr = (WsByteBufferPoolManagerImpl) WsByteBufferFactory.getBufferManager();
    ...
    public void testFCBuffer() {
        ...
        try {
            ...
            WsByteBuffer buffer = WsByteBufferFactory.getBufferManager().allocateFileChannelBuffer(fc);
            ...
            buffer = WsByteBufferFactory.getBufferManager().allocateFileChannelBuffer(fc);
            buffer.get();
    ...
    public void testEquals() {
        try {
            WsByteBufferPoolManager mgr = WsByteBufferFactory.getBufferManager();
