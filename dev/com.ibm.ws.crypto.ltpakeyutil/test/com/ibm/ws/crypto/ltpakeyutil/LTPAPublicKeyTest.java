...
public class LTPAPublicKeyTest {
	...
	public void testEncodedKeyIsDecodedWithRightContents() {
		...
		try {
			...
			assertEquals("The modulus must have the contents.", new String(expectedModulus),
					new String(actualRawKey[0]));
			assertEquals("The exponent must have the right contents.", new String(expectedExponent),
