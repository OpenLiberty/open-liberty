...
CREATE TABLE ${schemaname}.EmbManyXManyJoinTable (EMBEDIDMMENTITYA_ID INTEGER, identity_id INTEGER, identity_country VARCHAR(255));
CREATE TABLE ${schemaname}.IDClassMMEntA_IDClassMMEntB (IDCLASSMMENTITYA_ID INTEGER, identity_id INTEGER, identity_country VARCHAR(255));
...
CREATE TABLE ${schemaname}.MMCTEA_GCT (MMContainerTypeEntityA_ID INTEGER, MMContainerTypeEntityB_ID INTEGER);
CREATE TABLE ${schemaname}.MMCTEA_GLT (MMContainerTypeEntityA_ID INTEGER, MMContainerTypeEntityB_ID INTEGER);
CREATE TABLE ${schemaname}.MMCTEA_GMKT (MMContainerTypeEntityA_ID INTEGER, MMContainerTypeEntityB_ID INTEGER);
CREATE TABLE ${schemaname}.MMCTEA_GMT (MMContainerTypeEntityA_ID INTEGER, MMContainerTypeEntityB_ID INTEGER, KEY0 INTEGER);
CREATE TABLE ${schemaname}.MMCTEA_GST (MMContainerTypeEntityA_ID INTEGER, MMContainerTypeEntityB_ID INTEGER);
CREATE TABLE ${schemaname}.MMCTEA_OLT (MMContainerTypeEntityA_ID INTEGER, MMContainerTypeEntityB_ID INTEGER);
CREATE TABLE ${schemaname}.MMCTEA_UGCT (MMContainerTypeEntityA_ID INTEGER, MMContainerTypeEntityB_ID INTEGER);
CREATE TABLE ${schemaname}.MMCTEA_UGLT (MMContainerTypeEntityA_ID INTEGER, MMContainerTypeEntityB_ID INTEGER);
CREATE TABLE ${schemaname}.MMCTEA_UGMKT (MMContainerTypeEntityA_ID INTEGER, MMContainerTypeEntityB_ID INTEGER);
CREATE TABLE ${schemaname}.MMCTEA_UGST (MMContainerTypeEntityA_ID INTEGER, MMContainerTypeEntityB_ID INTEGER);
...
CREATE TABLE ${schemaname}.XMLEmbManyXManyJoinTable (XMLEMBEDIDMMENTITYA_ID INTEGER, identity_id INTEGER, identity_country VARCHAR(255));
CREATE TABLE ${schemaname}.XMLIDClassMMEntA_IDClassMMEntB (XMLIDCLASSMMENTITYA_ID INTEGER, identity_id INTEGER, identity_country VARCHAR(255));
...
CREATE TABLE ${schemaname}.XMLMMCTEA_GCT (XMLMMContainerTypeEntityA_ID INTEGER, XMLMMContainerTypeEntityB_ID INTEGER);
CREATE TABLE ${schemaname}.XMLMMCTEA_GLT (XMLMMContainerTypeEntityA_ID INTEGER, XMLMMContainerTypeEntityB_ID INTEGER);
CREATE TABLE ${schemaname}.XMLMMCTEA_GMKT (XMLMMContainerTypeEntityA_ID INTEGER, XMLMMContainerTypeEntityB_ID INTEGER);
CREATE TABLE ${schemaname}.XMLMMCTEA_GMT (XMLMMContainerTypeEntityA_ID INTEGER, XMLMMContainerTypeEntityB_ID INTEGER, KEY0 INTEGER);
CREATE TABLE ${schemaname}.XMLMMCTEA_GST (XMLMMContainerTypeEntityA_ID INTEGER, XMLMMContainerTypeEntityB_ID INTEGER);
CREATE TABLE ${schemaname}.XMLMMCTEA_OLT (XMLMMContainerTypeEntityA_ID INTEGER, XMLMMContainerTypeEntityB_ID INTEGER);
CREATE TABLE ${schemaname}.XMLMMCTEA_UGCT (XMLMMContainerTypeEntityA_ID INTEGER, XMLMMContainerTypeEntityB_ID INTEGER);
CREATE TABLE ${schemaname}.XMLMMCTEA_UGLT (XMLMMContainerTypeEntityA_ID INTEGER, XMLMMContainerTypeEntityB_ID INTEGER);
CREATE TABLE ${schemaname}.XMLMMCTEA_UGMKT (XMLMMContainerTypeEntityA_ID INTEGER, XMLMMContainerTypeEntityB_ID INTEGER);
CREATE TABLE ${schemaname}.XMLMMCTEA_UGST (XMLMMContainerTypeEntityA_ID INTEGER, XMLMMContainerTypeEntityB_ID INTEGER);
