 ...
 *******************************************************************************/
package signing.complex_4.servlets;
...
@OpenIdAuthenticationMechanismDefinition(providerURI = "${openIdConfig.providerURI}",
                                         ...
                                         providerMetadata = @OpenIdProviderMetadata(idTokenSigningAlgorithmsSupported = "RS384, ES256, #{'RS256'}, RS512"))

@DeclareRoles("all")
@ServletSecurity(@HttpConstraint(rolesAllowed = "all"))
public class ComplexSigning4Servlet extends BaseServlet {
