...
@OpenIdAuthenticationMechanismDefinition(providerURI = "${openIdConfig.providerURI}",
                                         ...
                                         providerMetadata = @OpenIdProviderMetadata(idTokenSigningAlgorithmsSupported = "${'RS384, RS256'}"))

@DeclareRoles("all")
@ServletSecurity(@HttpConstraint(rolesAllowed = "all"))
public class ComplexSigning5Servlet extends BaseServlet {
