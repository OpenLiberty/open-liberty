 ...
 *******************************************************************************/
package oidc.client.promptEL.servlets;
...
@WebServlet("/PromptELServlet")
@OpenIdAuthenticationMechanismDefinition(providerURI = "${providerBean.providerSecureRoot}/oidc/endpoint/${providerBean.provider}",
                                         clientId = "client_1",
...
public class PromptELServlet extends BaseServlet {
