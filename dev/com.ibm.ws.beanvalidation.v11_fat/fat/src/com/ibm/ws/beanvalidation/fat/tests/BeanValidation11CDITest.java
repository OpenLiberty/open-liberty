 ...
 */
public class BeanValidation11CDITest extends BasicValidation11CommonTest {
    ...
    public static void setUp() throws Exception {
        ...
        server = LibertyServerFactory.getLibertyServer("com.ibm.ws.beanvalidation.cdi_1.1.fat");
        ...
        server.startServer(BeanValidation11CDITest.class.getSimpleName() + ".log");
    }
