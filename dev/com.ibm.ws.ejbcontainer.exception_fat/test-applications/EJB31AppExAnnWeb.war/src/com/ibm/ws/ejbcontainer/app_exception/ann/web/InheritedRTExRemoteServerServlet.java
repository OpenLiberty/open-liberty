...
import com.ibm.ws.ejbcontainer.app_exception.ann.ejb.RTExRemoteInterface;
...
@WebServlet("/InheritedRTExRemoteServerServlet")
public class InheritedRTExRemoteServerServlet extends FATServlet {

    // Enables the remote client test to extend the remote server test.
    ...
    private final static String CLASSNAME = InheritedRTExRemoteServerServlet.class.getName();
    private final static Logger svLogger = Logger.getLogger(CLASSNAME);

    private RTExRemoteInterface lookupRemoteBean(String beanName) throws NamingException {
        return (RTExRemoteInterface) FATHelper.lookupDefaultBindingsEJBRemoteInterface(RTExRemoteInterface.class, "EJB31AppExAnnApp", "EJB31AppExAnnBean", beanName);
    }
     ...
     */
    @Test
    public void testAnnRemoteRTException0() throws Exception {
        RTExRemoteInterface bean = lookupRemoteBean("RTExceptionRemoteBean");
     ...
     */
    @Test
    public void testAnnRemoteRTException1() throws Exception {
        RTExRemoteInterface bean = lookupRemoteBean("RTExceptionRemoteBean");
        svLogger.info("--> INFO:  Successful bean lookup.");
     ...
     */
    @Test
    public void testAnnRemoteRTException2() throws Exception {
        RTExRemoteInterface bean = lookupRemoteBean("RTExceptionRemoteBean");
        svLogger.info("--> INFO:  Successful bean lookup.");
    ...
    public void testAnnRemoteRTException3() throws Exception {
        RTExRemoteInterface bean = lookupRemoteBean("RTExceptionRemoteBean");
        svLogger.info("--> INFO:  Successful bean lookup.");
     ...
     */
    @Test
    public void testAnnRemoteRTException4() throws Exception {
        RTExRemoteInterface bean = lookupRemoteBean("RTExceptionRemoteBean");
        svLogger.info("--> INFO:  Successful bean lookup.");
     ...
     */
    @Test
    public void testAnnRemoteRTException5() throws Exception {
        RTExRemoteInterface bean = lookupRemoteBean("RTExceptionRemoteBean");
        svLogger.info("--> INFO:  Successful bean lookup.");
