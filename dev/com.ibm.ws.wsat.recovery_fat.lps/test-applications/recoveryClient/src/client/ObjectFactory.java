...
public class ObjectFactory {
    ...
    private final static QName _Invoke_QNAME = new QName("http://server/", "invoke");
    private final static QName _InvokeResponse_QNAME = new QName("http://server/", "invokeResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server/", name = "invoke")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server/", name = "invokeResponse")
