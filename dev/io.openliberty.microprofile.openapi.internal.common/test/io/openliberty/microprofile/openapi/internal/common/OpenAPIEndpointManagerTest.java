...
public class OpenAPIEndpointManagerTest {
    ...
    private static final String API_PATH = "/ibm/api";
    ...
    public void validatePathFeaturePaths() {
        assertTrue(OpenAPIEndpointManager.validatePath(METRICS_PATH, EndpointId.UI));
        assertTrue(OpenAPIEndpointManager.validatePath(HEALTH_PATH, EndpointId.DOCUMENT));
        assertTrue(OpenAPIEndpointManager.validatePath(API_PATH, EndpointId.UI));
    }
