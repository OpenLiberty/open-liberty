...
public class Activator implements BundleActivator, ManagedServiceFactory {
    ...
    String _cfg_pid = "SamlUserResolver";
    // ************ FYI
    // With this sample, we have to specify something like:
    // <SamlUserResolver id="SampleSamlResolver1" /> or <SamlUserResolver id="SampleSamlResolver2" />
    // With 2 instance of tags in the server.xml it will have 2 instance of UserIdentityResolver services in runtime.
    //
    // This also needs to match the configuration element name in server.xml
    // example:  <SamlUserResolver id="SampleSamlResolver" service.vendor="IBM" user1="user2" user2="user3" user3="user4" user4="user1" />
                    ...
                    throws ConfigurationException
    {
        ...
        if (_context != null) {
            ...
            UserCredentialResolver idService = new SamlCredentialResolver(serviceProps);
