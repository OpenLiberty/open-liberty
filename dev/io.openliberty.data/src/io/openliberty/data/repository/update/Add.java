...
/**
 * <p>Annotates a repository method parameter to indicate adding the
 * parameter's value to the corresponding entity attribute.</p>
 *
 * <p>Example query:</p>
 *
 * <pre>
 * boolean increasePrice({@literal @Add("price")} float increase,
 *                       long productId);
 * </pre>
 *
 * <p>Example usage:</p>
 *
 * <pre>
 * successful = products.increasePrice(1.00f, productId1);
 * successful = products.increasePrice(-1.00f, productId2);
 * </pre>
 *
 ...
 *
 * <p>A parameter that is annotated with {@code Add} must not be used in
