...
@Mode(TestMode.FULL)
public class MP61EE10CompatibleTest {

    private static final String SERVER_NAME = "MP61andEE10";
    ...
    /**
     * microProfile-6.1 plus jakartaee-10.0
     * Should pass.
     *
     * @throws Exception
     */
    @Test
    @Mode(TestMode.FULL)
    public void testMP61andEE10() throws Exception {
