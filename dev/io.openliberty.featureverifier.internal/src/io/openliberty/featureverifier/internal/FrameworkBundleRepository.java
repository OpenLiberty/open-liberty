...
import io.openliberty.featureverifier.internal.buildtasks.classpath.VersionMatch;
    ...
    public Collection<Bundle> matchBundles(String symbName, String versionRange) {
        if (symbNamesToBundles.containsKey(symbName)) {
            ...
            for (Bundle b : symbNamesToBundles.get(symbName)) {
                io.openliberty.featureverifier.internal.buildtasks.classpath.Version v = new io.openliberty.featureverifier.internal.buildtasks.classpath.Version(b.getVersion().toString());
