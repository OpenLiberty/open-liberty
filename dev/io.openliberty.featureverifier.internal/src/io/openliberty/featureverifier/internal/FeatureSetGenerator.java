...
import io.openliberty.featureverifier.internal.buildtasks.semantic.versioning.model.SingletonChoice;
import io.openliberty.featureverifier.internal.buildtasks.semantic.versioning.model.SingletonSetId;
...
public class FeatureSetGenerator {
    ...
    protected static List<ConstrainedFeatureSet> mergeFeaturesIntoSets(List<ResolvedConstrainedFeature> expanded) {
        ...
        System.out.println("main bucket list starting at size " + buckets.size());
        while (buckets.size() > 0) {
            ...
            if (merged.size() > 0) {
                ...
                //System.out.println("main bucket list now at size "+buckets.size());
            }
        }
