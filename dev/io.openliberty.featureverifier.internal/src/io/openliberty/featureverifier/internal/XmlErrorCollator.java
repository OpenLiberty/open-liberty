...
//					}
    ...
    public static class TestSuite {
        ...
        public void writeXml(PrintWriter pw) {
            ...
            pw.println("<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
                       "<testsuite hostname=\"featureVerifier\" id=\"featureVerifier." + configName + "\" \n" +
                       "           name=\"Feature verification (" + configName + ")" + "\" package=\"featureverify." + configName + "\" time=\"1\" \n" +
    ...
    public static void newDumpRecordsToXML(File xml, File junit) throws IOException {
        ...
        TestSuite ts = new TestSuite(configName);
