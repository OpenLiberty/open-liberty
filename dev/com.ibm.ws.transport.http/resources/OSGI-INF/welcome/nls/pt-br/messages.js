var messages = {
    ...
    COMPATIBLE: "O Open Liberty é uma implementação compatível de:",
    MICROPROFILE: "Logotipo do MicroProfile",
    JAKARTA_EE: "Logotipo do Jakarta EE",
    RESOURCES_SECTION: "Seção de Recursos",
    RESOURCES: "Recursos e Ajuda",
    GITHUB: "Logotipo do GitHub",
    TWITTER: "Logotipo do Twitter",
    GITTER: "Logotipo do Gitter",
    STACK_OVERFLOW: "Logotipo do Estouro de pilha",
    GROUPS_IO: "Logotipo do Groups.io",
    OL_SUPPORT: "Logotipo do Open Liberty",
    DOCS: "Documentos", // Translate 'Documentation'
    COPYRIGHT: "copyright",
    OPEN_LIBERTY_FOOTER: "Logotipo do rodapé do Liberty",
    COPYRIGHT_OPEN_LIBERTY: "Licensed Materials — Property of the Open Liberty project, Copyright IBM Corp and others 1997, 2019. O projeto é distribuído sob os termos do Eclipse Public License v1.", // COPYRIGHT_URL
