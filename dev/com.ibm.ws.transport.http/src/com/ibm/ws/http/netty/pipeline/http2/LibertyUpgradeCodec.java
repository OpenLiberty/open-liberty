...
public class LibertyUpgradeCodec implements UpgradeCodecFactory {
     ...
     * Requests carrying an illegal version token 
     * are passed through to the downstream pipeline
     * {@link com.ibm.ws.http.netty.pipeline.inbound.HttpVersionValidationHandler}
     * rejects them with a 505 response.
     */
