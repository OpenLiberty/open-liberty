...
public class LibertyNettyALPNHandler extends ApplicationProtocolNegotiationHandler {
    ...
    protected void configurePipeline(ChannelHandlerContext ctx, String protocol) throws Exception {
        ...
        if (ApplicationProtocolNames.HTTP_1_1.equals(protocol)) {
            ...
            ctx.pipeline().addAfter(HttpPipelineInitializer.HTTP_KEEP_ALIVE_HANDLER_NAME, HttpPipelineInitializer.HTTP_REQUEST_HANDLER_NAME, new LibertyHttpRequestHandler(httpConfig));
