...
public class LibertyNettyALPNHandler extends ApplicationProtocolNegotiationHandler {
    ...
    protected void configurePipeline(ChannelHandlerContext ctx, String protocol) throws Exception {
        ...
        if (ApplicationProtocolNames.HTTP_1_1.equals(protocol)) {
            ...
            ctx.pipeline().addAfter(HttpPipelineInitializer.NETTY_HTTP_SERVER_CODEC, HttpVersionValidationHandler.NAME, HttpVersionValidationHandler.INSTANCE);
            ctx.pipeline().addAfter(HttpVersionValidationHandler.NAME, HttpPipelineInitializer.HTTP_KEEP_ALIVE_HANDLER_NAME, new HttpServerKeepAliveHandler());
