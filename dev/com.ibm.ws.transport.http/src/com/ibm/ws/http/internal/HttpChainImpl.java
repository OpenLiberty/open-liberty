 ...
 */
public class HttpChainImpl implements ChainEventListener {
    private static final TraceComponent tc = Tr.register(HttpChainImpl.class);
     ...
     */
    public HttpChainImpl(HttpEndpointImpl owner, boolean isHttps) {
        this.owner = owner;
