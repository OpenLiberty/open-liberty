            ...
            try {
                ...
                if (httpChannel == null) {
                    ...
                    if(headersOptions.get("id").equals("defaultHeaders")){
                        chanProps.put(HttpConfigConstants.PROPNAME_HEADERS_FEATURE, "false");
                        chanProps.put(HttpConfigConstants.PROPNAME_HEADERS_FEATURE_ADD, null);
                        chanProps.put(HttpConfigConstants.PROPNAME_HEADERS_FEATURE_SET, null);
                        chanProps.put(HttpConfigConstants.PROPNAME_HEADERS_FEATURE_SET_IF_MISSING, null);
                        chanProps.put(HttpConfigConstants.PROPNAME_HEADERS_FEATURE_REMOVE, null);
                    }
                        ...
                        if(headersOptions.containsKey("add")){
                            ...
                            chanProps.put(HttpConfigConstants.PROPNAME_HEADERS_FEATURE_ADD, headersOptions.get("add"));
                        }
                        if(headersOptions.containsKey("set")){
                            enableHeadersFeature=true;
                            chanProps.put(HttpConfigConstants.PROPNAME_HEADERS_FEATURE_SET, headersOptions.get("set"));
                        }
                        if(headersOptions.containsKey("setIfMissing")){
                            enableHeadersFeature=true;
                            chanProps.put(HttpConfigConstants.PROPNAME_HEADERS_FEATURE_SET_IF_MISSING, headersOptions.get("setIfMissing"));
                        }
                        if(headersOptions.containsKey("remove")){
                            enableHeadersFeature=true;
                            chanProps.put(HttpConfigConstants.PROPNAME_HEADERS_FEATURE_REMOVE, headersOptions.get("remove"));
                        }
                        chanProps.put(HttpConfigConstants.PROPNAME_HEADERS_FEATURE, enableHeadersFeature);
                    }
