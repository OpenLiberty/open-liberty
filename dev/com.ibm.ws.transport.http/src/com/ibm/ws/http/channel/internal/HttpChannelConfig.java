...
public class HttpChannelConfig {
    ...
    /** Tracks header names that have been configured erroneously **/
    ...
    private void parseConfig(ChannelData cc) {
        ...
        for (Entry<Object, Object> entry : propsIn.entrySet()) {
            ...
            if (key.equalsIgnoreCase(HttpConfigConstants.PROPNAME_HEADERS_FEATURE)) {
                props.put(HttpConfigConstants.PROPNAME_HEADERS_FEATURE, value);
            }

            if (key.equalsIgnoreCase(HttpConfigConstants.PROPNAME_HEADERS_FEATURE_ADD)) {
                props.put(HttpConfigConstants.PROPNAME_HEADERS_FEATURE_ADD, value);
            }

            if (key.equalsIgnoreCase(HttpConfigConstants.PROPNAME_HEADERS_FEATURE_SET)) {
                props.put(HttpConfigConstants.PROPNAME_HEADERS_FEATURE_SET, value);
            }

            if (key.equalsIgnoreCase(HttpConfigConstants.PROPNAME_HEADERS_FEATURE_SET_IF_MISSING)) {
                props.put(HttpConfigConstants.PROPNAME_HEADERS_FEATURE_SET_IF_MISSING, value);
            }

            if (key.equalsIgnoreCase(HttpConfigConstants.PROPNAME_HEADERS_FEATURE_REMOVE)) {
                props.put(HttpConfigConstants.PROPNAME_HEADERS_FEATURE_REMOVE, value);
            }
        ...
        parseHeadersFeature(props);
        parseHeadersFeatureRemove(props);
        parseHeadersFeatureAdd(props);
        parseHeadersFeatureOverwrite(props);
        parseHeadersFeatureSetIfMissing(props);
        logHeadersFeatureConfig();
     ...
     * @param props
     */
    private void parseHeadersFeature(Map<Object, Object> props) {

        Object value = props.get(HttpConfigConstants.PROPNAME_HEADERS_FEATURE);
        if (null != value) {
     ...
     * @param props
     */
    private void parseHeadersFeatureRemove(Map<Object, Object> props) {
        Object value = props.get(HttpConfigConstants.PROPNAME_HEADERS_FEATURE_REMOVE);
     ...
     * @param props
     */
    private void parseHeadersFeatureAdd(Map<Object, Object> props) {
        Object value = props.get(HttpConfigConstants.PROPNAME_HEADERS_FEATURE_ADD);
        if (null != value && this.isHeadersConfigEnabled) {
     ...
     * @param props
     */
    private void parseHeadersFeatureOverwrite(Map<Object, Object> props) {
        Object value = props.get(HttpConfigConstants.PROPNAME_HEADERS_FEATURE_SET);
        if (null != value && this.isHeadersConfigEnabled) {
     ...
     * @param props
     */
    private void parseHeadersFeatureSetIfMissing(Map<Object, Object> props) {
        Object value = props.get(HttpConfigConstants.PROPNAME_HEADERS_FEATURE_SET_IF_MISSING);
        if (null != value && this.isHeadersConfigEnabled) {
    ...
    private void logHeadersFeatureConfig() {
    ...
    private void setHeaderToCollection(String header, HttpConfigConstants.Headers collectionType) {
        ...
        if (headerName.isEmpty()) {
            ...
            if (this.configuredHeadersErrorSet.contains(headerNameHashCode)) {

                Tr.warning(tc, "knownDuplicateHeader", header, collectionType.getName());
            }
            ...
            //header is not unique AND we are entering this logic from the Headers.ADD enum, allow it.
                ...
                this.configuredHeadersErrorSet.add(headerName);
     ...
     */
    public Map<Integer, List<Map.Entry<String, String>>> getConfiguredHeadersToAppend() {
