...
public class HttpObjectFactory {
    ...
    private static final int SIZE_MAIN = 200;

    /** Pool of http request objects */
    private final ConcurrentObjectPool<HttpRequestMessage> reqPool = new ConcurrentObjectPool<HttpRequestMessage>(SIZE_MAIN);
    /** Pool of http response objects */
    private final ConcurrentObjectPool<HttpResponseMessage> respPool = new ConcurrentObjectPool<HttpResponseMessage>(SIZE_MAIN);
    /** Pool of http trailer objects */
    private final ConcurrentObjectPool<HttpTrailers> hdrPool = new ConcurrentObjectPool<HttpTrailers>(SIZE_MAIN);
