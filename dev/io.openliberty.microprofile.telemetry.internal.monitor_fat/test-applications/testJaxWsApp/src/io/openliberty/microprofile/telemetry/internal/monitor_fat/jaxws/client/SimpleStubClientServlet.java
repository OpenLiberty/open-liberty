...
public class SimpleStubClientServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        SimpleEchoService simpleEchoService = new SimpleEchoService(null, new QName("http://jaxws.monitor_fat.internal.telemetry.microprofile.openliberty.io/", "SimpleEchoService"));
