...
public class MetricsAuthenticationTest {
    ...
    private void testMetricsAuth() throws Exception {
        ...
        // check that when the authenticated user is in the monitor role, authorization is granted
        MetricsConnection monitorRole200 = MetricsConnection.connection_monitorRole(server);
        monitorRole200.expectedResponseCode(HttpURLConnection.HTTP_OK).getConnection();
