...
/**
 * Tests to ensure that the proxy support feature changes server object in the
 * final document. This class tests the following scenarios: requests to
 * /openapi with no Referer header, requests to /openapi with Referer header but
 * different ports than the server and finally requests to /openapi with Referer
 * header and same ports than the server. In these three scenarios, requests are
 * sent to both http and https ports.
 */
...
public class ProxySupportTest extends FATServletClient {
    ...
    /**
     * Tests to ensure when the call to /openapi doesn't include referer header, the
     * OAS doc has the server's host and port
     *
     * @throws Exception
     */
    @Test
    ...
    /**
     * Tests to ensure when the call to /openapi with a referer header that has
     * different port than the server, the OAS doc has correct host and port
     *
     * @throws Exception
     */
    @Test
    ...
    /**
     * Tests to ensure when the call to /openapi with a referer header that has the
     * same port than the server, the OAS doc has correct host and port
     *
     * @throws Exception
     */
    @Test
