...
public class OpenAPIValidationTestFive {
    ...
    public void testDiscriminator() throws Exception {
        assertNotNull("The Discriminator validator should have been triggered by the missing 'propertyName' field", server.waitForStringInLog("- Message: Required \"propertyName\" field is missing or is set to an invalid value,*"));
    }
