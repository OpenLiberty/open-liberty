...
public class MPJwtGoodMPConfigAsSystemProperties_NoPublicKey_UseJwksUri_JWK extends MPJwtGoodMPConfigAsSystemProperties {
    ...
    public static void setUp() throws Exception {
        ...
        MPConfigSettings mpConfigSettings = new MPConfigSettings(MPConfigSettings.jwksUri, MPConfigSettings.PublicKeyNotSet, MPConfigSettings.IssuerNotSet, MpJwtFatConstants.JWK_CERT);
