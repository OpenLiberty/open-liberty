 ...
 *******************************************************************************/
package com.ibm.ws.security.mp.jwt11.fat.propagationTests;

import org.junit.BeforeClass;
import org.junit.runner.RunWith;

import com.ibm.ws.security.mp.jwt11.fat.sharedTests.MPJwtPropagationTests;
...
public class MPJwtPropagationTests_usingWebTarget extends MPJwtPropagationTests {

    protected static Class<?> thisClass = MPJwtPropagationTests_usingWebTarget.class;

    @BeforeClass
    public static void setUp() throws Exception {

        propagationSetUp("rs_server_propagation.xml", webTargetConfigured_true);
