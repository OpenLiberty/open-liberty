...
public class MPJwtGoodMPConfigAsEnvVars_UseES384PublicKey_NoKeyLoc extends MPJwtWithGoodAltSigAlgMPConfig {
    ...
    public static void setUp() throws Exception {
        ...
        commonSetup(sigAlg, MP11ConfigSettings.PublicKeyLocationNotSet, MP11ConfigSettings.getComplexKeyForSigAlg(resourceServer, sigAlg), MPConfigLocation.ENV_VAR);
