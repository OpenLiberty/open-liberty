...
public class MPJwtGoodMPConfigAsEnvVars_NoPublicKey_UseKeyLocES256RelativeFile extends MPJwtWithGoodAltSigAlgMPConfig {
    ...
    public static void setUp() throws Exception {
        ...
        String sigAlg = MPJwt11FatConstants.SIGALG_ES256;
        commonSetup(envVarsResourceServer, sigAlg, JwtKeyTools.getPublicKeyFileNameForAlg(sigAlg), MP11ConfigSettings.PublicKeyNotSet, MPConfigLocation.ENV_VAR);

    }

    @Test
    public void MPJwtGoodMPConfigAsEnvVars_NoPublicKey_UseKeyLocES256RelativeFile_test() throws Exception {
        genericGoodTest();
    }
}
