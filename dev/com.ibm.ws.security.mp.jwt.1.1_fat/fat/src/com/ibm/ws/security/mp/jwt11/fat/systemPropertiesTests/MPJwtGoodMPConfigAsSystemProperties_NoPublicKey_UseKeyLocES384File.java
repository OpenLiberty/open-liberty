...
public class MPJwtGoodMPConfigAsSystemProperties_NoPublicKey_UseKeyLocES384File extends MPJwtWithGoodAltSigAlgMPConfig {
    ...
    public static void setUp() throws Exception {
        ...
        commonSetup(sysPropResourceServer, sigAlg, MP11ConfigSettings.getDefaultKeyFileLoc(sysPropResourceServer) + MP11ConfigSettings.getKeyFileNameForAlg(sigAlg),
                    MP11ConfigSettings.PublicKeyNotSet, MPConfigLocation.SYSTEM_PROP);

    }

    @Test
    public void MPJwtGoodMPConfigAsSystemProperties_NoPublicKey_UseKeyLocES384File_test() throws Exception {
        genericGoodTest();
    }
}
