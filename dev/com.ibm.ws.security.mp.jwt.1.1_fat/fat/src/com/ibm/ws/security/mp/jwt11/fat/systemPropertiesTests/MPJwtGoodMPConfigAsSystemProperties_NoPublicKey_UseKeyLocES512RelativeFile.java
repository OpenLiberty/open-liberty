...
public class MPJwtGoodMPConfigAsSystemProperties_NoPublicKey_UseKeyLocES512RelativeFile extends MPJwtWithGoodAltSigAlgMPConfig {
    ...
    public static void setUp() throws Exception {
        ...
        commonSetup(sysPropResourceServer, sigAlg, MP11ConfigSettings.getKeyFileNameForAlg(sigAlg), MP11ConfigSettings.PublicKeyNotSet, MPConfigLocation.SYSTEM_PROP);
