...
public class MPJwtGoodMPConfigAsSystemProperties_NoPublicKey_UseJwksUri_X509 extends MPJwtGoodMPConfigAsSystemProperties {

    public static Class<?> thisClass = MPJwtGoodMPConfigAsSystemProperties_NoPublicKey_UseJwksUri_X509.class;
    ...
    public static void setUp() throws Exception {
        ...
        MP11ConfigSettings mpConfigSettings = new MP11ConfigSettings(MP11ConfigSettings.jwksUri, MP11ConfigSettings.PublicKeyNotSet, MP11ConfigSettings.IssuerNotSet, MpJwtFatConstants.X509_CERT);
