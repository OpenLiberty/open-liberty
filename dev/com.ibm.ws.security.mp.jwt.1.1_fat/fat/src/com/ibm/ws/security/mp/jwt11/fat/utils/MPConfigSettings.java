...
public class MPConfigSettings {
    ...
    public final static String crtPrefix = "-----BEGIN CERTIFICATE-----";
    public final static String crtSuffix = "-----END CERTIFICATE-----";
    ...
    public String getSimpleKey(LibertyServer server, String fileName) throws Exception {
        ...
        if (rawKey != null) {
            return rawKey.replace(rsaPrefix, "").replace(rsaSuffix, "").replace(crtPrefix, "").replace(crtSuffix, "");
        }
        return rawKey;
    }
