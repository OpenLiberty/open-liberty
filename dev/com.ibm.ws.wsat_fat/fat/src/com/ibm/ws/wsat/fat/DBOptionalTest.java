...
public class DBOptionalTest extends DBTestBase {
	...
	public static void beforeTests() throws Exception {
		...
		ShrinkHelper.defaultDropinApp(server2, appNameOptional, "com.ibm.ws."+appNameOptional+".client","com.ibm.ws."+appNameOptional+".server","com.ibm.ws."+appNameOptional+".servlet","com.ibm.ws."+appNameOptional+".utils");
