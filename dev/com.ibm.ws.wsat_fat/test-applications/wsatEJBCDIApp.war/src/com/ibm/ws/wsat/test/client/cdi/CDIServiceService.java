...
@WebServiceClient(name = "CDIServiceService", targetNamespace = "http://server.test.wsat.ws.ibm.com/", wsdlLocation = "WEB-INF/wsdl/CDIServiceService.wsdl")
    ...
    extends Service
{
    ...
    private final static QName CDISERVICESERVICE_QNAME = new QName("http://server.test.wsat.ws.ibm.com/", "CDIServiceService");

    static {
            CDISERVICESERVICE_WSDL_LOCATION = com.ibm.ws.wsat.test.client.cdi.CDIServiceService.class.getResource("/WEB-INF/wsdl/CDIServiceService.wsdl");
...
//    }
    ...
    public CDIService getCDIServicePort() {
        return super.getPort(new QName("http://server.test.wsat.ws.ibm.com/", "CDIServicePort"), CDIService.class);
    }
    ...
    public CDIService getCDIServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.test.wsat.ws.ibm.com/", "CDIServicePort"), CDIService.class, features);
    }
