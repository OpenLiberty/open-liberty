...
public class CDIServicePortProxy{
    ...
    public class Descriptor {
        private com.ibm.ws.wsat.test.client.cdi.CDIServiceService _service = null;
        private com.ibm.ws.wsat.test.client.cdi.CDIService _proxy = null;
        ...
        public Descriptor(URL wsdlLocation, QName serviceName) {
            _service = new com.ibm.ws.wsat.test.client.cdi.CDIServiceService(wsdlLocation, serviceName);
            initCommon();
        }
        ...
        public void init() {
            ...
            try
            {
                ...
                _service = (com.ibm.ws.wsat.test.client.cdi.CDIServiceService)ctx.lookup("java:comp/env/service/CDIServiceService");
            }
            ...
            if (_service == null && !_useJNDIOnly)
                _service = new com.ibm.ws.wsat.test.client.cdi.CDIServiceService();
            initCommon();
        }
        ...
        public com.ibm.ws.wsat.test.client.cdi.CDIService getProxy() {
            return _proxy;
        }
