...
@WebServiceClient(name = "NormalServiceService", targetNamespace = "http://server.test.wsat.ws.ibm.com/", wsdlLocation = "WEB-INF/wsdl/NormalServiceService.wsdl")
    ...
    extends Service
{
    ...
    private final static QName NORMALSERVICESERVICE_QNAME = new QName("http://server.test.wsat.ws.ibm.com/", "NormalServiceService");

    static {
            NORMALSERVICESERVICE_WSDL_LOCATION = com.ibm.ws.wsat.test.client.normal.NormalServiceService.class.getResource("/WEB-INF/wsdl/NormalServiceService.wsdl");
...
//    }
    ...
    public NormalService getNormalServicePort() {
        return super.getPort(new QName("http://server.test.wsat.ws.ibm.com/", "NormalServicePort"), NormalService.class);
    }
    ...
    public NormalService getNormalServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.test.wsat.ws.ibm.com/", "NormalServicePort"), NormalService.class, features);
    }
