...
public class EJBServicePortProxy{
    ...
    public class Descriptor {
        private com.ibm.ws.wsat.test.client.ejb.EJBServiceService _service = null;
        private com.ibm.ws.wsat.test.client.ejb.EJBService _proxy = null;
        ...
        public Descriptor(URL wsdlLocation, QName serviceName) {
            _service = new com.ibm.ws.wsat.test.client.ejb.EJBServiceService(wsdlLocation, serviceName);
            initCommon();
        }
        ...
        public void init() {
            ...
            try
            {
                ...
                _service = (com.ibm.ws.wsat.test.client.ejb.EJBServiceService)ctx.lookup("java:comp/env/service/EJBServiceService");
            }
            ...
            if (_service == null && !_useJNDIOnly)
                _service = new com.ibm.ws.wsat.test.client.ejb.EJBServiceService();
            initCommon();
        }
        ...
        public com.ibm.ws.wsat.test.client.ejb.EJBService getProxy() {
            return _proxy;
        }
