...
import com.ibm.ws.wsat.fat.client.endtoend.HelloImplTwowayService;
		...
		if (result == true) {
			...
			try {
				...
				HelloImplTwowayService service = new HelloImplTwowayService(
						wsdlLocation);
				com.ibm.ws.wsat.fat.client.endtoend.HelloImplTwoway proxy = service.getHelloImplTwowayPort();
