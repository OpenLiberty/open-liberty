...
@WebServiceClient(name = "HelloImplTwowayService", targetNamespace = "http://server.fat.wsat.ws.ibm.com/", wsdlLocation = "http://localhost:9888/endtoend/HelloImplTwowayService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOIMPLTWOWAYSERVICE_QNAME = new QName("http://server.fat.wsat.ws.ibm.com/", "HelloImplTwowayService");
    ...
    public HelloImplTwoway getHelloImplTwowayPort() {
        return super.getPort(new QName("http://server.fat.wsat.ws.ibm.com/", "HelloImplTwowayPort"), HelloImplTwoway.class);
    }
    ...
    public HelloImplTwoway getHelloImplTwowayPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.fat.wsat.ws.ibm.com/", "HelloImplTwowayPort"), HelloImplTwoway.class, features);
    }
