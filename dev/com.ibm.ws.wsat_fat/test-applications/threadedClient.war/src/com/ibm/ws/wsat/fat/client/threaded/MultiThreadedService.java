...
@WebServiceClient(name = "MultiThreadedService", targetNamespace = "http://server.fat.wsat.ws.ibm.com/", wsdlLocation = "http://localhost:9992/threadedServer/MultiThreadedService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MULTITHREADEDSERVICE_QNAME = new QName("http://server.fat.wsat.ws.ibm.com/", "MultiThreadedService");
    ...
    public MultiThreaded getMultiThreadedPort() {
        return super.getPort(new QName("http://server.fat.wsat.ws.ibm.com/", "MultiThreadedPort"), MultiThreaded.class);
    }
    ...
    public MultiThreaded getMultiThreadedPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.fat.wsat.ws.ibm.com/", "MultiThreadedPort"), MultiThreaded.class, features);
    }
