...
<a href="http://localhost:9080/wsatApp/ClientServlet" target="_blank">http://localhost:9080/wsatApp/ClientServlet</a>?server1p=commit:http://localhost:9081&server2l=commit:http://localhost:9082
 <br> <br>
|---------------------------------------- README ----------------------------------------| <br>
...
&nbsp;&nbsp;&nbsp;&nbsp;	<br>
&nbsp;&nbsp;&nbsp;&nbsp;    &lt;webApplication id=&quot;wsatApp&quot; location=&quot;wsatApp.war&quot; name=&quot;wsatApp&quot;/&gt;<br>
...
<a href="http://localhost:9081/wsatApp/ResultServlet?server=server1&method=init" target"_blank">http://localhost:9081/wsatApp/ResultServlet?server=server1&method=init</a><br><br>
<b>Commit all transaction:</b> <br>
<a href="http://localhost:9080/wsatApp/ClientServlet?server1=commit:http://localhost:9081&server2=commit:http://localhost:9082" target"_blank">http://localhost:9080/wsatApp/ClientServlet?server1p=commit:http://localhost:9081&server2p=commit:http://localhost:9082</a><br><br>
<b>Other transaction:</b> <br>
<a href="http://localhost:9080/wsatApp/ClientServlet?server1=rollback:http://localhost:9081&server2=exception:http://localhost:9082" target"_blank">http://localhost:9080/wsatApp/ClientServlet?server1p=rollback:http://localhost:9081&server2p=exception:http://localhost:9082</a><br><br>
<b>Without client transaction:</b> <br>
<a href="http://localhost:9080/wsatApp/ClientServlet?server1=countdb:http://localhost:9081&server2=countdb:http://localhost:9082&withouttrans=true" target"_blank">http://localhost:9080/wsatApp/ClientServlet?server1=countdb:http://localhost:9081&server2=countdb:http://localhost:9082&withouttrans=true</a><br><br>
<b>Get db count:</b> <br>
<a href="http://localhost:9081/wsatApp/ResultServlet?server=server1" target"_blank">http://localhost:9081/wsatApp/ResultServlet?server=server1</a><br>
<br><br>
