...
@WebServiceClient(name = "HelloImplOnewayService", targetNamespace = "http://server.fat.wsat.ws.ibm.com/", wsdlLocation = "http://localhost:8010/oneway/HelloImplOnewayService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOIMPLONEWAYSERVICE_QNAME = new QName("http://server.fat.wsat.ws.ibm.com/", "HelloImplOnewayService");
    ...
    public HelloImplOneway getHelloImplOnewayPort() {
        return super.getPort(new QName("http://server.fat.wsat.ws.ibm.com/", "HelloImplOnewayPort"), HelloImplOneway.class);
    }
    ...
    public HelloImplOneway getHelloImplOnewayPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.fat.wsat.ws.ibm.com/", "HelloImplOnewayPort"), HelloImplOneway.class, features);
    }
