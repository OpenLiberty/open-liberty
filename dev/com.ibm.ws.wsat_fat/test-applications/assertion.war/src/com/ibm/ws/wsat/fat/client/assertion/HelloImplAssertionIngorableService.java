...
@WebServiceClient(name = "HelloImplAssertionIngorableService", targetNamespace = "http://server.fat.wsat.ws.ibm.com/", wsdlLocation = "http://localhost:8010/assertion/HelloImplAssertionIngorableService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOIMPLASSERTIONINGORABLESERVICE_QNAME = new QName("http://server.fat.wsat.ws.ibm.com/", "HelloImplAssertionIngorableService");
    ...
    public Hello getHelloImplAssertionIngorablePort() {
        return super.getPort(new QName("http://server.fat.wsat.ws.ibm.com/", "HelloImplAssertionIngorablePort"), Hello.class);
    }
    ...
    public Hello getHelloImplAssertionIngorablePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.fat.wsat.ws.ibm.com/", "HelloImplAssertionIngorablePort"), Hello.class, features);
    }
