...
@WebServiceClient(name = "HelloImplAssertionOptionalService", targetNamespace = "http://server.fat.wsat.ws.ibm.com/", wsdlLocation = "http://localhost:8010/assertion/HelloImplAssertionOptionalService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOIMPLASSERTIONOPTIONALSERVICE_QNAME = new QName("http://server.fat.wsat.ws.ibm.com/", "HelloImplAssertionOptionalService");
    ...
    public Hello getHelloImplAssertionOptionalPort() {
        return super.getPort(new QName("http://server.fat.wsat.ws.ibm.com/", "HelloImplAssertionOptionalPort"), Hello.class);
    }
    ...
    public Hello getHelloImplAssertionOptionalPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.fat.wsat.ws.ibm.com/", "HelloImplAssertionOptionalPort"), Hello.class, features);
    }
