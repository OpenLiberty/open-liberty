...
@WebServiceClient(name = "HelloImplNoAssertionService", targetNamespace = "http://server.fat.wsat.ws.ibm.com/", wsdlLocation = "http://localhost:8010/assertion/HelloImplNoAssertionService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOIMPLNOASSERTIONSERVICE_QNAME = new QName("http://server.fat.wsat.ws.ibm.com/", "HelloImplNoAssertionService");
    ...
    public Hello getHelloImplNoAssertionPort() {
        return super.getPort(new QName("http://server.fat.wsat.ws.ibm.com/", "HelloImplNoAssertionPort"), Hello.class);
    }
    ...
    public Hello getHelloImplNoAssertionPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.fat.wsat.ws.ibm.com/", "HelloImplNoAssertionPort"), Hello.class, features);
    }
