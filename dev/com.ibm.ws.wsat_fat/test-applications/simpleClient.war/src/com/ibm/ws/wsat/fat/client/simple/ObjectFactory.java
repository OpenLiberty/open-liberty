 ...
 * generated in the com.ibm.ws.wsat.fat.client.simple package. 
...
public class ObjectFactory {
    ...
    private final static QName _EnlistOneXAResource_QNAME = new QName("http://server.fat.wsat.ws.ibm.com/", "enlistOneXAResource");
    private final static QName _Echo_QNAME = new QName("http://server.fat.wsat.ws.ibm.com/", "echo");
    private final static QName _EnlistTwoXAResourcesResponse_QNAME = new QName("http://server.fat.wsat.ws.ibm.com/", "enlistTwoXAResourcesResponse");
    private final static QName _EnlistOneXAResourceResponse_QNAME = new QName("http://server.fat.wsat.ws.ibm.com/", "enlistOneXAResourceResponse");
    private final static QName _GetStatusResponse_QNAME = new QName("http://server.fat.wsat.ws.ibm.com/", "getStatusResponse");
    private final static QName _EchoResponse_QNAME = new QName("http://server.fat.wsat.ws.ibm.com/", "echoResponse");
    private final static QName _SleepResponse_QNAME = new QName("http://server.fat.wsat.ws.ibm.com/", "sleepResponse");
    private final static QName _EnlistTwoXAResources_QNAME = new QName("http://server.fat.wsat.ws.ibm.com/", "enlistTwoXAResources");
    private final static QName _GetStatus_QNAME = new QName("http://server.fat.wsat.ws.ibm.com/", "getStatus");
    private final static QName _Sleep_QNAME = new QName("http://server.fat.wsat.ws.ibm.com/", "sleep");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.ibm.ws.wsat.fat.client.simple
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.fat.wsat.ws.ibm.com/", name = "enlistOneXAResource")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.fat.wsat.ws.ibm.com/", name = "enlistTwoXAResourcesResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.fat.wsat.ws.ibm.com/", name = "enlistOneXAResourceResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.fat.wsat.ws.ibm.com/", name = "getStatusResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.fat.wsat.ws.ibm.com/", name = "sleepResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.fat.wsat.ws.ibm.com/", name = "enlistTwoXAResources")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.fat.wsat.ws.ibm.com/", name = "getStatus")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.fat.wsat.ws.ibm.com/", name = "sleep")
