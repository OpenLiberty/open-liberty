...
@WebServiceClient(name = "WSATSimpleService", targetNamespace = "http://server.fat.wsat.ws.ibm.com/", wsdlLocation = "http://localhost:9992/simpleServer/WSATSimpleService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WSATSIMPLESERVICE_QNAME = new QName("http://server.fat.wsat.ws.ibm.com/", "WSATSimpleService");
    ...
    public WSATSimple getWSATSimplePort() {
        return super.getPort(new QName("http://server.fat.wsat.ws.ibm.com/", "WSATSimplePort"), WSATSimple.class);
    }
    ...
    public WSATSimple getWSATSimplePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.fat.wsat.ws.ibm.com/", "WSATSimplePort"), WSATSimple.class, features);
    }
