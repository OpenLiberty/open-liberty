 ...
 * generated in the com.ibm.ws.wsatAppService.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _SayHelloToOtherWithoutResponse_QNAME = new QName("http://server.wsatAppService.ws.ibm.com/", "sayHelloToOtherWithoutResponse");
    private final static QName _SayHelloToOtherWithout_QNAME = new QName("http://server.wsatAppService.ws.ibm.com/", "sayHelloToOtherWithout");
    private final static QName _SayHelloToOtherResponse_QNAME = new QName("http://server.wsatAppService.ws.ibm.com/", "sayHelloToOtherResponse");
    private final static QName _SayHelloToOther_QNAME = new QName("http://server.wsatAppService.ws.ibm.com/", "sayHelloToOther");
    private final static QName _SayHelloResponse_QNAME = new QName("http://server.wsatAppService.ws.ibm.com/", "sayHelloResponse");
    private final static QName _SayHello_QNAME = new QName("http://server.wsatAppService.ws.ibm.com/", "sayHello");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.ibm.ws.wsatAppService.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.wsatAppService.ws.ibm.com/", name = "sayHelloToOtherWithoutResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.wsatAppService.ws.ibm.com/", name = "sayHelloToOtherWithout")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.wsatAppService.ws.ibm.com/", name = "sayHelloToOtherResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.wsatAppService.ws.ibm.com/", name = "sayHelloToOther")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.wsatAppService.ws.ibm.com/", name = "sayHelloResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.wsatAppService.ws.ibm.com/", name = "sayHello")
