...
import com.ibm.ws.jpa.fvt.ordercolumns.web.OrderColumnBiTestServlet;
import com.ibm.ws.jpa.fvt.ordercolumns.web.OrderColumnElementTestServlet;
import com.ibm.ws.jpa.fvt.ordercolumns.web.OrderColumnUniTestServlet;
...
@Mode(TestMode.LITE)
public class JPA20OrderColumn_WEB extends JPAFATServletClient {

    @Rule
    public static SkipDatabaseRule skipDBRule = new SkipDatabaseRule();

    private final static String CONTEXT_ROOT = "OrderColumnWeb";
    private final static String RESOURCE_ROOT = "test-applications/ordercolumn/";
    private final static String appFolder = "web";
    private final static String appName = "OrderColumnWebApp";
    ...
    static {
        dropSet.add("JPA20_ORDERCOLUMN_${provider}_DROP_${dbvendor}.ddl");
        createSet.add("JPA20_ORDERCOLUMN_${provider}_CREATE_${dbvendor}.ddl");
    }

    @Server("JPA20OrderColumnServer")
    @TestServlets({
                    @TestServlet(servlet = OrderColumnUniTestServlet.class, path = CONTEXT_ROOT + "/" + "OrderColumnUniTestServlet"),
                    @TestServlet(servlet = OrderColumnBiTestServlet.class, path = CONTEXT_ROOT + "/" + "OrderColumnBiTestServlet"),
                    @TestServlet(servlet = OrderColumnElementTestServlet.class, path = CONTEXT_ROOT + "/" + "OrderColumnElementTestServlet")
    })
    ...
    public static void setUp() throws Exception {
        ...
        bannerStart(JPA20OrderColumn_WEB.class);
        ...
        System.out.println(JPA20OrderColumn_WEB.class.getName() + " Setting up database tables...");
    ...
    private static void setupTestApplication() throws Exception {
        ...
        webApp.addPackages(false, "com.ibm.ws.jpa.fvt.ordercolumns");
        webApp.addPackages(true, "com.ibm.ws.jpa.fvt.ordercolumns.model");
        webApp.addPackages(true, "com.ibm.ws.jpa.fvt.ordercolumns.web");
    ...
    public static void tearDown() throws Exception {
        try {
            ...
            bannerEnd(JPA20OrderColumn_WEB.class, timestart);
        }
    }
}
