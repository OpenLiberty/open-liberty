...
public class TestOLGH9339_EJB extends JPAFATServletClient {
    ...
    static {
        dropSet.add("OLGH9339_${provider}_DROP_${dbvendor}.ddl");
        createSet.add("OLGH9339_${provider}_CREATE_${dbvendor}.ddl");
        populateSet.add("OLGH9339_${provider}_POPULATE_${dbvendor}.ddl");
    }
    ...
    public static void setUp() throws Exception {
        ...
        System.out.println(TestOLGH9339_EJB.class.getName() + " Setting up database tables...");
