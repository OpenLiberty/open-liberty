...
public class JPA20CriteriaQuery_EJB extends JPAFATServletClient {
    ...
    static {
        dropSet.add("JPA20_CRITERIAQUERY_${provider}_DROP_${dbvendor}.ddl");
        createSet.add("JPA20_CRITERIAQUERY_${provider}_CREATE_${dbvendor}.ddl");
        populateSet.add("JPA20_CRITERIAQUERY_${provider}_POPULATE_${dbvendor}.ddl");
    }

    @Server("JPA20CriteriaQueryServer")
    @TestServlets({
    ...
    public static void setUp() throws Exception {
        ...
        System.out.println(JPA20CriteriaQuery_EJB.class.getName() + " Setting up database tables...");
