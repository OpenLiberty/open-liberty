...
public class TestOLGH16686_WEB extends JPAFATServletClient {
    ...
    static {
        dropSet.add("OLGH16686_${provider}_DROP_${dbvendor}.ddl");
        createSet.add("OLGH16686_${provider}_CREATE_${dbvendor}.ddl");
    }
    ...
    public static void setUp() throws Exception {
        ...
        System.out.println(TestOLGH16686_WEB.class.getName() + " Setting up database tables...");
