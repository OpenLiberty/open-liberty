...
public class JPA20Cache_WEB extends JPAFATServletClient {
    ...
    static {
        dropSet.add("JPA20_CACHE_${provider}_DROP_${dbvendor}.ddl");
        createSet.add("JPA20_CACHE_${provider}_CREATE_${dbvendor}.ddl");
    }
    ...
    public static void setUp() throws Exception {
        ...
        System.out.println(JPA20Cache_WEB.class.getName() + " Setting up database tables...");
