...
public class JPA20Example_EJB extends JPAFATServletClient {
    ...
    static {
        dropSet.add("JPA20_EXAMPLE_${provider}_DROP_${dbvendor}.ddl");
        createSet.add("JPA20_EXAMPLE_${provider}_CREATE_${dbvendor}.ddl");
        populateSet.add("JPA20_EXAMPLE_${provider}_POPULATE_${dbvendor}.ddl");
    }
    ...
    public static void setUp() throws Exception {
        ...
        System.out.println(JPA20Example_EJB.class.getName() + " Setting up database tables...");
