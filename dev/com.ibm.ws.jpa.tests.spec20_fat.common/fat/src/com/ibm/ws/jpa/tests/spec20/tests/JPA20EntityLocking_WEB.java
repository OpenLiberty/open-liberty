...
public class JPA20EntityLocking_WEB extends JPAFATServletClient {
    ...
    static {
        dropSet.add("JPA20_ENTITYLOCKING_${provider}_DROP_${dbvendor}.ddl");
        createSet.add("JPA20_ENTITYLOCKING_${provider}_CREATE_${dbvendor}.ddl");
//        populateSet.add("JPA20_ENTITYLOCKING_${provider}_POPULATE_${dbvendor}.ddl");
    }

    @Server("JPA20EntityLocking")
    @TestServlets({
    ...
    public static void setUp() throws Exception {
        ...
        bannerStart(JPA20EntityLocking_WEB.class);
        ...
        System.out.println(JPA20EntityLocking_WEB.class.getName() + " Setting up database tables...");
    ...
    private static void setupTestApplication() throws Exception {
        ...
        webApp.addPackages(true, "com.ibm.ws.jpa.fvt.entitylocking.entities");
        webApp.addPackages(true, "com.ibm.ws.jpa.fvt.entitylocking.testlogic");
        webApp.addPackages(true, "com.ibm.ws.jpa.fvt.entitylocking.tests.web");
    ...
    public static void tearDown() throws Exception {
        try {
            ...
            bannerEnd(JPA20EntityLocking_WEB.class, timestart);
        }
    }
}
