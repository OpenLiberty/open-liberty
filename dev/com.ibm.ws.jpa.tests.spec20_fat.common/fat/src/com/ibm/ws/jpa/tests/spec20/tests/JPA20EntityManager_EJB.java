...
public class JPA20EntityManager_EJB extends JPAFATServletClient {
    ...
    static {
        dropSet.add("JPA20_ENTITYMANAGER_${provider}_DROP_${dbvendor}.ddl");
        createSet.add("JPA20_ENTITYMANAGER_${provider}_CREATE_${dbvendor}.ddl");
        populateSet.add("JPA20_ENTITYMANAGER_${provider}_POPULATE_${dbvendor}.ddl");
    }

    @Server("JPA20EntityManagerServer")
    @TestServlets({
    ...
    public static void setUp() throws Exception {
        ...
        System.out.println(JPA20EntityManager_EJB.class.getName() + " Setting up database tables...");
