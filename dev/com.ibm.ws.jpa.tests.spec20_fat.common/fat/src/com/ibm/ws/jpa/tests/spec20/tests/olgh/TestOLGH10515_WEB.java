...
import com.ibm.ws.jpa.tests.spec20.tests.SkipDatabaseRule;
...
public class TestOLGH10515_WEB extends JPAFATServletClient {
    ...
    static {
        dropSet.add("OLGH10515_${provider}_DROP_${dbvendor}.ddl");
        createSet.add("OLGH10515_${provider}_CREATE_${dbvendor}.ddl");
        populateSet.add("OLGH10515_${provider}_POPULATE_${dbvendor}.ddl");
    }
    ...
    public static void setUp() throws Exception {
        ...
        System.out.println(JPA20CriteriaQuery_WEB.class.getName() + " Setting up database tables...");
