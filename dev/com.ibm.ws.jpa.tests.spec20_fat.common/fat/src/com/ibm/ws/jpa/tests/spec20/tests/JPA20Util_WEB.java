...
public class JPA20Util_WEB extends JPAFATServletClient {
    ...
    static {
        dropSet.add("JPA20_UTIL_${provider}_DROP_${dbvendor}.ddl");
        createSet.add("JPA20_UTIL_${provider}_CREATE_${dbvendor}.ddl");
    }

    @Server("JPA20UtilServer")
    @TestServlets({
    ...
    public static void setUp() throws Exception {
        ...
        System.out.println(JPA20Util_WEB.class.getName() + " Setting up database tables...");
