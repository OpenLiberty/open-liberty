...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0104_SELECT",
                                    query = "SELECT e FROM Entity0104 e WHERE e.entity0104_id1 = :id1_0104 AND e.entity0104_id2 = :id2_0104")
              })
@Entity
@IdClass(IdClass0104.class)
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0104")
public class Entity0104 {
    ...
    @Version
    private Integer entity0104_version;

    private String entity0104_string01;

    private String entity0104_string02;

    private String entity0104_string03;

    public Entity0104() {}

    public Entity0104(Character id1,
                      Character id2,
                      Integer version,
                      String string01,
                      String string02,
        ...
        this.entity0104_version = version;
        this.entity0104_string01 = string01;
        this.entity0104_string02 = string02;
        this.entity0104_string03 = string03;
    }
    ...
    public String toString() {
        return (" Entity0104: " +
                ...
                " entity0104_version: " + getEntity0104_version() +
                " entity0104_string01: " + getEntity0104_string01() +
                " entity0104_string02: " + getEntity0104_string02() +
                " entity0104_string03: " + getEntity0104_string03());
    }
    ...
    public void setEntity0104_id1(Character p) {
        this.entity0104_id1 = p;
    }
    ...
    public void setEntity0104_id2(Character p) {
        this.entity0104_id2 = p;
    }

    public Integer getEntity0104_version() {
        return entity0104_version;
    }

    public void setEntity0104_version(Integer p) {
        this.entity0104_version = p;
    }

    public String getEntity0104_string01() {
        return entity0104_string01;
    }

    public void setEntity0104_string01(String p) {
        this.entity0104_string01 = p;
    }

    public String getEntity0104_string02() {
        return entity0104_string02;
    }

    public void setEntity0104_string02(String p) {
        this.entity0104_string02 = p;
    }

    public String getEntity0104_string03() {
        return entity0104_string03;
    }

    public void setEntity0104_string03(String p) {
        this.entity0104_string03 = p;
    }
}
