...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0411_SELECT",
                                    query = "SELECT e FROM Entity0411 e WHERE e.entity0411_id = :id_0411")
              })
@Entity
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0411")
public class Entity0411 {

    @Id
    @OneToOne
    private Entity0011 entity0411_id;

    @Version
    private Timestamp entity0411_version;

    private String entity0411_string01;

    private String entity0411_string02;

    private String entity0411_string03;

    public Entity0411() {}

    public Entity0411(Entity0011 id,
                      Timestamp version,
                      String string01,
                      String string02,
                      String string03) {
        this.entity0411_id = id;
        this.entity0411_version = version;
        this.entity0411_string01 = string01;
        this.entity0411_string02 = string02;
        this.entity0411_string03 = string03;
    }

    @Override
    public String toString() {
        return (" Entity0411: " +
                " entity0411_id: " + getEntity0411_id() +
                " entity0411_version: " + getEntity0411_version() +
                " entity0411_string01: " + getEntity0411_string01() +
                " entity0411_string02: " + getEntity0411_string02() +
                " entity0411_string03: " + getEntity0411_string03());
    }

    //----------------------------------------------------------------------------------------------
    // Persisent property accessor(s)
    //----------------------------------------------------------------------------------------------
    public Entity0011 getEntity0411_id() {
        return entity0411_id;
    }

    public void setEntity0411_id(Entity0011 p) {
        this.entity0411_id = p;
    }

    public Timestamp getEntity0411_version() {
        return entity0411_version;
    }

    public void setEntity0411_version(Timestamp p) {
        this.entity0411_version = p;
    }

    public String getEntity0411_string01() {
        return entity0411_string01;
    }

    public void setEntity0411_string01(String p) {
        this.entity0411_string01 = p;
    }

    public String getEntity0411_string02() {
        return entity0411_string02;
    }

    public void setEntity0411_string02(String p) {
        this.entity0411_string02 = p;
    }

    public String getEntity0411_string03() {
        return entity0411_string03;
    }

    public void setEntity0411_string03(String p) {
        this.entity0411_string03 = p;
    }
}
