...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0318_SELECT",
                                    query = "SELECT e FROM Entity0318 e WHERE e.entity0318_id1 = :id1_0318 AND e.entity0318_id2 = :id2_0318 AND e.entity0318_id3 = :id3_0318")
              })
@Entity
@IdClass(IdClass0318.class)
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0318")
public class Entity0318 {
    ...
    @Version
    private short entity0318_version;

    private String entity0318_string01;

    private String entity0318_string02;

    private String entity0318_string03;

    public Entity0318() {}

    public Entity0318(java.util.Date id1,
                      java.sql.Date id2,
                      java.util.Date id3,
                      short version,
                      String string01,
        ...
        this.entity0318_version = version;
        this.entity0318_string01 = string01;
        this.entity0318_string02 = string02;
        this.entity0318_string03 = string03;
    }
    ...
    public String toString() {
        return (" Entity0318: " +
                ...
                " entity0318_version: " + getEntity0318_version() +
                " entity0318_string01: " + getEntity0318_string01() +
                " entity0318_string02: " + getEntity0318_string02() +
                " entity0318_string03: " + getEntity0318_string03());
    }
    ...
    public void setEntity0318_id1(java.util.Date p) {
        this.entity0318_id1 = p;
    }
    ...
    public void setEntity0318_id2(java.sql.Date p) {
        this.entity0318_id2 = p;
    }
    ...
    public void setEntity0318_id3(java.util.Date p) {
        this.entity0318_id3 = p;
    }

    public short getEntity0318_version() {
        return entity0318_version;
    }

    public void setEntity0318_version(short p) {
        this.entity0318_version = p;
    }

    public String getEntity0318_string01() {
        return entity0318_string01;
    }

    public void setEntity0318_string01(String p) {
        this.entity0318_string01 = p;
    }

    public String getEntity0318_string02() {
        return entity0318_string02;
    }

    public void setEntity0318_string02(String p) {
        this.entity0318_string02 = p;
    }

    public String getEntity0318_string03() {
        return entity0318_string03;
    }

    public void setEntity0318_string03(String p) {
        this.entity0318_string03 = p;
    }
}
