...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0419_SELECT",
                                    query = "SELECT e FROM Entity0419 e WHERE e.entity0419_id = :id_0419")
              })
@Entity
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0419")
public class Entity0419 {

    @Id
    @OneToOne
    private Entity0019 entity0419_id;

    @Version
    private int entity0419_version;

    private String entity0419_string01;

    private String entity0419_string02;

    private String entity0419_string03;

    public Entity0419() {}

    public Entity0419(Entity0019 id,
                      int version,
                      String string01,
                      String string02,
                      String string03) {
        this.entity0419_id = id;
        this.entity0419_version = version;
        this.entity0419_string01 = string01;
        this.entity0419_string02 = string02;
        this.entity0419_string03 = string03;
    }

    @Override
    public String toString() {
        return (" Entity0419: " +
                " entity0419_id: " + getEntity0419_id() +
                " entity0419_version: " + getEntity0419_version() +
                " entity0419_string01: " + getEntity0419_string01() +
                " entity0419_string02: " + getEntity0419_string02() +
                " entity0419_string03: " + getEntity0419_string03());
    }

    //----------------------------------------------------------------------------------------------
    // Persisent property accessor(s)
    //----------------------------------------------------------------------------------------------
    public Entity0019 getEntity0419_id() {
        return entity0419_id;
    }

    public void setEntity0419_id(Entity0019 p) {
        this.entity0419_id = p;
    }

    public int getEntity0419_version() {
        return entity0419_version;
    }

    public void setEntity0419_version(int p) {
        this.entity0419_version = p;
    }

    public String getEntity0419_string01() {
        return entity0419_string01;
    }

    public void setEntity0419_string01(String p) {
        this.entity0419_string01 = p;
    }

    public String getEntity0419_string02() {
        return entity0419_string02;
    }

    public void setEntity0419_string02(String p) {
        this.entity0419_string02 = p;
    }

    public String getEntity0419_string03() {
        return entity0419_string03;
    }

    public void setEntity0419_string03(String p) {
        this.entity0419_string03 = p;
    }
}
