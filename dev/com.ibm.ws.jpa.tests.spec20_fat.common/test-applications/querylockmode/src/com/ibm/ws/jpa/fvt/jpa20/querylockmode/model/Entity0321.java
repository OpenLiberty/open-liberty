...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0321_SELECT",
                                    query = "SELECT e FROM Entity0321 e WHERE e.entity0321_id1 = :id1_0321 AND e.entity0321_id2 = :id2_0321 AND e.entity0321_id3 = :id3_0321")
              })
@Entity
@IdClass(IdClass0321.class)
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0321")
public class Entity0321 {
    ...
    @Version
    private int entity0321_version;

    private String entity0321_string01;

    private String entity0321_string02;

    private String entity0321_string03;

    public Entity0321() {}

    public Entity0321(Byte id1,
                      Character id2,
                      double id3,
                      int version,
                      String string01,
        ...
        this.entity0321_version = version;
        this.entity0321_string01 = string01;
        this.entity0321_string02 = string02;
        this.entity0321_string03 = string03;
    }
    ...
    public String toString() {
        return (" Entity0321: " +
                ...
                " entity0321_version: " + getEntity0321_version() +
                " entity0321_string01: " + getEntity0321_string01() +
                " entity0321_string02: " + getEntity0321_string02() +
                " entity0321_string03: " + getEntity0321_string03());
    }
    ...
    public void setEntity0321_id1(Byte p) {
        this.entity0321_id1 = p;
    }
    ...
    public void setEntity0321_id2(Character p) {
        this.entity0321_id2 = p;
    }
    ...
    public void setEntity0321_id3(double p) {
        this.entity0321_id3 = p;
    }

    public int getEntity0321_version() {
        return entity0321_version;
    }

    public void setEntity0321_version(int p) {
        this.entity0321_version = p;
    }

    public String getEntity0321_string01() {
        return entity0321_string01;
    }

    public void setEntity0321_string01(String p) {
        this.entity0321_string01 = p;
    }

    public String getEntity0321_string02() {
        return entity0321_string02;
    }

    public void setEntity0321_string02(String p) {
        this.entity0321_string02 = p;
    }

    public String getEntity0321_string03() {
        return entity0321_string03;
    }

    public void setEntity0321_string03(String p) {
        this.entity0321_string03 = p;
    }
}
