...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0214_SELECT",
                                    query = "SELECT e FROM Entity0214 e WHERE e.entity0214_id1 = :id1_0214 AND e.entity0214_id2 = :id2_0214 AND e.entity0214_id3 = :id3_0214")
              })
@Entity
@IdClass(IdClass0214.class)
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0214")
public class Entity0214 {
    ...
    @Version
    private long entity0214_version;

    private String entity0214_string01;

    private String entity0214_string02;

    private String entity0214_string03;

    public Entity0214() {}

    public Entity0214(short id1,
                      short id2,
                      short id3,
                      long version,
                      String string01,
        ...
        this.entity0214_version = version;
        this.entity0214_string01 = string01;
        this.entity0214_string02 = string02;
        this.entity0214_string03 = string03;
    }
    ...
    public String toString() {
        return (" Entity0214: " +
                ...
                " entity0214_version: " + getEntity0214_version() +
                " entity0214_string01: " + getEntity0214_string01() +
                " entity0214_string02: " + getEntity0214_string02() +
                " entity0214_string03: " + getEntity0214_string03());
    }
    ...
    public void setEntity0214_id1(short p) {
        this.entity0214_id1 = p;
    }
    ...
    public void setEntity0214_id2(short p) {
        this.entity0214_id2 = p;
    }
    ...
    public void setEntity0214_id3(short p) {
        this.entity0214_id3 = p;
    }

    public long getEntity0214_version() {
        return entity0214_version;
    }

    public void setEntity0214_version(long p) {
        this.entity0214_version = p;
    }

    public String getEntity0214_string01() {
        return entity0214_string01;
    }

    public void setEntity0214_string01(String p) {
        this.entity0214_string01 = p;
    }

    public String getEntity0214_string02() {
        return entity0214_string02;
    }

    public void setEntity0214_string02(String p) {
        this.entity0214_string02 = p;
    }

    public String getEntity0214_string03() {
        return entity0214_string03;
    }

    public void setEntity0214_string03(String p) {
        this.entity0214_string03 = p;
    }
}
