...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0305_SELECT",
                                    query = "SELECT e FROM Entity0305 e WHERE e.entity0305_id1 = :id1_0305 AND e.entity0305_id2 = :id2_0305 AND e.entity0305_id3 = :id3_0305")
              })
@Entity
@IdClass(IdClass0305.class)
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0305")
public class Entity0305 {
    ...
    @Version
    private Short entity0305_version;

    private String entity0305_string01;

    private String entity0305_string02;

    private String entity0305_string03;

    public Entity0305() {}

    public Entity0305(String id1,
                      double id2,
                      Double id3,
                      Short version,
                      String string01,
        ...
        this.entity0305_version = version;
        this.entity0305_string01 = string01;
        this.entity0305_string02 = string02;
        this.entity0305_string03 = string03;
    }
    ...
    public String toString() {
        return (" Entity0305: " +
                ...
                " entity0305_version: " + getEntity0305_version() +
                " entity0305_string01: " + getEntity0305_string01() +
                " entity0305_string02: " + getEntity0305_string02() +
                " entity0305_string03: " + getEntity0305_string03());
    }
    ...
    public void setEntity0305_id1(String p) {
        this.entity0305_id1 = p;
    }
    ...
    public void setEntity0305_id2(double p) {
        this.entity0305_id2 = p;
    }
    ...
    public void setEntity0305_id3(Double p) {
        this.entity0305_id3 = p;
    }

    public Short getEntity0305_version() {
        return entity0305_version;
    }

    public void setEntity0305_version(Short p) {
        this.entity0305_version = p;
    }

    public String getEntity0305_string01() {
        return entity0305_string01;
    }

    public void setEntity0305_string01(String p) {
        this.entity0305_string01 = p;
    }

    public String getEntity0305_string02() {
        return entity0305_string02;
    }

    public void setEntity0305_string02(String p) {
        this.entity0305_string02 = p;
    }

    public String getEntity0305_string03() {
        return entity0305_string03;
    }

    public void setEntity0305_string03(String p) {
        this.entity0305_string03 = p;
    }
}
