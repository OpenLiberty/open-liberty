...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0010_SELECT",
                                    query = "SELECT e FROM Entity0010 e WHERE e.entity0010_id = :id_0010"),
                        @NamedQuery(name = "ENTITY0010_UPDATE",
                                    query = "UPDATE Entity0010 e SET e.entity0010_string01 = :string01_0010, e.entity0010_string02 = :string02_0010, e.entity0010_string03 = :string03_0010 WHERE e.entity0010_id = :id_0010")
              })
@Entity
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0010")
public class Entity0010 {

    @Id
    private int entity0010_id;

    @Version
    private long entity0010_version;

    private String entity0010_string01;

    private String entity0010_string02;

    private String entity0010_string03;

    public Entity0010() {}

    public Entity0010(int id,
                      long version,
                      String string01,
                      String string02,
                      String string03) {
        this.entity0010_id = id;
        this.entity0010_version = version;
        this.entity0010_string01 = string01;
        this.entity0010_string02 = string02;
        this.entity0010_string03 = string03;
    }

    @Override
    public String toString() {
        return (" Entity0010: " +
                " entity0010_id: " + getEntity0010_id() +
                " entity0010_version: " + getEntity0010_version() +
                " entity0010_string01: " + getEntity0010_string01() +
                " entity0010_string02: " + getEntity0010_string02() +
                " entity0010_string03: " + getEntity0010_string03());
    }

    //----------------------------------------------------------------------------------------------
    // Persisent property accessor(s)
    //----------------------------------------------------------------------------------------------
    public int getEntity0010_id() {
        return entity0010_id;
    }

    public void setEntity0010_id(int p) {
        this.entity0010_id = p;
    }

    public long getEntity0010_version() {
        return entity0010_version;
    }

    public void setEntity0010_version(long p) {
        this.entity0010_version = p;
    }

    public String getEntity0010_string01() {
        return entity0010_string01;
    }

    public void setEntity0010_string01(String p) {
        this.entity0010_string01 = p;
    }

    public String getEntity0010_string02() {
        return entity0010_string02;
    }

    public void setEntity0010_string02(String p) {
        this.entity0010_string02 = p;
    }

    public String getEntity0010_string03() {
        return entity0010_string03;
    }

    public void setEntity0010_string03(String p) {
        this.entity0010_string03 = p;
    }
}
