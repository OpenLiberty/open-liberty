...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0111_SELECT",
                                    query = "SELECT e FROM Entity0111 e WHERE e.entity0111_id1 = :id1_0111 AND e.entity0111_id2 = :id2_0111")
              })
@Entity
@IdClass(IdClass0111.class)
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0111")
public class Entity0111 {
    ...
    @Version
    private Integer entity0111_version;

    private String entity0111_string01;

    private String entity0111_string02;

    private String entity0111_string03;

    public Entity0111() {}

    public Entity0111(Integer id1,
                      Integer id2,
                      Integer version,
                      String string01,
                      String string02,
        ...
        this.entity0111_version = version;
        this.entity0111_string01 = string01;
        this.entity0111_string02 = string02;
        this.entity0111_string03 = string03;
    }
    ...
    public String toString() {
        return (" Entity0111: " +
                ...
                " entity0111_version: " + getEntity0111_version() +
                " entity0111_string01: " + getEntity0111_string01() +
                " entity0111_string02: " + getEntity0111_string02() +
                " entity0111_string03: " + getEntity0111_string03());
    }
    ...
    public void setEntity0111_id1(Integer p) {
        this.entity0111_id1 = p;
    }
    ...
    public void setEntity0111_id2(Integer p) {
        this.entity0111_id2 = p;
    }

    public Integer getEntity0111_version() {
        return entity0111_version;
    }

    public void setEntity0111_version(Integer p) {
        this.entity0111_version = p;
    }

    public String getEntity0111_string01() {
        return entity0111_string01;
    }

    public void setEntity0111_string01(String p) {
        this.entity0111_string01 = p;
    }

    public String getEntity0111_string02() {
        return entity0111_string02;
    }

    public void setEntity0111_string02(String p) {
        this.entity0111_string02 = p;
    }

    public String getEntity0111_string03() {
        return entity0111_string03;
    }

    public void setEntity0111_string03(String p) {
        this.entity0111_string03 = p;
    }
}
