...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0346_SELECT",
                                    query = "SELECT e FROM Entity0346 e WHERE e.entity0346_id1 = :id1_0346 AND e.entity0346_id2 = :id2_0346 AND e.entity0346_id3 = :id3_0346")
              })
@Entity
@IdClass(IdClass0346.class)
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0346")
public class Entity0346 {
    ...
    @Version
    private short entity0346_version;

    private String entity0346_string01;

    private String entity0346_string02;

    private String entity0346_string03;

    public Entity0346() {}

    public Entity0346(int id1,
                      Long id2,
                      BigDecimal id3,
                      short version,
                      String string01,
        ...
        this.entity0346_version = version;
        this.entity0346_string01 = string01;
        this.entity0346_string02 = string02;
        this.entity0346_string03 = string03;
    }
    ...
    public String toString() {
        return (" Entity0346: " +
                ...
                " entity0346_version: " + getEntity0346_version() +
                " entity0346_string01: " + getEntity0346_string01() +
                " entity0346_string02: " + getEntity0346_string02() +
                " entity0346_string03: " + getEntity0346_string03());
    }
    ...
    public void setEntity0346_id1(int p) {
        this.entity0346_id1 = p;
    }
    ...
    public void setEntity0346_id2(Long p) {
        this.entity0346_id2 = p;
    }
    ...
    public void setEntity0346_id3(BigDecimal p) {
        this.entity0346_id3 = p;
    }

    public short getEntity0346_version() {
        return entity0346_version;
    }

    public void setEntity0346_version(short p) {
        this.entity0346_version = p;
    }

    public String getEntity0346_string01() {
        return entity0346_string01;
    }

    public void setEntity0346_string01(String p) {
        this.entity0346_string01 = p;
    }

    public String getEntity0346_string02() {
        return entity0346_string02;
    }

    public void setEntity0346_string02(String p) {
        this.entity0346_string02 = p;
    }

    public String getEntity0346_string03() {
        return entity0346_string03;
    }

    public void setEntity0346_string03(String p) {
        this.entity0346_string03 = p;
    }
}
