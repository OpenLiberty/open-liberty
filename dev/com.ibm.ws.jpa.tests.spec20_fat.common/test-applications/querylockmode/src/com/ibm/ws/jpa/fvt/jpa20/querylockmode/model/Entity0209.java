...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0209_SELECT",
                                    query = "SELECT e FROM Entity0209 e WHERE e.entity0209_id1 = :id1_0209 AND e.entity0209_id2 = :id2_0209 AND e.entity0209_id3 = :id3_0209")
              })
@Entity
@IdClass(IdClass0209.class)
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0209")
public class Entity0209 {
    ...
    @Version
    private short entity0209_version;

    private String entity0209_string01;

    private String entity0209_string02;

    private String entity0209_string03;

    public Entity0209() {}

    public Entity0209(Float id1,
                      Float id2,
                      Float id3,
                      short version,
                      String string01,
        ...
        this.entity0209_version = version;
        this.entity0209_string01 = string01;
        this.entity0209_string02 = string02;
        this.entity0209_string03 = string03;
    }
    ...
    public String toString() {
        return (" Entity0209: " +
                ...
                " entity0209_version: " + getEntity0209_version() +
                " entity0209_string01: " + getEntity0209_string01() +
                " entity0209_string02: " + getEntity0209_string02() +
                " entity0209_string03: " + getEntity0209_string03());
    }
    ...
    public void setEntity0209_id1(Float p) {
        this.entity0209_id1 = p;
    }
    ...
    public void setEntity0209_id2(Float p) {
        this.entity0209_id2 = p;
    }
    ...
    public void setEntity0209_id3(Float p) {
        this.entity0209_id3 = p;
    }

    public short getEntity0209_version() {
        return entity0209_version;
    }

    public void setEntity0209_version(short p) {
        this.entity0209_version = p;
    }

    public String getEntity0209_string01() {
        return entity0209_string01;
    }

    public void setEntity0209_string01(String p) {
        this.entity0209_string01 = p;
    }

    public String getEntity0209_string02() {
        return entity0209_string02;
    }

    public void setEntity0209_string02(String p) {
        this.entity0209_string02 = p;
    }

    public String getEntity0209_string03() {
        return entity0209_string03;
    }

    public void setEntity0209_string03(String p) {
        this.entity0209_string03 = p;
    }
}
