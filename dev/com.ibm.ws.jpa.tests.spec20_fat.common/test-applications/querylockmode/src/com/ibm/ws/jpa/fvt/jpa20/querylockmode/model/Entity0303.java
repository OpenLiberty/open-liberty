...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0303_SELECT",
                                    query = "SELECT e FROM Entity0303 e WHERE e.entity0303_id1 = :id1_0303 AND e.entity0303_id2 = :id2_0303 AND e.entity0303_id3 = :id3_0303")
              })
@Entity
@IdClass(IdClass0303.class)
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0303")
public class Entity0303 {
    ...
    @Version
    private Long entity0303_version;

    private String entity0303_string01;

    private String entity0303_string02;

    private String entity0303_string03;

    public Entity0303() {}

    public Entity0303(char id1,
                      Character id2,
                      String id3,
                      Long version,
                      String string01,
        ...
        this.entity0303_version = version;
        this.entity0303_string01 = entity0303_string01;
        this.entity0303_string02 = entity0303_string02;
        this.entity0303_string03 = entity0303_string03;
    }
    ...
    public String toString() {
        return (" Entity0303: " +
                ...
                " entity0303_version: " + getEntity0303_version() +
                " entity0303_string01: " + getEntity0303_string01() +
                " entity0303_string02: " + getEntity0303_string02() +
                " entity0303_string03: " + getEntity0303_string03());
    }
    ...
    public void setEntity0303_id1(char p) {
        this.entity0303_id1 = p;
    }
    ...
    public void setEntity0303_id2(Character p) {
        this.entity0303_id2 = p;
    }
    ...
    public void setEntity0303_id3(String p) {
        this.entity0303_id3 = p;
    }

    public Long getEntity0303_version() {
        return entity0303_version;
    }

    public void setEntity0303_version(Long p) {
        this.entity0303_version = p;
    }

    public String getEntity0303_string01() {
        return entity0303_string01;
    }

    public void setEntity0303_string01(String p) {
        this.entity0303_string01 = p;
    }

    public String getEntity0303_string02() {
        return entity0303_string02;
    }

    public void setEntity0303_string02(String p) {
        this.entity0303_string02 = p;
    }

    public String getEntity0303_string03() {
        return entity0303_string03;
    }

    public void setEntity0303_string03(String p) {
        this.entity0303_string03 = p;
    }
}
