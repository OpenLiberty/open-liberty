...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0008_SELECT",
                                    query = "SELECT e FROM Entity0008 e WHERE e.entity0008_id = :id_0008"),
                        @NamedQuery(name = "ENTITY0008_UPDATE",
                                    query = "UPDATE Entity0008 e SET e.entity0008_string01 = :string01_0008, e.entity0008_string02 = :string02_0008, e.entity0008_string03 = :string03_0008 WHERE e.entity0008_id = :id_0008")
              })
@Entity
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0008")
public class Entity0008 {

    @Id
    private float entity0008_id;

    @Version
    private int entity0008_version;

    private String entity0008_string01;

    private String entity0008_string02;

    private String entity0008_string03;

    public Entity0008() {}

    public Entity0008(float id,
                      int version,
                      String string01,
                      String string02,
                      String string03) {
        this.entity0008_id = id;
        this.entity0008_version = version;
        this.entity0008_string01 = string01;
        this.entity0008_string02 = string02;
        this.entity0008_string03 = string03;
    }

    @Override
    public String toString() {
        return (" Entity0008: " +
                " entity0008_id: " + getEntity0008_id() +
                " entity0008_version: " + getEntity0008_version() +
                " entity0008_string01: " + getEntity0008_string01() +
                " entity0008_string02: " + getEntity0008_string02() +
                " entity0008_string03: " + getEntity0008_string03());
    }

    //----------------------------------------------------------------------------------------------
    // Persisent property accessor(s)
    //----------------------------------------------------------------------------------------------
    public float getEntity0008_id() {
        return entity0008_id;
    }

    public void setEntity0008_id(float p) {
        this.entity0008_id = p;
    }

    public int getEntity0008_version() {
        return entity0008_version;
    }

    public void setEntity0008_version(int p) {
        this.entity0008_version = p;
    }

    public String getEntity0008_string01() {
        return entity0008_string01;
    }

    public void setEntity0008_string01(String p) {
        this.entity0008_string01 = p;
    }

    public String getEntity0008_string02() {
        return entity0008_string02;
    }

    public void setEntity0008_string02(String p) {
        this.entity0008_string02 = p;
    }

    public String getEntity0008_string03() {
        return entity0008_string03;
    }

    public void setEntity0008_string03(String p) {
        this.entity0008_string03 = p;
    }
}
