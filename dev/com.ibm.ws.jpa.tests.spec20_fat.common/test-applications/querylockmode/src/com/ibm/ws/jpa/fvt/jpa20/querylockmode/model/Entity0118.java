...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0118_SELECT",
                                    query = "SELECT e FROM Entity0118 e WHERE e.entity0118_id1 = :id1_0118 AND e.entity0118_id2 = :id2_0118")
              })
@Entity
@IdClass(IdClass0118.class)
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0118")
public class Entity0118 {
    ...
    @Version
    private Integer entity0118_version;

    private String entity0118_string01;

    private String entity0118_string02;

    private String entity0118_string03;

    public Entity0118() {}

    public Entity0118(java.util.Date id1,
                      java.util.Date id2,
                      Integer version,
                      String string01,
                      String string02,
        ...
        this.entity0118_version = version;
        this.entity0118_string01 = string01;
        this.entity0118_string02 = string02;
        this.entity0118_string03 = string03;
    }
    ...
    public String toString() {
        return (" Entity0118: " +
                ...
                " entity0118_version: " + getEntity0118_version() +
                " entity0118_string01: " + getEntity0118_string01() +
                " entity0118_string02: " + getEntity0118_string02() +
                " entity0118_string03: " + getEntity0118_string03());
    }
    ...
    public void setEntity0118_id1(java.util.Date p) {
        this.entity0118_id1 = p;
    }
    ...
    public void setEntity0118_id2(java.util.Date p) {
        this.entity0118_id2 = p;
    }

    public Integer getEntity0118_version() {
        return entity0118_version;
    }

    public void setEntity0118_version(Integer p) {
        this.entity0118_version = p;
    }

    public String getEntity0118_string01() {
        return entity0118_string01;
    }

    public void setEntity0118_string01(String p) {
        this.entity0118_string01 = p;
    }

    public String getEntity0118_string02() {
        return entity0118_string02;
    }

    public void setEntity0118_string02(String p) {
        this.entity0118_string02 = p;
    }

    public String getEntity0118_string03() {
        return entity0118_string03;
    }

    public void setEntity0118_string03(String p) {
        this.entity0118_string03 = p;
    }
}
