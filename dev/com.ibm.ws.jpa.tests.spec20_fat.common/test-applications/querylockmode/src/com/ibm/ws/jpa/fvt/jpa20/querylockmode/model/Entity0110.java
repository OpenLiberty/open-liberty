...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0110_SELECT",
                                    query = "SELECT e FROM Entity0110 e WHERE e.entity0110_id1 = :id1_0110 AND e.entity0110_id2 = :id2_0110")
              })
@Entity
@IdClass(IdClass0110.class)
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0110")
public class Entity0110 {
    ...
    @Version
    private int entity0110_version;

    private String entity0110_string01;

    private String entity0110_string02;

    private String entity0110_string03;

    public Entity0110() {}

    public Entity0110(int id1,
                      int id2,
                      int version,
                      String string01,
                      String string02,
        ...
        this.entity0110_version = version;
        this.entity0110_string01 = string01;
        this.entity0110_string02 = string02;
        this.entity0110_string03 = string03;
    }
    ...
    public String toString() {
        return (" Entity0110: " +
                ...
                " entity0110_version: " + getEntity0110_version() +
                " entity0110_string01: " + getEntity0110_string01() +
                " entity0110_string02: " + getEntity0110_string02() +
                " entity0110_string03: " + getEntity0110_string03());
    }
    ...
    public void setEntity0110_id1(int p) {
        this.entity0110_id1 = p;
    }
    ...
    public void setEntity0110_id2(int p) {
        this.entity0110_id2 = p;
    }

    public int getEntity0110_version() {
        return entity0110_version;
    }

    public void setEntity0110_version(int p) {
        this.entity0110_version = p;
    }

    public String getEntity0110_string01() {
        return entity0110_string01;
    }

    public void setEntity0110_string01(String p) {
        this.entity0110_string01 = p;
    }

    public String getEntity0110_string02() {
        return entity0110_string02;
    }

    public void setEntity0110_string02(String p) {
        this.entity0110_string02 = p;
    }

    public String getEntity0110_string03() {
        return entity0110_string03;
    }

    public void setEntity0110_string03(String p) {
        this.entity0110_string03 = p;
    }
}
