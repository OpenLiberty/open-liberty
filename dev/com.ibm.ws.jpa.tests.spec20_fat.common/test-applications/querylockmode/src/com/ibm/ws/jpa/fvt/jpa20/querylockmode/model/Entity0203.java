...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0203_SELECT",
                                    query = "SELECT e FROM Entity0203 e WHERE e.entity0203_id1 = :id1_0203 AND e.entity0203_id2 = :id2_0203 AND e.entity0203_id3 = :id3_0203")
              })
@Entity
@IdClass(IdClass0203.class)
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0203")
public class Entity0203 {
    ...
    @Version
    private Short entity0203_version;

    private String entity0203_string01;

    private String entity0203_string02;

    private String entity0203_string03;

    public Entity0203() {}

    public Entity0203(char id1,
                      char id2,
                      char id3,
                      Short version,
                      String string01,
        ...
        this.entity0203_version = version;
        this.entity0203_string01 = string01;
        this.entity0203_string02 = string02;
        this.entity0203_string03 = string03;
    }
    ...
    public String toString() {
        return (" Entity0203: " +
                ...
                " entity0203_version: " + getEntity0203_version() +
                " entity0203_string01: " + getEntity0203_string01() +
                " entity0203_string02: " + getEntity0203_string02() +
                " entity0203_string03: " + getEntity0203_string03());
    }
    ...
    public void setEntity0203_id1(char p) {
        this.entity0203_id1 = p;
    }
    ...
    public void setEntity0203_id2(char p) {
        this.entity0203_id2 = p;
    }
    ...
    public void setEntity0203_id3(char p) {
        this.entity0203_id3 = p;
    }

    public Short getEntity0203_version() {
        return entity0203_version;
    }

    public void setEntity0203_version(Short p) {
        this.entity0203_version = p;
    }

    public String getEntity0203_string01() {
        return entity0203_string01;
    }

    public void setEntity0203_string01(String p) {
        this.entity0203_string01 = p;
    }

    public String getEntity0203_string02() {
        return entity0203_string02;
    }

    public void setEntity0203_string02(String p) {
        this.entity0203_string02 = p;
    }

    public String getEntity0203_string03() {
        return entity0203_string03;
    }

    public void setEntity0203_string03(String p) {
        this.entity0203_string03 = p;
    }
}
