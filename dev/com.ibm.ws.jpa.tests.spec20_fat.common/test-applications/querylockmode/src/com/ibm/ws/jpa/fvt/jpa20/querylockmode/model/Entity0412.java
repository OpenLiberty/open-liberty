...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0412_SELECT",
                                    query = "SELECT e FROM Entity0412 e WHERE e.entity0412_id = :id_0412")
              })
@Entity
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0412")
public class Entity0412 {

    @Id
    @OneToOne
    private Entity0012 entity0412_id;

    @Version
    private int entity0412_version;

    private String entity0412_string01;

    private String entity0412_string02;

    private String entity0412_string03;

    public Entity0412() {}

    public Entity0412(Entity0012 id,
                      int version,
                      String string01,
                      String string02,
                      String string03) {
        this.entity0412_id = id;
        this.entity0412_version = version;
        this.entity0412_string01 = string01;
        this.entity0412_string02 = string02;
        this.entity0412_string03 = string03;
    }

    @Override
    public String toString() {
        return (" Entity0412: " +
                " entity0412_id: " + getEntity0412_id() +
                " entity0412_version: " + getEntity0412_version() +
                " entity0412_string01: " + getEntity0412_string01() +
                " entity0412_string02: " + getEntity0412_string02() +
                " entity0412_string03: " + getEntity0412_string03());
    }

    //----------------------------------------------------------------------------------------------
    // Persisent property accessor(s)
    //----------------------------------------------------------------------------------------------
    public Entity0012 getEntity0412_id() {
        return entity0412_id;
    }

    public void setEntity0412_id(Entity0012 p) {
        this.entity0412_id = p;
    }

    public int getEntity0412_version() {
        return entity0412_version;
    }

    public void setEntity0412_version(int p) {
        this.entity0412_version = p;
    }

    public String getEntity0412_string01() {
        return entity0412_string01;
    }

    public void setEntity0412_string01(String p) {
        this.entity0412_string01 = p;
    }

    public String getEntity0412_string02() {
        return entity0412_string02;
    }

    public void setEntity0412_string02(String p) {
        this.entity0412_string02 = p;
    }

    public String getEntity0412_string03() {
        return entity0412_string03;
    }

    public void setEntity0412_string03(String p) {
        this.entity0412_string03 = p;
    }
}
