...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0347_SELECT",
                                    query = "SELECT e FROM Entity0347 e WHERE e.entity0347_id1 = :id1_0347 AND e.entity0347_id2 = :id2_0347 AND e.entity0347_id3 = :id3_0347")
              })
@Entity
@IdClass(IdClass0347.class)
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0347")
public class Entity0347 {
    ...
    @Version
    private Short entity0347_version;

    private String entity0347_string01;

    private String entity0347_string02;

    private String entity0347_string03;

    public Entity0347() {}

    public Entity0347(Integer id1,
                      short id2,
                      BigInteger id3,
                      Short version,
                      String string01,
        ...
        this.entity0347_version = version;
        this.entity0347_string01 = string01;
        this.entity0347_string02 = string02;
        this.entity0347_string03 = string03;
    }
    ...
    public String toString() {
        return (" Entity0347: " +
                ...
                " entity0347_version: " + getEntity0347_version() +
                " entity0347_string01: " + getEntity0347_string01() +
                " entity0347_string02: " + getEntity0347_string02() +
                " entity0347_string03: " + getEntity0347_string03());
    }
    ...
    public void setEntity0347_id1(Integer p) {
        this.entity0347_id1 = p;
    }
    ...
    public void setEntity0347_id2(short p) {
        this.entity0347_id2 = p;
    }
    ...
    public void setEntity0347_id3(BigInteger p) {
        this.entity0347_id3 = p;
    }

    public Short getEntity0347_version() {
        return entity0347_version;
    }

    public void setEntity0347_version(Short p) {
        this.entity0347_version = p;
    }

    public String getEntity0347_string01() {
        return entity0347_string01;
    }

    public void setEntity0347_string01(String p) {
        this.entity0347_string01 = p;
    }

    public String getEntity0347_string02() {
        return entity0347_string02;
    }

    public void setEntity0347_string02(String p) {
        this.entity0347_string02 = p;
    }

    public String getEntity0347_string03() {
        return entity0347_string03;
    }

    public void setEntity0347_string03(String p) {
        this.entity0347_string03 = p;
    }
}
