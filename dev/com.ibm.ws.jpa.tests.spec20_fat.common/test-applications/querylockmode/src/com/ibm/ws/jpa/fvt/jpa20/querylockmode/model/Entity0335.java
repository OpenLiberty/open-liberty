...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0335_SELECT",
                                    query = "SELECT e FROM Entity0335 e WHERE e.entity0335_id1 = :id1_0335 AND e.entity0335_id2 = :id2_0335 AND e.entity0335_id3 = :id3_0335")
              })
@Entity
@IdClass(IdClass0335.class)
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0335")
public class Entity0335 {
    ...
    @Version
    private int entity0335_version;

    private String entity0335_string01;

    private String entity0335_string02;

    private String entity0335_string03;

    public Entity0335() {}

    public Entity0335(BigDecimal id1,
                      java.util.Date id2,
                      java.sql.Date id3,
                      int version,
                      String string01,
        ...
        this.entity0335_version = version;
        this.entity0335_string01 = string01;
        this.entity0335_string02 = string02;
        this.entity0335_string03 = string03;
    }
    ...
    public String toString() {
        return (" Entity0335: " +
                ...
                " entity0335_version: " + getEntity0335_version() +
                " entity0335_string01: " + getEntity0335_string01() +
                " entity0335_string02: " + getEntity0335_string02() +
                " entity0335_string03: " + getEntity0335_string03());
    }
    ...
    public void setEntity0335_id1(BigDecimal p) {
        this.entity0335_id1 = p;
    }
    ...
    public void setEntity0335_id2(java.util.Date p) {
        this.entity0335_id2 = p;
    }
    ...
    public void setEntity0335_id3(java.sql.Date p) {
        this.entity0335_id3 = p;
    }

    public int getEntity0335_version() {
        return entity0335_version;
    }

    public void setEntity0335_version(int p) {
        this.entity0335_version = p;
    }

    public String getEntity0335_string01() {
        return entity0335_string01;
    }

    public void setEntity0335_string01(String p) {
        this.entity0335_string01 = p;
    }

    public String getEntity0335_string02() {
        return entity0335_string02;
    }

    public void setEntity0335_string02(String p) {
        this.entity0335_string02 = p;
    }

    public String getEntity0335_string03() {
        return entity0335_string03;
    }

    public void setEntity0335_string03(String p) {
        this.entity0335_string03 = p;
    }
}
