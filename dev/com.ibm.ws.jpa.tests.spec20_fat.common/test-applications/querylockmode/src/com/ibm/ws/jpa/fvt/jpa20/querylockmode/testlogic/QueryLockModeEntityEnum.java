...
public enum QueryLockModeEntityEnum implements JPAEntityClassEnum {
    Entity0001 {
        @Override
    ...
    public static QueryLockModeEntityEnum resolveEntityByName(String entityName) {
        return QueryLockModeEntityEnum.valueOf(entityName);
    }
}
