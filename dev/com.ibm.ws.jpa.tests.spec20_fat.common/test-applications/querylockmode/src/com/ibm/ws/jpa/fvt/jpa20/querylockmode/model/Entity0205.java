...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0205_SELECT",
                                    query = "SELECT e FROM Entity0205 e WHERE e.entity0205_id1 = :id1_0205 AND e.entity0205_id2 = :id2_0205 AND e.entity0205_id3 = :id3_0205")
              })
@Entity
@IdClass(IdClass0205.class)
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0205")
public class Entity0205 {
    ...
    @Version
    private int entity0205_version;

    private String entity0205_string01;

    private String entity0205_string02;

    private String entity0205_string03;

    public Entity0205() {}

    public Entity0205(String id1,
                      String id2,
                      String id3,
                      int version,
                      String string01,
        ...
        this.entity0205_version = version;
        this.entity0205_string01 = string01;
        this.entity0205_string02 = string02;
        this.entity0205_string03 = string03;
    }
    ...
    public String toString() {
        return (" Entity0205: " +
                ...
                " entity0205_version: " + getEntity0205_version() +
                " entity0205_string01: " + getEntity0205_string01() +
                " entity0205_string02: " + getEntity0205_string02() +
                " entity0205_string03: " + getEntity0205_string03());
    }
    ...
    public void setEntity0205_id1(String p) {
        this.entity0205_id1 = p;
    }
    ...
    public void setEntity0205_id2(String p) {
        this.entity0205_id2 = p;
    }
    ...
    public void setEntity0205_id3(String p) {
        this.entity0205_id3 = p;
    }

    public int getEntity0205_version() {
        return entity0205_version;
    }

    public void setEntity0205_version(int p) {
        this.entity0205_version = p;
    }

    public String getEntity0205_string01() {
        return entity0205_string01;
    }

    public void setEntity0205_string01(String p) {
        this.entity0205_string01 = p;
    }

    public String getEntity0205_string02() {
        return entity0205_string02;
    }

    public void setEntity0205_string02(String p) {
        this.entity0205_string02 = p;
    }

    public String getEntity0205_string03() {
        return entity0205_string03;
    }

    public void setEntity0205_string03(String p) {
        this.entity0205_string03 = p;
    }
}
