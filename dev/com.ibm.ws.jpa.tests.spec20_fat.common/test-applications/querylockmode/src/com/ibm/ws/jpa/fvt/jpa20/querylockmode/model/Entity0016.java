...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0016_SELECT",
                                    query = "SELECT e FROM Entity0016 e WHERE e.entity0016_id = :id_0016"),
                        @NamedQuery(name = "ENTITY0016_UPDATE",
                                    query = "UPDATE Entity0016 e SET e.entity0016_string01 = :string01_0016, e.entity0016_string02 = :string02_0016, e.entity0016_string03 = :string03_0016 WHERE e.entity0016_id = :id_0016")
              })
@Entity
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0016")
public class Entity0016 {
    ...
    @Version
    private Integer entity0016_version;

    private String entity0016_string01;

    private String entity0016_string02;

    private String entity0016_string03;

    public Entity0016() {}

    public Entity0016(BigDecimal id,
                      Integer version,
                      String string01,
                      String string02,
                      String string03) {
        this.entity0016_id = id;
        this.entity0016_version = version;
        this.entity0016_string01 = string01;
        this.entity0016_string02 = string02;
        this.entity0016_string03 = string03;
    }

    @Override
    public String toString() {
        return (" Entity0016: " +
                " entity0016_id: " + getEntity0016_id() +
                " entity0016_version: " + getEntity0016_version() +
                " entity0016_string01: " + getEntity0016_string01() +
                " entity0016_string02: " + getEntity0016_string02() +
                " entity0016_string03: " + getEntity0016_string03());
    }

    //----------------------------------------------------------------------------------------------
    // Persisent property accessor(s)
    //----------------------------------------------------------------------------------------------
    public BigDecimal getEntity0016_id() {
        return entity0016_id;
    }

    public void setEntity0016_id(BigDecimal p) {
        this.entity0016_id = p;
    }

    public Integer getEntity0016_version() {
        return entity0016_version;
    }

    public void setEntity0016_version(Integer p) {
        this.entity0016_version = p;
    }

    public String getEntity0016_string01() {
        return entity0016_string01;
    }

    public void setEntity0016_string01(String p) {
        this.entity0016_string01 = p;
    }

    public String getEntity0016_string02() {
        return entity0016_string02;
    }

    public void setEntity0016_string02(String p) {
        this.entity0016_string02 = p;
    }

    public String getEntity0016_string03() {
        return entity0016_string03;
    }

    public void setEntity0016_string03(String p) {
        this.entity0016_string03 = p;
    }
}
