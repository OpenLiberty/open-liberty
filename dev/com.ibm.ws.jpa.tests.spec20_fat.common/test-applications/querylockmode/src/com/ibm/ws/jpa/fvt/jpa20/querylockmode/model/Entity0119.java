...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0119_SELECT",
                                    query = "SELECT e FROM Entity0119 e WHERE e.entity0119_id1 = :id1_0119 AND e.entity0119_id2 = :id2_0119")
              })
@Entity
@IdClass(IdClass0119.class)
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0119")
public class Entity0119 {
    ...
    @Version
    private long entity0119_version;

    private String entity0119_string01;

    private String entity0119_string02;

    private String entity0119_string03;

    public Entity0119() {}

    public Entity0119(java.sql.Date id1,
                      java.sql.Date id2,
                      long version,
                      String string01,
                      String string02,
        ...
        this.entity0119_version = version;
        this.entity0119_string01 = string01;
        this.entity0119_string02 = string02;
        this.entity0119_string03 = string03;
    }
    ...
    public String toString() {
        return (" Entity0119: " +
                ...
                " entity0119_version: " + getEntity0119_version() +
                " entity0119_string01: " + getEntity0119_string01() +
                " entity0119_string02: " + getEntity0119_string02() +
                " entity0119_string03: " + getEntity0119_string03());
    }
    ...
    public void setEntity0119_id1(java.sql.Date p) {
        this.entity0119_id1 = p;
    }
    ...
    public void setEntity0119_id2(java.sql.Date p) {
        this.entity0119_id2 = p;
    }

    public long getEntity0119_version() {
        return entity0119_version;
    }

    public void setEntity0119_version(long p) {
        this.entity0119_version = p;
    }

    public String getEntity0119_string01() {
        return entity0119_string01;
    }

    public void setEntity0119_string01(String p) {
        this.entity0119_string01 = p;
    }

    public String getEntity0119_string02() {
        return entity0119_string02;
    }

    public void setEntity0119_string02(String p) {
        this.entity0119_string02 = p;
    }

    public String getEntity0119_string03() {
        return entity0119_string03;
    }

    public void setEntity0119_string03(String p) {
        this.entity0119_string03 = p;
    }
}
