...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0336_SELECT",
                                    query = "SELECT e FROM Entity0336 e WHERE e.entity0336_id1 = :id1_0336 AND e.entity0336_id2 = :id2_0336 AND e.entity0336_id3 = :id3_0336")
              })
@Entity
@IdClass(IdClass0336.class)
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0336")
public class Entity0336 {
    ...
    @Version
    private Integer entity0336_version;

    private String entity0336_string01;

    private String entity0336_string02;

    private String entity0336_string03;

    public Entity0336() {}

    public Entity0336(BigDecimal id1,
                      java.sql.Date id2,
                      java.util.Date id3,
                      Integer version,
                      String string01,
        ...
        this.entity0336_version = version;
        this.entity0336_string01 = string01;
        this.entity0336_string02 = string02;
        this.entity0336_string03 = string03;
    }
    ...
    public String toString() {
        return (" Entity0336: " +
                ...
                " entity0336_version: " + getEntity0336_version() +
                " entity0336_string01: " + getEntity0336_string01() +
                " entity0336_string02: " + getEntity0336_string02() +
                " entity0336_string03: " + getEntity0336_string03());
    }
    ...
    public void setEntity0336_id1(BigDecimal p) {
        this.entity0336_id1 = p;
    }
    ...
    public void setEntity0336_id2(java.sql.Date p) {
        this.entity0336_id2 = p;
    }
    ...
    public void setEntity0336_id3(java.util.Date p) {
        this.entity0336_id3 = p;
    }

    public Integer getEntity0336_version() {
        return entity0336_version;
    }

    public void setEntity0336_version(Integer p) {
        this.entity0336_version = p;
    }

    public String getEntity0336_string01() {
        return entity0336_string01;
    }

    public void setEntity0336_string01(String p) {
        this.entity0336_string01 = p;
    }

    public String getEntity0336_string02() {
        return entity0336_string02;
    }

    public void setEntity0336_string02(String p) {
        this.entity0336_string02 = p;
    }

    public String getEntity0336_string03() {
        return entity0336_string03;
    }

    public void setEntity0336_string03(String p) {
        this.entity0336_string03 = p;
    }
}
