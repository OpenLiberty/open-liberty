...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0337_SELECT",
                                    query = "SELECT e FROM Entity0337 e WHERE e.entity0337_id1 = :id1_0337 AND e.entity0337_id2 = :id2_0337 AND e.entity0337_id3 = :id3_0337")
              })
@Entity
@IdClass(IdClass0337.class)
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0337")
public class Entity0337 {
    ...
    @Version
    private long entity0337_version;

    private String entity0337_string01;

    private String entity0337_string02;

    private String entity0337_string03;

    public Entity0337() {}

    public Entity0337(byte id1,
                      Character id2,
                      Double id3,
                      long version,
                      String string01,
        ...
        this.entity0337_version = version;
        this.entity0337_string01 = string01;
        this.entity0337_string02 = string02;
        this.entity0337_string03 = string03;
    }
    ...
    public String toString() {
        return (" Entity0337: " +
                ...
                " entity0337_version: " + getEntity0337_version() +
                " entity0337_string01: " + getEntity0337_string01() +
                " entity0337_string02: " + getEntity0337_string02() +
                " entity0337_string03: " + getEntity0337_string03());
    }
    ...
    public void setEntity0337_id1(byte p) {
        this.entity0337_id1 = p;
    }
    ...
    public void setEntity0337_id2(Character p) {
        this.entity0337_id2 = p;
    }
    ...
    public void setEntity0337_id3(Double p) {
        this.entity0337_id3 = p;
    }

    public long getEntity0337_version() {
        return entity0337_version;
    }

    public void setEntity0337_version(long p) {
        this.entity0337_version = p;
    }

    public String getEntity0337_string01() {
        return entity0337_string01;
    }

    public void setEntity0337_string01(String p) {
        this.entity0337_string01 = p;
    }

    public String getEntity0337_string02() {
        return entity0337_string02;
    }

    public void setEntity0337_string02(String p) {
        this.entity0337_string02 = p;
    }

    public String getEntity0337_string03() {
        return entity0337_string03;
    }

    public void setEntity0337_string03(String p) {
        this.entity0337_string03 = p;
    }
}
