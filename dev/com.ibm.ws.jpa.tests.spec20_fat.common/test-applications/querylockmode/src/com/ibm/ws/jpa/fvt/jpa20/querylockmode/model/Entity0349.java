...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0349_SELECT",
                                    query = "SELECT e FROM Entity0349 e WHERE e.entity0349_id1 = :id1_0349 AND e.entity0349_id2 = :id2_0349 AND e.entity0349_id3 = :id3_0349")
              })
@Entity
@IdClass(IdClass0349.class)
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0349")
public class Entity0349 {
    ...
    @Version
    private int entity0349_version;

    private String entity0349_string01;

    private String entity0349_string02;

    private String entity0349_string03;

    public Entity0349() {}

    public Entity0349(Long id1,
                      BigDecimal id2,
                      java.sql.Date id3,
                      int version,
                      String string01,
        ...
        this.entity0349_version = version;
        this.entity0349_string01 = string01;
        this.entity0349_string02 = string02;
        this.entity0349_string03 = string03;
    }
    ...
    public String toString() {
        return (" Entity0349: " +
                ...
                " entity0349_version: " + getEntity0349_version() +
                " entity0349_string01: " + getEntity0349_string01() +
                " entity0349_string02: " + getEntity0349_string02() +
                " entity0349_string03: " + getEntity0349_string03());
    }
    ...
    public void setEntity0349_id1(Long p) {
        this.entity0349_id1 = p;
    }
    ...
    public void setEntity0349_id2(BigDecimal p) {
        this.entity0349_id2 = p;
    }
    ...
    public void setEntity0349_id3(java.sql.Date p) {
        this.entity0349_id3 = p;
    }

    public int getEntity0349_version() {
        return entity0349_version;
    }

    public void setEntity0349_version(int p) {
        this.entity0349_version = p;
    }

    public String getEntity0349_string01() {
        return entity0349_string01;
    }

    public void setEntity0349_string01(String p) {
        this.entity0349_string01 = p;
    }

    public String getEntity0349_string02() {
        return entity0349_string02;
    }

    public void setEntity0349_string02(String p) {
        this.entity0349_string02 = p;
    }

    public String getEntity0349_string03() {
        return entity0349_string03;
    }

    public void setEntity0349_string03(String p) {
        this.entity0349_string03 = p;
    }
}
