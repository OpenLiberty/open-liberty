...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0109_SELECT",
                                    query = "SELECT e FROM Entity0109 e WHERE e.entity0109_id1 = :id1_0109 AND e.entity0109_id2 = :id2_0109")
              })
@Entity
@IdClass(IdClass0109.class)
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0109")
public class Entity0109 {

    @Id
    private Float entity0109_id1;

    @Id
    private Float entity0109_id2;

    @Version
    private Timestamp entity0109_version;

    private String entity0109_string01;

    private String entity0109_string02;

    private String entity0109_string03;

    public Entity0109() {}

    public Entity0109(Float id1,
                      Float id2,
                      Timestamp version,
                      String string01,
                      String string02,
                      String string03) {
        this.entity0109_id1 = id1;
        this.entity0109_id2 = id2;
        this.entity0109_version = version;
        this.entity0109_string01 = string01;
        this.entity0109_string02 = string02;
        this.entity0109_string03 = string03;
    }

    @Override
    public String toString() {
        return (" Entity0109: " +
                " entity0109_id1: " + getEntity0109_id1() +
                " entity0109_id2: " + getEntity0109_id2() +
                " entity0109_version: " + getEntity0109_version() +
                " entity0109_string01: " + getEntity0109_string01() +
                " entity0109_string02: " + getEntity0109_string02() +
                " entity0109_string03: " + getEntity0109_string03());
    }

    //----------------------------------------------------------------------------------------------
    // Persisent property accessor(s)
    //----------------------------------------------------------------------------------------------
    public Float getEntity0109_id1() {
        return entity0109_id1;
    }

    public void setEntity0109_id1(Float p) {
        this.entity0109_id1 = p;
    }

    public Float getEntity0109_id2() {
        return entity0109_id2;
    }

    public void setEntity0109_id2(Float p) {
        this.entity0109_id2 = p;
    }

    public Timestamp getEntity0109_version() {
        return entity0109_version;
    }

    public void setEntity0109_version(Timestamp p) {
        this.entity0109_version = p;
    }

    public String getEntity0109_string01() {
        return entity0109_string01;
    }

    public void setEntity0109_string01(String p) {
        this.entity0109_string01 = p;
    }

    public String getEntity0109_string02() {
        return entity0109_string02;
    }

    public void setEntity0109_string02(String p) {
        this.entity0109_string02 = p;
    }

    public String getEntity0109_string03() {
        return entity0109_string03;
    }

    public void setEntity0109_string03(String p) {
        this.entity0109_string03 = p;
    }
}
