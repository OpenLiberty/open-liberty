...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0015_SELECT",
                                    query = "SELECT e FROM Entity0015 e WHERE e.entity0015_id = :id_0015"),
                        @NamedQuery(name = "ENTITY0015_UPDATE",
                                    query = "UPDATE Entity0015 e SET e.entity0015_string01 = :string01_0015, e.entity0015_string02 = :string02_0015, e.entity0015_string03 = :string03_0015 WHERE e.entity0015_id = :id_0015")
              })
@Entity
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0015")
public class Entity0015 {

    @Id
    private Short entity0015_id;

    @Version
    private int entity0015_version;

    private String entity0015_string01;

    private String entity0015_string02;

    private String entity0015_string03;

    public Entity0015() {}

    public Entity0015(Short id,
                      int version,
                      String string01,
                      String string02,
                      String string03) {
        this.entity0015_id = id;
        this.entity0015_version = version;
        this.entity0015_string01 = string01;
        this.entity0015_string02 = string02;
        this.entity0015_string03 = string03;
    }

    @Override
    public String toString() {
        return (" Entity0015: " +
                " entity0015_id: " + getEntity0015_id() +
                " entity0015_version: " + getEntity0015_version() +
                " entity0015_string01: " + getEntity0015_string01() +
                " entity0015_string02: " + getEntity0015_string02() +
                " entity0015_string03: " + getEntity0015_string03());
    }

    //----------------------------------------------------------------------------------------------
    // Persisent property accessor(s)
    //----------------------------------------------------------------------------------------------
    public Short getEntity0015_id() {
        return entity0015_id;
    }

    public void setEntity0015_id(Short p) {
        this.entity0015_id = p;
    }

    public int getEntity0015_version() {
        return entity0015_version;
    }

    public void setEntity0015_version(int p) {
        this.entity0015_version = p;
    }

    public String getEntity0015_string01() {
        return entity0015_string01;
    }

    public void setEntity0015_string01(String p) {
        this.entity0015_string01 = p;
    }

    public String getEntity0015_string02() {
        return entity0015_string02;
    }

    public void setEntity0015_string02(String p) {
        this.entity0015_string02 = p;
    }

    public String getEntity0015_string03() {
        return entity0015_string03;
    }

    public void setEntity0015_string03(String p) {
        this.entity0015_string03 = p;
    }
}
