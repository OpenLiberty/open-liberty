...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0219_SELECT",
                                    query = "SELECT e FROM Entity0219 e WHERE e.entity0219_id1 = :id1_0219 AND e.entity0219_id2 = :id2_0219 AND e.entity0219_id3 = :id3_0219")
              })
@Entity
@IdClass(IdClass0219.class)
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0219")
public class Entity0219 {
    ...
    @Version
    private int entity0219_version;

    private String entity0219_string01;

    private String entity0219_string02;

    private String entity0219_string03;

    public Entity0219() {}

    public Entity0219(java.sql.Date id1,
                      java.sql.Date id2,
                      java.sql.Date id3,
                      int version,
                      String string01,
        ...
        this.entity0219_version = version;
        this.entity0219_string01 = string01;
        this.entity0219_string02 = string02;
        this.entity0219_string03 = string03;
    }
    ...
    public String toString() {
        return (" Entity0219: " +
                ...
                " entity0219_version: " + getEntity0219_version() +
                " entity0219_string01: " + getEntity0219_string01() +
                " entity0219_string02: " + getEntity0219_string02() +
                " entity0219_string03: " + getEntity0219_string03());
    }
    ...
    public void setEntity0219_id1(java.sql.Date p) {
        this.entity0219_id1 = p;
    }
    ...
    public void setEntity0219_id2(java.sql.Date p) {
        this.entity0219_id2 = p;
    }
    ...
    public void setEntity0219_id3(java.sql.Date p) {
        this.entity0219_id3 = p;
    }

    public int getEntity0219_version() {
        return entity0219_version;
    }

    public void setEntity0219_version(int p) {
        this.entity0219_version = p;
    }

    public String getEntity0219_string01() {
        return entity0219_string01;
    }

    public void setEntity0219_string01(String p) {
        this.entity0219_string01 = p;
    }

    public String getEntity0219_string02() {
        return entity0219_string02;
    }

    public void setEntity0219_string02(String p) {
        this.entity0219_string02 = p;
    }

    public String getEntity0219_string03() {
        return entity0219_string03;
    }

    public void setEntity0219_string03(String p) {
        this.entity0219_string03 = p;
    }
}
