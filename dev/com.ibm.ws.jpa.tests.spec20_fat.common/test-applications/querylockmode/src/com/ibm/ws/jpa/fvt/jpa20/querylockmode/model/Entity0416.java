...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0416_SELECT",
                                    query = "SELECT e FROM Entity0416 e WHERE e.entity0416_id = :id_0416")
              })
@Entity
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0416")
public class Entity0416 {

    @Id
    @OneToOne
    private Entity0016 entity0416_id;

    @Version
    private short entity0416_version;

    private String entity0416_string01;

    private String entity0416_string02;

    private String entity0416_string03;

    public Entity0416() {}

    public Entity0416(Entity0016 id,
                      short version,
                      String string01,
                      String string02,
                      String string03) {
        this.entity0416_id = id;
        this.entity0416_version = version;
        this.entity0416_string01 = string01;
        this.entity0416_string02 = string02;
        this.entity0416_string03 = string03;
    }

    @Override
    public String toString() {
        return (" Entity0416: " +
                " entity0416_id: " + getEntity0416_id() +
                " entity0416_version: " + getEntity0416_version() +
                " entity0416_string01: " + getEntity0416_string01() +
                " entity0416_string02: " + getEntity0416_string02() +
                " entity0416_string03: " + getEntity0416_string03());
    }

    //----------------------------------------------------------------------------------------------
    // Persisent property accessor(s)
    //----------------------------------------------------------------------------------------------
    public Entity0016 getEntity0416_id() {
        return entity0416_id;
    }

    public void setEntity0416_id(Entity0016 p) {
        this.entity0416_id = p;
    }

    public short getEntity0416_version() {
        return entity0416_version;
    }

    public void setEntity0416_version(short p) {
        this.entity0416_version = p;
    }

    public String getEntity0416_string01() {
        return entity0416_string01;
    }

    public void setEntity0416_string01(String p) {
        this.entity0416_string01 = p;
    }

    public String getEntity0416_string02() {
        return entity0416_string02;
    }

    public void setEntity0416_string02(String p) {
        this.entity0416_string02 = p;
    }

    public String getEntity0416_string03() {
        return entity0416_string03;
    }

    public void setEntity0416_string03(String p) {
        this.entity0416_string03 = p;
    }
}
