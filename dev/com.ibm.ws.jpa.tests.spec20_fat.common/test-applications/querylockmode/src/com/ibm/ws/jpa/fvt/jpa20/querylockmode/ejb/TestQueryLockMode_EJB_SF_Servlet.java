...
@WebServlet(urlPatterns = "/TestQueryLockMode_EJB_SF_Servlet")
public class TestQueryLockMode_EJB_SF_Servlet extends EJBDBTestVehicleServlet {

    @PostConstruct
    private void initFAT() {
        testClassName = QueryLockModeTestLogic.class.getName();
        ejbJNDIName = "ejb/QueryLockModeTestSFEJB";
    ...
    @Test
    public void jpa_spec20_querylockmode_testScenario01_AMJTA_EJB_SF() throws Exception {
        final String testName = "jpa20_querylockmode_@LOCKMODE@_testScenario01_AMJTA_EJB_SF";
    ...
    @Test
    public void jpa_spec20_querylockmode_testScenario01_AMRL_EJB_SF() throws Exception {
        final String testName = "jpa20_querylockmode_@LOCKMODE@_testScenario01_AMRL_EJB_SF";
        final String testMethod = "testScenario01";
     ...
     *
     * @Test
     * public void jpa_spec20_querylockmode_testScenario01_CMTS_EJB_SF() throws Exception {
