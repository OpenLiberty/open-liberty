...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0005_SELECT",
                                    query = "SELECT e FROM Entity0005 e WHERE e.entity0005_id = :id_0005"),
                        @NamedQuery(name = "ENTITY0005_UPDATE",
                                    query = "UPDATE Entity0005 e SET e.entity0005_string01 = :string01_0005, e.entity0005_string02 = :string02_0005, e.entity0005_string03 = :string03_0005 WHERE e.entity0005_id = :id_0005")
              })
@Entity
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0005")
public class Entity0005 {

    @Id
    private String entity0005_id;

    @Version
    private short entity0005_version;

    private String entity0005_string01;

    private String entity0005_string02;

    private String entity0005_string03;

    public Entity0005() {}

    public Entity0005(String id,
                      short version,
                      String string01,
                      String string02,
                      String string03) {
        this.entity0005_id = id;
        this.entity0005_version = version;
        this.entity0005_string01 = string01;
        this.entity0005_string02 = string02;
        this.entity0005_string03 = string03;
    }

    @Override
    public String toString() {
        return (" Entity0005: " +
                " entity0005_id: " + getEntity0005_id() +
                " entity0005_version: " + getEntity0005_version() +
                " entity0005_string01: " + getEntity0005_string01() +
                " entity0005_string02: " + getEntity0005_string02() +
                " entity0005_string03: " + getEntity0005_string03());
    }

    //----------------------------------------------------------------------------------------------
    // Persisent property accessor(s)
    //----------------------------------------------------------------------------------------------
    public String getEntity0005_id() {
        return entity0005_id;
    }

    public void setEntity0005_id(String p) {
        this.entity0005_id = p;
    }

    public short getEntity0005_version() {
        return entity0005_version;
    }

    public void setEntity0005_version(short p) {
        this.entity0005_version = p;
    }

    public String getEntity0005_string01() {
        return entity0005_string01;
    }

    public void setEntity0005_string01(String p) {
        this.entity0005_string01 = p;
    }

    public String getEntity0005_string02() {
        return entity0005_string02;
    }

    public void setEntity0005_string02(String p) {
        this.entity0005_string02 = p;
    }

    public String getEntity0005_string03() {
        return entity0005_string03;
    }

    public void setEntity0005_string03(String p) {
        this.entity0005_string03 = p;
    }
}
