...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0102_SELECT",
                                    query = "SELECT e FROM Entity0102 e WHERE e.entity0102_id1 = :id1_0102 AND e.entity0102_id2 = :id2_0102")
              })
@Entity
@IdClass(IdClass0102.class)
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0102")
public class Entity0102 {
    ...
    @Version
    private Timestamp entity0102_version;

    private String entity0102_string01;

    private String entity0102_string02;

    private String entity0102_string03;

    public Entity0102() {}

    public Entity0102(Byte id1,
                      Byte id2,
                      Timestamp version,
                      String string01,
                      String string02,
        ...
        this.entity0102_version = version;
        this.entity0102_string01 = string01;
        this.entity0102_string02 = string02;
        this.entity0102_string03 = string03;
    }
    ...
    public String toString() {
        return (" Entity0102: " +
                ...
                " entity0102_version: " + getEntity0102_version() +
                " entity0102_string01: " + getEntity0102_string01() +
                " entity0102_string02: " + getEntity0102_string02() +
                " entity0102_string03: " + getEntity0102_string03());
    }
    ...
    public void setEntity0102_id1(Byte p) {
        this.entity0102_id1 = p;
    }
    ...
    public void setEntity0102_id2(Byte p) {
        this.entity0102_id2 = p;
    }

    public Timestamp getEntity0102_version() {
        return entity0102_version;
    }

    public void setEntity0102_version(Timestamp p) {
        this.entity0102_version = p;
    }

    public String getEntity0102_string01() {
        return entity0102_string01;
    }

    public void setEntity0102_string01(String p) {
        this.entity0102_string01 = p;
    }

    public String getEntity0102_string02() {
        return entity0102_string02;
    }

    public void setEntity0102_string02(String p) {
        this.entity0102_string02 = p;
    }

    public String getEntity0102_string03() {
        return entity0102_string03;
    }

    public void setEntity0102_string03(String p) {
        this.entity0102_string03 = p;
    }
}
