...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0329_SELECT",
                                    query = "SELECT e FROM Entity0329 e WHERE e.entity0329_id1 = :id1_0329 AND e.entity0329_id2 = :id2_0329 AND e.entity0329_id3 = :id3_0329")
              })
@Entity
@IdClass(IdClass0329.class)
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0329")
public class Entity0329 {
    ...
    @Version
    private Integer entity0329_version;

    private String entity0329_string01;

    private String entity0329_string02;

    private String entity0329_string03;

    public Entity0329() {}

    public Entity0329(int id1,
                      long id2,
                      short id3,
                      Integer version,
                      String string01,
        ...
        this.entity0329_version = version;
        this.entity0329_string01 = string01;
        this.entity0329_string02 = string02;
        this.entity0329_string03 = string03;
    }
    ...
    public String toString() {
        return (" Entity0329: " +
                ...
                " entity0329_version: " + getEntity0329_version() +
                " entity0329_string01: " + getEntity0329_string01() +
                " entity0329_string02: " + getEntity0329_string02() +
                " entity0329_string03: " + getEntity0329_string03());
    }
    ...
    public void setEntity0329_id1(int p) {
        this.entity0329_id1 = p;
    }
    ...
    public void setEntity0329_id2(long p) {
        this.entity0329_id2 = p;
    }
    ...
    public void setEntity0329_id3(short p) {
        this.entity0329_id3 = p;
    }

    public Integer getEntity0329_version() {
        return entity0329_version;
    }

    public void setEntity0329_version(Integer p) {
        this.entity0329_version = p;
    }

    public String getEntity0329_string01() {
        return entity0329_string01;
    }

    public void setEntity0329_string01(String p) {
        this.entity0329_string01 = p;
    }

    public String getEntity0329_string02() {
        return entity0329_string02;
    }

    public void setEntity0329_string02(String p) {
        this.entity0329_string02 = p;
    }

    public String getEntity0329_string03() {
        return entity0329_string03;
    }

    public void setEntity0329_string03(String p) {
        this.entity0329_string03 = p;
    }
}
