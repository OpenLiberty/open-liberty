...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0325_SELECT",
                                    query = "SELECT e FROM Entity0325 e WHERE e.entity0325_id1 = :id1_0325 AND e.entity0325_id2 = :id2_0325 AND e.entity0325_id3 = :id3_0325")
              })
@Entity
@IdClass(IdClass0325.class)
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0325")
public class Entity0325 {
    ...
    @Version
    private short entity0325_version;

    private String entity0325_string01;

    private String entity0325_string02;

    private String entity0325_string03;

    public Entity0325() {}

    public Entity0325(double id1,
                      float id2,
                      int id3,
                      short version,
                      String string01,
        ...
        this.entity0325_version = version;
        this.entity0325_string01 = string01;
        this.entity0325_string02 = string02;
        this.entity0325_string03 = string03;
    }
    ...
    public String toString() {
        return (" Entity0325: " +
                ...
                " entity0325_version: " + getEntity0325_version() +
                " entity0325_string01: " + getEntity0325_string01() +
                " entity0325_string02: " + getEntity0325_string02() +
                " entity0325_string03: " + getEntity0325_string03());
    }
    ...
    public void setEntity0325_id1(double p) {
        this.entity0325_id1 = p;
    }
    ...
    public void setEntity0325_id2(float p) {
        this.entity0325_id2 = p;
    }
    ...
    public void setEntity0325_id3(int p) {
        this.entity0325_id3 = p;
    }

    public short getEntity0325_version() {
        return entity0325_version;
    }

    public void setEntity0325_version(short p) {
        this.entity0325_version = p;
    }

    public String getEntity0325_string01() {
        return entity0325_string01;
    }

    public void setEntity0325_string01(String p) {
        this.entity0325_string01 = p;
    }

    public String getEntity0325_string02() {
        return entity0325_string02;
    }

    public void setEntity0325_string02(String p) {
        this.entity0325_string02 = p;
    }

    public String getEntity0325_string03() {
        return entity0325_string03;
    }

    public void setEntity0325_string03(String p) {
        this.entity0325_string03 = p;
    }
}
