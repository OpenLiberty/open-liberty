...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0345_SELECT",
                                    query = "SELECT e FROM Entity0345 e WHERE e.entity0345_id1 = :id1_0345 AND e.entity0345_id2 = :id2_0345 AND e.entity0345_id3 = :id3_0345")
              })
@Entity
@IdClass(IdClass0345.class)
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0345")
public class Entity0345 {
    ...
    @Version
    private Long entity0345_version;

    private String entity0345_string01;

    private String entity0345_string02;

    private String entity0345_string03;

    public Entity0345() {}

    public Entity0345(Float id1,
                      long id2,
                      Short id3,
                      Long version,
                      String string01,
        ...
        this.entity0345_version = version;
        this.entity0345_string01 = string01;
        this.entity0345_string02 = string02;
        this.entity0345_string03 = string03;
    }
    ...
    public String toString() {
        return (" Entity0345: " +
                ...
                " entity0345_version: " + getEntity0345_version() +
                " entity0345_string01: " + getEntity0345_string01() +
                " entity0345_string02: " + getEntity0345_string02() +
                " entity0345_string03: " + getEntity0345_string03());
    }
    ...
    public void setEntity0345_id1(Float p) {
        this.entity0345_id1 = p;
    }
    ...
    public void setEntity0345_id2(long p) {
        this.entity0345_id2 = p;
    }
    ...
    public void setEntity0345_id3(Short p) {
        this.entity0345_id3 = p;
    }

    public Long getEntity0345_version() {
        return entity0345_version;
    }

    public void setEntity0345_version(Long p) {
        this.entity0345_version = p;
    }

    public String getEntity0345_string01() {
        return entity0345_string01;
    }

    public void setEntity0345_string01(String p) {
        this.entity0345_string01 = p;
    }

    public String getEntity0345_string02() {
        return entity0345_string02;
    }

    public void setEntity0345_string02(String p) {
        this.entity0345_string02 = p;
    }

    public String getEntity0345_string03() {
        return entity0345_string03;
    }

    public void setEntity0345_string03(String p) {
        this.entity0345_string03 = p;
    }
}
