...
public enum DerivedIdentityEntityEnum implements JPAEntityClassEnum {
    Entity0001 {
        @Override
    ...
    public static DerivedIdentityEntityEnum resolveEntityByName(String entityName) {
        return DerivedIdentityEntityEnum.valueOf(entityName);
    }
}
