...
@NamedQueries ( 
    value={
        @NamedQuery(name  = "ENTITY0406_SELECT",
                    query = "SELECT e FROM Entity0406 e WHERE e.entity0406_id = :id_0406")
    }
)
@Entity
@Inheritance(strategy=InheritanceType.TABLE_PER_CLASS)
@Table(name="CDM_Entity0406")
public class Entity0406 {

    @Id
    @OneToOne
    private Entity0006  entity0406_id;

    @Version
    private Integer     entity0406_version;

    private String      entity0406_string01;

    private String      entity0406_string02;

    private String      entity0406_string03;


    public Entity0406() {
    }

    public Entity0406(Entity0006  id,
                      Integer     version, 
                      String      string01,
                      String      string02,
                      String      string03) {
        this.entity0406_id       = id;
        this.entity0406_version  = version;
        this.entity0406_string01 = string01;
        this.entity0406_string02 = string02;
        this.entity0406_string03 = string03;
    }

    public String toString() {
        return( " Entity0406: "          + 
                " entity0406_id: "       + getEntity0406_id() + 
                " entity0406_version: "  + getEntity0406_version() + 
                " entity0406_string01: " + getEntity0406_string01() +
                " entity0406_string02: " + getEntity0406_string02() + 
                " entity0406_string03: " + getEntity0406_string03() );
    }
    ...
    //----------------------------------------------------------------------------------------------
    public Entity0006 getEntity0406_id() {
        return entity0406_id;
    }
    public void setEntity0406_id(Entity0006 p) {
        this.entity0406_id = p;
    }


    public Integer getEntity0406_version() {
        return entity0406_version;
    }
    public void setEntity0406_version(Integer p) {
        this.entity0406_version = p;
    }


    public String getEntity0406_string01() {
        return entity0406_string01;
    }
    public void setEntity0406_string01(String p) {
        this.entity0406_string01 = p;
    }


    public String getEntity0406_string02() {
        return entity0406_string02;
    }
    public void setEntity0406_string02(String p) {
        this.entity0406_string02 = p;
    }


    public String getEntity0406_string03() {
        return entity0406_string03;
    }
    public void setEntity0406_string03(String p) {
        this.entity0406_string03 = p;
    }
}
