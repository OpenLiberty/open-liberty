...
@NamedQueries ( 
    value={
        @NamedQuery(name  = "ENTITY0414_SELECT",
                    query = "SELECT e FROM Entity0414 e WHERE e.entity0414_id = :id_0414")
    }
)
@Entity
@Inheritance(strategy=InheritanceType.TABLE_PER_CLASS)
@Table(name="CDM_Entity0414")
public class Entity0414 {

    @Id
    @OneToOne
    private Entity0014  entity0414_id;

    @Version
    private long        entity0414_version;

    private String      entity0414_string01;

    private String      entity0414_string02;

    private String      entity0414_string03;


    public Entity0414() {
    }

    public Entity0414(Entity0014  id,
                      long        version, 
                      String      string01,
                      String      string02,
                      String      string03) {
        this.entity0414_id       = id;
        this.entity0414_version  = version;
        this.entity0414_string01 = string01;
        this.entity0414_string02 = string02;
        this.entity0414_string03 = string03;
    }

    public String toString() {
        return( " Entity0414: "          + 
                " entity0414_id: "       + getEntity0414_id() + 
                " entity0414_version: "  + getEntity0414_version() + 
                " entity0414_string01: " + getEntity0414_string01() +
                " entity0414_string02: " + getEntity0414_string02() + 
                " entity0414_string03: " + getEntity0414_string03() );
    }
    ...
    //----------------------------------------------------------------------------------------------
    public Entity0014 getEntity0414_id() {
        return entity0414_id;
    }
    public void setEntity0414_id(Entity0014 p) {
        this.entity0414_id = p;
    }


    public long getEntity0414_version() {
        return entity0414_version;
    }
    public void setEntity0414_version(long p) {
        this.entity0414_version = p;
    }


    public String getEntity0414_string01() {
        return entity0414_string01;
    }
    public void setEntity0414_string01(String p) {
        this.entity0414_string01 = p;
    }


    public String getEntity0414_string02() {
        return entity0414_string02;
    }
    public void setEntity0414_string02(String p) {
        this.entity0414_string02 = p;
    }


    public String getEntity0414_string03() {
        return entity0414_string03;
    }
    public void setEntity0414_string03(String p) {
        this.entity0414_string03 = p;
    }
}
