...
@NamedQueries ( 
    value={
        @NamedQuery(name  = "ENTITY0413_SELECT",
                    query = "SELECT e FROM Entity0413 e WHERE e.entity0413_id = :id_0413")
    }
)
@Entity
@Inheritance(strategy=InheritanceType.TABLE_PER_CLASS)
@Table(name="CDM_Entity0413")
public class Entity0413 {

    @Id
    @OneToOne
    private Entity0013  entity0413_id;

    @Version
    private Integer     entity0413_version;

    private String      entity0413_string01;

    private String      entity0413_string02;

    private String      entity0413_string03;


    public Entity0413() {
    }

    public Entity0413(Entity0013  id,
                      Integer     version, 
                      String      string01,
                      String      string02,
                      String      string03) {
        this.entity0413_id       = id;
        this.entity0413_version  = version;
        this.entity0413_string01 = string01;
        this.entity0413_string02 = string02;
        this.entity0413_string03 = string03;
    }

    public String toString() {
        return( " Entity0413: "          + 
                " entity0413_id: "       + getEntity0413_id() + 
                " entity0413_version: "  + getEntity0413_version() + 
                " entity0413_string01: " + getEntity0413_string01() +
                " entity0413_string02: " + getEntity0413_string02() + 
                " entity0413_string03: " + getEntity0413_string03() );
    }
    ...
    //----------------------------------------------------------------------------------------------
    public Entity0013 getEntity0413_id() {
        return entity0413_id;
    }
    public void setEntity0413_id(Entity0013 p) {
        this.entity0413_id = p;
    }


    public Integer getEntity0413_version() {
        return entity0413_version;
    }
    public void setEntity0413_version(Integer p) {
        this.entity0413_version = p;
    }


    public String getEntity0413_string01() {
        return entity0413_string01;
    }
    public void setEntity0413_string01(String p) {
        this.entity0413_string01 = p;
    }


    public String getEntity0413_string02() {
        return entity0413_string02;
    }
    public void setEntity0413_string02(String p) {
        this.entity0413_string02 = p;
    }


    public String getEntity0413_string03() {
        return entity0413_string03;
    }
    public void setEntity0413_string03(String p) {
        this.entity0413_string03 = p;
    }
}
