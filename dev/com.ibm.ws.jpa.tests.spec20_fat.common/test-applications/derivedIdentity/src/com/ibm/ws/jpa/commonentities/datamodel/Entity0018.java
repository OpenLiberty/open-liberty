...
@NamedQueries ( 
    value={
        @NamedQuery(name  = "ENTITY0018_SELECT",
                    query = "SELECT e FROM Entity0018 e WHERE e.entity0018_id = :id_0018"),
        @NamedQuery(name  = "ENTITY0018_UPDATE",
                    query = "UPDATE Entity0018 e SET e.entity0018_string01 = :string01_0018, e.entity0018_string02 = :string02_0018, e.entity0018_string03 = :string03_0018 WHERE e.entity0018_id = :id_0018")
    }
)
@Entity
@Inheritance(strategy=InheritanceType.TABLE_PER_CLASS)
@Table(name="CDM_Entity0018")
public class Entity0018 {

    @Id
    @Temporal(TemporalType.DATE)
    private java.util.Date  entity0018_id;

    @Version
    private Long            entity0018_version;

    private String          entity0018_string01;

    private String          entity0018_string02;

    private String          entity0018_string03;


    public Entity0018() {
    }

    public Entity0018(java.util.Date     id,
                      Long               version, 
                      String             string01,
                      String             string02,
                      String             string03) {
        this.entity0018_id       = id;
        this.entity0018_version  = version;
        this.entity0018_string01 = string01;
        this.entity0018_string02 = string02;
        this.entity0018_string03 = string03;
    }

    public String toString() {
        return( " Entity0018: "          + 
                " entity0018_id: "       + getEntity0018_id() + 
                " entity0018_version: "  + getEntity0018_version() + 
                " entity0018_string01: " + getEntity0018_string01() +
                " entity0018_string02: " + getEntity0018_string02() + 
                " entity0018_string03: " + getEntity0018_string03() );
    }
    ...
    //----------------------------------------------------------------------------------------------
    public java.util.Date getEntity0018_id() {
        return entity0018_id;
    }
    public void setEntity0018_id(java.util.Date p) {
        this.entity0018_id = p;
    }


    public Long getEntity0018_version() {
        return entity0018_version;
    }
    public void setEntity0018_version(Long p) {
        this.entity0018_version = p;
    }


    public String getEntity0018_string01() {
        return entity0018_string01;
    }
    public void setEntity0018_string01(String p) {
        this.entity0018_string01 = p;
    }


    public String getEntity0018_string02() {
        return entity0018_string02;
    }
    public void setEntity0018_string02(String p) {
        this.entity0018_string02 = p;
    }


    public String getEntity0018_string03() {
        return entity0018_string03;
    }
    public void setEntity0018_string03(String p) {
        this.entity0018_string03 = p;
    }
}
