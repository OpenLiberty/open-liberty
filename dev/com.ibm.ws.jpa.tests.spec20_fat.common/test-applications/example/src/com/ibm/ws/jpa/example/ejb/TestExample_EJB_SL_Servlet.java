...
public class TestExample_EJB_SL_Servlet extends EJBDBTestVehicleServlet {
    ...
    @Test
    public void jpa_spec20_example_template_EJB_SL_AMJTA_Web() throws Exception {
        final String testName = "jpa_spec20_example_template_EJB_SL_AMJTA_Web";
    ...
    @Test
    public void jpa_spec20_example_template_EJB_SL_AMRL_Web() throws Exception {
        final String testName = "jpa_spec20_example_template_EJB_SL_AMRL_Web";
        final String testMethod = "template";
    ...
    @Test
    public void jpa_spec20_example_template_EJB_SL_CMTS_Web() throws Exception {
        final String testName = "jpa_spec20_example_template_EJB_SL_CMTS_Web";
        final String testMethod = "template";
