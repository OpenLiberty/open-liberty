...
@WebServlet("/AsyncFutureCancelLocalTest")
@SuppressWarnings("serial")
public class FutureCancelLocalTestServlet extends FATServlet {
    private static final String CLASS_NAME = FutureCancelLocalTestServlet.class.getName();
    ...
    @EJB(beanName = "FutureCancelDriverLocalBean")
     ...
     */
    @Test
    public void testLocalAsyncCancelledFalseParameter() throws Exception {
     ...
     */
    @Test
    public void testLocalAsyncCancelledTrueParameter() throws Exception {
     ...
     * <p>An asynchronous method is called repeatedly until the resulting Future
     * object can be cancelled successfully. isCancelled, isDone, and
     * Future.get with timeout are called on the cancelled Future. All
     * uncancelled futures are waited upon for cleanup.
     *
     * The expected result is that calling an asynchronous method that sleeps
     * will eventually fill all available threads in the thread pool, and an
     * asynchronous method will eventually be buffered, which will allow it to
     ...
     */
    @Test
    public void testLocalAsyncRecancelledFalseParameter() throws Exception {
     ...
     */
    @Test
    public void testLocalAsyncRecancelledTrueParameter() throws Exception {
        List<Future<String>> uncancelledFutures = new ArrayList<Future<String>>();
     ...
     */
    @Test
    public void testLocalAsyncNotCancelledTrueParameter() throws Exception {
     ...
     */
    @Test
    public void testLocalAsyncNotCancelledFalseParameter() throws Exception {
     ...
     */
    @Test
    public void testLocalAsyncNotCancelledTrueParameterWithTwoSessionContextWasCancelCalled() throws Exception {
     ...
     */
    @Test
    public void testLocalAsyncNotCancelledFalseParameterWithTwoSessionContextWasCancelCalled() throws Exception {
     ...
     *
     * <p>An asynchronous method is called, then SessionContext.wasCancelCalled
     * is called, after that Future.cancel(true) is called, but the object
     * can't be cancelled successfully then the call sequence is
     ...
     */
    @Test
    public void testLocalAsyncNotCancelledTrueFalseTrue() throws Exception {
     ...
     *
     * <p>An asynchronous method is called, then SessionContext.wasCancelCalled
     * is called, after that Future.cancel(false) is called, but the object
     * can't be cancelled successfully then the call sequence is
     * SessionContext.wasCancelCalled, Future.cancel(true),
     * SessionContext.wasCancelCalled, Future.cancel(false),
     * SessionContext.wasCancelCalled.
     ...
     */
    @Test
    public void testLocalAsyncNotCancelledFalseTrueFalse() throws Exception {
     ...
     */
    @Test
    public void testLocalSessionContextWasCancelCalledInSync() throws Exception {
     ...
     */
    @Test
    public void testLocalSessionContextWasCancelCalledInVoid() throws Exception {
