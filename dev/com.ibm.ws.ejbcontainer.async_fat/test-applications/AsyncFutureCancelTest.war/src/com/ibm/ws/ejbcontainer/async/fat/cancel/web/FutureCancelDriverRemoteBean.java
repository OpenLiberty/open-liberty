...
@Stateless
@Remote(FutureCancelDriver.class)
public class FutureCancelDriverRemoteBean {
    private static final String CLASSNAME = FutureCancelDriverRemoteBean.class.getName();
