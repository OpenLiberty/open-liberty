 ...
 **/
@Stateless
@Local(InheritanceXMLLocal.class)
public class InheritanceStatelessXMLBean extends SuperClass {
    public final static String CLASSNAME = InheritanceStatelessXMLBean.class.getName();
