 ...
 */
public class JavacoreCommandHandler implements CommandHandlerExtension {
    ...
    static {
        HELP_TEXT_SHORT.add("To request a JVM core dump from a Liberty server:");
        HELP_TEXT_SHORT.add("  MODIFY <jobname.>identifier,javacore");
    }
