...
public class ProtocolVersionToolDescriptionTest {

    @Rule
    public McpClient client = new McpClient(server, "/protocolVersionToolDescriptionTest");
    ...
    public static void setup() throws Exception {
        WebArchive war = ShrinkWrap.create(WebArchive.class, "protocolVersionToolDescriptionTest.war").addPackage(ProtocolVersionTestTools.class.getPackage());
    ...
    public void testNewerProtocolVersionIncludeOutputSchemaInToolDescription() throws Exception {
        ...
        String response = new HttpRequest(server, "/protocolVersionToolDescriptionTest/mcp")
