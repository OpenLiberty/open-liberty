...
public class DeploymentProblemTest extends FATServletClient {
    ...
    public void testInvalidToolNamesWithinvalidLengthAndCharactersTestCase() throws Exception {
        String expectedLengthErrorHeader = Pattern.quote("The openlibertyopenliberty openlibertyopenliberty_openlibertyopenlibertyopenlibertyopenlibertyopenliberty openlibertyopenliberty_openlibertyopenlibertyopenliberty name of the io.openliberty.mcp.internal.fat.tool.deploymentErrorApps.InvalidToolNameTest.invalidTool5 MCP tool method is invalid. Tool names must be between 1 and 128 characters in length inclusive.");
        String expectedCharacterErrorHeader = Pattern.quote("The openlibertyopenliberty openlibertyopenliberty_openlibertyopenlibertyopenlibertyopenlibertyopenliberty openlibertyopenliberty_openlibertyopenlibertyopenliberty name of the io.openliberty.mcp.internal.fat.tool.deploymentErrorApps.InvalidToolNameTest.invalidTool5 MCP tool method is invalid. Tool names must only contain ASCII letters, digits, underscores or hyphens.");
