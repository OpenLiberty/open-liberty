...
public class NoClassAnnotationTests extends FATServletClient {
    ...
    public static void setup() throws Exception {
        WebArchive war = ShrinkWrap.create(WebArchive.class, "noClassAnnotationTools.war").addPackage(NoClassAnnotationTools.class.getPackage());
