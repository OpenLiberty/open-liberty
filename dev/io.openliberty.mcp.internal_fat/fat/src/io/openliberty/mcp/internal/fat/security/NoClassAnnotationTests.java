...
public class NoClassAnnotationTests extends AbstractNoClassAnnotation {
    ...
    public static void teardown() throws Exception {
        server.setMarkToEndOfLog();
        server.deleteFileFromLibertyServerRoot("dropins/noClassAnnotationTools.war");
        server.waitForStringInLog("CWWKZ0009I:.*noClassAnnotationTools");
        server.removeInstalledAppForValidation("noClassAnnotationTools");
    }
}