...
public class FATSuite {
    ...
    /**
     * Run tests that use 2.1 attributes with the 1.1 feature and show that they're ignored
     */
    @ClassRule
    public static RepeatTests repeat = RepeatTests.with(new SecurityTestRepeatAction(MPJwt21FatConstants.MP_JWT_11));
