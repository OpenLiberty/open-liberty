...
@Mode(TestMode.FULL)
public class MP71EE9CompatibleTest {

    private static final String SERVER_NAME = "MP71andEE9";
    ...
    /**
     * microProfile-7.1 plus jakartaee-9.0
     * Should fail because microProfile-7.1 is not compatible with jakartaee-9.0
     *
     * @throws Exception
     */
    @Test
    ...
    public void testMP71andEE9() throws Exception {
        try {
