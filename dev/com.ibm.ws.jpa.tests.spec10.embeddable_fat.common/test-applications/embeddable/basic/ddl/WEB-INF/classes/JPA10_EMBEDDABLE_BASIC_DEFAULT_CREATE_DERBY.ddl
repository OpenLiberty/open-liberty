CREATE TABLE ${schemaname}.AnnRootEmBT (id INTEGER NOT NULL, enumeratedOrdinalValueFA INTEGER, enumeratedStringValueFA VARCHAR(255), enumeratedOrdinalValuePA INTEGER, enumeratedStringValuePA VARCHAR(255), integerValueAttributeOverride INTEGER, integerValue INTEGER, integerValueFAColumn INTEGER, integerValuePAColumn INTEGER, clobValueFA CLOB(2147483647), clobValuePA CLOB(2147483647), temporalValueFA DATE, temporalValuePA DATE, PRIMARY KEY (id));
CREATE TABLE ${schemaname}.ColDate (parent_id INTEGER, value DATE);
...
CREATE TABLE ${schemaname}.ColLob (parent_id INTEGER, value CLOB(2147483647));
CREATE TABLE ${schemaname}.EntColLobPAE (parent_id INTEGER, clobValuePA VARCHAR(255));
CREATE TABLE ${schemaname}.EntListEnumPAEOrderBy (parent_id INTEGER, enumeratedOrdinalValuePA INTEGER, enumeratedStringValuePA VARCHAR(255));
CREATE TABLE ${schemaname}.EntListEnumPAEOrderColumn (parent_id INTEGER, enumeratedOrdinalValuePA INTEGER, enumeratedStringValuePA VARCHAR(255), valueOrderColumn INTEGER);
...
CREATE TABLE ${schemaname}.EntListTemporalPAE (parent_id INTEGER, temporalValuePA VARCHAR(255), valueOrderColumn INTEGER);
CREATE TABLE ${schemaname}.EntMapDateTemporalPAE (parent_id INTEGER, mykey DATE NOT NULL, temporalValuePA VARCHAR(255));
CREATE TABLE ${schemaname}.EntMapEnumPAEEnumPAE (parent_id INTEGER, mykey VARCHAR(255) NOT NULL, valueOrdinal INTEGER, valueString VARCHAR(255));
...
CREATE TABLE ${schemaname}.EntMapIntegerTemporalPAE (parent_id INTEGER, mykey INTEGER NOT NULL, temporalValuePA VARCHAR(255));
CREATE TABLE ${schemaname}.EntMapLobPAELobPAE (parent_id INTEGER, mykey CLOB(2147483647), value VARCHAR(255));
CREATE TABLE ${schemaname}.EntSetIntegerPAE (parent_id INTEGER, integerValuePAColumn INTEGER);
CREATE TABLE ${schemaname}.ListDate (parent_id INTEGER, value DATE, valueOrderColumn INTEGER);
...
CREATE TABLE ${schemaname}.ListLob (parent_id INTEGER, value CLOB(2147483647), valueOrderColumn INTEGER);
CREATE TABLE ${schemaname}.MapDateDate (parent_id INTEGER, mykey DATE NOT NULL, value DATE);
CREATE TABLE ${schemaname}.MapEnumEnum (parent_id INTEGER, mykey VARCHAR(255) NOT NULL, value VARCHAR(255));
CREATE TABLE ${schemaname}.MapEnumLob (parent_id INTEGER, mykey VARCHAR(255) NOT NULL, value CLOB(2147483647));
CREATE TABLE ${schemaname}.MapIntDate (parent_id INTEGER, mykey INTEGER NOT NULL, value DATE);
CREATE TABLE ${schemaname}.MapIntInt (parent_id INTEGER, mykey INTEGER NOT NULL, value INTEGER);
CREATE TABLE ${schemaname}.SetDate (parent_id INTEGER, value DATE);
...
CREATE TABLE ${schemaname}.SetLob (parent_id INTEGER, value CLOB(2147483647));
CREATE TABLE ${schemaname}.XMLRootEmBT (id INTEGER NOT NULL, enumeratedOrdinalValueFA INTEGER, enumeratedStringValueFA VARCHAR(255), enumeratedOrdinalValuePA INTEGER, enumeratedStringValuePA VARCHAR(255), integerValueAttributeOverride INTEGER, integerValue INTEGER, integerValueFAColumn INTEGER, integerValuePAColumn INTEGER, transientValue INTEGER, clobValueFA CLOB(2147483647), clobValuePA CLOB(2147483647), temporalValueFA DATE, temporalValuePA DATE, PRIMARY KEY (id));
...
CREATE TABLE ${schemaname}.XMLColLob (parent_id INTEGER, value CLOB(2147483647));
CREATE TABLE ${schemaname}.XMLEntColLobPAE (parent_id INTEGER, clobValuePA VARCHAR(255));
CREATE TABLE ${schemaname}.XMLEntListEnumPAEOrderBy (parent_id INTEGER, enumeratedOrdinalValuePA INTEGER, enumeratedStringValuePA VARCHAR(255));
CREATE TABLE ${schemaname}.XMLEntListEnumPAEOrderColumn (parent_id INTEGER, enumeratedOrdinalValuePA INTEGER, enumeratedStringValuePA VARCHAR(255), valueOrderColumn INTEGER);
...
CREATE TABLE ${schemaname}.XMLListLob (parent_id INTEGER, value CLOB(2147483647), valueOrderColumn INTEGER);
CREATE TABLE ${schemaname}.XMLListTemporalPAE (parent_id INTEGER, temporalValuePA VARCHAR(255), valueOrderColumn INTEGER);
CREATE TABLE ${schemaname}.XMLMapDateDate (parent_id INTEGER, mykey DATE, value DATE);
CREATE TABLE ${schemaname}.XMLMapDateTemporalPAE (parent_id INTEGER, mykey DATE, temporalValuePA DATE);
CREATE TABLE ${schemaname}.XMLMapEnumEnum (parent_id INTEGER, mykey VARCHAR(255), value VARCHAR(255));
CREATE TABLE ${schemaname}.XMLMapEnumLob (parent_id INTEGER, mykey VARCHAR(255), value CLOB(2147483647));
...
CREATE TABLE ${schemaname}.XMLSetLob (parent_id INTEGER, value CLOB(2147483647));
