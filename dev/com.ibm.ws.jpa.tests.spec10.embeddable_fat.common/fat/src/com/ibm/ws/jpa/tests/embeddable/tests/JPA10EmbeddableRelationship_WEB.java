...
public class JPA10EmbeddableRelationship_WEB extends JPAFATServletClient {
    ...
    private final static Set<String> deleteSet = new HashSet<String>();

    private static long timestart = 0;

    static {
        dropSet.add("JPA10_EMBEDDABLE_RELATIONSHIP_${provider}_DROP_${dbvendor}.ddl");
        createSet.add("JPA10_EMBEDDABLE_RELATIONSHIP_${provider}_CREATE_${dbvendor}.ddl");
        deleteSet.add("JPA10_EMBEDDABLE_RELATIONSHIP_${provider}_DELETE_${dbvendor}.ddl");
    }
