...
public class TimeIDPInitiatedTests extends TimeSAMLTests {

    private static final Class<?> thisClass = TimeIDPInitiatedTests.class;
    ...
    public static void setupBeforeTest() throws Exception {
        ...
        startSPWithIDPServer("com.ibm.ws.security.saml.sso-2.0_fat.3", "server_1_notSigned.xml", extraMsgs, extraApps, true);
