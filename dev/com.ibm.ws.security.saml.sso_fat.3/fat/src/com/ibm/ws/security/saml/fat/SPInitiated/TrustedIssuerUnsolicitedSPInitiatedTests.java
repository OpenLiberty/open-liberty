...
public class TrustedIssuerUnsolicitedSPInitiatedTests extends TrustedIssuerSAMLTests {

    private static final Class<?> thisClass = TrustedIssuerUnsolicitedSPInitiatedTests.class;
    ...
    public static void setupBeforeTest() throws Exception {
        ...
        startSPWithIDPServer("com.ibm.ws.security.saml.sso-2.0_fat.3", "server_trustedIssuers_unsolicited.xml", extraMsgs, extraApps, true);
