...
public class TrustedIssuerSolicitedSPInitiatedTests extends TrustedIssuerSAMLTests {

    private static final Class<?> thisClass = TrustedIssuerSolicitedSPInitiatedTests.class;
