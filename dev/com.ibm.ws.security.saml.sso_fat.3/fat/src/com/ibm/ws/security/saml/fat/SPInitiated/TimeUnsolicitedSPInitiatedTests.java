...
public class TimeUnsolicitedSPInitiatedTests extends TimeSAMLTests {
    ...
    public static void setupBeforeTest() throws Exception {
        ...
        startSPWithIDPServer("com.ibm.ws.security.saml.sso-2.0_fat.3", "server_1_notSigned_unsolicited.xml", extraMsgs, extraApps, true);
