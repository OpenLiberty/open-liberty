...
package com.ibm.ws.security.tai.sample;
...
public class SampleTAI implements TrustAssociationInterceptor {
    private static final TraceComponent tc = Tr.register(SampleTAI.class);
    ...
    public boolean isTargetInterceptor(HttpServletRequest req)
        ...
        while (attrKeys.hasMoreElements()) {
            ...
            Tr.debug(tc, "key:" + attrKey + " value:" + obj, obj);
        }

        if (!isOidcAuthorize(req)) {
            Tr.debug(tc, "This is not a request for oidc or oauth2");
            return false;
        }
        // if not https
        //if( !req.isSecure() ){
        ...
        return okClientId.equals(clientId);
    }
    ...
    public TAIResult negotiateValidateandEstablishTrust(HttpServletRequest req, HttpServletResponse rsp)
        ...
        String user = properties.getProperty("taiusername");
        ...
        if (iResult == 0) {
            ...
            hashtable.put(EXTERNAL_CLAIMS, getBlueHashMap());
    ...
    /**
     * Get the blue-mix specific key-value pairs
     * 
     * @return
     */
    private Map<String, String[]> getBlueHashMap() {
        HashMap<String, String[]> blueMap = new HashMap<String, String[]>();
        String claimNames = properties.getProperty("claimNames");
        StringTokenizer st = new StringTokenizer(claimNames, ", ");
        while (st.hasMoreTokens()) {
            String key = st.nextToken();
            String value = (String) properties.get(key);
            System.out.println(" key:" + key + " value:" + value);
            blueMap.put(key, new String[] { value });
        }
        return blueMap;
    }
    ...
    private boolean isOidcAuthorize(HttpServletRequest req) {
        ...
        //    if (OAUTH_APPLICATION.equals(applicationName) || OIDC_APPLICATION.equals(applicationName)) {
        //        isOidcAuthorize = true;
        //    }
        //}
