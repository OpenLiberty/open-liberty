...
public class OIDCGrantTypesCustomStoreTest extends GenericGrantTypesTests {
    ...
    private static final Class<?> thisClass = OIDCGrantTypesCustomStoreTest.class;
    ...
    public static void setupBeforeTest() throws Exception {
        ...
        testOPServer = commonSetUp("com.ibm.ws.security.openidconnect.server-1.0_fat", "server_grantTypesCustomStore.xml", Constants.OIDC_OP, extraApps, Constants.DO_NOT_USE_DERBY,  Constants.USE_MONGODB, extraMsgs, null, Constants.OIDC_OP, true, true, tokenType, certType, Constants.JUNIT_REPORTING);
