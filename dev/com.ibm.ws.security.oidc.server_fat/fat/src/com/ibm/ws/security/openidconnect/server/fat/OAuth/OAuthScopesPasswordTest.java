...
@Mode(TestMode.FULL)
public class OAuthScopesPasswordTest extends GenericScopesTests {

    private static final Class<?> thisClass = OAuthScopesPasswordTest.class;
    ...
    public static void setupBeforeTest() throws Exception {
        ...
        goodActions = Constants.PASSWORD_PROTECTED_RESOURCE_NOJSP_ACTIONS;
        flowType = Constants.PASSWORD_FLOW;
