...
public class OAuthWebClientAuthCodeDerbyXORTest extends genericWebClientAuthCodeCommonTest {

    private static final Class<?> thisClass = OAuthWebClientAuthCodeDerbyXORTest.class;
    ...
    public static void setupBeforeTest() throws Exception {
        ...
        testOPServer = commonSetUp("com.ibm.ws.security.openidconnect.server-1.0_fat", "server_derby_xor.xml", Constants.OAUTH_OP, extraApps, Constants.USE_DERBY, extraMsgs);
