...
public class OIDCWebClientAuthCodeCustomStoreXORTest extends genericWebClientAuthCodeCommonTest {

    public static RSCommonTestTools rsTools = new RSCommonTestTools();

    private static final Class<?> thisClass = OIDCWebClientAuthCodeCustomStoreXORTest.class;
