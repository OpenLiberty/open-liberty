...
public class OIDCScopesPasswordTest extends GenericScopesTests {

    public static RSCommonTestTools rsTools = new RSCommonTestTools();

    private static final Class<?> thisClass = OIDCScopesPasswordTest.class;
    ...
    public static void setupBeforeTest() throws Exception {
        ...
        emptyScopeActions = Constants.PASSWORD_NOJSP_ACTIONS;
