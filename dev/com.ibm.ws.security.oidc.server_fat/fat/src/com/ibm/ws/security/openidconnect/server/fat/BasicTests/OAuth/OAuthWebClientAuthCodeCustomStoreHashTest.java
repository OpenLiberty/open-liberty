...
public class OAuthWebClientAuthCodeCustomStoreHashTest extends genericWebClientAuthCodeCommonTest {

    private static final Class<?> thisClass = OAuthWebClientAuthCodeCustomStoreHashTest.class;
