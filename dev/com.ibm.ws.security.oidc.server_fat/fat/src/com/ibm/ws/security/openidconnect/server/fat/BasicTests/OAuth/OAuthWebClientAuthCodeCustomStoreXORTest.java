...
public class OAuthWebClientAuthCodeCustomStoreXORTest extends genericWebClientAuthCodeCommonTest {

	private static final Class<?> thisClass = OAuthWebClientAuthCodeCustomStoreXORTest.class;
	...
	public static void setupBeforeTest() throws Exception {
		...
		testOPServer = commonSetUp("com.ibm.ws.security.openidconnect.server-1.0_fat", "server_customstore_xor.xml",
