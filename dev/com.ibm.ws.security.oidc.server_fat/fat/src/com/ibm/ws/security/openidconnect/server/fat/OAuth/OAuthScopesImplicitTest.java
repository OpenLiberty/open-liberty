...
@Mode(TestMode.FULL)
public class OAuthScopesImplicitTest extends GenericScopesTests {

    private static final Class<?> thisClass = OAuthScopesImplicitTest.class;
    ...
    public static void setupBeforeTest() throws Exception {
        ...
        testOPServer = commonSetUp("com.ibm.ws.security.openidconnect.server-1.0_fat", "server_scopes.xml", Constants.OAUTH_OP, extraApps, Constants.DO_NOT_USE_DERBY, extraMsgs);

        targetProvider = Constants.OAUTHCONFIGSAMPLE_APP;
        goodActions = Constants.IMPLICIT_AUTHENTICATION_ACTIONS;
        testSettings = setImplicitClientDefaultSettings();
        flowType = Constants.IMPLICIT_FLOW;
