...
public class OIDCWebClientAuthCodeDerbyXORTest extends genericWebClientAuthCodeCommonTest {

    public static RSCommonTestTools rsTools = new RSCommonTestTools();

    private static final Class<?> thisClass = OIDCWebClientAuthCodeDerbyXORTest.class;
    ...
    public static void setupBeforeTest() throws Exception {
        ...
        extraMsgs.add("CWWKZ0001I.*" + Constants.OIDCCONFIGDERBY_START_APP);
        ...
        testOPServer = commonSetUp("com.ibm.ws.security.openidconnect.server-1.0_fat", "server_derby_xor.xml", Constants.OIDC_OP, extraApps, Constants.USE_DERBY, extraMsgs, null, Constants.OIDC_OP, true, true, tokenType, certType);
