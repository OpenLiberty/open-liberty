...
public class OIDCWebClientAuthCodeDerbyHashTest extends genericWebClientAuthCodeCommonTest {

    public static RSCommonTestTools rsTools = new RSCommonTestTools();

    private static final Class<?> thisClass = OIDCWebClientAuthCodeDerbyHashTest.class;
