...
import com.ibm.ws.security.openidconnect.server.fat.CommonTests.GenericPromptLoginTests;
...
@Mode(TestMode.FULL)
public class OAuthPromptLoginTest extends GenericPromptLoginTests {

    private static final Class<?> thisClass = OAuthPromptLoginTest.class;
