...
public class OIDCGrantTypesDerbyTest extends GenericGrantTypesTests {
    ...
    private static final Class<?> thisClass = OIDCGrantTypesDerbyTest.class;
    ...
    public static void setupBeforeTest() throws Exception {
        ...
        testOPServer = commonSetUp("com.ibm.ws.security.openidconnect.server-1.0_fat", "server_grantTypesDerby.xml", Constants.OIDC_OP, extraApps, Constants.USE_DERBY, extraMsgs, null, Constants.OIDC_OP, true, true, tokenType, certType, Constants.JUNIT_REPORTING);
