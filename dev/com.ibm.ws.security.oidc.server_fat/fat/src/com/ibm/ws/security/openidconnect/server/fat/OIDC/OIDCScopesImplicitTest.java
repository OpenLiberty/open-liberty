...
public class OIDCScopesImplicitTest extends GenericScopesTests {

    public static RSCommonTestTools rsTools = new RSCommonTestTools();

    private static final Class<?> thisClass = OIDCScopesImplicitTest.class;
    ...
    public static void setupBeforeTest() throws Exception {
        ...
        //extraMsgs.add("CWWKS1402I.*" + Constants.OIDCCONFIGMEDIATOR_APP);
        ...
        emptyScopeActions = Constants.IMPLICIT_AUTHENTICATION_ACTION_WITH_ERR;
