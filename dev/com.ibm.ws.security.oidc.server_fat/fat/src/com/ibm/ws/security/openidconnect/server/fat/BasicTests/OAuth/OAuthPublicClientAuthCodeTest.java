...
public class OAuthPublicClientAuthCodeTest extends genericPublicClientAuthCodeTest {

    private static final Class<?> thisClass = OAuthPublicClientAuthCodeTest.class;
