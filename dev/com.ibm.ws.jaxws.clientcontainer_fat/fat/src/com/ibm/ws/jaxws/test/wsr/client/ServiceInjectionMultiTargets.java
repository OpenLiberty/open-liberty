...
//passed!
public class ServiceInjectionMultiTargets {

    @WebServiceRef(name = "services/serviceInjectionMultiTargets")
    static PeopleService service1;

    @WebServiceRef(name = "services/serviceInjectionMultiTargets", value = PeopleService.class)
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            People bill = ((PeopleService) service2).getBillPort();
            TestUtils.setEndpointAddressProperty((BindingProvider) bill, args[0], Integer.parseInt(args[1]));
            System.out.println(bill.hello("Response from ServiceInjectionMultiTargets"));
        } catch (Throwable t) {
