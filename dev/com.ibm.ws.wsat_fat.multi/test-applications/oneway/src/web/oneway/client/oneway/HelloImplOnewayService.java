...
@WebServiceClient(name = "HelloImplOnewayService", targetNamespace = "http://server.oneway.web/", wsdlLocation = "http://localhost:8010/oneway/HelloImplOnewayService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOIMPLONEWAYSERVICE_QNAME = new QName("http://server.oneway.web/", "HelloImplOnewayService");
    ...
    public HelloImplOneway getHelloImplOnewayPort() {
        return super.getPort(new QName("http://server.oneway.web/", "HelloImplOnewayPort"), HelloImplOneway.class);
    }
    ...
    public HelloImplOneway getHelloImplOnewayPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.oneway.web/", "HelloImplOnewayPort"), HelloImplOneway.class, features);
    }
