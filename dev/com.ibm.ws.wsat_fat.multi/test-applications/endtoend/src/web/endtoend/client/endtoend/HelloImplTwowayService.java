...
@WebServiceClient(name = "HelloImplTwowayService", targetNamespace = "http://server.endtoend.web/", wsdlLocation = "http://localhost:9888/endtoend/HelloImplTwowayService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOIMPLTWOWAYSERVICE_QNAME = new QName("http://server.endtoend.web/", "HelloImplTwowayService");
    ...
    public HelloImplTwoway getHelloImplTwowayPort() {
        return super.getPort(new QName("http://server.endtoend.web/", "HelloImplTwowayPort"), HelloImplTwoway.class);
    }
    ...
    public HelloImplTwoway getHelloImplTwowayPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.endtoend.web/", "HelloImplTwowayPort"), HelloImplTwoway.class, features);
    }
