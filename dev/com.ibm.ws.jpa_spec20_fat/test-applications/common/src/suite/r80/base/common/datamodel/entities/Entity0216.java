...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0216_SELECT",
                                    query = "SELECT e FROM Entity0216 e WHERE e.entity0216_id1 = :id1_0216 AND e.entity0216_id2 = :id2_0216 AND e.entity0216_id3 = :id3_0216")
              })
@Entity
@IdClass(IdClass0216.class)
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0216")
public class Entity0216 {
    ...
    @Version
    private short entity0216_version;

    private String entity0216_string01;

    private String entity0216_string02;

    private String entity0216_string03;

    public Entity0216() {}

    public Entity0216(BigDecimal id1,
                      BigDecimal id2,
                      BigDecimal id3,
                      short version,
                      String string01,
        ...
        this.entity0216_version = version;
        this.entity0216_string01 = string01;
        this.entity0216_string02 = string02;
        this.entity0216_string03 = string03;
    }
    ...
    public String toString() {
        return (" Entity0216: " +
                ...
                " entity0216_version: " + getEntity0216_version() +
                " entity0216_string01: " + getEntity0216_string01() +
                " entity0216_string02: " + getEntity0216_string02() +
                " entity0216_string03: " + getEntity0216_string03());
    }
    ...
    public void setEntity0216_id1(BigDecimal p) {
        this.entity0216_id1 = p;
    }
    ...
    public void setEntity0216_id2(BigDecimal p) {
        this.entity0216_id2 = p;
    }
    ...
    public void setEntity0216_id3(BigDecimal p) {
        this.entity0216_id3 = p;
    }

    public short getEntity0216_version() {
        return entity0216_version;
    }

    public void setEntity0216_version(short p) {
        this.entity0216_version = p;
    }

    public String getEntity0216_string01() {
        return entity0216_string01;
    }

    public void setEntity0216_string01(String p) {
        this.entity0216_string01 = p;
    }

    public String getEntity0216_string02() {
        return entity0216_string02;
    }

    public void setEntity0216_string02(String p) {
        this.entity0216_string02 = p;
    }

    public String getEntity0216_string03() {
        return entity0216_string03;
    }

    public void setEntity0216_string03(String p) {
        this.entity0216_string03 = p;
    }
}
