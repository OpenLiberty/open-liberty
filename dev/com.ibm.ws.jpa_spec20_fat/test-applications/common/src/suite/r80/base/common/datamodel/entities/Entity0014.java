...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0014_SELECT",
                                    query = "SELECT e FROM Entity0014 e WHERE e.entity0014_id = :id_0014"),
                        @NamedQuery(name = "ENTITY0014_UPDATE",
                                    query = "UPDATE Entity0014 e SET e.entity0014_string01 = :string01_0014, e.entity0014_string02 = :string02_0014, e.entity0014_string03 = :string03_0014 WHERE e.entity0014_id = :id_0014")
              })
@Entity
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0014")
public class Entity0014 {

    @Id
    private short entity0014_id;

    @Version
    private Timestamp entity0014_version;

    private String entity0014_string01;

    private String entity0014_string02;

    private String entity0014_string03;

    public Entity0014() {}

    public Entity0014(short id,
                      Timestamp version,
                      String string01,
                      String string02,
                      String string03) {
        this.entity0014_id = id;
        this.entity0014_version = version;
        this.entity0014_string01 = string01;
        this.entity0014_string02 = string02;
        this.entity0014_string03 = string03;
    }

    @Override
    public String toString() {
        return (" Entity0014: " +
                " entity0014_id: " + getEntity0014_id() +
                " entity0014_version: " + getEntity0014_version() +
                " entity0014_string01: " + getEntity0014_string01() +
                " entity0014_string02: " + getEntity0014_string02() +
                " entity0014_string03: " + getEntity0014_string03());
    }

    //----------------------------------------------------------------------------------------------
    // Persisent property accessor(s)
    //----------------------------------------------------------------------------------------------
    public short getEntity0014_id() {
        return entity0014_id;
    }

    public void setEntity0014_id(short p) {
        this.entity0014_id = p;
    }

    public Timestamp getEntity0014_version() {
        return entity0014_version;
    }

    public void setEntity0014_version(Timestamp p) {
        this.entity0014_version = p;
    }

    public String getEntity0014_string01() {
        return entity0014_string01;
    }

    public void setEntity0014_string01(String p) {
        this.entity0014_string01 = p;
    }

    public String getEntity0014_string02() {
        return entity0014_string02;
    }

    public void setEntity0014_string02(String p) {
        this.entity0014_string02 = p;
    }

    public String getEntity0014_string03() {
        return entity0014_string03;
    }

    public void setEntity0014_string03(String p) {
        this.entity0014_string03 = p;
    }
}
