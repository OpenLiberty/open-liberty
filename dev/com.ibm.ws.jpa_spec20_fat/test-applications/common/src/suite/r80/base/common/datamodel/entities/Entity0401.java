...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0401_SELECT",
                                    query = "SELECT e FROM Entity0401 e WHERE e.entity0401_id = :id_0401")
              })
@Entity
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0401")
public class Entity0401 {

    @Id
    @OneToOne
    private Entity0001 entity0401_id;

    @Version
    private Long entity0401_version;

    private String entity0401_string01;

    private String entity0401_string02;

    private String entity0401_string03;

    public Entity0401() {}

    public Entity0401(Entity0001 id,
                      Long version,
                      String string01,
                      String string02,
                      String string03) {
        this.entity0401_id = id;
        this.entity0401_version = version;
        this.entity0401_string01 = string01;
        this.entity0401_string02 = string02;
        this.entity0401_string03 = string03;
    }

    @Override
    public String toString() {
        return (" Entity0401: " +
                " entity0401_id: " + getEntity0401_id() +
                " entity0401_version: " + getEntity0401_version() +
                " entity0401_string01: " + getEntity0401_string01() +
                " entity0401_string02: " + getEntity0401_string02() +
                " entity0401_string03: " + getEntity0401_string03());
    }

    //----------------------------------------------------------------------------------------------
    // Persisent property accessor(s)
    //----------------------------------------------------------------------------------------------
    public Entity0001 getEntity0401_id() {
        return entity0401_id;
    }

    public void setEntity0401_id(Entity0001 p) {
        this.entity0401_id = p;
    }

    public Long getEntity0401_version() {
        return entity0401_version;
    }

    public void setEntity0401_version(Long p) {
        this.entity0401_version = p;
    }

    public String getEntity0401_string01() {
        return entity0401_string01;
    }

    public void setEntity0401_string01(String p) {
        this.entity0401_string01 = p;
    }

    public String getEntity0401_string02() {
        return entity0401_string02;
    }

    public void setEntity0401_string02(String p) {
        this.entity0401_string02 = p;
    }

    public String getEntity0401_string03() {
        return entity0401_string03;
    }

    public void setEntity0401_string03(String p) {
        this.entity0401_string03 = p;
    }
}
