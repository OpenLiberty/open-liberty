...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0323_SELECT",
                                    query = "SELECT e FROM Entity0323 e WHERE e.entity0323_id1 = :id1_0323 AND e.entity0323_id2 = :id2_0323 AND e.entity0323_id3 = :id3_0323")
              })
@Entity
@IdClass(IdClass0323.class)
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0323")
public class Entity0323 {
    ...
    @Version
    private long entity0323_version;

    private String entity0323_string01;

    private String entity0323_string02;

    private String entity0323_string03;

    public Entity0323() {}

    public Entity0323(Character id1,
                      double id2,
                      float id3,
                      long version,
                      String string01,
        ...
        this.entity0323_version = version;
        this.entity0323_string01 = string01;
        this.entity0323_string02 = string02;
        this.entity0323_string03 = string03;
    }
    ...
    public String toString() {
        return (" Entity0323: " +
                ...
                " entity0323_version: " + getEntity0323_version() +
                " entity0323_string01: " + getEntity0323_string01() +
                " entity0323_string02: " + getEntity0323_string02() +
                " entity0323_string03: " + getEntity0323_string03());
    }
    ...
    public void setEntity0323_id1(Character p) {
        this.entity0323_id1 = p;
    }
    ...
    public void setEntity0323_id2(double p) {
        this.entity0323_id2 = p;
    }
    ...
    public void setEntity0323_id3(float p) {
        this.entity0323_id3 = p;
    }

    public long getEntity0323_version() {
        return entity0323_version;
    }

    public void setEntity0323_version(long p) {
        this.entity0323_version = p;
    }

    public String getEntity0323_string01() {
        return entity0323_string01;
    }

    public void setEntity0323_string01(String p) {
        this.entity0323_string01 = p;
    }

    public String getEntity0323_string02() {
        return entity0323_string02;
    }

    public void setEntity0323_string02(String p) {
        this.entity0323_string02 = p;
    }

    public String getEntity0323_string03() {
        return entity0323_string03;
    }

    public void setEntity0323_string03(String p) {
        this.entity0323_string03 = p;
    }
}
