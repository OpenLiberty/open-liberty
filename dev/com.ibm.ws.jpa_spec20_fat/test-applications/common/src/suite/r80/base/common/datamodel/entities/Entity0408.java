...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0408_SELECT",
                                    query = "SELECT e FROM Entity0408 e WHERE e.entity0408_id = :id_0408")
              })
@Entity
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0408")
public class Entity0408 {

    @Id
    @OneToOne
    private Entity0008 entity0408_id;

    @Version
    private Long entity0408_version;

    private String entity0408_string01;

    private String entity0408_string02;

    private String entity0408_string03;

    public Entity0408() {}

    public Entity0408(Entity0008 id,
                      Long version,
                      String string01,
                      String string02,
                      String string03) {
        this.entity0408_id = id;
        this.entity0408_version = version;
        this.entity0408_string01 = string01;
        this.entity0408_string02 = string02;
        this.entity0408_string03 = string03;
    }

    @Override
    public String toString() {
        return (" Entity0408: " +
                " entity0408_id: " + getEntity0408_id() +
                " entity0408_version: " + getEntity0408_version() +
                " entity0408_string01: " + getEntity0408_string01() +
                " entity0408_string02: " + getEntity0408_string02() +
                " entity0408_string03: " + getEntity0408_string03());
    }

    //----------------------------------------------------------------------------------------------
    // Persisent property accessor(s)
    //----------------------------------------------------------------------------------------------
    public Entity0008 getEntity0408_id() {
        return entity0408_id;
    }

    public void setEntity0408_id(Entity0008 p) {
        this.entity0408_id = p;
    }

    public Long getEntity0408_version() {
        return entity0408_version;
    }

    public void setEntity0408_version(Long p) {
        this.entity0408_version = p;
    }

    public String getEntity0408_string01() {
        return entity0408_string01;
    }

    public void setEntity0408_string01(String p) {
        this.entity0408_string01 = p;
    }

    public String getEntity0408_string02() {
        return entity0408_string02;
    }

    public void setEntity0408_string02(String p) {
        this.entity0408_string02 = p;
    }

    public String getEntity0408_string03() {
        return entity0408_string03;
    }

    public void setEntity0408_string03(String p) {
        this.entity0408_string03 = p;
    }
}
