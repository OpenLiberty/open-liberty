...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0417_SELECT",
                                    query = "SELECT e FROM Entity0417 e WHERE e.entity0417_id = :id_0417")
              })
@Entity
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0417")
public class Entity0417 {

    @Id
    @OneToOne
    private Entity0017 entity0417_id;

    @Version
    private Short entity0417_version;

    private String entity0417_string01;

    private String entity0417_string02;

    private String entity0417_string03;

    public Entity0417() {}

    public Entity0417(Entity0017 id,
                      Short version,
                      String string01,
                      String string02,
                      String string03) {
        this.entity0417_id = id;
        this.entity0417_version = version;
        this.entity0417_string01 = string01;
        this.entity0417_string02 = string02;
        this.entity0417_string03 = string03;
    }

    @Override
    public String toString() {
        return (" Entity0417: " +
                " entity0417_id: " + getEntity0417_id() +
                " entity0417_version: " + getEntity0417_version() +
                " entity0417_string01: " + getEntity0417_string01() +
                " entity0417_string02: " + getEntity0417_string02() +
                " entity0417_string03: " + getEntity0417_string03());
    }

    //----------------------------------------------------------------------------------------------
    // Persisent property accessor(s)
    //----------------------------------------------------------------------------------------------
    public Entity0017 getEntity0417_id() {
        return entity0417_id;
    }

    public void setEntity0417_id(Entity0017 p) {
        this.entity0417_id = p;
    }

    public Short getEntity0417_version() {
        return entity0417_version;
    }

    public void setEntity0417_version(Short p) {
        this.entity0417_version = p;
    }

    public String getEntity0417_string01() {
        return entity0417_string01;
    }

    public void setEntity0417_string01(String p) {
        this.entity0417_string01 = p;
    }

    public String getEntity0417_string02() {
        return entity0417_string02;
    }

    public void setEntity0417_string02(String p) {
        this.entity0417_string02 = p;
    }

    public String getEntity0417_string03() {
        return entity0417_string03;
    }

    public void setEntity0417_string03(String p) {
        this.entity0417_string03 = p;
    }
}
