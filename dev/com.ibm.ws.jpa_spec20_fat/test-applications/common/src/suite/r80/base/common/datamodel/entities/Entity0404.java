...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0404_SELECT",
                                    query = "SELECT e FROM Entity0404 e WHERE e.entity0404_id = :id_0404")
              })
@Entity
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0404")
public class Entity0404 {

    @Id
    @OneToOne
    private Entity0004 entity0404_id;

    @Version
    private Timestamp entity0404_version;

    private String entity0404_string01;

    private String entity0404_string02;

    private String entity0404_string03;

    public Entity0404() {}

    public Entity0404(Entity0004 id,
                      Timestamp version,
                      String string01,
                      String string02,
                      String string03) {
        this.entity0404_id = id;
        this.entity0404_version = version;
        this.entity0404_string01 = string01;
        this.entity0404_string02 = string02;
        this.entity0404_string03 = string03;
    }

    @Override
    public String toString() {
        return (" Entity0404: " +
                " entity0404_id: " + getEntity0404_id() +
                " entity0404_version: " + getEntity0404_version() +
                " entity0404_string01: " + getEntity0404_string01() +
                " entity0404_string02: " + getEntity0404_string02() +
                " entity0404_string03: " + getEntity0404_string03());
    }

    //----------------------------------------------------------------------------------------------
    // Persisent property accessor(s)
    //----------------------------------------------------------------------------------------------
    public Entity0004 getEntity0404_id() {
        return entity0404_id;
    }

    public void setEntity0404_id(Entity0004 p) {
        this.entity0404_id = p;
    }

    public Timestamp getEntity0404_version() {
        return entity0404_version;
    }

    public void setEntity0404_version(Timestamp p) {
        this.entity0404_version = p;
    }

    public String getEntity0404_string01() {
        return entity0404_string01;
    }

    public void setEntity0404_string01(String p) {
        this.entity0404_string01 = p;
    }

    public String getEntity0404_string02() {
        return entity0404_string02;
    }

    public void setEntity0404_string02(String p) {
        this.entity0404_string02 = p;
    }

    public String getEntity0404_string03() {
        return entity0404_string03;
    }

    public void setEntity0404_string03(String p) {
        this.entity0404_string03 = p;
    }
}
