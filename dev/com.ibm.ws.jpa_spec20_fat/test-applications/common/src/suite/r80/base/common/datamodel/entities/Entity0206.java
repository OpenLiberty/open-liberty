...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0206_SELECT",
                                    query = "SELECT e FROM Entity0206 e WHERE e.entity0206_id1 = :id1_0206 AND e.entity0206_id2 = :id2_0206 AND e.entity0206_id3 = :id3_0206")
              })
@Entity
@IdClass(IdClass0206.class)
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0206")
public class Entity0206 {
    ...
    @Version
    private Integer entity0206_version;

    private String entity0206_string01;

    private String entity0206_string02;

    private String entity0206_string03;

    public Entity0206() {}

    public Entity0206(double id1,
                      double id2,
                      double id3,
                      Integer version,
                      String string01,
        ...
        this.entity0206_version = version;
        this.entity0206_string01 = string01;
        this.entity0206_string02 = string02;
        this.entity0206_string03 = string03;
    }
    ...
    public String toString() {
        return (" Entity0206: " +
                ...
                " entity0206_version: " + getEntity0206_version() +
                " entity0206_string01: " + getEntity0206_string01() +
                " entity0206_string02: " + getEntity0206_string02() +
                " entity0206_string03: " + getEntity0206_string03());
    }
    ...
    public void setEntity0206_id1(double p) {
        this.entity0206_id1 = p;
    }
    ...
    public void setEntity0206_id2(double p) {
        this.entity0206_id2 = p;
    }
    ...
    public void setEntity0206_id3(double p) {
        this.entity0206_id3 = p;
    }

    public Integer getEntity0206_version() {
        return entity0206_version;
    }

    public void setEntity0206_version(Integer p) {
        this.entity0206_version = p;
    }

    public String getEntity0206_string01() {
        return entity0206_string01;
    }

    public void setEntity0206_string01(String p) {
        this.entity0206_string01 = p;
    }

    public String getEntity0206_string02() {
        return entity0206_string02;
    }

    public void setEntity0206_string02(String p) {
        this.entity0206_string02 = p;
    }

    public String getEntity0206_string03() {
        return entity0206_string03;
    }

    public void setEntity0206_string03(String p) {
        this.entity0206_string03 = p;
    }
}
