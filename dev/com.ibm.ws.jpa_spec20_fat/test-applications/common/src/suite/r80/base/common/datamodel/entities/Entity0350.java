...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0350_SELECT",
                                    query = "SELECT e FROM Entity0350 e WHERE e.entity0350_id1 = :id1_0350 AND e.entity0350_id2 = :id2_0350 AND e.entity0350_id3 = :id3_0350")
              })
@Entity
@IdClass(IdClass0350.class)
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0350")
public class Entity0350 {
    ...
    @Version
    private Integer entity0350_version;

    private String entity0350_string01;

    private String entity0350_string02;

    private String entity0350_string03;

    public Entity0350() {}

    public Entity0350(BigDecimal id1,
                      java.sql.Date id2,
                      byte id3,
                      Integer version,
                      String string01,
        ...
        this.entity0350_version = version;
        this.entity0350_string01 = string01;
        this.entity0350_string02 = string02;
        this.entity0350_string03 = string03;
    }
    ...
    public String toString() {
        return (" Entity0350: " +
                ...
                " entity0350_version: " + getEntity0350_version() +
                " entity0350_string01: " + getEntity0350_string01() +
                " entity0350_string02: " + getEntity0350_string02() +
                " entity0350_string03: " + getEntity0350_string03());
    }
    ...
    public void setEntity0350_id1(BigDecimal p) {
        this.entity0350_id1 = p;
    }
    ...
    public void setEntity0350_id2(java.sql.Date p) {
        this.entity0350_id2 = p;
    }
    ...
    public void setEntity0350_id3(byte p) {
        this.entity0350_id3 = p;
    }

    public Integer getEntity0350_version() {
        return entity0350_version;
    }

    public void setEntity0350_version(Integer p) {
        this.entity0350_version = p;
    }

    public String getEntity0350_string01() {
        return entity0350_string01;
    }

    public void setEntity0350_string01(String p) {
        this.entity0350_string01 = p;
    }

    public String getEntity0350_string02() {
        return entity0350_string02;
    }

    public void setEntity0350_string02(String p) {
        this.entity0350_string02 = p;
    }

    public String getEntity0350_string03() {
        return entity0350_string03;
    }

    public void setEntity0350_string03(String p) {
        this.entity0350_string03 = p;
    }
}
