...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0328_SELECT",
                                    query = "SELECT e FROM Entity0328 e WHERE e.entity0328_id1 = :id1_0328 AND e.entity0328_id2 = :id2_0328 AND e.entity0328_id3 = :id3_0328")
              })
@Entity
@IdClass(IdClass0328.class)
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0328")
public class Entity0328 {
    ...
    @Version
    private int entity0328_version;

    private String entity0328_string01;

    private String entity0328_string02;

    private String entity0328_string03;

    public Entity0328() {}

    public Entity0328(Float id1,
                      Integer id2,
                      Long id3,
                      int version,
                      String string01,
        ...
        this.entity0328_version = version;
        this.entity0328_string01 = string01;
        this.entity0328_string02 = string02;
        this.entity0328_string03 = string03;
    }
    ...
    public String toString() {
        return (" Entity0328: " +
                ...
                " entity0328_version: " + getEntity0328_version() +
                " entity0328_string01: " + getEntity0328_string01() +
                " entity0328_string02: " + getEntity0328_string02() +
                " entity0328_string03: " + getEntity0328_string03());
    }
    ...
    public void setEntity0328_id1(Float p) {
        this.entity0328_id1 = p;
    }
    ...
    public void setEntity0328_id2(Integer p) {
        this.entity0328_id2 = p;
    }
    ...
    public void setEntity0328_id3(Long p) {
        this.entity0328_id3 = p;
    }

    public int getEntity0328_version() {
        return entity0328_version;
    }

    public void setEntity0328_version(int p) {
        this.entity0328_version = p;
    }

    public String getEntity0328_string01() {
        return entity0328_string01;
    }

    public void setEntity0328_string01(String p) {
        this.entity0328_string01 = p;
    }

    public String getEntity0328_string02() {
        return entity0328_string02;
    }

    public void setEntity0328_string02(String p) {
        this.entity0328_string02 = p;
    }

    public String getEntity0328_string03() {
        return entity0328_string03;
    }

    public void setEntity0328_string03(String p) {
        this.entity0328_string03 = p;
    }
}
