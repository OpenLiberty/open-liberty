...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0332_SELECT",
                                    query = "SELECT e FROM Entity0332 e WHERE e.entity0332_id1 = :id1_0332 AND e.entity0332_id2 = :id2_0332 AND e.entity0332_id3 = :id3_0332")
              })
@Entity
@IdClass(IdClass0332.class)
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0332")
public class Entity0332 {
    ...
    @Version
    private short entity0332_version;

    private String entity0332_string01;

    private String entity0332_string02;

    private String entity0332_string03;

    public Entity0332() {}

    public Entity0332(Long id1,
                      Short id2,
                      BigInteger id3,
                      short version,
                      String string01,
        ...
        this.entity0332_version = version;
        this.entity0332_string01 = string01;
        this.entity0332_string02 = string02;
        this.entity0332_string03 = string03;
    }
    ...
    public String toString() {
        return (" Entity0332: " +
                ...
                " entity0332_version: " + getEntity0332_version() +
                " entity0332_string01: " + getEntity0332_string01() +
                " entity0332_string02: " + getEntity0332_string02() +
                " entity0332_string03: " + getEntity0332_string03());
    }
    ...
    public void setEntity0332_id1(Long p) {
        this.entity0332_id1 = p;
    }
    ...
    public void setEntity0332_id2(Short p) {
        this.entity0332_id2 = p;
    }
    ...
    public void setEntity0332_id3(BigInteger p) {
        this.entity0332_id3 = p;
    }

    public short getEntity0332_version() {
        return entity0332_version;
    }

    public void setEntity0332_version(short p) {
        this.entity0332_version = p;
    }

    public String getEntity0332_string01() {
        return entity0332_string01;
    }

    public void setEntity0332_string01(String p) {
        this.entity0332_string01 = p;
    }

    public String getEntity0332_string02() {
        return entity0332_string02;
    }

    public void setEntity0332_string02(String p) {
        this.entity0332_string02 = p;
    }

    public String getEntity0332_string03() {
        return entity0332_string03;
    }

    public void setEntity0332_string03(String p) {
        this.entity0332_string03 = p;
    }
}
