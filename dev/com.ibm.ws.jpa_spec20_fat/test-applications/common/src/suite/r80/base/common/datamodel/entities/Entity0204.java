...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0204_SELECT",
                                    query = "SELECT e FROM Entity0204 e WHERE e.entity0204_id1 = :id1_0204 AND e.entity0204_id2 = :id2_0204 AND e.entity0204_id3 = :id3_0204")
              })
@Entity
@IdClass(IdClass0204.class)
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0204")
public class Entity0204 {
    ...
    @Version
    private Timestamp entity0204_version;

    private String entity0204_string01;

    private String entity0204_string02;

    private String entity0204_string03;

    public Entity0204() {}

    public Entity0204(Character id1,
                      Character id2,
                      Character id3,
                      Timestamp version,
                      String string01,
        ...
        this.entity0204_version = version;
        this.entity0204_string01 = string01;
        this.entity0204_string02 = string02;
        this.entity0204_string03 = string03;
    }
    ...
    public String toString() {
        return (" Entity0204: " +
                ...
                " entity0204_version: " + getEntity0204_version() +
                " entity0204_string01: " + getEntity0204_string01() +
                " entity0204_string02: " + getEntity0204_string02() +
                " entity0204_string03: " + getEntity0204_string03());
    }
    ...
    public void setEntity0204_id1(Character p) {
        this.entity0204_id1 = p;
    }
    ...
    public void setEntity0204_id2(Character p) {
        this.entity0204_id2 = p;
    }
    ...
    public void setEntity0204_id3(Character p) {
        this.entity0204_id3 = p;
    }

    public Timestamp getEntity0204_version() {
        return entity0204_version;
    }

    public void setEntity0204_version(Timestamp p) {
        this.entity0204_version = p;
    }

    public String getEntity0204_string01() {
        return entity0204_string01;
    }

    public void setEntity0204_string01(String p) {
        this.entity0204_string01 = p;
    }

    public String getEntity0204_string02() {
        return entity0204_string02;
    }

    public void setEntity0204_string02(String p) {
        this.entity0204_string02 = p;
    }

    public String getEntity0204_string03() {
        return entity0204_string03;
    }

    public void setEntity0204_string03(String p) {
        this.entity0204_string03 = p;
    }
}
