...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0351_SELECT",
                                    query = "SELECT e FROM Entity0351 e WHERE e.entity0351_id1 = :id1_0351 AND e.entity0351_id2 = :id2_0351 AND e.entity0351_id3 = :id3_0351")
              })
@Entity
@IdClass(IdClass0351.class)
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0351")
public class Entity0351 {
    ...
    @Version
    private long entity0351_version;

    private String entity0351_string01;

    private String entity0351_string02;

    private String entity0351_string03;

    public Entity0351() {}

    public Entity0351(java.sql.Date id1,
                      byte id2,
                      Character id3,
                      long version,
                      String string01,
        ...
        this.entity0351_version = version;
        this.entity0351_string01 = string01;
        this.entity0351_string02 = string02;
        this.entity0351_string03 = string03;
    }
    ...
    public String toString() {
        return (" Entity0351: " +
                ...
                " entity0351_version: " + getEntity0351_version() +
                " entity0351_string01: " + getEntity0351_string01() +
                " entity0351_string02: " + getEntity0351_string02() +
                " entity0351_string03: " + getEntity0351_string03());
    }
    ...
    public void setEntity0351_id1(java.sql.Date p) {
        this.entity0351_id1 = p;
    }
    ...
    public void setEntity0351_id2(byte p) {
        this.entity0351_id2 = p;
    }
    ...
    public void setEntity0351_id3(Character p) {
        this.entity0351_id3 = p;
    }

    public long getEntity0351_version() {
        return entity0351_version;
    }

    public void setEntity0351_version(long p) {
        this.entity0351_version = p;
    }

    public String getEntity0351_string01() {
        return entity0351_string01;
    }

    public void setEntity0351_string01(String p) {
        this.entity0351_string01 = p;
    }

    public String getEntity0351_string02() {
        return entity0351_string02;
    }

    public void setEntity0351_string02(String p) {
        this.entity0351_string02 = p;
    }

    public String getEntity0351_string03() {
        return entity0351_string03;
    }

    public void setEntity0351_string03(String p) {
        this.entity0351_string03 = p;
    }
}
