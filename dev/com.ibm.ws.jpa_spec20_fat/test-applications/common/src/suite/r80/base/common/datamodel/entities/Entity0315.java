...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0315_SELECT",
                                    query = "SELECT e FROM Entity0315 e WHERE e.entity0315_id1 = :id1_0315 AND e.entity0315_id2 = :id2_0315 AND e.entity0315_id3 = :id3_0315")
              })
@Entity
@IdClass(IdClass0315.class)
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0315")
public class Entity0315 {
    ...
    @Version
    private Integer entity0315_version;

    private String entity0315_string01;

    private String entity0315_string02;

    private String entity0315_string03;

    public Entity0315() {}

    public Entity0315(Short id1,
                      BigDecimal id2,
                      BigInteger id3,
                      Integer version,
                      String string01,
        ...
        this.entity0315_version = version;
        this.entity0315_string01 = string01;
        this.entity0315_string02 = string02;
        this.entity0315_string03 = string03;
    }
    ...
    public String toString() {
        return (" Entity0315: " +
                ...
                " entity0315_version: " + getEntity0315_version() +
                " entity0315_string01: " + getEntity0315_string01() +
                " entity0315_string02: " + getEntity0315_string02() +
                " entity0315_string03: " + getEntity0315_string03());
    }
    ...
    public void setEntity0315_id1(Short p) {
        this.entity0315_id1 = p;
    }
    ...
    public void setEntity0315_id2(BigDecimal p) {
        this.entity0315_id2 = p;
    }
    ...
    public void setEntity0315_id3(BigInteger p) {
        this.entity0315_id3 = p;
    }

    public Integer getEntity0315_version() {
        return entity0315_version;
    }

    public void setEntity0315_version(Integer p) {
        this.entity0315_version = p;
    }

    public String getEntity0315_string01() {
        return entity0315_string01;
    }

    public void setEntity0315_string01(String p) {
        this.entity0315_string01 = p;
    }

    public String getEntity0315_string02() {
        return entity0315_string02;
    }

    public void setEntity0315_string02(String p) {
        this.entity0315_string02 = p;
    }

    public String getEntity0315_string03() {
        return entity0315_string03;
    }

    public void setEntity0315_string03(String p) {
        this.entity0315_string03 = p;
    }
}
