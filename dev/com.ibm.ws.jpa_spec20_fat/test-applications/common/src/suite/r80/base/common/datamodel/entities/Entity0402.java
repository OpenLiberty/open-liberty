...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0402_SELECT",
                                    query = "SELECT e FROM Entity0402 e WHERE e.entity0402_id = :id_0402")
              })
@Entity
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0402")
public class Entity0402 {

    @Id
    @OneToOne
    private Entity0002 entity0402_id;

    @Version
    private short entity0402_version;

    private String entity0402_string01;

    private String entity0402_string02;

    private String entity0402_string03;

    public Entity0402() {}

    public Entity0402(Entity0002 id,
                      short version,
                      String string01,
                      String string02,
                      String string03) {
        this.entity0402_id = id;
        this.entity0402_version = version;
        this.entity0402_string01 = string01;
        this.entity0402_string02 = string02;
        this.entity0402_string03 = string03;
    }

    @Override
    public String toString() {
        return (" Entity0402: " +
                " entity0402_id: " + getEntity0402_id() +
                " entity0402_version: " + getEntity0402_version() +
                " entity0402_string01: " + getEntity0402_string01() +
                " entity0402_string02: " + getEntity0402_string02() +
                " entity0402_string03: " + getEntity0402_string03());
    }

    //----------------------------------------------------------------------------------------------
    // Persisent property accessor(s)
    //----------------------------------------------------------------------------------------------
    public Entity0002 getEntity0402_id() {
        return entity0402_id;
    }

    public void setEntity0402_id(Entity0002 p) {
        this.entity0402_id = p;
    }

    public short getEntity0402_version() {
        return entity0402_version;
    }

    public void setEntity0402_version(short p) {
        this.entity0402_version = p;
    }

    public String getEntity0402_string01() {
        return entity0402_string01;
    }

    public void setEntity0402_string01(String p) {
        this.entity0402_string01 = p;
    }

    public String getEntity0402_string02() {
        return entity0402_string02;
    }

    public void setEntity0402_string02(String p) {
        this.entity0402_string02 = p;
    }

    public String getEntity0402_string03() {
        return entity0402_string03;
    }

    public void setEntity0402_string03(String p) {
        this.entity0402_string03 = p;
    }
}
