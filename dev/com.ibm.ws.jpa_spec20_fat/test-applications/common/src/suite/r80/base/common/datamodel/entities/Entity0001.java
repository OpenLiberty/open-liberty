...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0001_SELECT",
                                    query = "SELECT e FROM Entity0001 e WHERE e.entity0001_id = :id_0001"),
                        @NamedQuery(name = "ENTITY0001_UPDATE",
                                    query = "UPDATE Entity0001 e SET e.entity0001_string01 = :string01_0001, e.entity0001_string02 = :string02_0001, e.entity0001_string03 = :string03_0001 WHERE e.entity0001_id = :id_0001")
              })
@Entity
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0001")
public class Entity0001 {

    @Id
    private byte entity0001_id;

    @Version
    private int entity0001_version;

    private String entity0001_string01;

    private String entity0001_string02;

    private String entity0001_string03;

    public Entity0001() {}

    public Entity0001(byte id,
                      int version,
                      String string01,
                      String string02,
                      String string03) {
        this.entity0001_id = id;
        this.entity0001_version = version;
        this.entity0001_string01 = string01;
        this.entity0001_string02 = string02;
        this.entity0001_string03 = string03;
    }

    @Override
    public String toString() {
        return (" Entity0001: " +
                " entity0001_id: " + getEntity0001_id() +
                " entity0001_version: " + getEntity0001_version() +
                " entity0001_string01: " + getEntity0001_string01() +
                " entity0001_string02: " + getEntity0001_string02() +
                " entity0001_string03: " + getEntity0001_string03());
    }

    //----------------------------------------------------------------------------------------------
    // Persisent property accessor(s)
    //----------------------------------------------------------------------------------------------
    public byte getEntity0001_id() {
        return entity0001_id;
    }

    public void setEntity0001_id(byte p) {
        this.entity0001_id = p;
    }

    public int getEntity0001_version() {
        return entity0001_version;
    }

    public void setEntity0001_version(int p) {
        this.entity0001_version = p;
    }

    public String getEntity0001_string01() {
        return entity0001_string01;
    }

    public void setEntity0001_string01(String p) {
        this.entity0001_string01 = p;
    }

    public String getEntity0001_string02() {
        return entity0001_string02;
    }

    public void setEntity0001_string02(String p) {
        this.entity0001_string02 = p;
    }

    public String getEntity0001_string03() {
        return entity0001_string03;
    }

    public void setEntity0001_string03(String p) {
        this.entity0001_string03 = p;
    }
}
