...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0116_SELECT",
                                    query = "SELECT e FROM Entity0116 e WHERE e.entity0116_id1 = :id1_0116 AND e.entity0116_id2 = :id2_0116")
              })
@Entity
@IdClass(IdClass0116.class)
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0116")
public class Entity0116 {
    ...
    @Version
    private Timestamp entity0116_version;

    private String entity0116_string01;

    private String entity0116_string02;

    private String entity0116_string03;

    public Entity0116() {}

    public Entity0116(BigDecimal id1,
                      BigDecimal id2,
                      Timestamp version,
                      String string01,
                      String string02,
                      String string03) {
        this.entity0116_id1 = id1;
        this.entity0116_id2 = id2;
        this.entity0116_version = version;
        this.entity0116_string01 = string01;
        this.entity0116_string02 = string02;
        this.entity0116_string03 = string03;
    }

    @Override
    public String toString() {
        return (" Entity0116: " +
                " entity0116_id1: " + getEntity0116_id1() +
                " entity0116_id2: " + getEntity0116_id2() +
                " entity0116_version: " + getEntity0116_version() +
                " entity0116_string01: " + getEntity0116_string01() +
                " entity0116_string02: " + getEntity0116_string02() +
                " entity0116_string03: " + getEntity0116_string03());
    }

    //----------------------------------------------------------------------------------------------
    // Persisent property accessor(s)
    //----------------------------------------------------------------------------------------------
    public BigDecimal getEntity0116_id1() {
        return entity0116_id1;
    }

    public void setEntity0116_id1(BigDecimal p) {
        this.entity0116_id1 = p;
    }

    public BigDecimal getEntity0116_id2() {
        return entity0116_id2;
    }

    public void setEntity0116_id2(BigDecimal p) {
        this.entity0116_id2 = p;
    }

    public Timestamp getEntity0116_version() {
        return entity0116_version;
    }

    public void setEntity0116_version(Timestamp p) {
        this.entity0116_version = p;
    }

    public String getEntity0116_string01() {
        return entity0116_string01;
    }

    public void setEntity0116_string01(String p) {
        this.entity0116_string01 = p;
    }

    public String getEntity0116_string02() {
        return entity0116_string02;
    }

    public void setEntity0116_string02(String p) {
        this.entity0116_string02 = p;
    }

    public String getEntity0116_string03() {
        return entity0116_string03;
    }

    public void setEntity0116_string03(String p) {
        this.entity0116_string03 = p;
    }
}
