 ...
 *
 *          +----------------------                +----------------------+                +----------------------+
 *          |  EntityManyToOne01  |<-------------->|  EntityManyToOne01  |<-------------->|  EntityManyToOne02  |
 *          +----------------------  n          n  +----------------------+  n          n  +----------------------+
 *
 * </pre>
 */
...
@Table(name = "CDM_EntityManyToOne01")
public class EntityManyToOne01 {

    @Basic(fetch = FetchType.EAGER)
    @Column(columnDefinition = "INTEGER",
            insertable = true,
            length = 15,
            name = "entityManyToOne01_id",
            nullable = false,
            precision = 15,
            scale = 15,
            table = "CDM_EntityManyToOne01",
            updatable = true)
    @Id
    private int entityManyToOne01_id;

    @Basic(fetch = FetchType.LAZY)
    @Column(columnDefinition = "INTEGER",
            insertable = true,
            length = 15,
            name = "entityManyToOne01_version",
            nullable = false,
            precision = 15,
            scale = 15,
            table = "CDM_EntityManyToOne01",
            updatable = true)
    @Version
    private int entityManyToOne01_version;

    public EntityManyToOne01() {}

    public EntityManyToOne01(int id,
                             int version) {

        this.entityManyToOne01_id = id;
        this.entityManyToOne01_version = version;
    }

    @Override
    public String toString() {
        return (" EntityManyToOne01: " +
                " entityManyToOne01_id: " + getEntityManyToOne01_id() +
                " entityManyToOne01_version: " + getEntityManyToOne01_version());
    }

    //----------------------------------------------------------------------------------------------
    // Persisent property accessor(s)
    //----------------------------------------------------------------------------------------------
    public int getEntityManyToOne01_id() {
        return entityManyToOne01_id;
    }

    public void setEntityManyToOne01_id(int p) {
        this.entityManyToOne01_id = p;
    }

    public int getEntityManyToOne01_version() {
        return entityManyToOne01_version;
    }

    public void setEntityManyToOne01_version(int p) {
        this.entityManyToOne01_version = p;
    }
