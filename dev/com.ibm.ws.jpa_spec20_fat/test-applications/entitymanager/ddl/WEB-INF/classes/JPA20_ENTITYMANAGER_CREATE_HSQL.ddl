CREATE TABLE ${schemaname}.EMDETACH_ENTAM2MLIST (JPA20ENTITYMANAGERDETACHENTITY_ID INTEGER, ENTAM2MLIST_ID INTEGER);
CREATE TABLE ${schemaname}.EMDETACH_ENTAM2MLIST_CA (JPA20ENTITYMANAGERDETACHENTITY_ID INTEGER, ENTAM2MLIST_CA_ID INTEGER);
CREATE TABLE ${schemaname}.EMDETACH_ENTAM2MLIST_CD (JPA20ENTITYMANAGERDETACHENTITY_ID INTEGER, ENTAM2MLIST_CD_ID INTEGER);
CREATE TABLE ${schemaname}.EMDETACH_ENTAO2MLIST (JPA20ENTITYMANAGERDETACHENTITY_ID INTEGER, ENTAO2MLIST_ID INTEGER);
CREATE TABLE ${schemaname}.EMDETACH_ENTAO2MLIST_CA (JPA20ENTITYMANAGERDETACHENTITY_ID INTEGER, ENTAO2MLIST_CA_ID INTEGER);
CREATE TABLE ${schemaname}.EMDETACH_ENTAO2MLIST_CD (JPA20ENTITYMANAGERDETACHENTITY_ID INTEGER, ENTAO2MLIST_CD_ID INTEGER);
CREATE TABLE ${schemaname}.JPA20EntityManagerDetachEntity (id INTEGER NOT NULL, strData VARCHAR(255), ENTAM2O_ID INTEGER, ENTAM2O_CA_ID INTEGER, ENTAM2O_CD_ID INTEGER, ENTAO2O_ID INTEGER, ENTAO2O_CA_ID INTEGER, ENTAO2O_CD_ID INTEGER, PRIMARY KEY (id));
CREATE TABLE ${schemaname}.JPA20EntityManagerEntityA (id INTEGER NOT NULL, strData VARCHAR(255), PRIMARY KEY (id));
CREATE TABLE ${schemaname}.JPA20EntityManagerEntityA_JPA20EntityManagerEntityB (ENTITYALIST_ID INTEGER, ENTITYBLIST_ID INTEGER);
CREATE TABLE ${schemaname}.JPA20EntityManagerEntityB (id INTEGER NOT NULL, strData VARCHAR(255), PRIMARY KEY (id));
CREATE TABLE ${schemaname}.JPA20EntityManagerEntityC (id INTEGER NOT NULL, strData VARCHAR(255), ENTITYA_ID INTEGER, ENTITYALAZY_ID INTEGER, PRIMARY KEY (id));
CREATE TABLE ${schemaname}.JPA20EntityManagerFindEntity (id INTEGER NOT NULL, firstName VARCHAR(255), lastName VARCHAR(255), vacationDays INTEGER, PRIMARY KEY (id));
