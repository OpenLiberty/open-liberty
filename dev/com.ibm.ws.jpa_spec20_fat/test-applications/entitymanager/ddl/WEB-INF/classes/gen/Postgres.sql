...
CREATE TABLE JPA20EMDetachEntity (id INTEGER NOT NULL, strData VARCHAR(255), version BIGINT, ENTAM2O_ID INTEGER, ENTAM2O_CA_ID INTEGER, ENTAM2O_CD_ID INTEGER, ENTAO2O_ID INTEGER, ENTAO2O_CA_ID INTEGER, ENTAO2O_CD_ID INTEGER, PRIMARY KEY (id));
