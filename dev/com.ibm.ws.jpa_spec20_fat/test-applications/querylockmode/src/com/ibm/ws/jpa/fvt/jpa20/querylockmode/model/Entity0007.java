...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0007_SELECT",
                                    query = "SELECT e FROM Entity0007 e WHERE e.entity0007_id = :id_0007"),
                        @NamedQuery(name = "ENTITY0007_UPDATE",
                                    query = "UPDATE Entity0007 e SET e.entity0007_string01 = :string01_0007, e.entity0007_string02 = :string02_0007, e.entity0007_string03 = :string03_0007 WHERE e.entity0007_id = :id_0007")
              })
@Entity
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0007")
public class Entity0007 {

    @Id
    private Double entity0007_id;

    @Version
    private Timestamp entity0007_version;

    private String entity0007_string01;

    private String entity0007_string02;

    private String entity0007_string03;

    public Entity0007() {}

    public Entity0007(Double id,
                      Timestamp version,
                      String string01,
                      String string02,
                      String string03) {
        this.entity0007_id = id;
        this.entity0007_version = version;
        this.entity0007_string01 = string01;
        this.entity0007_string02 = string02;
        this.entity0007_string03 = string03;
    }

    @Override
    public String toString() {
        return (" Entity0007: " +
                " entity0007_id: " + getEntity0007_id() +
                " entity0007_version: " + getEntity0007_version() +
                " entity0007_string01: " + getEntity0007_string01() +
                " entity0007_string02: " + getEntity0007_string02() +
                " entity0007_string03: " + getEntity0007_string03());
    }

    //----------------------------------------------------------------------------------------------
    // Persisent property accessor(s)
    //----------------------------------------------------------------------------------------------
    public Double getEntity0007_id() {
        return entity0007_id;
    }

    public void setEntity0007_id(Double p) {
        this.entity0007_id = p;
    }

    public Timestamp getEntity0007_version() {
        return entity0007_version;
    }

    public void setEntity0007_version(Timestamp p) {
        this.entity0007_version = p;
    }

    public String getEntity0007_string01() {
        return entity0007_string01;
    }

    public void setEntity0007_string01(String p) {
        this.entity0007_string01 = p;
    }

    public String getEntity0007_string02() {
        return entity0007_string02;
    }

    public void setEntity0007_string02(String p) {
        this.entity0007_string02 = p;
    }

    public String getEntity0007_string03() {
        return entity0007_string03;
    }

    public void setEntity0007_string03(String p) {
        this.entity0007_string03 = p;
    }
}
