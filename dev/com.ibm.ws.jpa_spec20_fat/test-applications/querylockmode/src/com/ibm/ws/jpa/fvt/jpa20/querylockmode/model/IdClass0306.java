 ...
 * </ol>
 */
public class IdClass0306 implements Serializable {
    ...
    public boolean equals(Object o) {
        if (o == null)
            return false;
        if (!(o instanceof IdClass0306))
            return false;
        if (o == this)
            return true;
        IdClass0306 idClass = (IdClass0306) o;
        return (idClass.entity0306_id1 == entity0306_id1 &&
                idClass.entity0306_id2 == entity0306_id2 &&
                idClass.entity0306_id3 == entity0306_id3);
    ...
    public int hashCode() {
        int result = 0;
        Long long1 = Double.doubleToLongBits(entity0306_id1);
        result = result + (int) (long1 ^ (long1 >>> 32));
        result = result + entity0306_id2.hashCode();
        result = result + Float.floatToIntBits(entity0306_id3);
        return result;
    }
