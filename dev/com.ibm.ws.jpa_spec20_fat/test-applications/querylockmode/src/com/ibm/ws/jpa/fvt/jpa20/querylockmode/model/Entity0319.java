...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0319_SELECT",
                                    query = "SELECT e FROM Entity0319 e WHERE e.entity0319_id1 = :id1_0319 AND e.entity0319_id2 = :id2_0319 AND e.entity0319_id3 = :id3_0319")
              })
@Entity
@IdClass(IdClass0319.class)
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0319")
public class Entity0319 {
    ...
    @Version
    private Short entity0319_version;

    private String entity0319_string01;

    private String entity0319_string02;

    private String entity0319_string03;

    public Entity0319() {}

    public Entity0319(java.sql.Date id1,
                      java.util.Date id2,
                      java.sql.Date id3,
                      Short version,
                      String string01,
        ...
        this.entity0319_version = version;
        this.entity0319_string01 = string01;
        this.entity0319_string02 = string02;
        this.entity0319_string03 = string03;
    }
    ...
    public String toString() {
        return (" Entity0319: " +
                ...
                " entity0319_version: " + getEntity0319_version() +
                " entity0319_string01: " + getEntity0319_string01() +
                " entity0319_string02: " + getEntity0319_string02() +
                " entity0319_string03: " + getEntity0319_string03());
    }
    ...
    public void setEntity0319_id1(java.sql.Date p) {
        this.entity0319_id1 = p;
    }
    ...
    public void setEntity0319_id2(java.util.Date p) {
        this.entity0319_id2 = p;
    }
    ...
    public void setEntity0319_id3(java.sql.Date p) {
        this.entity0319_id3 = p;
    }

    public Short getEntity0319_version() {
        return entity0319_version;
    }

    public void setEntity0319_version(Short p) {
        this.entity0319_version = p;
    }

    public String getEntity0319_string01() {
        return entity0319_string01;
    }

    public void setEntity0319_string01(String p) {
        this.entity0319_string01 = p;
    }

    public String getEntity0319_string02() {
        return entity0319_string02;
    }

    public void setEntity0319_string02(String p) {
        this.entity0319_string02 = p;
    }

    public String getEntity0319_string03() {
        return entity0319_string03;
    }

    public void setEntity0319_string03(String p) {
        this.entity0319_string03 = p;
    }
}
