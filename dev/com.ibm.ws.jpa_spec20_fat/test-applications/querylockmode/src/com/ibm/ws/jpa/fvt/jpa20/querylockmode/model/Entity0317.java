...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0317_SELECT",
                                    query = "SELECT e FROM Entity0317 e WHERE e.entity0317_id1 = :id1_0317 AND e.entity0317_id2 = :id2_0317 AND e.entity0317_id3 = :id3_0317")
              })
@Entity
@IdClass(IdClass0317.class)
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0317")
public class Entity0317 {
    ...
    @Version
    private Long entity0317_version;

    private String entity0317_string01;

    private String entity0317_string02;

    private String entity0317_string03;

    public Entity0317() {}

    public Entity0317(BigInteger id1,
                      java.util.Date id2,
                      java.sql.Date id3,
                      Long version,
                      String string01,
        ...
        this.entity0317_version = version;
        this.entity0317_string01 = string01;
        this.entity0317_string02 = string02;
        this.entity0317_string03 = string03;
    }
    ...
    public String toString() {
        return (" Entity0317 " +
                ...
                " entity0317_version: " + getEntity0317_version() +
                " entity0317_string01: " + getEntity0317_string01() +
                " entity0317_string02: " + getEntity0317_string02() +
                " entity0317_string03: " + getEntity0317_string03());
    }
    ...
    public void setEntity0317_id1(BigInteger p) {
        this.entity0317_id1 = p;
    }
    ...
    public void setEntity0317_id2(java.util.Date p) {
        this.entity0317_id2 = p;
    }
    ...
    public void setEntity0317_id3(java.sql.Date p) {
        this.entity0317_id3 = p;
    }

    public Long getEntity0317_version() {
        return entity0317_version;
    }

    public void setEntity0317_version(Long p) {
        this.entity0317_version = p;
    }

    public String getEntity0317_string01() {
        return entity0317_string01;
    }

    public void setEntity0317_string01(String p) {
        this.entity0317_string01 = p;
    }

    public String getEntity0317_string02() {
        return entity0317_string02;
    }

    public void setEntity0317_string02(String p) {
        this.entity0317_string02 = p;
    }

    public String getEntity0317_string03() {
        return entity0317_string03;
    }

    public void setEntity0317_string03(String p) {
        this.entity0317_string03 = p;
    }
}
