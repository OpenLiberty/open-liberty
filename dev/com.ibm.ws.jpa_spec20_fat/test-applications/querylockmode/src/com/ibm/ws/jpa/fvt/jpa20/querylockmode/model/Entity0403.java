...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0403_SELECT",
                                    query = "SELECT e FROM Entity0403 e WHERE e.entity0403_id = :id_0403")
              })
@Entity
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0403")
public class Entity0403 {

    @Id
    @OneToOne
    private Entity0003 entity0403_id;

    @Version
    private Short entity0403_version;

    private String entity0403_string01;

    private String entity0403_string02;

    private String entity0403_string03;

    public Entity0403() {}

    public Entity0403(Entity0003 id,
                      Short version,
                      String string01,
                      String string02,
                      String string03) {
        this.entity0403_id = id;
        this.entity0403_version = version;
        this.entity0403_string01 = string01;
        this.entity0403_string02 = string02;
        this.entity0403_string03 = string03;
    }

    @Override
    public String toString() {
        return (" Entity0403: " +
                " entity0403_id: " + getEntity0403_id() +
                " entity0403_version: " + getEntity0403_version() +
                " entity0403_string01: " + getEntity0403_string01() +
                " entity0403_string02: " + getEntity0403_string02() +
                " entity0403_string03: " + getEntity0403_string03());
    }

    //----------------------------------------------------------------------------------------------
    // Persisent property accessor(s)
    //----------------------------------------------------------------------------------------------
    public Entity0003 getEntity0403_id() {
        return entity0403_id;
    }

    public void setEntity0403_id(Entity0003 p) {
        this.entity0403_id = p;
    }

    public Short getEntity0403_version() {
        return entity0403_version;
    }

    public void setEntity0403_version(Short p) {
        this.entity0403_version = p;
    }

    public String getEntity0403_string01() {
        return entity0403_string01;
    }

    public void setEntity0403_string01(String p) {
        this.entity0403_string01 = p;
    }

    public String getEntity0403_string02() {
        return entity0403_string02;
    }

    public void setEntity0403_string02(String p) {
        this.entity0403_string02 = p;
    }

    public String getEntity0403_string03() {
        return entity0403_string03;
    }

    public void setEntity0403_string03(String p) {
        this.entity0403_string03 = p;
    }
}
