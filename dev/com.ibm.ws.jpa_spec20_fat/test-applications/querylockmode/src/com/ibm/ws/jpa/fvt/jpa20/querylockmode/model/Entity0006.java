...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0006_SELECT",
                                    query = "SELECT e FROM Entity0006 e WHERE e.entity0006_id = :id_0006"),
                        @NamedQuery(name = "ENTITY0006_UPDATE",
                                    query = "UPDATE Entity0006 e SET e.entity0006_string01 = :string01_0006, e.entity0006_string02 = :string02_0006, e.entity0006_string03 = :string03_0006 WHERE e.entity0006_id = :id_0006")
              })
@Entity
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0006")
public class Entity0006 {

    @Id
    private double entity0006_id;

    @Version
    private Short entity0006_version;

    private String entity0006_string01;

    private String entity0006_string02;

    private String entity0006_string03;

    public Entity0006() {}

    public Entity0006(double id,
                      Short version,
                      String string01,
                      String string02,
                      String string03) {
        this.entity0006_id = id;
        this.entity0006_version = version;
        this.entity0006_string01 = string01;
        this.entity0006_string02 = string02;
        this.entity0006_string03 = string03;
    }

    @Override
    public String toString() {
        return (" Entity0006: " +
                " entity0006_id: " + getEntity0006_id() +
                " entity0006_version: " + getEntity0006_version() +
                " entity0006_string01: " + getEntity0006_string01() +
                " entity0006_string02: " + getEntity0006_string02() +
                " entity0006_string03: " + getEntity0006_string03());
    }

    //----------------------------------------------------------------------------------------------
    // Persisent property accessor(s)
    //----------------------------------------------------------------------------------------------
    public double getEntity0006_id() {
        return entity0006_id;
    }

    public void setEntity0006_id(double p) {
        this.entity0006_id = p;
    }

    public Short getEntity0006_version() {
        return entity0006_version;
    }

    public void setEntity0006_version(Short p) {
        this.entity0006_version = p;
    }

    public String getEntity0006_string01() {
        return entity0006_string01;
    }

    public void setEntity0006_string01(String p) {
        this.entity0006_string01 = p;
    }

    public String getEntity0006_string02() {
        return entity0006_string02;
    }

    public void setEntity0006_string02(String p) {
        this.entity0006_string02 = p;
    }

    public String getEntity0006_string03() {
        return entity0006_string03;
    }

    public void setEntity0006_string03(String p) {
        this.entity0006_string03 = p;
    }
}
