...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0307_SELECT",
                                    query = "SELECT e FROM Entity0307 e WHERE e.entity0307_id1 = :id1_0307 AND e.entity0307_id2 = :id2_0307 AND e.entity0307_id3 = :id3_0307")
              })
@Entity
@IdClass(IdClass0307.class)
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0307")
public class Entity0307 {
    ...
    @Version
    private int entity0307_version;

    private String entity0307_string01;

    private String entity0307_string02;

    private String entity0307_string03;

    public Entity0307() {}

    public Entity0307(Double id1,
                      float id2,
                      Float id3,
                      int version,
                      String string01,
        ...
        this.entity0307_version = version;
        this.entity0307_string01 = string01;
        this.entity0307_string02 = string02;
        this.entity0307_string03 = string03;
    }
    ...
    public String toString() {
        return (" Entity0307: " +
                ...
                " entity0307_version: " + getEntity0307_version() +
                " entity0307_string01: " + getEntity0307_string01() +
                " entity0307_string02: " + getEntity0307_string02() +
                " entity0307_string03: " + getEntity0307_string03());
    }
    ...
    public void setEntity0307_id1(Double p) {
        this.entity0307_id1 = p;
    }
    ...
    public void setEntity0307_id2(float p) {
        this.entity0307_id2 = p;
    }
    ...
    public void setEntity0307_id3(Float p) {
        this.entity0307_id3 = p;
    }

    public int getEntity0307_version() {
        return entity0307_version;
    }

    public void setEntity0307_version(int p) {
        this.entity0307_version = p;
    }

    public String getEntity0307_string01() {
        return entity0307_string01;
    }

    public void setEntity0307_string01(String p) {
        this.entity0307_string01 = p;
    }

    public String getEntity0307_string02() {
        return entity0307_string02;
    }

    public void setEntity0307_string02(String p) {
        this.entity0307_string02 = p;
    }

    public String getEntity0307_string03() {
        return entity0307_string03;
    }

    public void setEntity0307_string03(String p) {
        this.entity0307_string03 = p;
    }
}
