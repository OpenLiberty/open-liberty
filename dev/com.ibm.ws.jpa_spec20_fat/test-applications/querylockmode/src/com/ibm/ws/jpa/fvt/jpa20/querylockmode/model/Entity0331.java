...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0331_SELECT",
                                    query = "SELECT e FROM Entity0331 e WHERE e.entity0331_id1 = :id1_0331 AND e.entity0331_id2 = :id2_0331 AND e.entity0331_id3 = :id3_0331")
              })
@Entity
@IdClass(IdClass0331.class)
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0331")
public class Entity0331 {
    ...
    @Version
    private Long entity0331_version;

    private String entity0331_string01;

    private String entity0331_string02;

    private String entity0331_string03;

    public Entity0331() {}

    public Entity0331(long id1,
                      short id2,
                      BigDecimal id3,
                      Long version,
                      String string01,
        ...
        this.entity0331_version = version;
        this.entity0331_string01 = string01;
        this.entity0331_string02 = string02;
        this.entity0331_string03 = string03;
    }
    ...
    public String toString() {
        return (" Entity0331: " +
                ...
                " entity0331_version: " + getEntity0331_version() +
                " entity0331_string01: " + getEntity0331_string01() +
                " entity0331_string02: " + getEntity0331_string02() +
                " entity0331_string03: " + getEntity0331_string03());
    }
    ...
    public void setEntity0331_id1(long p) {
        this.entity0331_id1 = p;
    }
    ...
    public void setEntity0331_id2(short p) {
        this.entity0331_id2 = p;
    }
    ...
    public void setEntity0331_id3(BigDecimal p) {
        this.entity0331_id3 = p;
    }

    public Long getEntity0331_version() {
        return entity0331_version;
    }

    public void setEntity0331_version(Long p) {
        this.entity0331_version = p;
    }

    public String getEntity0331_string01() {
        return entity0331_string01;
    }

    public void setEntity0331_string01(String p) {
        this.entity0331_string01 = p;
    }

    public String getEntity0331_string02() {
        return entity0331_string02;
    }

    public void setEntity0331_string02(String p) {
        this.entity0331_string02 = p;
    }

    public String getEntity0331_string03() {
        return entity0331_string03;
    }

    public void setEntity0331_string03(String p) {
        this.entity0331_string03 = p;
    }
}
