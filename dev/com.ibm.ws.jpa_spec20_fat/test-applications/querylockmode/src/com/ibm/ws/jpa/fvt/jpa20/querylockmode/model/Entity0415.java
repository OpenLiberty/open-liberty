...
@NamedQueries(
              value = {
                        @NamedQuery(name = "ENTITY0415_SELECT",
                                    query = "SELECT e FROM Entity0415 e WHERE e.entity0415_id = :id_0415")
              })
@Entity
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Table(name = "CDM_Entity0415")
public class Entity0415 {

    @Id
    @OneToOne
    private Entity0015 entity0415_id;

    @Version
    private Long entity0415_version;

    private String entity0415_string01;

    private String entity0415_string02;

    private String entity0415_string03;

    public Entity0415() {}

    public Entity0415(Entity0015 id,
                      Long version,
                      String string01,
                      String string02,
                      String string03) {
        this.entity0415_id = id;
        this.entity0415_version = version;
        this.entity0415_string01 = string01;
        this.entity0415_string02 = string02;
        this.entity0415_string03 = string03;
    }

    @Override
    public String toString() {
        return (" Entity0415: " +
                " entity0415_id: " + getEntity0415_id() +
                " entity0415_version: " + getEntity0415_version() +
                " entity0415_string01: " + getEntity0415_string01() +
                " entity0415_string02: " + getEntity0415_string02() +
                " entity0415_string03: " + getEntity0415_string03());
    }

    //----------------------------------------------------------------------------------------------
    // Persisent property accessor(s)
    //----------------------------------------------------------------------------------------------
    public Entity0015 getEntity0415_id() {
        return entity0415_id;
    }

    public void setEntity0415_id(Entity0015 p) {
        this.entity0415_id = p;
    }

    public Long getEntity0415_version() {
        return entity0415_version;
    }

    public void setEntity0415_version(Long p) {
        this.entity0415_version = p;
    }

    public String getEntity0415_string01() {
        return entity0415_string01;
    }

    public void setEntity0415_string01(String p) {
        this.entity0415_string01 = p;
    }

    public String getEntity0415_string02() {
        return entity0415_string02;
    }

    public void setEntity0415_string02(String p) {
        this.entity0415_string02 = p;
    }

    public String getEntity0415_string03() {
        return entity0415_string03;
    }

    public void setEntity0415_string03(String p) {
        this.entity0415_string03 = p;
    }
}
