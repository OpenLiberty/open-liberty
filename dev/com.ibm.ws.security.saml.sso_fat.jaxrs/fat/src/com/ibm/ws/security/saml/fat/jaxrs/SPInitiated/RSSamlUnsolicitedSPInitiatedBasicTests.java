...
public class RSSamlUnsolicitedSPInitiatedBasicTests extends RSSamlBasicTests {

    private static final Class<?> thisClass = RSSamlUnsolicitedSPInitiatedBasicTests.class;
    ...
    public static void setupBeforeTest() throws Exception {
        ...
        startSPWithIDPServer(SPServerName, "server_1_unsolicited.xml", extraMsgs, extraApps, true);
