...
@Stateful(name = "DMIPubYesInhAnoOvrdTestSFEXEJB")
@Local(DMIPubYesInhAnoOvrdTestSFEXEJBLocal.class)
@TransactionManagement(javax.ejb.TransactionManagementType.BEAN)
public class DMIPubYesInhAnoOvrdTestSFEXEJB extends DMIPubYesInhAnoOvrdTestEXSuperclass {
    ...
    @PersistenceContext(unitName = "OVRD_COMMON_JTA", type = PersistenceContextType.EXTENDED,
                        name = "jpa/DMIPubYesInhAnoOvrdTestEJB/ovdem_cmex_common_ejb")
    ...
    @PersistenceContext(unitName = "OVRD_EJB_JTA", type = PersistenceContextType.EXTENDED,
                        name = "jpa/DMIPubYesInhAnoOvrdTestEJB/ovdem_cmex_ejb_ejb")
    ...
    @PersistenceContext(unitName = "../lib/jpapulib.jar#OVRD_COMMON_JTA", type = PersistenceContextType.EXTENDED,
                        name = "jpa/DMIPubYesInhAnoOvrdTestEJB/ovdem_cmex_common_earlib")
    ...
    @PersistenceContext(unitName = "OVRD_JPALIB_JTA", type = PersistenceContextType.EXTENDED,
                        name = "jpa/DMIPubYesInhAnoOvrdTestEJB/ovdem_cmex_jpalib_earlib")
