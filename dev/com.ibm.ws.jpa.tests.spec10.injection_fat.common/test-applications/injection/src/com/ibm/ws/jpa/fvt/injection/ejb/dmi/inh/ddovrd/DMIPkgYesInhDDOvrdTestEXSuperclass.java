 ...
 *
 */
public abstract class DMIPkgYesInhDDOvrdTestEXSuperclass extends DMIInhCommonEJBEXSuperclass {
    ...
    @PersistenceContext(unitName = "COMMON_JTA", type = PersistenceContextType.EXTENDED,
                        name = "jpa/DMIPkgYesInhDDOvrdTestEJB/ovdem_cmex_common_ejb")
    ...
    @PersistenceContext(unitName = "EJB_JTA", type = PersistenceContextType.EXTENDED,
                        name = "jpa/DMIPkgYesInhDDOvrdTestEJB/ovdem_cmex_ejb_ejb")
    ...
    @PersistenceContext(unitName = "../lib/jpapulib.jar#COMMON_JTA", type = PersistenceContextType.EXTENDED,
                        name = "jpa/DMIPkgYesInhDDOvrdTestEJB/ovdem_cmex_common_earlib")
    ...
    @PersistenceContext(unitName = "JPALIB_JTA", type = PersistenceContextType.EXTENDED,
                        name = "jpa/DMIPkgYesInhDDOvrdTestEJB/ovdem_cmex_jpalib_earlib")
