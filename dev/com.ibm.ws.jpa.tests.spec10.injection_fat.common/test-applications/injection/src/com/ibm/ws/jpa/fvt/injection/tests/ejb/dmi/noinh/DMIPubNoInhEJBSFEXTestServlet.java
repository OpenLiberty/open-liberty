 ...
 *
 */
public class DMIPubNoInhEJBSFEXTestServlet extends EJBDBTestVehicleServlet {
     ...
     */
    @Test
    public void jpa10_Injection_DMI_NoInheritance_testCommonPUName_PUB_NOOVRD_EJB_SF_CMEX() throws Exception {
        final String testName = "jpa10_Injection_DMI_NoInheritance_testCommonPUName_PUB_NOOVRD_EJB_SF_CMEX";
    ...
    @Test
    public void jpa10_Injection_DMI_NoInheritance_testCommonPUNameSpecifiedPersistencePathLibJar_PUB_NOOVRD_EJB_SF_CMEX() throws Exception {
        final String testName = "jpa10_Injection_DMI_NoInheritance_testCommonPUNameSpecifiedPersistencePathLibJar_PUB_NOOVRD_EJB_SF_CMEX";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DMI_NoInheritance_testUniquePUNameAppModule_PUB_NOOVRD_EJB_SF_CMEX() throws Exception {
        final String testName = "jpa10_Injection_DMI_NoInheritance_testUniquePUNameAppModule_PUB_NOOVRD_EJB_SF_CMEX";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DMI_NoInheritance_testUniquePUNameLibJar_PUB_NOOVRD_EJB_SF_CMEX() throws Exception {
        final String testName = "jpa10_Injection_DMI_NoInheritance_testUniquePUNameLibJar_PUB_NOOVRD_EJB_SF_CMEX";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DMI_NoInheritance_testCommonPUName_PUB_OVRD_EJB_SF_CMEX() throws Exception {
        final String testName = "jpa10_Injection_DMI_NoInheritance_testCommonPUName_PUB_OVRD_EJB_SF_CMEX";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DMI_NoInheritance_testCommonPUNameSpecifiedPersistencePathLibJar_PUB_OVRD_EJB_SF_CMEX() throws Exception {
        final String testName = "jpa10_Injection_DMI_NoInheritance_testCommonPUNameSpecifiedPersistencePathLibJar_PUB_OVRD_EJB_SF_CMEX";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DMI_NoInheritance_testUniquePUNameAppModule_PUB_OVRD_EJB_SF_CMEX() throws Exception {
        final String testName = "jpa10_Injection_DMI_NoInheritance_testUniquePUNameAppModule_PUB_OVRD_EJB_SF_CMEX";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DMI_NoInheritance_testUniquePUNameLibJar_PUB_OVRD_EJB_SF_CMEX() throws Exception {
        final String testName = "jpa10_Injection_DMI_NoInheritance_testUniquePUNameLibJar_PUB_OVRD_EJB_SF_CMEX";
        final String testMethod = "testInjectionTarget";
