...
public class DeploymentDescriptorJNDIEJBSFEXServlet extends EJBDBTestVehicleServlet {
    ...
    private final static String ejbJNDIName = "ejb/jndi/DDJNDISFEXEJB";
    ...
    @Test
    public void jpa10_Injection_EJB_SF_JNDI_testCommonPUName_DD_CMEX() throws Exception {
        final String testName = "jpa10_Injection_EJB_SF_JNDI_testCommonPUName_DD_CMEX";
        ...
        final String resource = "java:comp/env/jpa/ejb/jndi/dd/ejb/common_cmex";
    ...
    @Test
    public void jpa10_Injection_EJB_SF_JNDI_testCommonPUNameSpecifiedPersistencePathLibJar_DD_CMEX() throws Exception {
        final String testName = "jpa10_Injection_EJB_SF_JNDI_testCommonPUNameSpecifiedPersistencePathLibJar_DD_CMEX";
        final String testMethod = "testInjectionTarget";
        ...
        final PersistenceContextType pcType = PersistenceContextType.CONTAINER_MANAGED_ES;
        final PersistenceInjectionType piType = PersistenceInjectionType.JNDI;
        final String resource = "java:comp/env/jpa/ejb/jndi/dd/earlib/common_cmex";
        final JPAPersistenceContext jpaPCtx = new JPAPersistenceContext("test-jpa-resource", pcType, piType, resource);
    ...
    @Test
    public void jpa10_Injection_EJB_SF_JNDI_testUniquePUNameAppModule_DD_CMEX() throws Exception {
        final String testName = "jpa10_Injection_EJB_SF_JNDI_testUniquePUNameAppModule_DD_CMEX";
        final String testMethod = "testInjectionTarget";
        ...
        final PersistenceContextType pcType = PersistenceContextType.CONTAINER_MANAGED_ES;
        final PersistenceInjectionType piType = PersistenceInjectionType.JNDI;
        final String resource = "java:comp/env/jpa/ejb/jndi/dd/ejb/ejb_cmex";
        final JPAPersistenceContext jpaPCtx = new JPAPersistenceContext("test-jpa-resource", pcType, piType, resource);
    ...
    @Test
    public void jpa10_Injection_EJB_SF_JNDI_testUniquePUNameLibJar_DD_CMEX() throws Exception {
        final String testName = "jpa10_Injection_EJB_SF_JNDI_testUniquePUNameLibJar_DD_CMEX";
        final String testMethod = "testInjectionTarget";
        ...
        final PersistenceContextType pcType = PersistenceContextType.CONTAINER_MANAGED_ES;
        final PersistenceInjectionType piType = PersistenceInjectionType.JNDI;
        final String resource = "java:comp/env/jpa/ejb/jndi/dd/earlib/jpalib_cmex";
        final JPAPersistenceContext jpaPCtx = new JPAPersistenceContext("test-jpa-resource", pcType, piType, resource);
...
//    @Test
    public void jpa10_Injection_EJB_SF_JNDI_TEMPLATE_DD_CMEX() throws Exception {
        final String testName = "jpa10_Injection_EJB_SF_JNDI_TEMPLATE_DD_CMEX";
        final String testMethod = "testInjectionTarget";
        ...
        final PersistenceContextType pcType = PersistenceContextType.CONTAINER_MANAGED_ES;
        final PersistenceInjectionType piType = PersistenceInjectionType.JNDI;
        final String resource = "java:comp/env/jpa/web/jndi/dd/webapp/common_CMEX";
        final JPAPersistenceContext jpaPCtx = new JPAPersistenceContext("test-jpa-resource", pcType, piType, resource);
