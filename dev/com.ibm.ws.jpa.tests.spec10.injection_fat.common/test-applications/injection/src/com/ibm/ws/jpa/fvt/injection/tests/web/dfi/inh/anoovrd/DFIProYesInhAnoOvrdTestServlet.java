...
public class DFIProYesInhAnoOvrdTestServlet extends DFIProYesInhAnoOvrdTestSuperclass {
     ...
     */
    @Test
    public void jpa10_Injection_DFI_YesInheritance_testCommonPUName_PRO_NOOVRD_Web_AMJTA() throws Exception {
        final String testName = "jpa10_Injection_DFI_YesInheritance_testCommonPUName_PRO_NOOVRD_Web_AMJTA";
    ...
    @Test
    public void jpa10_Injection_DFI_YesInheritance_testCommonPUName_PRO_NOOVRD_Web_AMRL() throws Exception {
        final String testName = "jpa10_Injection_DFI_YesInheritance_testCommonPUName_PRO_NOOVRD_Web_AMRL";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DFI_YesInheritance_testCommonPUName_PRO_NOOVRD_Web_CMTS() throws Exception {
        final String testName = "jpa10_Injection_DFI_YesInheritance_testCommonPUName_PRO_NOOVRD_Web_CMTS";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DFI_YesInheritance_testCommonPUNameSpecifiedPersistencePathLibJar_PRO_NOOVRD_Web_AMJTA() throws Exception {
        final String testName = "jpa10_Injection_DFI_YesInheritance_testCommonPUNameSpecifiedPersistencePathLibJar_PRO_NOOVRD_Web_AMJTA";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DFI_YesInheritance_testCommonPUNameSpecifiedPersistencePathLibJar_PRO_NOOVRD_Web_AMRL() throws Exception {
        final String testName = "jpa10_Injection_DFI_YesInheritance_testCommonPUNameSpecifiedPersistencePathLibJar_PRO_NOOVRD_Web_AMRL";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DFI_YesInheritance_testCommonPUNameSpecifiedPersistencePathLibJar_PRO_NOOVRD_Web_CMTS() throws Exception {
        final String testName = "jpa10_Injection_DFI_YesInheritance_testCommonPUNameSpecifiedPersistencePathLibJar_PRO_NOOVRD_Web_CMTS";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DFI_YesInheritance_testUniquePUNameAppModule_PRO_NOOVRD_Web_AMJTA() throws Exception {
        final String testName = "jpa10_Injection_DFI_YesInheritance_testUniquePUNameAppModule_PRO_NOOVRD_Web_AMJTA";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DFI_YesInheritance_testUniquePUNameAppModule_PRO_NOOVRD_Web_AMRL() throws Exception {
        final String testName = "jpa10_Injection_DFI_YesInheritance_testUniquePUNameAppModule_PRO_NOOVRD_Web_AMRL";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DFI_YesInheritance_testUniquePUNameAppModule_PRO_NOOVRD_Web_CMTS() throws Exception {
        final String testName = "jpa10_Injection_DFI_YesInheritance_testUniquePUNameAppModule_PRO_NOOVRD_Web_CMTS";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DFI_YesInheritance_testUniquePUNameLibJar_PRO_NOOVRD_Web_AMJTA() throws Exception {
        final String testName = "jpa10_Injection_DFI_YesInheritance_testUniquePUNameLibJar_PRO_NOOVRD_Web_AMJTA";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DFI_YesInheritance_testUniquePUNameLibJar_PRO_NOOVRD_Web_AMRL() throws Exception {
        final String testName = "jpa10_Injection_DFI_YesInheritance_testUniquePUNameLibJar_PRO_NOOVRD_Web_AMRL";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DFI_YesInheritance_testUniquePUNameLibJar_PRO_NOOVRD_Web_CMTS() throws Exception {
        final String testName = "jpa10_Injection_DFI_YesInheritance_testUniquePUNameLibJar_PRO_NOOVRD_Web_CMTS";
        final String testMethod = "testInjectionTarget";
