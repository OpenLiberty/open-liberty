 ...
 *
 */
public class DMIProNoInhEJBSFEXTestServlet extends EJBDBTestVehicleServlet {
    ...
    private final static String ejbJNDIName = "ejb/dmi/noinh/DMIProNoInhSFEXEJB";
     ...
     */
    @Test
    public void jpa10_Injection_DMI_NoInheritance_testCommonPUName_PRO_NOOVRD_EJB_SF_CMEX() throws Exception {
        final String testName = "jpa10_Injection_DMI_NoInheritance_testCommonPUName_PRO_NOOVRD_EJB_SF_CMEX";
     ...
     */
    @Test
    public void jpa10_Injection_DMI_NoInheritance_testCommonPUNameSpecifiedPersistencePathLibJar_PRO_NOOVRD_EJB_SF_CMEX() throws Exception {
        final String testName = "jpa10_Injection_DMI_NoInheritance_testCommonPUNameSpecifiedPersistencePathLibJar_PRO_NOOVRD_EJB_SF_CMEX";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DMI_NoInheritance_testUniquePUNameAppModule_PRO_NOOVRD_EJB_SF_CMEX() throws Exception {
        final String testName = "jpa10_Injection_DMI_NoInheritance_testUniquePUNameAppModule_PRO_NOOVRD_EJB_SF_CMEX";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DMI_NoInheritance_testUniquePUNameLibJar_PRO_NOOVRD_EJB_SF_CMEX() throws Exception {
        final String testName = "jpa10_Injection_DMI_NoInheritance_testUniquePUNameLibJar_PRO_NOOVRD_EJB_SF_CMEX";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DMI_NoInheritance_testCommonPUName_PRO_OVRD_EJB_SF_CMEX() throws Exception {
        final String testName = "jpa10_Injection_DMI_NoInheritance_testCommonPUName_PRO_OVRD_EJB_SF_CMEX";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DMI_NoInheritance_testCommonPUNameSpecifiedPersistencePathLibJar_PRO_OVRD_EJB_SF_CMEX() throws Exception {
        final String testName = "jpa10_Injection_DMI_NoInheritance_testCommonPUNameSpecifiedPersistencePathLibJar_PRO_OVRD_EJB_SF_CMEX";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DMI_NoInheritance_testUniquePUNameAppModule_PRO_OVRD_EJB_SF_CMEX() throws Exception {
        final String testName = "jpa10_Injection_DMI_NoInheritance_testUniquePUNameAppModule_PRO_OVRD_EJB_SF_CMEX";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DMI_NoInheritance_testUniquePUNameLibJar_PRO_OVRD_EJB_SF_CMEX() throws Exception {
        final String testName = "jpa10_Injection_DMI_NoInheritance_testUniquePUNameLibJar_PRO_OVRD_EJB_SF_CMEX";
        final String testMethod = "testInjectionTarget";
