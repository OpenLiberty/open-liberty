 ...
 *
 */
public class DFIProYesInhAnoOvrdEJBSFEXTestServlet extends EJBDBTestVehicleServlet {
    ...
    private final static String ejbJNDIName = "ejb/dfi/inh/ano/DFIProYesInhAnoOvrdTestSFEXEJB";
...
//                       new JPAPersistenceContext("cleanup", PersistenceContextType.APPLICATION_MANAGED_RL, PersistenceInjectionType.JNDI, "java:comp/env/jpa/cleanup"));
    ...
    @Test
    public void jpa10_Injection_DFI_YesInheritance_testCommonPUName_PRO_NOOVRD_EJB_SF_CMEX() throws Exception {
        final String testName = "jpa10_Injection_DFI_YesInheritance_testCommonPUName_PRO_NOOVRD_EJB_SF_CMEX";
    ...
    @Test
    public void jpa10_Injection_DFI_YesInheritance_testCommonPUNameSpecifiedPersistencePathLibJar_PRO_NOOVRD_EJB_SF_CMEX() throws Exception {
        final String testName = "jpa10_Injection_DFI_YesInheritance_testCommonPUNameSpecifiedPersistencePathLibJar_PRO_NOOVRD_EJB_SF_CMEX";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DFI_YesInheritance_testUniquePUNameAppModule_PRO_NOOVRD_EJB_SF_CMEX() throws Exception {
        final String testName = "jpa10_Injection_DFI_YesInheritance_testUniquePUNameAppModule_PRO_NOOVRD_EJB_SF_CMEX";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DFI_YesInheritance_testUniquePUNameLibJar_PRO_NOOVRD_EJB_SF_CMEX() throws Exception {
        final String testName = "jpa10_Injection_DFI_YesInheritance_testUniquePUNameLibJar_PRO_NOOVRD_EJB_SF_CMEX";
        final String testMethod = "testInjectionTarget";
