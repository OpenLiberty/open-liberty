 ...
 *
 */
public abstract class DMIPkgYesInhDDOvrdTestSuperclass extends DMIInhCommonServletSuperclass {
    private static final long serialVersionUID = -1498316229948664681L;
    ...
    @PersistenceContext(unitName = "COMMON_JTA", type = PersistenceContextType.TRANSACTION,
                        name = "jpa/DMIPkgYesInhDDOvrdTestServlet/ovdem_cmts_common_webapp")
    ...
    @PersistenceContext(unitName = "WEBAPP_JTA", type = PersistenceContextType.TRANSACTION,
                        name = "jpa/DMIPkgYesInhDDOvrdTestServlet/ovdem_cmts_webapp_webapp")
    ...
    @PersistenceContext(unitName = "../lib/jpapulib.jar#COMMON_JTA", type = PersistenceContextType.TRANSACTION,
                        name = "jpa/DMIPkgYesInhDDOvrdTestServlet/ovdem_cmts_common_earlib")
    ...
    @PersistenceContext(unitName = "JPALIB_JTA", type = PersistenceContextType.TRANSACTION,
                        name = "jpa/DMIPkgYesInhDDOvrdTestServlet/ovdem_cmts_jpalib_earlib")
    ...
    @PersistenceUnit(unitName = "COMMON_JTA", name = "jpa/DMIPkgYesInhDDOvrdTestServlet/ovdemf_amjta_common_webapp")
    ...
    @PersistenceUnit(unitName = "WEBAPP_JTA", name = "jpa/DMIPkgYesInhDDOvrdTestServlet/ovdemf_amjta_webapp_webapp")
    ...
    @PersistenceUnit(unitName = "../lib/jpapulib.jar#COMMON_JTA", name = "jpa/DMIPkgYesInhDDOvrdTestServlet/ovdemf_amjta_common_earlib")
    ...
    @PersistenceUnit(unitName = "JPALIB_JTA", name = "jpa/DMIPkgYesInhDDOvrdTestServlet/ovdemf_amjta_jpalib_earlib")
    ...
    @PersistenceUnit(unitName = "COMMON_RL", name = "jpa/DMIPkgYesInhDDOvrdTestServlet/ovdemf_amrl_common_webapp")
    ...
    @PersistenceUnit(unitName = "WEBAPP_RL", name = "jpa/DMIPkgYesInhDDOvrdTestServlet/ovdemf_amrl_webapp_webapp")
    ...
    @PersistenceUnit(unitName = "../lib/jpapulib.jar#COMMON_RL", name = "jpa/DMIPkgYesInhDDOvrdTestServlet/ovdemf_amrl_common_earlib")
    ...
    @PersistenceUnit(unitName = "JPALIB_RL", name = "jpa/DMIPkgYesInhDDOvrdTestServlet/ovdemf_amrl_jpalib_earlib")
