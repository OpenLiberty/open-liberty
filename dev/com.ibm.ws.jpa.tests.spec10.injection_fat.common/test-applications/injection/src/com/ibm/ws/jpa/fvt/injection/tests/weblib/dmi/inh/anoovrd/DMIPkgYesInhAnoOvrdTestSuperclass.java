 ...
 *
 */
public abstract class DMIPkgYesInhAnoOvrdTestSuperclass extends DMIInhCommonServletSuperclass {
    private static final long serialVersionUID = -1489916924031750454L;
    ...
    @PersistenceUnit(unitName = "COMMON_JTA", name = "jpa/DMIPkgYesInhAnoOvrdTestServlet/ovdemf_amjta_common_webapp")
    ...
    @PersistenceUnit(unitName = "WEBAPP_JTA", name = "jpa/DMIPkgYesInhAnoOvrdTestServlet/ovdemf_amjta_webapp_webapp")
    ...
    @PersistenceUnit(unitName = "../lib/jpapulib.jar#COMMON_JTA", name = "jpa/DMIPkgYesInhAnoOvrdTestServlet/ovdemf_amjta_common_earlib")
    ...
    @PersistenceUnit(unitName = "JPALIB_JTA", name = "jpa/DMIPkgYesInhAnoOvrdTestServlet/ovdemf_amjta_jpalib_earlib")
    ...
    @PersistenceUnit(unitName = "COMMON_RL", name = "jpa/DMIPkgYesInhAnoOvrdTestServlet/ovdemf_amrl_common_webapp")
    ...
    @PersistenceUnit(unitName = "WEBAPP_RL", name = "jpa/DMIPkgYesInhAnoOvrdTestServlet/ovdemf_amrl_webapp_webapp")
    ...
    @PersistenceUnit(unitName = "../lib/jpapulib.jar#COMMON_RL", name = "jpa/DMIPkgYesInhAnoOvrdTestServlet/ovdemf_amrl_common_earlib")
    ...
    @PersistenceUnit(unitName = "JPALIB_RL", name = "jpa/DMIPkgYesInhAnoOvrdTestServlet/ovdemf_amrl_jpalib_earlib")
