 ...
 * <li>BEFORE_APP_START : initialized and constructed on first use; no pool preload</li>
 * <li>AFTER_APP_START : initialized and constructed on first use; no pool preload</li>
 * </ul>
 *
 ...
 */
@Stateless
public class SLCheckpointBeanQ implements CheckpointLocal {
    private static final String BEAN_NAME = SLCheckpointBeanQ.class.getSimpleName();
    private static final Logger logger = Logger.getLogger(SLCheckpointBeanQ.class.getName());
