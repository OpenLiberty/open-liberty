 ...
 */
@Singleton
public class SGCheckpointBeanP implements CheckpointLocal {
    private static final String BEAN_NAME = SGCheckpointBeanP.class.getSimpleName();
    private static final Logger logger = Logger.getLogger(SGCheckpointBeanP.class.getName());
