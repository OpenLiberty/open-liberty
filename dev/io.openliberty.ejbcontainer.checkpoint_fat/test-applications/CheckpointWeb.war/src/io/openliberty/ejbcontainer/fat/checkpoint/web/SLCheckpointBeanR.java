 ...
 */
@Stateless
public class SLCheckpointBeanR implements CheckpointLocal {
    private static final String BEAN_NAME = SLCheckpointBeanR.class.getSimpleName();
    private static final Logger logger = Logger.getLogger(SLCheckpointBeanR.class.getName());
