 ...
 */
@Singleton
public class SGCheckpointBeanO implements CheckpointLocal {
    private static final String BEAN_NAME = SGCheckpointBeanO.class.getSimpleName();
    private static final Logger logger = Logger.getLogger(SGCheckpointBeanO.class.getName());
