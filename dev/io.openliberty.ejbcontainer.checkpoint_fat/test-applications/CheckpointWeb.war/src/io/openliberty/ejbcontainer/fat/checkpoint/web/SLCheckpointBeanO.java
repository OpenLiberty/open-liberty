 ...
 */
@Stateless
public class SLCheckpointBeanO implements CheckpointLocal {
    private static final String BEAN_NAME = SLCheckpointBeanO.class.getSimpleName();
    private static final Logger logger = Logger.getLogger(SLCheckpointBeanO.class.getName());
