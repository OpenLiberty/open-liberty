 ...
 */
@Stateless
public class SLCheckpointBeanN implements CheckpointLocal {
    private static final String BEAN_NAME = SLCheckpointBeanN.class.getSimpleName();
    private static final Logger logger = Logger.getLogger(SLCheckpointBeanN.class.getName());
