 ...
 */
@Stateless
public class SLCheckpointBeanI implements CheckpointLocal {
    private static final String BEAN_NAME = SLCheckpointBeanI.class.getSimpleName();
    private static final Logger logger = Logger.getLogger(SLCheckpointBeanI.class.getName());
