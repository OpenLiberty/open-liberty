 ...
 */
@Singleton
public class SGCheckpointBeanI implements CheckpointLocal {
    private static final String BEAN_NAME = SGCheckpointBeanI.class.getSimpleName();
    private static final Logger logger = Logger.getLogger(SGCheckpointBeanI.class.getName());
