 ...
 */
@Stateless
public class SLCheckpointBeanK implements CheckpointLocal {
    private static final String BEAN_NAME = SLCheckpointBeanK.class.getSimpleName();
    private static final Logger logger = Logger.getLogger(SLCheckpointBeanK.class.getName());
