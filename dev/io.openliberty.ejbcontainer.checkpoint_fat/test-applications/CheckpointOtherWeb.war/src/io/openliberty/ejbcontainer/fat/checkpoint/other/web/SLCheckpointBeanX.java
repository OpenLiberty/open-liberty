 ...
 */
@Stateless
public class SLCheckpointBeanX implements CheckpointLocal {
    private static final String BEAN_NAME = SLCheckpointBeanX.class.getSimpleName();
    private static final Logger logger = Logger.getLogger(SLCheckpointBeanX.class.getName());
