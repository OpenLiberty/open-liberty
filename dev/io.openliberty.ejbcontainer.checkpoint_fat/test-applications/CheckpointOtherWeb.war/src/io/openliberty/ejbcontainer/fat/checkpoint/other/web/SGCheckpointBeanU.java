 ...
 */
@Singleton
public class SGCheckpointBeanU implements CheckpointLocal {
    private static final String BEAN_NAME = SGCheckpointBeanU.class.getSimpleName();
    private static final Logger logger = Logger.getLogger(SGCheckpointBeanU.class.getName());
