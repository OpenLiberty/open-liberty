 ...
 */
@Stateless
public class SLCheckpointBeanV implements CheckpointLocal {
    private static final String BEAN_NAME = SLCheckpointBeanV.class.getSimpleName();
    private static final Logger logger = Logger.getLogger(SLCheckpointBeanV.class.getName());
