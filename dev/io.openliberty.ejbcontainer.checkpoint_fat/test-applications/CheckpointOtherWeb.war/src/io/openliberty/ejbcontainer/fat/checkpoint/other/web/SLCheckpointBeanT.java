 ...
 */
@Stateless
public class SLCheckpointBeanT implements CheckpointLocal {
    private static final String BEAN_NAME = SLCheckpointBeanT.class.getSimpleName();
    private static final Logger logger = Logger.getLogger(SLCheckpointBeanT.class.getName());
