 ...
 */
@Singleton
public class SGCheckpointBeanD implements CheckpointLocal {
    private static final String BEAN_NAME = SGCheckpointBeanD.class.getSimpleName();
    private static final Logger logger = Logger.getLogger(SGCheckpointBeanD.class.getName());
