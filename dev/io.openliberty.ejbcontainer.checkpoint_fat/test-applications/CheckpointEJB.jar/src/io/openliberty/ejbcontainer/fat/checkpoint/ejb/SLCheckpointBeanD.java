 ...
 */
@Stateless
public class SLCheckpointBeanD implements CheckpointLocal {
    private static final String BEAN_NAME = SLCheckpointBeanD.class.getSimpleName();
    private static final Logger logger = Logger.getLogger(SLCheckpointBeanD.class.getName());
