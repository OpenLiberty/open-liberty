 ...
 */
@Stateless
public class SLCheckpointBeanF implements CheckpointLocal {
    private static final String BEAN_NAME = SLCheckpointBeanF.class.getSimpleName();
    private static final Logger logger = Logger.getLogger(SLCheckpointBeanF.class.getName());
