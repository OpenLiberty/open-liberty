...
public class EjbStartCheckpointTest extends FATServletClient {
    ...
    /*@formatter:off*/
    @ClassRule
    public static RepeatTests r = RepeatTests.with(FeatureReplacementAction.EE7_FEATURES().fullFATOnly().forServers("EjbStartCheckpointMockServer"))
                                    .andWith(FeatureReplacementAction.EE8_FEATURES().forServers("EjbStartCheckpointMockServer"))
                                    .andWith(FeatureReplacementAction.EE9_FEATURES().fullFATOnly().forServers("EjbStartCheckpointMockServer"))
                                    .andWith(FeatureReplacementAction.EE10_FEATURES().forServers("EjbStartCheckpointMockServer").conditionalFullFATOnly(FeatureReplacementAction.GREATER_THAN_OR_EQUAL_JAVA_17))
                                    .andWith(FeatureReplacementAction.EE11_FEATURES().forServers("EjbStartCheckpointMockServer"));
    /*@formatter:on*/
