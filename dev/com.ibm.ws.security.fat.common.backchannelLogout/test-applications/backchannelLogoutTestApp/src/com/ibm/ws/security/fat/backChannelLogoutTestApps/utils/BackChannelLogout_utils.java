...
public class BackChannelLogout_utils {
    ...
    public String getProviderName(String opLogoutUri) throws Exception {

        // example OP logout uri: https://localhost:8920/oidc/endpoint/OidcConfigSample_defaultBCLTimeout/logout - return OidcConfigSample_defaultBCLTimeout

        String[] splits = opLogoutUri.split("/");

        String provider = splits[splits.length - 2];
