...
/**
 * Implementation entity for the inverse side of the B5RF bidirectional relationship defined on the entity BiEntityA.
 *
 */
@Entity
public class OOBiEntB_B5RF extends AbstractOneXOneBiEntityB {
    @OneToOne(mappedBy = "b5rf")
    private OOBiEntA entityA;

    public OOBiEntB_B5RF() {
        super();
    }

    public OOBiEntB_B5RF(int id, String name) {
        super(id, name);
    }
    ...
    public String toString() {
        return "OOBiEntB_B5RF [getId()=" + getId() + ", getName()=" + getName() + "]";
    }
}