...
@Entity
public class OONoOptBiEntityA implements INoOptEntityA {
    /**
    ...
    private OONoOptBiEntityB b;

    public OONoOptBiEntityA() {

    }

    public OONoOptBiEntityB getB() {
        return b;
    }

    public void setB(OONoOptBiEntityB b) {
        this.b = b;
    }
    ...
    public String toString() {
        return "OONoOptBiEntityA [id=" + id + ", name=" + name + "]";
    }
}
