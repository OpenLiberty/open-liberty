...
@Mode(TestMode.FULL)
public class DDSimpleEarTests_Web_App_ConfigExt extends CommonTests_Simple {
    public static final Class<?> TEST_CLASS = DDSimpleEarTests_Web_App_ConfigExt.class;

    @BeforeClass
    public static void setUp() throws Exception {
        commonSetUp(TEST_CLASS, "server_simple_ear_ext.xml", setUpSimpleEar_WebAppExt);
    }
