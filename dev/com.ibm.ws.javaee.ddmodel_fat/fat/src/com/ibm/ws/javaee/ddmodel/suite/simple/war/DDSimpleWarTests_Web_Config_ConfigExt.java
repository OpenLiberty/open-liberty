...
@Mode(TestMode.FULL)
public class DDSimpleWarTests_Web_Config_ConfigExt extends CommonTests_Simple {
    public static final Class<?> TEST_CLASS = DDSimpleWarTests_Web_Config_ConfigExt.class;

    @BeforeClass
    public static void setUp() throws Exception {
        commonSetUp(TEST_CLASS, "server_simple_war_cfg_ext.xml", setUpSimpleWarExt);
    }
    ...
    @Test
    public void testContextRoot_War_Web_Config_ConfigExt() throws Exception {
