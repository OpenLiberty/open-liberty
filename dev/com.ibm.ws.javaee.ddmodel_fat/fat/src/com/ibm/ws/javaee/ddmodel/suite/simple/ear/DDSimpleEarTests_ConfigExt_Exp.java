...
@Mode(TestMode.LITE)
public class DDSimpleEarTests_ConfigExt_Exp extends CommonTests_Simple {
    public static final Class<?> TEST_CLASS = DDSimpleEarTests_ConfigExt_Exp.class;

    @BeforeClass
    public static void setUp() throws Exception {
        commonSetUp(TEST_CLASS, "server_simple_ear_ext_exp.xml", setUpSimpleEar_NoExt);
    }
    ...
    @Test
    public void testContextRoot_Ear_ConfigExt_Exp() throws Exception {
