...
@Mode(TestMode.FULL)
public class DDSimpleWarTests_Web_ConfigExt extends CommonTests_Simple {
    public static final Class<?> TEST_CLASS = DDSimpleWarTests_Web_ConfigExt.class;

    @BeforeClass
    public static void setUp() throws Exception {
        commonSetUp(TEST_CLASS, "server_simple_war_ext.xml", setUpSimpleWarExt);
    }
    ...
    @Test
    public void testContextRoot_War_Web_ConfigExt() throws Exception {
