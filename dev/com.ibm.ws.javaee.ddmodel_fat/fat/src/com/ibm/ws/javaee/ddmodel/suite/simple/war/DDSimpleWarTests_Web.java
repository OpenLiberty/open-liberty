...
@Mode(TestMode.LITE)
public class DDSimpleWarTests_Web extends CommonTests_Simple {
    public static final Class<?> TEST_CLASS = DDSimpleWarTests_Web.class;

    @BeforeClass
    public static void setUp() throws Exception {
        commonSetUp(TEST_CLASS, "server_simple_war_noext.xml", setUpSimpleWarExt);
    }
    ...
    @Test
    public void testContextRoot_War_Web() throws Exception {
