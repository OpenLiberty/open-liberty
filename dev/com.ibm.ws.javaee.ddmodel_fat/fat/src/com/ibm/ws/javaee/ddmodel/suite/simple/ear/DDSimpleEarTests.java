...
@Mode(TestMode.LITE)
public class DDSimpleEarTests extends CommonTests_Simple {
    public static final Class<?> TEST_CLASS = DDSimpleEarTests.class;

    @BeforeClass
    public static void setUp() throws Exception {
        commonSetUp(TEST_CLASS, "server_simple_ear_noext.xml", setUpSimpleEar_NoExt);
    }
    ...
    public void testContextRoot_Ear_ConfigExt() throws Exception {
        testHello(TEST_CLASS, SIMPLE_CONTEXT_ROOT);
    }
}
