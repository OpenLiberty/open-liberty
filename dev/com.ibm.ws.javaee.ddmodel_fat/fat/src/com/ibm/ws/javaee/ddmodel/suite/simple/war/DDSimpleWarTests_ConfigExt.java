...
@Mode(TestMode.LITE)
public class DDSimpleWarTests_ConfigExt extends CommonTests_Simple {
    public static final Class<?> TEST_CLASS = DDSimpleWarTests_ConfigExt.class;

    @BeforeClass
    public static void setUp() throws Exception {
        commonSetUp(TEST_CLASS, "server_simple_war_ext.xml", setUpSimpleWarNoExt);
    }
    ...
    @Test
    public void testContextRoot_War_ConfigExt() throws Exception {
