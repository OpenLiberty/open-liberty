...
@Mode(TestMode.LITE)
public class DDSimpleWarTests_Web_Config_ConfigExt_Exp extends CommonTests_Simple {
    public static final Class<?> TEST_CLASS = DDSimpleWarTests_Web_Config_ConfigExt_Exp.class;

    @BeforeClass
    public static void setUp() throws Exception {
        commonSetUp(TEST_CLASS, "server_simple_war_cfg_ext_exp.xml", setUpSimpleWarExt);
    }
    ...
    @Test
    public void testContextRoot_War_Web_Config_ConfigExt_Exp() throws Exception {
