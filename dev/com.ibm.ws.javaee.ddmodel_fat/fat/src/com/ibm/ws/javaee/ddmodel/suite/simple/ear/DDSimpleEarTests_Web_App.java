...
@Mode(TestMode.FULL)
public class DDSimpleEarTests_Web_App extends CommonTests_Simple {
    public static final Class<?> TEST_CLASS = DDSimpleEarTests_Web_App.class;

    @BeforeClass
    public static void setUp() throws Exception {
        commonSetUp(TEST_CLASS, "server_simple_ear_noext.xml", setUpSimpleEar_WebAppExt);
    }
    ...
    @Test
    public void testContextRoot_Ear_Web_App() throws Exception {
