...
@WebServiceClient(name = "SayHelloSingletonService", targetNamespace = "http://ejb.ejbinwar.jaxws.ws.ibm.com/",
                  wsdlLocation = "META-INF/resources/wsdl/SayHelloSingletonService.wsdl")
public class SayHelloSingletonService
                extends Service
{

    private final static URL SAYHELLOSINGLETONSERVICE_WSDL_LOCATION;
    private final static Logger logger = Logger.getLogger(com.ibm.ws.jaxws.ejbinwar.ejb.SayHelloSingletonService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = com.ibm.ws.jaxws.ejbinwar.ejb.SayHelloSingletonService.class.getResource(".");
    ...
    public SayHelloSingletonService() {
        super(SAYHELLOSINGLETONSERVICE_WSDL_LOCATION, new QName("http://ejb.ejbinwar.jaxws.ws.ibm.com/", "SayHelloSingletonService"));
    }
    ...
    public SayHello getSayHelloSingletonPort() {
        return super.getPort(new QName("http://ejb.ejbinwar.jaxws.ws.ibm.com/", "SayHelloSingletonPort"), SayHello.class);
    }
    ...
    public SayHello getSayHelloSingletonPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ejb.ejbinwar.jaxws.ws.ibm.com/", "SayHelloSingletonPort"), SayHello.class, features);
    }
