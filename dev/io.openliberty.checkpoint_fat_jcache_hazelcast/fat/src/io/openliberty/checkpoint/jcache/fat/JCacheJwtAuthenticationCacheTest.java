...
public class JCacheJwtAuthenticationCacheTest extends BaseTestCase {
    ...
    private static final String SERVER1 = "io.openliberty.jcache.internal.fat.jwt.auth.cache.1";
    private static final String SERVER2 = "io.openliberty.jcache.internal.fat.jwt.auth.cache.2";
    ...
    @ClassRule
    public static RepeatTests repeatTest = FATSuite.defaultMPRepeat(new String[] { SERVER1, SERVER2 });
