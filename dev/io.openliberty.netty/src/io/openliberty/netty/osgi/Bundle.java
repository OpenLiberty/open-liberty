 ...
 *******************************************************************************/
package io.openliberty.netty.osgi;
...
import io.openliberty.netty.internal.NettyConstants;
import io.openliberty.netty.internal.NettyImpl;
 ...
 */
@Component(service = { Bundle.class, ServerQuiesceListener.class },
           name = "io.openliberty.netty",
           configurationPid = "io.openliberty.netty",
           configurationPolicy = ConfigurationPolicy.OPTIONAL,
           immediate = true,
           property = { "service.vendor=IBM" })
public class Bundle implements ServerQuiesceListener {

    /** Trace service */
    private static final TraceComponent tc = Tr.register(Bundle.class,
                                                         NettyConstants.BASE_TRACE_NAME,
     ...
     * calls.
     */
    private static final AtomicReference<Bundle> instance = new AtomicReference<Bundle>();
    ...
    protected synchronized void modified(Map<String, Object> cfwConfiguration) {
        ...
        this.netty.updateConfig(cfwConfiguration);
    }
    ...
    public WsByteBufferPoolManager getBufferManager() {
        ...
        return result != null ? result : Netty.getBufferManager();
    }
