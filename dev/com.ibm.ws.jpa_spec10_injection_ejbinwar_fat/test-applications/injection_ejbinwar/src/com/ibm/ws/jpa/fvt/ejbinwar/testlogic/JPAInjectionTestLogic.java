...
//        cleanupDatabase(jpaResource.getEm(), jpaResource.getTj(), JPAInjectionEntityEnum.values(), log);
...
//        }
        ...
        if ("EJB_NOOVERRIDE".equalsIgnoreCase(expectedInjectionPattern)) {
            ...
            Assert.fail("Invalid.ejbinwar.pattern specified ('" + targetPattern + "').  Cannot execute the test.");
            return;
        }
