...
/**
 * Test the session cookie-config setAttribute API setting via application which override the web.xml cookie-config
 * Also test the specific getter and getAttribute for the same specific attributes (i.e Domain, Path) to make sure
 * both return the same value.
 */
@Mode(TestMode.FULL)
@RunWith(FATRunner.class)
public class Servlet60SessionCookieConfigSCITest {

    private static final Logger LOG = Logger.getLogger(Servlet60SessionCookieConfigSCITest.class.getName());
    ...
    @Server("servlet60_sessionCookieConfigSCITest")
    ...
    public static void setUp() throws Exception {
        ...
        server.startServer(Servlet60SessionCookieConfigSCITest.class.getSimpleName() + ".log");
    }
     ...
     */
    @Test
    public void test_sessionCookieConfigureDynamicAddedBySCI() throws Exception {
     ...
     */
    @Test
    public void test_sessionCookieConfigureIllegalStateException() throws Exception {
        String url = "http://" + server.getHostname() + ":" + server.getHttpDefaultPort() + "/" + TEST_APP_NAME + "/TestSessionCookieConfigServlet?testName=TestIllegalOperation";
        String expectedGeneralResponse = "Hello World from TestSessionCookieConfigServlet";
        LOG.info("\n Sending Request [" + url + "]");
        HttpGet getMethod = new HttpGet(url);
