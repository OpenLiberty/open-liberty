...
@Mode(TestMode.FULL)
public class JPA10Example_EJB extends JPAFATServletClient {
    ...
    static {
        dropSet.add("JPA10_EXAMPLE_DROP_${dbvendor}.ddl");
        createSet.add("JPA10_EXAMPLE_CREATE_${dbvendor}.ddl");
        populateSet.add("JPA10_EXAMPLE_POPULATE_${dbvendor}.ddl");
    }
    ...
    public static void setUp() throws Exception {
        ...
        bannerStart(JPA10Example_EJB.class);
...
//        cel.add(loader);
    ...
    public static void tearDown() throws Exception {
        try {
            ...
            bannerEnd(JPA10Example_EJB.class, timestart);
        }
    }
}
