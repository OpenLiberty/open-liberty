...
@WebServlet(urlPatterns = "/TestOLGH11795_EJB_SL_Servlet")
public class TestOLGH11795_EJB_SL_Servlet extends EJBTestVehicleServlet {

    @PostConstruct
    private void initFAT() {
        testClassName = JPATestOLGH11795Logic.class.getName();
        ejbJNDIName = "ejb/OLGH11795SLEJB";
    ...
    @Test
    public void jpa_spec10_olgh11795_testJoinColumnWithSameDuplicateName_EJB_SL_AMJTA_Web() throws Exception {
        final String testName = "jpa_spec10_olgh11795_testJoinColumnWithSameDuplicateName_EJB_SL_AMJTA_Web";
    ...
    @Test
    public void jpa_spec10_olgh11795_testJoinColumnWithSameDuplicateName_EJB_SL_AMRL_Web() throws Exception {
        final String testName = "jpa_spec10_olgh11795_testJoinColumnWithSameDuplicateName_EJB_SL_AMRL_Web";
        final String testMethod = "testJoinColumnWithSameDuplicateName";
    ...
    @Test
    public void jpa_spec10_olgh11795_testJoinColumnWithSameDuplicateName_EJB_SL_CMTS_Web() throws Exception {
        final String testName = "jpa_spec10_olgh11795_testJoinColumnWithSameDuplicateName_EJB_SL_CMTS_Web";
        final String testMethod = "testJoinColumnWithSameDuplicateName";
