...
CREATE TABLE ${schemaname}.AnoJTCDRoot (id INTEGER NOT NULL, name VARCHAR(255), DISC_COL CHAR(254), PRIMARY KEY (id));
...
CREATE TABLE ${schemaname}.AnoSTCDRoot (id INTEGER NOT NULL, name VARCHAR(255), DISC_COL CHAR(254), intVal INTEGER, stringVal1 VARCHAR(255), stringVal2 VARCHAR(255), floatVal REAL, PRIMARY KEY (id));
...
CREATE TABLE ${schemaname}.XMLJTCDRoot (id INTEGER NOT NULL, name VARCHAR(255), DISC_COL CHAR(254), PRIMARY KEY (id));
...
CREATE TABLE ${schemaname}.XMLSTCDRoot (id INTEGER NOT NULL, name VARCHAR(255), DISC_COL CHAR(254), stringVal1 VARCHAR(255), stringVal2 VARCHAR(255), intVal INTEGER, floatVal REAL, PRIMARY KEY (id));
