...
CREATE TABLE ${schemaname}.AnoConcreteLeaf2 (id INTEGER NOT NULL, name VARCHAR(255), floatVal FLOAT4, PRIMARY KEY (id));
...
CREATE TABLE ${schemaname}.AnoJTCDLeaf2 (id INTEGER NOT NULL, floatVal FLOAT4, PRIMARY KEY (id));
CREATE TABLE ${schemaname}.AnoJTCDLeaf3 (id INTEGER NOT NULL, stringVal1 VARCHAR(255), stringVal2 VARCHAR(255), PRIMARY KEY (id));
CREATE TABLE ${schemaname}.AnoJTCDRoot (id INTEGER NOT NULL, name VARCHAR(255), DISC_COL INTEGER, PRIMARY KEY (id));
CREATE TABLE ${schemaname}.AnoJTIDLeaf1 (id INTEGER NOT NULL, intVal INTEGER, PRIMARY KEY (id));
CREATE TABLE ${schemaname}.AnoJTIDLeaf2 (id INTEGER NOT NULL, floatVal FLOAT4, PRIMARY KEY (id));
...
CREATE TABLE ${schemaname}.AnoJTSDLeaf2 (id INTEGER NOT NULL, floatVal FLOAT4, PRIMARY KEY (id));
...
CREATE TABLE ${schemaname}.AnoSTCDRoot (id INTEGER NOT NULL, name VARCHAR(255), DISC_COL INTEGER, intVal INTEGER, stringVal1 VARCHAR(255), stringVal2 VARCHAR(255), floatVal FLOAT4, PRIMARY KEY (id));
CREATE TABLE ${schemaname}.AnoSTIDRoot (id INTEGER NOT NULL, name VARCHAR(255), DISC_COL INTEGER, intVal INTEGER, floatVal FLOAT4, stringVal1 VARCHAR(255), stringVal2 VARCHAR(255), PRIMARY KEY (id));
CREATE TABLE ${schemaname}.AnoSTSDRoot (id INTEGER NOT NULL, name VARCHAR(255), DISC_COL VARCHAR(31), intVal INTEGER, stringVal1 VARCHAR(255), stringVal2 VARCHAR(255), floatVal FLOAT4, PRIMARY KEY (id));
...
CREATE TABLE ${schemaname}.XMLConcreteLeaf2 (id INTEGER NOT NULL, name VARCHAR(255), floatVal FLOAT4, PRIMARY KEY (id));
...
CREATE TABLE ${schemaname}.XMLJTCDLeaf2 (id INTEGER NOT NULL, floatVal FLOAT4, PRIMARY KEY (id));
CREATE TABLE ${schemaname}.XMLJTCDLeaf3 (id INTEGER NOT NULL, stringVal1 VARCHAR(255), stringVal2 VARCHAR(255), PRIMARY KEY (id));
CREATE TABLE ${schemaname}.XMLJTCDRoot (id INTEGER NOT NULL, name VARCHAR(255), DISC_COL INTEGER, PRIMARY KEY (id));
CREATE TABLE ${schemaname}.XMLJTIDLeaf1 (id INTEGER NOT NULL, intVal INTEGER, PRIMARY KEY (id));
CREATE TABLE ${schemaname}.XMLJTIDLeaf2 (id INTEGER NOT NULL, floatVal FLOAT4, PRIMARY KEY (id));
...
CREATE TABLE ${schemaname}.XMLJTSDLeaf2 (id INTEGER NOT NULL, floatVal FLOAT4, PRIMARY KEY (id));
...
CREATE TABLE ${schemaname}.XMLSTCDRoot (id INTEGER NOT NULL, name VARCHAR(255), DISC_COL INTEGER, floatVal FLOAT4, stringVal1 VARCHAR(255), stringVal2 VARCHAR(255), intVal INTEGER, PRIMARY KEY (id));
CREATE TABLE ${schemaname}.XMLSTIDRoot (id INTEGER NOT NULL, name VARCHAR(255), DISC_COL INTEGER, intVal INTEGER, floatVal FLOAT4, stringVal1 VARCHAR(255), stringVal2 VARCHAR(255), PRIMARY KEY (id));
CREATE TABLE ${schemaname}.XMLSTSDRoot (id INTEGER NOT NULL, name VARCHAR(255), DISC_COL VARCHAR(255), floatVal FLOAT4, intVal INTEGER, stringVal1 VARCHAR(255), stringVal2 VARCHAR(255), PRIMARY KEY (id));
