...
public class AdvEnvAnnObjServletRequestListener implements ServletRequestListener {
    private static final String CLASS_NAME = AdvEnvAnnObjServletRequestListener.class.getName();
    ...
    public AdvEnvAnnObjServletRequestListener() {
    ...
    public void requestInitialized(ServletRequestEvent sre) {
        ...
        if (testName != null && testName.toString().equals("testEnvAnnObjRequestListener")) {
            svLogger.info("Obj Servlet Request: Request Initialized...");
            populateMap();
            EnvAnnObjTestHelper.processRequest(CLASS_NAME, WCEventTracker.KEY_LISTENER_INIT_AdvEnvAnnObjServletRequestListener, map);
        }
    }
