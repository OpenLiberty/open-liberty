...
public class AdvEnvAnnObjServletContextListener implements ServletContextListener {
    private static final String CLASS_NAME = AdvEnvAnnObjServletContextListener.class.getName();
    ...
    public AdvEnvAnnObjServletContextListener() {
    ...
    public void contextInitialized(ServletContextEvent arg0) {
        ...
        populateMap();
        EnvAnnObjTestHelper.processRequest(CLASS_NAME, WCEventTracker.KEY_LISTENER_INIT_AdvEnvAnnObjServletContextListener, map);
    }
