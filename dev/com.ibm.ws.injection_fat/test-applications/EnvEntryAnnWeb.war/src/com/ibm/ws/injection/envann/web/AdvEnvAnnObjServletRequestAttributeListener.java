...
public class AdvEnvAnnObjServletRequestAttributeListener implements ServletRequestAttributeListener {
    private static final String CLASS_NAME = AdvEnvAnnObjServletRequestAttributeListener.class.getName();
    ...
    public AdvEnvAnnObjServletRequestAttributeListener() {
    ...
    public void attributeAdded(ServletRequestAttributeEvent arg0) {
        ...
        populateMap();
        EnvAnnObjTestHelper.processRequest(CLASS_NAME, WCEventTracker.KEY_LISTENER_ADD_AdvEnvAnnObjServletRequestAttributeListener, map);
    }
    ...
    public void attributeRemoved(ServletRequestAttributeEvent arg0) {
        ...
        populateMap();
        EnvAnnObjTestHelper.processRequest(CLASS_NAME, WCEventTracker.KEY_LISTENER_DEL_AdvEnvAnnObjServletRequestAttributeListener, map);
    }
    ...
    public void attributeReplaced(ServletRequestAttributeEvent arg0) {
        ...
        populateMap();
        EnvAnnObjTestHelper.processRequest(CLASS_NAME, WCEventTracker.KEY_LISTENER_REP_AdvEnvAnnObjServletRequestAttributeListener, map);
    }
