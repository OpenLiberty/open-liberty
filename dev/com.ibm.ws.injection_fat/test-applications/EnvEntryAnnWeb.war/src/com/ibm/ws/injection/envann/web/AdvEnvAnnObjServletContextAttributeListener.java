...
public class AdvEnvAnnObjServletContextAttributeListener implements ServletContextAttributeListener {
    ...
    public AdvEnvAnnObjServletContextAttributeListener() {
    ...
    public void attributeAdded(ServletContextAttributeEvent arg0) {
        ...
        populateMap();
        EnvAnnObjTestHelper.processRequest(CLASS_NAME, WCEventTracker.KEY_LISTENER_ADD_AdvEnvAnnObjContextAttributeListener, map);
    }
    ...
    public void attributeRemoved(ServletContextAttributeEvent arg0) {
        ...
        populateMap();
        EnvAnnObjTestHelper.processRequest(CLASS_NAME, WCEventTracker.KEY_LISTENER_DEL_AdvEnvAnnObjContextAttributeListener, map);
    }
    ...
    public void attributeReplaced(ServletContextAttributeEvent arg0) {
        ...
        populateMap();
        EnvAnnObjTestHelper.processRequest(CLASS_NAME, WCEventTracker.KEY_LISTENER_REP_AdvEnvAnnObjContextAttributeListener, map);
    }
