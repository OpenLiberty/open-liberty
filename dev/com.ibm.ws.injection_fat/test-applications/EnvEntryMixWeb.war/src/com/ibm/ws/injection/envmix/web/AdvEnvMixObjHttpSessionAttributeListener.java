...
@Resources(value = {
                     @Resource(name = "com.ibm.ws.injection.envmix.web.AdvEnvMixObjHttpSessionAttributeListener/JNDI_Class_Ann_String", type = String.class),
                     @Resource(name = "com.ibm.ws.injection.envmix.web.AdvEnvMixObjHttpSessionAttributeListener/JNDI_Class_Ann_Character", type = Character.class),
                     @Resource(name = "com.ibm.ws.injection.envmix.web.AdvEnvMixObjHttpSessionAttributeListener/JNDI_Class_Ann_Byte", type = Byte.class),
                     @Resource(name = "com.ibm.ws.injection.envmix.web.AdvEnvMixObjHttpSessionAttributeListener/JNDI_Class_Ann_Short", type = Short.class),
                     @Resource(name = "com.ibm.ws.injection.envmix.web.AdvEnvMixObjHttpSessionAttributeListener/JNDI_Class_Ann_Integer", type = Integer.class),
                     @Resource(name = "com.ibm.ws.injection.envmix.web.AdvEnvMixObjHttpSessionAttributeListener/JNDI_Class_Ann_Long", type = Long.class),
                     @Resource(name = "com.ibm.ws.injection.envmix.web.AdvEnvMixObjHttpSessionAttributeListener/JNDI_Class_Ann_Boolean", type = Boolean.class),
                     @Resource(name = "com.ibm.ws.injection.envmix.web.AdvEnvMixObjHttpSessionAttributeListener/JNDI_Class_Ann_Double", type = Double.class),
                     @Resource(name = "com.ibm.ws.injection.envmix.web.AdvEnvMixObjHttpSessionAttributeListener/JNDI_Class_Ann_Float", type = Float.class)
})
public class AdvEnvMixObjHttpSessionAttributeListener implements HttpSessionAttributeListener {
    private static final String CLASS_NAME = AdvEnvMixObjHttpSessionAttributeListener.class.getName();
    ...
    public AdvEnvMixObjHttpSessionAttributeListener() {
    ...
    public void attributeAdded(HttpSessionBindingEvent arg0) {
        ...
        doWork(WCEventTracker.KEY_LISTENER_ADD_AdvEnvMixObjHttpSessionAttributeListener);
    }

    @Override
    public void attributeRemoved(HttpSessionBindingEvent arg0) {
        svLogger.info("Obj Http Session: Attribute removed...");
        doWork(WCEventTracker.KEY_LISTENER_DEL_AdvEnvMixObjHttpSessionAttributeListener);
    }

    @Override
    public void attributeReplaced(HttpSessionBindingEvent arg0) {
        svLogger.info("Obj Http Session: Attribute replaced...");
        doWork(WCEventTracker.KEY_LISTENER_REP_AdvEnvMixObjHttpSessionAttributeListener);
    }
