...
@Resources(value = {
                     @Resource(name = "com.ibm.ws.injection.envmix.web.AdvEnvMixObjServletRequestListener/JNDI_Class_Ann_String", type = String.class),
                     @Resource(name = "com.ibm.ws.injection.envmix.web.AdvEnvMixObjServletRequestListener/JNDI_Class_Ann_Character", type = Character.class),
                     @Resource(name = "com.ibm.ws.injection.envmix.web.AdvEnvMixObjServletRequestListener/JNDI_Class_Ann_Byte", type = Byte.class),
                     @Resource(name = "com.ibm.ws.injection.envmix.web.AdvEnvMixObjServletRequestListener/JNDI_Class_Ann_Short", type = Short.class),
                     @Resource(name = "com.ibm.ws.injection.envmix.web.AdvEnvMixObjServletRequestListener/JNDI_Class_Ann_Integer", type = Integer.class),
                     @Resource(name = "com.ibm.ws.injection.envmix.web.AdvEnvMixObjServletRequestListener/JNDI_Class_Ann_Long", type = Long.class),
                     @Resource(name = "com.ibm.ws.injection.envmix.web.AdvEnvMixObjServletRequestListener/JNDI_Class_Ann_Boolean", type = Boolean.class),
                     @Resource(name = "com.ibm.ws.injection.envmix.web.AdvEnvMixObjServletRequestListener/JNDI_Class_Ann_Double", type = Double.class),
                     @Resource(name = "com.ibm.ws.injection.envmix.web.AdvEnvMixObjServletRequestListener/JNDI_Class_Ann_Float", type = Float.class)
})
public class AdvEnvMixObjServletRequestListener implements ServletRequestListener {
    private static final String CLASS_NAME = AdvEnvMixObjServletRequestListener.class.getName();
    ...
    public AdvEnvMixObjServletRequestListener() {
    ...
    public void requestInitialized(ServletRequestEvent sre) {
        ...
        if (testName != null && testName.toString().equals("testEnvMixObjRequestListener")) {
            ...
            EnvMixObjTestHelper.processRequest(CLASS_NAME, key, clmap);
        }
    }
