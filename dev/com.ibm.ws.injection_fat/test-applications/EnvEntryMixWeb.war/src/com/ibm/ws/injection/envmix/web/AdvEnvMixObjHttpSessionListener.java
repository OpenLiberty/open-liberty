...
@Resources(value = {
                     @Resource(name = "com.ibm.ws.injection.envmix.web.AdvEnvMixObjHttpSessionListener/JNDI_Class_Ann_String", type = String.class),
                     @Resource(name = "com.ibm.ws.injection.envmix.web.AdvEnvMixObjHttpSessionListener/JNDI_Class_Ann_Character", type = Character.class),
                     @Resource(name = "com.ibm.ws.injection.envmix.web.AdvEnvMixObjHttpSessionListener/JNDI_Class_Ann_Byte", type = Byte.class),
                     @Resource(name = "com.ibm.ws.injection.envmix.web.AdvEnvMixObjHttpSessionListener/JNDI_Class_Ann_Short", type = Short.class),
                     @Resource(name = "com.ibm.ws.injection.envmix.web.AdvEnvMixObjHttpSessionListener/JNDI_Class_Ann_Integer", type = Integer.class),
                     @Resource(name = "com.ibm.ws.injection.envmix.web.AdvEnvMixObjHttpSessionListener/JNDI_Class_Ann_Long", type = Long.class),
                     @Resource(name = "com.ibm.ws.injection.envmix.web.AdvEnvMixObjHttpSessionListener/JNDI_Class_Ann_Boolean", type = Boolean.class),
                     @Resource(name = "com.ibm.ws.injection.envmix.web.AdvEnvMixObjHttpSessionListener/JNDI_Class_Ann_Double", type = Double.class),
                     @Resource(name = "com.ibm.ws.injection.envmix.web.AdvEnvMixObjHttpSessionListener/JNDI_Class_Ann_Float", type = Float.class)
})
