...
@Resources(value = {
                     @Resource(name = "com.ibm.ws.injection.envmix.web.AdvEnvMixPrimServletRequestListener/JNDI_Ann_char", type = Character.class),
                     @Resource(name = "com.ibm.ws.injection.envmix.web.AdvEnvMixPrimServletRequestListener/JNDI_Ann_byte", type = Byte.class),
                     @Resource(name = "com.ibm.ws.injection.envmix.web.AdvEnvMixPrimServletRequestListener/JNDI_Ann_short", type = Short.class),
                     @Resource(name = "com.ibm.ws.injection.envmix.web.AdvEnvMixPrimServletRequestListener/JNDI_Ann_int", type = Integer.class),
                     @Resource(name = "com.ibm.ws.injection.envmix.web.AdvEnvMixPrimServletRequestListener/JNDI_Ann_long", type = Long.class),
                     @Resource(name = "com.ibm.ws.injection.envmix.web.AdvEnvMixPrimServletRequestListener/JNDI_Ann_boolean", type = Boolean.class),
                     @Resource(name = "com.ibm.ws.injection.envmix.web.AdvEnvMixPrimServletRequestListener/JNDI_Ann_double", type = Double.class),
                     @Resource(name = "com.ibm.ws.injection.envmix.web.AdvEnvMixPrimServletRequestListener/JNDI_Ann_float", type = Float.class)
})
