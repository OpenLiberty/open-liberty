...
@Resources(value = {
                     @Resource(name = "suite.r85.base.injection.envmix.web.AdvEnvMixPrimHttpSessionAttributeListener/JNDI_Ann_char", type = Character.class),
                     @Resource(name = "suite.r85.base.injection.envmix.web.AdvEnvMixPrimHttpSessionAttributeListener/JNDI_Ann_byte", type = Byte.class),
                     @Resource(name = "suite.r85.base.injection.envmix.web.AdvEnvMixPrimHttpSessionAttributeListener/JNDI_Ann_short", type = Short.class),
                     @Resource(name = "suite.r85.base.injection.envmix.web.AdvEnvMixPrimHttpSessionAttributeListener/JNDI_Ann_int", type = Integer.class),
                     @Resource(name = "suite.r85.base.injection.envmix.web.AdvEnvMixPrimHttpSessionAttributeListener/JNDI_Ann_long", type = Long.class),
                     @Resource(name = "suite.r85.base.injection.envmix.web.AdvEnvMixPrimHttpSessionAttributeListener/JNDI_Ann_boolean", type = Boolean.class),
                     @Resource(name = "suite.r85.base.injection.envmix.web.AdvEnvMixPrimHttpSessionAttributeListener/JNDI_Ann_double", type = Double.class),
                     @Resource(name = "suite.r85.base.injection.envmix.web.AdvEnvMixPrimHttpSessionAttributeListener/JNDI_Ann_float", type = Float.class)
})
public class AdvEnvMixPrimHttpSessionAttributeListener implements HttpSessionAttributeListener {
    private static final String CLASS_NAME = AdvEnvMixPrimHttpSessionAttributeListener.class.getName();
    ...
    public void attributeAdded(HttpSessionBindingEvent arg0) {
        ...
        processRequest(WCEventTracker.KEY_LISTENER_ADD_AdvEnvMixPrimHttpSessionAttributeListener);
    }

    @Override
    public void attributeRemoved(HttpSessionBindingEvent arg0) {
        svLogger.info("Prim Http Session: Attribute removed...");
        processRequest(WCEventTracker.KEY_LISTENER_DEL_AdvEnvMixPrimHttpSessionAttributeListener);
    }

    @Override
    public void attributeReplaced(HttpSessionBindingEvent arg0) {
        svLogger.info("Prim Http Session: Attribute replaced...");
        processRequest(WCEventTracker.KEY_LISTENER_REP_AdvEnvMixPrimHttpSessionAttributeListener);
    }
