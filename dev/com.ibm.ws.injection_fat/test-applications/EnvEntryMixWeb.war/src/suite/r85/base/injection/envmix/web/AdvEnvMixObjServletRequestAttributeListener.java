...
@Resources(value = {
                     @Resource(name = "suite.r85.base.injection.envmix.web.AdvEnvMixObjServletRequestAttributeListener/JNDI_Class_Ann_String", type = String.class),
                     @Resource(name = "suite.r85.base.injection.envmix.web.AdvEnvMixObjServletRequestAttributeListener/JNDI_Class_Ann_Character", type = Character.class),
                     @Resource(name = "suite.r85.base.injection.envmix.web.AdvEnvMixObjServletRequestAttributeListener/JNDI_Class_Ann_Byte", type = Byte.class),
                     @Resource(name = "suite.r85.base.injection.envmix.web.AdvEnvMixObjServletRequestAttributeListener/JNDI_Class_Ann_Short", type = Short.class),
                     @Resource(name = "suite.r85.base.injection.envmix.web.AdvEnvMixObjServletRequestAttributeListener/JNDI_Class_Ann_Integer", type = Integer.class),
                     @Resource(name = "suite.r85.base.injection.envmix.web.AdvEnvMixObjServletRequestAttributeListener/JNDI_Class_Ann_Long", type = Long.class),
                     @Resource(name = "suite.r85.base.injection.envmix.web.AdvEnvMixObjServletRequestAttributeListener/JNDI_Class_Ann_Boolean", type = Boolean.class),
                     @Resource(name = "suite.r85.base.injection.envmix.web.AdvEnvMixObjServletRequestAttributeListener/JNDI_Class_Ann_Double", type = Double.class),
                     @Resource(name = "suite.r85.base.injection.envmix.web.AdvEnvMixObjServletRequestAttributeListener/JNDI_Class_Ann_Float", type = Float.class)
})
public class AdvEnvMixObjServletRequestAttributeListener implements ServletRequestAttributeListener {
    private static final String CLASS_NAME = AdvEnvMixObjServletRequestAttributeListener.class.getName();
    ...
    public AdvEnvMixObjServletRequestAttributeListener() {
    ...
    public void attributeAdded(ServletRequestAttributeEvent arg0) {
        ...
        doWork(WCEventTracker.KEY_LISTENER_ADD_AdvEnvMixObjServletRequestAttributeListener);
    }

    @Override
    public void attributeRemoved(ServletRequestAttributeEvent arg0) {
        svLogger.info("Obj Servlet Request: Attribute removed...");
        doWork(WCEventTracker.KEY_LISTENER_DEL_AdvEnvMixObjServletRequestAttributeListener);
    }

    @Override
    public void attributeReplaced(ServletRequestAttributeEvent arg0) {
        svLogger.info("Obj Servlet Request: Attribute replaced...");
        doWork(WCEventTracker.KEY_LISTENER_REP_AdvEnvMixObjServletRequestAttributeListener);
    }
