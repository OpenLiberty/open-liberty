...
@Resources(value = {
                     @Resource(name = "suite.r85.base.injection.envmix.web.AdvEnvMixObjHttpSessionAttributeListener/JNDI_Class_Ann_String", type = String.class),
                     @Resource(name = "suite.r85.base.injection.envmix.web.AdvEnvMixObjHttpSessionAttributeListener/JNDI_Class_Ann_Character", type = Character.class),
                     @Resource(name = "suite.r85.base.injection.envmix.web.AdvEnvMixObjHttpSessionAttributeListener/JNDI_Class_Ann_Byte", type = Byte.class),
                     @Resource(name = "suite.r85.base.injection.envmix.web.AdvEnvMixObjHttpSessionAttributeListener/JNDI_Class_Ann_Short", type = Short.class),
                     @Resource(name = "suite.r85.base.injection.envmix.web.AdvEnvMixObjHttpSessionAttributeListener/JNDI_Class_Ann_Integer", type = Integer.class),
                     @Resource(name = "suite.r85.base.injection.envmix.web.AdvEnvMixObjHttpSessionAttributeListener/JNDI_Class_Ann_Long", type = Long.class),
                     @Resource(name = "suite.r85.base.injection.envmix.web.AdvEnvMixObjHttpSessionAttributeListener/JNDI_Class_Ann_Boolean", type = Boolean.class),
                     @Resource(name = "suite.r85.base.injection.envmix.web.AdvEnvMixObjHttpSessionAttributeListener/JNDI_Class_Ann_Double", type = Double.class),
                     @Resource(name = "suite.r85.base.injection.envmix.web.AdvEnvMixObjHttpSessionAttributeListener/JNDI_Class_Ann_Float", type = Float.class)
})
