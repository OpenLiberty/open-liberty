...
@Resources(value = {
                     @Resource(name = "suite.r85.base.injection.envmix.web.AdvEnvMixPrimServletRequestListener/JNDI_Ann_char", type = Character.class),
                     @Resource(name = "suite.r85.base.injection.envmix.web.AdvEnvMixPrimServletRequestListener/JNDI_Ann_byte", type = Byte.class),
                     @Resource(name = "suite.r85.base.injection.envmix.web.AdvEnvMixPrimServletRequestListener/JNDI_Ann_short", type = Short.class),
                     @Resource(name = "suite.r85.base.injection.envmix.web.AdvEnvMixPrimServletRequestListener/JNDI_Ann_int", type = Integer.class),
                     @Resource(name = "suite.r85.base.injection.envmix.web.AdvEnvMixPrimServletRequestListener/JNDI_Ann_long", type = Long.class),
                     @Resource(name = "suite.r85.base.injection.envmix.web.AdvEnvMixPrimServletRequestListener/JNDI_Ann_boolean", type = Boolean.class),
                     @Resource(name = "suite.r85.base.injection.envmix.web.AdvEnvMixPrimServletRequestListener/JNDI_Ann_double", type = Double.class),
                     @Resource(name = "suite.r85.base.injection.envmix.web.AdvEnvMixPrimServletRequestListener/JNDI_Ann_float", type = Float.class)
})
public class AdvEnvMixPrimServletRequestListener implements ServletRequestListener {
    private static final String CLASS_NAME = AdvEnvMixPrimServletRequestListener.class.getName();
    ...
    public void requestInitialized(ServletRequestEvent sre) {
        ...
        processRequest(sre, WCEventTracker.KEY_LISTENER_INIT_AdvEnvMixPrimServletRequestListener);
    }
    ...
    public void processRequest(ServletRequestEvent sre, String key) {
        ...
        if (testName != null && testName.toString().equals("testEnvMixPrimRequestListener")) {
