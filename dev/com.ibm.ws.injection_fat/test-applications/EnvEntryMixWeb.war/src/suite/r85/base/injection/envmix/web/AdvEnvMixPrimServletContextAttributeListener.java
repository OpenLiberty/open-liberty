 ...
 *******************************************************************************/
package suite.r85.base.injection.envmix.web;
...
@Resources(value = {
                     @Resource(name = "suite.r85.base.injection.envmix.web.AdvEnvMixPrimServletContextAttributeListener/JNDI_Ann_char", type = Character.class),
                     @Resource(name = "suite.r85.base.injection.envmix.web.AdvEnvMixPrimServletContextAttributeListener/JNDI_Ann_byte", type = Byte.class),
                     @Resource(name = "suite.r85.base.injection.envmix.web.AdvEnvMixPrimServletContextAttributeListener/JNDI_Ann_short", type = Short.class),
                     @Resource(name = "suite.r85.base.injection.envmix.web.AdvEnvMixPrimServletContextAttributeListener/JNDI_Ann_int", type = Integer.class),
                     @Resource(name = "suite.r85.base.injection.envmix.web.AdvEnvMixPrimServletContextAttributeListener/JNDI_Ann_long", type = Long.class),
                     @Resource(name = "suite.r85.base.injection.envmix.web.AdvEnvMixPrimServletContextAttributeListener/JNDI_Ann_boolean", type = Boolean.class),
                     @Resource(name = "suite.r85.base.injection.envmix.web.AdvEnvMixPrimServletContextAttributeListener/JNDI_Ann_double", type = Double.class),
                     @Resource(name = "suite.r85.base.injection.envmix.web.AdvEnvMixPrimServletContextAttributeListener/JNDI_Ann_float", type = Float.class)
})
public class AdvEnvMixPrimServletContextAttributeListener implements ServletContextAttributeListener {
    private static final String CLASS_NAME = AdvEnvMixPrimServletContextAttributeListener.class.getName();
    ...
    public void attributeAdded(ServletContextAttributeEvent arg0) {
        ...
        processRequest(WCEventTracker.KEY_LISTENER_ADD_AdvEnvMixPrimContextAttributeListener);
    }

    @Override
    public void attributeRemoved(ServletContextAttributeEvent arg0) {
        svLogger.info("Prim Servlet Context: Attribute removed...");
        processRequest(WCEventTracker.KEY_LISTENER_DEL_AdvEnvMixPrimContextAttributeListener);
    }

    @Override
    public void attributeReplaced(ServletContextAttributeEvent arg0) {
        svLogger.info("Prim Servlet Context: Attribute replaced...");
        processRequest(WCEventTracker.KEY_LISTENER_REP_AdvEnvMixPrimContextAttributeListener);
    }
