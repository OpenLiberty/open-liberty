...
@Resource(name = "com.ibm.ws.injection.repeatable.envmix.web.AdvRepeatableEnvMixPrimServletRequestAttributeListener/JNDI_Ann_char", type = Character.class)
@Resource(name = "com.ibm.ws.injection.repeatable.envmix.web.AdvRepeatableEnvMixPrimServletRequestAttributeListener/JNDI_Ann_byte", type = Byte.class)
@Resource(name = "com.ibm.ws.injection.repeatable.envmix.web.AdvRepeatableEnvMixPrimServletRequestAttributeListener/JNDI_Ann_short", type = Short.class)
@Resource(name = "com.ibm.ws.injection.repeatable.envmix.web.AdvRepeatableEnvMixPrimServletRequestAttributeListener/JNDI_Ann_int", type = Integer.class)
@Resource(name = "com.ibm.ws.injection.repeatable.envmix.web.AdvRepeatableEnvMixPrimServletRequestAttributeListener/JNDI_Ann_long", type = Long.class)
@Resource(name = "com.ibm.ws.injection.repeatable.envmix.web.AdvRepeatableEnvMixPrimServletRequestAttributeListener/JNDI_Ann_boolean", type = Boolean.class)
@Resource(name = "com.ibm.ws.injection.repeatable.envmix.web.AdvRepeatableEnvMixPrimServletRequestAttributeListener/JNDI_Ann_double", type = Double.class)
@Resource(name = "com.ibm.ws.injection.repeatable.envmix.web.AdvRepeatableEnvMixPrimServletRequestAttributeListener/JNDI_Ann_float", type = Float.class)
public class AdvRepeatableEnvMixPrimServletRequestAttributeListener implements ServletRequestAttributeListener {
    private static final String CLASS_NAME = AdvRepeatableEnvMixPrimServletRequestAttributeListener.class.getName();
    ...
    public void attributeAdded(ServletRequestAttributeEvent arg0) {
        ...
        processRequest(WCEventTracker.KEY_LISTENER_ADD_AdvRepeatableEnvMixPrimServletRequestAttributeListener);
    }

    @Override
    public void attributeRemoved(ServletRequestAttributeEvent arg0) {
        svLogger.info("Prim Servlet Request: Attribute removed...");
        processRequest(WCEventTracker.KEY_LISTENER_DEL_AdvRepeatableEnvMixPrimServletRequestAttributeListener);
    }

    @Override
    public void attributeReplaced(ServletRequestAttributeEvent arg0) {
        svLogger.info("Prim Servlet Request: Attribute replaced...");
        processRequest(WCEventTracker.KEY_LISTENER_REP_AdvRepeatableEnvMixPrimServletRequestAttributeListener);
    }
