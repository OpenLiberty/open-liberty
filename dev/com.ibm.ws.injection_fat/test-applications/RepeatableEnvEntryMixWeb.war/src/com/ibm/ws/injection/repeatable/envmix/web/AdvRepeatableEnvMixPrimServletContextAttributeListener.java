...
@Resource(name = "com.ibm.ws.injection.repeatable.envmix.web.AdvRepeatableEnvMixPrimServletContextAttributeListener/JNDI_Ann_char", type = Character.class)
@Resource(name = "com.ibm.ws.injection.repeatable.envmix.web.AdvRepeatableEnvMixPrimServletContextAttributeListener/JNDI_Ann_byte", type = Byte.class)
@Resource(name = "com.ibm.ws.injection.repeatable.envmix.web.AdvRepeatableEnvMixPrimServletContextAttributeListener/JNDI_Ann_short", type = Short.class)
@Resource(name = "com.ibm.ws.injection.repeatable.envmix.web.AdvRepeatableEnvMixPrimServletContextAttributeListener/JNDI_Ann_int", type = Integer.class)
@Resource(name = "com.ibm.ws.injection.repeatable.envmix.web.AdvRepeatableEnvMixPrimServletContextAttributeListener/JNDI_Ann_long", type = Long.class)
@Resource(name = "com.ibm.ws.injection.repeatable.envmix.web.AdvRepeatableEnvMixPrimServletContextAttributeListener/JNDI_Ann_boolean", type = Boolean.class)
@Resource(name = "com.ibm.ws.injection.repeatable.envmix.web.AdvRepeatableEnvMixPrimServletContextAttributeListener/JNDI_Ann_double", type = Double.class)
@Resource(name = "com.ibm.ws.injection.repeatable.envmix.web.AdvRepeatableEnvMixPrimServletContextAttributeListener/JNDI_Ann_float", type = Float.class)
public class AdvRepeatableEnvMixPrimServletContextAttributeListener implements ServletContextAttributeListener {
    private static final String CLASS_NAME = AdvRepeatableEnvMixPrimServletContextAttributeListener.class.getName();
    ...
    public void attributeAdded(ServletContextAttributeEvent arg0) {
        ...
        processRequest(WCEventTracker.KEY_LISTENER_ADD_AdvRepeatableEnvMixPrimContextAttributeListener);
    }

    @Override
    public void attributeRemoved(ServletContextAttributeEvent arg0) {
        svLogger.info("Prim Servlet Context: Attribute removed...");
        processRequest(WCEventTracker.KEY_LISTENER_DEL_AdvRepeatableEnvMixPrimContextAttributeListener);
    }

    @Override
    public void attributeReplaced(ServletContextAttributeEvent arg0) {
        svLogger.info("Prim Servlet Context: Attribute replaced...");
        processRequest(WCEventTracker.KEY_LISTENER_REP_AdvRepeatableEnvMixPrimContextAttributeListener);
    }
