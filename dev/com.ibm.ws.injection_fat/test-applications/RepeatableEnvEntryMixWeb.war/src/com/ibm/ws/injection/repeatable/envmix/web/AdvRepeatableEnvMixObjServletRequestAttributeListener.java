...
@Resource(name = "com.ibm.ws.injection.repeatable.envmix.web.AdvRepeatableEnvMixObjServletRequestAttributeListener/JNDI_Class_Ann_String", type = String.class)
@Resource(name = "com.ibm.ws.injection.repeatable.envmix.web.AdvRepeatableEnvMixObjServletRequestAttributeListener/JNDI_Class_Ann_Character", type = Character.class)
@Resource(name = "com.ibm.ws.injection.repeatable.envmix.web.AdvRepeatableEnvMixObjServletRequestAttributeListener/JNDI_Class_Ann_Byte", type = Byte.class)
@Resource(name = "com.ibm.ws.injection.repeatable.envmix.web.AdvRepeatableEnvMixObjServletRequestAttributeListener/JNDI_Class_Ann_Short", type = Short.class)
@Resource(name = "com.ibm.ws.injection.repeatable.envmix.web.AdvRepeatableEnvMixObjServletRequestAttributeListener/JNDI_Class_Ann_Integer", type = Integer.class)
@Resource(name = "com.ibm.ws.injection.repeatable.envmix.web.AdvRepeatableEnvMixObjServletRequestAttributeListener/JNDI_Class_Ann_Long", type = Long.class)
@Resource(name = "com.ibm.ws.injection.repeatable.envmix.web.AdvRepeatableEnvMixObjServletRequestAttributeListener/JNDI_Class_Ann_Boolean", type = Boolean.class)
@Resource(name = "com.ibm.ws.injection.repeatable.envmix.web.AdvRepeatableEnvMixObjServletRequestAttributeListener/JNDI_Class_Ann_Double", type = Double.class)
@Resource(name = "com.ibm.ws.injection.repeatable.envmix.web.AdvRepeatableEnvMixObjServletRequestAttributeListener/JNDI_Class_Ann_Float", type = Float.class)
public class AdvRepeatableEnvMixObjServletRequestAttributeListener implements ServletRequestAttributeListener {
    private static final String CLASS_NAME = AdvRepeatableEnvMixObjServletRequestAttributeListener.class.getName();
    ...
    public AdvRepeatableEnvMixObjServletRequestAttributeListener() {
    ...
    public void attributeAdded(ServletRequestAttributeEvent arg0) {
        ...
        doWork(WCEventTracker.KEY_LISTENER_ADD_AdvRepeatableEnvMixObjServletRequestAttributeListener);
    }

    @Override
    public void attributeRemoved(ServletRequestAttributeEvent arg0) {
        svLogger.info("Obj Servlet Request: Attribute removed...");
        doWork(WCEventTracker.KEY_LISTENER_DEL_AdvRepeatableEnvMixObjServletRequestAttributeListener);
    }

    @Override
    public void attributeReplaced(ServletRequestAttributeEvent arg0) {
        svLogger.info("Obj Servlet Request: Attribute replaced...");
        doWork(WCEventTracker.KEY_LISTENER_REP_AdvRepeatableEnvMixObjServletRequestAttributeListener);
    }
