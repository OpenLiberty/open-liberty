...
@Resource(name = "com.ibm.ws.injection.repeatable.envmix.web.AdvRepeatableEnvMixPrimServletRequestListener/JNDI_Ann_char", type = Character.class)
@Resource(name = "com.ibm.ws.injection.repeatable.envmix.web.AdvRepeatableEnvMixPrimServletRequestListener/JNDI_Ann_byte", type = Byte.class)
@Resource(name = "com.ibm.ws.injection.repeatable.envmix.web.AdvRepeatableEnvMixPrimServletRequestListener/JNDI_Ann_short", type = Short.class)
@Resource(name = "com.ibm.ws.injection.repeatable.envmix.web.AdvRepeatableEnvMixPrimServletRequestListener/JNDI_Ann_int", type = Integer.class)
@Resource(name = "com.ibm.ws.injection.repeatable.envmix.web.AdvRepeatableEnvMixPrimServletRequestListener/JNDI_Ann_long", type = Long.class)
@Resource(name = "com.ibm.ws.injection.repeatable.envmix.web.AdvRepeatableEnvMixPrimServletRequestListener/JNDI_Ann_boolean", type = Boolean.class)
@Resource(name = "com.ibm.ws.injection.repeatable.envmix.web.AdvRepeatableEnvMixPrimServletRequestListener/JNDI_Ann_double", type = Double.class)
@Resource(name = "com.ibm.ws.injection.repeatable.envmix.web.AdvRepeatableEnvMixPrimServletRequestListener/JNDI_Ann_float", type = Float.class)
public class AdvRepeatableEnvMixPrimServletRequestListener implements ServletRequestListener {
    private static final String CLASS_NAME = AdvRepeatableEnvMixPrimServletRequestListener.class.getName();
    ...
    public void requestInitialized(ServletRequestEvent sre) {
        ...
        processRequest(sre, WCEventTracker.KEY_LISTENER_INIT_AdvRepeatableEnvMixPrimServletRequestListener);
    }
    ...
    public void processRequest(ServletRequestEvent sre, String key) {
        ...
        if (testName != null && testName.toString().equals("testRepeatableEnvMixPrimRequestListener")) {
