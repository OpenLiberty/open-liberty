...
@Resource(name = "com.ibm.ws.injection.repeatable.envmix.web.AdvRepeatableEnvMixPrimHttpSessionAttributeListener/JNDI_Ann_char", type = Character.class)
@Resource(name = "com.ibm.ws.injection.repeatable.envmix.web.AdvRepeatableEnvMixPrimHttpSessionAttributeListener/JNDI_Ann_byte", type = Byte.class)
@Resource(name = "com.ibm.ws.injection.repeatable.envmix.web.AdvRepeatableEnvMixPrimHttpSessionAttributeListener/JNDI_Ann_short", type = Short.class)
@Resource(name = "com.ibm.ws.injection.repeatable.envmix.web.AdvRepeatableEnvMixPrimHttpSessionAttributeListener/JNDI_Ann_int", type = Integer.class)
@Resource(name = "com.ibm.ws.injection.repeatable.envmix.web.AdvRepeatableEnvMixPrimHttpSessionAttributeListener/JNDI_Ann_long", type = Long.class)
@Resource(name = "com.ibm.ws.injection.repeatable.envmix.web.AdvRepeatableEnvMixPrimHttpSessionAttributeListener/JNDI_Ann_boolean", type = Boolean.class)
@Resource(name = "com.ibm.ws.injection.repeatable.envmix.web.AdvRepeatableEnvMixPrimHttpSessionAttributeListener/JNDI_Ann_double", type = Double.class)
@Resource(name = "com.ibm.ws.injection.repeatable.envmix.web.AdvRepeatableEnvMixPrimHttpSessionAttributeListener/JNDI_Ann_float", type = Float.class)
public class AdvRepeatableEnvMixPrimHttpSessionAttributeListener implements HttpSessionAttributeListener {
    private static final String CLASS_NAME = AdvRepeatableEnvMixPrimHttpSessionAttributeListener.class.getName();
    ...
    public void attributeAdded(HttpSessionBindingEvent arg0) {
        ...
        processRequest(WCEventTracker.KEY_LISTENER_ADD_AdvRepeatableEnvMixPrimHttpSessionAttributeListener);
    }

    @Override
    public void attributeRemoved(HttpSessionBindingEvent arg0) {
        svLogger.info("Prim Http Session: Attribute removed...");
        processRequest(WCEventTracker.KEY_LISTENER_DEL_AdvRepeatableEnvMixPrimHttpSessionAttributeListener);
    }

    @Override
    public void attributeReplaced(HttpSessionBindingEvent arg0) {
        svLogger.info("Prim Http Session: Attribute replaced...");
        processRequest(WCEventTracker.KEY_LISTENER_REP_AdvRepeatableEnvMixPrimHttpSessionAttributeListener);
    }
