...
@PersistenceContext(name = "suite.r85.base.injection.jpa.web.AdvJPAPersistenceFilter/JNDI_Class_Ann_PC", unitName = "test")
@PersistenceUnit(name = "suite.r85.base.injection.jpa.web.AdvJPAPersistenceFilter/JNDI_Class_Ann_PU", unitName = "test")
