...
@Resource(name = "suite.r85.base.injection.resref.web.AdvResRefHttpSessionListener/JNDI_Fld_Ann_DataSource", type = javax.sql.DataSource.class)
public class AdvResRefHttpSessionListener implements HttpSessionListener {
    ...
    public AdvResRefHttpSessionListener() {
