...
public class AdvEnvXMLObjHttpSessionListener implements HttpSessionListener {
    ...
    public AdvEnvXMLObjHttpSessionListener() {
    ...
    public void sessionCreated(HttpSessionEvent arg0) {
        ...
        populateMap();
        EnvXMLObjTestHelper.processRequest(CLASS_NAME, WCEventTracker.KEY_LISTENER_CREATED_AdvEnvXMLObjHttpSessionListener, map);
    }
