...
public class AdvEnvXMLPrimServletContextAttributeListener implements ServletContextAttributeListener {
    private static final String CLASS_NAME = AdvEnvXMLPrimServletContextAttributeListener.class.getName();
    ...
    public AdvEnvXMLPrimServletContextAttributeListener() {
        try {
    ...
    public void attributeAdded(ServletContextAttributeEvent arg0) {
        ...
        processRequest(WCEventTracker.KEY_LISTENER_ADD_AdvEnvXMLPrimContextAttributeListener);
    }

    @Override
    public void attributeRemoved(ServletContextAttributeEvent arg0) {
        svLogger.info("Prim Servlet Context: Attribute removed...");
        processRequest(WCEventTracker.KEY_LISTENER_DEL_AdvEnvXMLPrimContextAttributeListener);
    }

    @Override
    public void attributeReplaced(ServletContextAttributeEvent arg0) {
        svLogger.info("Prim Servlet Context: Attribute replaced...");
        processRequest(WCEventTracker.KEY_LISTENER_REP_AdvEnvXMLPrimContextAttributeListener);
    }
