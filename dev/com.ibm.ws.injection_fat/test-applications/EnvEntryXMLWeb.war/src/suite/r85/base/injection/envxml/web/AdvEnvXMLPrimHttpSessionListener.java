...
public class AdvEnvXMLPrimHttpSessionListener implements HttpSessionListener {
    private static final String CLASS_NAME = AdvEnvXMLPrimHttpSessionListener.class.getName();
    ...
    public AdvEnvXMLPrimHttpSessionListener() {
        try {
    ...
    public void sessionCreated(HttpSessionEvent arg0) {
        ...
        processRequest(WCEventTracker.KEY_LISTENER_CREATED_AdvEnvXMLPrimHttpSessionListener);
    }
