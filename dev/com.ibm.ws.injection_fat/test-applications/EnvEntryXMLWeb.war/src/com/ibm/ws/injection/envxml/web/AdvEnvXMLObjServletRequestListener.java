...
public class AdvEnvXMLObjServletRequestListener implements ServletRequestListener {
    private static final String CLASS_NAME = AdvEnvXMLObjServletRequestListener.class.getName();
    ...
    public AdvEnvXMLObjServletRequestListener() {
    ...
    public void requestInitialized(ServletRequestEvent sre) {
        ...
        if (testName != null && testName.toString().equals("testEnvXMLObjRequestListener")) {
            svLogger.info("Obj Servlet Request: Request Initialized...");
            populateMap();
            EnvXMLObjTestHelper.processRequest(CLASS_NAME, WCEventTracker.KEY_LISTENER_INIT_AdvEnvXMLObjServletRequestListener, map);
        }
    }
