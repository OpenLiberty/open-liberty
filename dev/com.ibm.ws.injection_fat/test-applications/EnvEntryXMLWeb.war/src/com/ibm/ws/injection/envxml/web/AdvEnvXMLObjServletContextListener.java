...
public class AdvEnvXMLObjServletContextListener implements ServletContextListener {
    private static final String CLASS_NAME = AdvEnvXMLObjServletContextListener.class.getName();
    ...
    public AdvEnvXMLObjServletContextListener() {
    ...
    public void contextInitialized(ServletContextEvent arg0) {
        ...
        populateMap();
        EnvXMLObjTestHelper.processRequest(CLASS_NAME, WCEventTracker.KEY_LISTENER_INIT_AdvEnvXMLObjServletContextListener, map);
    }
