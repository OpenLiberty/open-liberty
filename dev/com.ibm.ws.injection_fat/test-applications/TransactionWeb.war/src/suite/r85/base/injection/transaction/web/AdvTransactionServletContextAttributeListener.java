...
@Resources(value = {
                     @Resource(name = "suite.r85.base.injection.transaction.web.AdvTransactionServletContextAttributeListener/JNDI_Class_Ann_UserTransaction",
                               type = javax.transaction.UserTransaction.class),
                     @Resource(name = "suite.r85.base.injection.transaction.web.AdvTransactionServletContextAttributeListener/JNDI_Class_Ann_TranSynchReg",
