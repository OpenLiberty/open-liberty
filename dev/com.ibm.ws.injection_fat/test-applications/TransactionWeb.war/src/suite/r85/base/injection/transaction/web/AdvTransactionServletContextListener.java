...
@Resources(value = {
                     @Resource(name = "suite.r85.base.injection.transaction.web.AdvTransactionServletContextListener/JNDI_Class_Ann_UserTransaction",
                               type = javax.transaction.UserTransaction.class),
                     @Resource(name = "suite.r85.base.injection.transaction.web.AdvTransactionServletContextListener/JNDI_Class_Ann_TranSynchReg",
                               type = TransactionSynchronizationRegistry.class)
})
public class AdvTransactionServletContextListener implements ServletContextListener {
    private static final String CLASS_NAME = AdvTransactionServletContextListener.class.getName();
    ...
    public AdvTransactionServletContextListener() {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        svLogger.info("Context Initialized in AdvTransactionServletContextListener");
