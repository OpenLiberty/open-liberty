...
@Resource(name = "com.ibm.ws.injection.repeatable.transaction.web.AdvRepeatableTransactionServletRequestListener/JNDI_Class_Ann_UserTransaction",
          type = javax.transaction.UserTransaction.class)
@Resource(name = "com.ibm.ws.injection.repeatable.transaction.web.AdvRepeatableTransactionServletRequestListener/JNDI_Class_Ann_TranSynchReg",
          type = TransactionSynchronizationRegistry.class)
public class AdvRepeatableTransactionServletRequestListener implements ServletRequestListener {
    private static final String CLASS_NAME = AdvRepeatableTransactionServletRequestListener.class.getName();
    ...
    public AdvRepeatableTransactionServletRequestListener() {
    ...
    public void requestInitialized(ServletRequestEvent sre) {
        ...
        if (testName != null && testName.toString().equals("testRepeatableTransactionRequestListener")) {
