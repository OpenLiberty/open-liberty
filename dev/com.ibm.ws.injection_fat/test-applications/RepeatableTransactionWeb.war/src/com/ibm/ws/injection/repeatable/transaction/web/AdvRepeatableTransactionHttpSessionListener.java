...
@Resource(name = "com.ibm.ws.injection.repeatable.transaction.web.AdvRepeatableTransactionHttpSessionListener/JNDI_Class_Ann_UserTransaction",
          type = javax.transaction.UserTransaction.class)
@Resource(name = "com.ibm.ws.injection.repeatable.transaction.web.AdvRepeatableTransactionHttpSessionListener/JNDI_Class_Ann_TranSynchReg",
          type = TransactionSynchronizationRegistry.class)
public class AdvRepeatableTransactionHttpSessionListener implements HttpSessionListener {
    private static final String CLASS_NAME = AdvRepeatableTransactionHttpSessionListener.class.getName();
    ...
    public AdvRepeatableTransactionHttpSessionListener() {
    ...
    public void sessionCreated(HttpSessionEvent arg0) {
        svLogger.info("Session Created in AdvRepeatableTransactionHttpSessionListener");
