...
@Resource(name = "com.ibm.ws.injection.repeatable.transaction.web.AdvRepeatableTransactionHttpSessionAttributeListener/JNDI_Class_Ann_UserTransaction",
          type = javax.transaction.UserTransaction.class)
@Resource(name = "com.ibm.ws.injection.repeatable.transaction.web.AdvRepeatableTransactionHttpSessionAttributeListener/JNDI_Class_Ann_TranSynchReg",
          type = TransactionSynchronizationRegistry.class)
public class AdvRepeatableTransactionHttpSessionAttributeListener implements HttpSessionAttributeListener {
    private static final String CLASS_NAME = AdvRepeatableTransactionHttpSessionAttributeListener.class.getName();
    ...
    public AdvRepeatableTransactionHttpSessionAttributeListener() {
        map = new HashMap<String, Object>();
    }

    @Override
    public void attributeAdded(HttpSessionBindingEvent hsbe) {
        svLogger.info("AdvRepeatableTransactionHttpSessionAtrributeListener: Attribute added");
        doWork(WCEventTracker.KEY_LISTENER_ADD_AdvRepeatableTransactionHttpSessionAttributeListener);
    }

    @Override
    public void attributeRemoved(HttpSessionBindingEvent hsbe) {
        svLogger.info("AdvRepeatableTransactionHttpSessionAtrributeListener: Attribute Removed");
        doWork(WCEventTracker.KEY_LISTENER_DEL_AdvRepeatableTransactionHttpSessionAttributeListener);
    }

    @Override
    public void attributeReplaced(HttpSessionBindingEvent hsbe) {
        svLogger.info("AdvRepeatableTransactionHttpSessionAtrributeListener: Attribute Replaced");
        doWork(WCEventTracker.KEY_LISTENER_REP_AdvRepeatableTransactionHttpSessionAttributeListener);
    }
