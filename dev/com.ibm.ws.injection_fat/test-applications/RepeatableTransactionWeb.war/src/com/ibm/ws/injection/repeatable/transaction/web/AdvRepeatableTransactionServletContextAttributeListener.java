...
@Resource(name = "com.ibm.ws.injection.repeatable.transaction.web.AdvRepeatableTransactionServletContextAttributeListener/JNDI_Class_Ann_UserTransaction",
          type = javax.transaction.UserTransaction.class)
@Resource(name = "com.ibm.ws.injection.repeatable.transaction.web.AdvRepeatableTransactionServletContextAttributeListener/JNDI_Class_Ann_TranSynchReg",
          type = TransactionSynchronizationRegistry.class)
public class AdvRepeatableTransactionServletContextAttributeListener implements ServletContextAttributeListener {
    private static final String CLASS_NAME = AdvRepeatableTransactionServletContextAttributeListener.class.getName();
    ...
    public AdvRepeatableTransactionServletContextAttributeListener() {
        map = new HashMap<String, Object>();
    }

    @Override
    public void attributeAdded(ServletContextAttributeEvent arg0) {
        svLogger.info("AdvRepeatableTransactionHttpContextAtrributeListener: Attribute added");
        doWork(WCEventTracker.KEY_LISTENER_ADD_AdvRepeatableTransactionContextAttributeListener);
    }

    @Override
    public void attributeRemoved(ServletContextAttributeEvent arg0) {
        svLogger.info("AdvRepeatableTransactionHttpContextAtrributeListener: Attribute Removed");
        doWork(WCEventTracker.KEY_LISTENER_DEL_AdvRepeatableTransactionContextAttributeListener);
    }

    @Override
    public void attributeReplaced(ServletContextAttributeEvent arg0) {
        svLogger.info("AdvRepeatableTransactionHttpContextAtrributeListener: Attribute Replaced");
        doWork(WCEventTracker.KEY_LISTENER_REP_AdvRepeatableTransactionContextAttributeListener);
    }
