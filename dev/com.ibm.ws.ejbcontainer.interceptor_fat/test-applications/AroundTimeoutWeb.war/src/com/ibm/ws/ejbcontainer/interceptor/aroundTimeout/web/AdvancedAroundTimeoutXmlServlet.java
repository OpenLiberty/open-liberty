...
import static com.ibm.ws.ejbcontainer.interceptor.aroundTimeout_xml.ejb.AdvancedInterface.AUTO_TIMER_INFO;
import static com.ibm.ws.ejbcontainer.interceptor.aroundTimeout_xml.ejb.TimerData.MAX_TIMER_WAIT;
...
public class AdvancedAroundTimeoutXmlServlet extends FATServlet {
    private final static String CLASS_NAME = AdvancedAroundTimeoutXmlServlet.class.getName();
