...
@Interceptors({ NoExceptionInterceptor.class })
public class AroundTimeoutNoExBean {
    private static final String CLASS_NAME = AroundTimeoutNoExBean.class.getName();
    ...
    private Object aroundTimeout(InvocationContext c) {
