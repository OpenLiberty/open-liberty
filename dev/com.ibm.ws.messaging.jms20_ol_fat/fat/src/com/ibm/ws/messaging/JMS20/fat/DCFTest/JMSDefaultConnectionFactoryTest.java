...
public class JMSDefaultConnectionFactoryTest {
    ...
    private static LibertyServer server = LibertyServerFactory
                    .getLibertyServer("JMSDefaultConnectionFactoryTest_TestServer");

    private static LibertyServer server1 = LibertyServerFactory
                    .getLibertyServer("JMSDefaultConnectionFactoryTest_TestServer1");
    ...
    public static void setUpShirnkWrap() throws Exception {
        ...
        Archive JMSDefaultConnectionFactoryTestwar = ShrinkWrap.create(WebArchive.class, "JMSDefaultConnectionFactoryTest.war")
            .addClass("web.JMSDefaultConnectionFactoryTestServlet")
            .add(new FileAsset(new File("test-applications//JMSDefaultConnectionFactoryTest.war/resources/WEB-INF/web.xml")), "WEB-INF/web.xml")
            .add(new FileAsset(new File("test-applications//JMSDefaultConnectionFactoryTest.war/resources/WEB-INF/beans.xml")), "WEB-INF/beans.xml")
            .add(new FileAsset(new File("test-applications//JMSDefaultConnectionFactoryTest.war/resources/META-INF/permissions.xml")), "META-INF/permissions.xml");

        ShrinkHelper.exportDropinAppToServer(server, JMSDefaultConnectionFactoryTestwar, OVERWRITE);

        ShrinkHelper.exportDropinAppToServer(server1, JMSDefaultConnectionFactoryTestwar, OVERWRITE);
