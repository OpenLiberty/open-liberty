...
public class JMSContextTest_118066 {
    ...
    private static LibertyServer server1 = LibertyServerFactory.getLibertyServer("JMSContextTest_118066_TestServer2");
    ...
    public void testStartJMSContextStartSecOffBinding() throws Exception {
        ...
        val = runInServlet("testStartJMSContextStartSecOffBinding");
        assertTrue("testStartJMSContextStartSecOffBinding failed ", val);
    }
    ...
    public void testStartJMSContextStartSecOffTCP() throws Exception {
        ...
        val = runInServlet("testStartJMSContextStartSecOffTCP");
        assertTrue("testStartJMSContextStartSecOffTCP failed ", val);
