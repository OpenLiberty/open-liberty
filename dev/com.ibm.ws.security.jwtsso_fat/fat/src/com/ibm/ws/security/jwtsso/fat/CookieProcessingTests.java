...
public class CookieProcessingTests extends CommonJwtFat {
     ...
     *
     * At this time, we do not honor the type of application auth, nor do we expose
     * an attribute to do so (unlike mp-jwt). Any application will be accessed directly
