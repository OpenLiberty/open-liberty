...
import com.ibm.ws.jpa.olgh8950.web.TestOLGH8950Servlet;
...
public class TestOLGH8950_Web extends JPAFATServletClient {
    ...
    public static void setUp() throws Exception {
        ...
        bannerStart(TestOLGH8950_Web.class);
        ...
        System.out.println(TestOLGH8950_Web.class.getName() + " Setting up database tables...");
    ...
    private static void setupTestApplication() throws Exception {
        ...
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh8950.model");
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh8950.testlogic");
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh8950.web");
    ...
    public static void tearDown() throws Exception {
        try {
            ...
            bannerEnd(TestOLGH8950_Web.class, timestart);
        }
    }
}
