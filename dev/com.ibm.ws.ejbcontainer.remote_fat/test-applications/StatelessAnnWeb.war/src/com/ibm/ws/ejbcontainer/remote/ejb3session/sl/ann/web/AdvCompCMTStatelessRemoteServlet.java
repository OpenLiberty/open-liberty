...
public class AdvCompCMTStatelessRemoteServlet extends FATServlet {
    ...
    public void testCompIntTxAttribs() throws Exception {
        ...
        try {
            ...
            // --------------------------------------------------------------------
            AdvCMTStatelessEJBHome slHome = (AdvCMTStatelessEJBHome) PortableRemoteObject.narrow(FATHelper.lookupDefaultBindingEJBJavaApp(AdvCMTStatelessEJBHomeInterface, Module,
                                                                                                                                          AdvCompBean),
                                                                                                 AdvCMTStatelessEJBHome.class);
