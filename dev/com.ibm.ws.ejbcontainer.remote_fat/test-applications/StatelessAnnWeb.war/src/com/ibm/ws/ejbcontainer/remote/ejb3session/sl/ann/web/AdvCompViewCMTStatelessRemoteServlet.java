...
/**
 * <dl>
 * <dt><b>Test Name:</b> AdvCompViewCMTStatelessRemoteTest .
 *
 ...
 * Business Interfaces,
 * EJB injection, and not implementing SessionBean. (remote version of tests)
 * <p>
 *
 * <dt><b>Test Matrix:</b>
 * <dd>
 ...
 * <li>testCompIntInjection - (remote) Business Interface: Verify EJB field and method injection occurrs properly
 * </ul>
 * <br>
 * Data Sources - None
 * </dl>
...
@WebServlet("/AdvCompViewCMTStatelessRemoteServlet")
public class AdvCompViewCMTStatelessRemoteServlet extends FATServlet {
    /**
     * Definitions for the logger
     */
    private final static String CLASSNAME = AdvCompViewCMTStatelessLocalServlet.class.getName();
    ...
    private static final String AdvCompViewBean = "AdvCompViewCMTStatelessRemote";
    ...
    public void testBizIntTxAttribs_AdvCompViewCMTStatelessRemote() throws Exception {
        ...
        try {
            ...
            // Locate SL Remote Home/Factory and execute the test
            // --------------------------------------------------------------------
            BasicCMTStatelessRemote bean = (BasicCMTStatelessRemote) FATHelper.lookupDefaultBindingEJBJavaApp(BasicCMTStatelessRemoteInterface, Module, AdvCompViewBean);
            assertNotNull("1 ---> SLRSB created successfully.", bean);
            bean.tx_Default();
            bean.tx_Required();
            bean.tx_NotSupported();
            ...
            // --------------------------------------------------------------------
            AdvCMTStatelessRemote bean2 = (AdvCMTStatelessRemote) FATHelper.lookupDefaultBindingEJBJavaApp(AdvCMTStatelessRemoteInterface, Module, AdvCompViewBean);
    ...
    /**
     * Test that EJB field and method injection occurs properly on an EJB 3.0 CMT Stateless Session EJB, (remote) Business Interface.
     * <p>
     *
     * This test will confirm the following :
     * <ol>
    ...
    public void testCompIntInjection_AdvCompViewCMTStatelessRemote() throws Exception {
        ...
        // Locate SL Remote Home/Factory and execute the test
        // --------------------------------------------------------------------
        EJBInjectionRemote bean = (EJBInjectionRemote) FATHelper.lookupDefaultBindingEJBJavaApp(EJBInjectionRemoteInterface, Module, AdvCompViewBean);
        assertNotNull("1 ---> SLRSB created successfully.", bean);
