...
/**
 * Tests EJB Container support for the Basic EJB 3.0 Container Managed Stateful Session bean functionality.
 * <p>
 *
 * Sub-tests
 * <ul>
 * <li>testTxAttribs - Business Interface: Verify methods with all ContainerManaged Tx Attributes
 * <li>testBizMethods - Business Interface: Verify getInvokedBusinessInterface and getBusinessObject work correctly
 * </ul>
 */
@WebServlet("/BasicCMTStatefulXMLRemoteServlet")
public class BasicCMTStatefulXMLRemoteServlet extends FATServlet {

    private static final long serialVersionUID = -4851343852770401058L;
    private final static String CLASSNAME = BasicCMTStatefulXMLRemoteServlet.class.getName();
    ...
    /**
     * Test calling methods on an EJB 3.0 CMT Stateful Session EJB, Business Interface, with each of the different Transaction Attributes.
     * <p>
     *
     ...
     */
    @Test
    public void testSFSBTxAttribsXML() throws Exception {
    ...
    public void testSFSBBizMethodsXML() throws Exception {
        // --------------------------------------------------------------------
        // Locate SF Remote Home/Factory and execute the test
        // --------------------------------------------------------------------
        BasicCMTStatefulRemote bean = (BasicCMTStatefulRemote)

        FATHelper.lookupDefaultBindingEJBJavaApp(BasicCMTStatefulRemoteInterface, Module, BasicBean);
        assertNotNull("1 ---> SFLSB created successfully.", bean);
        try {
