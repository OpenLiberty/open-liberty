 ...
 **/
@Stateful(name = "RemoveCompCMTBean")
@Remote(RemoveCMTRemote.class)
@RemoteHome(RemoveCMTEJBRemoteHome.class)
@TransactionManagement(CONTAINER)
public class RemoveCompCMTBean implements SessionBean, SessionSynchronization {

    private static final long serialVersionUID = 49410249073613852L;

    private SessionContext ivContext;

    private String ivString = "RemoveCompCMTBean";
