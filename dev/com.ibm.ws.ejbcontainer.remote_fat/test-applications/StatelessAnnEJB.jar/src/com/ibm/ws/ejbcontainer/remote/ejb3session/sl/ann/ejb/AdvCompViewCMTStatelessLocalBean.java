...
/**
 * Bean implementation class for Enterprise Bean: AdvCMTStatelessLocal
 **/
@Stateless(name = "AdvCompViewCMTStatelessLocal")
@LocalHome(BasicCMTStatelessEJBLocalHome.class)
@TransactionManagement(CONTAINER)
public class AdvCompViewCMTStatelessLocalBean {
    /** New Line character for this system. **/
    public static final String NL = System.getProperty("line.separator", "\n");
    private static final String CLASS_NAME = AdvCompViewCMTStatelessLocalBean.class.getName();
    private final static Logger svLogger = Logger.getLogger(CLASS_NAME);

    @Resource
    private SessionContext ivContext;

    @EJB(name = "ejb/AdvCompCMTStatelessEJBLocal_home", beanInterface = AdvCMTStatelessEJBLocalHome.class, beanName = "AdvCompCMTStatelessLocal",
         mappedName = "BasicCMTStatelessLocalBean", description = "homeInject")
    ...
    public AdvCompViewCMTStatelessLocalBean() {}
}