 ...
 **/
@Stateless
public class TwoIntOnImplStatelessRemoteBean implements BasicCMTStatelessRemote, AnnotatedCMTStatelessRemote {
    /** New Line character for this system. **/
    public static final String NL = System.getProperty("line.separator", "\n");

    // Logger
    private static final String CLASS_NAME = TwoIntOnImplStatelessRemoteBean.class.getName();
    ...
    // Methods from Annotated interface
    @Override
    ...
    public TwoIntOnImplStatelessRemoteBean() {}
}