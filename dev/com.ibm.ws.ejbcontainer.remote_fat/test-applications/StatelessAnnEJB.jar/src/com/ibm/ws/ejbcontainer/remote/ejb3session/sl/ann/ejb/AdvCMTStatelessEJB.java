...
/**
 * EJB (remote) interface for advanced Container Managed Transaction Stateless
 * Session bean.
 **/
public interface AdvCMTStatelessEJB extends EJBObject {
    ...
    public void verifyEJBFieldInjection() throws RemoteException;

    public void verifyEJBMethodInjection() throws RemoteException;

    public void verifyNoEJBFieldInjection() throws RemoteException;

    public void verifyNoEJBMethodInjection() throws RemoteException;
}