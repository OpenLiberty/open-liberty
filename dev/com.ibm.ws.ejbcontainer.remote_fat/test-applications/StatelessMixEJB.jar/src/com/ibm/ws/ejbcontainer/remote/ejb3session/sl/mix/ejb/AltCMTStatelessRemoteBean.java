...
/**
 * Bean implementation class for Enterprise Bean: AltCMTStatelessRemoteBean
 **/
@Remote(AltCMTStatelessRemote.class)
public class AltCMTStatelessRemoteBean {
    private static final String CLASS_NAME = AltCMTStatelessRemoteBean.class.getName();
    ...
    public AltCMTStatelessRemoteBean() {}
}