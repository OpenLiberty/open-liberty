 ...
 * CompNoBizCMTStatelessRemoteBean
 **/
@Stateless(name = "CompNoBizCMTStatelessRemote")
@RemoteHome(CMTStatelessEJBHome.class)
@TransactionManagement(CONTAINER)
public class CompNoBizCMTStatelessRemoteBean {
    private static final String CLASS_NAME = CompNoBizCMTStatelessRemoteBean.class.getName();
    ...
    public CompNoBizCMTStatelessRemoteBean() {}
}