 ...
 * BaseAnnotationOverByXMLTxAttrBean2 This bean is used to verify that the XML
 * used in the Base Bean takes precedence over the SuperBean's annotation
 * demarcation of TX attributes.
 *
 * This bean uses the XML to specifically set the trans-attribute for the
 * method, superAnnotationMethod, to RequiresNew. This method is implemented in
 * the SuperClass only.
 *
 **/
