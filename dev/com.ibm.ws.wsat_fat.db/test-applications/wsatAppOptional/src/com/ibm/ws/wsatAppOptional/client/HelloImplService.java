...
@WebServiceClient(name = "HelloImplService", targetNamespace = "http://server.wsatAppOptional.ws.ibm.com/", wsdlLocation = "file:/C:/Jordan/workspace/WDT/cxfApp2/WebContent/WEB-INF/wsdl/hello.wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOIMPLSERVICE_QNAME = new QName("http://server.wsatAppOptional.ws.ibm.com/", "HelloImplService");
    ...
    public Hello getHelloImplPort() {
        return super.getPort(new QName("http://server.wsatAppOptional.ws.ibm.com/", "HelloImplPort"), Hello.class);
    }
    ...
    public Hello getHelloImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.wsatAppOptional.ws.ibm.com/", "HelloImplPort"), Hello.class, features);
    }
