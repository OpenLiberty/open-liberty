...
public class EncoderRegistry {
    ...
    private void sortEncoders() {
        toolResponseEncoders.sort(Comparator.<ToolResponseEncoder<?>> comparingInt(encoder ->
            encoderPriorities.getOrDefault(encoder, DEFAULT_ENCODER_PRIORITY)).reversed());
        contentEncoders.sort(Comparator.<ContentEncoder<?>> comparingInt(encoder ->
            encoderPriorities.getOrDefault(encoder, DEFAULT_ENCODER_PRIORITY)).reversed());
    }
