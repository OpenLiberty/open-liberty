 ...
 *******************************************************************************/
package signing.complex_1.servlets;
...
@OpenIdAuthenticationMechanismDefinition(providerURI = "${openIdConfig.providerURI}",
                                         ...
                                         providerMetadata = @OpenIdProviderMetadata(idTokenSigningAlgorithmsSupported = "${'RS384'.concat(', RS256')}"))

@DeclareRoles("all")
@ServletSecurity(@HttpConstraint(rolesAllowed = "all"))
public class ComplexSigning1Servlet extends BaseServlet {
