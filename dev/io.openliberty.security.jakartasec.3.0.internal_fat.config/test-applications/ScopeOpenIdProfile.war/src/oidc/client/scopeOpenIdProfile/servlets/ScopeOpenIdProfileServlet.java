 ...
 *******************************************************************************/
package oidc.client.scopeOpenIdProfile.servlets;
...
@WebServlet("/ScopeOpenIdProfileServlet")
@OpenIdAuthenticationMechanismDefinition(providerURI = "${providerBean.providerSecureRoot}/oidc/endpoint/OP1",
                                         ...
                                         scope = { Constants.OPENID_SCOPE, Constants.PROFILE_SCOPE },
...
public class ScopeOpenIdProfileServlet extends BaseServlet {
