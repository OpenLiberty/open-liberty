...
import com.ibm.ws.ejbcontainer.tx.methodintf.web.SerialFilterDisabledServlet;
...
public class SerialFilterDisabledTest {

    @Server("com.ibm.ws.kernel.instrument.serialfilter.fat.SerialFilterDisabled")
    @TestServlets({ @TestServlet(servlet = SerialFilterDisabledServlet.class, contextRoot = "MethodIntfWeb") })
...
//    public static RepeatTests r = RepeatTests.with(FeatureReplacementAction.EE7_FEATURES().forServers("com.ibm.ws.kernel.instrument.serialfilter.fat.MDBServer")).andWith(FeatureReplacementAction.EE8_FEATURES().forServers("com.ibm.ws.kernel.instrument.serialfilter.fat.MDBServer"));
    ...
    @Test
    public void testNoSerialFilterEnabledMessage() throws Exception {
        assertNull("The messages.log file should not contain CWWKS8000I message.", server.waitForStringInLogUsingMark("CWWKS8000I"));
    }
