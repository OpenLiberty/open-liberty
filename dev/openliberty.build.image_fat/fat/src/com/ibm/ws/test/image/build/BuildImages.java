...
public class BuildImages {
    ...
    public static final long INSTALL_FROM_JAR_TIMEOUT_NS = 10 * TimeConstants.NS_IN_SEC;
    ...
    public static enum ImageType {
        ...
        public void installFromJar(String installationPath) throws Exception {
            ...
            useRawImage.installFromJar(installationPath, INSTALL_FROM_JAR_TIMEOUT_NS);
        }
    };
