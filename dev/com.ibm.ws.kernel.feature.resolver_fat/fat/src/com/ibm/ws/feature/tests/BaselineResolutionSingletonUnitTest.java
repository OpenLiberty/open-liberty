...
public class BaselineResolutionSingletonUnitTest extends BaselineResolutionUnitTest {
    /** Control parameter: Used to disable this unit test. */
    public static final boolean IS_ENABLED = BaselineResolutionEnablement.enableSingleton;
    ...
    public static void tearDownClass() throws Exception {
        doTearDownClass(BaselineResolutionSingletonUnitTest.class);
    }
    ...
    public static Collection<Object[]> data() throws Exception {
        ...
        if (!IS_ENABLED) {
            return nullCases("singleton baseline");
        }
    ...
    public BaselineResolutionSingletonUnitTest(String name, VerifyCase testCase) throws Exception {
        super(name, testCase);
    }
    ...
    @Test
    public void baseline_singletonTest() throws Exception {
        if (!IS_ENABLED) {
            nullResult();
            return;
        }
