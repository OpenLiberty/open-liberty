[FEATURE RESOLUTION FAT NOTES][TFB][06-Jun-2024][START]
...
Baseline data is created by running "BaselineResolutionGenerationTest", which starts the server with
...
Baseline data generation is triggered from "BaselineResolutionGenerationTest":

dev/com.ibm.ws.kernel.feature.resolver_fat/fat/src/com/ibm/ws/feature/tests/
  BaselineResolutionGenerationTest.java
...
dev/com.ibm.ws.kernel.feature.resolver_fat/fat/src/com/ibm/ws/feature/tests/
  BaselineResolutionUnitTest.java
  BaselineResolutionServletUnitTest.java
  BaselineResolutionSingletonUnitTest.java

[FEATURE RESOLUTION FAT NOTES][TFB][06-Jun-2024][END]
