...
public class EE9toMP {
    ...
    public void ee9toHealthAndMetricsMaxTest() throws Exception {
        ...
        assertNotNull("Expected mpMetrics-4.0 after features resolved but got: " + server.findStringsInLogs("CWWKF0012I: The server installed the following features:"),
                      server.waitForStringInLog("mpMetrics-4.0"));
