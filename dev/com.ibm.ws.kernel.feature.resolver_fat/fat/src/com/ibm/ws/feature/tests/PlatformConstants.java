...
public class PlatformConstants {
    ...
    public static final String MICROPROFILE_DESCENDING = "MicroProfile-6.1, MicroProfile-6.0, MicroProfile-5.0, MicroProfile-4.1, " +
    ...
    public static final String MICROPROFILE_ASCENDING = "MicroProfile-1.0, MicroProfile-1.2, MicroProfile-1.3, MicroProfile-1.4, " +
