...
public class EE8toMP {
    ...
    public void ee8toHealthAndMetricsMaxTest() throws Exception {
        ...
        assertNotNull("Expected mpMetrics-3.0 after features resolved but got: " + server.findStringsInLogs("CWWKF0012I: The server installed the following features:"),
                      server.waitForStringInLog("mpMetrics-3.0"));
        assertNotNull("Expected mpHealth-3.1 after features resolved but got: " + server.findStringsInLogs("CWWKF0012I: The server installed the following features:"),
                      server.waitForStringInLog("mpHealth-3.1"));
