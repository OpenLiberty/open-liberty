...
public class BaselineResolutionMicroProfileUnitTest extends BaselineResolutionUnitTest {
    /** Control parameter: Used to disable this unit test. */
    public static final boolean IS_ENABLED = BaselineResolutionEnablement.enableMicroProfile;
    ...
    public static Collection<Object[]> data() throws Exception {
        ...
        if (!IS_ENABLED) {
            return nullCases("microProfile baseline");
        }
    ...
    public BaselineResolutionMicroProfileUnitTest(String name, VerifyCase testCase) throws Exception {
        super(name, testCase);
    }
    ...
    @Test
    public void baseline_microProfileTest() throws Exception {
        if (!IS_ENABLED) {
            nullResult();
            return;
        }
