...
public interface PlatformConstants {
    ...
    String MICROPROFILE_DESCENDING = "MicroProfile-7.1, MicroProfile-7.0, MicroProfile-6.1, MicroProfile-6.0, MicroProfile-5.0, MicroProfile-4.1, " +
    ...
    String MICROPROFILE_ASCENDING = "MicroProfile-1.0, MicroProfile-1.2, MicroProfile-1.3, MicroProfile-1.4, " +
                                    ...
                                    "MicroProfile-4.0, MicroProfile-4.1, MicroProfile-5.0, MicroProfile-6.0, MicroProfile-6.1, MicroProfile-7.0, MicroProfile-7.1";
