...
public class VersionlessServletToMicroProfileTest extends VersionlessTestBase {
    ...
    public static final String MIN_ENV_VAR = "MicroProfile-1.2, MicroProfile-2.0, MicroProfile-3.0, MicroProfile-4.0, MicroProfile-5.0, MicroProfile-6.0";

    public static final String MAX_ENV_VAR = "MicroProfile-6.0, MicroProfile-5.0, MicroProfile-4.0, MicroProfile-3.0, MicroProfile-2.0, MicroProfile-1.2";


    @Test
    public void servlet3HealthMaxTest() throws Exception {
        String preferredVersions = MAX_ENV_VAR;
    ...
    public void servlet3HealthMinTest() throws Exception {
        String preferredVersions = MIN_ENV_VAR;
