...
//@LoginConfig(authMethod = "XXXXX", realmName = "YYYYY")  //bt: testing
@Path("/endp")
@DenyAll
@RequestScoped
public class RolesEndpoint {
    ...
    public String echoInput(@Context SecurityContext sec, @QueryParam("input") String input,
        ...
        System.out.println("******** injected JsonWebToken: " + jwtPrincipal);
        System.out.println("*** sc auth method is " + sec.getAuthenticationScheme());
        System.out.println("*** sreq auth method is " + sreq.getAuthType());
    ...
    @RolesAllowed("Tester") //bt: fix per Scott 9/7
