...
public class ClaimValueInjectionTest extends FATServletClient {
    ...
    @Test //@Test(groups = TEST_GROUP_CDI,           description = "Verify that the injected token issuer claim is as expected")
    ...
    @Test //@Test(groups = TEST_GROUP_CDI,           description = "Verify that the injected raw token claim is as expected")
    ...
    @Test //@Test(groups = TEST_GROUP_CDI,          description = "Verify that the injected jti claim is as expected")
    ...
    @Test //@Test(groups = TEST_GROUP_CDI,           description = "Verify that the injected aud claim is as expected")
    ...
    @Test //@Test(groups = TEST_GROUP_CDI,          description = "Verify that the injected iat claim is as expected")
    ...
    @Test //@Test(groups = TEST_GROUP_CDI,           description = "Verify that the injected sub claim is as expected")
    ...
    @Test //@Test(groups = TEST_GROUP_CDI,          description = "Verify that the injected custom claim is missing as expected")
    ...
    @Test //@Test(groups = TEST_GROUP_CDI,          description = "Verify that the injected customString claim is as expected")
    ...
    @Test //@Test(groups = TEST_GROUP_CDI,          description = "Verify that the injected customInteger claim is as expected")
    ...
    @Test //@Test(groups = TEST_GROUP_CDI,          description = "Verify that the injected customDouble claim is as expected")
