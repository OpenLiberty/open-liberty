...
/**
 * <p>Java class for ArrayInstanceType complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="entry" type="{ClassInfo_1.0}ArrayEntryType" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "ArrayInstanceType", propOrder = {
    "entry",
    "properties"
})
public class ArrayInstanceType {

    protected List<ArrayEntryType> entry;
     ...
     * 
     */
    public List<ArrayEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<ArrayEntryType>();
        }
        return this.entry;
    }
