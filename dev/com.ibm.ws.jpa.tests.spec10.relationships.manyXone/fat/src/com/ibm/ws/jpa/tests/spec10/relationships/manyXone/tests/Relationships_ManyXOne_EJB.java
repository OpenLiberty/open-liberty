...
public class Relationships_ManyXOne_EJB extends JPAFATServletClient {
    private final static String CONTEXT_ROOT = "ManyXOne10EJB";
    ...
    private final static String appName = "manyXoneejb";
    ...
    @TestServlets({
                    @TestServlet(servlet = TestManyXOneUnidirectional_EJB_SL_Servlet.class, path = CONTEXT_ROOT + "/" + "TestManyXOneUnidirectional_EJB_SL_Servlet"),
                    @TestServlet(servlet = TestManyXOneUnidirectional_EJB_SF_Servlet.class, path = CONTEXT_ROOT + "/" + "TestManyXOneUnidirectional_EJB_SF_Servlet"),
                    @TestServlet(servlet = TestManyXOneUnidirectional_EJB_SFEX_Servlet.class, path = CONTEXT_ROOT + "/" + "TestManyXOneUnidirectional_EJB_SFEX_Servlet"),
                    @TestServlet(servlet = TestManyXOneBidirectional_EJB_SL_Servlet.class, path = CONTEXT_ROOT + "/" + "TestManyXOneBidirectional_EJB_SL_Servlet"),
                    @TestServlet(servlet = TestManyXOneBidirectional_EJB_SF_Servlet.class, path = CONTEXT_ROOT + "/" + "TestManyXOneBidirectional_EJB_SF_Servlet"),
                    @TestServlet(servlet = TestManyXOneBidirectional_EJB_SFEX_Servlet.class, path = CONTEXT_ROOT + "/" + "TestManyXOneBidirectional_EJB_SFEX_Servlet"),
                    @TestServlet(servlet = TestManyXOneCompoundPK_EJB_SL_Servlet.class, path = CONTEXT_ROOT + "/" + "TestManyXOneCompoundPK_EJB_SL_Servlet"),
                    @TestServlet(servlet = TestManyXOneCompoundPK_EJB_SF_Servlet.class, path = CONTEXT_ROOT + "/" + "TestManyXOneCompoundPK_EJB_SF_Servlet"),
                    @TestServlet(servlet = TestManyXOneCompoundPK_EJB_SFEX_Servlet.class, path = CONTEXT_ROOT + "/" + "TestManyXOneCompoundPK_EJB_SFEX_Servlet")
    })
