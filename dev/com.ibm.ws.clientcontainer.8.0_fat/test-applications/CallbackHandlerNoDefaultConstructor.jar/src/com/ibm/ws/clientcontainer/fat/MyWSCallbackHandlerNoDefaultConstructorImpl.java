...
public class MyWSCallbackHandlerNoDefaultConstructorImpl implements CallbackHandler {
     ...
     */
    public MyWSCallbackHandlerNoDefaultConstructorImpl(String userName, String password) {
     ...
     * @param password The password in clear text.
     */
    public MyWSCallbackHandlerNoDefaultConstructorImpl(String userName, String realmName, String password) {
     ...
     */
    public MyWSCallbackHandlerNoDefaultConstructorImpl(String userName, String realmName, String password, java.util.Map appContext) {
        this.userName = userName;
        this.password = password;
     ...
     */
    public MyWSCallbackHandlerNoDefaultConstructorImpl(byte[] credToken) {
