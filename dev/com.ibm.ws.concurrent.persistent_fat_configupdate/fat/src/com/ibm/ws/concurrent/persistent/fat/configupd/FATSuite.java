...
@RunWith(Suite.class)
@SuiteClasses({ PersistentExecutorConfigUpdateTest.class })
public class FATSuite {
    ...
    public static void beforeSuite() throws Exception {
        ...
        LibertyFileManager.deleteLibertyDirectoryAndContents(machine, installRoot + "/usr/shared/resources/data/persistcfgdb");
    }
}