...
/**
 * Servlet implementation class for TransactionalBeanTest.
 */
@WebServlet("/transactionalbean")
@Mode(TestMode.FULL)
public class TransactionalBeanServlet extends FATServlet {
    ...
    @Mode(TestMode.LITE)
    @ExpectedFFDC(value = { "java.lang.IllegalStateException" })
    public void testNotSupported009a() {
