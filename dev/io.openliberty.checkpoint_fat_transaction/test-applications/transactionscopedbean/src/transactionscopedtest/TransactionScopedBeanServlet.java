...
/**
 * Test servlet for TransactionScopedBeansTest.
 */
@WebServlet("/transactionscopedbean")
public class TransactionScopedBeanServlet extends FATServlet {
    ...
    // Verify that TransactionalScope triggers CDI observers
