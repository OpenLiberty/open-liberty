...
// TODO this is copied from the com.ibm.ws.jca.cm bundle from it is shared between
// connection factories and data sources. Should we move it to a more common location
// to share it with concurrency resources as well?
/**
