...
public class Http2LiteModeTests extends FATServletClient {
    ...
    static final String defaultServletPath = "H2FATDriver/H2FATDriverServlet?hostName=";
    static final String genericServletPath = "H2FATDriver/GenericFrameTests?hostName=";
    static final String continuationServletPath = "H2FATDriver/ContinuationFrameTests?hostName=";
    static final String dataServletPath = "H2FATDriver/DataFrameTests?hostName=";
