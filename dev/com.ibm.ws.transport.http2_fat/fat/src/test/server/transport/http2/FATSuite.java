...
public class FATSuite {
    ...
    @ClassRule
    public static RepeatTests r = RepeatTests.withoutModification().andWith(FeatureReplacementAction.BETA_OPTION()); // Run with no modifications to the server besides enabling Beta and running netty
