...
public class WrongCtorPolicyConfigFactory extends PolicyConfigurationFactory {

    // Must have either a no argument constructor or one that takes a PolicyConfigurationFactory
    public WrongCtorPolicyConfigFactory(int badArgument) {
    }
