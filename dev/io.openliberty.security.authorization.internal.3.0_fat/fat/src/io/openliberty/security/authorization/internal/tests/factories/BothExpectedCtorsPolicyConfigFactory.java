...
public class BothExpectedCtorsPolicyConfigFactory extends PolicyConfigurationFactory {

    public BothExpectedCtorsPolicyConfigFactory() {

    }

    public BothExpectedCtorsPolicyConfigFactory(PolicyConfigurationFactory wrappedFactory) {
