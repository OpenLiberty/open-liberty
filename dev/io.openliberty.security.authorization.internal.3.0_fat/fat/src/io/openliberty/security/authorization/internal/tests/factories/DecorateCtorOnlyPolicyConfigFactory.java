...
public class DecorateCtorOnlyPolicyConfigFactory extends PolicyConfigurationFactory {

    public DecorateCtorOnlyPolicyConfigFactory(PolicyConfigurationFactory wrappedFactory) {
