...
@Component(service = OpenAPIModelWalker.class, configurationPolicy = ConfigurationPolicy.IGNORE)
public class OpenAPI30ModelWalker extends OpenAPIModelWalkerImpl {
