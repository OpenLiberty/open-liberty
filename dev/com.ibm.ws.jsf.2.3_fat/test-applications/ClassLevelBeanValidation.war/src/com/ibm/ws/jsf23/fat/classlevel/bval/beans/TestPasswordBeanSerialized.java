 ...
 * This bean implements Serializable, which will use be used to copy the bean for the class level bean validation feature.
 */
@Named
@RequestScoped
...
public class TestPasswordBeanSerialized implements PasswordHolder, Serializable {
    ...
    public TestPasswordBeanSerialized() {}
