 ...
 *******************************************************************************/
package com.ibm.ws.jsf23.fat.cdi.jar.appconfigpop.faces40;
...
public class ACPJarInitializer extends ApplicationConfigurationPopulator {
    ...
    public void populateApplicationConfiguration(Document document) {
        ...
        sel.appendChild(createNode(document, "system-event-listener-class", "com.ibm.ws.jsf23.fat.cdi.common.managed.CustomSystemEventListener"));
        ...
        nh.setTextContent("com.ibm.ws.jsf23.fat.cdi.common.managed.faces40.CustomNavigationHandler");
        a.appendChild(nh);

        Element rh = document.createElementNS(ns, "resource-handler");
        rh.setTextContent("com.ibm.ws.jsf23.fat.cdi.common.managed.CustomResourceHandler");
        a.appendChild(rh);
