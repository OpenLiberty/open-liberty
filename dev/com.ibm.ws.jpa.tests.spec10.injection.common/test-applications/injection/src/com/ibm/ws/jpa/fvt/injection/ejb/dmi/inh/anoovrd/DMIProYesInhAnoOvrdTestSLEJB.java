...
@Stateless(name = "DMIProYesInhAnoOvrdTestSLEJB")
@Local(DMIProYesInhAnoOvrdTestSLEJBLocal.class)
@TransactionManagement(javax.ejb.TransactionManagementType.BEAN)
public class DMIProYesInhAnoOvrdTestSLEJB extends DMIProYesInhAnoOvrdTestSuperclass {
    ...
    @Override
    @PersistenceUnit(unitName = "OVRD_COMMON_JTA", name = "jpa/DMIProYesInhAnoOvrdTestEJB/ovdemf_amjta_common_ejb")
    ...
    @Override
    @PersistenceUnit(unitName = "OVRD_EJB_JTA", name = "jpa/DMIProYesInhAnoOvrdTestEJB/ovdemf_amjta_ejb_ejb")
    ...
    @Override
    @PersistenceUnit(unitName = "../lib/jpapulib.jar#OVRD_COMMON_JTA", name = "jpa/DMIProYesInhAnoOvrdTestEJB/ovdemf_amjta_common_earlib")
    ...
    @Override
    @PersistenceUnit(unitName = "OVRD_JPALIB_JTA", name = "jpa/DMIProYesInhAnoOvrdTestEJB/ovdemf_amjta_jpalib_earlib")
    ...
    @Override
    @PersistenceUnit(unitName = "OVRD_COMMON_RL", name = "jpa/DMIProYesInhAnoOvrdTestEJB/ovdemf_amrl_common_ejb")
    ...
    @Override
    @PersistenceUnit(unitName = "OVRD_EJB_RL", name = "jpa/DMIProYesInhAnoOvrdTestEJB/ovdemf_amrl_ejb_ejb")
    ...
    @Override
    @PersistenceUnit(unitName = "../lib/jpapulib.jar#OVRD_COMMON_RL", name = "jpa/DMIProYesInhAnoOvrdTestEJB/ovdemf_amrl_common_earlib")
    ...
    @Override
    @PersistenceUnit(unitName = "OVRD_JPALIB_RL", name = "jpa/DMIProYesInhAnoOvrdTestEJB/ovdemf_amrl_jpalib_earlib")
