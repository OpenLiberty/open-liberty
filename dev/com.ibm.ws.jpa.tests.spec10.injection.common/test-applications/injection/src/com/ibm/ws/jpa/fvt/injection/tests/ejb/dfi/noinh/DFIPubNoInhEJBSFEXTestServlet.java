 ...
 *
 */
public class DFIPubNoInhEJBSFEXTestServlet extends EJBTestVehicleServlet {
    ...
    private final static String ejbJNDIName = "ejb/dfi/noinh/DFIPubNoInhSFEXEJB";
     ...
     */
    @Test
    public void jpa10_Injection_DFI_NoInheritance_testCommonPUName_PUB_NOOVRD_EJB_SF_CMEX() throws Exception {
        final String testName = "jpa10_Injection_DFI_NoInheritance_testCommonPUName_PUB_NOOVRD_EJB_SF_CMEX";
    ...
    @Test
    public void jpa10_Injection_DFI_NoInheritance_testCommonPUNameSpecifiedPersistencePathLibJar_PUB_NOOVRD_EJB_SF_CMEX() throws Exception {
        final String testName = "jpa10_Injection_DFI_NoInheritance_testCommonPUNameSpecifiedPersistencePathLibJar_PUB_NOOVRD_EJB_SF_CMEX";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DFI_NoInheritance_testUniquePUNameAppModule_PUB_NOOVRD_EJB_SF_CMEX() throws Exception {
        final String testName = "jpa10_Injection_DFI_NoInheritance_testUniquePUNameAppModule_PUB_NOOVRD_EJB_SF_CMEX";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DFI_NoInheritance_testUniquePUNameLibJar_PUB_NOOVRD_EJB_SF_CMEX() throws Exception {
        final String testName = "jpa10_Injection_DFI_NoInheritance_testUniquePUNameLibJar_PUB_NOOVRD_EJB_SF_CMEX";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DFI_NoInheritance_testCommonPUName_PUB_OVRD_EJB_SF_CMEX() throws Exception {
        final String testName = "jpa10_Injection_DFI_NoInheritance_testCommonPUName_PUB_OVRD_EJB_SF_CMEX";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DFI_NoInheritance_testCommonPUNameSpecifiedPersistencePathLibJar_PUB_OVRD_EJB_SF_CMEX() throws Exception {
        final String testName = "jpa10_Injection_DFI_NoInheritance_testCommonPUNameSpecifiedPersistencePathLibJar_PUB_OVRD_EJB_SF_CMEX";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DFI_NoInheritance_testUniquePUNameAppModule_PUB_OVRD_EJB_SF_CMEX() throws Exception {
        final String testName = "jpa10_Injection_DFI_NoInheritance_testUniquePUNameAppModule_PUB_OVRD_EJB_SF_CMEX";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DFI_NoInheritance_testUniquePUNameLibJar_PUB_OVRD_EJB_SF_CMEX() throws Exception {
        final String testName = "jpa10_Injection_DFI_NoInheritance_testUniquePUNameLibJar_PUB_OVRD_EJB_SF_CMEX";
        final String testMethod = "testInjectionTarget";
