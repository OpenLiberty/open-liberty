...
import com.ibm.ws.jpa.fvt.injection.ejb.dmi.inh.DMIInhCommonEJBSuperclass;
 ...
 *
 */
public abstract class DMIProYesInhAnoOvrdTestSuperclass extends DMIInhCommonEJBSuperclass {
    ...
    protected void setEm_cmts_common_ejb(EntityManager emCmtsCommonWebapp) {
    ...
    protected void setEm_cmts_ejb_ejb(EntityManager emCmtsWebappWebapp) {
    ...
    protected void setEmf_amjta_common_ejb(EntityManagerFactory emfAmjtaCommonWebapp) {
    ...
    protected void setEmf_amjta_ejb_ejb(EntityManagerFactory emfAmjtaWebappWebapp) {
    ...
    protected void setEmf_amrl_common_ejb(EntityManagerFactory emfAmrlCommonWebapp) {
    ...
    protected void setEmf_amrl_ejb_ejb(EntityManagerFactory emfAmrlWebappWebapp) {
    ...
    @PersistenceContext(unitName = "COMMON_JTA", type = PersistenceContextType.TRANSACTION,
                        name = "jpa/DMIProYesInhAnoOvrdTestEJB/ovdem_cmts_common_ejb")
    protected void setOvdem_cmts_common_ejb(EntityManager ovdemCmtsCommonWebapp) {
    ...
    @PersistenceContext(unitName = "EJB_JTA", type = PersistenceContextType.TRANSACTION,
                        name = "jpa/DMIProYesInhAnoOvrdTestEJB/ovdem_cmts_ejb_ejb")
    protected void setOvdem_cmts_ejb_ejb(EntityManager ovdemCmtsWebappWebapp) {
    ...
    @PersistenceContext(unitName = "../lib/jpapulib.jar#COMMON_JTA", type = PersistenceContextType.TRANSACTION,
                        name = "jpa/DMIProYesInhAnoOvrdTestEJB/ovdem_cmts_common_earlib")
    ...
    @PersistenceContext(unitName = "JPALIB_JTA", type = PersistenceContextType.TRANSACTION,
                        name = "jpa/DMIProYesInhAnoOvrdTestEJB/ovdem_cmts_jpalib_earlib")
    ...
    @PersistenceUnit(unitName = "COMMON_JTA", name = "jpa/DMIProYesInhAnoOvrdTestEJB/ovdemf_amjta_common_ejb")
    protected void setOvdemf_amjta_common_ejb(EntityManagerFactory ovdemfAmjtaCommonWebapp) {
    ...
    @PersistenceUnit(unitName = "EJB_JTA", name = "jpa/DMIProYesInhAnoOvrdTestEJB/ovdemf_amjta_ejb_ejb")
    protected void setOvdemf_amjta_ejb_ejb(
    ...
    @PersistenceUnit(unitName = "../lib/jpapulib.jar#COMMON_JTA", name = "jpa/DMIProYesInhAnoOvrdTestEJB/ovdemf_amjta_common_earlib")
    ...
    @PersistenceUnit(unitName = "JPALIB_JTA", name = "jpa/DMIProYesInhAnoOvrdTestEJB/ovdemf_amjta_jpalib_earlib")
    ...
    @PersistenceUnit(unitName = "COMMON_RL", name = "jpa/DMIProYesInhAnoOvrdTestEJB/ovdemf_amrl_common_ejb")
    protected void setOvdemf_amrl_common_ejb(
    ...
    @PersistenceUnit(unitName = "EJB_RL", name = "jpa/DMIProYesInhAnoOvrdTestEJB/ovdemf_amrl_ejb_ejb")
    protected void setOvdemf_amrl_ejb_ejb(
    ...
    @PersistenceUnit(unitName = "../lib/jpapulib.jar#COMMON_RL", name = "jpa/DMIProYesInhAnoOvrdTestEJB/ovdemf_amrl_common_earlib")
    ...
    @PersistenceUnit(unitName = "JPALIB_RL", name = "jpa/DMIProYesInhAnoOvrdTestEJB/ovdemf_amrl_jpalib_earlib")
