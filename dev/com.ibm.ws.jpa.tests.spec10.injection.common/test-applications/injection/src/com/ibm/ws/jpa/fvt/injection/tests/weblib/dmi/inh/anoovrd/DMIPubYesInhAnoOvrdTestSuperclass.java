 ...
 *
 */
public abstract class DMIPubYesInhAnoOvrdTestSuperclass extends DMIInhCommonServletSuperclass {
    private static final long serialVersionUID = -4087559889927261871L;
    ...
    @PersistenceUnit(unitName = "COMMON_JTA", name = "jpa/DMIPubYesInhAnoOvrdTestServlet/ovdemf_amjta_common_webapp")
    ...
    @PersistenceUnit(unitName = "WEBAPP_JTA", name = "jpa/DMIPubYesInhAnoOvrdTestServlet/ovdemf_amjta_webapp_webapp")
    ...
    @PersistenceUnit(unitName = "../lib/jpapulib.jar#COMMON_JTA", name = "jpa/DMIPubYesInhAnoOvrdTestServlet/ovdemf_amjta_common_earlib")
    ...
    @PersistenceUnit(unitName = "JPALIB_JTA", name = "jpa/DMIPubYesInhAnoOvrdTestServlet/ovdemf_amjta_jpalib_earlib")
    ...
    @PersistenceUnit(unitName = "COMMON_RL", name = "jpa/DMIPubYesInhAnoOvrdTestServlet/ovdemf_amrl_common_webapp")
    ...
    @PersistenceUnit(unitName = "WEBAPP_RL", name = "jpa/DMIPubYesInhAnoOvrdTestServlet/ovdemf_amrl_webapp_webapp")
    ...
    @PersistenceUnit(unitName = "../lib/jpapulib.jar#COMMON_RL", name = "jpa/DMIPubYesInhAnoOvrdTestServlet/ovdemf_amrl_common_earlib")
    ...
    @PersistenceUnit(unitName = "JPALIB_RL", name = "jpa/DMIPubYesInhAnoOvrdTestServlet/ovdemf_amrl_jpalib_earlib")
