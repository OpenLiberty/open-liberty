...
package com.ibm.ws.jpa.fvt.injection.tests.weblib.dmi.inh.anoovrd;
 ...
 *
 */
public class DMIPubYesInhAnoOvrdTestServlet extends DMIPubYesInhAnoOvrdTestSuperclass {
    private static final long serialVersionUID = -2354033323164349696L;
    ...
    @PersistenceContext(unitName = "OVRD_COMMON_JTA", type = PersistenceContextType.TRANSACTION,
                        name = "jpa/DMIPubYesInhAnoOvrdTestServlet/ovdem_cmts_common_webapp")
    ...
    @PersistenceContext(unitName = "OVRD_WEBAPP_JTA", type = PersistenceContextType.TRANSACTION,
                        name = "jpa/DMIPubYesInhAnoOvrdTestServlet/ovdem_cmts_webapp_webapp")
    ...
    @PersistenceContext(unitName = "../lib/jpapulib.jar#OVRD_COMMON_JTA", type = PersistenceContextType.TRANSACTION,
                        name = "jpa/DMIPubYesInhAnoOvrdTestServlet/ovdem_cmts_common_earlib")
    ...
    @PersistenceContext(unitName = "OVRD_JPALIB_JTA", type = PersistenceContextType.TRANSACTION,
                        name = "jpa/DMIPubYesInhAnoOvrdTestServlet/ovdem_cmts_jpalib_earlib")
    ...
    @Override
    @PersistenceUnit(unitName = "OVRD_COMMON_JTA", name = "jpa/DMIPubYesInhAnoOvrdTestServlet/ovdemf_amjta_common_webapp")
    ...
    @Override
    @PersistenceUnit(unitName = "OVRD_WEBAPP_JTA", name = "jpa/DMIPubYesInhAnoOvrdTestServlet/ovdemf_amjta_webapp_webapp")
    ...
    @Override
    @PersistenceUnit(unitName = "../lib/jpapulib.jar#OVRD_COMMON_JTA", name = "jpa/DMIPubYesInhAnoOvrdTestServlet/ovdemf_amjta_common_earlib")
    ...
    @Override
    @PersistenceUnit(unitName = "OVRD_JPALIB_JTA", name = "jpa/DMIPubYesInhAnoOvrdTestServlet/ovdemf_amjta_jpalib_earlib")
    ...
    @Override
    @PersistenceUnit(unitName = "OVRD_COMMON_RL", name = "jpa/DMIPubYesInhAnoOvrdTestServlet/ovdemf_amrl_common_webapp")
    ...
    @Override
    @PersistenceUnit(unitName = "OVRD_WEBAPP_RL", name = "jpa/DMIPubYesInhAnoOvrdTestServlet/ovdemf_amrl_webapp_webapp")
    ...
    @Override
    @PersistenceUnit(unitName = "../lib/jpapulib.jar#OVRD_COMMON_RL", name = "jpa/DMIPubYesInhAnoOvrdTestServlet/ovdemf_amrl_common_earlib")
    ...
    @Override
    @PersistenceUnit(unitName = "OVRD_JPALIB_RL", name = "jpa/DMIPubYesInhAnoOvrdTestServlet/ovdemf_amrl_jpalib_earlib")
     ...
     */
    @Test
    public void jpa10_Injection_DMI_YesInheritance_testCommonPUName_PUB_NOOVRD_WebLib_AMJTA() throws Exception {
        final String testName = "jpa10_Injection_DMI_YesInheritance_testCommonPUName_PUB_NOOVRD_WebLib_AMJTA";
    ...
    @Test
    public void jpa10_Injection_DMI_YesInheritance_testCommonPUName_PUB_NOOVRD_WebLib_AMRL() throws Exception {
        final String testName = "jpa10_Injection_DMI_YesInheritance_testCommonPUName_PUB_NOOVRD_WebLib_AMRL";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DMI_YesInheritance_testCommonPUName_PUB_NOOVRD_WebLib_CMTS() throws Exception {
        final String testName = "jpa10_Injection_DMI_YesInheritance_testCommonPUName_PUB_NOOVRD_WebLib_CMTS";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DMI_YesInheritance_testCommonPUNameSpecifiedPersistencePathLibJar_PUB_NOOVRD_WebLib_AMJTA() throws Exception {
        final String testName = "jpa10_Injection_DMI_YesInheritance_testCommonPUNameSpecifiedPersistencePathLibJar_PUB_NOOVRD_WebLib_AMJTA";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DMI_YesInheritance_testCommonPUNameSpecifiedPersistencePathLibJar_PUB_NOOVRD_WebLib_AMRL() throws Exception {
        final String testName = "jpa10_Injection_DMI_YesInheritance_testCommonPUNameSpecifiedPersistencePathLibJar_PUB_NOOVRD_WebLib_AMRL";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DMI_YesInheritance_testCommonPUNameSpecifiedPersistencePathLibJar_PUB_NOOVRD_WebLib_CMTS() throws Exception {
        final String testName = "jpa10_Injection_DMI_YesInheritance_testCommonPUNameSpecifiedPersistencePathLibJar_PUB_NOOVRD_WebLib_CMTS";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DMI_YesInheritance_testUniquePUNameAppModule_PUB_NOOVRD_WebLib_AMJTA() throws Exception {
        final String testName = "jpa10_Injection_DMI_YesInheritance_testUniquePUNameAppModule_PUB_NOOVRD_WebLib_AMJTA";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DMI_YesInheritance_testUniquePUNameAppModule_PUB_NOOVRD_WebLib_AMRL() throws Exception {
        final String testName = "jpa10_Injection_DMI_YesInheritance_testUniquePUNameAppModule_PUB_NOOVRD_WebLib_AMRL";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DMI_YesInheritance_testUniquePUNameAppModule_PUB_NOOVRD_WebLib_CMTS() throws Exception {
        final String testName = "jpa10_Injection_DMI_YesInheritance_testUniquePUNameAppModule_PUB_NOOVRD_WebLib_CMTS";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DMI_YesInheritance_testUniquePUNameLibJar_PUB_NOOVRD_WebLib_AMJTA() throws Exception {
        final String testName = "jpa10_Injection_DMI_YesInheritance_testUniquePUNameLibJar_PUB_NOOVRD_WebLib_AMJTA";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DMI_YesInheritance_testUniquePUNameLibJar_PUB_NOOVRD_WebLib_AMRL() throws Exception {
        final String testName = "jpa10_Injection_DMI_YesInheritance_testUniquePUNameLibJar_PUB_NOOVRD_WebLib_AMRL";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DMI_YesInheritance_testUniquePUNameLibJar_PUB_NOOVRD_WebLib_CMTS() throws Exception {
        final String testName = "jpa10_Injection_DMI_YesInheritance_testUniquePUNameLibJar_PUB_NOOVRD_WebLib_CMTS";
        final String testMethod = "testInjectionTarget";
