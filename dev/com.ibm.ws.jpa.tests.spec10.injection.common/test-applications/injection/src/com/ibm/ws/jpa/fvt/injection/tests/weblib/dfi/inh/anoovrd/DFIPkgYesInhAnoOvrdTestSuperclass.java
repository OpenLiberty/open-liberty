 ...
 *
 */
public abstract class DFIPkgYesInhAnoOvrdTestSuperclass extends JPATestServlet {
    private static final long serialVersionUID = -5112398751016717597L;
    ...
    @Test
    public void jpa10_Injection_DFI_YesInheritance_testCommonPUName_PKG_NOOVRD_WebLib_AMJTA() throws Exception {
        final String testName = "jpa10_Injection_DFI_YesInheritance_testCommonPUName_PKG_NOOVRD_WebLib_AMJTA";
    ...
    @Test
    public void jpa10_Injection_DFI_YesInheritance_testCommonPUName_PKG_NOOVRD_WebLib_AMRL() throws Exception {
        final String testName = "jpa10_Injection_DFI_YesInheritance_testCommonPUName_PKG_NOOVRD_WebLib_AMRL";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DFI_YesInheritance_testCommonPUName_PKG_NOOVRD_WebLib_CMTS() throws Exception {
        final String testName = "jpa10_Injection_DFI_YesInheritance_testCommonPUName_PKG_NOOVRD_WebLib_CMTS";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DFI_YesInheritance_testCommonPUNameSpecifiedPersistencePathLibJar_PKG_NOOVRD_WebLib_AMJTA() throws Exception {
        final String testName = "jpa10_Injection_DFI_YesInheritance_testCommonPUNameSpecifiedPersistencePathLibJar_PKG_NOOVRD_WebLib_AMJTA";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DFI_YesInheritance_testCommonPUNameSpecifiedPersistencePathLibJar_PKG_NOOVRD_WebLib_AMRL() throws Exception {
        final String testName = "jpa10_Injection_DFI_YesInheritance_testCommonPUNameSpecifiedPersistencePathLibJar_PKG_NOOVRD_WebLib_AMRL";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DFI_YesInheritance_testCommonPUNameSpecifiedPersistencePathLibJar_PKG_NOOVRD_WebLib_CMTS() throws Exception {
        final String testName = "jpa10_Injection_DFI_YesInheritance_testCommonPUNameSpecifiedPersistencePathLibJar_PKG_NOOVRD_WebLib_CMTS";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DFI_YesInheritance_testUniquePUNameAppModule_PKG_NOOVRD_WebLib_AMJTA() throws Exception {
        final String testName = "jpa10_Injection_DFI_YesInheritance_testUniquePUNameAppModule_PKG_NOOVRD_WebLib_AMJTA";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DFI_YesInheritance_testUniquePUNameAppModule_PKG_NOOVRD_WebLib_AMRL() throws Exception {
        final String testName = "jpa10_Injection_DFI_YesInheritance_testUniquePUNameAppModule_PKG_NOOVRD_WebLib_AMRL";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DFI_YesInheritance_testUniquePUNameAppModule_PKG_NOOVRD_WebLib_CMTS() throws Exception {
        final String testName = "jpa10_Injection_DFI_YesInheritance_testUniquePUNameAppModule_PKG_NOOVRD_WebLib_CMTS";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DFI_YesInheritance_testUniquePUNameLibJar_PKG_NOOVRD_WebLib_AMJTA() throws Exception {
        final String testName = "jpa10_Injection_DFI_YesInheritance_testUniquePUNameLibJar_PKG_NOOVRD_WebLib_AMJTA";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DFI_YesInheritance_testUniquePUNameLibJar_PKG_NOOVRD_WebLib_AMRL() throws Exception {
        final String testName = "jpa10_Injection_DFI_YesInheritance_testUniquePUNameLibJar_PKG_NOOVRD_WebLib_AMRL";
        final String testMethod = "testInjectionTarget";
    ...
    @Test
    public void jpa10_Injection_DFI_YesInheritance_testUniquePUNameLibJar_PKG_NOOVRD_WebLib_CMTS() throws Exception {
        final String testName = "jpa10_Injection_DFI_YesInheritance_testUniquePUNameLibJar_PKG_NOOVRD_WebLib_CMTS";
        final String testMethod = "testInjectionTarget";
