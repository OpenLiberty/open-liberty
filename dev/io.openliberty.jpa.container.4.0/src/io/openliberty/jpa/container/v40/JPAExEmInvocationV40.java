...
public class JPAExEmInvocationV40 extends JPAExEmInvocation {
    public JPAExEmInvocationV40(UOWCoordinator uowCoord, EntityManager em, boolean txIsUnsynchronized) {
    ...
    public <T> EntityGraph<T> getEntityGraph(Class<T> entityClass, String graphName) {
        return ivEm.getEntityGraph(entityClass, graphName);
    }
