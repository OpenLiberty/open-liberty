...
CREATE TABLE ${schemaname}.OOBiCardEntA (id INTEGER NOT NULL, name VARCHAR(255), B_ID INTEGER, PRIMARY KEY (id), UNIQUE(B_ID));
...
CREATE TABLE ${schemaname}.OOCardEntA (id INTEGER NOT NULL, name VARCHAR(255), B_ID INTEGER, PRIMARY KEY (id), UNIQUE(B_ID));
...
CREATE TABLE ${schemaname}.XMLOOBiCardEntA (id INTEGER NOT NULL, name VARCHAR(255), B_ID INTEGER, PRIMARY KEY (id), UNIQUE(B_ID));
...
CREATE TABLE ${schemaname}.XMLOOCardEntA (id INTEGER NOT NULL, name VARCHAR(255), B_ID INTEGER, PRIMARY KEY (id), UNIQUE(B_ID));
