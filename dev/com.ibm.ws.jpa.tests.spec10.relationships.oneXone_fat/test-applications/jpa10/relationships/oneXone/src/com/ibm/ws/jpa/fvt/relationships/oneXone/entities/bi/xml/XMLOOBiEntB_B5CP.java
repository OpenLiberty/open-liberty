 ...
 *
 */
public class XMLOOBiEntB_B5CP extends XMLAbstractOneXOneBiEntityB {
    private XMLOOBiEntA entityA;

    public XMLOOBiEntB_B5CP() {
        super();
    }

    public XMLOOBiEntB_B5CP(int id, String name) {
        super(id, name);
    }
    ...
    public String toString() {
        return "XMLOOBiEntB_B5CP [getId()=" + getId() + ", getName()=" + getName() + "]";
    }
}