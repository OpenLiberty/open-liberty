        ...
        mockery.checking(new Expectations() {
            {
                ...
                one(writer).print("CWOAU0073E: An error was encountered while authenticating a user. Please try closing the web browser and authenticating again, or contact the site administrator if the problem persists.");
                one(writer).close();
            }
        });
    }
