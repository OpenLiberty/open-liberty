...
public class OAuth20AccessTokenBearerImpl extends OAuth20AccessToken {
    ...
    private static final String TOKEN_TYPE = OAuth20Constants.SUBTYPE_BEARER;
    ...
    public OAuth20AccessTokenBearerImpl(String id, String componentId,
        ...
        super(id, componentId, TOKEN_TYPE, stateId, lifetimeSeconds,
                IS_PERSISTENT, extensionProperties, grantType);
        init(clientId, username, redirectUri, scope);
    }

    private void init(String clientId, String username, String redirectUri,
            String[] scope) {
        _clientId = clientId;
        _username = username;
