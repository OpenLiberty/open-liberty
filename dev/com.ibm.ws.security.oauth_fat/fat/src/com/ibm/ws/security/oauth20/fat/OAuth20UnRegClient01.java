...
public class OAuth20UnRegClient01 extends OAuth20TestCommon {

    private static final Class<?> thisClass = OAuth20UnRegClient01.class;
    ...
    public void testOAuthUnRegAuthCode() throws Exception {

        final String thisMethod = "testOAuthUnRegAuthCode";
        try {
