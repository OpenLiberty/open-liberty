...
public class OAuth20CustomStoreClient02 extends OAuth20Client02Common {

    private static final Class<?> thisClass = OAuth20CustomStoreClient02.class;
    ...
    public void setupBeforeTest() throws Exception {
        commonSetup(MONGO_STORE_FEATURE_SERVER2);
