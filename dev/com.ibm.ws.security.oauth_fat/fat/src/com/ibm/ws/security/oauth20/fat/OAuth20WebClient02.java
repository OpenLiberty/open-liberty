...
public class OAuth20WebClient02 extends OAuth20TestCommon {

    private static final Class<?> thisClass = OAuth20WebClient02.class;
    ...
    @Test
    public void testOAuthAuthApprovalForm() throws Exception {

        final String thisMethod = "testOAuthAuthApprovalForm";
        try {
            ...
            assertTrue("Did not receive approval form", respReceived.contains(approvalForm));
