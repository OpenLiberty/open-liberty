...
public class OAuth20WebClient01 extends OAuth20TestCommon {

    private static final Class<?> thisClass = OAuth20WebClient01.class;
    ...
    @Test
    public void testOAuthAuthCodeFlow() throws Exception {
        final String thisMethod = "testOAuthAuthCodeFlow";

        Log.info(thisClass, thisMethod, "getExceptionsThrownOnErrorStatus: " + HttpUnitOptions.getExceptionsThrownOnErrorStatus()); // TODO REMOVE
        Log.info(thisClass, thisMethod, "getExceptionsThrownOnScriptError: " + HttpUnitOptions.getExceptionsThrownOnScriptError()); // TODO REMOVE
