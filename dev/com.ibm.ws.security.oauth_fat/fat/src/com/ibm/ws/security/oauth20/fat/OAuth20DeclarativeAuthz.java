...
public class OAuth20DeclarativeAuthz extends OAuth20TestCommon {

    private static final Class<?> thisClass = OAuth20DeclarativeAuthz.class;
    ...
    @Test
    public void testOAuthDeclarativeAuthz() throws Exception {

        final String thisMethod = "testOAuthDeclarativeAuthz";
        try {
            ...
            authorizeEndpt = httpsStart + "/oauth2/declarativeEndpoint/OAuthConfigSample/authorize";
            ...
            // Verify that we did not get the custom login form
            assertFalse("Did not receive standard OAuth login form",
