...
define({
      ...
      ERROR_CANNOT_HAVE_MULTIPLE_SEARCHBY : "搜尋準則不能有多個依 {0} 參數來過濾的過濾器。", // {0} will be another translated message key like SUBMITTER and BATCH_JOB_NAME
      ...
      LOADING_VIEW_TITLE : "正在載入視圖",
      LOADING_GRID : "等待從伺服器傳回搜尋結果",
      PAGENUMBER : "頁碼",
      SELECT_QUERY_SIZE: "選取查詢大小",
      LINK_EXPLORE_HOST: "選取以在「探索」工具中檢視主機 {0} 的詳細資料。",      // Host name
      LINK_EXPLORE_SERVER: "選取以在「探索」工具中檢視伺服器 {0} 的詳細資料。",  // Server name
      ...
      RESTART_INSTANCE_MESSAGE: "您要重新啟動與工作實例 {0} 相關聯的最近一次工作執行嗎？",     // Job Instance ID number
      STOP_INSTANCE_MESSAGE: "您要停止與工作實例 {0} 相關聯的最近一次工作執行嗎？",           // Job Instance ID number
      PURGE_INSTANCE_MESSAGE: "您要清除與工作實例 {0} 相關聯的所有資料庫項目和工作日誌嗎？",     // Job Instance ID number
      ...
      PARMS_ENTRY_ERROR: "參數名稱是必要項。",
      JOB_PARAMETER_CREATE: "選取 {0} 來新增參數，供下次執行這個工作實例時使用。",  // 0 - Button label
      JOB_PARAMETER_CREATE_BUTTON: "表格標頭中的新增參數按鈕。",

      //JOB LOGS PAGE MESSAGES
      JOBLOGS_LOG_CONTENT : "工作日誌內容",
      FILE_DOWNLOAD : "檔案下載",
      DOWNLOAD_DIALOG_DESCRIPTION : "您要下載日誌檔嗎？",
      INCLUDE_ALL_LOGS : "包含工作執行的所有日誌檔",
      ...
      IGNORED_SEARCH_CRITERIA : "結果中已忽略下列的過濾準則：{0}",

      GRIDX_SUMMARY_TEXT : "顯示最新的 ${0} 個工作實例"
