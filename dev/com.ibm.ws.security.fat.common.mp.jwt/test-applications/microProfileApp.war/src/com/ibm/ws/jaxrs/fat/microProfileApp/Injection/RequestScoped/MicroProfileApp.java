...
package com.ibm.ws.jaxrs.fat.microProfileApp.Injection.RequestScoped;
...
// http://localhost:<nonSecurePort>/microProfileApp/rest/InjectionRequestScoped/MicroProfileApp
// allow the same methods to invoke GET, POST, PUT, ... invocation type determines which is invoked.

@Path("InjectionRequestScoped")
@RequestScoped
