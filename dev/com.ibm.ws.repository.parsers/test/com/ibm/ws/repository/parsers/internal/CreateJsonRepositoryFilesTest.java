...
public class CreateJsonRepositoryFilesTest {
    ...
    public void testJsonWithSpecifiedMetadata() throws IOException {
        ...
        File assetFile = new File(baseDir, "test-resources/esa/esaAssetOnly/" + name);
        File metadataFile = new File(baseDir, "test-resources/esa/esaMetadataOnly/" + name + ".metadata.zip");
        ...
        createdFile = new File(baseDir, "/build/json/" + name + ".json");
        File referenceFile = new File(baseDir, "/test-resources/reference/" + name + ".json");
    ...
    private void testSomeJson(String name, String srcDir, String assetType) throws IOException {
        ...
        File assetFile = new File(baseDir, "/test-resources/" + srcDir + "/" + name);
