...
@Mode(TestMode.LITE)
public class SingleFeatureDefaultPrincipalMappingTest extends FATServletClient {

    private final Class<SingleFeatureDefaultPrincipalMappingTest> thisClass = SingleFeatureDefaultPrincipalMappingTest.class;
    ...
    public static void setUp() throws Exception {
        server = LibertyServerFactory.getLibertyServer("com.ibm.ws.security.auth.data.fat.dpm.single");
