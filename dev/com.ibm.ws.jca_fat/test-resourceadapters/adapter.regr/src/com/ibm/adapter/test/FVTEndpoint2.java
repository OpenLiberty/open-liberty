...
public class FVTEndpoint2 implements MessageListener, MessageEndpoint {
    ...
    public void onMessage(Message message) {
        try {
            System.out.println("--onMessage: Hey, I am endpoint 2. I got the message :" + ((TextMessage) message).getText());
        } catch (Exception e) {
        }
    }

    public void messageMethod1(String message) {
        System.out.println("--messageMethod1: Hey, I am endpoint 2. I got the message :" + message);
    }

    public void messageMethod2(String message) {
        System.out.println("--messageMethod2: Hey, I am endpoint 2. I got the message :" + message);
    }
    ...
    public void beforeDelivery(Method method) throws NoSuchMethodException, ResourceException {
        System.out.println("--endpoint 2: beforeDelivery");
    }
    ...
    public void afterDelivery() throws ResourceException {
        System.out.println("--endpoint 2: afterDelivery");
    }
    ...
    @Override
    public void release() {
        System.out.println("--endpoint 2: release");
    }
