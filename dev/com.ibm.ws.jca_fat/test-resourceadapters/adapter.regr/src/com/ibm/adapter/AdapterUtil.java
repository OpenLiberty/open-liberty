...
import com.ibm.adapter.jdbc.JdbcObject;
...
public class AdapterUtil {
    ...
    /*
     * 06/02/04: static String xaRecoveryAliasOutbound = null;
     *
    ...
    /**
     * Map a SQLException. And, if it's a connection error, send a
     * CONNECTION_ERROR_OCCURRED ConnectionEvent to all listeners of the Managed
     * Connection.
     *
     * @param jdbcWrapper
     *            the WebSphere JDBC wrapper object throwing the exception.
     * @param sqlX
     *            the SQLException to map.
     *
     * @return A mapped SQLException subclass, if the SQLException maps.
     *         Otherwise, the original exception.
     */
    public static SQLException mapException(JdbcObject jdbcWrapper,
                                            SQLException sqlX) {
        return sqlX;
    }
    ...
    // Added begin - LI2110.97 - 06/08/2004
    /**
    ...
    // Added end - LI2110.97 - 06/08/2004

    // Added begins - LI2110.01 - 01/03/2005
    /**
     * Set the condition for testcase
     *
     *
    ...
    // Added ends - LI2110.01 - 01/03/2005
