...
public class ConnectionBase implements javax.resource.cci.Connection {
    ...
    // @SuppressWarnings("unused")
    private final boolean bSignalError = false;

    private ManagedConnectionBase mc = null;

    private static final TraceComponent tc = Tr.register(ConnectionBase.class,
                                                         SimpleRAImpl.RAS_GROUP, null);
    ...
    public ConnectionBase(ManagedConnectionBase mc,
                          ConnectionRequestInfoBase cxReq) {
        this.mc = mc;
    ...
    /**
     * @see com.ibm.tra.outbound.base.Connection#createInteraction() Creates a
     *      fake interaction with a EIS resource.
     */
    @Override
    ...
    /**
     * @see com.ibm.tra.outbound.base.Connection#getLocalTransaction() Creating
     *      a local transaction and returning it for the user to use. Note that
     *      at this point this is a fake local transaction and really isn't
     *      going to be used to demarcate anything.
     */
    @Override
    ...
    /**
     * @see com.ibm.tra.outbound.base.Connection#getMetaData() Gets the meta
     *      data object CCIConnectionMetaData
     */
    @Override
    ...
    /**
     * @see com.ibm.tra.outbound.base.Connection#getResultSetInfo() Gets the
     *      details of various result set supported features. These are all
     *      definied in our CCIResultSetInfo object
     */
    @Override
