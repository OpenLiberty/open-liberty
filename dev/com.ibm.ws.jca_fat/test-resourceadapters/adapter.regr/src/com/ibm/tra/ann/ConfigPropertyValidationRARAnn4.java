...
public class ConfigPropertyValidationRARAnn4 implements ResourceAdapter, Serializable {

    static final String className = ConfigPropertyValidationRARAnn4.class.getName();
