...
@Connector(
           authMechanisms = // CONN_2_AUTHMECH
           @AuthenticationMechanism(
                                    description = "CONN_2_AUTHMECH_1_DESC",
                                    authMechanism = "BasicPassword",
                                    credentialInterface = AuthenticationMechanism.CredentialInterface.PasswordCredential),

           description = "CONN_2_DESC",

           displayName = "TRA_jca16_ann_ConnectorMergeAction_SingleElement",

           eisType = "CONN_2_EISTYPE",

           licenseDescription = "CONN_2_LICDESC",
           licenseRequired = false, // CONN_2_LICREQ

           securityPermissions = // CONN_2_SECPERM
           @SecurityPermission(
                               description = "CONN_2_SECPERM_1_DESC",
                               permissionSpec = "grant { permission java.util.PropertyPermission \"*\", \"read, write\"; };"),

           smallIcon = "CONN_2_SMALLICON",
           largeIcon = "CONN_2_LARGEICON",

           reauthenticationSupport = true, // CONN_2_REAUTHSUPPORT

           requiredWorkContexts = TransactionContext.class, // CONN_2_REQWRKCTX

           transactionSupport = TransactionSupport.TransactionSupportLevel.XATransaction,
// CONN_2_TXSUPPORT

           vendorName = "CONN_2_VENDORNAME",

           version = "CONN_2_VERSION")
public class ConnectorAnn2 implements ResourceAdapter, Serializable {

    static final String className = ConnectorAnn2.class.getName();
