...
public class ConfigPropertyRARAnn1 implements ResourceAdapter, Serializable {

    static final String className = ConfigPropertyRARAnn1.class.getName();
    ...
    @ConfigProperty(type = java.lang.String.class, ignore = true)
    String userName1;
