...
@Connector(
           authMechanisms = {
                              @AuthenticationMechanism(
                                                       description = "CONN_3_AUTHMECH_1_DESC",
                                                       authMechanism = "BasicPassword",
                                                       credentialInterface = AuthenticationMechanism.CredentialInterface.PasswordCredential),
                              @AuthenticationMechanism(
                                                       description = "CONN_3_AUTHMECH_2_DESC",
                                                       authMechanism = "Kerbv5",
                                                       credentialInterface = AuthenticationMechanism.CredentialInterface.GenericCredential) },

           description = { "CONN_3_DESC_1", "CONN_3_DESC_2" },

           displayName = {
                           "TRA_jca16_ann_ConnectorMergeAction_MultiElement",
                           "CONN_3_DISPNAME_1" },

           eisType = "CONN_3_EISTYPE",

           licenseDescription = { "CONN_3_LICDESC_1", "CONN_3_LICDESC_2" },
           licenseRequired = false, // CONN_3_LICREQ

           reauthenticationSupport = false, // CONN_3_REAUTHSUPPORT

           requiredWorkContexts = { TransactionContext.class, SecurityContext.class },
// { CONN_3_REQWRKCTX_1, CONN_3_REQWRKCTX_2 }

           securityPermissions = {
                                   @SecurityPermission(
                                                       description = "CONN_3_SECPERM_1_DESC",
                                                       permissionSpec = "grant { permission java.util.PropertyPermission \"*\", \"read, write\"; };"),
                                   @SecurityPermission(
                                                       description = "CONN_3_SECPERM_2_DESC",
           ...
           smallIcon = { "CONN_3_SMALLICON_1", "CONN_3_SMALLICON_2" },
           largeIcon = { "CONN_3_LARGEICON_1", "CONN_3_LARGEICON_2" },

           transactionSupport = TransactionSupport.TransactionSupportLevel.XATransaction,
// CONN_3_TXSUPPORT

           vendorName = "CONN_3_VENDORNAME",

           version = "CONN_3_VERSION")
public class ConnectorAnn3 implements ResourceAdapter, Serializable {

    static final String className = ConnectorAnn3.class.getName();
