...
// All @Connector elements are unspecified.  Use this class to verify
// the default values of @Connector elements merge in accordance to
// JCA 1.6 requirements.

@SuppressWarnings("serial")
@Connector(
// No displayName ==> ra.xml has display name
)
public class ConnectorAnnDef0 implements ResourceAdapter, Serializable {

    static final String className = ConnectorAnnDef0.class.getName();
