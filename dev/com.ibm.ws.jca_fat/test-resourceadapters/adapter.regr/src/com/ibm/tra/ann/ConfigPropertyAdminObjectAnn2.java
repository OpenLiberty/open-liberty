...
@AdministeredObject(
                    adminObjectInterfaces = { TRAAdminObject.class, TRAAdminObject1.class })
public class ConfigPropertyAdminObjectAnn2 implements TRAAdminObject, TRAAdminObject1 {
    ...
    @SuppressWarnings("unchecked")
    public ConfigPropertyAdminObjectAnn2() {
