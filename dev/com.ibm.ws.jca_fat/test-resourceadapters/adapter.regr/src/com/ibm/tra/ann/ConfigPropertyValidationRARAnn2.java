...
public class ConfigPropertyValidationRARAnn2 implements ResourceAdapter, Serializable {

    static final String className = ConfigPropertyValidationRARAnn2.class.getName();
