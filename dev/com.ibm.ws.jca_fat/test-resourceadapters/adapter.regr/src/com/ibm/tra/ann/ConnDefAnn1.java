...
public class ConnDefAnn1 extends ManagedConnectionFactoryBase implements javax.resource.spi.ManagedConnectionFactory {

    private static final String className = "ConnDefAnn1";

    private static final TraceComponent tc = Tr.register(ConnDefAnn1.class, SimpleRAImpl.RAS_GROUP, null);
