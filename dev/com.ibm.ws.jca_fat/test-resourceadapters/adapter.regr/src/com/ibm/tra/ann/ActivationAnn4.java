...
public class ActivationAnn4 extends ActivationSpecBase {

    public ActivationAnn4() {
        super();
    }
    ...
    public void setDestination(Destination dest) {
        ...
        if (DebugTracer.isDebugActivationSpec()) {
            ...
            out.println("ActivationAnn4.setDestination(): recieved dest: ");
            out.println("toString(): " + destination.toString());
            out.println("Class: " + destination.getClass().getName());
            out.println("End ActivationAnn4.setDestination()");
        }
    }
    ...
    public void setDestinationType(String dt) {
        ...
        if (DebugTracer.isDebugActivationSpec()) {
            PrintStream out = DebugTracer.getPrintStream();
            out.println("ActivationAnn4.setDestinationType() : destination type: " + dt);
        }
    }
    ...
    public void validate() throws InvalidPropertyException {
        ...
        if (debug) {
            out.println("ActivationAnn4.validate(): Current contents of Prop1: " + prop1);
            out.println("ActivationAnn4.validate(): Current destinationType: " + destinationType);
        }
        if (destination != null) {
            if (destination instanceof TRAAdminObject1) {
                if (debug)
                    out.println("ActivationAnn4.validate(): destination is of type TRAAdminObject1");
                good = true;
                ...
                if (debug)
                    out.println("ActivationAnn4.validate(): destination is of type TRAAdminObject2");
                good = true;
            } else {
                if (debug)
                    out.println("ActivationAnn4.validate(): destination is of type: " + prop1.getClass().getName());
                good = true; // for now
            }
        } else {
            if (debug)
                out.println("ActivationAnn4.validate(): destination is null");
            good = true; // why not.
        }
        if (!good) {
            throw new InvalidPropertyException("ActivationAnn4.validate() failed due to unusable type.");
        }
    }
