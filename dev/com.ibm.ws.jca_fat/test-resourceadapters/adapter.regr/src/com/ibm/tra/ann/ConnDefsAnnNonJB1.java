...
@ConnectionDefinitions(
                       value = {
                                 ...
                                 @ConnectionDefinition( // CD_2
                                                        ...
                                                        connectionImpl = com.ibm.tra.outbound.impl.J2CConnection.class) })
public class ConnDefsAnnNonJB1 extends ManagedConnectionFactoryBase implements javax.resource.spi.ManagedConnectionFactory {

    private static final String className = "ConnDefsAnnNonJB1";

    private static final TraceComponent tc = Tr.register(ConnDefsAnnNonJB1.class, SimpleRAImpl.RAS_GROUP, null);

    // Private CTOR for JB validation.
    // (F743-15626.1: Validation works, but does not cause installRAR to fail). 
    private ConnDefsAnnNonJB1() {
        super();
