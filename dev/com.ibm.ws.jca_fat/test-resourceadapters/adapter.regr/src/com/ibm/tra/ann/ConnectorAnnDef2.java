...
// 1. One smallIcon, largeIcon is not specified (default)
...
//displayName="CONN_DEF_2_DISPNAME",    // Not a test RAR name==> ra.xml has display name

//eisType="CONN_DEF_2_EISTYPE",

//licenseDescription={"CONN_DEF_2_LICDESC"},
//licenseRequired=false,                          // CONN_DEF_2_LICREQ

//reauthenticationSupport=true,                   // CONN_DEF_2_REAUTHSUPPORT

//requiredWorkContexts={},                        // CONN_DEF_2_REQWRKCTX

//securityPermissions={ @SecurityPermission() },  // CONN_DEF_2_SECPERM=SECPERM_DEF

           smallIcon = "CONN_DEF_2_SMALLICON"
//largeIcon="CONN_DEF_2_LARGEICON",

//transactionSupport=TransactionSupport.TransactionSupportLevel.LocalTransaction,
// CONN_DEF_2_TXSUPPORT

//vendorName="CONN_DEF_2_VENDORNAME",

//version="CONN_DEF_2_VERSION"
)
public class ConnectorAnnDef2 implements ResourceAdapter, Serializable {

    static final String className = ConnectorAnnDef2.class.getName();
