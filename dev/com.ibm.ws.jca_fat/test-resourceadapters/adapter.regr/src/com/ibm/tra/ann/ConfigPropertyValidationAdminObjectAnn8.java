...
public class ConfigPropertyValidationAdminObjectAnn8 implements TRAAdminObject {
    ...
    @SuppressWarnings("unchecked")
    public ConfigPropertyValidationAdminObjectAnn8() {
    ...
    public void letPassword(String password) {
