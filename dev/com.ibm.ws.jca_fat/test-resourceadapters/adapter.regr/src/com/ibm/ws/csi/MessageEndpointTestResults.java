...
/**
 * This interface allows FVT testcase to obtain test results that are reported
 * by the test resource adapter (test RA), MDB method, and websphere application
 * server components so that the FVT testcase can verify compliance with both
 * EJB and JCA specifications.
 */
public interface MessageEndpointTestResults {
    ...
    /**
     * Used by FVT testcase to clear prior results and to reinitialize results
     * to its initial state. Used by FVT testcase at the start of each variation
     * it wants to test.
     */
    public void clearResults();

    /**
     * Used by FVT testcase to determine the number of messages delivered since
     * the last call to the clearResults method of this interface.
     *
    ...
    /**
     * FVT testcase uses this method to determine if the isDeliveryTransacted
     * method of the MessageEndpointFactory interface returns boolean true or
     * not.
     *
    ...
    /**
     * FVT tescase uses this method to determine if option A message delivery
     * was used.
     *
    ...
    /**
     * FVT tescase uses this method to determine if option B message delivery
     * was used.
     *
    ...
    /**
     * FVT tescase uses this method to determine if MDB method was invoked from
     * within a global transaction context.
     *
    ...
    /**
     * FVT tescase uses this method to determine if MDB method was invoked from
     * within a local transaction context.
     *
    ...
    /**
     * FVT tescase uses this method to determine if message delivery resulted in
     * XAResource provided by test RA to be enlisted.
     *
    ...
    /**
     * FVT tescase uses this method to determine if message delivery resulted in
     * commit method being driven on XAResource provided by test RA.
     *
    ...
    /**
     * FVT tescase uses this method to determine if message delivery resulted in
     * rollback method being driven on XAResource provided by test RA.
     *
    ...
    /**
     * Used by test RA to report results of isDeliveryTransacted invocation on
     * the MessageEndpointFactory interface.
     *
     * @param transacted
     *            value returned by isDeliveryTransacted method.
     */
    public void setIsDeliveryTransacted(boolean transacted);

    /**
     * Used by test RA to indicate message delivery option A was used to deliver
     * the message to the MessageEndpoint object.
     */
    public void setOptionAMessageDelivery();

    /**
     * Used by test RA to indicate message delivery option B was used to deliver
     * the message to the MessageEndpoint object.
     */
    public void setOptionBMessageDelivery();

    /**
     * Used by test RA to indicate enlistment of the XAResource it provided to
     * createEndpoint method has occured.
     */
    public void setRaXaResourceEnlisted();

    /**
     * Used by test RA to indicates the commit method on the XAResource it
     * provided to createEndpoint method was driven.
     */
    public void setRaXaResourceCommit();

    /**
     * Used by test RA to indicates the rollback method on the XAResource it
     * provided to createEndpoint method was driven.
     */
    ...
    /**
     * Used by test RA to indicate it caught a javax.ejb.EJBException thrown by
     * MessageEndpoint proxy during message delivery.
     */
    // d248457.2
    ...
    /**
     * Called by EJB container to indicate is invoking a MDB method from within
     * a global transaction context.
     */
