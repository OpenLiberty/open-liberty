...
@Mode(TestMode.LITE)
@CheckpointTest
public class InboundSecurityCheckpointTest extends JCAFATTest implements RarTests {
    private final static Class<?> c = InboundSecurityCheckpointTest.class;
    ...
    public static void setUp() throws Exception {
        ...
        server = LibertyServerFactory.getLibertyServer("com.ibm.ws.jca.fat.regr.checkpoint", null, true);
        buildFvtAppEar();
