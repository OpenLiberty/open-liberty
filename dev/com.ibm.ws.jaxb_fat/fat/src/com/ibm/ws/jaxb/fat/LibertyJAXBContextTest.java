...
public class LibertyJAXBContextTest extends FATServletClient {
    ...
    public static void setUp() throws Exception {
        ShrinkHelper.defaultDropinApp(server, APP_NAME, "jaxb.web", "jaxb.web.utils", "jaxb.web.dataobjects");
