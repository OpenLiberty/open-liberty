...
public class SFRemoteHomeMethodServlet extends FATServlet {
     ...
     */
    //@Test
    public void testSFRemoteHomeMethod() throws Exception {
     ...
     */
    //@Test
    public void testSFRemoteHomeMethodWithArg() throws Exception {
        svLogger.info("This test does not apply to Stateful beans.");
    }
     ...
     */
    //@Test
    public void testSFRemoteHomeMethodWithMultiArgs() throws Exception {
        svLogger.info("This test does not apply to Stateful beans.");
    }
     ...
     */
    @Test
    public void testSFRemoteHomeGetEJBMetaData() throws Exception {
     ...
     */
    @Test
    public void testSFRemoteHomeEJBMetaDataGetEJBHome() throws Exception {
        EJBMetaData md = fhome1.getEJBMetaData();
        assertNotNull("Get EJB Metadata from home was null.", md);
     ...
     */
    @Test
    public void testSFRemoteHomeEJBMetaDataGetHomeInterfaceClass() throws Exception {
        EJBMetaData md = fhome1.getEJBMetaData();
        assertNotNull("Get EJB Metadata from home was null.", md);
     ...
     */
    @Test
    public void testSFRemoteHomeEJBMetaDataGetRemoteInterfaceClass() throws Exception {
        EJBMetaData md = fhome1.getEJBMetaData();
        assertNotNull("Get EJB Metadata from home was null.", md);
     ...
     */
    @Test
    public void testSFRemoteHomeEJBMetaDataGetPrimaryKeyClass() throws Exception {
        try {
            EJBMetaData md = fhome1.getEJBMetaData();
            assertNotNull("Get EJB Metadata from home was null.", md);
     ...
     */
    @Test
    public void testSFRemoteHomeEJBMetaDataIsSession() throws Exception {
        EJBMetaData md = fhome1.getEJBMetaData();
        assertNotNull("Get EJB Metadata from home was null.", md);
     ...
     */
    @Test
    public void testSFRemoteHomeEJBMetaDataIsStatefulSession() throws Exception {
        EJBMetaData md = fhome1.getEJBMetaData();
        assertNotNull("Get EJB Metadata from home was null.", md);
     ...
     */
    @Test
    public void testSFRemoteHomeGetHomeHandle() throws Exception {
     ...
     */
    @Test
    public void testSFRemoteHomeGetHomeHandleGetEJBHome() throws Exception {
        HomeHandle handle = fhome1.getHomeHandle();
        assertNotNull("Get EJB home handle from home was null.", handle);
     ...
     */
    @Test
    public void testSFRemoteHomeHandleSerialization() throws Exception {
        HomeHandle handle = fhome1.getHomeHandle();
        assertNotNull("Get EJB home handle from home was null.", handle);
