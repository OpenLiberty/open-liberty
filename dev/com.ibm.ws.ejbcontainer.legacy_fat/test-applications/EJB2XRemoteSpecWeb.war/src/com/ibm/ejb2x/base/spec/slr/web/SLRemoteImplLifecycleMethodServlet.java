...
public class SLRemoteImplLifecycleMethodServlet extends FATServlet {
    ...
    private final static String ejbJndiName2 = "com/ibm/ejb2x/base/spec/slr/ejb/SLRaCMTHome";
     ...
     */
    @Test
    public void testSLRemoteCMTLifecycle_constructor() throws Exception {
     ...
     */
    @Test
    public void testSLRemoteCMTLifecycle_setSessionContext() throws Exception {
     ...
     */
    //@Test
    public void testSLRemoteCMTLifecycle_unsetSessionContext() throws Exception {
     ...
     */
    @Test
    public void testSLRemoteCMTLifecycle_ejbCreate() throws Exception {
     ...
     */
    //@Test
    public void testSLRemoteCMTLifecycle_ejbPostCreate() throws Exception {
     ...
     */
    //@Test
    public void testSLRemoteCMTLifecycle_ejbRemove() throws Exception {
        svLogger.info("No specification defined way to validate this for stateless beans.");
    }
     ...
     */
    //@Test
    public void testSLRemoteCMTLifecycle_ejbActivate() throws Exception {
        svLogger.info("This test does not apply to Stateless beans.");
    }
     ...
     */
    //@Test
    public void testSLRemoteCMTLifecycle_ejbPassivate() throws Exception {
        svLogger.info("This test does not apply to Stateless beans.");
    }
     ...
     */
    //@Test
    public void testSLRemoteCMTLifecycle_ejbFind() throws Exception {
        svLogger.info("This test does not apply to Stateless beans.");
    }
     ...
     */
    //@Test
    public void testSLRemoteCMTLifecycle_ejbHome() throws Exception {
        svLogger.info("This test does not apply to Stateless beans.");
    }
     ...
     */
    //@Test
    public void testSLRemoteCMTLifecycle_ejbLoad() throws Exception {
        svLogger.info("This test does not apply to Stateless beans.");
    }
     ...
     */
    //@Test
    public void testSLRemoteCMTLifecycle_ejbStore() throws Exception {
        svLogger.info("This test does not apply to Stateless beans.");
    }
     ...
     */
    @Test
    public void testSLRemoteBMTLifecycle_constructor() throws Exception {
        // Exception will be thrown if constructor not called properly
     ...
     */
    @Test
    public void testSLRemoteBMTLifecycle_setSessionContext() throws Exception {
        // Exception will be thrown if setSessionContext not called properly
     ...
     */
    //@Test
    public void testSLRemoteBMTLifecycle_unsetSessionContext() throws Exception {
        svLogger.info("No specification defined way to validate this for stateless beans.");
    }
     ...
     */
    @Test
    public void testSLRemoteBMTLifecycle_ejbCreate() throws Exception {
        // Exception will be thrown if ejbCreate not called properly
     ...
     */
    //@Test
    public void testSLRemoteBMTLifecycle_ejbPostCreate() throws Exception {
        svLogger.info("This test does not apply to Stateless beans.");
    }
     ...
     */
    //@Test
    public void testSLRemoteBMTLifecycle_ejbRemove() throws Exception {
        svLogger.info("No specification defined way to validate this for stateless beans.");
    }
     ...
     */
    //@Test
    public void testSLRemoteBMTLifecycle_ejbActivate() throws Exception {
        svLogger.info("This test does not apply to Stateless beans.");
    }
     ...
     */
    //@Test
    public void testSLRemoteBMTLifecycle_ejbPassivate() throws Exception {
        svLogger.info("This test does not apply to Stateless beans.");
    }
     ...
     */
    @Test
    public void testSLRemoteBMTBusinessMethod() throws Exception {
        String testStr = "Test string.";
     ...
     */
    //@Test
    public void testSLRemoteBMTLifecycle_ejbFind() throws Exception {
        svLogger.info("This test does not apply to Stateless beans.");
    }
     ...
     */
    //@Test
    public void testSLRemoteBMTLifecycle_ejbHome() throws Exception {
        svLogger.info("This test does not apply to Stateless beans.");
    }
     ...
     */
    //@Test
    public void testSLRemoteBMTLifecycle_ejbLoad() throws Exception {
        svLogger.info("This test does not apply to Stateless beans.");
    }
     ...
     */
    //@Test
    public void testSLRemoteBMTLifecycle_ejbStore() throws Exception {
        svLogger.info("This test does not apply to Stateless beans.");
    }
}