...
public class SLRemoteInterfaceRemoveServlet extends FATServlet {
     ...
     */
    @Test
    public void testSLRemoteEJBObjectRemove() throws Exception {
        SLRa ejb1 = null;
        ejb1 = fhome1.create();
     ...
     */
    @Test
    public void testSLRemoteEJBObjectRemoveNonExisting() throws Exception {
        SLRa ejb1 = null;
        ejb1 = fhome1.create();
        assertNotNull("Remove test, EJB instance creation was null.", ejb1);
        ejb1.remove();
     ...
     */
    //@Test
    public void testSLRemoteEJBObjectRemoveEnlisted() throws Exception {
