 ...
 * <dl>
 * <dt>Test Name:
 * <dd>SLLocalHomeCreateTest (formerly WSTestSLL_HCTest)
 *
...
@WebServlet("/SLLocalHomeCreateServlet")
public class SLLocalHomeCreateServlet extends FATServlet {

    private final static String CLASS_NAME = SLLocalHomeCreateServlet.class.getName();
    ...
    /**
     * (hcs01) Test Stateless local home create (no parameters)
     */
    @Test
    public void testSLLocalHomeCreate() throws Exception {
        SLLa ejb1 = fhome1.create();
        assertNotNull("Create EJB was null.", ejb1);
    }

    /**
     * (hcs02) Test Stateless local home create (with primary key)
     */
    //@Test
    public void testSLLocalHomeCreateWithKey() throws Exception {
        svLogger.info("This test does not apply to Stateless beans.");
    }

    /**
     * (hcs03) Test Stateless local home create (with duplicate primary key)
     */
    //@Test
    public void testSLLocalHomeCreateWithDuplicateKey() throws Exception {
        svLogger.info("This test does not apply to Stateless beans.");
    }

    /**
     * (hcl01) Test Stateless local home create (with multiple args)
     */
    //@Test
    public void testSLLocalHomeCreateWithMultiArgs() throws Exception {
        svLogger.info("This test does not apply to Stateless beans.");
    }

    /**
     * (hcl02) Test Stateless local home create (with duplicate multiple args)
     */
    //@Test
    public void testSLLocalHomeCreateWithDuplicateMultiArgs() throws Exception {
        svLogger.info("This test does not apply to Stateless beans.");
    }
}
