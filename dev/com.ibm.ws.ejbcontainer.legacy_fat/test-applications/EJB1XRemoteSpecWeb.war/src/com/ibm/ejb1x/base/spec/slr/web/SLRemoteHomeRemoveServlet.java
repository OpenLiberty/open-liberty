...
import com.ibm.ejb1x.base.spec.slr.ejb.SLRaFakeKey;
...
public class SLRemoteHomeRemoveServlet extends FATServlet {
     ...
     */
    @Test
    public void test1XSLHomeRemoveWithKey() throws Exception {
     ...
     */
    //@Test
    public void test1XSLHomeRemoveWithNonExistKey() throws Exception {
     ...
     */
    //@Test
    public void test1XSLHomeRemoveWithEnlistedKey() throws Exception {
        svLogger.info("This test does not apply to Stateless beans.");
    }
     ...
     */
    @Test
    public void test1XSLHomeRemoveWithHandle() throws Exception {
        SLRa ejb1 = null;
        try {
            ejb1 = fhome1.create();
     ...
     */
    @Test
    public void test1XSLHomeRemoveWithNonExistHandle() throws Exception {
        SLRa ejb1 = null;
        try {
            ejb1 = fhome1.create();
            assertNotNull("Create EJB was null.", ejb1);
     ...
     */
    //@Test
    public void test1XSLHomeRemoveWithEnlistedHandle() throws Exception {
        svLogger.info("This test does not apply to Stateless beans.");
    }
}
