...
public class SLRemoteHomeCreateServlet extends FATServlet {
     ...
     */
    @Test
    public void test1XSLHomeCreate() throws Exception {
     ...
     */
    //@Test
    public void test1XSLHomeCreateWithKey() {
     ...
     */
    //@Test
    public void test1XSLHomeCreateWithDuplicateKey() {
        svLogger.info("This test does not apply to Stateless beans.");
    }
     ...
     */
    //@Test
    public void test1XSLHomeCreateWithMultiArgs() {
        svLogger.info("This test does not apply to Stateless beans.");
    }
     ...
     */
    //@Test
    public void test1XSLHomeCreateWithDuplicateMultiArgs() {
        svLogger.info("This test does not apply to Stateless beans.");
    }
}
