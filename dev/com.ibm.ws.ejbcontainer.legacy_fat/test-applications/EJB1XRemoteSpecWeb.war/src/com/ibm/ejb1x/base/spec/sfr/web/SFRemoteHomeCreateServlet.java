...
public class SFRemoteHomeCreateServlet extends FATServlet {
     ...
     */
    @Test
    public void test1XSFHomeCreate() throws Exception {
     ...
     */
    //@Test
    public void test1XSFHomeCreateWithKey() throws Exception {
     ...
     */
    //@Test
    public void test1XSFHomeCreateWithDuplicateKey() throws Exception {
        svLogger.info("This test does not apply to Stateful beans.");
    }
     ...
     */
    @Test
    public void test1XSFHomeCreateWithMultiArgs() throws Exception {
        SFRa ejb1 = null;
        try {
     ...
     */
    //@Test
    public void test1XSFHomeCreateWithDuplicateMultiArgs() throws Exception {
        svLogger.info("This test does not apply to Stateful beans.");
    }
}
