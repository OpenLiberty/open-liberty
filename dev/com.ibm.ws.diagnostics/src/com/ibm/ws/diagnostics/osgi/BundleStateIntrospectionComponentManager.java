 ...
 *
 */
public class BundleStateIntrospectionComponentManager implements StaticComponentManager {

    @Override
    public ReturnValue activate(Object instance, ComponentContext componentContext) {
        ((BundleStateIntrospection) instance).activate(componentContext.getBundleContext());
