 ...
 *
 */
public class BundleWiringIntrospectionComponentManager implements StaticComponentManager {

    @Override
    public ReturnValue activate(Object instance, ComponentContext componentContext) {
        ((BundleWiringIntrospection) instance).activate(componentContext.getBundleContext());
