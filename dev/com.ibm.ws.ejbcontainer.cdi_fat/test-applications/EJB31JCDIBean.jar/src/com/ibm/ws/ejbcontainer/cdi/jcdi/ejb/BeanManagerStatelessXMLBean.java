...
/**
 * Stateless bean that has a BeanManager injected via the <resource-env-ref> XML
 * stanza; that should also be able to lookup a BeanManager in java:comp.
 **/
@Stateless(name = "BeanManagerStatelessXML")
@Local(BeanManagerLocal.class)
@Remote(BeanManagerRemote.class)
public class BeanManagerStatelessXMLBean {
    private static final String CLASS_NAME = BeanManagerStatelessXMLBean.class.getName();
    private static final Logger svLogger = Logger.getLogger(CLASS_NAME);

    @Resource(name = "EJBName")
    private String ivEJBName = "BeanManagerStatelessXML";

    @Resource(name = "EJBContext")
    private SessionContext ivContext;

    // @Resource( name="BeanManager" ) - in XML
