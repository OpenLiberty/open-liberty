 ...
 * with mappedName; that should also be able to lookup a BeanManager in java:comp.
 **/
@Stateless(name = "BeanManagerStatelessMappedName")
@Local(BeanManagerLocal.class)
@Remote(BeanManagerRemote.class)
public class BeanManagerStatelessMappedNameBean {
    private static final String CLASS_NAME = BeanManagerStatelessAnnotationBean.class.getName();
    private static final Logger svLogger = Logger.getLogger(CLASS_NAME);

    @Resource(name = "EJBName")
    private String ivEJBName = "BeanManagerStatelessMappedName";

    @Resource(name = "EJBContext")
    private SessionContext ivContext;

    @Resource(name = "BeanManager", mappedName = "java:comp/BeanManager")
