...
/**
 * Stateless bean that has a CDI interceptor, but no EJB interceptors.
 **/
@Stateless(name = "CDIInterceptorStateless")
@Local(InterceptorLocal.class)
@Remote(InterceptorRemote.class)
@CDIInterceptorBinding
public class CDIInterceptorStatelessBean implements InterceptorAccess {
    private static final String CLASS_NAME = CDIInterceptorStatelessBean.class.getName();
    private static final Logger svLogger = Logger.getLogger(CLASS_NAME);

    @Resource(name = "EJBName")
    private String ivEJBName = "CDIInterceptorStateless";
