...
public class Mpjwt12TCKLauncher_aud_noenv3 {

    @Server("jwt12tckAudNoenvTai")
    ...
    public void launchMpjwt12TCKLauncher_aud_noenv3() throws Exception {
        String port = String.valueOf(server.getBvtPort());
        String bucketAndTestName = this.getClass().getCanonicalName();
        Map<String, String> additionalProps = new HashMap<>();
        MvnUtils.runTCKMvnCmd(server, bucketAndTestName, bucketAndTestName, "tck_suite_aud_noenv3.xml", additionalProps, Collections.emptySet());
