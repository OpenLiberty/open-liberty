...
@Mode(TestMode.LITE)
public class DefaultPrincipalMappingPassUtils11Test extends FATServletClient {

    private final Class<DefaultPrincipalMappingPassUtils11Test> thisClass = DefaultPrincipalMappingPassUtils11Test.class;
    ...
    public static void setUp() throws Exception {
        server = LibertyServerFactory.getLibertyServer("io.openliberty.security.auth.data.fat.dpm.pu11");
