 ...
 *******************************************************************************/
package io.openliberty.ejbcontainer.remote.ejb3session.sl.ann.web;
...
import io.openliberty.ejbcontainer.remote.ejb3session.sl.ann.ejb.TxAttrEJB;
import io.openliberty.ejbcontainer.remote.ejb3session.sl.ann.ejb.TxAttrEJBHome;
import io.openliberty.ejbcontainer.remote.ejb3session.sl.ann.ejb.TxAttrEJBLocal;
import io.openliberty.ejbcontainer.remote.ejb3session.sl.ann.ejb.TxAttrEJBLocalHome;
...
@WebServlet("/TxAttrComp2Servlet")
public class TxAttrComp2Servlet extends FATServlet {
    /**
     * Definitions for the logger
     */
    private final static String CLASSNAME = TxAttrComp2Servlet.class.getName();
     ...
     */
    @Test
    public void testRequiredAttrib_TxAttrComp2() throws Exception {
     ...
     */
    @Test
    public void testRequiredAttribInGlobalTrans_TxAttrComp2() throws Exception {
        byte[] tid = null;
     ...
     */
    @Test
    public void testRequiresNewAttribIfClientTranExists_TxAttrComp2() throws Exception {
        byte[] tid = null;
        UserTransaction userTran = null;
     ...
     */
    @Test
    public void testRequiresNewAttribOnGlobalInt_TxAttrComp2() throws Exception {
        assertNotNull("Remote bean, bean2, not null", bean2);
     ...
     */
    @Test
    public void testMandatoryAttribInGlobalTrans_TxAttrComp2() throws Exception {
        byte[] tid = null;
        UserTransaction userTran = null;
     ...
     */
    @Test
    public void testNever_TxAttrComp2() throws Exception {
        assertNotNull("Remote bean, bean2, not null", bean2);
    ...
    public void testNeverException_TxAttrComp2() throws Exception {
        byte[] tid = null;
        UserTransaction userTran = null;
        ...
        try {
            ...
            try {
                bean2.txNever(tid);
                fail("Container did not throw a java.rmi.RemoteException as expected for TX Never when transaction already existed.");
            } catch (RemoteException ex) {
                svLogger.info("container threw expected java.rmi.RemoteException for TX Never when transaction already existed.");
            }
     ...
     */
    @Test
    public void testNotSupported_TxAttrComp2() throws Exception {
        assertNotNull("Remote bean, bean2, not null", bean2);
     ...
     */
    @Test
    public void testNotSupportedGlobalTransExists_TxAttrComp2() throws Exception {
        byte[] tid = null;
        UserTransaction userTran = null;
     ...
     */
    @Test
    public void testSupportsAttrib_TxAttrComp2() throws Exception {
        assertNotNull("Remote bean, bean2, not null", bean2);
     ...
     */
    @Test
    public void testSupportsAttribOnGlobalTrans_TxAttrComp2() throws Exception {
        byte[] tid = null;
        UserTransaction userTran = null;
