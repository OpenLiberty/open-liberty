...
import io.openliberty.ejbcontainer.remote.ejb3session.sl.ann.ejb.AdvCMTStatelessRemote;
import io.openliberty.ejbcontainer.remote.ejb3session.sl.ann.ejb.AnnotatedCMTStatelessRemote;
import io.openliberty.ejbcontainer.remote.ejb3session.sl.ann.ejb.AnnotatedCMTStatelessRemote2;
import io.openliberty.ejbcontainer.remote.ejb3session.sl.ann.ejb.BasicCMTStatelessRemote;
import io.openliberty.ejbcontainer.remote.ejb3session.sl.ann.ejb.BasicCMTStatelessRemote2;
import io.openliberty.ejbcontainer.remote.ejb3session.sl.ann.ejb.UserTransactionRemote;
