...
import io.openliberty.ejbcontainer.remote.ejb3session.sl.ann.ejb.TxAttrRemote;
...
@WebServlet("/TxAttrServlet")
public class TxAttrServlet extends FATServlet {
    /**
     * Definitions for the logger
     */
    private final static String CLASSNAME = TxAttrServlet.class.getName();
     ...
     */
    @Test
    public void testRequiredAttrib_TxAttr() throws Exception {
     ...
     */
    @Test
    public void testRequiredAttribInGlobalTrans_TxAttr() throws Exception {
        byte[] tid = null;
     ...
     */
    @Test
    public void testRequiresNewAttribIfClientTranExists_TxAttr() throws Exception {
        byte[] tid = null;
        UserTransaction userTran = null;
     ...
     */
    @Test
    public void testRequiresNewAttribOnGlobalInt_TxAttr() throws Exception {
        assertNotNull("Remote bean, bean2, not null", bean2);
    ...
    public void testMandatoryAttribThrowsExcp_TxAttr() throws Exception {
        try {
            assertNotNull("Remote bean, bean2, not null", bean2);
     ...
     */
    @Test
    public void testMandatoryAttribInGlobalTrans_TxAttr() throws Exception {
        byte[] tid = null;
        UserTransaction userTran = null;
     ...
     */
    @Test
    public void testNever_TxAttr() throws Exception {
        assertNotNull("Remote bean, bean2, not null", bean2);
    ...
    public void testNeverException_TxAttr() throws Exception {
        byte[] tid = null;
        UserTransaction userTran = null;
     ...
     */
    @Test
    public void testNotSupported_TxAttr() throws Exception {
        assertNotNull("Remote bean, bean2, not null", bean2);
     ...
     */
    @Test
    public void testNotSupportedGlobalTransExists_TxAttr() throws Exception {
        byte[] tid = null;
        UserTransaction userTran = null;
     ...
     */
    @Test
    public void testSupportsAttrib_TxAttr() throws Exception {
        assertNotNull("Remote bean, bean2, not null", bean2);
     ...
     */
    @Test
    public void testSupportsAttribOnGlobalTrans_TxAttr() throws Exception {
        byte[] tid = null;
        UserTransaction userTran = null;
