...
import io.openliberty.ejbcontainer.remote.ejb3session.sl.ann.ejb.BasicCMTStatelessEJBLocal;
import io.openliberty.ejbcontainer.remote.ejb3session.sl.ann.ejb.BasicCMTStatelessEJBLocalHome;

/**
 * <dl>
 * <dt><b>Test Name:</b> AdvCompViewCMTStatelessLocalTest .
 *
 ...
 * Business Interfaces,
 * EJB injection, and not implementing SessionBean.
 * <p>
 *
 * <dt><b>Test Matrix:</b>
 * <dd>
 ...
 * <li>testCompIntInjection - Business Interface: Verify EJB field and method injection occurs properly
 * </ul>
 * <br>
 * Data Sources - None
 * </dl>
...
@WebServlet("/AdvCompViewCMTStatelessLocalServlet")
public class AdvCompViewCMTStatelessLocalServlet extends FATServlet {
    /**
    ...
    private static final String AdvCompViewBean = "AdvCompViewCMTStatelessLocal";
