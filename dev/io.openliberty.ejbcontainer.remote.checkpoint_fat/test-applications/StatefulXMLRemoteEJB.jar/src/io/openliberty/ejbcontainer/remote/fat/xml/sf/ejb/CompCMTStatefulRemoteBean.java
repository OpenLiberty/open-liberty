...
public class CompCMTStatefulRemoteBean implements SessionBean {
    private static final String CLASS_NAME = CompCMTStatefulRemoteBean.class.getName();
    ...
    public CompCMTStatefulRemoteBean() {
    }
