...
public class AdvBasicCMTStatefulRemoteBean {
    private static final String CLASS_NAME = AdvBasicCMTStatefulRemoteBean.class.getName();
    ...
    public AdvBasicCMTStatefulRemoteBean() {
    }
}
