...
@Stateful(name = "SerializableStatefulBean")
@ExcludeDefaultInterceptors
public class SerializableStatefulBean implements Serializable {
    private final static String CLASSNAME = SerializableStatefulBean.class.getName();
    ...
    private final Timer timerVal = null;
    ...
    @PostConstruct
    public void create() {
        svLogger.info("SerializableStatefulBean.create()");
        strVal = null;
        intVal = null;
        serObjVal = null;
        passCount = 0;
    ...
    public void create(String str, Integer i, SerObj serObj, SerObj2 serObj2) {
        svLogger.info("SerializableStatefulBean.create(parms)");
        strVal = str;
        intVal = i;
    ...
    public void passivate() {
        svLogger.info("SerializableStatefulBean.passivate");
        passCount++;
    }

    @PostActivate
    public void activate() {
        svLogger.info("SerializableStatefulBean.activate");
        actCount++;
    }
