...
import io.openliberty.ejbcontainer.remote.ejb3session.sl.mix.sc2.CMTStatelessRemote;
...
public class ExternalBeanClassWithAnnServlet extends FATServlet {
    ...
    public void testLookupXMLBasedName() throws Exception {
        ...
        // --------------------------------------------------------------------
        CMTStatelessRemote bean1 = (CMTStatelessRemote) FATHelper.lookupJavaBinding("java:global/StatelessMixTest/StatelessMixSCEJB/CMTStatelessRemote!io.openliberty.ejbcontainer.remote.ejb3session.sl.mix.sc2.CMTStatelessRemote"); //FATHelper.lookupDefaultBindingEJBJavaApp(businessInterface, module, beanName1);
