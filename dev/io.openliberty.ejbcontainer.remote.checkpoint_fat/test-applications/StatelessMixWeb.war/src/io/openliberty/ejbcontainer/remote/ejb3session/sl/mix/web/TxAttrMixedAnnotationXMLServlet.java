 ...
 *******************************************************************************/
package io.openliberty.ejbcontainer.remote.ejb3session.sl.mix.web;
...
import io.openliberty.ejbcontainer.remote.ejb3session.sl.mix.ejb.ExpClassExpAllxmlLocal;
import io.openliberty.ejbcontainer.remote.ejb3session.sl.mix.ejb.ExpClassExpAllxmlRemote;
import io.openliberty.ejbcontainer.remote.ejb3session.sl.mix.ejb.ExpClassExpXMLMethodLocal;
import io.openliberty.ejbcontainer.remote.ejb3session.sl.mix.ejb.ExpClassExpXMLMethodRemote;
import io.openliberty.ejbcontainer.remote.ejb3session.sl.mix.ejb.ExpMethodExpAllxmlLocal;
import io.openliberty.ejbcontainer.remote.ejb3session.sl.mix.ejb.ExpMethodExpAllxmlRemote;
import io.openliberty.ejbcontainer.remote.ejb3session.sl.mix.ejb.ExpMethodExpXMLMethodLocal;
import io.openliberty.ejbcontainer.remote.ejb3session.sl.mix.ejb.ExpMethodExpXMLMethodRemote;
import io.openliberty.ejbcontainer.remote.ejb3session.sl.mix.ejb.ImpClassExpAllxmlLocal;
import io.openliberty.ejbcontainer.remote.ejb3session.sl.mix.ejb.ImpClassExpAllxmlRemote;
import io.openliberty.ejbcontainer.remote.ejb3session.sl.mix.ejb.ImpClassExpXMLMethodLocal;
import io.openliberty.ejbcontainer.remote.ejb3session.sl.mix.ejb.ImpClassExpXMLMethodRemote;
