...
import io.openliberty.ejbcontainer.remote.ejb3session.sl.mix.ejb.CMTStatelessEJB;
import io.openliberty.ejbcontainer.remote.ejb3session.sl.mix.ejb.CMTStatelessEJBHome;
import io.openliberty.ejbcontainer.remote.ejb3session.sl.mix.ejb.CMTStatelessRemote;
...
public class MixCompCMTStatelessRemoteServlet extends FATServlet {
    ...
    final String businessInterface = "io.openliberty.ejbcontainer.remote.ejb3session.sl.mix.ejb.CMTStatelessRemote";
