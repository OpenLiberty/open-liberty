...
import io.openliberty.ejbcontainer.remote.fat.mix.sf.ejb.CMTStatefulEJBRemote;
import io.openliberty.ejbcontainer.remote.fat.mix.sf.ejb.CMTStatefulEJBRemoteHome;
...
public class CompCMTStatefulMixRemoteServlet extends FATServlet {
    ...
    final String businessInterface = "io.openliberty.ejbcontainer.remote.fat.mix.sf.ejb.CMTStatefulRemote";
