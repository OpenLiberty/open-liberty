 ...
 *******************************************************************************/
package io.openliberty.ejbcontainer.remote.fat.crossapp.client;
...
public class CrossAppTestServlet extends FATServlet {
    private static final String JNDI_HOME = "java:global/CrossAppRemoteEJB/CrossAppRemoteBean!io.openliberty.ejbcontainer.remote.fat.crossapp.shared.CrossAppEJBHome";
    private static final String JNDI_RMI = "java:global/CrossAppRemoteEJB/CrossAppRemoteBean!io.openliberty.ejbcontainer.remote.fat.crossapp.shared.CrossAppBusinessRMI";
    private static final String JNDI_REMOTE = "java:global/CrossAppRemoteEJB/CrossAppRemoteBean!io.openliberty.ejbcontainer.remote.fat.crossapp.shared.CrossAppBusinessRemote";
    private static final String JNDI_2X_HOME = "java:global/CrossApp2xTest/CrossApp2xEJB/CrossAppEJBHome2xBean!io.openliberty.ejbcontainer.remote.fat.crossapp.shared.CrossAppEJBHome2x";
