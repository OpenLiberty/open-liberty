...
import io.openliberty.ejbcontainer.remote.fat.ann.sf.ejb.BasicCMTStatefulRemote;

/**
 *
 */
@SuppressWarnings("serial")
@WebServlet("/NoCMTStatefulAnnRemoteServlet")
public class NoCMTStatefulAnnRemoteServlet extends FATServlet {

    private final static String CLASSNAME = NoCMTStatefulAnnRemoteServlet.class.getName();
    ...
    private static final String NoBean = "NoCMTStatefulRemoteBean";
     ...
     */
    @Test
    public void testSFSBNoCMTTxAttribsAnn() throws Exception {
