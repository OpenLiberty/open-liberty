...
@Singleton(name = "FailedDependency")
@LocalBean
public class FailedDependencyBean implements BasicSingleton {
    private boolean ivValue;

    @Resource
    private void setSessionContext(SessionContext ejbContext) {
        throw new UnsupportedOperationException("Expected Dependency Exception.");
    }
