...
/**
 * Bean implementation class for Enterprise Bean: ImpClassExpXMLMethodBean
 **/
@Local(ImpClassExpXMLMethodLocal.class)
@Remote(ImpClassExpXMLMethodRemote.class)
public class ImpClassExpXMLMethodBean {
    /**
     ...
     *             transaction context.
     */
    public boolean impClassExpXMLMethod(byte[] tid) {
