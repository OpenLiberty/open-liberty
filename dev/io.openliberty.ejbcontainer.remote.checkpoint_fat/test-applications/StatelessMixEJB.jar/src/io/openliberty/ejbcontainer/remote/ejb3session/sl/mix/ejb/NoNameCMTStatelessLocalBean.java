...
/**
 * Bean implementation class for Enterprise Bean: CMTStatelessLocal
 **/
@Stateless
@Local(CMTStatelessLocal.class)
public class NoNameCMTStatelessLocalBean {
    private static final String CLASS_NAME = NoNameCMTStatelessLocalBean.class.getName();
    ...
    public NoNameCMTStatelessLocalBean() {}
}