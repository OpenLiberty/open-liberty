...
/**
 * Bean implementation class for Enterprise Bean: CompNoBizCMTStatelessLocalBean
 **/
@Stateless(name = "CompNoBizCMTStatelessLocal")
@LocalHome(CMTStatelessEJBLocalHome.class)
@TransactionManagement(CONTAINER)
public class CompNoBizCMTStatelessLocalBean {
    private static final String CLASS_NAME = CompNoBizCMTStatelessLocalBean.class.getName();
    ...
    public CompNoBizCMTStatelessLocalBean() {}
}