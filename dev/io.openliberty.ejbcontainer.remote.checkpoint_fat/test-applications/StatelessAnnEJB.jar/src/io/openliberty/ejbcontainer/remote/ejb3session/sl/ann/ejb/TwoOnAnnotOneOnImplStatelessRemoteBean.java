 ...
 * TwoOnAnnOneOnImplStatlessRemote
 **/
@Stateless
@Remote({ BasicCMTStatelessRemote.class, AdvCMTStatelessRemote.class })
@RemoteHome(BasicCMTStatelessEJBHome.class)
@TransactionManagement(CONTAINER)
public class TwoOnAnnotOneOnImplStatelessRemoteBean implements BasicCMTStatelessRemote2 {
    /** New Line character for this system. **/
    public static final String NL = System.getProperty("line.separator", "\n");

    // Logger
    private static final String CLASS_NAME = TwoOnAnnotOneOnImplStatelessRemoteBean.class.getName();
    ...
    public TwoOnAnnotOneOnImplStatelessRemoteBean() {}
}