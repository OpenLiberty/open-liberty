...
/**
 * Bean implementation class for Enterprise Bean: RemoveCMTLocal and Remote
 **/
@Stateful(name = "RemoveAdvCMTBean")
@Remote({ RemoveCMTRemote.class, RemoveRemote.class })
@RemoteHome(RemoveCMTEJBRemoteHome.class)
@TransactionManagement(CONTAINER)
public class RemoveAdvCMTBean implements SessionSynchronization {

    @Resource
    private SessionContext ivContext;

    private String ivString = "RemoveAdvCMTBean";
