...
import io.openliberty.ejbcontainer.remote.enventry.web.EnvEntryServlet;

@RunWith(FATRunner.class)
public class BadApplicationTests extends AbstractTest {
    public static String eeVersion;

    @Server("checkpointBadAppServer")
    ...
    @ClassRule
    public static RepeatTests r = RepeatTests.with(FeatureReplacementAction.EE10_FEATURES().forServers("checkpointBadAppServer"));
//    public static RepeatTests r = RepeatTests.with(FeatureReplacementAction.EE7_FEATURES().fullFATOnly().forServers("checkpointBadAppServer")).andWith(FeatureReplacementAction.EE8_FEATURES().forServers("checkpointBadAppServer")).andWith(FeatureReplacementAction.EE9_FEATURES().fullFATOnly().forServers("io.openliberty.ejbcontainer.remote.fat.BadAppServer")).andWith(FeatureReplacementAction.EE10_FEATURES().fullFATOnly().forServers("checkpointBadAppServer"));
    ...
    public static void beforeClass() throws Exception {
        ...
        JavaArchive AppExcExtendsThrowableErrBeanJar = ShrinkHelper.buildJavaArchive("AppExcExtendsThrowableErrBean.jar",
                                                                                     "io.openliberty.ejbcontainer.remote.jitdeploy.error1.ejb.");
        ...
        //#################### EnvEntryShared.jar
        JavaArchive EnvEntrySharedJar = ShrinkHelper.buildJavaArchive("EnvEntryShared.jar", "io.openliberty.ejbcontainer.remote.enventry.shared.");

        ShrinkHelper.exportToServer(server, "lib/global", EnvEntrySharedJar, DeployOptions.SERVER_ONLY);

        //#################### EnvEntryApp
        JavaArchive EnvEntryEJBJar = ShrinkHelper.buildJavaArchive("EnvEntryEJB.jar", "io.openliberty.ejbcontainer.remote.enventry.ejb.");
        WebArchive EnvEntryWeb = ShrinkHelper.buildDefaultApp("EnvEntryWeb.war", "io.openliberty.ejbcontainer.remote.enventry.web.");
        ...
        //################### EnvEntryBad1App
        JavaArchive EnvEntryBad1EJBJar = ShrinkHelper.buildJavaArchive("EnvEntryBad1EJB.jar", "io.openliberty.ejbcontainer.remote.enventry.bad.ejb.");
        ...
        //################### EnvEntryBad2App
        JavaArchive EnvEntryBad2EJBJar = ShrinkHelper.buildJavaArchive("EnvEntryBad2EJB.jar", "io.openliberty.ejbcontainer.remote.enventry.bad.ejb2.");
        ...
        //################### EnvEntryBad3App
        JavaArchive EnvEntryBad3EJBJar = ShrinkHelper.buildJavaArchive("EnvEntryBad3EJB.jar", "io.openliberty.ejbcontainer.remote.enventry.bad.ejb3.");
        ...
        //################### EnvEntryBad4App
        JavaArchive EnvEntryBad4EJBJar = ShrinkHelper.buildJavaArchive("EnvEntryBad4EJB.jar", "io.openliberty.ejbcontainer.remote.enventry.bad.ejb4.");
    ...
    protected static final String NOSUCHCLASS = "io.openliberty.ejbcontainer.remote.enventry.bad.ejb.NoSuchClass";

    // For E2, constant for the bogus enum class name, which should appear somewhere in the error message:
    protected static final String NOSUCHENUMTYPE_ENUM_TYPE = "io.openliberty.ejbcontainer.remote.enventry.bad.ejb2.NoSuchEnumType";

    // For E3, constants for the Enum class name and the bogus enum value, which should appear somewhere in the error message:
    protected static final String NOSUCHENUMVALUE_ENUM_TYPE = "io.openliberty.ejbcontainer.remote.enventry.shared.EnvEntryDriver\\$EnvEntryEnum";
    ...
    protected static final String EXISTING_NON_ENUM_NON_CLASS_ENV_ENTRY_TYPE = "io.openliberty.ejbcontainer.remote.enventry.bad.ejb4.Bad4";
    ...
    @Test
    @Mode(TestMode.FULL)
    @ExpectedFFDC({ "javax.ejb.NoSuchEJBException", "io.openlibertyspi.injectionengine.InjectionException",
                    "javax.ejb.EJBException", "com.ibm.ejs.container.ContainerException",
                    "com.ibm.ejs.container.EJBConfigurationException", "io.openliberty.container.service.state.StateChangeException" })
    ...
    @Test
    @Mode(TestMode.FULL)
    @ExpectedFFDC({ "com.ibm.ejs.container.EJBConfigurationException", "io.openlibertyspi.injectionengine.InjectionConfigurationException", "java.lang.ClassNotFoundException" })
