...
import io.openliberty.ejbcontainer.remote.fat.ann.sf.web.AdvBasicCMTStatefulAnnRemoteServlet;
import io.openliberty.ejbcontainer.remote.fat.ann.sf.web.AdvCompCMTStatefulAnnRemoteServlet;
import io.openliberty.ejbcontainer.remote.fat.ann.sf.web.BasicCMTStatefulAnnRemoteServlet;
import io.openliberty.ejbcontainer.remote.fat.ann.sf.web.CompCMTStatefulAnnRemoteServlet;
import io.openliberty.ejbcontainer.remote.fat.ann.sf.web.EmptyCMTStatefulAnnRemoteServlet;
import io.openliberty.ejbcontainer.remote.fat.ann.sf.web.InitCMTStatefulAnnRemoteServlet;
import io.openliberty.ejbcontainer.remote.fat.ann.sf.web.NoCMTStatefulAnnRemoteServlet;
import io.openliberty.ejbcontainer.remote.fat.ann.sf.web.RemoveBMTStatefulAnnRemoteServlet;
import io.openliberty.ejbcontainer.remote.fat.ann.sf.web.RemoveCMTStatefulAnnRemoteServlet;
import io.openliberty.ejbcontainer.remote.fat.mix.sf.web.CompCMTStatefulMixRemoteServlet;
import io.openliberty.ejbcontainer.remote.fat.mix.sf.web.InterfaceMixRemoteServlet;
import io.openliberty.ejbcontainer.remote.fat.mix.sf.web.StatefulPassivationMixServlet;
import io.openliberty.ejbcontainer.remote.fat.mix.sf.web.StatefulTwoNamesMixRemoteServlet;
import io.openliberty.ejbcontainer.remote.fat.xml.sf.web.AdvBasicCMTStatefulXMLRemoteServlet;
import io.openliberty.ejbcontainer.remote.fat.xml.sf.web.AdvCompCMTStatefulXMLRemoteServlet;
import io.openliberty.ejbcontainer.remote.fat.xml.sf.web.BasicCMTStatefulXMLRemoteServlet;
import io.openliberty.ejbcontainer.remote.fat.xml.sf.web.CompCMTStatefulXMLRemoteServlet;
import io.openliberty.ejbcontainer.remote.fat.xml.sf.web.InitCMTStatefulXMLRemoteServlet;
import io.openliberty.ejbcontainer.remote.fat.xml.sf.web.RemoveBMTStatefulXMLRemoteServlet;
import io.openliberty.ejbcontainer.remote.fat.xml.sf.web.RemoveCMTStatefulXMLRemoteServlet;

@RunWith(FATRunner.class)
public class RemoteSessionTests extends AbstractTest {

    @Server("io.openliberty.ejbcontainer.remote.fat.RemoteSessionServer")
    ...
    @ClassRule
    public static RepeatTests r = RepeatTests.with(FeatureReplacementAction.EE7_FEATURES().fullFATOnly().forServers("io.openliberty.ejbcontainer.remote.fat.RemoteSessionServer")).andWith(FeatureReplacementAction.EE8_FEATURES().forServers("io.openliberty.ejbcontainer.remote.fat.RemoteSessionServer")).andWith(new JakartaEE9Action().conditionalFullFATOnly(FeatureReplacementAction.GREATER_THAN_OR_EQUAL_JAVA_11).forServers("io.openliberty.ejbcontainer.remote.fat.RemoteSessionServer")).andWith(new JakartaEE10Action().forServers("io.openliberty.ejbcontainer.remote.fat.RemoteSessionServer"));
    ...
    public static void beforeClass() throws Exception {
        ...
        JavaArchive StatefulAnnRemoteEJB = ShrinkHelper.buildJavaArchive("StatefulAnnRemoteEJB.jar", "io.openliberty.ejbcontainer.remote.fat.ann.sf.ejb.");
        WebArchive StatefulAnnRemoteWeb = ShrinkHelper.buildDefaultApp("StatefulAnnRemoteWeb.war", "io.openliberty.ejbcontainer.remote.fat.ann.sf.web.");
        ...
        JavaArchive StatefulMixRemoteEJB = ShrinkHelper.buildJavaArchive("StatefulMixRemoteEJB.jar", "io.openliberty.ejbcontainer.remote.fat.mix.sf.ejb.");
        ...
        WebArchive StatefulMixRemoteWeb = ShrinkHelper.buildDefaultApp("StatefulMixRemoteWeb.war", "io.openliberty.ejbcontainer.remote.fat.mix.sf.web.");
        ...
        JavaArchive StatefulXMLRemoteEJB = ShrinkHelper.buildJavaArchive("StatefulXMLRemoteEJB.jar", "io.openliberty.ejbcontainer.remote.fat.xml.sf.ejb.");
        ...
        WebArchive StatefulXMLRemoteWeb = ShrinkHelper.buildDefaultApp("StatefulXMLRemoteWeb.war", "io.openliberty.ejbcontainer.remote.fat.xml.sf.web.");
