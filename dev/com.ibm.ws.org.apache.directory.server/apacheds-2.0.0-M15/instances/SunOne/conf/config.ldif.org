...
dn: ads-partitionId=rtp.raleigh.ibm.com,ou=partitions,ads-directoryServiceId=def
 ault,ou=config
ads-contextEntry:: ZG46IGRjPXJ0cCxkYz1yYWxlaWdoLGRjPWlibSxkYz1jb20Kb2JqZWN0Q2xhc
 3M6IGRvbWFpbgpvYmplY3RDbGFzczogdG9wCmRjOiBydHAKCg==
ads-enabled: TRUE
ads-partitionCacheSize: 100
ads-partitionSyncOnWrite: TRUE
ads-partitionId: rtp.raleigh.ibm.com
objectClass: top
objectClass: ads-jdbmPartition
objectClass: ads-partition
objectClass: ads-base
ads-partitionSuffix: dc=rtp,dc=raleigh,dc=ibm,dc=com

dn: ou=indexes,ads-partitionId=rtp.raleigh.ibm.com,ou=partitions,ads-directorySe
 rviceId=default,ou=config
ou: indexes
objectClass: organizationalUnit
objectClass: top

dn: ads-indexAttributeId=apacheAlias,ou=indexes,ads-partitionId=rtp.raleigh.ibm.
...
dn: ads-indexAttributeId=apacheOneAlias,ou=indexes,ads-partitionId=rtp.raleigh.i
...
dn: ads-indexAttributeId=apacheOneLevel,ou=indexes,ads-partitionId=rtp.raleigh.i
 bm.com,ou=partitions,ads-directoryServiceId=default,ou=config
...
dn: ads-indexAttributeId=apachePresence,ou=indexes,ads-partitionId=rtp.raleigh.i
 bm.com,ou=partitions,ads-directoryServiceId=default,ou=config
ads-indexAttributeId: apachePresence
ads-enabled: TRUE
objectClass: ads-jdbmIndex
...
dn: ads-indexAttributeId=apacheRdn,ou=indexes,ads-partitionId=rtp.raleigh.ibm.co
...
dn: ads-indexAttributeId=apacheSubAlias,ou=indexes,ads-partitionId=rtp.raleigh.i
 bm.com,ou=partitions,ads-directoryServiceId=default,ou=config
ads-indexAttributeId: apacheSubAlias
ads-enabled: TRUE
objectClass: ads-jdbmIndex
...
dn: ads-indexAttributeId=apacheSubLevel,ou=indexes,ads-partitionId=rtp.raleigh.i
 bm.com,ou=partitions,ads-directoryServiceId=default,ou=config
...
dn: ads-indexAttributeId=dc,ou=indexes,ads-partitionId=rtp.raleigh.ibm.com,ou=pa
...
dn: ads-indexAttributeId=entryCSN,ou=indexes,ads-partitionId=rtp.raleigh.ibm.com
...
dn: ads-indexAttributeId=entryUUID,ou=indexes,ads-partitionId=rtp.raleigh.ibm.co
 m,ou=partitions,ads-directoryServiceId=default,ou=config
...
dn: ads-indexAttributeId=krb5PrincipalName,ou=indexes,ads-partitionId=rtp.raleig
 h.ibm.com,ou=partitions,ads-directoryServiceId=default,ou=config
ads-indexAttributeId: krb5PrincipalName
ads-enabled: TRUE
objectClass: ads-jdbmIndex
objectClass: top
...
dn: ads-indexAttributeId=objectClass,ou=indexes,ads-partitionId=rtp.raleigh.ibm.
 com,ou=partitions,ads-directoryServiceId=default,ou=config
ads-indexAttributeId: objectClass
ads-enabled: TRUE
objectClass: ads-jdbmIndex
...
dn: ads-indexAttributeId=ou,ou=indexes,ads-partitionId=rtp.raleigh.ibm.com,ou=pa
 rtitions,ads-directoryServiceId=default,ou=config
ads-indexAttributeId: ou
ads-enabled: TRUE
objectClass: ads-jdbmIndex
...
dn: ads-indexAttributeId=uid,ou=indexes,ads-partitionId=rtp.raleigh.ibm.com,ou=p
