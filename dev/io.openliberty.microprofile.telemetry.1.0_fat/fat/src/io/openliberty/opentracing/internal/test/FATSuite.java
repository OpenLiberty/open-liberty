...
public class FATSuite implements FATOpentracingConstants {
    ...
    private static final String FEATURE_NAME1 = "io.openliberty.opentracing.mock-3.0.mf";
    private static final String BUNDLE_NAME1 = "io.openliberty.opentracing.mock-3.0.jar";
