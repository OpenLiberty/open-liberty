 ...
 *
 */
public class JSONMetricWriter21 extends JSONMetricWriter implements OutputWriter {
    private static final TraceComponent tc = Tr.register(JSONMetricWriter21.class);

    public JSONMetricWriter21(Writer writer) {
        super(writer);
    }
