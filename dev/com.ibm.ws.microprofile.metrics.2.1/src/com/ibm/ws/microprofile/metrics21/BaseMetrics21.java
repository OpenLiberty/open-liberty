...
public class BaseMetrics21 extends BaseMetrics {
    ...
    public static synchronized BaseMetrics21 getInstance21(SharedMetricRegistries sharedMetricRegistry) {
        ...
        if (baseMetrics21 == null)
            baseMetrics21 = new BaseMetrics21();
        return baseMetrics21;
    }

    protected BaseMetrics21() {
        super();
    }
    @Override
    ...
    private class BMGauge<T extends Number> implements Gauge<T> {
