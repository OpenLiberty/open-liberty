...
public class ApiTestServlet extends FATServlet {
    ...
    public void testCanLoadJakartaWsRsClasses() throws Exception {
        // interfaces
        assertTrue(canLoad("jakarta.ws.rs.SeBootstrap"));
        // classes
    ...
    public void testCanLoadJakartaWsRsCoreClasses() throws Exception {
        ...
        assertTrue(canLoad("jakarta.ws.rs.core.EntityPart"));
        ...
        assertTrue(canLoad("jakarta.ws.rs.core.Link$JaxbAdapter"));
        assertTrue(canLoad("jakarta.ws.rs.core.Link$JaxbLink"));
