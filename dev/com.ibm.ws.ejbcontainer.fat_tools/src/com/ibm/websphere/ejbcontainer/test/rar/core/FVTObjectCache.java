...
import com.ibm.websphere.ejbcontainer.test.rar.work.FVTSimpleWorkImpl;
...
public class FVTObjectCache {
    ...
    public final FVTComplexWorkImpl getComplexWork(String deliveryId, FVTMessage message, FVTWorkDispatcher dispatcher) {
        ...
        return work == null
                        ? new FVTComplexWorkImpl(deliveryId, message, dispatcher)
                        : work.recycle(deliveryId, message, dispatcher);
    }
    ...
    public final FVTSimpleWorkImpl getSimpleWork(String deliveryId, String endpointName, MessageEndpointFactoryWrapper factoryWrapper, FVTXAResourceImpl resource) {
        ...
        return work == null
                        ? new FVTSimpleWorkImpl(deliveryId, endpointName, factoryWrapper, resource)
                        : work.recycle(deliveryId, endpointName, factoryWrapper, resource);
    }
