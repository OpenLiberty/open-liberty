...
//  06/02/03   jitang     LIDB2110.31  provide J2C 1.5 support
//  12/18/03   swai                    Change Tr.error, Tr.info, Tr.warning call to svLogger.info
//  03/05/04   alvinso    LI2110.69    @alvinso.1 : Add method getSharingViolation and setSharingViolation
//                                     to signal getConnection() to throw SharingViolationException
//  03/11/04   alvinso    LI2110.69    @alvinso.2 : Add methods to kill the server process
//  05/31/04   swai       LI2110.69    @alvinso.3 : Add methods to XAProcessing JetStream test cases.
//  06/02/04   swai                    Remove the methods for XAProcessing because there will be a
//                                     separate RAR and EAR for the XAProcessing test case.
//  06/08/04   gburli     LI2110.97    Add methods to set and get MCs to different Sets of MCs.
//                                     Change the ALL_MC_INVALID etc to constants.
//  06/13/04   swai                    Added ENTIRE_POOL_PURGEPOLICY as a new flag for ValidatingMCF
//                                     test case.
//  01/03/05   gburli      D2438030    Add methods for testcase for LI2110.01
//  ----------------------------------------------------------------
...
import com.ibm.websphere.ejbcontainer.test.rar.jdbc.JdbcConnection;
