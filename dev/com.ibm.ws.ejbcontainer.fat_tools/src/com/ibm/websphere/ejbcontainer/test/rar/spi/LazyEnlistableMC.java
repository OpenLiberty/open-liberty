...
public class LazyEnlistableMC extends ManagedConnectionImpl implements LazyEnlistableManagedConnection {
     ...
     */
    public LazyEnlistableMC(ManagedConnectionFactoryImpl mcf, PooledConnection pconn, Connection conn, Subject sub, ConnectionRequestInfoImpl cxRequestInfo) throws ResourceException {
