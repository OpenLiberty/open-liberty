...
//  06/02/04   swai                    Change name and resourceAdapter to protected from private
//  --------------------------------------------------------------------
...
public class ActivationSpecImpl implements ActivationSpec, Serializable {
    ...
    protected String name; // 06/02/04: swai

    /** resoure adpater instance */
    protected ResourceAdapter resourceAdapter; // 06/02/04: swai
