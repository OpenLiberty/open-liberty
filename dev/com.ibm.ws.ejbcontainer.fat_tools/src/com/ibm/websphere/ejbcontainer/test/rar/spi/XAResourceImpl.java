...
//  03/11/04   alvinso    LI2110.68    @alvinso.1 Add checking in commit() for killing the server process.  
//                                                Kill the server process if AdapterUtil.getKillServer is set to true
//  03/31/04   alvinso    LIDB2110-69  Change TraceComponent from private to protected
//  ----------------------------------------------------------------
...
public class XAResourceImpl implements XAResource {
    ...
    public void start(Xid xid, int flags) throws XAException
    {
        ...
        { this, ivMC, xid, AdapterUtil.getXAResourceStartFlagString(flags) });
