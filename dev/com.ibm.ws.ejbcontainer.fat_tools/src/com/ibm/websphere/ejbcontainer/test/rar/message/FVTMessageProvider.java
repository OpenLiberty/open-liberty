...
//  08/02/03    swai       d174256      Added getTestResultsWork inputWork, String endpointName, int instanceId)
//                                      and getTestResult(Work inputWork)
...
public interface FVTMessageProvider extends FVTBaseMessageProvider {
     ...
     * @exception ResourceException
     */
    public void sendMessageWaitNestedWork(String deliveryId, FVTMessage message, int state, Xid parentXid, Xid childXid, int doWorkType, int nestedDoWorkType) throws ResourceException;
