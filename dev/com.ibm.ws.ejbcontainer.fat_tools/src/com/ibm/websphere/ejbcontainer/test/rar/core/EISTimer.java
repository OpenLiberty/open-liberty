...
//  --------    -------    ------       ---------------------------------
//  09/18/03    swai       d177221      Create - this timer class is used to verify
//                                      check if the underlying EIS (messageProvider)
//                                      fails or not. When the timer expires, check
//                                      if EISFail is true. If so, need to do sth with
//                                      the WorkDispatcher.
//                                      The constructor should take the object of
//                                      FVTMessageProviderImpl.
...
//                                      called.
//  10/05/03    swai                    Add EISTimerState. This shows what the timer is
//                                      up to. Normal, rollback is complete, rollback 
//                                      failed. This will be checked by 
//                                      FVTMessageProviderImpl.signalEISFailure().
//                                      When test case signal EIS failure, this method
//                                      will not return until rollback is either completed
//                                      or failed. Then the test case will know whether
//                                      the rollback is completed or not and can fail the
//                                      the test case if necessary.                                
//  10/22/03    swai                    Modify the constructor so that it takes WorkDispatcher
//                                      instance too so that there is no need to get WD from
//                                      the provider instance.
//  12/01/03    swai                    Added isRollbackFailed and setSyncObject methods
