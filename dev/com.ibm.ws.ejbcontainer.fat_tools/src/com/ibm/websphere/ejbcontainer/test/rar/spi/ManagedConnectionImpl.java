...
//  01/10/03   jitang     d156456      Fix connection properties.
//  02/05/03   jitang	  d157688      Implement ConnectionEventSender interface
...
//
//  03/05/04   alvinso    LI2110.69    @alvinso.1 : Add condition to handle SharingViolationException in getConnection()
//  03/30/04   kak        LIDB2110-69  change some fields from private to protected
//  06/08/04   gburli     LI2110.97    Modified destroy method for ValidatingMCF test cases.
//  ----------------------------------------------------------------
...
import com.ibm.websphere.ejbcontainer.test.rar.core.ConnectionEventSender;
...
public class ManagedConnectionImpl implements ManagedConnection, ConnectionEventSender
{
     ...
     * Constructor
     */
    public ManagedConnectionImpl(ManagedConnectionFactoryImpl mcf, PooledConnection pconn, Connection conn, Subject sub, ConnectionRequestInfoImpl cxRequestInfo) throws ResourceException {
