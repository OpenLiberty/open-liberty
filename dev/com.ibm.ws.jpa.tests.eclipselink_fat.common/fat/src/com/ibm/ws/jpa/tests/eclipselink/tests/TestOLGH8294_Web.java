...
import com.ibm.ws.jpa.olgh8294.web.TestOLGH8294Servlet;
...
@Mode(TestMode.FULL)
public class TestOLGH8294_Web extends JPAFATServletClient {
    private final static String CONTEXT_ROOT = "olgh8294Web";
    private final static String RESOURCE_ROOT = "test-applications/olgh8294/";
    private final static String appFolder = "web";
    private final static String appName = "olgh8294Web";
    ...
    static {
        dropSet.add("JPA_OLGH8294_DROP_${dbvendor}.ddl");
        createSet.add("JPA_OLGH8294_CREATE_${dbvendor}.ddl");
        populateSet.add("JPA_OLGH8294_POPULATE_${dbvendor}.ddl");
    }

    @Server("EclipseLinkServer")
    @TestServlets({
                    @TestServlet(servlet = TestOLGH8294Servlet.class, path = CONTEXT_ROOT + "/" + "TestOLGH8294Servlet")
    })
    ...
    public static void setUp() throws Exception {
        ...
        bannerStart(TestOLGH8294_Web.class);
        ...
        System.out.println(TestOLGH8294_Web.class.getName() + " Setting up database tables...");
    ...
    private static void setupTestApplication() throws Exception {
        ...
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh8294.model");
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh8294.testlogic");
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh8294.web");
    ...
    public static void tearDown() throws Exception {
        try {
            ...
            bannerEnd(TestOLGH8294_Web.class, timestart);
        }
    }
}
