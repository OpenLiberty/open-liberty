...
public class TestOLGH9018_Web extends JPAFATServletClient {
    ...
    static {
        dropSet.add("JPA_OLGH9018_DROP_${dbvendor}.ddl");
        createSet.add("JPA_OLGH9018_CREATE_${dbvendor}.ddl");
    }
    ...
    public static void setUp() throws Exception {
        ...
        System.out.println(TestOLGH9018_Web.class.getName() + " Setting up database tables...");
