...
import com.ibm.ws.jpa.olgh16970.web.TestOLGH16970Servlet;
...
@Mode(TestMode.FULL)
public class TestOLGH16970_Web extends JPAFATServletClient {
    private final static String CONTEXT_ROOT = "olgh16970Web";
    private final static String RESOURCE_ROOT = "test-applications/olgh16970/";
    private final static String appFolder = "web";
    private final static String appName = "olgh16970Web";
    ...
    @TestServlets({
                    @TestServlet(servlet = TestOLGH16970Servlet.class, path = CONTEXT_ROOT + "/" + "TestOLGH16970Servlet")
    })
    ...
    public static void setUp() throws Exception {
        ...
        bannerStart(TestOLGH16970_Web.class);
        ...
        System.out.println(TestOLGH16970_Web.class.getName() + " Setting up database tables...");
    ...
    private static void setupTestApplication() throws Exception {
        ...
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh16970.model");
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh16970.testlogic");
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh16970.web");
    ...
    public static void tearDown() throws Exception {
        try {
            ...
            bannerEnd(TestOLGH16970_Web.class, timestart);
        }
    }
}
