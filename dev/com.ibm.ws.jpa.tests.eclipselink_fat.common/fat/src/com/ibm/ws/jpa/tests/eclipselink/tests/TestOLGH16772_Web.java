...
import com.ibm.ws.jpa.olgh16772.web.TestOLGH16772Servlet;
...
@Mode(TestMode.FULL)
public class TestOLGH16772_Web extends JPAFATServletClient {
    private final static String CONTEXT_ROOT = "olgh16772Web";
    private final static String RESOURCE_ROOT = "test-applications/olgh16772/";
    private final static String appFolder = "web";
    private final static String appName = "olgh16772Web";
    ...
    static {
        dropSet.add("JPA_OLGH16772_DROP_${dbvendor}.ddl");
        createSet.add("JPA_OLGH16772_CREATE_${dbvendor}.ddl");
    }

    @Server("EclipseLinkServer")
    @TestServlets({
                    @TestServlet(servlet = TestOLGH16772Servlet.class, path = CONTEXT_ROOT + "/" + "TestOLGH16772Servlet")
    })
    ...
    public static void setUp() throws Exception {
        ...
        bannerStart(TestOLGH16772_Web.class);
    ...
    private static void setupTestApplication() throws Exception {
        ...
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh16772.model");
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh16772.testlogic");
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh16772.web");
    ...
    public static void tearDown() throws Exception {
        try {
            ...
            bannerEnd(TestOLGH16772_Web.class, timestart);
        }
    }
}
