...
import com.ibm.ws.jpa.olgh16588.web.TestOLGH16588Servlet;
...
@Mode(TestMode.FULL)
public class TestOLGH16588_Web extends JPAFATServletClient {
    private final static String CONTEXT_ROOT = "olgh16588Web";
    private final static String RESOURCE_ROOT = "test-applications/olgh16588/";
    private final static String appFolder = "web";
    private final static String appName = "olgh16588Web";
    ...
    @TestServlets({
                    @TestServlet(servlet = TestOLGH16588Servlet.class, path = CONTEXT_ROOT + "/" + "TestOLGH16588Servlet"),
    })
    ...
    public static void setUp() throws Exception {
        ...
        bannerStart(TestOLGH16588_Web.class);
        ...
        System.out.println(TestOLGH16588_Web.class.getName() + " Setting up database tables...");
    ...
    private static void setupTestApplication() throws Exception {
        ...
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh16588.model");
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh16588.testlogic");
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh16588.web");
    ...
    public static void tearDown() throws Exception {
        try {
            ...
            bannerEnd(TestOLGH16588_Web.class, timestart);
        }
    }
}
