...
import com.ibm.ws.jpa.olgh9035.web.TestOLGH9035Servlet;
...
@Mode(TestMode.FULL)
public class TestOLGH9035_Web extends JPAFATServletClient {
    private final static String CONTEXT_ROOT = "olgh9035Web";
    private final static String RESOURCE_ROOT = "test-applications/olgh9035/";
    private final static String appFolder = "web";
    private final static String appName = "olgh9035Web";
    ...
    static {
        dropSet.add("JPA_OLGH9035_DROP_${dbvendor}.ddl");
        createSet.add("JPA_OLGH9035_CREATE_${dbvendor}.ddl");
    }

    @Server("EclipseLinkServer")
    @TestServlets({
                    @TestServlet(servlet = TestOLGH9035Servlet.class, path = CONTEXT_ROOT + "/" + "TestOLGH9035Servlet")
    })
    ...
    public static void setUp() throws Exception {
        ...
        bannerStart(TestOLGH9035_Web.class);
        ...
        System.out.println(TestOLGH9035_Web.class.getName() + " Setting up database tables...");
    ...
    private static void setupTestApplication() throws Exception {
        ...
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh9035.model");
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh9035.testlogic");
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh9035.web");
    ...
    public static void tearDown() throws Exception {
        try {
            ...
            bannerEnd(TestOLGH9035_Web.class, timestart);
        }
    }
}
