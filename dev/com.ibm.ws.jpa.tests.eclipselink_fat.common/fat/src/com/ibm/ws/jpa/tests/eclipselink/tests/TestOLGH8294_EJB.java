...
import com.ibm.ws.jpa.olgh8294.ejb.TestOLGH8294_EJB_SFEx_Servlet;
import com.ibm.ws.jpa.olgh8294.ejb.TestOLGH8294_EJB_SF_Servlet;
import com.ibm.ws.jpa.olgh8294.ejb.TestOLGH8294_EJB_SL_Servlet;
...
public class TestOLGH8294_EJB extends JPAFATServletClient {
    ...
    public static void setUp() throws Exception {
        ...
        bannerStart(TestOLGH8294_EJB.class);
        ...
        System.out.println(TestOLGH8294_EJB.class.getName() + " Setting up database tables...");
    ...
    public static void tearDown() throws Exception {
        try {
            ...
            bannerEnd(TestOLGH8294_EJB.class, timestart);
        }
    }
}
