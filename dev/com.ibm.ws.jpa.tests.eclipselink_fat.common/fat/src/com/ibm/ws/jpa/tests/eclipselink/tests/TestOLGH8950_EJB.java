...
public class TestOLGH8950_EJB extends JPAFATServletClient {
    private final static String CONTEXT_ROOT = "olgh8950Ejb";
    ...
    @TestServlets({
                    @TestServlet(servlet = TestOLGH8950_EJB_SL_Servlet.class, path = CONTEXT_ROOT + "/" + "TestOLGH8950_EJB_SL_Servlet"),
                    @TestServlet(servlet = TestOLGH8950_EJB_SF_Servlet.class, path = CONTEXT_ROOT + "/" + "TestOLGH8950_EJB_SF_Servlet"),
                    @TestServlet(servlet = TestOLGH8950_EJB_SFEx_Servlet.class, path = CONTEXT_ROOT + "/" + "TestOLGH8950_EJB_SFEx_Servlet")
    })
