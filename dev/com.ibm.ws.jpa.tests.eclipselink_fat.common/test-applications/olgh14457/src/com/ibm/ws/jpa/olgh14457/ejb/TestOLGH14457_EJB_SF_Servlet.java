...
@WebServlet(urlPatterns = "/TestOLGH14457_EJB_SF_Servlet")
public class TestOLGH14457_EJB_SF_Servlet extends EJBDBTestVehicleServlet {

    @PostConstruct
    private void initFAT() {
        testClassName = JPATestOLGH14457Logic.class.getName();
        ejbJNDIName = "ejb/OLGH14457SFEJB";
    ...
    @Test
    public void jpa_eclipselink_olgh14457_testCaseExpressionReturnType_EJB_SF_AMJTA_Web() throws Exception {
        final String testName = "jpa_eclipselink_olgh14457_testCaseExpressionReturnType_EJB_SF_AMJTA_Web";
    ...
    @Test
    public void jpa_eclipselink_olgh14457_testCaseExpressionReturnType_EJB_SF_AMRL_Web() throws Exception {
        final String testName = "jpa_eclipselink_olgh14457_testCaseExpressionReturnType_EJB_SF_AMRL_Web";
        final String testMethod = "testCaseExpressionReturnType";
    ...
    @Test
    public void jpa_eclipselink_olgh14457_testCaseExpressionReturnType_EJB_SF_CMTS_Web() throws Exception {
        final String testName = "jpa_eclipselink_olgh14457_testCaseExpressionReturnType_EJB_SF_CMTS_Web";
        final String testMethod = "testCaseExpressionReturnType";
