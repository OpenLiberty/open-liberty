...
public class TestOLGH9018_EJB_SF_Servlet extends EJBDBTestVehicleServlet {
    ...
    @Test
    public void jpa_eclipselink_olgh9018_testUnwrapExclusiveConnection_EJB_SF_AMJTA_Web() throws Exception {
        final String testName = "jpa_eclipselink_olgh9018_testUnwrapExclusiveConnection_EJB_SF_AMJTA_Web";
    ...
    @Test
    public void jpa_eclipselink_olgh9018_testUnwrapExclusiveConnection_EJB_SF_AMRL_Web() throws Exception {
        final String testName = "jpa_eclipselink_olgh9018_testUnwrapExclusiveConnection_EJB_SF_AMRL_Web";
        final String testMethod = "testUnwrapExclusiveConnection";
     ...
     */
//    @Test
//    public void jpa_eclipselink_olgh9018_testUnwrapExclusiveConnection_EJB_SF_CMTS_Web() throws Exception {
//        final String testName = "jpa_eclipselink_olgh9018_testUnwrapExclusiveConnection_EJB_SF_CMTS_Web";
//        final String testMethod = "testUnwrapExclusiveConnection";
