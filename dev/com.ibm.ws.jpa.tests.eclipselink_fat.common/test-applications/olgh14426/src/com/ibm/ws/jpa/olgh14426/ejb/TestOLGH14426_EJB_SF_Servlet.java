...
@WebServlet(urlPatterns = "/TestOLGH14426_EJB_SF_Servlet")
public class TestOLGH14426_EJB_SF_Servlet extends EJBDBTestVehicleServlet {

    @PostConstruct
    private void initFAT() {
        testClassName = JPATestOLGH14426Logic.class.getName();
        ejbJNDIName = "ejb/OLGH14426SFEJB";
    ...
    @Test
    public void jpa_eclipselink_olgh14426_testEclipseLinkCopy_EJB_SF_AMJTA_Web() throws Exception {
        final String testName = "jpa_eclipselink_olgh14426_testEclipseLinkCopy_EJB_SF_AMJTA_Web";
    ...
    @Test
    public void jpa_eclipselink_olgh14426_testEclipseLinkCopy_EJB_SF_AMRL_Web() throws Exception {
        final String testName = "jpa_eclipselink_olgh14426_testEclipseLinkCopy_EJB_SF_AMRL_Web";
        final String testMethod = "testEclipseLinkCopy";
    ...
    @Test
    public void jpa_eclipselink_olgh14426_testEclipseLinkCopy_EJB_SF_CMTS_Web() throws Exception {
        final String testName = "jpa_eclipselink_olgh14426_testEclipseLinkCopy_EJB_SF_CMTS_Web";
        final String testMethod = "testEclipseLinkCopy";
