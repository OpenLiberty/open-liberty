...
@Mode(TestMode.FULL)
public class LibertyOP_BasicConfigTests_oauth_usingSocialConfig extends Social_BasicConfigTests {

    public static Class<?> thisClass = LibertyOP_BasicConfigTests_oauth_usingSocialConfig.class;
    ...
    public static void setUp() throws Exception {
        ...
        genericTestServer = commonSetUp(SocialConstants.SERVER_NAME + ".LibertyOP.social", "server_LibertyOP_basicConfigTests_oauth_usingSocialConfig.xml", SocialConstants.GENERIC_SERVER, extraApps, SocialConstants.DO_NOT_USE_DERBY, startMsgs);
