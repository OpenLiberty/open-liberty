...
/**
 * A bringup test for MDB and POJO message endpoint behavior over checkpoint and restore.
 */
...
public class MsgEndpointTest extends FATServletClient {
    ...
    public static void setUp() throws Exception {
        // Assemble the Ears, Wars, and Rars (oh my)
        ...
        server.addCheckpointRegexIgnoreMessages(CHECKPOINT_IGNORE_REGEX);
        server.startServer();
