...
public class ConcurBMTNonJMS implements MessageListener {
    @Resource
    ...
    public void ejbCreate() {
        System.out.println("--ConcurBMTNonJMS: ejbCreate");
    }
    ...
    public void onMessage(Message message) {
        if (AdapterUtil.inGlobalTransaction()) {
            System.out.println("ConcurBMTNonJMS is in a global transaction");
        } else {
            System.out.println("ConcurBMTNonJMS is in a local transaction");
        }
        System.out.println("--onMessage: ConcurBMTNonJMS got the message :" + message);
    }
    ...
    public void onStringMessage(String message) {
        ...
        System.out.println("--ConcurBMTNonJMS (" + message + "): entering onStringMessage");
        ...
        synchronized (currentSyncObject) {
            ...
            while (concurrentInfo.getConcurrentMsgNumber() > 0) {
                System.out.println("--ConcurBMTNonJMS (" + message + "): in the while block");
                try {
                    Thread.sleep(100);
        ...
        System.out.println("--ConcurBMTNonJMS (" + message + "): exiting onStringMessage.");
    }
