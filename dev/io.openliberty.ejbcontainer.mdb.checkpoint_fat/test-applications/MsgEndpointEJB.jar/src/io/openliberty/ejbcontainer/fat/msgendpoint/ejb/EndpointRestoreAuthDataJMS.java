...
public class EndpointRestoreAuthDataJMS implements MessageListenerAuth {
    ...
    public void ejbCreate() {
        System.out.println("--EndpointRestoreAuthDataJMS: ejbCreate");
    }
    ...
    public void onMessage(Message message) {
        if (AdapterUtil.inGlobalTransaction()) {
            System.out.println("EndpointRestoreAuthDataJMS is in a global transaction");
        } else {
            System.out.println("EndpointRestoreAuthDataJMS is in a local transaction");
        }
        System.out.println("--onMessage: EndpointRestoreAuthDataJMS got the message :" + message);
    }
    ...
    public void onStringMessage(String message) {
        ...
        System.out.println("--onStringMessage: EndpointRestoreAuthDataJMS got the message :" + message);
    ...
    public void onIntegerMessage(Integer message) {
        ...
        System.out.println("--onIntegerMessage: EndpointRestoreAuthDataJMS got the message :" + message);
    }
