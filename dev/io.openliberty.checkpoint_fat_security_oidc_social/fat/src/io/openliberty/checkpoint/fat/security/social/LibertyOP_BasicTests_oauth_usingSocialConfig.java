...
public class LibertyOP_BasicTests_oauth_usingSocialConfig extends SocialCommonTest {
    ...
    public static RepeatTests r = RepeatTests.withoutModification()
                    .andWith(FeatureReplacementAction.EE9_FEATURES().forServers(OP_SERVER, GENERIC_SERVER).fullFATOnly())
                    .andWith(FeatureReplacementAction.EE10_FEATURES().forServers(OP_SERVER, GENERIC_SERVER).fullFATOnly())
                    .andWith(FeatureReplacementAction.EE11_FEATURES().forServers(OP_SERVER, GENERIC_SERVER).fullFATOnly());
