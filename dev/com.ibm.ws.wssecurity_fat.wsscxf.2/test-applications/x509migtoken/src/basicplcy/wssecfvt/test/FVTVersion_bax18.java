...
@WebServiceProvider(targetNamespace = "http://x509mig.libertyfat.test/contract",
                    serviceName = "FatBAX18Service", portName = "UrnX509Token18",
 ...
 * @author Todd Roling
 */
public class FVTVersion_bax18 implements javax.xml.ws.Provider<SOAPMessage> {
    ...
    public SOAPMessage invoke(SOAPMessage request) {
        ...
        try {
            System.out.println("Incoming Client Request as a SOAPMessage(mig bax18)");
            ...
            StringReader respMsg = new StringReader("<SOAP-ENV:Envelope xmlns:SOAP-ENV=\"http://schemas.xmlsoap.org/soap/envelope/\">" +
                                                    "<SOAP-ENV:Body><provider><message>LIBERTYFAT X509 bax18</message></provider></SOAP-ENV:Body>" +
                                                    "</SOAP-ENV:Envelope>");
