...
public class Java9HelperImpl implements DeserializationHelper {

   private static final Logger logger = Logger.getLogger(Java9HelperImpl.class.getName());

   public void addInterfaceFilter(ObjectInputStream ois, Class type) {
      ObjectInputFilter f = new Java9HelperImpl.InterfaceFilter(type);
      ois.setObjectInputFilter(f);
      return;
   }

   // Although this code is identical to the Java 8 code, it is implementing
