...
public class TestExample_EAR extends JPAFATServletClient {
    private final static String CONTEXT_ROOT = "exampleEAR";
    private final static String RESOURCE_ROOT = "test-applications/example/";
    private final static String appName = "exampleEAR";
    ...
    private static void setupTestApplication() throws Exception {
        ...
        jpa_libJar.addPackages(true, "com.ibm.ws.ormdiag.example.jpa");
        ShrinkHelper.addDirectory(jpa_libJar, RESOURCE_ROOT + "resources/jpa");

        //Create an EAR with the WAR & a JPA library bundle
...
//        cel.add(loader);
    ...
    public static void tearDown() throws Exception {
        try {
            ...
            try {
                ...
                server.deleteFileFromLibertyServerRoot("apps/" + appName + ".ear");
    ...
    public void testBasicDump() throws Exception {
        ...
        ORMIntrospectorHelper.verifyApplications(appName, 0, 2,
                                                 new String[] { "wsjpa:wsjar:file:.../" + appName + "_JPALib.jar!/",
                                                                "wsjpa:wsjar:file:.../" + appName + "_WAR.war/WEB-INF/lib/" + appName + "_JPA.jar!/" },
                                                 introspectorData);
        ...
        final String entity1 = "package com.ibm.ws.ormdiag.example.jpa;\n" +
                               ...
                               "\n" +
                               "}";
        classes.add(new JPAClass("com.ibm.ws.ormdiag.example.jpa.ExampleEntity", "wsjpa:wsjar:file:.../" + appName + "_WAR.war/WEB-INF/lib/" + appName + "_JPA.jar!/", entity1));

        ORMIntrospectorHelper.verifyPersistentClasses(classes, introspectorData);

        classes.clear();
        classes.add(new JPAClass("com.ibm.ws.ormdiag.example.jpa.ExampleEntity", "wsjpa:wsjar:file:.../" + appName + "_JPALib.jar!/", entity1));
