...
public class ReflectionUtil {
    ...
    public static Class<?> forName(String name) throws ClassNotFoundException {
        ...
        if (c == null) {
            if (name.endsWith("[]")) {
                ...
                c = Class.forName(nc, true, ((System.getSecurityManager() != null) ? AccessController.doPrivileged(
                ...
                c = Class.forName(name, true, ((System.getSecurityManager() != null) ? AccessController.doPrivileged(
                        new PrivilegedAction<ClassLoader>(){
                            @Override
                            public ClassLoader run() {
                            	return Thread.currentThread().getContextClassLoader();
    ...
    public static Method getMethod(EvaluationContext ctx, Object base, Object property,
        ...
        for (Method m : methods) {
            ...
            //m.getParameterTypes will ALWAYS return an array, it may be of length 0 though
