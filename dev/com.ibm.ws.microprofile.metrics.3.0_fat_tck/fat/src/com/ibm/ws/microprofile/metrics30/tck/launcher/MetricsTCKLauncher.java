 ...
 *******************************************************************************/
package com.ibm.ws.microprofile.metrics30.tck.launcher;
...
public class MetricsTCKLauncher {
    ...
    public void launchTck() throws Exception {
        ...
        MvnUtils.runTCKMvnCmd(server, "com.ibm.ws.microprofile.metrics.3.0_fat_tck", "launchTck", additionalProps);
    }
