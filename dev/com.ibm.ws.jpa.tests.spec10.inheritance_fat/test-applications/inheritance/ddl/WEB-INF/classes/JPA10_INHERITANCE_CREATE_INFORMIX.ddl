...
CREATE TABLE ${schemaname}.AnoJTCDRoot (id INTEGER NOT NULL, name VARCHAR(255), DISC_COL CHAR(255), PRIMARY KEY (id)) LOCK MODE ROW;
...
CREATE TABLE ${schemaname}.AnoSTCDRoot (id INTEGER NOT NULL, name VARCHAR(255), DISC_COL CHAR(255), intVal INTEGER, stringVal1 VARCHAR(255), stringVal2 VARCHAR(255), floatVal REAL, PRIMARY KEY (id)) LOCK MODE ROW;
CREATE TABLE ${schemaname}.AnoSTIDRoot (id INTEGER NOT NULL, name VARCHAR(255), DISC_COL INTEGER, intVal INTEGER, stringVal1 VARCHAR(255), stringVal2 VARCHAR(255), floatVal REAL, PRIMARY KEY (id)) LOCK MODE ROW;
CREATE TABLE ${schemaname}.AnoSTSDRoot (id INTEGER NOT NULL, name VARCHAR(255), DISC_COL VARCHAR(31), stringVal1 VARCHAR(255), stringVal2 VARCHAR(255), floatVal REAL, intVal INTEGER, PRIMARY KEY (id)) LOCK MODE ROW;
CREATE TABLE ${schemaname}.AnoXMLMSCEntity (id NUMERIC(32,0) NOT NULL, name VARCHAR(255), overridenNameAO VARCHAR(255), description VARCHAR(255), PRIMARY KEY (id)) LOCK MODE ROW;
...
CREATE TABLE ${schemaname}.XMLJTCDRoot (id INTEGER NOT NULL, name VARCHAR(255), DISC_COL CHAR(255), PRIMARY KEY (id)) LOCK MODE ROW;
...
CREATE TABLE ${schemaname}.XMLSTCDRoot (id INTEGER NOT NULL, name VARCHAR(255), DISC_COL CHAR(255), stringVal1 VARCHAR(255), stringVal2 VARCHAR(255), intVal INTEGER, floatVal REAL, PRIMARY KEY (id)) LOCK MODE ROW;
CREATE TABLE ${schemaname}.XMLSTIDRoot (id INTEGER NOT NULL, name VARCHAR(255), DISC_COL INTEGER, floatVal REAL, intVal INTEGER, stringVal1 VARCHAR(255), stringVal2 VARCHAR(255), PRIMARY KEY (id)) LOCK MODE ROW;
CREATE TABLE ${schemaname}.XMLSTSDRoot (id INTEGER NOT NULL, name VARCHAR(255), DISC_COL VARCHAR(255), stringVal1 VARCHAR(255), stringVal2 VARCHAR(255), intVal INTEGER, floatVal REAL, PRIMARY KEY (id)) LOCK MODE ROW;
