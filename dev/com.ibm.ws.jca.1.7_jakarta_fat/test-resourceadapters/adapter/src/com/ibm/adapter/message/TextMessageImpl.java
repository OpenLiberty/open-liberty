...
/**
 * <p>This class implements jakarta.jms.TextMessage This is used for TRA to create a TextMessage.</p>
 */
public class TextMessageImpl implements TextMessage {
    ...
    /**
     * @see jakarta.jms.TextMessage#setText(String)
     */
    @Override
    ...
    /**
     * @see jakarta.jms.Message#propertyExists(String)
     */
    @Override
    ...
    /**
     * @see jakarta.jms.Message#getBooleanProperty(String)
     */
    @Override
    ...
    /**
     * @see jakarta.jms.Message#getByteProperty(String)
     */
    @Override
    ...
    /**
     * @see jakarta.jms.Message#getShortProperty(String)
     */
    @Override
    ...
    /**
     * @see jakarta.jms.Message#getIntProperty(String)
     */
    @Override
    ...
    /**
     * @see jakarta.jms.Message#getLongProperty(String)
     */
    @Override
    ...
    /**
     * @see jakarta.jms.Message#getFloatProperty(String)
     */
    @Override
    ...
    /**
     * @see jakarta.jms.Message#getDoubleProperty(String)
     */
    @Override
    ...
    /**
     * @see jakarta.jms.Message#getStringProperty(String)
     */
    @Override
    ...
    /**
     * @see jakarta.jms.Message#getObjectProperty(String)
     */
    @Override
    ...
    /**
     * @see jakarta.jms.Message#setBooleanProperty(String, boolean)
     */
    @Override
    ...
    /**
     * @see jakarta.jms.Message#setByteProperty(String, byte)
     */
    @Override
    ...
    /**
     * @see jakarta.jms.Message#setShortProperty(String, short)
     */
    @Override
    ...
    /**
     * @see jakarta.jms.Message#setIntProperty(String, int)
     */
    @Override
    ...
    /**
     * @see jakarta.jms.Message#setLongProperty(String, long)
     */
    @Override
    ...
    /**
     * @see jakarta.jms.Message#setFloatProperty(String, float)
     */
    @Override
    ...
    /**
     * @see jakarta.jms.Message#setDoubleProperty(String, double)
     */
    @Override
    ...
    /**
     * @see jakarta.jms.Message#setStringProperty(String, String)
     */
    @Override
    ...
    /**
     * @see jakarta.jms.Message#setObjectProperty(String, Object)
     */
    @Override
    ...
    /**
     * @see jakarta.jms.Message#getBody(Class)
     */
    @Override
    ...
    /**
     * @see jakarta.jms.Message#isBodyAssignableTo(Class)
     */
    @Override
    ...
    /**
     * @see jakarta.jms.Message#setJMSDeliveryMode(long)
     */
    @Override
