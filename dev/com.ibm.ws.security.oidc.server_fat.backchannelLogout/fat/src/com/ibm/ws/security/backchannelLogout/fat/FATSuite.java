...
public class FATSuite {
	...
	public static RepeatTests repeat = RepeatTests.with(FeatureReplacementAction.NO_REPLACEMENT().liteFATOnly())
			...
			.andWith(new SecurityTestFeatureEE9RepeatAction().notOnWindows().alwaysAddFeature("servlet-5.0")
					.fullFATOnly())
			.andWith(new SecurityTestFeatureEE10RepeatAction().notOnWindows().alwaysAddFeature("servlet-6.0")
					.fullFATOnly())
			.andWith(new SecurityTestFeatureEE11RepeatAction().notOnWindows().alwaysAddFeature("servlet-6.1")
					.fullFATOnly());
}
