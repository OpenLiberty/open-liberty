...
public class JwtMessageConstants extends com.ibm.ws.security.fat.common.MessageConstants {
    ...
    public static final String CWWKS6005E_CONFIG_NOT_AVAILABLE = "CWWKS6005E";

    public static final String CWWKS6007E_BAD_KEY_ALIAS = "CWWKS6007E";
    public static final String CWWKS6008E_BUILD_ID_UNKNOWN = "CWWKS6008E";
    public static final String CWWKS6009E_INVALID_CLAIM = "CWWKS6009E";

    public static final String CWWKS6015E_INVALID_CLAIM = "CWWKS6015E";
    public static final String CWWKS6016E_BAD_KEY_ALIAS = "CWWKS6016E";
    public static final String CWWKS6017E_BAD_EMPTY_TOKEN = "CWWKS6017E";
    public static final String CWWKS6018E_CLAIM_MUST_BE_GT_ZERO = "CWWKS6018E";
    public static final String CWWKS6019E_BAD_DATA_TYPE = "CWWKS6019E";
    public static final String CWWKS6020E_CAN_NOT_CAST = "CWWKS6020E";
    public static final String CWWKS6021E_CLAIMS_ARE_NOT_VALID = "CWWKS6021E";
    ...
    public static final String CWWKS6036E_INVALID_KEY = "CWWKS6036E";
    public static final String CWWKS6037E_INVALID_SIG_ALG = "CWWKS6037E";

    public static final String CWWKS6039E_JWK_BAD_SIG_ALG = "CWWKS6039E";
    ...
    public static final String CWWKS6042E_BAD_EXP_TIME = "CWWKS6042E";
    ...
    public static final String CWWKS6057E_BAD_CTY_VALUE = "CWWKS6057E";
    public static final String CWWKS6058W_KEY_MGMT_KEY_MISSING = "CWWKS6058W";

    public static final String CWWKS6062E_PLAINTEXT_KEY = "CWWKS6062E";
    ...
    public static final String CWWKS6065E_JWE_DOES_NOT_CONTAIN_JWS = "CWWKS6065E";
