...
public abstract class AbstractOpenTelemetryProducer {

    private static final TraceComponent tc = Tr.register(AbstractOpenTelemetryProducer.class);
    ...
    public OpenTelemetryInfo getOpenTelemetryInfo() {
        try {
            ...
            if (!checkDisabled(telemetryProperties)) {
                OpenTelemetry openTelemetry = AccessController.doPrivileged(getSDKBuilderPrivilegedAction(telemetryProperties));
    ...
    protected Resource customizeResource(Resource resource, ConfigProperties c) {
