...
@Stateless(name = "DMIPriYesInhAnoOvrdTestSLEJB")
@Local(DMIPriYesInhAnoOvrdTestSLEJBLocal.class)
@TransactionManagement(javax.ejb.TransactionManagementType.BEAN)
public class DMIPriYesInhAnoOvrdTestSLEJB extends DMIPriYesInhAnoOvrdTestSuperclass {
    ...
    @SuppressWarnings("unused")
    @PersistenceUnit(unitName = "OVRD_EJB_JTA")
    ...
    @SuppressWarnings("unused")
    @PersistenceUnit(unitName = "OVRD_COMMON_RL") //, name="jpa/DMIPriYesInhAnoOvrdTestEJB/ovdemf_amrl_common_ejb")
    ...
    @SuppressWarnings("unused")
    @PersistenceUnit(unitName = "OVRD_EJB_RL")
