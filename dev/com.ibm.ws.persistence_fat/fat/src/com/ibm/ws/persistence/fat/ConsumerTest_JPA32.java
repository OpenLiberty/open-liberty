...
public class ConsumerTest_JPA32 extends FATServletClient {
    ...
    @Server("com.ibm.ws.persistence.consumer.jpa32")
    ...
    public static void beforeClass() throws Exception {
        ...
        JakartaEEAction.transformApp(someArchive, EEVersion.EE11);
        ...
        JakartaEEAction.transformApp(warArchive, EEVersion.EE11);
