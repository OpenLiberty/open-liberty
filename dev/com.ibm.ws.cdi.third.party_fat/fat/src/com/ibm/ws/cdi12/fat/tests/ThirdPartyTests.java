...
public class ThirdPartyTests extends LoggingTest {
    ...
    public static void setUp() throws Exception {
        ...
        WebArchive deltaspikeTest = ShrinkWrap.create(WebArchive.class, "deltaspikeTest.war")
                        ...
                        .add(new FileAsset(new File("test-applications/deltaspikeTest.war/resources/WEB-INF/lib/quartz-2.3.2.jar")), "/WEB-INF/lib/quartz-2.3.2.jar")
                        ...
                        .add(new FileAsset(new File("test-applications/deltaspikeTest.war/resources/WEB-INF/lib/slf4j-jdk14-1.7.36.jar")), "/WEB-INF/lib/slf4j-jdk14-1.7.36.jar")
                        .add(new FileAsset(new File("test-applications/deltaspikeTest.war/resources/WEB-INF/lib/slf4j-api-1.7.36.jar")), "/WEB-INF/lib/slf4j-api-1.7.36.jar")
