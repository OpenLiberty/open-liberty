...
@Component(configurationPid = "com.ibm.ws.security.common.token.propagation.tokenpropagationhelper", configurationPolicy = ConfigurationPolicy.OPTIONAL, name = "TokenPropagationHelper", service = TokenPropagationHelper.class, immediate = true)
    ...
    public static synchronized boolean pushSubject(String username) {
        ...
        try {
            ...
            FFDCFilter.processException(e,
                    ...
                    new Object[] { username });
            Tr.error(tc, "ERROR_AUTHENTICATE", new Object[] { username, e }); // CWWKS6103E
            return false;
        } catch (Exception e) {
            FFDCFilter.processException(e,
                    TokenPropagationHelper.class.getName(), "pushSubject",
