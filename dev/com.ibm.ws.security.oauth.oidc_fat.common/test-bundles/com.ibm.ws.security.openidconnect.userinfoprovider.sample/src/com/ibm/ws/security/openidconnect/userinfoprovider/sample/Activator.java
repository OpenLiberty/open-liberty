...
public class Activator implements BundleActivator, ManagedServiceFactory {
    ...
    String _cfg_pid = "UserinfoProvider";

    BundleContext _context = null;
    Hashtable<String, ServiceRegistration<UserinfoProvider>> userinfoProviderRef =
                    new Hashtable<String, ServiceRegistration<UserinfoProvider>>(10, 5);
                    ...
                    throws ConfigurationException
    {
        ...
        if (_context != null) {
            System.out.println("register userinfo provider service upon pid:" + pid);
            ...
            UserinfoProvider service = new CustomUserinfoProvider(serviceProps);
            ServiceRegistration<UserinfoProvider> sr = _context.registerService(UserinfoProvider.class,
            		service, serviceProps);
            userinfoProviderRef.put(pid, sr);
        }
    }
    ...
    public void deleted(String pid) {
        ...
        ServiceRegistration<UserinfoProvider> sr = userinfoProviderRef.get(pid);
        sr.unregister();
        userinfoProviderRef.remove(pid);
    }
