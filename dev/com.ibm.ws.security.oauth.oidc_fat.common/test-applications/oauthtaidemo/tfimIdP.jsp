	...
	<tbody>
		<TR align="left">
			...
			<TD bgcolor="white" width="250">
				...
				type="text" name="Sso_URL" size="80" value="https://host.com:9443/sps/LiangIdp1/saml20/logininitial">
				</FONT>
			</TD>
		</TR>
		...
		<TR align="left">
			...
			<TD bgcolor="white" width="250"><FONT color="black"><INPUT
				type="text" name="PartnerId" size="80" value="https://host.com:9443/samlsps/acs"></FONT></TD>
		</TR>
		...
		<TR align="left">
			...
			<TD bgcolor="white" width="250"><FONT color="black"><INPUT
				type="text" name="target" size="80" value="https://host.com:9443/samldemo/sniff"></FONT></TD>
		</TR>
		...
		<TR align="left">
			...
			<TD bgcolor="white" width="250"><FONT color="black"><INPUT
				type="text" name="AllowCreate" size="80" value="false"></FONT></TD>
		</TR>
	</tbody>
</table>
</center>
