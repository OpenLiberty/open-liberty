...
<%
    ...
    if ("true".equals(request.getParameter("auto"))) {
        System.out.println("jwtNoClientSecret.jsp: in auto");
        submit = true;
        ...
        System.out.println("jwtNoClientSecret.jsp: client_id: " + clientId);
        System.out.println("jwtNoClientSecret.jsp: jwt_bearer_token: " + jwtBearerToken);
        System.out.println("jwtNoClientSecret.jsp: token_endpoint: " + tokenEndpoint);
...
<form name="tokform" method="POST" action="jwtNoClientSecret.jsp">
...
if (submit) {
        ...
        System.out.println("jwtNoClientSecret.jsp: Start Test Case:  " + testName + "===============================");
        System.out.println("jwtNoClientSecret.jsp: opened the connection to " + urlToken + ": " + connToken);
        ...
        // read response
        connToken.connect();
        System.out.println("jwtNoClientSecret.jsp string buffer: " + sb.toString());
        System.out.println("jwtNoClientSecret.jsp: connected");
        InputStream streamToken = null;
        int responseCodeToken = connToken.getResponseCode();
        System.out.println("jwtNoClientSecret.jsp: got response code: " + responseCodeToken);
...
System.out.println("jwtNoClientSecret.jsp: End Test Case:  " + testName + "===============================");
        }   
} // end submit     
