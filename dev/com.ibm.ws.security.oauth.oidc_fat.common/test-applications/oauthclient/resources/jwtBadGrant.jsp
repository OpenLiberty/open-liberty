...
<%
    ...
    if ("true".equals(request.getParameter("auto"))) {
        System.out.println("jwt.jsp: in auto");
        submit = true;
...
<form name="tokform" method="POST" action="jwt.jsp">
...
if (submit) {
        ...
        System.out.println("jwt.jsp: Start Test Case:  " + testName + "===============================");
        System.out.println("jwt.jsp: opened the connection to " + urlToken + ": " + connToken);
        ...
        sb.append("client_id=" + clientId + 
                 ...
                 "&grant_type=urn:ietf:params:oauth:grant-type:foofoo" +
        ...
        // read response
        connToken.connect();
        System.out.println("jwt.jsp string buffer: " + sb.toString());
...
System.out.println("jwt.jsp: End Test Case:  " + testName + "===============================");
        }   
} // end submit     
