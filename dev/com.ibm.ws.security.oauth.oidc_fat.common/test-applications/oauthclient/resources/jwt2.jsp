...
<%
    ...
    String jwtBearerToken2 = "ENTER HERE";
    ...
    if ("true".equals(request.getParameter("auto"))) {
        ...
        action = request.getParameter("action") == null ? "POST" : request.getParameter("action")  ;
        clientId = request.getParameter("client_id");
        clientSecret = request.getParameter("client_secret");
        jwtBearerToken = request.getParameter("jwt_bearer_token");
        jwtBearerToken2 = request.getParameter("jwt_bearer_token2");
...
<form name="tokform" method="POST" action="jwt2.jsp">
<input type="hidden" name="auto" value="true" />
<table width=800>
<tr><td>Client Id</td><td><input type="text" name="testCaseName" value="<%=testName%>" /></td></tr>
<tr><td>Invoke action</td><td><input type="text" name="action" value="<%=action%>" /></td></tr>
...
<tr><td>JWT-Bearer Token</td><td><input type="text" name="jwt_bearer_token2" value="<%=jwtBearerToken2%>" size="360" /></td></tr>
...
if (submit) {
        ...
        System.out.println("jwt2.jsp: Start Test Case:  " + testName + "===============================");
        System.out.println("jwt2.jsp: opened the connection to " + urlToken + ": " + connToken);
        connToken.setRequestMethod(action);
        ...
        // read response
        connToken.connect();
        System.out.println("jwt2.jsp string buffer: " + sb.toString());
        System.out.println("jwt2.jsp: connected");
        InputStream streamToken = null;
        int responseCodeToken = connToken.getResponseCode();
        System.out.println("jwt2.jsp: got response code: " + responseCodeToken);
...
System.out.println("jwt2.jsp: End Test Case:  " + testName + "===============================");
        }   
} // end submit     
