...
<%
    ...
    if ("true".equals(request.getParameter("auto"))) {
        ...
        System.out.println("jwt.jsp: client_id: " + clientId);
        System.out.println("jwt.jsp: client_secret: " + clientSecret);
        System.out.println("jwt.jsp: jwt_bearer_token: " + jwtBearerToken);
        System.out.println("jwt.jsp: token_endpoint: " + tokenEndpoint);
...
<form name="tokform" method="GET"> action="jwt.jsp">
...
if (submit) {
        ...
        System.out.println("jwtGet.jsp: Start Test Case:  " + testName + "===============================");
        System.out.println("jwtGet.jsp: opened the connection to " + urlToken + ": " + connToken);
        ...
        // read response
        connToken.connect();
        System.out.println("jwt.jsp: connected");
        InputStream streamToken = null;
        int responseCodeToken = connToken.getResponseCode();
        System.out.println("jwt.jsp: got response code: " + responseCodeToken);
...
System.out.println("jwtGet.jsp: End Test Case:  " + testName + "===============================");
        }   
} // end submit     
