...
<%
    ...
    if ("true".equals(request.getParameter("auto"))) {
        System.out.println("jwtNoClientId.jsp: in auto");
        submit = true;
        ...
        System.out.println("jwtNoClientId.jsp: client_secret: " + clientSecret);
        System.out.println("jwtNoClientId.jsp: jwt_bearer_token: " + jwtBearerToken);
        System.out.println("jwtNoClientId.jsp: token_endpoint: " + tokenEndpoint);
...
<form name="tokform" method="POST" action="jwtNoClientId.jsp">
...
if (submit) {
        ...
        System.out.println("jwtNoClientId.jsp: Start Test Case:  " + testName + "===============================");
        System.out.println("jwtNoClientId.jsp: opened the connection to " + urlToken + ": " + connToken);
        ...
        // read response
        connToken.connect();
        System.out.println("jwtNoClientId.jsp string buffer: " + sb.toString());
        System.out.println("jwtNoClientId.jsp: connected");
        InputStream streamToken = null;
        int responseCodeToken = connToken.getResponseCode();
        System.out.println("jwtNoClientId.jsp: got response code: " + responseCodeToken);
...
System.out.println("jwtNoClientId.jsp: End Test Case:  " + testName + "===============================");
        }   
} // end submit     
