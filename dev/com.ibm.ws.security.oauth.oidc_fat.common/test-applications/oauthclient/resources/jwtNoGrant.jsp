...
<%
    ...
    String tokenEndpoint = urlBase + "/oidc/v10/endpoint/OidcConfigSample/token";
    String jwt_scope = "openid profile";
    String extraParams = "";

    
    if ("true".equals(request.getParameter("auto"))) {
        System.out.println("jwtNoGrant.jsp: in auto");
        submit = true;
        ...
        System.out.println("jwtNoGrant.jsp: client_id: " + clientId);
        System.out.println("jwtNoGrant.jsp: client_secret: " + clientSecret);
        System.out.println("jwtNoGrant.jsp: jwt_bearer_token: " + jwtBearerToken);
        System.out.println("jwtNoGrant.jsp: token_endpoint: " + tokenEndpoint);
...
<form name="tokform" method="POST" action="jwtNoGrant.jsp">
...
if (submit) {
        ...
        System.out.println("jwtNoGrant.jsp: Start Test Case:  " + testName + "===============================");
        System.out.println("jwtNoGrant.jsp: opened the connection to " + urlToken + ": " + connToken);
        ...
        // read response
        connToken.connect();
        System.out.println("jwtNoGrant.jsp string buffer: " + sb.toString());
        System.out.println("jwtNoGrant.jsp: connected");
        InputStream streamToken = null;
        int responseCodeToken = connToken.getResponseCode();
        System.out.println("jwtNoGrant.jsp: got response code: " + responseCodeToken);
...
System.out.println("jwtNoGrant.jsp: End Test Case:  " + testName + "===============================");
        }   
} // end submit     
