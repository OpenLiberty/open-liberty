 ...
 * Form Login Servlet
 */
public class FormLoginServletE2E1 extends FlexibleBaseServlet {
    private static final long serialVersionUID = 1L;

    public FormLoginServletE2E1() {
        super("FormLoginServletE2E1");
     	...
     	mySteps.add(new ProcessAccessTokenStep()); 
