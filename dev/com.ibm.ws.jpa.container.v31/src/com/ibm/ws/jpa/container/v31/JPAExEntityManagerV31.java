...
public class JPAExEntityManagerV31 extends JPAExEntityManager {
    private static final TraceComponent tc = Tr.register(JPAExEntityManagerV31.class,
                                                         JPA_TRACE_GROUP,
                                                         JPA_RESOURCE_BUNDLE_NAME);

    public JPAExEntityManagerV31(JPAPuId puRefId,
                                 JPAPUnitInfo puInfo,
                                 J2EEName j2eeName,
                                 String refName,
                                 Map<?, ?> properties,
