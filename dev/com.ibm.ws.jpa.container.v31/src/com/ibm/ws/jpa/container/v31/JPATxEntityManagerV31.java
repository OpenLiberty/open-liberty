...
public class JPATxEntityManagerV31 extends JPATxEntityManager {
    private static final TraceComponent tc = Tr.register(JPATxEntityManagerV31.class,
                                                         JPA_TRACE_GROUP,
                                                         JPA_RESOURCE_BUNDLE_NAME);

    public JPATxEntityManagerV31(JPAPuId puRefId, JPAPUnitInfo puInfo, J2EEName j2eeName, String refName, Map<?, ?> properties, boolean isUnsynchronized,
    ...
    protected JPATxEmInvocation createJPATxEmInvocation(UOWCoordinator uowCoord, EntityManager em) {
        return new JPATxEmInvocationV31(uowCoord, em, this, isTxUnsynchronized());
    }

    @Override
    protected JPANoTxEmInvocation createJPANoTxEmInvocation(UOWCoordinator uowCoord, EntityManager em) {
        return new JPANoTxEmInvocationV31(uowCoord, em, this, ivUnsynchronized);
    }
