...
public class JPANoTxEmInvocationV31 extends JPANoTxEmInvocation {
    protected JPANoTxEmInvocationV31(UOWCoordinator uowCoord, EntityManager em, JPAEntityManager jpaEm, boolean txIsUnsynchronized) {
