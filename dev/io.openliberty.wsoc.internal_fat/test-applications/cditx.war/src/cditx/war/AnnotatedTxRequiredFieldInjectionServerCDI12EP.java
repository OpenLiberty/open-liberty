...
// JavaScript to access from a WebSocket capable browser would be:  ws://<Host Name>:<port>/<Context-Root>/EPTxRequiredFieldInjectionCDI12

@ServerEndpoint(value = "/EPTxRequiredFieldInjectionCDI12")
public class AnnotatedTxRequiredFieldInjectionServerCDI12EP {
    ...
    public @Inject CounterTxRequiredApplicationScoped txAppScopedCounter;
    ...
    @Inject
    public AnnotatedTxRequiredFieldInjectionServerCDI12EP(CounterDependentScoped input) {
        if (input != null) {
    ...
    public AnnotatedTxRequiredFieldInjectionServerCDI12EP() {
    ...
    public void onOpen(Session session, EndpointConfig ec) {
        System.out.println("TxRequired: into onOpen >");
        currentSession = session;
        txAppScopedCounter.getNext();
        // we should be able to use injected stuff here
        responseMessage = N1.toString();
        System.out.println("TxRequired: exit onOpen < " + responseMessage);
    }

    @OnMessage
    public void receiveMessageCDI(String message) {
        System.out.println("TxRequired: into receiveMessageCDI >");
        ...
        System.out.println("TxRequired: exit receiveMessage < " + responseMessage);
    }
