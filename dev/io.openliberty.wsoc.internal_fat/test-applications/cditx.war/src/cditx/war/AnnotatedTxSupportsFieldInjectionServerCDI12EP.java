...
// JavaScript to access from a WebSocket capable browser would be:  ws://<Host Name>:<port>/<Context-Root>/EPTxSupportsFieldInjectionCDI12

@ServerEndpoint(value = "/EPTxSupportsFieldInjectionCDI12")
public class AnnotatedTxSupportsFieldInjectionServerCDI12EP {
    ...
    public @Inject CounterTxSupportsApplicationScoped txAppScopedCounter;
    ...
    @Inject
    public AnnotatedTxSupportsFieldInjectionServerCDI12EP(CounterDependentScoped input) {
        if (input != null) {
    ...
    public AnnotatedTxSupportsFieldInjectionServerCDI12EP() {
    ...
    public void onOpen(Session session, EndpointConfig ec) {
        System.out.println("TxSupports: into onOpen >");
        currentSession = session;
        txAppScopedCounter.getNext();
        // we should be able to use injected stuff here
        responseMessage = N1.toString();
        System.out.println("TxSupports: exit onOpen < " + responseMessage);
    }

    @OnMessage
    public void receiveMessageCDI(String message) {
        System.out.println("TxSupports: into receiveMessageCDI >");
        ...
        System.out.println("TxSupports: exit receiveMessage < " + responseMessage);
    }
