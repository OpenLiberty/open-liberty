...
@ApplicationScoped
@Named
public class CounterTxMandatoryApplicationScoped extends Counter {
    ...
    public int getNext() {
        System.out.println("CounterTxMandatoryApplicationScoped getNext() called");
        ...
        try {
            ...
            System.out.println("CounterTxMandatoryApplicationScoped getNext() caught exc: " + e);
            e.printStackTrace();
        }
