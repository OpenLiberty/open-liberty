...
// JavaScript to access from a WebSocket capable browser would be:  ws://<Host Name>:<port>/<Context-Root>/EPTxRequiresNewFieldInjectionCDI12

@ServerEndpoint(value = "/EPTxRequiresNewFieldInjectionCDI12")
public class AnnotatedTxRequiresNewFieldInjectionServerCDI12EP {
    ...
    public @Inject CounterTxRequiresNewApplicationScoped txAppScopedCounter;
    ...
    @Inject
    public AnnotatedTxRequiresNewFieldInjectionServerCDI12EP(CounterDependentScoped input) {
        if (input != null) {
    ...
    public AnnotatedTxRequiresNewFieldInjectionServerCDI12EP() {
    ...
    public void onOpen(Session session, EndpointConfig ec) {
        System.out.println("TxRequiresNew: into onOpen >");
        currentSession = session;
        txAppScopedCounter.getNext();
        // we should be able to use injected stuff here
        responseMessage = N1.toString();
        System.out.println("TxRequiresNew: exit onOpen < " + responseMessage);
    }

    @OnMessage
    public void receiveMessageCDI(String message) {
        System.out.println("TxRequiresNew: into receiveMessageCDI >");
        ...
        System.out.println("TxRequiresNew: exit receiveMessage < " + responseMessage);
    }
