...
@ApplicationScoped
@Named
public class CounterTxRequiredApplicationScoped extends Counter {
    ...
    public int getNext() {
        System.out.println("CounterTxRequiredApplicationScoped getNext() called");
        ...
        try {
            ...
            System.out.println("CounterTxRequiredApplicationScoped getNext() caught exc: " + e);
            e.printStackTrace();
        }
