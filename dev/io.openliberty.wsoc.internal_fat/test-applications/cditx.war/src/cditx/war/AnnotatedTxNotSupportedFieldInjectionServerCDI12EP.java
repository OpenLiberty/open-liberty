...
// JavaScript to access from a WebSocket capable browser would be:  ws://<Host Name>:<port>/<Context-Root>/EPTxNotSupportedFieldInjectionCDI12

@ServerEndpoint(value = "/EPTxNotSupportedFieldInjectionCDI12")
public class AnnotatedTxNotSupportedFieldInjectionServerCDI12EP {
    ...
    public @Inject CounterTxNotSupportedApplicationScoped txAppScopedCounter;
    ...
    @Inject
    public AnnotatedTxNotSupportedFieldInjectionServerCDI12EP(CounterDependentScoped input) {
        if (input != null) {
    ...
    public AnnotatedTxNotSupportedFieldInjectionServerCDI12EP() {
    ...
    public void onOpen(Session session, EndpointConfig ec) {
        System.out.println("TxNotSupported: into onOpen >");
        currentSession = session;
        txAppScopedCounter.getNext();
        // we should be able to use injected stuff here
        responseMessage = N1.toString();
        System.out.println("TxNotSupported: exit onOpen < " + responseMessage);
    }

    @OnMessage
    public void receiveMessageCDI(String message) {
        System.out.println("TxNotSupported: into receiveMessageCDI >");
        ...
        System.out.println("TxNotSupported: exit receiveMessage < " + responseMessage);
    }
