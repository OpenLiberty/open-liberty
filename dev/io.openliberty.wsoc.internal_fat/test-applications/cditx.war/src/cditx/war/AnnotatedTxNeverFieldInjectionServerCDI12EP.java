...
// JavaScript to access from a WebSocket capable browser would be:  ws://<Host Name>:<port>/<Context-Root>/EPTxNeverFieldInjectionCDI12

@ServerEndpoint(value = "/EPTxNeverFieldInjectionCDI12")
public class AnnotatedTxNeverFieldInjectionServerCDI12EP {
    ...
    public @Inject CounterTxNeverApplicationScoped txAppScopedCounter;
    ...
    @Inject
    public AnnotatedTxNeverFieldInjectionServerCDI12EP(CounterDependentScoped input) {
        if (input != null) {
    ...
    public AnnotatedTxNeverFieldInjectionServerCDI12EP() {
    ...
    public void receiveMessageCDI(String message) {
        ...
        System.out.println("TxNever: exit receiveMessage < " + responseMessage);
    }
