...
public class AsyncEventsTest extends FATServletClient {
    ...
    @Server("cdi20AsyncEventsServer")
    @TestServlets({ @TestServlet(servlet = AsyncEventsServlet.class, path = APP_NAME + "/asyncevents") })
    public static LibertyServer server1;

    @BeforeClass
    public static void setUp() throws Exception {
        // Create a WebArchive that will have the file name 'asyncEventsApp.war' once it's written to a file
        ...
        WebArchive app1 = ShrinkWrap.create(WebArchive.class, APP_NAME + ".war")
                        .addPackages(true, "asyncEventsApp.web")
                        .addAsWebInfResource(new File("test-applications/" + APP_NAME + "/resources/index.jsp"));
        // Write the WebArchive to 'publish/servers/cdi20AsyncEventsServer/apps/asyncEventsApp.war' and print the contents
