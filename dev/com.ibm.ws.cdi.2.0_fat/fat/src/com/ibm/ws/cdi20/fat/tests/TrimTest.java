...
public class TrimTest extends FATServletClient {
    public static final String APP_NAME = "trimTestApp";

    @Server("cdi20BasicServer")
    @TestServlets({ @TestServlet(servlet = TrimTestServlet.class, path = APP_NAME + "/trimTest") })
