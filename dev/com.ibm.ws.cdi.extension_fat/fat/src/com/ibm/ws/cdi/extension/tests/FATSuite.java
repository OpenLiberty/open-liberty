...
public class FATSuite {
    ...
    @ClassRule
    public static RepeatTests r = RepeatTests.withoutModification().andWith(FeatureReplacementAction.EE8_FEATURES()).andWith(FeatureReplacementAction.EE9_FEATURES().removeFeature("usr:cdi.helloworld.extension-1.0").removeFeature("usr:cdi.spi.extension-1.0").removeFeature("usr:cdi.spi.constructor.fail.extension-1.0").removeFeature("cdi.internals-1.0").addFeature("usr:cdi.helloworld.extension-3.0").addFeature("usr:cdi.spi.extension-3.0").addFeature("usr:cdi.spi.constructor.fail.extension-3.0").addFeature("cdi.internals-3.0"));
