...
import com.ibm.ws.sib.netty.jfapchannel.JMSHeartbeatHandler;
import com.ibm.ws.sib.netty.jfapchannel.NettyNetworkConnectionFactory;
import com.ibm.ws.sib.netty.jfapchannel.NettyToWsBufferDecoder;
import com.ibm.ws.sib.netty.jfapchannel.WsBufferToNettyEncoder;
...
//    private ServerBootstrapExtended serverBootstrap;
    ...
    private class JMSTCPInitializer extends ChannelInitializerWrapper {
        ...
        protected void initChannel(Channel ch) throws Exception {
            ...
            ch.attr(JMSServerHandler.CHAIN_ATTR_KEY).set(_chainName);
