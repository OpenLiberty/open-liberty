...
/**
 * This is the test class that will run basic OpenID Connect RP tests with an RP configuration (using access token and X509 cert) which includes discovery of OP endpoints.
