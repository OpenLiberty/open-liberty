...
/**
 * This is the test class that will run  OpenID Connect RP (using JWT Token with JWK cert) tests with an RP configuration which includes discovery of OP endpoints.
 ...
 *     
 * This test class extends GenericOidcClientTests and exercises the authorization, token, userinfo and jwk endpoints after discovery.
...
public class OidcClientDiscoveryJWTBasicTests extends GenericOidcClientTests {

    @SuppressWarnings("serial")
    @BeforeClass
    public static void setUp() throws Exception {

        thisClass = OidcClientDiscoveryJWTBasicTests.class;
     ...
     * <LI>
     * <LI>Test is showing a good main path flow between RP and OP using discovered endpoints. In this scenario, a message is logged to indicate that the values
