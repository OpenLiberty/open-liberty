...
public class RuntimeModeIgnoresMPConfigTest {

    private static final String SERVER_NAME = "spanTestServer";
    private static final String SERVICE_NAME = "Test service";

    private static final Class<RuntimeModeIgnoresMPConfigTest> c = RuntimeModeIgnoresMPConfigTest.class;

    public static JaegerContainer jaegerContainer = new JaegerContainer().withLogConsumer(new SimpleLogConsumer(RuntimeModeIgnoresMPConfigTest.class, "jaeger"));
    ...
    public static void setUp() throws Exception {
        ...
        //Because we're
        PropertiesAsset ignoredConfig = new PropertiesAsset().addProperty("otel.service.name", "multi-app-1");

        // Construct the test application
        WebArchive jaegerTest = ShrinkWrap.create(WebArchive.class, "spanTest.war")
                                          .addPackage(TestResource.class.getPackage())
                                          .addAsResource(ignoredConfig, "META-INF/microprofile-config.properties");;
