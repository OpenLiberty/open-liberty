...
@SkipIfSysProp(OS_ZOS) //Agent214 crashes on ZOS because it tries to read /proc as UTF-8
public class Agent214Test {

    private static final Class<Agent214Test> c = Agent214Test.class;
    ...
    public static RepeatTests repeat = TelemetryActions.telemetry21Repeats(SERVER_NAME);
    ...
    public void testBasic() throws Exception {
        ...
        if (TelemetryActions.mpTelemetry21EE7orEE8IsActive()) {
            assertThat(span, JaegerSpanMatcher.isSpan().withTraceId(traceId)
                                              .withAttribute(HttpAttributes.HTTP_ROUTE, "/agentTest")
    ...
    public void testPathParameter() throws Exception {
        ...
        assertThat(span, JaegerSpanMatcher.isSpan().withTraceId(traceId)
                                          .withAttribute(HttpAttributes.HTTP_ROUTE, "/agentTest/pathparameter/{parameter}")
                                          .withAttribute(HttpAttributes.HTTP_REQUEST_METHOD, "GET"));
    ...
    public void testHttpClient() throws Exception {
        ...
        assertThat(root, isSpan().withKind(SERVER)
                                 .withAttribute(HttpAttributes.HTTP_ROUTE, "/agentTest/httpclient"));
        ...
        assertThat(child3, isSpan().withKind(SERVER)
                                   .withAttribute(HttpAttributes.HTTP_ROUTE, "/agentTest/httpclient/target"));
    }
    ...
    public void testJaxRSClient() throws Exception {
        ...
        Span root = findOneFrom(spans, hasNoParent());
        assertThat(root, isSpan().withKind(SERVER)
                                 .withAttribute(HttpAttributes.HTTP_ROUTE, "/agentTest/jaxrsclient"));
    ...
    public void testMPRestClient() throws Exception {
        ...
        Span root = findOneFrom(spans, hasNoParent());
        assertThat(root, isSpan().withKind(SERVER)
                                 .withAttribute(HttpAttributes.HTTP_ROUTE, "/agentTest/mprestclient"));
