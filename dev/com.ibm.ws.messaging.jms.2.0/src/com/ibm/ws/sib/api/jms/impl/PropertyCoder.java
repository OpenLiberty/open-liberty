...
import com.ibm.ws.sib.jms.util.UTF8Coder;
...
class ShortStringPropertyCoder extends PropertyCoder {
  ...
  void encodeProperty(ByteArrayOutputStream baos, Object value) throws JMSException {
    ...
    if (value instanceof String) {
      ...
      int len = UTF8Coder.getEncodedLength(strVal);
      ...
      UTF8Coder.encode(buffer, ArrayUtil.SHORT_SIZE, strVal); // Encode in the String value itself
