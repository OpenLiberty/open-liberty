...
public class FATSuite extends PostgresqlContainerSuite {
    ...
    .andWith(FeatureReplacementAction.EE10_FEATURES().conditionalFullFATOnly(FeatureReplacementAction.GREATER_THAN_OR_EQUAL_JAVA_17).forServers(DBRerouteTest.serverNames))
    .andWith(FeatureReplacementAction.EE11_FEATURES().forServers(DBRerouteTest.serverNames));
}
