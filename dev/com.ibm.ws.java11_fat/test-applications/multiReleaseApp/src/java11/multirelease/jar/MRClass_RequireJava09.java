...
public class MRClass_RequireJava09 {
    ...
    // This class should be in /META-INF/versions/9/java11/cnfe/web/ and only loadable on Java 9+

    private static final int JAVA_VERSION = 9;
