...
CREATE TABLE JPAXMLEmpBean (empid integer NOT NULL, bonus DOUBLE PRECISION, execLevel CHAR(1), hireDate DATE, hireTime TIME, hireTimestamp TIMESTAMP, isManager BOOL, name VARCHAR(40), rating INTEGER, salary DOUBLE PRECISION, DEPT_DEPTNO INTEGER, HOME_STREET VARCHAR(255), WORK_STREET VARCHAR(255), PRIMARY KEY (empid));
