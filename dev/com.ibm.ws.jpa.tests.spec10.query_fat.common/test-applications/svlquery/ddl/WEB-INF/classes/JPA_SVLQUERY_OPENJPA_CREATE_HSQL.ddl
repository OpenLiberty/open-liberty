...
CREATE TABLE ${schemaname}.JPAXMLDeptBean (deptno INTEGER NOT NULL, budget REAL, name VARCHAR(40), MGR_EMPID integer, charityAmount NUMERIC, charityName VARCHAR(40), REPORTSTO_DEPTNO INTEGER, PRIMARY KEY (deptno));
CREATE TABLE ${schemaname}.JPAXMLEmpBean (empid integer NOT NULL, bonus NUMERIC, execLevel INTEGER, hireDate DATE, hireTime TIME, hireTimestamp TIMESTAMP, isManager BIT, name VARCHAR(40), rating INTEGER, salary NUMERIC, DEPT_DEPTNO INTEGER, HOME_STREET VARCHAR(255), WORK_STREET VARCHAR(255), PRIMARY KEY (empid));
CREATE TABLE ${schemaname}.JPAXMLLineItemPartTab (lid INTEGER NOT NULL, cost NUMERIC, quantity INTEGER, PRODUCT_PID INTEGER, ORDER_OID INTEGER, PRIMARY KEY (lid));
CREATE TABLE ${schemaname}.JPAXMLOrderPartTab (oid INTEGER NOT NULL, amount NUMERIC, delivered BIT, CUSTOMER_ID INTEGER, PRIMARY KEY (oid));
CREATE TABLE ${schemaname}.JPAXMLPartTab (partno INTEGER NOT NULL, name VARCHAR(40), XMLPARTTYPE VARCHAR(255), assemblyCost NUMERIC, massIncrement NUMERIC, cost NUMERIC, mass NUMERIC, PRIMARY KEY (partno));
...
CREATE TABLE ${schemaname}.JPAXMLProjectBean (projid integer NOT NULL, budget NUMERIC, cost NUMERIC, description VARCHAR(40), durationDays SMALLINT, name VARCHAR(40), personMonths TINYINT, startTime BIGINT, DEPT_DEPTNO INTEGER, PRIMARY KEY (projid));
...
CREATE TABLE ${schemaname}.JPAXMLTaskBean (taskid INTEGER NOT NULL, cost NUMERIC, description VARCHAR(40), name VARCHAR(40), PROJECT_PROJID integer, PRIMARY KEY (taskid));
CREATE TABLE ${schemaname}.JPAXMLTaskBean_JPAXMLEmpBean (TASKS_TASKID INTEGER, EMPS_EMPID integer);
CREATE TABLE ${schemaname}.JPAXMLTypeTestBean (id INTEGER NOT NULL, ageofUniverse BIGINT, bigbytes VARBINARY, busPass VARBINARY, deficitUSA NUMERIC, i1 TINYINT, i2 SMALLINT, i4 INTEGER, i8 BIGINT, iboolean BIT, ibytes VARBINARY, ic INTEGER, ichars VARCHAR(255), idouble NUMERIC, ifloat REAL, name VARCHAR(255), o1 TINYINT, o2 SMALLINT, o4 INTEGER, o8 BIGINT, oboolean BIT, obytes VARBINARY, oc INTEGER, ochars VARCHAR(255), odouble NUMERIC, ofloat REAL, payScale VARCHAR(20), sdate DATE, status SMALLINT, stime TIME, stimestamp TIMESTAMP, ucalendar TIMESTAMP, udate TIMESTAMP, PRIMARY KEY (id));
