...
CREATE TABLE JPAEmpBean (empid INT NOT NULL, bonus FLOAT(32), execLevel INT, hireDate DATETIME, hireTime DATETIME, hireTimestamp DATETIME, isManager BIT, name VARCHAR(40), rating INT, salary FLOAT(32), DEPT_DEPTNO INT, HOME_STREET VARCHAR(255), WORK_STREET VARCHAR(255), PRIMARY KEY (empid));
...
CREATE TABLE JPAXMLEmpBean (empid integer NOT NULL, bonus FLOAT(32), execLevel INT, hireDate DATETIME, hireTime DATETIME, hireTimestamp DATETIME, isManager BIT, name VARCHAR(40), rating INT, salary FLOAT(32), DEPT_DEPTNO INT, HOME_STREET VARCHAR(255), WORK_STREET VARCHAR(255), PRIMARY KEY (empid));
