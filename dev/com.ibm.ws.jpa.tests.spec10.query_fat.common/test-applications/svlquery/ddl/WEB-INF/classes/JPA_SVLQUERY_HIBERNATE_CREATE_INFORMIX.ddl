...
CREATE TABLE ${schemaname}.JPAEmpBean (empid INTEGER NOT NULL, bonus DOUBLE PRECISION, execLevel CHAR, hireDate DATE, hireTime DATETIME HOUR TO SECOND, hireTimestamp DATETIME YEAR TO FRACTION(3), isManager BOOLEAN, name VARCHAR(40), rating INTEGER, salary DOUBLE PRECISION, DEPT_DEPTNO INTEGER, HOME_STREET VARCHAR(255), WORK_STREET VARCHAR(255), PRIMARY KEY (empid)) LOCK MODE ROW;
...
CREATE TABLE ${schemaname}.JPAXMLEmpBean (empid integer NOT NULL, bonus DOUBLE PRECISION, execLevel CHAR, hireDate DATE, hireTime DATETIME HOUR TO SECOND, hireTimestamp DATETIME YEAR TO FRACTION(3), isManager BOOLEAN, name VARCHAR(40), rating INTEGER, salary DOUBLE PRECISION, DEPT_DEPTNO INTEGER, HOME_STREET VARCHAR(255), WORK_STREET VARCHAR(255), PRIMARY KEY (empid)) LOCK MODE ROW;
