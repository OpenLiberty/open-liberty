...
CREATE TABLE ${schemaname}.JPAEmpBean (empid INTEGER NOT NULL, bonus NUMERIC, execLevel CHAR, hireDate DATE, hireTime TIME, hireTimestamp TIMESTAMP, isManager BIT, name VARCHAR(40), rating INTEGER, salary NUMERIC, DEPT_DEPTNO INTEGER, HOME_STREET VARCHAR(255), WORK_STREET VARCHAR(255), PRIMARY KEY (empid));
...
CREATE TABLE ${schemaname}.JPAXMLEmpBean (empid integer NOT NULL, bonus NUMERIC, execLevel CHAR, hireDate DATE, hireTime TIME, hireTimestamp TIMESTAMP, isManager BIT, name VARCHAR(40), rating INTEGER, salary NUMERIC, DEPT_DEPTNO INTEGER, HOME_STREET VARCHAR(255), WORK_STREET VARCHAR(255), PRIMARY KEY (empid));
