...
CREATE TABLE ${schemaname}.JPAEmpBean (empid INTEGER NOT NULL, bonus DOUBLE, execLevel CHAR(254), hireDate DATE, hireTime TIME, hireTimestamp TIMESTAMP, isManager BOOLEAN, name VARCHAR(40), rating INTEGER, salary DOUBLE, DEPT_DEPTNO INTEGER, HOME_STREET VARCHAR(254), WORK_STREET VARCHAR(254), PRIMARY KEY (empid));
...
CREATE TABLE ${schemaname}.JPAXMLEmpBean (empid integer NOT NULL, bonus DOUBLE, execLevel CHAR(254), hireDate DATE, hireTime TIME, hireTimestamp TIMESTAMP, isManager BOOLEAN, name VARCHAR(40), rating INTEGER, salary DOUBLE, DEPT_DEPTNO INTEGER, HOME_STREET VARCHAR(254), WORK_STREET VARCHAR(254), PRIMARY KEY (empid));
...
CREATE TABLE ${schemaname}.JPAXMLPartTab (partno INTEGER NOT NULL, name VARCHAR(40), XMLPARTTYPE VARCHAR(254), assemblyCost DOUBLE, massIncrement DOUBLE, cost DOUBLE, mass DOUBLE, PRIMARY KEY (partno));
