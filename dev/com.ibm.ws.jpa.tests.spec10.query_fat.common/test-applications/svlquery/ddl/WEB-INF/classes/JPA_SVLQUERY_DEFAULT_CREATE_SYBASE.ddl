...
CREATE TABLE ${schemaname}.JPAEmpBean (empid INT NOT NULL, bonus FLOAT(32) NULL, execLevel CHAR NULL, hireDate DATETIME NULL, hireTime DATETIME NULL, hireTimestamp DATETIME NULL, isManager TINYINT NULL, name VARCHAR(40) NULL, rating INT NULL, salary FLOAT(32) NULL, DEPT_DEPTNO INT NULL, HOME_STREET VARCHAR(255) NULL, WORK_STREET VARCHAR(255) NULL, UNQ_INDEX NUMERIC IDENTITY UNIQUE, PRIMARY KEY (empid));
...
CREATE TABLE ${schemaname}.JPAXMLEmpBean (empid integer NOT NULL, bonus FLOAT(32) NULL, execLevel CHAR NULL, hireDate DATETIME NULL, hireTime DATETIME NULL, hireTimestamp DATETIME NULL, isManager TINYINT NULL, name VARCHAR(40) NULL, rating INT NULL, salary FLOAT(32) NULL, DEPT_DEPTNO INT NULL, HOME_STREET VARCHAR(255) NULL, WORK_STREET VARCHAR(255) NULL, UNQ_INDEX NUMERIC IDENTITY UNIQUE, PRIMARY KEY (empid));
