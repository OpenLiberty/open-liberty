...
CREATE TABLE ${schemaname}.JPAEmpBean (empid NUMBER NOT NULL, bonus NUMBER, execLevel INTEGER, hireDate DATE, hireTime DATE, hireTimestamp TIMESTAMP, isManager NUMBER, name VARCHAR2(40), rating NUMBER, salary NUMBER, DEPT_DEPTNO NUMBER, HOME_STREET VARCHAR2(255), WORK_STREET VARCHAR2(255), PRIMARY KEY (empid));
...
CREATE TABLE ${schemaname}.JPAXMLEmpBean (empid integer NOT NULL, bonus NUMBER, execLevel INTEGER, hireDate DATE, hireTime DATE, hireTimestamp TIMESTAMP, isManager NUMBER, name VARCHAR2(40), rating NUMBER, salary NUMBER, DEPT_DEPTNO NUMBER, HOME_STREET VARCHAR2(255), WORK_STREET VARCHAR2(255), PRIMARY KEY (empid));
