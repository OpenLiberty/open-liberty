...
public class XMLTypeTestBean implements ITypeTestBean, java.io.Serializable, Cloneable {
    ...
    public XMLTypeTestBean() {
    }

    public XMLTypeTestBean(int id) {
        this.i4 = id;
    }
    ...
    public boolean equals(Object o) {
        if (o instanceof XMLTypeTestBean && ((XMLTypeTestBean) o).i4 == i4)
            return true;
        return false;
    }
    ...
    @Override
    public Object clone() {
        XMLTypeTestBean rc = new XMLTypeTestBean();
