...
@Entity
@NamedQuery(name = "CONCURR_CASE_QUERY", query = "SELECT CASE WHEN (COUNT(e) > 0) THEN true ELSE false END FROM SimpleEntityOLGH19342 e WHERE e.KeyString = :id")
public class SimpleEntityOLGH19342 {
