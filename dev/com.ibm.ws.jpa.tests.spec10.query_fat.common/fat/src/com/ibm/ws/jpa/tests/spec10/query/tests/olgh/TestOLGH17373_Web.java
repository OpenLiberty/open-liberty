...
import com.ibm.ws.jpa.olgh17373.web.TestOLGH17373Servlet;
...
public class TestOLGH17373_Web extends JPAFATServletClient {
    ...
    private final static String CONTEXT_ROOT = "olgh17373Web";
    private final static String RESOURCE_ROOT = "test-applications/olgh17373/";
    private final static String appFolder = "web";
    private final static String appName = "olgh17373Web";
    ...
    static {
        dropSet.add("JPA_OLGH17373_${provider}_DROP_${dbvendor}.ddl");
        createSet.add("JPA_OLGH17373_${provider}_CREATE_${dbvendor}.ddl");
        populateSet.add("JPA_OLGH17373_${provider}_POPULATE_${dbvendor}.ddl");
    }

    @Server("JPA10QueryServer")
    @TestServlets({
                    @TestServlet(servlet = TestOLGH17373Servlet.class, path = CONTEXT_ROOT + "/" + "TestOLGH17373Servlet")
    })
    ...
    public static void setUp() throws Exception {
        ...
        bannerStart(TestOLGH17373_Web.class);
        ...
        System.out.println(TestOLGH17373_Web.class.getName() + " Setting up database tables...");
    ...
    private static void setupTestApplication() throws Exception {
        ...
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh17373.model");
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh17373.testlogic");
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh17373.web");
    ...
    public static void tearDown() throws Exception {
        try {
            ...
            bannerEnd(TestOLGH17373_Web.class, timestart);
        }
    }
}
