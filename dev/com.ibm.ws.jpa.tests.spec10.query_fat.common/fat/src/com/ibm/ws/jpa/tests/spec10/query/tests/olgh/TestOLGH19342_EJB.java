...
@Mode(TestMode.FULL)
public class TestOLGH19342_EJB extends JPAFATServletClient {

    @Rule
    public static SkipRule skipRule = new SkipRule();

    private final static String CONTEXT_ROOT = "olgh19342Ejb";
    private final static String RESOURCE_ROOT = "test-applications/olgh19342/";
    private final static String appFolder = "ejb";
    private final static String appName = "olgh19342Ejb";
    ...
    static {
        dropSet.add("JPA_OLGH19342_${provider}_DROP_${dbvendor}.ddl");
        createSet.add("JPA_OLGH19342_${provider}_CREATE_${dbvendor}.ddl");
    }
    ...
    public static void setUp() throws Exception {
        ...
        bannerStart(TestOLGH19342_EJB.class);
        ...
        System.out.println(TestOLGH19342_EJB.class.getName() + " Setting up database tables...");
    ...
    private static void setupTestApplication() throws Exception {
        JavaArchive ejbApp = ShrinkWrap.create(JavaArchive.class, "olgh19342Ejb.jar");
        ejbApp.addPackages(true, "com.ibm.ws.jpa.olgh19342.ejblocal");
        ejbApp.addPackages(true, "com.ibm.ws.jpa.olgh19342.model");
        ejbApp.addPackages(true, "com.ibm.ws.jpa.olgh19342.testlogic");
        ShrinkHelper.addDirectory(ejbApp, RESOURCE_ROOT + appFolder + "/" + appName + ".jar");

        WebArchive webApp = ShrinkWrap.create(WebArchive.class, appName + ".war");
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh19342.ejb");
    ...
    public static void tearDown() throws Exception {
        try {
            ...
            bannerEnd(TestOLGH19342_EJB.class, timestart);
        }
    }
}
