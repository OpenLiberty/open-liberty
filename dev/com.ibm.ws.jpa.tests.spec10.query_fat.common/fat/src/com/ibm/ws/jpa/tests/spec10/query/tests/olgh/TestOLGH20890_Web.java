...
import com.ibm.ws.jpa.olgh20890.web.TestOLGH20890Servlet;
...
public class TestOLGH20890_Web extends JPAFATServletClient {
    ...
    @TestServlets({
                    @TestServlet(servlet = TestOLGH20890Servlet.class, path = CONTEXT_ROOT + "/" + "TestOLGH20890Servlet"),
    })
    ...
    public static void setUp() throws Exception {
        ...
        bannerStart(TestOLGH20890_Web.class);
        ...
        System.out.println(TestOLGH20890_Web.class.getName() + " Setting up database tables...");
    ...
    private static void setupTestApplication() throws Exception {
        ...
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh20890.model");
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh20890.testlogic");
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh20890.web");
    ...
    public static void tearDown() throws Exception {
        try {
            ...
            bannerEnd(TestOLGH20890_Web.class, timestart);
        }
    }
}
