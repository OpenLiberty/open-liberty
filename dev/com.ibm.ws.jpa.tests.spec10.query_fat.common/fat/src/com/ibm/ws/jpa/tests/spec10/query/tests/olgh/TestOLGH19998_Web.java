...
import com.ibm.ws.jpa.olgh19998.web.TestOLGH19998Servlet;
...
public class TestOLGH19998_Web extends JPAFATServletClient {
    ...
    @TestServlets({
                    @TestServlet(servlet = TestOLGH19998Servlet.class, path = CONTEXT_ROOT + "/" + "TestOLGH19998Servlet"),
    })
    ...
    public static void setUp() throws Exception {
        ...
        bannerStart(TestOLGH19998_Web.class);
        ...
        System.out.println(TestOLGH19998_Web.class.getName() + " Setting up database tables...");
    ...
    private static void setupTestApplication() throws Exception {
        ...
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh19998.model");
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh19998.testlogic");
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh19998.web");
    ...
    public static void tearDown() throws Exception {
        try {
            ...
            bannerEnd(TestOLGH19998_Web.class, timestart);
        }
    }
}
