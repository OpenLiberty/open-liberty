...
import com.ibm.ws.jpa.olgh17376.ejb.TestOLGH17376_EJB_SFEx_Servlet;
import com.ibm.ws.jpa.olgh17376.ejb.TestOLGH17376_EJB_SF_Servlet;
import com.ibm.ws.jpa.olgh17376.ejb.TestOLGH17376_EJB_SL_Servlet;
...
@Mode(TestMode.FULL)
public class TestOLGH17376_EJB extends JPAFATServletClient {

    @Rule
    public static SkipRule skipRule = new SkipRule();

    private final static String CONTEXT_ROOT = "olgh17376Ejb";
    private final static String RESOURCE_ROOT = "test-applications/olgh17376/";
    private final static String appFolder = "ejb";
    private final static String appName = "olgh17376Ejb";
    ...
    static {
        dropSet.add("JPA_OLGH17376_${provider}_DROP_${dbvendor}.ddl");
        createSet.add("JPA_OLGH17376_${provider}_CREATE_${dbvendor}.ddl");
        populateSet.add("JPA_OLGH17376_${provider}_POPULATE_${dbvendor}.ddl");
    }

    @Server("JPA10QueryServer")
    @TestServlets({
                    @TestServlet(servlet = TestOLGH17376_EJB_SL_Servlet.class, path = CONTEXT_ROOT + "/" + "TestOLGH17376_EJB_SL_Servlet"),
                    @TestServlet(servlet = TestOLGH17376_EJB_SF_Servlet.class, path = CONTEXT_ROOT + "/" + "TestOLGH17376_EJB_SF_Servlet"),
                    @TestServlet(servlet = TestOLGH17376_EJB_SFEx_Servlet.class, path = CONTEXT_ROOT + "/" + "TestOLGH17376_EJB_SFEx_Servlet")
    })
    ...
    public static void setUp() throws Exception {
        ...
        bannerStart(TestOLGH17376_EJB.class);
        ...
        System.out.println(TestOLGH17376_EJB.class.getName() + " Setting up database tables...");
    ...
    private static void setupTestApplication() throws Exception {
        JavaArchive ejbApp = ShrinkWrap.create(JavaArchive.class, "olgh17376Ejb.jar");
        ejbApp.addPackages(true, "com.ibm.ws.jpa.olgh17376.ejblocal");
        ejbApp.addPackages(true, "com.ibm.ws.jpa.olgh17376.model");
        ejbApp.addPackages(true, "com.ibm.ws.jpa.olgh17376.testlogic");
        ShrinkHelper.addDirectory(ejbApp, RESOURCE_ROOT + appFolder + "/" + appName + ".jar");

        WebArchive webApp = ShrinkWrap.create(WebArchive.class, appName + ".war");
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh17376.ejb");
    ...
    public static void tearDown() throws Exception {
        try {
            ...
            bannerEnd(TestOLGH17376_EJB.class, timestart);
        }
    }
}
