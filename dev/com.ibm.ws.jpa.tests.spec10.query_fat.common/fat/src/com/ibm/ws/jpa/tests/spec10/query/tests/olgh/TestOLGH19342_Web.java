...
import com.ibm.ws.jpa.olgh19342.web.TestOLGH19342Servlet;
...
public class TestOLGH19342_Web extends JPAFATServletClient {
    ...
    @TestServlets({
                    @TestServlet(servlet = TestOLGH19342Servlet.class, path = CONTEXT_ROOT + "/" + "TestOLGH19342Servlet")
    })
    ...
    public static void setUp() throws Exception {
        ...
        bannerStart(TestOLGH19342_Web.class);
        ...
        System.out.println(TestOLGH19342_Web.class.getName() + " Setting up database tables...");
    ...
    private static void setupTestApplication() throws Exception {
        ...
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh19342.model");
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh19342.testlogic");
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh19342.web");
    ...
    public static void tearDown() throws Exception {
        try {
            ...
            bannerEnd(TestOLGH19342_Web.class, timestart);
        }
    }
}
