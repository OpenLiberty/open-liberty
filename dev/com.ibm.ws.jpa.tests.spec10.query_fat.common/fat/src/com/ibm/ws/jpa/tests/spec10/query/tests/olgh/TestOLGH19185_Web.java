...
import com.ibm.ws.jpa.olgh19185.web.TestOLGH19185Servlet;
...
public class TestOLGH19185_Web extends JPAFATServletClient {
    ...
    @TestServlets({
                    @TestServlet(servlet = TestOLGH19185Servlet.class, path = CONTEXT_ROOT + "/" + "TestOLGH19185Servlet")
    })
    ...
    public static void setUp() throws Exception {
        ...
        bannerStart(TestOLGH19185_Web.class);
        ...
        System.out.println(TestOLGH19185_Web.class.getName() + " Setting up database tables...");
    ...
    private static void setupTestApplication() throws Exception {
        ...
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh19185.model");
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh19185.testlogic");
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh19185.web");
    ...
    public static void tearDown() throws Exception {
        try {
            ...
            bannerEnd(TestOLGH19185_Web.class, timestart);
        }
    }
}
