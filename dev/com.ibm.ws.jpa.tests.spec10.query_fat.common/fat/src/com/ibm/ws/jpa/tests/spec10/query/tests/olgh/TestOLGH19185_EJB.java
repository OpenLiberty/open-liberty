...
import com.ibm.ws.jpa.olgh19185.ejb.TestOLGH19185_EJB_SFEx_Servlet;
import com.ibm.ws.jpa.olgh19185.ejb.TestOLGH19185_EJB_SF_Servlet;
import com.ibm.ws.jpa.olgh19185.ejb.TestOLGH19185_EJB_SL_Servlet;
...
@Mode(TestMode.FULL)
public class TestOLGH19185_EJB extends JPAFATServletClient {

    @Rule
    public static SkipRule skipRule = new SkipRule();

    private final static String CONTEXT_ROOT = "olgh19185Ejb";
    private final static String RESOURCE_ROOT = "test-applications/olgh19185/";
    private final static String appFolder = "ejb";
    private final static String appName = "olgh19185Ejb";
    ...
    static {
        dropSet.add("JPA_OLGH19185_${provider}_DROP_${dbvendor}.ddl");
        createSet.add("JPA_OLGH19185_${provider}_CREATE_${dbvendor}.ddl");
        populateSet.add("JPA_OLGH19185_${provider}_POPULATE_${dbvendor}.ddl");
    }

    @Server("JPA10QueryServer")
    @TestServlets({
                    @TestServlet(servlet = TestOLGH19185_EJB_SL_Servlet.class, path = CONTEXT_ROOT + "/" + "TestOLGH19185_EJB_SL_Servlet"),
                    @TestServlet(servlet = TestOLGH19185_EJB_SF_Servlet.class, path = CONTEXT_ROOT + "/" + "TestOLGH19185_EJB_SF_Servlet"),
                    @TestServlet(servlet = TestOLGH19185_EJB_SFEx_Servlet.class, path = CONTEXT_ROOT + "/" + "TestOLGH19185_EJB_SFEx_Servlet")
    })
    ...
    public static void setUp() throws Exception {
        ...
        bannerStart(TestOLGH19185_EJB.class);
        ...
        System.out.println(TestOLGH19185_EJB.class.getName() + " Setting up database tables...");
    ...
    private static void setupTestApplication() throws Exception {
        JavaArchive ejbApp = ShrinkWrap.create(JavaArchive.class, "olgh19185Ejb.jar");
        ejbApp.addPackages(true, "com.ibm.ws.jpa.olgh19185.ejblocal");
        ejbApp.addPackages(true, "com.ibm.ws.jpa.olgh19185.model");
        ejbApp.addPackages(true, "com.ibm.ws.jpa.olgh19185.testlogic");
        ShrinkHelper.addDirectory(ejbApp, RESOURCE_ROOT + appFolder + "/" + appName + ".jar");

        WebArchive webApp = ShrinkWrap.create(WebArchive.class, appName + ".war");
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh19185.ejb");
    ...
    public static void tearDown() throws Exception {
        try {
            ...
            bannerEnd(TestOLGH19185_EJB.class, timestart);
        }
    }
}
