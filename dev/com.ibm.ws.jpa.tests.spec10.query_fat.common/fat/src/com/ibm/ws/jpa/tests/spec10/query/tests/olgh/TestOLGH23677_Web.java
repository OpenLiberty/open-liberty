...
import com.ibm.ws.jpa.olgh23677.web.TestOLGH23677Servlet;
...
@Mode(TestMode.LITE)
public class TestOLGH23677_Web extends JPAFATServletClient {

    @Rule
    public static SkipRule skipRule = new SkipRule();

    private final static String CONTEXT_ROOT = "olgh23677Web";
    private final static String RESOURCE_ROOT = "test-applications/olgh23677/";
    private final static String appFolder = "web";
    private final static String appName = "olgh23677Web";
    ...
    @TestServlets({
                    @TestServlet(servlet = TestOLGH23677Servlet.class, path = CONTEXT_ROOT + "/" + "TestOLGH23677Servlet"),
    })
    ...
    public static void setUp() throws Exception {
        ...
        bannerStart(TestOLGH23677_Web.class);
        ...
        System.out.println(TestOLGH23677_Web.class.getName() + " Setting up database tables...");
    ...
    private static void setupTestApplication() throws Exception {
        ...
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh23677.model");
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh23677.testlogic");
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh23677.web");
    ...
    public static void tearDown() throws Exception {
        try {
            ...
            bannerEnd(TestOLGH23677_Web.class, timestart);
        }
    }
}
