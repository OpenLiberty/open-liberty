...
import com.ibm.ws.jpa.olgh20890.ejb.TestOLGH20890_EJB_SFEx_Servlet;
import com.ibm.ws.jpa.olgh20890.ejb.TestOLGH20890_EJB_SF_Servlet;
import com.ibm.ws.jpa.olgh20890.ejb.TestOLGH20890_EJB_SL_Servlet;
...
@Mode(TestMode.FULL)
public class TestOLGH20890_EJB extends JPAFATServletClient {

    @Rule
    public static SkipRule skipRule = new SkipRule();

    private final static String CONTEXT_ROOT = "olgh20890Ejb";
    private final static String RESOURCE_ROOT = "test-applications/olgh20890/";
    private final static String appFolder = "ejb";
    private final static String appName = "olgh20890Ejb";
    ...
    static {
        dropSet.add("JPA_OLGH20890_${provider}_DROP_${dbvendor}.ddl");
        createSet.add("JPA_OLGH20890_${provider}_CREATE_${dbvendor}.ddl");
    }

    @Server("JPA10QueryServer")
    @TestServlets({
                    @TestServlet(servlet = TestOLGH20890_EJB_SL_Servlet.class, path = CONTEXT_ROOT + "/" + "TestOLGH20890_EJB_SL_Servlet"),
                    @TestServlet(servlet = TestOLGH20890_EJB_SF_Servlet.class, path = CONTEXT_ROOT + "/" + "TestOLGH20890_EJB_SF_Servlet"),
                    @TestServlet(servlet = TestOLGH20890_EJB_SFEx_Servlet.class, path = CONTEXT_ROOT + "/" + "TestOLGH20890_EJB_SFEx_Servlet")
    })
    ...
    public static void setUp() throws Exception {
        ...
        bannerStart(TestOLGH20890_EJB.class);
        ...
        System.out.println(TestOLGH20890_EJB.class.getName() + " Setting up database tables...");
    ...
    private static void setupTestApplication() throws Exception {
        JavaArchive ejbApp = ShrinkWrap.create(JavaArchive.class, "olgh20890Ejb.jar");
        ejbApp.addPackages(true, "com.ibm.ws.jpa.olgh20890.ejblocal");
        ejbApp.addPackages(true, "com.ibm.ws.jpa.olgh20890.model");
        ejbApp.addPackages(true, "com.ibm.ws.jpa.olgh20890.testlogic");
        ShrinkHelper.addDirectory(ejbApp, RESOURCE_ROOT + appFolder + "/" + appName + ".jar");

        WebArchive webApp = ShrinkWrap.create(WebArchive.class, appName + ".war");
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh20890.ejb");
    ...
    public static void tearDown() throws Exception {
        try {
            ...
            bannerEnd(TestOLGH20890_EJB.class, timestart);
        }
    }
}
