...
import com.ibm.ws.jpa.olgh8014.web.TestOLGH8014Servlet;
...
public class TestOLGH8014_Web extends JPAFATServletClient {
    ...
    static {
        dropSet.add("JPA_OLGH8014_${provider}_DROP_${dbvendor}.ddl");
        createSet.add("JPA_OLGH8014_${provider}_CREATE_${dbvendor}.ddl");
        populateSet.add("JPA_OLGH8014_${provider}_POPULATE_${dbvendor}.ddl");
    }
    ...
    public static void setUp() throws Exception {
        ...
        bannerStart(TestOLGH8014_Web.class);
        ...
        System.out.println(TestOLGH8014_Web.class.getName() + " Setting up database tables...");
    ...
    private static void setupTestApplication() throws Exception {
        ...
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh8014.model");
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh8014.testlogic");
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh8014.web");
    ...
    public static void tearDown() throws Exception {
        try {
            ...
            bannerEnd(TestOLGH8014_Web.class, timestart);
        }
    }
}
