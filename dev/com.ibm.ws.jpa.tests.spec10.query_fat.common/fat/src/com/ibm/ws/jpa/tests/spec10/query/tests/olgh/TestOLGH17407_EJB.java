...
import com.ibm.ws.jpa.olgh17407.ejb.TestOLGH17407_EJB_SFEx_Servlet;
import com.ibm.ws.jpa.olgh17407.ejb.TestOLGH17407_EJB_SF_Servlet;
import com.ibm.ws.jpa.olgh17407.ejb.TestOLGH17407_EJB_SL_Servlet;
...
@Mode(TestMode.FULL)
public class TestOLGH17407_EJB extends JPAFATServletClient {

    @Rule
    public static SkipRule skipRule = new SkipRule();

    private final static String CONTEXT_ROOT = "olgh17407Ejb";
    private final static String RESOURCE_ROOT = "test-applications/olgh17407/";
    private final static String appFolder = "ejb";
    private final static String appName = "olgh17407Ejb";
    ...
    static {
        dropSet.add("JPA_OLGH17407_${provider}_DROP_${dbvendor}.ddl");
        createSet.add("JPA_OLGH17407_${provider}_CREATE_${dbvendor}.ddl");
        populateSet.add("JPA_OLGH17407_${provider}_POPULATE_${dbvendor}.ddl");
    }

    @Server("JPA10QueryServer")
    @TestServlets({
                    @TestServlet(servlet = TestOLGH17407_EJB_SL_Servlet.class, path = CONTEXT_ROOT + "/" + "TestOLGH17407_EJB_SL_Servlet"),
                    @TestServlet(servlet = TestOLGH17407_EJB_SF_Servlet.class, path = CONTEXT_ROOT + "/" + "TestOLGH17407_EJB_SF_Servlet"),
                    @TestServlet(servlet = TestOLGH17407_EJB_SFEx_Servlet.class, path = CONTEXT_ROOT + "/" + "TestOLGH17407_EJB_SFEx_Servlet")
    })
    ...
    public static void setUp() throws Exception {
        ...
        bannerStart(TestOLGH17407_EJB.class);
        ...
        System.out.println(TestOLGH17407_EJB.class.getName() + " Setting up database tables...");
    ...
    private static void setupTestApplication() throws Exception {
        JavaArchive ejbApp = ShrinkWrap.create(JavaArchive.class, "olgh17407Ejb.jar");
        ejbApp.addPackages(true, "com.ibm.ws.jpa.olgh17407.ejblocal");
        ejbApp.addPackages(true, "com.ibm.ws.jpa.olgh17407.model");
        ejbApp.addPackages(true, "com.ibm.ws.jpa.olgh17407.testlogic");
        ShrinkHelper.addDirectory(ejbApp, RESOURCE_ROOT + appFolder + "/" + appName + ".jar");

        WebArchive webApp = ShrinkWrap.create(WebArchive.class, appName + ".war");
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh17407.ejb");
    ...
    public static void tearDown() throws Exception {
        try {
            ...
            bannerEnd(TestOLGH17407_EJB.class, timestart);
        }
    }
}
