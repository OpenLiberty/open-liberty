...
public class TestExample_EJB_SL_Servlet extends EJBTestVehicleServlet {
    ...
    @Test
    public void jpa_jpa21_example_template_EJB_SL_AMJTA_Web() throws Exception {
        final String testName = "jpa_jpa21_example_template_EJB_SL_AMJTA_Web";
...
//        executeDDL("JPA_EXAMPLE_DELETE_${dbvendor}.ddl");
    ...
    @Test
    public void jpa_jpa21_example_template_EJB_SL_AMRL_Web() throws Exception {
        final String testName = "jpa_jpa21_example_template_EJB_SL_AMRL_Web";
        final String testMethod = "template";
...
//        executeDDL("JPA_EXAMPLE_DELETE_${dbvendor}.ddl");
    ...
    @Test
    public void jpa_jpa21_example_template_EJB_SL_CMTS_Web() throws Exception {
        final String testName = "jpa_jpa21_example_template_EJB_SL_CMTS_Web";
        final String testMethod = "template";
