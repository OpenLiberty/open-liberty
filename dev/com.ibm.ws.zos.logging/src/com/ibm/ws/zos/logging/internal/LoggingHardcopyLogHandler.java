...
public class LoggingHardcopyLogHandler implements WsLogHandler {
     ...
     * CTOR
     */
    public LoggingHardcopyLogHandler(ZosLoggingBundleActivator zosLoggingBundleActivator) {
    ...
    public void publish(RoutedMessage routedMessage) {
        ...
        if (englishMsg != null) {
            int writeReturnCode = writeToOperatorProgrammerAndHardcopy(NativeMethodUtils.convertToEBCDIC(englishMsg, false));
    ...
    protected int writeToOperatorProgrammerAndHardcopy(byte[] msg) {
        return zosLoggingBundleActivator.ntv_WriteToOperatorProgrammerAndHardcopy(msg);
    }
