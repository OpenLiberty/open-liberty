...
/**
 * Component/Compatibility Stateful Bean implementation for testing Environent
 * Injection of primitive methods with no XML.
 **/
@SuppressWarnings("unused")
@Stateful(name = "CompSFEnvInjectPrimMthd")
...
public class CompSFEnvInjectPrimMthdBean implements SessionBean {
    private static final long serialVersionUID = 3677156736425357416L;
    private static final String CLASS_NAME = CompSFEnvInjectPrimMthdBean.class.getName();
    ...
    public CompSFEnvInjectPrimMthdBean() {
        // Intentionally blank
    }
