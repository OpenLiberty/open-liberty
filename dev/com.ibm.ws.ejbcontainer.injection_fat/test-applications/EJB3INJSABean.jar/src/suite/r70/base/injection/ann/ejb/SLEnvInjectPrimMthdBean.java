...
@Stateless(name = "SLEnvInjectPrimMthd")
@Local(EnvInjectionLocal.class)
@Remote(EnvInjectionRemote.class)
public class SLEnvInjectPrimMthdBean {
    private static final String CLASS_NAME = SLEnvInjectPrimMthdBean.class.getName();
    ...
    public SLEnvInjectPrimMthdBean() {
        // Intentionally blank
    }
}
