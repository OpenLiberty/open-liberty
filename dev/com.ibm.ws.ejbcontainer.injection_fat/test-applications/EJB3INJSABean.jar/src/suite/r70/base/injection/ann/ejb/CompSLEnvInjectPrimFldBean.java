...
public class CompSLEnvInjectPrimFldBean implements SessionBean {
    private static final long serialVersionUID = -1653410168004723595L;
    private static final String CLASS_NAME = CompSLEnvInjectPrimFldBean.class.getName();
