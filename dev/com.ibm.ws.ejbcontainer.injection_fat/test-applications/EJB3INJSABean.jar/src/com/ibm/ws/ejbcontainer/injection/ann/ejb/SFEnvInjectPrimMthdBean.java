...
/**
 * Basic Stateful Bean implementation for testing Environent Injection
 * of primitive methods with no XML.
 **/
@SuppressWarnings("unused")
@Stateful(name = "SFEnvInjectPrimMthd")
@Local(EnvInjectionLocal.class)
@Remote(EnvInjectionRemote.class)
public class SFEnvInjectPrimMthdBean {
    private static final String CLASS_NAME = SFEnvInjectPrimMthdBean.class.getName();
    ...
    public SFEnvInjectPrimMthdBean() {
        // Intentionally blank
    }
}
