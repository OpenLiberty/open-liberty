...
/**
 * Basic Stateless Bean implementation for testing ejb-link to a different module using EJB Injection via XML
 **/
public class OtherBean {
    private static final String CLASS_NAME = OtherBean.class.getName();
