...
@Stateful(name = "SFMsgDestinationTestBean")
public class SFMsgDestinationTestBean implements SFMsgDestinationLocalBiz {
    ...
    public void putQueueMessage() {
        try {
            FATMDBHelper.putQueueMessage(Qmessage, CF_NAME, REQUEST_QUEUE);
        } catch (Exception ex) {
    ...
    public String getQueueMessage() {
        try {
            ...
            message = "SFMsgDestinationTestBean:" + message;
