 ...
 **/
@Stateful(name = "BasicSFEnvInjectObjMthd")
@Local(EnvInjectionLocal.class)
@Remote(EnvInjectionRemote.class)
public class BasicSFEnvInjectObjMthdBean {
    private static final String CLASS_NAME = BasicSFEnvInjectObjMthdBean.class.getName();
    ...
    public BasicSFEnvInjectObjMthdBean() {
        // intentionally blank
    }
}
