...
public class CompSLEnvInjectObjFldBean implements SessionBean {
    private static final long serialVersionUID = 6165748248701247694L;
    private static final String CLASS_NAME = CompSLEnvInjectObjFldBean.class.getName();
