...
// 1.1 REGR/ws/code/ejbcontainer.test/src/com/ibm/ws/ejbcontainer/injection/mix/ejb/BasicSLEnvInjectFldWithMthdBean.java, WAS.ejbcontainer.fvt, WAS855.REGR, cf141822.02 5/3/10 11:14:07
//
...
//
// Module  :  BasicSLEnvInjectFldWithMthdBean.java
//
...
public class BasicSLEnvInjectFldWithMthdBean
{
   private static final String CLASS_NAME =
      BasicSLEnvInjectFldWithMthdBean.class.getName();
   ...
   @Resource public    String    ivString;
   @Resource           Character ivCharacter;
   @Resource protected Byte      ivByte;
   @Resource private   Short     ivShort;
   @Resource public    Integer   ivInteger;
   @Resource           Long      ivLong;
   @Resource protected Boolean   ivBoolean;
   @Resource private   Double    ivDouble;
   @Resource public    Float     ivFloat;
