...
// 1.1 REGR/ws/code/ejbcontainer.test/src/com/ibm/ws/ejbcontainer/injection/mix/ejb/BasicSLEnvInjectPrimFldBean.java, WAS.ejbcontainer.fvt, WAS855.REGR, cf141822.02 2/27/10 16:52:41
//
...
//
// Module  :  BasicSLEnvInjectPrimFldBean.java
//
 ...
 * of primitive fields.
 **/
@Stateless (name="BasicSLEnvInjectPrimFld")
@Local (EnvInjectionLocal.class)
@Remote (EnvInjectionRemote.class)
public class BasicSLEnvInjectPrimFldBean
{
   private static final String CLASS_NAME =
      BasicSLEnvInjectPrimFldBean.class.getName();
   ...
   public BasicSLEnvInjectPrimFldBean()
   {
      // Intentionally blank
   }
}
