...
// 1.1 REGR/ws/code/ejbcontainer.test/src/com/ibm/ws/ejbcontainer/injection/mix/ejb/BasicSFEnvInjectObjFldBean.java, WAS.ejbcontainer.fvt, WAS855.REGR, cf141822.02 2/27/10 16:52:29
//
...
//
// Module  :  BasicSFEnvInjectObjFldBean.java
//
 ...
 * of primitive object fields.
 **/
@Stateful (name="BasicSFEnvInjectObjFld")
@Local (EnvInjectionLocal.class)
@Remote (EnvInjectionRemote.class)
public class BasicSFEnvInjectObjFldBean
{
   private static final String CLASS_NAME =
      BasicSFEnvInjectObjFldBean.class.getName();
   ...
   public BasicSFEnvInjectObjFldBean()
   {
      // Intentionally blank
   }
}
