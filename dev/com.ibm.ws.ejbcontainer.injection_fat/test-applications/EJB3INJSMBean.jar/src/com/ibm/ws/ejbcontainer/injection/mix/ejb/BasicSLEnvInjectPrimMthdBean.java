...
// 1.1 REGR/ws/code/ejbcontainer.test/src/com/ibm/ws/ejbcontainer/injection/mix/ejb/BasicSLEnvInjectPrimMthdBean.java, WAS.ejbcontainer.fvt, WAS855.REGR, cf141822.02 2/27/10 16:52:43
//
...
//
// Module  :  BasicSLEnvInjectPrimMthdBean.java
//
...
@Stateless (name="BasicSLEnvInjectPrimMthd")
@Local (EnvInjectionLocal.class)
@Remote (EnvInjectionRemote.class)
public class BasicSLEnvInjectPrimMthdBean
{
   private static final String CLASS_NAME =
      BasicSLEnvInjectPrimMthdBean.class.getName();
   ...
   public BasicSLEnvInjectPrimMthdBean()
   {
      // Intentionally blank
   }
}
