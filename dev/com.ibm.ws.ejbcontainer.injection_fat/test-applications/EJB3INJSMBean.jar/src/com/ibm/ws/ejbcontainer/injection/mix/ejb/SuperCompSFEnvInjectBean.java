...
// 1.1 REGR/ws/code/ejbcontainer.test/src/com/ibm/ws/ejbcontainer/injection/mix/ejb/SuperCompSFEnvInjectBean.java, WAS.ejbcontainer.fvt, WAS855.REGR, cf141822.02 2/27/10 16:53:13
//
...
//
// Module  :  SuperCompSFEnvInjectBean.java
//
// Source File Description:
//
//     Component Stateful Bean implementation for superclass test
//
// Change Activity:
//
 ...
 **/
@Stateful (name="SuperCompSFEnvInject")
@LocalHome (SuperEnvInjectionEJBLocalHome.class)
@RemoteHome(SuperEnvInjectionEJBRemoteHome.class)
@TransactionManagement (CONTAINER)
public class SuperCompSFEnvInjectBean extends SuperSuperEnvInject implements SessionBean
{
   private static final long serialVersionUID = 945588162251539159L;
   ...
   @Resource (description="This is the session context.")
   ...
   public SuperEnvInjectionEJBLocal create() throws CreateException {return null;}
