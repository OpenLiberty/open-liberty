...
// 1.1 REGR/ws/code/ejbcontainer.test/src/com/ibm/ws/ejbcontainer/injection/mix/ejb/BasicSFEnvInjectPrimFldBean.java, WAS.ejbcontainer.fvt, WAS855.REGR, cf141822.02 2/27/10 16:52:33
//
...
//
// Module  :  BasicSFEnvInjectPrimFldBean.java
//
 ...
 * of primitive fields.
 **/
@Stateful (name="BasicSFEnvInjectPrimFld")
@Local (EnvInjectionLocal.class)
@Remote (EnvInjectionRemote.class)
public class BasicSFEnvInjectPrimFldBean
{
   private static final String CLASS_NAME =
      BasicSFEnvInjectPrimFldBean.class.getName();
   ...
   public BasicSFEnvInjectPrimFldBean()
   {
      // Intentionally blank
   }
}
