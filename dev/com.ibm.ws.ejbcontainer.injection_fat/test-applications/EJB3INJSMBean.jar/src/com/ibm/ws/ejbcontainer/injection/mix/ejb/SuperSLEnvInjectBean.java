...
// 1.1 REGR/ws/code/ejbcontainer.test/src/com/ibm/ws/ejbcontainer/injection/mix/ejb/SuperSLEnvInjectBean.java, WAS.ejbcontainer.fvt, WAS855.REGR, cf141822.02 2/27/10 16:53:31
//
...
//
// Module  :  SuperSLEnvInjectBean.java
//
// Source File Description:
//
//     Stateless Bean implementation for superclass test
//
// Change Activity:
//
...
@Stateless (name="SuperSLEnvInject")
@Local (SuperEnvInjectionLocal.class)
@Remote (SuperEnvInjectionRemote.class)
public class SuperSLEnvInjectBean extends SuperSuperEnvInject
{
   ...
   @Resource (description="This is my number.")
