...
// 1.1 REGR/ws/code/ejbcontainer.test/src/com/ibm/ws/ejbcontainer/injection/mix/ejbint/XMLInjectionInterceptor3.java, WAS.ejbcontainer.fvt, WAS855.REGR, cf141822.02 4/5/10 09:38:55
//
 ...
 * or <message-driven> stanza that appears in the ejb-jar.xml file of the EJB 3 module.
 ...
 */
public class XMLInjectionInterceptor3
{
   private static final String CLASS_NAME = XMLInjectionInterceptor3.class.getName();
   private static final Logger svLogger = Logger.getLogger(CLASS_NAME);

   private static final String PASSED = "XII3_PASSED";

   private static final String CF_NAME = "java:comp/env/XMLInjectionInterceptor3/jms/WSTestQCF";
   private static final String REQUEST_QUEUE = "java:comp/env/XMLInjectionInterceptor3/jms/RequestQueue";

   // @EJB(name="XMLInjectionInterceptor3/ejbLocalRef",beanName="MixedSFInterceptorBean")
   MixedSFLocal ejbLocalRef;  // EJB Local ref

   // @EJB(name="XMLInjectionInterceptor3/ejbRemoteRef",beanName="MixedSFInterceptorBean")
   MixedSFRemote ejbRemoteRef;  // EJB Remote ref

   // @Resource (name="XMLInjectionInterceptor3/jms/WSTestQCF", authenticationType=APPLICATION, shareable=true, description="Queue conn factory")
   public QueueConnectionFactory qcf;

   // @Resource(name="XMLInjectionInterceptor3/jms/RequestQueue")
   public Queue reqQueue;

   // @Resource(name="XMLInjectionInterceptor3/jms/ResponseQueue")
   public Queue resQueue;

   //  @Resource(name="XMLInjectionInterceptor3/StringVal")
   ...
   private Object aroundInvoke( InvocationContext inv ) throws Exception
   {
      ...
      if ( methodName.equals("getXMLInterceptor3Results") || methodName.equals("onCreateDBEntryNikki") )
      {
         ...
         svLogger.info("XMLInjectionInterceptor3 pre-send results: " + PASSED);
         if ( methodName.equals("onCreateDBEntryNikki") )
         {
