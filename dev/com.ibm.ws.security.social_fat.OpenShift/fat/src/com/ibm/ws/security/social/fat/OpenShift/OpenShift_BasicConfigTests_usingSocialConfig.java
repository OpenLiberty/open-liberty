...
@Mode(TestMode.FULL)
public class OpenShift_BasicConfigTests_usingSocialConfig extends Social_BasicConfigTests {

    public static Class<?> thisClass = OpenShift_BasicConfigTests_usingSocialConfig.class;
    ...
    public static void setUp() throws Exception {
        ...
        genericTestServer = commonSetUp(SocialConstants.SERVER_NAME + ".OpenShift.social", "server_OpenShift_basicConfigTests_usingSocialConfig.xml", SocialConstants.GENERIC_SERVER, extraApps, SocialConstants.DO_NOT_USE_DERBY, startMsgs);
