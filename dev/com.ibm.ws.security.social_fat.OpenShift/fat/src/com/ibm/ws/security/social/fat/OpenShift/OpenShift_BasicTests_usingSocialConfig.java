...
@Mode(TestMode.FULL)
public class OpenShift_BasicTests_usingSocialConfig extends Social_BasicTests {

    public static Class<?> thisClass = OpenShift_BasicTests_usingSocialConfig.class;
    ...
    public static void setUp() throws Exception {
        ...
        genericTestServer = commonSetUp(SocialConstants.SERVER_NAME + ".OpenShift.social", "server_OpenShift_basicTests_usingSocialConfig.xml", SocialConstants.GENERIC_SERVER, extraApps, SocialConstants.DO_NOT_USE_DERBY, startMsgs);

        setActionsForProvider(SocialConstants.OPENSHIFT_PROVIDER, SocialConstants.OAUTH_OP);

        setGenericVSSpeicificProviderFlags(GenericConfig, "server_OpenShift_basicTests_usingSocialConfig");
