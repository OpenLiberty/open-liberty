...
public class ClientFilter implements ClientResponseFilter, ClientRequestFilter {


    private final static Logger LOG = Logger.getLogger(ClientFilter.class.getName());
    ...
    public void filter(ClientRequestContext reqCtx, ClientResponseContext resCtx) throws IOException {
        ...
        entity = entity.replaceFirst("\\{\"data\":\\{\"[a-zA-Z]*\"", "{\"data\":{\"allWidgets\"");
        LOG.log(Level.INFO, "Response converted entity={0}", new Object[]{entity});
