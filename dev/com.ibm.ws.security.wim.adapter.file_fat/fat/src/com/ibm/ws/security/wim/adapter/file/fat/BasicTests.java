...
public class BasicTests {
    ...
    //TODO : Test getUsers() with different wildcard chars supported, when actual FILE adapter is added.
    //TODO : Test getUsers() is returning the actual no of users specified by limit, when actual FILE adapter is added.(User wildcards)
    ...
    //TODO : Test getGroups() with different wildcard chars supported, when actual FILE adapter is added.
    //TODO : Test getGroups() is returning the actual no of groups specified by limit, when actual FILE adapter is added.(User wildcards)
    ...
    public void getRealm() throws Exception {
        ...
        assertEquals("allURAPIs", servlet.getRealm());
    }
    ...
    public void checkPasswordWithInvalidUser() throws Exception {
        ...
        assertNotNull("Expected CWIML4537E message.", server.waitForStringInLog("CWIML4537E"));
