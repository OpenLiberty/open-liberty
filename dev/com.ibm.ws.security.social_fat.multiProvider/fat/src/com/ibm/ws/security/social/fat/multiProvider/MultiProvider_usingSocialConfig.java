...
@Mode(TestMode.FULL)
public class MultiProvider_usingSocialConfig extends Social_MultiProvider_BasicTests {

    public static Class<?> thisClass = MultiProvider_usingSocialConfig.class;
