 ...
 * under the License.
 */
// PI45044 embreijo   Row state is lost when JSF lifecycle spans multiple requests (e.g. Portal ACTION/RENDER requests).
...
public class UIData extends UIComponentBase implements NamingContainer, UniqueIdVendor
{
    ...
    private static final String SAVE_UIDATA_ROW_STATE = "com.ibm.ws.jsf.saveUIDataRowState"; // PI45044
    ...
    private boolean _saveUIDataRowState = 
                    Boolean.parseBoolean(FacesContext.getCurrentInstance().getExternalContext().getInitParameter(SAVE_UIDATA_ROW_STATE)); // PI45044
    ...
    private static class EditableValueHolderState implements Serializable // PI45044
    {
    ...
    public Object saveState(FacesContext context)
    {
        ...
        if (initialStateMarked())
        {
            ...
            // PI45044 start
            if (_saveUIDataRowState && !context.getCurrentPhaseId().equals(PhaseId.RENDER_RESPONSE))
            {
