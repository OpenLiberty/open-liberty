 ...
 *******************************************************************************/
package io.openliberty.checkpoint.fat.crac.app.multiple2;
...
public class MultiApp2Servlet extends HttpServlet {
    ...
    class TestResource implements Resource {
        ...
        public void beforeCheckpoint(Context<? extends Resource> context) throws Exception {
            ...
            System.out.println(MultiApp2Servlet.this.getClass().getSimpleName() + ": TESTING - beforeCheckpoint " + expectedResource);
        }
        ...
        public void afterRestore(Context<? extends Resource> context) throws Exception {
            ...
            System.out.println(MultiApp2Servlet.this.getClass().getSimpleName() + ": TESTING - afterRestore " + expectedResource);
        }
    }

    final List<TestResource> testResources;

    public MultiApp2Servlet() {
