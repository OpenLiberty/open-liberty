 ...
 *******************************************************************************/
package io.openliberty.checkpoint.fat.crac.app.request.fail.notsupported;
...
public class CRaCResourceRequestFailNotSupportedServlet extends HttpServlet {
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        try {
            ...
            System.out.println("TESTING - got UnsupportedOperationException: " + e.getMessage());
        }
