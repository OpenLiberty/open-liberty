...
import io.openliberty.checkpoint.fat.crac.app.request.fail.checkpoint.CRaCResourceRequestFailCheckpointServlet;
import io.openliberty.checkpoint.spi.CheckpointPhase;

@RunWith(FATRunner.class)
@CheckpointTest
public class CRaCResourceRequestFailCheckpointTest {
    public static final String APP_NAME = "testApp";
    public static final String APP_PACKAGE = CRaCResourceRequestFailCheckpointServlet.class.getPackage().getName();
    ...
    public void setUp() throws Exception {
        server.setCheckpoint(new CheckpointInfo(CheckpointPhase.APP_REQUESTED, true, true, true, //
                        server -> {
    ...
    public void testRequestCheckpointFail() throws Exception {
        ...
        assertNotNull("Applicaiton did not get CheckpointException", server.waitForStringInLogUsingMark("TESTING - got CheckpointException.", 0));
    }
