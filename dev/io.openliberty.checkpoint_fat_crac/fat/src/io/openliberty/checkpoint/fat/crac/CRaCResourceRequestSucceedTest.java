...
import io.openliberty.checkpoint.fat.crac.app.request.succeed.CRaCResourceRequestSucceedServlet;
import io.openliberty.checkpoint.spi.CheckpointPhase;

@RunWith(FATRunner.class)
@CheckpointTest
public class CRaCResourceRequestSucceedTest extends FATServletClient {

    public static final String APP_NAME = "testApp";
    public static final String APP_PACKAGE = CRaCResourceRequestSucceedServlet.class.getPackage().getName();

    @Server("cracFATServer")
    @TestServlet(servlet = CRaCResourceRequestSucceedServlet.class, contextRoot = APP_NAME)
    ...
    public void setUp() throws Exception {
        ...
        assertNotNull("No control back after restore",
                      server.waitForStringInLogUsingMark("TESTING - control back after restor", 0));
