...
package com.ibm.ws.jpa.fvt.jarfile.tests.jarfilesupport.weblib2;
...
@WebServlet(urlPatterns = "/JarFileWebLibLibTestServlet")
public class JarFileWebLibLibTestServlet extends JPADBTestServlet {
