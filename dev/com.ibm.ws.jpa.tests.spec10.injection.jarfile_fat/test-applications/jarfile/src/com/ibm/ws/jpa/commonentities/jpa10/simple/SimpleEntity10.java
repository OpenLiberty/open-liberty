...
@Entity
@Table(name = "CMN10_SimpleEnt")
public class SimpleEntity10 implements ISimpleEntity10 {
    @Id
    private int id;
    ...
    public String toString() {
        return "SimpleEntity10 [id=" + id + ", strData=" + strData
