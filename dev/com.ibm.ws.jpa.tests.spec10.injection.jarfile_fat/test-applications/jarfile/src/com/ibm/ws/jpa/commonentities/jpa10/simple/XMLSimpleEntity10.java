...
public class XMLSimpleEntity10 implements ISimpleEntity10 {
    private int id;
    ...
    public XMLSimpleEntity10() {

    }

    public XMLSimpleEntity10(int id) {
        this.id = id;
    }
    ...
    public String toString() {
        return "XMLSimpleEntity10 [id=" + id + ", strData=" + strData
