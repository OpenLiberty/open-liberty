...
public class JwkEndpointValidationUrlTests extends CommonSecurityFat {
	...
	/**
	 * <p>
	 * Invoke the JwkEnpointUrl (using http) and specifying a config that uses
	 * HS256.
	 * <p>
	...
	public void JwkEndpointValidationUrlTests_sigAlg_RS384() throws Exception {
		...
		// // use the token to access the protected app - one last check to
		// ensure that the token is valid
		// invokeAndValidateProtectedApp(UseTokenInHeader, builderResponse,
		// builderId.replace("jwkEnabled_", ""));
