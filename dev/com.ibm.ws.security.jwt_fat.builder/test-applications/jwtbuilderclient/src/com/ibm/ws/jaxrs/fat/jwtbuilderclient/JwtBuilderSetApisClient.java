...
public class JwtBuilderSetApisClient extends HttpServlet {
	 ...
	 * @param attrs - the caller requested parms
	 * @throws Exception
	 */
	 ...
	 * 
	 * @param object JsonObject to get the string object from.
	 * @param key The JSON key to get the String value for.
	 ...
	 * 
	 * @param array JsonArray to get the string object from.
	 * @param idx The idx to get the String value for.
	 * @return The String value if it exists.
	 */
	 ...
	 * 
	 * @param object The JsonObject to get the generic object from.
	 * @param key The JSON key to get the Object value for.
	 ...
	 * 
	 * @param object JsonObject to get the Long object from.
	 * @param key The JSON key to get the Long value for.
