...
public class TestEnableDisableFeaturesTest {
    ...
    public void testEDF1() throws Exception {
        ...
        serverEDF1.setServerConfigurationFile("server_mpMetric21.xml");
    ...
    public void testEDF2() throws Exception {
    	...
    	Log.info(c, testName, "------- Enable mpMetrics-2.1 and monitor-1.0: threadpool metrics should be available ------");
        ...
        Assert.assertNotNull("CWWKO0219I NOT FOUND",serverEDF2.waitForStringInTraceUsingMark("Monitoring MXBean WebSphere:type=ServletStats"));
       	checkStrings(getHttpsServlet("/metrics/vendor", serverEDF2), new String[] {
           	...
           	"vendor_servlet_responseTime_total_seconds{servlet=\"com_ibm_ws_microprofile_metrics_private_2_1_PrivateMetricsRESTProxyServlet\"}",
           	"vendor_servlet_request_total{servlet=\"com_ibm_ws_microprofile_metrics_private_2_1_PrivateMetricsRESTProxyServlet\"}"
       	}, new String[] {});
    }
