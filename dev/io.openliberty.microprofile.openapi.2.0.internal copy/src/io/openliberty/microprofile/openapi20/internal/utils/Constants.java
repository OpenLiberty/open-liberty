...
public class Constants {
    ...
    public static final String STATIC_FILE_META_INF_OPENAPI_YAML = STRING_FORWARD_SLASH +
                                                                   DIR_META_INF +
                                                                   STRING_FORWARD_SLASH +
                                                                   STATIC_FILE_NAME +
                                                                   FILE_SUFFIX_YAML;
    public static final String STATIC_FILE_WEB_INF_CLASSES_META_INF_OPENAPI_YAML = STRING_FORWARD_SLASH +
                                                                                   DIR_WEB_INF +
                                                                                   STRING_FORWARD_SLASH +
                                                                                   DIR_CLASSES +
                                                                                   STRING_FORWARD_SLASH +
                                                                                   ...
                                                                                   STATIC_FILE_NAME +
                                                                                   FILE_SUFFIX_YAML;
    public static final String STATIC_FILE_META_INF_OPENAPI_YML = STRING_FORWARD_SLASH +
                                                                  DIR_META_INF +
                                                                  STRING_FORWARD_SLASH +
                                                                  STATIC_FILE_NAME +
                                                                  FILE_SUFFIX_YML;
    public static final String STATIC_FILE_WEB_INF_CLASSES_META_INF_OPENAPI_YML = STRING_FORWARD_SLASH +
                                                                                  DIR_WEB_INF +
                                                                                  STRING_FORWARD_SLASH +
                                                                                  DIR_CLASSES +
                                                                                  STRING_FORWARD_SLASH +
                                                                                  ...
                                                                                  STATIC_FILE_NAME +
                                                                                  FILE_SUFFIX_YML;
    public static final String STATIC_FILE_META_INF_OPENAPI_JSON = STRING_FORWARD_SLASH +
                                                                   DIR_META_INF +
                                                                   STRING_FORWARD_SLASH +
                                                                   STATIC_FILE_NAME +
                                                                   FILE_SUFFIX_JSON;
    public static final String STATIC_FILE_WEB_INF_CLASSES_META_INF_OPENAPI_JSON = STRING_FORWARD_SLASH +
                                                                                   DIR_WEB_INF +
                                                                                   STRING_FORWARD_SLASH +
                                                                                   DIR_CLASSES +
                                                                                   STRING_FORWARD_SLASH +
