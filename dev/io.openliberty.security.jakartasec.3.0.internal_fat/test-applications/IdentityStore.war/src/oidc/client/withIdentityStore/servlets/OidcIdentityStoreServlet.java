...
@DeclareRoles("idStoreGroup") // specify a group unique to the identitystore
@ServletSecurity(@HttpConstraint(rolesAllowed = "idStoreGroup")) // specify a group unique to the identitystore
