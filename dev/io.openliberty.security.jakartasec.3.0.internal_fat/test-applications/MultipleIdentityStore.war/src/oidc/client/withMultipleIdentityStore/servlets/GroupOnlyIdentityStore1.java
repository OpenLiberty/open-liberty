...
@Dependent
@ApplicationScoped
public class GroupOnlyIdentityStore1 implements IdentityStore {

    private static String className = GroupOnlyIdentityStore1.class.getName();
    private static Logger log = Logger.getLogger(GroupOnlyIdentityStore1.class.getName());
