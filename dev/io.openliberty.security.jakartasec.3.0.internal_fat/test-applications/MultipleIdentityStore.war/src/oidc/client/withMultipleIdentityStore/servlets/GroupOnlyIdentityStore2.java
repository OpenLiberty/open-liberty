...
@Dependent
@ApplicationScoped
public class GroupOnlyIdentityStore2 implements IdentityStore {

    private static String className = GroupOnlyIdentityStore2.class.getName();
