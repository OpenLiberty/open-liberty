...
@WebFault(name = "UserNotFoundException", targetNamespace = "http://ejbbasic.jaxws.testapp.checkpoint.openliberty.io/")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: io.openliberty.checkpoint.testapp.jaxws.ejbbasic.client.UserNotFoundException
     */
