...
@WebServiceClient(name = "UserQueryService", targetNamespace = "http://ejbbasic.jaxws.testapp.checkpoint.openliberty.io/", wsdlLocation = "file:/D:/1/wsimporterror/UserQueryService.wsdl")
public class UserQueryService extends Service {
    ...
    private final static QName USERQUERYSERVICE_QNAME = new QName("http://ejbbasic.jaxws.testapp.checkpoint.openliberty.io/", "UserQueryService");
    ...
    public UserQuery getUserQueryPort() {
        return super.getPort(new QName("http://ejbbasic.jaxws.testapp.checkpoint.openliberty.io/", "UserQueryPort"), UserQuery.class);
    }
    ...
    public UserQuery getUserQueryPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ejbbasic.jaxws.testapp.checkpoint.openliberty.io/", "UserQueryPort"), UserQuery.class, features);
    }
