...
@WebServiceClient(name = "SayHelloService", targetNamespace = "http://ejbbasic.jaxws.testapp.checkpoint.openliberty.io/", wsdlLocation = "file:/D:/temp/wsgen/SayHelloService.wsdl")
                ...
                extends Service
{
    ...
    private final static QName SAYHELLOSERVICE_QNAME = new QName("http://ejbbasic.jaxws.testapp.checkpoint.openliberty.io/", "SayHelloService");
    ...
    public SayHelloInterface getSayHelloPort() {
        return super.getPort(new QName("http://ejbbasic.jaxws.testapp.checkpoint.openliberty.io/", "SayHelloPort"), SayHelloInterface.class);
    }
    ...
    public SayHelloInterface getSayHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ejbbasic.jaxws.testapp.checkpoint.openliberty.io/", "SayHelloPort"), SayHelloInterface.class, features);
    }
