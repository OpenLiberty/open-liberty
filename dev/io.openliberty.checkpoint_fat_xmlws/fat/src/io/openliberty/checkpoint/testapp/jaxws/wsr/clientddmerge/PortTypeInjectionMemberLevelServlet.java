 ...
 *******************************************************************************/
package io.openliberty.checkpoint.testapp.jaxws.wsr.clientddmerge;
...
@WebServlet("/PortTypeInjectionMemberLevelServlet")
public class PortTypeInjectionMemberLevelServlet extends HttpServlet {
    private static final long serialVersionUID = -1L;

    // test normal port type injection
    @WebServiceRef(name = "services/portTypeInjectionMemberLevel")
    People bill;

    public PortTypeInjectionMemberLevelServlet() {
        super();
    }
