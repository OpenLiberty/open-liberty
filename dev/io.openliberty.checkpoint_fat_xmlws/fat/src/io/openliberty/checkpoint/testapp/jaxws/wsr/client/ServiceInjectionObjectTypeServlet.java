...
@WebServlet("/ServiceInjectionObjectTypeServlet")
public class ServiceInjectionObjectTypeServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;

    // test Object service injection with specified type
    @WebServiceRef(name = "services/serviceInjectionObjectType", type = PeopleService.class, value = Service.class)
    Object service;

    public ServiceInjectionObjectTypeServlet() {
        super();
    }
