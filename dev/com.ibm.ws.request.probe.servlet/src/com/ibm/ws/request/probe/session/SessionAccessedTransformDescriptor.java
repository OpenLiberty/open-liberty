...
public class SessionAccessedTransformDescriptor implements RequestProbeTransformDescriptor {

    private static final String classToInstrument = "com/ibm/ws/session/SessionEventDispatcher";
    private static final String methodToInstrument = "sessionAccessed";
    private static final String descOfMethod = "(Lcom/ibm/wsspi/session/ISession;)V";
    private static final String requestProbeType = "websphere.session.sessionAccessed";
