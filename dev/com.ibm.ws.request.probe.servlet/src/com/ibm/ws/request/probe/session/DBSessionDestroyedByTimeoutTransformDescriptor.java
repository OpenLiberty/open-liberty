...
public class DBSessionDestroyedByTimeoutTransformDescriptor implements RequestProbeTransformDescriptor {
    ...
    private static final String requestProbeType = "websphere.session.dbSessionDestroyedByTimeout";
