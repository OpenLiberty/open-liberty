...
public class SessionDestroyedTransformDescriptor implements RequestProbeTransformDescriptor {
    ...
    private static final String requestProbeType = "websphere.session.sessionDestroyed";
