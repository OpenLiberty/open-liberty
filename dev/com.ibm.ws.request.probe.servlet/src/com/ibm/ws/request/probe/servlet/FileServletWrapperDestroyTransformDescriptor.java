...
public class FileServletWrapperDestroyTransformDescriptor implements RequestProbeTransformDescriptor {

    private static final String classToInstrument = "com/ibm/ws/webcontainer/servlet/FileServletWrapper";
    private static final String methodToInstrument = "destroy";
    private static final String descOfMethod = "all";
    private static final String requestProbeType = "websphere.fileservlet.destroy";
