 ...
 * test purpose.</p>
 */
public class FVTEndpoint2 implements MessageListener, MessageEndpoint {
    private final static String CLASSNAME = FVTEndpoint2.class.getName();
    ...
    public void onMessage(Message message) {
        try {
            svLogger.info("--onMessage: Hey, I am endpoint 2. I got the message :" + ((TextMessage) message).getText());
        } catch (Exception e) {
        }
    }

    public void messageMethod1(String message) {
        svLogger.info("--messageMethod1: Hey, I am endpoint 2. I got the message :" + message);
    }

    public void messageMethod2(String message) {
        svLogger.info("--messageMethod2: Hey, I am endpoint 2. I got the message :" + message);
    }
    ...
    public void beforeDelivery(Method method) throws NoSuchMethodException, ResourceException {
        svLogger.info("--endpoint 2: beforeDelivery");
    }
    ...
    public void afterDelivery() throws ResourceException {
        svLogger.info("--endpoint 2: afterDelivery");
    }
    ...
    @Override
    public void release() {
        svLogger.info("--endpoint 2: release");
    }
}