...
public class ConnectionManager {
    public static String dbProductName = "Oracle";
    ...
    private void registerDriver() {
        ...
        // Load the JDBC driver to "register" the Oracle DriverManager class
        try {
    ...
    public Connection getDriverConnection(String serverName, int portNumber, String userName, String password, String selectMethod, String databaseName,
        ...
        String url = "jdbc:oracle:thin:" + userName + "/" + password + "@//" + serverName + ":" + portNumber + "/" + databaseName;
        ...
        // For Oracle call the getConnection method of the DriverManager class. The DriverManager is "registered" in the IfxConnectionPoolDataSource constructor.
        //
