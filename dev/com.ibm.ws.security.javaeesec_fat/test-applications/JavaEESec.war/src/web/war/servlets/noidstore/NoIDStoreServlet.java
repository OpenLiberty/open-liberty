 ...
 *******************************************************************************/
package web.war.servlets.noidstore;

import web.jar.base.FlexibleBaseServlet;

import javax.servlet.annotation.WebServlet;

@WebServlet("/NoIDStoreServlet")
public class NoIDStoreServlet extends FlexibleBaseServlet {
    private static final long serialVersionUID = 1L;

    public NoIDStoreServlet() {
        super("NoIDStoreServlet");
