 ...
 *******************************************************************************/
package web.war.servlets.appllogintocontinue;
...
@WebServlet("/MultipleISApplLoginToContinueServlet")
...
public class MultipleISApplLoginToContinueServlet extends FlexibleBaseServlet {
    private static final long serialVersionUID = 1L;

    public MultipleISApplLoginToContinueServlet() {
        super("MultipleIdentityStore.MultipleISApplLoginToContinueServlet");
