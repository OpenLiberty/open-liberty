...
public class JavaEESecAnnotatedFormLoginNoIdentityStoreServlet extends FlexibleBaseServlet {
    private static final long serialVersionUID = 1L;

    public JavaEESecAnnotatedFormLoginNoIdentityStoreServlet() {
        super("JavaEESecAnnotatedFormLoginNoIdentityStoreServlet");
