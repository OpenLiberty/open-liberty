...
package com.ibm.ws.security.javaeesec.fat.suite3;
...
public class HttpAuthenticationMechanismDBShortNameTest extends JavaEESecTestBase {
    ...
    protected static LibertyServer myServer = LibertyServerFactory.getLibertyServer("com.ibm.ws.security.javaeesec.db.shortname.fat");
    protected static Class<?> logClass = HttpAuthenticationMechanismDBShortNameTest.class;
    ...
    public HttpAuthenticationMechanismDBShortNameTest() {
