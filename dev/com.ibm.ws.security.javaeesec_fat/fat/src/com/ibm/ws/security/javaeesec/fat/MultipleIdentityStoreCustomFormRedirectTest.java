...
public class MultipleIdentityStoreCustomFormRedirectTest extends JavaEESecTestBase {
    ...
    public static void setUp() throws Exception {
        ...
        WCApplicationHelper.addWarToServerApps(myServer, WAR_NAME, true, JAR_NAME, false, "web.jar.base", "web.war.servlets.customform", "web.war.servlets.customform.get.redirect",
