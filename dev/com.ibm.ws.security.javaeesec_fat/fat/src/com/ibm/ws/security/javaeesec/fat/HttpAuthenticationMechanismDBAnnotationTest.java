...
public class HttpAuthenticationMechanismDBAnnotationTest extends JavaEESecTestBase {
    ...
    protected static LibertyServer myServer = LibertyServerFactory.getLibertyServer("com.ibm.ws.security.javaeesec.db.anno.fat");
    protected static Class<?> logClass = HttpAuthenticationMechanismDBAnnotationTest.class;
    protected String queryString = "/DatabaseAnnotatedDSServlet/JavaEESecAnnotatedBasic";
    protected static String urlBase;
    protected static String JAR_NAME = "JavaEESecBase.jar";

    protected DefaultHttpClient httpclient;

    public HttpAuthenticationMechanismDBAnnotationTest() {
    ...
    public static void setUp() throws Exception {
        ...
        WCApplicationHelper.addWarToServerApps(myServer, "DatabaseAnnotatedDSServlet.war", true, JAR_NAME, false, "web.jar.base", "web.war.annotatedbasic.ds");
