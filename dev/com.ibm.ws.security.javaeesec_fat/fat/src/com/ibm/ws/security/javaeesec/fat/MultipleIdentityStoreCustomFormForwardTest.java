...
@Mode(TestMode.FULL)
public class MultipleIdentityStoreCustomFormForwardTest extends JavaEESecTestBase {

    protected static LibertyServer myServer = LibertyServerFactory.getLibertyServer("com.ibm.ws.security.javaeesec.fat");
    protected static Class<?> logClass = MultipleIdentityStoreCustomFormForwardTest.class;
    ...
    public MultipleIdentityStoreCustomFormForwardTest() {
    ...
    public static void setUp() throws Exception {
        ...
        WCApplicationHelper.addWarToServerApps(myServer, WAR_NAME, true, JAR_NAME, false, "web.jar.base", "web.war.servlets.customform", "web.war.servlets.customform.get.forward",
