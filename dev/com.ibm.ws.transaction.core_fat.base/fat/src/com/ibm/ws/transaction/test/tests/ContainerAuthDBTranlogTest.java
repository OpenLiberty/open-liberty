...
public class ContainerAuthDBTranlogTest extends FATServletClient {
    ...
    public static void setUp() throws Exception {
        ...
        serverBase.setServerStartTimeout(300000);
        serverConAuth.setServerStartTimeout(300000);
        serverConAuthBadUser.setServerStartTimeout(300000);
        serverEmbed.setServerStartTimeout(300000);
        serverEmbedBadUser.setServerStartTimeout(300000);
    }
    ...
    public void testNoContainerAuth() throws Exception {
        ...
        // Start serverBase
        FATUtils.startServers(serverBase);
    ...
    public void testContainerAuth() throws Exception {
        ...
        // Start serverConAuth
        FATUtils.startServers(serverConAuth);
    ...
    public void testContainerAuthBadUser() throws Exception {
        ...
        // Start serverConAuth
        FATUtils.startServers(serverConAuthBadUser);
    ...
    public void testContainerAuthEmbed() throws Exception {
        ...
        // Start serverEmbed
        FATUtils.startServers(serverEmbed);
        // Check for key string to see whether it succeeded
    ...
    public void testContainerAuthEmbedBadUser() throws Exception {
        ...
        // Start serverEmbed
        FATUtils.startServers(serverEmbedBadUser);
        // Check for key string to see whether it succeeded
