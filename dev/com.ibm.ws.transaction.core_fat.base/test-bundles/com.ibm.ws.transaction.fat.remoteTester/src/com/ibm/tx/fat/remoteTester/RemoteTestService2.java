 ...
 *
 */
@Component(immediate = true, service = XAResourceFactory.class, property = { "testfilter=wsat2" })
public class RemoteTestService2 implements XAResourceFactory {

    protected static final TraceComponent tc = Tr.register(RemoteTestService2.class);
    ...
    public XAResource getXAResource(Serializable xaResInfo) throws XAResourceNotAvailableException {
        System.out.println("getXAResource: in service 2");
