...
public class BasicValidation11CommonTest extends BasicValidation10CommonTest {
     ...
     * Hibernate Bval 1.1 bundle.
     */
    @Test
    public void testBuildHibernateConfiguredValidatorFactory11() throws Exception {
        run("HibernateBvalConfig_11", "BeanValidationServlet");
    }

    /**
     * Ensure that the hibernate bval impl classes have the proper visibility to
     * the application.
     */
    @Test
    public void testHibernateBvalImplClassVisibility11() throws Exception {
        run("HibernateBvalConfig_11", "BeanValidationServlet");
    }
