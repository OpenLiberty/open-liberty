...
public class BasicValidation10CommonTest extends AbstractTest {
     ...
     * Hibernate Bval 1.0 bundle.
     */
    @Test
    public void testBuildHibernateConfiguredValidatorFactory10() throws Exception {
        run("HibernateBvalConfig_10", "BeanValidationServlet",
            "testBuildHibernateConfiguredValidatorFactory&isFeature11=" + isUsingBval11);
    }
     ...
     */
    @Test
    public void testHibernateBvalImplClassVisibility10() throws Exception {
        run("HibernateBvalConfig_10", "BeanValidationServlet");
    }
