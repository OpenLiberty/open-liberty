...
//2/01/2021 renamed the package; it's not match

@WebServiceProvider(targetNamespace="http://caller.libertyfat.test/contract",
                    serviceName="SAMLCallerSymEncrService", portName="SAMLCallerSymEncrPort",
...
/**
 */
public class SAMLCallerSymEncr implements javax.xml.ws.Provider<SOAPMessage> {
    ...
    public SOAPMessage invoke(SOAPMessage request) {
        ...
        String respMsg = new String(
                               ...
                               "<SOAP-ENV:Body><provider><message>Liberty Fat SamlCaller SAMLCallerSymEncr(" + PrincipalUserID +
