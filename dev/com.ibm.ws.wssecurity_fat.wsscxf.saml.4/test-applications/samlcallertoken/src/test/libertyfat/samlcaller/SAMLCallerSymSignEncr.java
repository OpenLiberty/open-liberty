...
/**
 */
public class SAMLCallerSymSignEncr implements javax.xml.ws.Provider<SOAPMessage> {
    ...
    public SOAPMessage invoke(SOAPMessage request) {
        ...
        String respMsg = new String(
                               ...
                               "<SOAP-ENV:Body><provider><message>Liberty Fat SamlCaller SAMLCallerSymSignEncr(" + PrincipalUserID +
