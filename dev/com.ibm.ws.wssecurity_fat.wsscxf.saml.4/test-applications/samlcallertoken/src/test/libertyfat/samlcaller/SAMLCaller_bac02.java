...
@WebServiceProvider(targetNamespace="http://caller.libertyfat.test/contract",
                    serviceName="FatSamlC02Service", portName="SamlCallerToken02",
...
/**
 */
public class SAMLCaller_bac02 implements javax.xml.ws.Provider<SOAPMessage> {
    ...
    public SOAPMessage invoke(SOAPMessage request) {
        ...
        String respMsg = new String(
                               ...
                               "<SOAP-ENV:Body><provider><message>Liberty Fat SAMLCaller bac02(" + "realm name: " + RealmName + 
