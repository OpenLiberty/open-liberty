...
public class ConcurrencyAppTests40War extends ConcurrencyAppAbstractTests {
    ...
    public Set<String> getFeatures() {
        return new HashSet<>(Arrays.asList("servlet-6.1", "concurrent-3.1", "jndi-1.0", "connectors-2.1"));
    }
