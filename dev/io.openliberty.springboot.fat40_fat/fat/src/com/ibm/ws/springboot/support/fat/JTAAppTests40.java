...
public class JTAAppTests40 extends JTAAppAbstractTests {
    @Test
    ...
    public Set<String> getFeatures() {
        return new HashSet<>(Arrays.asList("springBoot-4.0", "servlet-6.1", "connectors-2.1", "jdbc-4.2", "jndi-1.0", "componenttest-2.0", "cdi-4.1", "enterpriseBeansLite-4.0"));
    }
