...
public class JPALibertyAppTests40 extends JPAAppAbstractTests {

    @Test
    public void testLibertyJPAAppRunner() throws Exception {
        assertNotNull("Did not find TESTS PASSED messages", server.waitForStringInLog("COMMAND_LINE_RUNNER: SPRING DATA TEST: PASSED"));
    }

    @Test
    public void testLibertyJPAWebContext() throws Exception {
