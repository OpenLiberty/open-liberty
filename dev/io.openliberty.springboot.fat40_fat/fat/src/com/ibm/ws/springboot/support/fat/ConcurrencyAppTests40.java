...
public class ConcurrencyAppTests40 extends ConcurrencyAppAbstractTests {
    ...
    public Set<String> getFeatures() {
        return new HashSet<>(Arrays.asList("springBoot-4.0", "servlet-6.1", "concurrent-3.1", "jndi-1.0", "connectors-2.1"));
    }
