...
public class TemplateTests40 extends JavaLevel {
    ...
    public void setupTest() throws Exception {
        templateName = "springBoot4";

        templateFeatures = new HashSet<String>();
        templateFeatures.add("expressionLanguage-6.0");
        templateFeatures.add("pages-4.0");
        templateFeatures.add("servlet-6.1");
        templateFeatures.add("springBoot-4.0");
        templateFeatures.add("ssl-1.0");
        templateFeatures.add("transportSecurity-1.0");
        templateFeatures.add("websocket-2.2");
    ...
    @Test
    public void testCreateSpringBoot4() throws Exception {
        System.out.println("Test create SpringBoot4 server from template");
