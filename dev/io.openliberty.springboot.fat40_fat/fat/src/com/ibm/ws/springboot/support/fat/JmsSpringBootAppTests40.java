...
public class JmsSpringBootAppTests40 extends JmsAbstractTests {
    @Override
    public Set<String> getFeatures() {
        return new HashSet<>(Arrays.asList("servlet-6.1", "messaging-3.1", "jndi-1.0", "componenttest-2.0", "springBoot-4.0", "jdbc-4.3"));
    }
