...
public class CHelper {
    ...
    public String getString(String propertyName) {
        return c.getOptionalValue(propertyName, String.class).orElse("NOT_PRESENT");
    }
    ...
    public boolean contains(String propertyName, String propertyValue) {
        String val = c.getOptionalValue(propertyName, String.class).orElse("NOT_PRESENT");
    ...
    private String toString(StringBuffer buff) {
        ...
        for (Iterator<String> iterator = names.iterator(); iterator.hasNext();) {
            String name = iterator.next();
            buff.append("\n<br>" + name + " = " + c.getOptionalValue(name, String.class).orElse("NOT_PRESENT"));
        }
