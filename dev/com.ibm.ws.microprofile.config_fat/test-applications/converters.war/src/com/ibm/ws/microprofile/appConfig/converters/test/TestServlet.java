...
public class TestServlet extends AbstractTestServlet {
    private static final String[] TESTS = new String[] {
                                                         TestConverterExceptions.class.getSimpleName(),
                                                         TestConverters.class.getSimpleName(),
                                                         TestConverterSubclass.class.getSimpleName(),
                                                         TestDiscoveredConverters.class.getSimpleName(),
                                                         TestMultipleSameTypeConverters.class.getSimpleName(),
    };
