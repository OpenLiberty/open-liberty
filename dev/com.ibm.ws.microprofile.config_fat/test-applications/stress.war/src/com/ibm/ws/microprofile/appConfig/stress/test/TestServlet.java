...
public class TestServlet extends AbstractTestServlet {
    private static final String[] TESTS = new String[] {
                                                         TestLargeConfigSources.class.getSimpleName(),
                                                         TestLargeDynamicUpdates.class.getSimpleName(),
                                                         TestManyConfigSources.class.getSimpleName(),
                                                         TestRegistrationDeregistration.class.getSimpleName(),
    };
