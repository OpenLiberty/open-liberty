...
@Component(name = "com.ibm.ws.security.social.facebook", configurationPolicy = ConfigurationPolicy.REQUIRE, immediate = true, service = SocialLoginConfig.class, property = { "service.vendor=IBM", "type=facebookLogin" })
public class FacebookLoginConfigImpl extends Oauth2LoginConfigImpl {
    public static final TraceComponent tc = Tr.register(FacebookLoginConfigImpl.class, TraceConstants.TRACE_GROUP, TraceConstants.MESSAGE_BUNDLE);

    public static final String KEY_permissions = "permissions"; // scope
    ...
    protected void setOptionalConfigAttributes(Map<String, Object> props) throws SocialLoginException {
        ...
        this.scope = configUtils.getConfigAttribute(props, KEY_permissions);
    ...
    protected void debug() {
        if (tc.isDebugEnabled()) {
            ...
            Tr.debug(tc, KEY_loginDialogEndpoint + " = " + authorizationEndpoint);
            ...
            Tr.debug(tc, KEY_permissions + " = " + scope);
