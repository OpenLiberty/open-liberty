...
public class LoggingAspectConfig {
    ...
    @Before("execution(* io.openliberty.springboot.support.version40.test.aop.app.AopService.getInternalService())")
    public void beforeInternalMethodExecution() {
        LOGGER.info("==> Before internal service method execution");
    }

    @After("execution(* io.openliberty.springboot.support.version40.test.aop.app.AopService.getService())")
