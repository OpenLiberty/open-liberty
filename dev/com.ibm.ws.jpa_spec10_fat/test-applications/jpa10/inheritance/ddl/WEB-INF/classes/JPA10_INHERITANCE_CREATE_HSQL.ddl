...
CREATE TABLE ${schemaname}.AnoSTCDRoot (id INTEGER NOT NULL, name VARCHAR(255), DISC_COL INTEGER, intVal INTEGER, stringVal1 VARCHAR(255), stringVal2 VARCHAR(255), floatVal REAL, PRIMARY KEY (id));
CREATE TABLE ${schemaname}.AnoSTIDRoot (id INTEGER NOT NULL, name VARCHAR(255), DISC_COL INTEGER, intVal INTEGER, floatVal REAL, stringVal1 VARCHAR(255), stringVal2 VARCHAR(255), PRIMARY KEY (id));
CREATE TABLE ${schemaname}.AnoSTSDRoot (id INTEGER NOT NULL, name VARCHAR(255), DISC_COL VARCHAR(31), intVal INTEGER, stringVal1 VARCHAR(255), stringVal2 VARCHAR(255), floatVal REAL, PRIMARY KEY (id));
...
CREATE TABLE ${schemaname}.XMLSTCDRoot (id INTEGER NOT NULL, name VARCHAR(255), DISC_COL INTEGER, floatVal REAL, stringVal1 VARCHAR(255), stringVal2 VARCHAR(255), intVal INTEGER, PRIMARY KEY (id));
CREATE TABLE ${schemaname}.XMLSTIDRoot (id INTEGER NOT NULL, name VARCHAR(255), DISC_COL INTEGER, intVal INTEGER, floatVal REAL, stringVal1 VARCHAR(255), stringVal2 VARCHAR(255), PRIMARY KEY (id));
CREATE TABLE ${schemaname}.XMLSTSDRoot (id INTEGER NOT NULL, name VARCHAR(255), DISC_COL VARCHAR(255), floatVal REAL, intVal INTEGER, stringVal1 VARCHAR(255), stringVal2 VARCHAR(255), PRIMARY KEY (id));
