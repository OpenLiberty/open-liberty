...
public class XMLMONoOptBiEntityA implements INoOptEntityA {
    ...
    public void setNoOptional(XMLMONoOptBiEntityB noOptional) {
    ...
    public void setNoOptionalField(INoOptEntityB b2) {
        setNoOptional((XMLMONoOptBiEntityB) b2);
    }

    @Override
    public String toString() {
        return "XMLMONoOptBiEntityA [id=" + id + ", name=" + name + ", noOptional=" + noOptional + "]";
    }
}
