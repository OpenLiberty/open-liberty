 ...
 *******************************************************************************/
package web.wsatAppOptional.client;
 ...
 * generated in the web.wsatAppOptional.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _SayHelloToOtherWithoutResponse_QNAME = new QName("http://server.wsatAppOptional.web/", "sayHelloToOtherWithoutResponse");
    private final static QName _SayHelloToOtherWithout_QNAME = new QName("http://server.wsatAppOptional.web/", "sayHelloToOtherWithout");
    private final static QName _SayHelloToOtherResponse_QNAME = new QName("http://server.wsatAppOptional.web/", "sayHelloToOtherResponse");
    private final static QName _SayHelloToOther_QNAME = new QName("http://server.wsatAppOptional.web/", "sayHelloToOther");
    private final static QName _SayHelloResponse_QNAME = new QName("http://server.wsatAppOptional.web/", "sayHelloResponse");
    private final static QName _SayHello_QNAME = new QName("http://server.wsatAppOptional.web/", "sayHello");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: web.wsatAppOptional.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.wsatAppOptional.web/", name = "sayHelloToOtherWithoutResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.wsatAppOptional.web/", name = "sayHelloToOtherWithout")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.wsatAppOptional.web/", name = "sayHelloToOtherResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.wsatAppOptional.web/", name = "sayHelloToOther")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.wsatAppOptional.web/", name = "sayHelloResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.wsatAppOptional.web/", name = "sayHello")
