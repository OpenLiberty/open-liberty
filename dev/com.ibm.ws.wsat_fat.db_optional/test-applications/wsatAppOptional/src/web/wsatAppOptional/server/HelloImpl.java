 ...
 *******************************************************************************/
package web.wsatAppOptional.server;
...
import web.wsatAppOptional.utils.CommonUtils;

@WebService(endpointInterface = "web.wsatAppOptional.server.Hello", wsdlLocation = "WEB-INF/wsdl/hello.wsdl")
