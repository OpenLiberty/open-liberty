...
public class Config20Tests extends FATServletClient {
    ...
    public static final String CONFIG_PROPERTIES_APP_NAME = "configPropertiesApp"; // new to mpConfig-2.0
    ...
    public static final String PROPERTY_EXPRESSION_APP_NAME = "propertyExpressionApp"; // new to mpConfig-2.0
    public static final String UNWRAP_APP_NAME = "unwrapApp"; // new to mpConfig-2.0
    ...
    public static void setUp() throws Exception {
        ...
        PropertiesAsset configPropertiesConfigSource = new PropertiesAsset()
                        .addProperty("validPrefix.validkey", "aValue")
                        .addProperty("validPrefix.validCamelCaseKey", "aValueFromCamelCase");
