 ...
 *
 */
public class IIOPWorkContextInitializer extends LocalObject implements ORBInitializer {
    private static final long serialVersionUID = 1L;
    private static final Encoding CDR_1_2_ENCODING = new Encoding(ENCODING_CDR_ENCAPS.value, (byte) 1, (byte) 2);
    private static final TraceComponent tc = Tr.register(IIOPWorkContextInitializer.class);

    public IIOPWorkContextInitializer() {
        if (TraceComponent.isAnyTracingEnabled() && tc.isDebugEnabled())
            Tr.debug(tc, "IIOPWorkContextInitializer.<init>");
    }
    ...
    public void post_init(ORBInitInfo info) {
        try {
            ...
            try {
                ...
                info.add_server_request_interceptor(new IIOPWorkContextInterceptor());
