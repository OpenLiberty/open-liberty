...
public interface OrbConfigurator {
    default Policy getTargetPolicy(ORB orb, Map<String, Object> properties, Map<String, Object> extraConfig) throws Exception {return null;}
    default Policy getClientPolicy(ORB orb, Map<String, Object> properties) throws Exception {return null;}
    default String getInitializerClassName(boolean endpoint) {return null;}
