...
public class LibertyLoginModuleSpecialCharsTest {
    ...
    private static final String APP_GROUP_ID = "login-module-special-chars-test-group";

    @Server("SimpleRxMessagingServer")
    @TestServlet(contextRoot = APP_NAME, servlet = LibertyLoginModuleSpecialCharsTestServlet.class)
    public static LibertyServer server;

    @BeforeClass
    public static void setup() throws Exception {

        String testUser = SaslPlainTests.kafkaContainer.getSpecialCharsUser();
        String testSecret = SaslPlainTests.kafkaContainer.getSpecialCharsSecret();
        ...
        ConnectorProperties outgoingProperties = simpleOutgoingChannel(connectionProps, SpecialCharsTestBean.CHANNEL_OUT);

        ConnectorProperties incomingProperties = simpleIncomingChannel(connectionProps, SpecialCharsTestBean.CHANNEL_IN, APP_GROUP_ID);
        ...
        PropertiesAsset appConfig = new PropertiesAsset()
                        ...
                        .addProperty(LibertyLoginModuleSpecialCharsTestServlet.TEST_USER_PROPERTY, testUser)
                        .addProperty(LibertyLoginModuleSpecialCharsTestServlet.TEST_SECRET_PROPERTY, testSecret)
        ...
        WebArchive war = ShrinkWrap.create(WebArchive.class, APP_NAME + ".war")
                        ...
                        .addPackage(LibertyLoginModuleSpecialCharsTestServlet.class.getPackage())
