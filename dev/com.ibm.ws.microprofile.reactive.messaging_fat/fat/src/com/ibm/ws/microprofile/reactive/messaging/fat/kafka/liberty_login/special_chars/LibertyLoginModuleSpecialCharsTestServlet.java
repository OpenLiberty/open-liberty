...
public class LibertyLoginModuleSpecialCharsTestServlet extends FATServlet {
    ...
    public void testLoginModuleNoEnc() {
        SimpleKafkaReader<String> reader = kafkaTestClient.readerFor(SpecialCharsTestBean.CHANNEL_OUT);
        SimpleKafkaWriter<String> writer = kafkaTestClient.writerFor(SpecialCharsTestBean.CHANNEL_IN);
