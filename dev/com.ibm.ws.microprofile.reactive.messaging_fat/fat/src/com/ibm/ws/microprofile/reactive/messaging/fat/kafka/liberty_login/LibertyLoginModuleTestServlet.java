...
public class LibertyLoginModuleTestServlet extends FATServlet {
    ...
    public void testLoginModule() {
        SimpleKafkaReader<String> reader = kafkaTestClient.readerFor(AesTestBean.CHANNEL_OUT);
        SimpleKafkaWriter<String> writer = kafkaTestClient.writerFor(AesTestBean.CHANNEL_IN);
