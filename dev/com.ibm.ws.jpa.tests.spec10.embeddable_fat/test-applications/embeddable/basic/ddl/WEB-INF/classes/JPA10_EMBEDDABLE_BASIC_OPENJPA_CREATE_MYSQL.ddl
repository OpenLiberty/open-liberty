...
CREATE TABLE ${schemaname}.ColDate (parent_id INTEGER, value DATETIME, valueOrderColumn INTEGER) ENGINE = innodb;
CREATE TABLE ${schemaname}.ColEnum (parent_id INTEGER, value VARCHAR(255), valueOrderColumn INTEGER) ENGINE = innodb;
CREATE TABLE ${schemaname}.ColInt (parent_id INTEGER, value INTEGER, valueOrderColumn INTEGER) ENGINE = innodb;
CREATE TABLE ${schemaname}.ColLob (parent_id INTEGER, value VARCHAR(255), valueOrderColumn INTEGER) ENGINE = innodb;
CREATE TABLE ${schemaname}.EntColLobPAE (parent_id INTEGER, clobValuePA TEXT, valueOrderColumn INTEGER) ENGINE = innodb;
CREATE TABLE ${schemaname}.EntListEnumPAEOrderBy (parent_id INTEGER, enumeratedOrdinalValuePA SMALLINT, enumeratedStringValuePA VARCHAR(20)) ENGINE = innodb;
CREATE TABLE ${schemaname}.EntListEnumPAEOrderColumn (parent_id INTEGER, enumeratedOrdinalValuePA SMALLINT, enumeratedStringValuePA VARCHAR(20), valueOrderColumn INTEGER) ENGINE = innodb;
...
CREATE TABLE ${schemaname}.ListIntOrderBy (parent_id INTEGER, value INTEGER) ENGINE = innodb;
CREATE TABLE ${schemaname}.ListIntOrderColumn (parent_id INTEGER, value INTEGER, valueOrderColumn INTEGER) ENGINE = innodb;
...
CREATE TABLE ${schemaname}.XMLColDate (parent_id INTEGER, value DATE, valueOrderColumn INTEGER) ENGINE = innodb;
CREATE TABLE ${schemaname}.XMLColEnum (parent_id INTEGER, value VARCHAR(255), valueOrderColumn INTEGER) ENGINE = innodb;
CREATE TABLE ${schemaname}.XMLColInt (parent_id INTEGER, value INTEGER, valueOrderColumn INTEGER) ENGINE = innodb;
CREATE TABLE ${schemaname}.XMLColLob (parent_id INTEGER, value TEXT, valueOrderColumn INTEGER) ENGINE = innodb;
CREATE TABLE ${schemaname}.XMLEntColLobPAE (parent_id INTEGER, clobValuePA TEXT, valueOrderColumn INTEGER) ENGINE = innodb;
CREATE TABLE ${schemaname}.XMLEntListEnumPAEOrderBy (parent_id INTEGER, enumeratedOrdinalValuePA SMALLINT, enumeratedStringValuePA VARCHAR(20)) ENGINE = innodb;
CREATE TABLE ${schemaname}.XMLEntListEnumPAEOrderColumn (parent_id INTEGER, enumeratedOrdinalValuePA SMALLINT, enumeratedStringValuePA VARCHAR(20), valueOrderColumn INTEGER) ENGINE = innodb;
...
CREATE TABLE ${schemaname}.XMLListIntOrderBy (parent_id INTEGER, value INTEGER) ENGINE = innodb;
CREATE TABLE ${schemaname}.XMLListIntOrderColumn (parent_id INTEGER, value INTEGER, valueOrderColumn INTEGER) ENGINE = innodb;
