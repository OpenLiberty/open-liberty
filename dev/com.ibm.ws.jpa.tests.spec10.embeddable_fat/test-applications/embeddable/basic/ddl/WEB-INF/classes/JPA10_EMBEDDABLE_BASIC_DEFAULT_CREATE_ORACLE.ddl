...
CREATE TABLE ${schemaname}.ColLob (parent_id NUMBER, value VARCHAR2(255), valueOrderColumn NUMBER);
CREATE TABLE ${schemaname}.EntColLobPAE (parent_id NUMBER, clobValuePA VARCHAR2(255), valueOrderColumn NUMBER);
...
CREATE TABLE ${schemaname}.EntMapLobPAELobPAE (parent_id NUMBER, mykey CLOB, value VARCHAR2(255));
...
CREATE TABLE ${schemaname}.XMLColLob (parent_id NUMBER, value VARCHAR2(255), valueOrderColumn NUMBER);
CREATE TABLE ${schemaname}.XMLEntColLobPAE (parent_id NUMBER, clobValuePA VARCHAR2(255), valueOrderColumn NUMBER);
...
CREATE TABLE ${schemaname}.XMLListLob (parent_id NUMBER, value VARCHAR2(255), valueOrderColumn NUMBER);
...
CREATE TABLE ${schemaname}.XMLMapEnumLob (parent_id NUMBER, mykey VARCHAR2(255), value VARCHAR2(255));
...
CREATE TABLE ${schemaname}.XMLSetLob (parent_id NUMBER, value VARCHAR2(255));
