...
CREATE TABLE ${schemaname}.EntColLobPAE (parent_id INTEGER, clobValuePA CLOB, valueOrderColumn INTEGER);
...
CREATE TABLE ${schemaname}.XMLColLob (parent_id INTEGER, value CLOB, valueOrderColumn INTEGER);
CREATE TABLE ${schemaname}.XMLEntColLobPAE (parent_id INTEGER, clobValuePA CLOB, valueOrderColumn INTEGER);
