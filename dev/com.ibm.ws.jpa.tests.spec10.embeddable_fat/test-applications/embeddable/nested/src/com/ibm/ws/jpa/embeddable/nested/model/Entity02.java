...
@Entity
@Table(name = "EN_Entity02")
public class Entity02 implements IEntity02 {
    ...
    @Embedded
    private Embeddable02a embeddable02a;

    public Entity02() {
        embeddable02a = new Embeddable02a();
    }

    public Entity02(String ent02_str01,
                    String ent02_str02,
                    String ent02_str03,
                    Embeddable02a embeddable02a) {
    ...
    public Embeddable02a getEmbeddable02a() {
        return embeddable02a;
    }

    public void setEmbeddable02a(Embeddable02a embeddable02a) {
        this.embeddable02a = embeddable02a;
    }
