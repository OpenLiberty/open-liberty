...
@Entity
@Table(name = "AnnBiO2MInv")
public class BiO2MInverseEntity {

    @Id
    protected int id;

    @OneToMany(mappedBy = "biM2OOwnerEmbed.biO2MInverseEntity")
    private HashSet<JPAEmbeddableRelationshipEntity> owners;

    public BiO2MInverseEntity() {
    }

    public BiO2MInverseEntity(int id,
    ...
    public boolean equals(Object otherObject) {
        ...
        if (otherObject == this)
            return true;
        if (!(otherObject instanceof BiO2MInverseEntity))
            return false;
