...
public class XMLBiM2OOwnerEntity {

    private int id;

    private XMLJPAEmbeddableRelationshipEntity inverse;

    public XMLBiM2OOwnerEntity() {
    }

    public XMLBiM2OOwnerEntity(int id, XMLJPAEmbeddableRelationshipEntity inverse) {
        this.id = id;
    ...
    public boolean equals(Object otherObject) {
        ...
        if (otherObject == this)
            return true;
        if (!(otherObject instanceof XMLBiM2OOwnerEntity))
            return false;
