...
//@Mode(TestMode.FULL)
public class TestOLGH10310_Web extends JPAFATServletClient {
    private final static String CONTEXT_ROOT = "olgh10310Web";
    private final static String RESOURCE_ROOT = "test-applications/olgh10310/";
    private final static String appFolder = "web";
    private final static String appName = "olgh10310Web";
    ...
    @TestServlets({
                    @TestServlet(servlet = TestOLGH10310Servlet.class, path = CONTEXT_ROOT + "/" + "TestOLGH10310Servlet")
    })
    ...
    public static void setUp() throws Exception {
        ...
        bannerStart(TestOLGH10310_Web.class);
    ...
    private static void setupTestApplication() throws Exception {
        ...
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh10310.model");
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh10310.testlogic");
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh10310.web");
    ...
    public static void tearDown() throws Exception {
        try {
            ...
            bannerEnd(TestOLGH10310_Web.class, timestart);
        }
    }
}
