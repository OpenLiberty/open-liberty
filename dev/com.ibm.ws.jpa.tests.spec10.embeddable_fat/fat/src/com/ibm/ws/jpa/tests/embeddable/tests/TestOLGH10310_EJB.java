...
import com.ibm.ws.jpa.olgh10310.ejb.TestOLGH10310_EJB_SFEx_Servlet;
...
//@Mode(TestMode.FULL)
public class TestOLGH10310_EJB extends JPAFATServletClient {
    private final static String CONTEXT_ROOT = "olgh10310Ejb";
    private final static String RESOURCE_ROOT = "test-applications/olgh10310/";
    private final static String appFolder = "ejb";
    private final static String appName = "olgh10310Ejb";
    ...
    static {
        dropSet.add("JPA_OLGH10310_${provider}_DROP_${dbvendor}.ddl");
        createSet.add("JPA_OLGH10310_${provider}_CREATE_${dbvendor}.ddl");
        populateSet.add("JPA_OLGH10310_${provider}_POPULATE_${dbvendor}.ddl");
    }

    @Server("EmbeddableServer")
    @TestServlets({
                    @TestServlet(servlet = TestOLGH10310_EJB_SL_Servlet.class, path = CONTEXT_ROOT + "/" + "TestOLGH10310_EJB_SL_Servlet"),
                    @TestServlet(servlet = TestOLGH10310_EJB_SF_Servlet.class, path = CONTEXT_ROOT + "/" + "TestOLGH10310_EJB_SF_Servlet"),
                    @TestServlet(servlet = TestOLGH10310_EJB_SFEx_Servlet.class, path = CONTEXT_ROOT + "/" + "TestOLGH10310_EJB_SFEx_Servlet")
    })
    ...
    public static void setUp() throws Exception {
        ...
        bannerStart(TestOLGH10310_EJB.class);
    ...
    private static void setupTestApplication() throws Exception {
        ...
        ejbApp.addPackages(true, "com.ibm.ws.jpa.olgh10310.ejblocal");
        ejbApp.addPackages(true, "com.ibm.ws.jpa.olgh10310.model");
        ejbApp.addPackages(true, "com.ibm.ws.jpa.olgh10310.testlogic");
        ShrinkHelper.addDirectory(ejbApp, RESOURCE_ROOT + appFolder + "/" + appName + ".jar");

        WebArchive webApp = ShrinkWrap.create(WebArchive.class, appName + ".war");
        webApp.addPackages(true, "com.ibm.ws.jpa.olgh10310.ejb");
    ...
    public static void tearDown() throws Exception {
        try {
            ...
            bannerEnd(TestOLGH10310_EJB.class, timestart);
        }
    }
}
