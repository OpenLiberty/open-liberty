...
package com.ibm.ws.jpa.spec10.embeddable.issues;
...
public class TestOLGH10310_EJB extends JPAFATServletClient {
    ...
    static {
        dropSet.add("JPA_OLGH10310_DROP_${dbvendor}.ddl");
        createSet.add("JPA_OLGH10310_CREATE_${dbvendor}.ddl");
        populateSet.add("JPA_OLGH10310_POPULATE_${dbvendor}.ddl");
    }
