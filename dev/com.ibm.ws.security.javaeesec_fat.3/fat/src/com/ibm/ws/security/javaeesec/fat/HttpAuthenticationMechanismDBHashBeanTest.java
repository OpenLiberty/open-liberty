...
public class HttpAuthenticationMechanismDBHashBeanTest extends JavaEESecTestBase {
    ...
    protected static Class<?> logClass = HttpAuthenticationMechanismDBHashBeanTest.class;
    ...
    public HttpAuthenticationMechanismDBHashBeanTest() {
    ...
    public static void setUp() throws Exception {
        ...
        try {
            ...
            // add custom hash jar
            WCApplicationHelper.createJarAllPackages(myServer, "../../../lib/LibertyFATTestFiles/", "CustomPasswordHashBean.jar", true,
    ...
    @Mode(TestMode.FULL)
    @Test
    public void testUserWithCustomHashBeansXML() throws Exception {
