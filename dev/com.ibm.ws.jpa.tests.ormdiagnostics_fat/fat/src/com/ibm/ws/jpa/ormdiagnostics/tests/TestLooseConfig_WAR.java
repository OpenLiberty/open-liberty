...
public class TestLooseConfig_WAR extends JPAFATServletClient {
    private final static String CONTEXT_ROOT = "looseConfigWAR";
    private final static String RESOURCE_ROOT = "test-applications/looseconfig/";
    private final static String appName = "looseConfigWAR";
...
//        webApp.addAsDirectory("/WEB-INF/lib");
        ...
        //Export the exploded archive to the publish/shared/apps directory
        ...
        server.copyFileToLibertyServerRoot(RESOURCE_ROOT + "resources/server", "apps", "looseConfigWAR_WAR.war.xml");
...
//        cel.add(loader);
    ...
    public static void tearDown() throws Exception {
        try {
            ...
            try {
                ...
                server.deleteFileFromLibertyServerRoot("apps/" + appName + "_WAR.war.xml");
    ...
    public void testBasicDump() throws Exception {
        ...
        ORMIntrospectorHelper.verifyApplications(appName, 0, 1,
                                                 new String[] { "file:.../" + appName + "_JPA.jar/" },
                                                 introspectorData);
