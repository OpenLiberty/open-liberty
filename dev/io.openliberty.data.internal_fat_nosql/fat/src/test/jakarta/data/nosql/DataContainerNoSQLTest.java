...
/**
 * This test is the same as DataNoSQLTest, except with a server that enables
 * dataContainer-1.0 rather than data-1.0.
 */
@RunWith(FATRunner.class)
@MinimumJavaLevel(javaLevel = 17)
public class DataContainerNoSQLTest extends FATServletClient {

    public static MongoDBContainer mongoDBContainer = FATSuite.mongoDBContainer;

    @Server("io.openliberty.data.internal.fat.nosql.container")
