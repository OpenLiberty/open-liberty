...
import com.ibm.ws.jpa.olgh9035.ejb.TestOLGH9035_EJB_SFEx_Servlet;
import com.ibm.ws.jpa.olgh9035.ejb.TestOLGH9035_EJB_SF_Servlet;
import com.ibm.ws.jpa.olgh9035.ejb.TestOLGH9035_EJB_SL_Servlet;
...
public class TestOLGH9035_EJB extends JPAFATServletClient {
    ...
    public static void setUp() throws Exception {
        ...
        bannerStart(TestOLGH9035_EJB.class);
        ...
        System.out.println(TestOLGH9035_EJB.class.getName() + " Setting up database tables...");
    ...
    public static void tearDown() throws Exception {
        try {
            ...
            bannerEnd(TestOLGH9035_EJB.class, timestart);
        }
    }
}
