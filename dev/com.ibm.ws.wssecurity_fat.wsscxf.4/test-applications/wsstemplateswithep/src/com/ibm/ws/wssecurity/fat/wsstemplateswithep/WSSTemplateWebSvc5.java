...
@WebServiceProvider(targetNamespace = "http://wsstemplates.wssecfvt.test",
                    portName = "WSSTemplate5",
                    serviceName = "WSSTemplatesService5",
                    wsdlLocation = "WEB-INF/WSSTemplatesTest.wsdl")

@ServiceMode(value = Service.Mode.MESSAGE)

public class WSSTemplateWebSvc5 implements Provider<SOAPMessage> {
    ...
    public SOAPMessage invoke(SOAPMessage request) {
        ...
        try {
            ...
            StringReader respMsg = new StringReader("<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\">" +
                                                    "<soapenv:Header/>" +
                                                    "<soapenv:Body xmlns=\"http://wsstemplates.wssecfvt.test/types\">" +
                                                    "<provider>This is WSSTemplateWebSvc5 Web Service.</provider></soapenv:Body></soapenv:Envelope>");
