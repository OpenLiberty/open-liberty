...
@WebServiceProvider(targetNamespace="http://wsstemplates.wssecfvt.test",
    portName="WSSTemplate1",
    serviceName="WSSTemplatesService1",
    wsdlLocation = "WEB-INF/WSSTemplatesTest.wsdl"
)

@ServiceMode(value = Service.Mode.MESSAGE)
public class WSSTemplateWebSvc1 implements Provider<SOAPMessage> {
    ...
    public SOAPMessage invoke(SOAPMessage request) {
        ...
        try {
            ...
            StringReader respMsg = new StringReader(
                ...
                "<provider>This is WSSTemplateWebSvc1 Web Service.</provider></soapenv:Body></soapenv:Envelope>");
