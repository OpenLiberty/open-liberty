...
@WebServiceProvider(targetNamespace = "http://caller.libertyfat.test/contract",
                    serviceName = "FatBAC07Service", portName = "UrnCallerToken07",
...
/**
 */
public class Caller_bac07 implements javax.xml.ws.Provider<SOAPMessage> {
    ...
    public SOAPMessage invoke(SOAPMessage request) {
        ...
        String respMsg = new String("<SOAP-ENV:Envelope xmlns:SOAP-ENV=\"http://schemas.xmlsoap.org/soap/envelope/\">" +
                                    "<SOAP-ENV:Body><provider><message>Liberty Fat Caller bac07(" + PrincipalUserID +
