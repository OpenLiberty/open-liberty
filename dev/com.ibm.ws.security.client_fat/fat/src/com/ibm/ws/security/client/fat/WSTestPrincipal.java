...
public class WSTestPrincipal implements Principal, Serializable {
    ...
    /**
     * A WSTestPrincipal's name is the securityName of the authenticated
     * identity.
     * 
    ...
    /**
     * {@inheritDoc} Two WSTestPrincipal are considered equal if their
     * accessIds are the same.
     */
    @Override
    public boolean equals(Object obj) {
        if (!(obj instanceof WSTestPrincipal)) {
            return false;
        }
        WSTestPrincipal that = (WSTestPrincipal) obj;
    ...
    /**
     * {@inheritDoc} Returns the a String of the format WSTestPrincipal:accessId.
     */
    @Override
    public String toString() {
        return "WSTestPrincipal:" + securityName;
    }
