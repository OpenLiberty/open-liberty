...
public class ProgrammaticLoginCallbackHandlerUnauthzUser implements CallbackHandler {
    ...
    public ProgrammaticLoginCallbackHandlerUnauthzUser() { }
     ...
     */
    public ProgrammaticLoginCallbackHandlerUnauthzUser(String userName, String password) {
     ...
     * @param password The password in clear text.
     */
    public ProgrammaticLoginCallbackHandlerUnauthzUser(String userName, String realmName, String password) {
        this.userName = userName;
        this.password = password;
     ...
     */
    public ProgrammaticLoginCallbackHandlerUnauthzUser(String userName, String realmName, String password, Map appContext) {
        this.userName = userName;
        this.password = password;
        this.realm = realmName;
     ...
     */
    public ProgrammaticLoginCallbackHandlerUnauthzUser(byte[] credToken) {
        return;
    }
    ...
    public void handle(Callback[] callbacks) throws IOException, UnsupportedCallbackException {
    	...
    	userName = Constants.USER_UNAUTHORIZED;
    	password = Constants.USER_UNAUTHORIZED_PWD;
