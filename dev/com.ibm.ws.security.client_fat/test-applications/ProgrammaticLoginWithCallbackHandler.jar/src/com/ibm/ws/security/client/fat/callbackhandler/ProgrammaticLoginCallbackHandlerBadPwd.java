...
public class ProgrammaticLoginCallbackHandlerBadPwd implements CallbackHandler {
    ...
    public ProgrammaticLoginCallbackHandlerBadPwd() { }
     ...
     */
    public ProgrammaticLoginCallbackHandlerBadPwd(String userName, String password) {
     ...
     * @param password The password in clear text.
     */
    public ProgrammaticLoginCallbackHandlerBadPwd(String userName, String realmName, String password) {
        this.userName = userName;
        this.password = password;
     ...
     */
    public ProgrammaticLoginCallbackHandlerBadPwd(String userName, String realmName, String password, Map appContext) {
        this.userName = userName;
        this.password = password;
        this.realm = realmName;
     ...
     */
    public ProgrammaticLoginCallbackHandlerBadPwd(byte[] credToken) {
        return;
    }
