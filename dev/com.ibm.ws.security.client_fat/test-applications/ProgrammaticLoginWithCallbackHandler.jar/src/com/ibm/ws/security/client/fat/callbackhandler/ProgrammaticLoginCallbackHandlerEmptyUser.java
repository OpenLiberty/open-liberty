...
public class ProgrammaticLoginCallbackHandlerEmptyUser implements CallbackHandler {
    ...
    public ProgrammaticLoginCallbackHandlerEmptyUser() { }
     ...
     */
    public ProgrammaticLoginCallbackHandlerEmptyUser(String userName, String password) {
     ...
     * @param password The password in clear text.
     */
    public ProgrammaticLoginCallbackHandlerEmptyUser(String userName, String realmName, String password) {
        this.userName = userName;
        this.password = password;
     ...
     */
    public ProgrammaticLoginCallbackHandlerEmptyUser(String userName, String realmName, String password, Map appContext) {
        this.userName = userName;
        this.password = password;
        this.realm = realmName;
     ...
     */
    public ProgrammaticLoginCallbackHandlerEmptyUser(byte[] credToken) {
        return;
    }
