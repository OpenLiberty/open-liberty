...
public class ProgrammaticLoginCallbackHandler implements CallbackHandler {
    ...
    public ProgrammaticLoginCallbackHandler() { }
     ...
     */
    public ProgrammaticLoginCallbackHandler(String userName, String password) {
     ...
     * @param password The password in clear text.
     */
    public ProgrammaticLoginCallbackHandler(String userName, String realmName, String password) {
        this.userName = userName;
        this.password = password;
     ...
     */
    public ProgrammaticLoginCallbackHandler(String userName, String realmName, String password, Map appContext) {
        this.userName = userName;
        this.password = password;
        this.realm = realmName;
     ...
     */
    public ProgrammaticLoginCallbackHandler(byte[] credToken) {
        return;
    }
