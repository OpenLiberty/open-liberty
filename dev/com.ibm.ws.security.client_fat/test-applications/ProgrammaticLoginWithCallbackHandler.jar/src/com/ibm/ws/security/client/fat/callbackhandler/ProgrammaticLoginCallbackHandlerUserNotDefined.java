...
public class ProgrammaticLoginCallbackHandlerUserNotDefined implements CallbackHandler {
    ...
    public ProgrammaticLoginCallbackHandlerUserNotDefined() { }
     ...
     */
    public ProgrammaticLoginCallbackHandlerUserNotDefined(String userName, String password) {
     ...
     * @param password The password in clear text.
     */
    public ProgrammaticLoginCallbackHandlerUserNotDefined(String userName, String realmName, String password) {
        this.userName = userName;
        this.password = password;
     ...
     */
    public ProgrammaticLoginCallbackHandlerUserNotDefined(String userName, String realmName, String password, Map appContext) {
        this.userName = userName;
        this.password = password;
        this.realm = realmName;
     ...
     */
    public ProgrammaticLoginCallbackHandlerUserNotDefined(byte[] credToken) {
        return;
    }
    ...
    public void handle(Callback[] callbacks) throws IOException, UnsupportedCallbackException {
    	...
    	userName = Constants.BAD_USER;
    	password = Constants.USER_2_PWD;
