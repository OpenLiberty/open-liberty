...
public class ProgrammaticLoginCallbackHandlerNullUser implements CallbackHandler {
    ...
    public ProgrammaticLoginCallbackHandlerNullUser() { }
     ...
     */
    public ProgrammaticLoginCallbackHandlerNullUser(String userName, String password) {
     ...
     * @param password The password in clear text.
     */
    public ProgrammaticLoginCallbackHandlerNullUser(String userName, String realmName, String password) {
        this.userName = userName;
        this.password = password;
     ...
     */
    public ProgrammaticLoginCallbackHandlerNullUser(String userName, String realmName, String password, Map appContext) {
        this.userName = userName;
        this.password = password;
        this.realm = realmName;
     ...
     */
    public ProgrammaticLoginCallbackHandlerNullUser(byte[] credToken) {
        return;
    }
