...
public class ProgrammaticLoginCallbackHandlerEmptyPwd implements CallbackHandler {
    ...
    public ProgrammaticLoginCallbackHandlerEmptyPwd() { }
     ...
     */
    public ProgrammaticLoginCallbackHandlerEmptyPwd(String userName, String password) {
     ...
     * @param password The password in clear text.
     */
    public ProgrammaticLoginCallbackHandlerEmptyPwd(String userName, String realmName, String password) {
        this.userName = userName;
        this.password = password;
     ...
     */
    public ProgrammaticLoginCallbackHandlerEmptyPwd(String userName, String realmName, String password, Map appContext) {
        this.userName = userName;
        this.password = password;
        this.realm = realmName;
     ...
     */
    public ProgrammaticLoginCallbackHandlerEmptyPwd(byte[] credToken) {
        return;
    }
