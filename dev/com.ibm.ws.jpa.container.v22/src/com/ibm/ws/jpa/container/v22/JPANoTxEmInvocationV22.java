...
public class JPANoTxEmInvocationV22 extends JPANoTxEmInvocation {
    protected JPANoTxEmInvocationV22(UOWCoordinator uowCoord, EntityManager em, JPAEntityManager jpaEm, boolean txIsUnsynchronized) {
