...
public class JPATxEntityManagerV22 extends JPATxEntityManager {
    private static final TraceComponent tc = Tr.register(JPATxEntityManagerV22.class,
                                                         JPA_TRACE_GROUP,
                                                         JPA_RESOURCE_BUNDLE_NAME);

    public JPATxEntityManagerV22(JPAPuId puRefId, JPAPUnitInfo puInfo, J2EEName j2eeName, String refName, Map<?, ?> properties, boolean isUnsynchronized,
    ...
    protected JPATxEmInvocation createJPATxEmInvocation(UOWCoordinator uowCoord, EntityManager em) {
        return new JPATxEmInvocationV22(uowCoord, em, this, isTxUnsynchronized());
    }

    @Override
    protected JPANoTxEmInvocation createJPANoTxEmInvocation(UOWCoordinator uowCoord, EntityManager em) {
        return new JPANoTxEmInvocationV22(uowCoord, em, this, ivUnsynchronized);
    }
