...
public class PreDestroyManagedBean {
    ...
    public void initialize() {
        ...
        synchronized (PreDestroyManagedBean.class) {
            svLogger.info("-- ejb.PreDestroyManagedBean.initialize" + svNextID);
            ivID = svNextID++;
        }
        if (ivUserTran != null) {
    ...
    public void destroy() {
        synchronized (PreDestroyManagedBean.class) {
            svDestroyed++;
            svLogger.info("-- ejb.PreDestroyManagedBean.destroy:" + ivID +
    ...
    public String toString() {
        return "ejb.PreDestroyManagedBean(ID=" + ivID + "," + ivValue + ")";
    }
