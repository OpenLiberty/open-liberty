...
public class HelloService1PortProxy{
    ...
    public class Descriptor {
        private com.ibm.ws.policyattachments.client1.service1.HelloService1_Service _service = null;
        private com.ibm.ws.policyattachments.client1.service1.HelloService1 _proxy = null;
        ...
        public Descriptor(URL wsdlLocation, QName serviceName) {
            _service = new com.ibm.ws.policyattachments.client1.service1.HelloService1_Service(wsdlLocation, serviceName);
            initCommon();
        }
        ...
        public void init() {
            ...
            try
            {
                ...
                _service = (com.ibm.ws.policyattachments.client1.service1.HelloService1_Service)ctx.lookup("java:comp/env/service/HelloService1");
            }
            ...
            if (_service == null && !_useJNDIOnly)
                _service = new com.ibm.ws.policyattachments.client1.service1.HelloService1_Service();
            initCommon();
        }
        ...
        public com.ibm.ws.policyattachments.client1.service1.HelloService1 getProxy() {
            return _proxy;
        }
