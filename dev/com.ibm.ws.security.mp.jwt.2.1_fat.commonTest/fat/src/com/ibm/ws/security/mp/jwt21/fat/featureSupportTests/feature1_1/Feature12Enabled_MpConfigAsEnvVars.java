 ...
 * We'll test that mpJwt-2.1 mp config properties are not used when the mpJwt-1.1 feature is enabled.
...
public class Feature12Enabled_MpConfigAsEnvVars extends Feature12Enabled_GenericEnvVarsAndSystemPropertiesTests {

    public static Class<?> thisClass = Feature12Enabled_MpConfigAsEnvVars.class;
    ...
    public static void setUp() throws Exception {
        ...
        commonMpJwt21Setup(envVarsResourceServer, MPConfigLocation.ENV_VAR);
