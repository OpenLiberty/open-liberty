...
public class Feature11Enabled_ConfigInServerXmlTests extends MPJwt21MPConfigTests {
    ...
    String[] rsAlgList = { MPJwt21FatConstants.SIGALG_RS256, MPJwt21FatConstants.SIGALG_RS384, MPJwt21FatConstants.SIGALG_RS512 };
    ...
    //        genericConfigTest(resourceServer, MPJwt21FatConstants.SIGALG_RS256, MPJwt21FatConstants.AUTHORIZATION, MPJwt21FatConstants.TOKEN_TYPE_BEARER, null);
    //
    //    }
    //
    //    /**
    ...
    //        genericConfigTest(resourceServer, MPJwt21FatConstants.SIGALG_RS256, MPJwt21FatConstants.COOKIE, MPJwt21FatConstants.TOKEN_TYPE_BEARER,
    ...
    //        genericConfigTest(resourceServer, MPJwt21FatConstants.SIGALG_RS256, MPJwt21FatConstants.COOKIE, "myJwt", setMissingTokenExpectations(resourceServer));
    //    }
    //
    //    /****************************** End Header & Cookie **********************************/
    //
    ...
    //
    //        genericConfigTest(resourceServer, "sign_RS256_enc_RS256", MPJwt21FatConstants.AUTHORIZATION, MPJwt21FatConstants.TOKEN_TYPE_BEARER,
