 ...
 * have mp-config tokenAge defined as system properties
...
public class FeatureSupport_SystemProperties_TokenAge extends OlderMpJwtFeatures_GenericEnvVarsAndSystemPropertiesTests_ClockSkew {

    protected static Class<?> thisClass = FeatureSupport_SystemProperties_TokenAge.class;
    ...
    public static void setUp() throws Exception {
        ...
        commonMpJwt21Setup(resourceServer, "rs_server_AltConfigNotInApp_allowTokenAgeOverrideServerXmlConfig.xml", 1, MP21ConfigSettings.DefaultClockSkew, MP21ConfigSettings.DefaultKeyMgmtKeyAlg, MPConfigLocation.SYSTEM_PROP);
