 ...
 * have mp-config clockSkew defined as environment variables
...
public class FeatureSupport_EnvVars_ClockSkew extends OlderMpJwtFeatures_GenericEnvVarsAndSystemPropertiesTests_ClockSkew {

    protected static Class<?> thisClass = FeatureSupport_EnvVars_ClockSkew.class;
    ...
    public static void setUp() throws Exception {
        ...
        commonMpJwt21Setup(resourceServer, "rs_server_AltConfigNotInApp_allowClockSkewOverrideServerXmlConfig.xml", 1, 1, MP21ConfigSettings.DefaultKeyMgmtKeyAlg, MPConfigLocation.ENV_VAR);
