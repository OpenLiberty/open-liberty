...
//          		new String[] { "sql: create table cities" }, new String[] {});
    ...
    private static String getHttpServlet(String servletPath) throws Exception {
    ...
    private static void checkStrings(String metricsText, String[] expectedString, String[] unexpectedString) {
