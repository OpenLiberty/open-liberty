...
import com.ibm.ws.microprofile12.fat.tests.helloworld.HelloWorldApplication;
...
public class SimpleJAXRSCDITest {
    ...
    private static final String[] MP_VERSIONS = { "1.2", "1.3", "1.4", "2.0", "2.1", "2.2", "3.0", "3.2", "3.3" };
