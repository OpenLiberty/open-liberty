...
public class MPJwtGoodMP12ConfigAsEnvVars_HeaderAuthorization extends GenericEnvVarsAndSystemPropertiesTests {

    public static Class<?> thisClass = MPJwtGoodMP12ConfigAsEnvVars_HeaderAuthorization.class;
    ...
    public static void setUp() throws Exception {
        ...
        commonMpJwt12Setup(envVarsResourceServer, "rs_server_AltConfigNotInApp_good12ServerXmlConfigWithAudiences.xml", MPJwt12FatConstants.AUTHORIZATION,
    ...
    @Test
    public void MPJwtGoodMP12ConfigAsEnvVars_HeaderAuthorization_test() throws Exception {
        genericGoodTest();
    }

    @Test
    public void MPJwtGoodMP12ConfigAsEnvVars_HeaderAuthorization_overriddenByServerXml_test() throws Exception {
