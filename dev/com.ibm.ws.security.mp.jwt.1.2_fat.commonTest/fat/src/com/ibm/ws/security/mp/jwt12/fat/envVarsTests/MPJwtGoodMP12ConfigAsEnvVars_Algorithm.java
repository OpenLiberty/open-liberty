...
public class MPJwtGoodMP12ConfigAsEnvVars_Algorithm extends GenericEnvVarsAndSystemPropertiesTests {

    public static Class<?> thisClass = MPJwtGoodMP12ConfigAsEnvVars_Algorithm.class;
    ...
    public static void setUp() throws Exception {
        ...
        commonMpJwt12Setup(envVarsResourceServer, "rs_server_AltConfigNotInApp_good12ServerXmlConfigWithOtherAlg.xml", MPJwt12FatConstants.COOKIE,
    ...
    @Test
    public void MPJwtGoodMP12ConfigAsEnvVars_Algorithm_test() throws Exception {
        genericGoodTest();
    }

    @Test
    public void MPJwtGoodMP12ConfigAsEnvVars_Algorithm_overriddenByServerXml_test() throws Exception {
