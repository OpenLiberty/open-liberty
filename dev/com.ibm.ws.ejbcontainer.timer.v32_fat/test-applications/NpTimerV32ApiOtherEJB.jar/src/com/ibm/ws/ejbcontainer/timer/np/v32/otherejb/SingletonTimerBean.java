...
public class SingletonTimerBean extends AbstractTimerTestBean implements TimerTestBean {
    ...
    public void initialize() {
        ...
        autoTimerCounter.adjustExpectedAutomaticTimerCount(7);
    }
    ...
    @Schedules({
                 @Schedule(year = "2100", minute = "*/2", info = "Automatic : NpTimerV32ApiOtherEJB : Every 2 Minutes in 2100", persistent = false),
                 @Schedule(year = "2100", minute = "*/6", info = "Automatic : NpTimerV32ApiOtherEJB : Every 6 Minutes in 2100", persistent = false),
                 @Schedule(year = "2100", minute = "*/9", info = "Automatic : NpTimerV32ApiOtherEJB : Every 9 Minutes in 2100", persistent = false),
                 @Schedule(year = "2100", minute = "*/21", info = "Automatic : NpTimerV32ApiOtherEJB : Every 21 Minutes in 2100", persistent = false)
    })
