 ...
 *******************************************************************************/
package com.ibm.ws.ejbcontainer.timer.np.v32.ejb;
...
public class StatelessTimerBean extends AbstractTimerTestBean implements TimerTestBean {
    ...
    private static final String module = "NpTimerV32ApiEJB";

    private static CountDownLatch timerLatch = null;
    private static CountDownLatch[] timerIntervalLatches = null;

    @Schedules({
                 @Schedule(year = "2100", minute = "*/3", info = "Automatic : NpTimerV32ApiEJB : Every 3 Minutes in 2100", persistent = false),
                 @Schedule(year = "2100", minute = "*/6", info = "Automatic : NpTimerV32ApiEJB : Every 6 Minutes in 2100", persistent = false),
                 @Schedule(year = "2100", minute = "*/9", info = "Automatic : NpTimerV32ApiEJB : Every 9 Minutes in 2100", persistent = false)
    })
