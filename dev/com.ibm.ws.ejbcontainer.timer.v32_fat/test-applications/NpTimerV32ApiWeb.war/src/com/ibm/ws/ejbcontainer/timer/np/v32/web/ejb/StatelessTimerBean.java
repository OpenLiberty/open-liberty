...
public class StatelessTimerBean extends AbstractTimerTestBean implements TimerTestBean {
    ...
    @Schedules({
                 @Schedule(year = "2100", minute = "*/3", info = "Automatic : NpTimerV32ApiWeb : Every 3 Minutes in 2100", persistent = false),
                 @Schedule(year = "2100", minute = "*/6", info = "Automatic : NpTimerV32ApiWeb : Every 6 Minutes in 2100", persistent = false),
                 @Schedule(year = "2100", minute = "*/9", info = "Automatic : NpTimerV32ApiWeb : Every 9 Minutes in 2100", persistent = false),
                 @Schedule(year = "2100", minute = "*/11", info = "Automatic : NpTimerV32ApiWeb : Every 11 Minutes in 2100", persistent = false)
    })
