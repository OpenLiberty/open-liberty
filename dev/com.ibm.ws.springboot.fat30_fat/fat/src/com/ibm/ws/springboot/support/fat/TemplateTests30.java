...
public class TemplateTests30 {
    ...
    @Test
    public void testCreateServerFromSpringBoot3() throws Exception {
        expectedFeatures = new String[] { "servlet-6.0", "websocket-2.1", "springBoot-3.0",
                                          "ssl-1.0", "transportSecurity-1.0" };
        serverName = "TemplateServer2";
