...
public class MDB20Test extends FATServletClient {
    ...
    @ClassRule
    public static RepeatTests r = RepeatTests.with(FeatureReplacementAction.EE7_FEATURES().forServers("ejbcontainer.mdb.jms.fat.mdb20")).andWith(FeatureReplacementAction.EE8_FEATURES().fullFATOnly().forServers("ejbcontainer.mdb.jms.fat.mdb20")).andWith(new JakartaEE9Action().forServers("ejbcontainer.mdb.jms.fat.mdb20"));
