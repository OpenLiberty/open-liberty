...
public class MDB30AnnTest extends FATServletClient {
    ...
    @ClassRule
    public static RepeatTests r = RepeatTests.with(FeatureReplacementAction.EE7_FEATURES().forServers("ejbcontainer.mdb.jms.fat.mdb30.ann")).andWith(FeatureReplacementAction.EE8_FEATURES().fullFATOnly().forServers("ejbcontainer.mdb.jms.fat.mdb30.ann")).andWith(new JakartaEE9Action().fullFATOnly().forServers("ejbcontainer.mdb.jms.fat.mdb30.ann"));
