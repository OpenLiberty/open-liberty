 ...
 *******************************************************************************/
package com.ibm.ws.ejbcontainer.mdb.jms.web;
...
import com.ibm.ws.ejbcontainer.mdb.jms.ejb20.BMTBeanIA;
import com.ibm.ws.ejbcontainer.mdb.jms.ejb20.BMTBeanNoCommit;
import com.ibm.ws.ejbcontainer.mdb.jms.ejb20.CMTBeanRequired;
 ...
 * <dd>EJB Container basic function test cases.
 *
 * <dt>Authors:
 * <dd>Sean Zhou/Ken Lawrence
 *
 * <dt>Command options:
 * <dd>
 * <TABLE width="100%">
...
public class MDB20Servlet extends FATServlet {
    private final static String CLASSNAME = MDB20Servlet.class.getName();
     ...
     */
    public void testDurableTopic1() throws Exception {
        FATMDBHelper.emptyQueue(qcfName, testResultQueueName);
        FATMDBHelper.putTopicMessage("Request test results", tcfName, tsports);
    }

    public void testDurableTopic2() throws Exception {
        String s = (String) FATMDBHelper.getQueueMessage(qcfName, testResultQueueName);
