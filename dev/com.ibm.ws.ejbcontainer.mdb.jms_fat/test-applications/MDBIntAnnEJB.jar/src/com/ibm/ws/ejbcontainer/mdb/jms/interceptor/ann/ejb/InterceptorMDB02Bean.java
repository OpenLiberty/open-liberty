...
@MessageDriven(activationConfig = { @ActivationConfigProperty(propertyName = "destinationType", propertyValue = "javax.jms.Queue"),
                                    ...
                                    @ActivationConfigProperty(propertyName = "destination", propertyValue = "MDB02ReqQueue") })
@Interceptors({ Interceptor01.class, Interceptor02.class })
public class InterceptorMDB02Bean implements MessageListener {
    private static final String CLASS_NAME = InterceptorMDB02Bean.class.getName();
    ...
    public void onMessage(Message msg) {
        ...
        try {
            ...
            if (rcvMsg.equals("AroundInvoke") || rcvMsg.equals("PostConstruct") || rcvMsg.equals("PreDestroy")) {
                ...
                FATMDBHelper.putQueueMessage(Boolean.toString(eqChk), replyQueueFactory, replyQueue);
                ...
                try {
                    ...
                    SimpleSLLocal obj = (SimpleSLLocal) ctx.lookup("com.ibm.ws.ejbcontainer.mdb.jms.interceptor.ann.ejb.InterceptorMDB02Bean/injectedRef");

                    result += "Just completed lookup of com.ibm.ws.ejbcontainer.mdb.jms.interceptor.ann.ejb.InterceptorMDB02Bean/injectedRef." + newline;
                    ...
                    if (expected.equals(obj.getString())) {
                        ...
                        result += "Successfully looked up the injected EJB via the default ENC created by injecting the EJB at the "
                                  + "field level and received expected message: " + obj.getString()
