...
@MessageDriven(activationConfig = { @ActivationConfigProperty(propertyName = "destinationType", propertyValue = "javax.jms.Queue"),
                                    ...
                                    @ActivationConfigProperty(propertyName = "destination", propertyValue = "MDB04ReqQueue") })
...
public class InterceptorMDB04Bean implements MessageListener {
    private static final String CLASS_NAME = InterceptorMDB04Bean.class.getName();
    ...
    public void preDestroy() {
        // Ensure java:comp/env lookups work in pre-destroy. d546031
        try {
            javax.naming.InitialContext nctx = new javax.naming.InitialContext();
            Object ejb = nctx.lookup("java:comp/env/ejb/yoMama");
            svLogger.info("InterceptorMDB04Bean.preDestroy: ejb=" + ejb);
            ...
            svLogger.info("InterceptorMDB04Bean.preDestroy: ex=" + ex);
            CheckInvocation.getInstance().recordCallInfo("PreDestroy", "InterceptorMDB04Bean.preDestroy:failed: " + ex, this);
        }
