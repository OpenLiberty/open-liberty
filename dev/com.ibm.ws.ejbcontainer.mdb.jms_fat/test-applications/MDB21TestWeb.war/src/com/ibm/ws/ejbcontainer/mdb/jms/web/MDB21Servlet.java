...
import com.ibm.ws.ejbcontainer.mdb.jms.ejb21.BMTBeanIA;
import com.ibm.ws.ejbcontainer.mdb.jms.ejb21.BMTBeanNoCommit;
import com.ibm.ws.ejbcontainer.mdb.jms.ejb21.CMTBeanRequired;
 ...
 * <br>Sub-tests
 * <ul>
 * <li> testCMTIA - testing the EJB container's behavior for CMT MDB
 ...
 * <li>
 * <li> testBMTIA - testing the EJB container's behavior for BMT MDB
 ...
 * <li> - MTX06 - NotSupportedException: UserTransaction.begin() before committing the previous transaction
 * <li>
 ...
 * <li> - MTX11 - CMT onMsg with 'Required', the Tx is committed (DB update is committed)
 * <li>
 * <li> testCMTRequiredRollback- MTX12 - CMT's onMsg() with 'Required', the Tx is not committed (DB update is not committed)
 * <li>
 * </ul>
 * <br>Data Sources
 * </dl>
...
public class MDB21Servlet extends FATServlet {
    private final static String CLASSNAME = MDB21Servlet.class.getName();
