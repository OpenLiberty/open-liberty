...
public class PageImpl<T> implements Page<T> {
    ...
    PageImpl(String jpql, Pagination pagination, QueryHandler<T> queryHandler,
    ...
    public Page<T> next() {
        ...
        PageImpl<T> next = new PageImpl<T>(jpql, pagination.next(), queryHandler, entityClass, method, numParams, args);
