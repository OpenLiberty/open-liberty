...
define({
    ...
    RESTART_DISABLED_FOR_ADMIN_CENTER: "Перезапуск данного сервера запрещен, так как на нем размещен Центр администрирования",
    ACTION_DISABLED_FOR_USER: "Действия отключены для этого ресурса, поскольку у пользователя нет прав доступа",

    RESTART_AC_TITLE: "Нельзя перезапустить Центр администрирования",
    RESTART_AC_DESCRIPTION: "На {0} расположен Центр администрирования. Центр администрирования не может перезапустить сам себя.",
    ...
    STOP_AC_TITLE: "Остановить Центр администрирования",
    STOP_AC_DESCRIPTION: "Сервер {0} является групповым контроллером, на котором выполняется Центр администрирования. Его остановка может повлиять на операции группового Liberty и привести к недоступности Центра администрирования.",
    STOP_AC_MESSAGE: "Остановить этот контроллер?",
    STOP_STANDALONE_DESCRIPTION: "На сервере {0} выполняется центр администрирования. Остановка сервера приведет к потере доступа к центру администрирования.",
    ...
    STOP_AC_CLUSTER_DESCRIPTION: "Кластер {0} содержит групповой контроллер, на котором запущен Центр администрирования.  Прекращение его работы может повлиять на операции группового Liberty и сделать Центр администрирования недоступным.",
