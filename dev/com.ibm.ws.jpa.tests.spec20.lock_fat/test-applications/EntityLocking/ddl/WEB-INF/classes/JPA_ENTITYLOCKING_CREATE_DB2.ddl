...
CREATE TABLE ${schemaname}.EL10LockEntA (ID INTEGER NOT NULL, STRDATA VARCHAR(254), VERSION INTEGER, ENTB_MTO INTEGER, ENTB_OTO INTEGER, PRIMARY KEY (ID));
CREATE TABLE ${schemaname}.EL10LockEntB (ID INTEGER NOT NULL, STRDATA VARCHAR(254), VERSION INTEGER, PRIMARY KEY (ID));
