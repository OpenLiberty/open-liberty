...
public class BeanValidation20_EJB extends JPAFATServletClient {
    ...
    @TestServlets({
                    @TestServlet(servlet = TestBeanValidation20_EJB_SF_Servlet.class, path = CONTEXT_ROOT + "/" + "TestBeanValidation20_EJB_SF_Servlet"),
                    @TestServlet(servlet = TestBeanValidation20_EJB_SFEx_Servlet.class, path = CONTEXT_ROOT + "/" + "TestBeanValidation20_EJB_SFEx_Servlet"),
                    @TestServlet(servlet = TestBeanValidation20_EJB_SL_Servlet.class, path = CONTEXT_ROOT + "/" + "TestBeanValidation20_EJB_SL_Servlet")
    })
    ...
    public static void setUp() throws Exception {
        ...
        bannerStart(BeanValidation20_EJB.class);
        ...
        System.out.println(BeanValidation20_EJB.class.getName() + " Setting up database tables...");
    ...
    private static void setupTestApplication() throws Exception {
        ...
        ejbApp.addPackages(true, "com.ibm.ws.jpa.beanvalidation20.ejblocal");
        ejbApp.addPackages(true, "com.ibm.ws.jpa.beanvalidation20.model");
        ejbApp.addPackages(true, "com.ibm.ws.jpa.beanvalidation20.testlogic");
        ShrinkHelper.addDirectory(ejbApp, RESOURCE_ROOT + appFolder + "/" + appName + ".jar");

        WebArchive webApp = ShrinkWrap.create(WebArchive.class, appName + ".war");
        webApp.addPackages(true, "com.ibm.ws.jpa.beanvalidation20.ejb");
    ...
    public static void tearDown() throws Exception {
        try {
            ...
            bannerEnd(BeanValidation20_EJB.class, timestart);
        }
    }
}
