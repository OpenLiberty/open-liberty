...
@Mode(TestMode.FULL)
public class SpnegoGenericOidcClientConsent_ConfigTests extends SpnegoOIDCCommonTest {

    public static Class<?> thisClass = SpnegoGenericOidcClientConsent_ConfigTests.class;
    ...
    @Mode(TestMode.LITE)
    @Test
    public void test_SPNEGO_OIDC_Client_GetMainPath_NotContain_no_Config() throws Exception {
        ...
        expectations = vData.addExpectation(expectations, SpnegoOIDCConstants.GET_SPNEGO_LOGIN_PAGE_METHOD, SpnegoOIDCConstants.RESPONSE_FULL, SpnegoOIDCConstants.STRING_CONTAINS,
                                            "Did Not get the OpenID Connect login page.", null, SpnegoOIDCConstants.LOGIN_PROMPT);
