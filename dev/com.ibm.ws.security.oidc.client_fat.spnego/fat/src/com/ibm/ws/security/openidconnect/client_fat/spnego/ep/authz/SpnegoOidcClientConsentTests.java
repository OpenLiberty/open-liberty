...
public class SpnegoOidcClientConsentTests extends SpnegoGenericOidcClientConsentTests {

    @SuppressWarnings("serial")
    @BeforeClass
    public static void setUp() throws Exception {

        thisClass = SpnegoOidcClientConsentTests.class;
        ...
        testOPServer = commonSetUpOPServer("com.ibm.ws.security.openidconnect.client-1.0_fat.spnego.op", "op_server_orig.xml",
