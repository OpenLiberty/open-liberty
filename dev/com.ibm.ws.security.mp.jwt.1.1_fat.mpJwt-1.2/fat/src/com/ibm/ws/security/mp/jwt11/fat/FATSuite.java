...
@SuiteClasses({
        ...
        // mp-config specified as system properties - run in project com.ibm.ws.security.mp.jwt.1.1_fat.mpJwt-1.2.sysProps

        // mp-config specified as env vars - run in project run in project com.ibm.ws.security.mp.jwt.1.1_fat.mpJwt-1.2.envVars
