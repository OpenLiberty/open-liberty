...
import com.ibm.ws.jpa.entitymanager.web.TestEntityManagerServlet;
...
public class JPA10EntityManager_Web extends JPAFATServletClient {
    ...
    static {
        dropSet.add("JPA10_ENTITYMANAGER_DROP_${dbvendor}.ddl");
        createSet.add("JPA10_ENTITYMANAGER_CREATE_${dbvendor}.ddl");
        populateSet.add("JPA10_ENTITYMANAGER_POPULATE_${dbvendor}.ddl");
    }

    @Server("JPA10EntityManagerWebServer")
    @TestServlets({
                    @TestServlet(servlet = TestEntityManagerServlet.class, path = CONTEXT_ROOT + "/" + "TestEntityManagerServlet")
    })
    ...
    public static void setUp() throws Exception {
        ...
        bannerStart(JPA10EntityManager_Web.class);
        ...
        System.out.println("TestEntityManager_Web Setting up database tables...");
    ...
    private static void setupTestApplication() throws Exception {
        ...
        webApp.addPackages(true, "com.ibm.ws.jpa.entitymanager.model");
        webApp.addPackages(true, "com.ibm.ws.jpa.entitymanager.testlogic");
        webApp.addPackages(true, "com.ibm.ws.jpa.entitymanager.web");
...
//        cel.add(loader);
    ...
    public static void tearDown() throws Exception {
        try {
            ...
            bannerEnd(JPA10EntityManager_Web.class, timestart);
        }
    }
}
