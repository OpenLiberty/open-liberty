...
@RunAs("Employee")
@Stateless
public class SecurityEJBM02Bean extends SecurityEJBBeanBase implements SecurityEJBInterface {

    private static final Class<?> c = SecurityEJBM02Bean.class;
    ...
    public String runAsClient() {
        try {
            ...
            result = result + "SecurityEJBM02Bean is invoking injected SecurityEJBRunAsBean running as client: \n";
    ...
    public String runAsSpecified() {
        try {
            ...
            result = result + "SecurityEJBM02Bean is invoking injected SecurityEJBRunAsBean running as specified Employee role: \n";
