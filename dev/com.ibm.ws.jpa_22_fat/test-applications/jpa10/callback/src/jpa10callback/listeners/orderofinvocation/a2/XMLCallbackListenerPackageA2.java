...
package jpa10callback.listeners.orderofinvocation.a2;

import jpa10callback.AbstractCallbackListener;

public class XMLCallbackListenerPackageA2 extends AbstractCallbackListener {
    private static final XMLCallbackListenerPackageA2 _singleton = new XMLCallbackListenerPackageA2();
