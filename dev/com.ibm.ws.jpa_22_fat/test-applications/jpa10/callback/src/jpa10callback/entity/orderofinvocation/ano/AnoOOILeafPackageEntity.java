...
@EntityListeners({
                   jpa10callback.listeners.orderofinvocation.c1.AnoCallbackListenerPackageC1.class,
                   jpa10callback.listeners.orderofinvocation.c2.AnoCallbackListenerPackageC2.class })
