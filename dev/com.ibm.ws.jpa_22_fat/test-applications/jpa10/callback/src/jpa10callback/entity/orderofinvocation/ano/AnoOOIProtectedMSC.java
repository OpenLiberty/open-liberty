...
@MappedSuperclass
@EntityListeners({
                   jpa10callback.listeners.orderofinvocation.b1.AnoCallbackListenerProtectedB1.class,
                   jpa10callback.listeners.orderofinvocation.b2.AnoCallbackListenerProtectedB2.class })
