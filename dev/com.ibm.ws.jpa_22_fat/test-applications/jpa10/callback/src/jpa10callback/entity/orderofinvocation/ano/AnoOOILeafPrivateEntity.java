...
@EntityListeners({
                   jpa10callback.listeners.orderofinvocation.c1.AnoCallbackListenerPrivateC1.class,
                   jpa10callback.listeners.orderofinvocation.c2.AnoCallbackListenerPrivateC2.class })
