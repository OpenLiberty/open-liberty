...
@EntityListeners({
                   jpa10callback.listeners.orderofinvocation.c1.AnoCallbackListenerProtectedC1.class,
                   jpa10callback.listeners.orderofinvocation.c2.AnoCallbackListenerProtectedC2.class })
