...
@MappedSuperclass
@EntityListeners({
                   jpa10callback.listeners.orderofinvocation.b1.AnoCallbackListenerPrivateB1.class,
                   jpa10callback.listeners.orderofinvocation.b2.AnoCallbackListenerPrivateB2.class })
