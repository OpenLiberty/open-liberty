...
@EntityListeners({
                   jpa10callback.listeners.orderofinvocation.c1.AnoCallbackListenerPublicC1.class,
                   jpa10callback.listeners.orderofinvocation.c2.AnoCallbackListenerPublicC2.class })
