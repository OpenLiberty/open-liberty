...
@MappedSuperclass
@EntityListeners({
                   jpa10callback.listeners.orderofinvocation.b1.AnoCallbackListenerPublicB1.class,
                   jpa10callback.listeners.orderofinvocation.b2.AnoCallbackListenerPublicB2.class })
