...
@MappedSuperclass
@EntityListeners({
                   jpa10callback.listeners.orderofinvocation.b1.AnoCallbackListenerPackageB1.class,
                   jpa10callback.listeners.orderofinvocation.b2.AnoCallbackListenerPackageB2.class })
