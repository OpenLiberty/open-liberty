 ...
 *******************************************************************************/
package io.openliberty.jaxws.fat.mock.endpoint;
 ...
 *
 * We set the publish servlet at http://127.0.0.1:8010/testHandlerProvider/SayHelloService which
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (requestPayload.contains("AddedElement")) {
            writer.append("<soap:Envelope xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\">\n"
                          + "  <soap:Body>\n"
                          + "    <ns2:sayHelloResponse xmlns:ns2=\"http://jaxws.samples.openliberty.io/\">\n"
