...
//        	}
    ...
    private void readHeadersFrame(final ChannelHandlerContext ctx, ByteBuf payload, int payloadEndIndex,
        ...
        if (flags.priorityPresent()) {
            ...
            // Check if padding is bigger than header block
            System.out.println("Verifying padding compared to lenght");
            System.out.println("Padding: "+padding);
            System.out.println("Length to read: "+lenToRead);
            if(padding > lenToRead) {
            	throw connectionError(PROTOCOL_ERROR, "Protocol error: %s", "Padding should not be larger than header block.");
            }
        ...
        // Check if padding is bigger than header block
        System.out.println("Verifying padding compared to length");
        System.out.println("Padding: "+padding);
        System.out.println("Length to read: "+len);
        if(padding > len) {
        	throw connectionError(PROTOCOL_ERROR, "HEADERS padding length must be less than the length of the payload");
        }
