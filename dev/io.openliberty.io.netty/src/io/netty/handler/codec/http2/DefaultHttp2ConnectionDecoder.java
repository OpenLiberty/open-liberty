...
//        }
    ...
    private final class FrameReadListener implements Http2FrameListener {
        ...
        public void onHeadersRead(ChannelHandlerContext ctx, int streamId, Http2Headers headers, int streamDependency,
            ...
            System.out.println("IRR Getting here headers1!");
            ...
            System.out.println("IRR Getting here headers2!");
            if (shouldIgnoreHeadersOrDataFrame(ctx, streamId, stream, "HEADERS")) {
                return;
            }
            System.out.println("IRR Getting here headers3!");
            ...
            System.out.println("IRR Getting here headers4!");
            ...
            switch (stream.state()) {
                ...
                case HALF_CLOSED_REMOTE:
                    ...
                    break;
                case CLOSED:
                	System.out.println("IRR Getting here closed stream headers!");
                    throw streamError(stream.id(), STREAM_CLOSED, "Stream %d in unexpected state: %s",
                            stream.id(), stream.state());
                default:
                    // Connection error.
            ...
            if (!isTrailers) {
            	...
            	// Need to check trailers don't contain pseudo headers "Pseudo-header fields MUST NOT appear in trailers"
            	for(Entry<CharSequence, CharSequence> entry : headers) {
                    if(entry.getKey().charAt(0) == ':') {
                        System.out.println("Found Invalid PseudoHeader in trailer!!");
        ...
        private boolean shouldIgnoreHeadersOrDataFrame(ChannelHandlerContext ctx, int streamId, Http2Stream stream,
            ...
            if (stream == null) {
            	...
            	System.out.println(streamCreatedAfterGoAwaySent(streamId));
                ...
                // never have existed.
                verifyStreamMayHaveExisted(streamId);
                System.out.println("Throwing stream error!");
