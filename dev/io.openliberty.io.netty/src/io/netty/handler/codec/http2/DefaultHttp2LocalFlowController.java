...
public class DefaultHttp2LocalFlowController implements Http2LocalFlowController {
     ...
     * @throws Http2Exception If no stream corresponding to {@code stream} could be found.
     */
    public void setConnectionWindow(int windowSize) throws Http2Exception {
        connectionState().window(windowSize);
    }
    ...
    private class DefaultState implements FlowState {
        ...
        public void incrementFlowControlWindows(int delta) throws Http2Exception {
            if (delta > 0 && window > MAX_INITIAL_WINDOW_SIZE - delta) {
            	System.out.println("Reached error increment flow control! Processed window: " + processedWindow + " Delta: " + delta + " Window: " + window + " Max window size: " + MAX_INITIAL_WINDOW_SIZE);
        ...
        private void returnProcessedBytes(int delta) throws Http2Exception {
            if (processedWindow - delta < window) {
            	System.out.println("Reached error return processed bytes! Processed window: " + processedWindow + " Delta: " + delta + " Window: " + window);
        ...
        public boolean consumeBytes(int numBytes) throws Http2Exception {
        	...
        	System.out.println("Consuming bytes: "+numBytes);
        ...
        private void writeWindowUpdate() throws Http2Exception {
            ...
            try {
            	...
            	System.out.println("Reached error write window update! Processed window: " + processedWindow + " Delta: " + deltaWindowSize + " Window: " + window + " Initial Window:"+ initialStreamWindowSize);
            	t.printStackTrace();
            ...
            System.out.println("New window size after window update for stream:" +stream.id());
            System.out.println("Window Size: "+window);
            System.out.println("Initial Window Size: "+initialStreamWindowSize);
            System.out.println("Processed Window: "+processedWindow);
            System.out.println("Window Update ratio: "+streamWindowUpdateRatio);
            System.out.println("Lower bound: "+lowerBound);
            System.out.println("End of stream: "+endOfStream);
        }
    }
