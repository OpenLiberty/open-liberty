...
public class Http2InboundFrameLogger implements Http2FrameReader {
    ...
    public void setConnection(Http2Connection connection) {
    	System.out.println("Setting connection to reader!");
    	if(this.reader instanceof DefaultHttp2FrameReader) {
        	((DefaultHttp2FrameReader) this.reader).setConnection(connection);
        }
    }
