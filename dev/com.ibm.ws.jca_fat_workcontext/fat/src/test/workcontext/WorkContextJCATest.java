...
public class WorkContextJCATest extends FATServletClient {

    @Server("jca.fat.WorkContextServer")
    public static LibertyServer server;
    private static String ServletURL;

    @ClassRule
    public static RepeatTests r = RepeatTests.with(FeatureReplacementAction.EE7_FEATURES().fullFATOnly().forServers("jca.fat.WorkContextServer")).andWith(FeatureReplacementAction.EE8_FEATURES().forServers("jca.fat.WorkContextServer")).andWith(new JakartaEE9Action().forServers("jca.fat.WorkContextServer"));
